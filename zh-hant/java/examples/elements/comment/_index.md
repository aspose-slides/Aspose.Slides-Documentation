...
type: docs
weight: 230
url: /zh-hant/java/examples/elements/comment/
keywords:
- 程式碼範例
- 註解
- PowerPoint
...
- Java
- Aspose.Slides
description: "在 Aspose.Slides for Java 中處理投影片註解：新增、回覆、編輯、標記解決，以及使用 Java 程式碼範例將註解匯出為 PPT、PPTX 與 ODP 簡報。"
---
本文示範如何使用 **Aspose.Slides for Java** 添加、閱讀、移除及回覆現代註解。
