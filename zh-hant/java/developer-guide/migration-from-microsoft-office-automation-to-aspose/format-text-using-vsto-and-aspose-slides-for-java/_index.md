...
- Java
- Aspose.Slides
description: "將 Microsoft Office 自動化遷移至 Aspose.Slides for Java，並以精確的控制在 PowerPoint (PPT、PPTX) 簡報中格式化文字。"
---
{{% alert color="info" %}} 
有時候，您需要以程式方式格式化投影片上的文字。本文說明如何使用 [VSTO](/slides/zh-hant/java/format-text-using-vsto-and-aspose-slides-for-java/) 或 [Aspose.Slides for Java](/slides/zh-hant/java/format-text-using-vsto-and-aspose-slides-for-java/) 讀取第一張投影片中包含文字的範例簡報。程式會將投影片上第三個文字方塊中的文字格式化，使其看起來與最後一個文字方塊的文字相同。
{{% /alert %}} 
## **Formatting Text**
...
以下螢幕截圖顯示執行 VSTO 與 Aspose.Slides for Java 程式碼前後的範例投影片。
...
若要使用 Aspose.Slides 格式化文字，請先在格式化文字之前加入字型。
