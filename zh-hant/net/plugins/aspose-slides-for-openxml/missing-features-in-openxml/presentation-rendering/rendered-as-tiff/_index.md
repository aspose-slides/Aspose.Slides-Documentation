...
---
TIFF 格式以其靈活性，能容納多頁影像和資料而聞名。鑑於 TIFF 格式的重要性與普及度，Aspose.Slides for .NET 提供了將簡報轉換為 TIFF 文件的支援。  
本文說明了不同的 TIFF 匯出選項：

- 將簡報轉換為預設大小的 TIFF。
- 將簡報轉換為自訂大小的 TIFF。

**Save** 方法由 **Presentation** 類別公開，開發人員可呼叫它將整個簡報轉換為 **TIFF** 文件。此外，TiffOptions 類別提供 ImageSize 屬性，使開發人員在需要時能定義影像的大小。
