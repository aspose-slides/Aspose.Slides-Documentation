---
title: 在 VSTO 和 Aspose.Slides 中建立新簡報
type: docs
weight: 80
url: /zh-hant/net/create-a-new-presentation-in-vsto-and-aspose-slides/
---
以下展示了兩個程式碼範例，說明如何使用 VSTO 和 Aspose.Slides for .NET 來達成相同的目標。
## **VSTO**
``` csharp
