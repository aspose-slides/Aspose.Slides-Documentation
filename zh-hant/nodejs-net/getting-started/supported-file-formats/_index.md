...
type: docs
weight: 30
url: /zh-hant/nodejs-net/supported-file-formats/
---
...
## **支援的檔案格式**
此表格列出 Aspose.Slides for Node.js via .NET 可載入與儲存的檔案格式：
...
|[PPS](https://docs.fileformat.com/presentation/pps/)|PowerPoint 97-2003 播放|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[PPSX ](https://docs.fileformat.com/presentation/ppsx/)|PowerPoint 播放|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|PowerPoint 宏功能簡報|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|PowerPoint 宏功能播放|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[POTM](https://docs.fileformat.com/presentation/potm/)|PowerPoint 宏功能範本|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|標記影像檔案格式| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|增強型中繼檔案格式| |{{< emoticons/tick >}}| |
...
|[GIF](https://docs.fileformat.com/image/gif/)|圖形互換格式| |{{< emoticons/tick >}}| |
|[BMP](https://docs.fileformat.com/image/bmp/)|裝置獨立點陣圖| |{{< emoticons/tick >}}| |
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|可縮放向量圖形| |{{< emoticons/tick >}}| |
