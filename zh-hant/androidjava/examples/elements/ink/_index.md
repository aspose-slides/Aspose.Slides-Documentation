...
type: docs
weight: 180
url: /zh-hant/androidjava/examples/elements/ink/
keywords:
- 程式範例
- 墨跡
- PowerPoint
...
- Java
- Aspose.Slides
description: "在 Aspose.Slides for Android 中使用 Ink：繪製、匯入與編輯筆畫，調整顏色與寬度，並使用 Java 範例匯出為 PPT、PPTX 與 ODP。"
---
本文提供了使用 **Aspose.Slides for Android via Java** 存取現有墨跡形狀並將其移除的範例。
