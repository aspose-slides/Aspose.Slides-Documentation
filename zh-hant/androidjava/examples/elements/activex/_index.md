...
type: docs
weight: 200
url: /zh-hant/androidjava/examples/elements/activex/
keywords:
- 程式碼範例
- ActiveX
- PowerPoint
...
- Java
- Aspose.Slides
description: "請參閱 Aspose.Slides for Android 的 ActiveX 範例：在 PPT 與 PPTX 簡報中插入、配置與控制 ActiveX 物件，並提供清晰的 Java 程式碼。"
---
本文示範如何在簡報中使用 **Aspose.Slides for Android via Java** 新增、存取、移除及設定 ActiveX 控制項。
