---
title: 將 PowerPoint 簡報轉換為含備註的 PDF（PHP）
...
- PHP
- Aspose.Slides
description: "使用 Aspose.Slides for PHP（透過 Java）將 PPT 和 PPTX 格式轉換為含備註的 PDF。保留版面配置和講者備註，以製作專業簡報。"
---
## **概覽**
