...
In [Aspose.Slides 21.6](https://docs.aspose.com/slides/pythonnet/aspose-slides-for-net-21-6-release-notes/), we implemented support for XAML export. You can now export your presentations to XAML. 
...
You get to select options from the [IXamlOptions](https://apireference.aspose.com/slides/pythonnet/aspose.slides.export.xaml/ixamloptions) interface that control the export process and determine how Aspose.Slides exports your presentation to XAML. 
