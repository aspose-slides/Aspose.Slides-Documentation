...
type: docs
weight: 110
url: /pythonnet/replacing-images-inside-presentation-image-collection/
---
...
1. Load the presentation file with image inside it using [Presentation](https://apireference.aspose.com/slides/pythonnet/aspose.slides/presentation) class.
