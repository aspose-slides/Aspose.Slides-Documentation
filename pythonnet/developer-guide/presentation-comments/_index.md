...
type: docs
weight: 100
url: /pythonnet/presentation-comments/
...
## **Reply Comments**
A new property [**ParentComment**](https://apireference.aspose.com/slides/pythonnet/aspose.slides/icomment/properties/parentcomment) has been added to [**IComment**](https://apireference.aspose.com/slides/pythonnet/aspose.slides/icomment) interface and [**Comment**](https://apireference.aspose.com/slides/pythonnet/aspose.slides/comment) class in Aspose.Slides for Python via .NET. It allows to get or set the parent comment, thus creating a dialog in the form of a hierarchy of comments and replies.
...
Remove method of [**IComment**](https://apireference.aspose.com/slides/pythonnet/aspose.slides/icomment) interface removes the comment with all its replies.
{{% /alert %}}

{{% alert color="info" title="Note" %}} 
If setting [**ParentComment**](https://apireference.aspose.com/slides/pythonnet/aspose.slides/icomment/properties/parentcomment) leads to a circular reference, the exception of type **PptxEditException** will be thrown.
{{% /alert %}}