...
[Aspose.Slides](/slides/pythonnet/) for .NET allows you to add large files (in this case, a large video file) through a process involving BLOBs to reduce memory consumption.
...
With methods from the [**IImageCollection**](https://apireference.aspose.com/slides/pythonnet/aspose.slides/iimagecollection) interface and [**ImageCollection** ](https://apireference.aspose.com/slides/pythonnet/aspose.slides/imagecollection)class, you can add a large image as a stream to get it treated as a BLOB. 
