...
Custom data (specific to a presentation) or user can exist as tags ([ITagCollection](https://apireference.aspose.com/slides/pythonnet/aspose.slides/itagcollection)) and CustomXmlParts ([ICustomXmlPartCollection](https://apireference.aspose.com/slides/pythonnet/aspose.slides/icustomxmlpartcollection)). 
