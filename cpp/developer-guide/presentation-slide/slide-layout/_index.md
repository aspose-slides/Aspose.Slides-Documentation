...
Slides in presentation could be set as different paper sizes. The [SlideSize.Type](http://www.aspose.com/api/net/slides/aspose.slides/slidesize/properties/type) property and [SlideSizeScaleType ](https://reference.aspose.com/slides/net/aspose.slides/slidesizescaletype)enumeration can be used to set the slide size. Developers can set size of slide as shown below in the example.
