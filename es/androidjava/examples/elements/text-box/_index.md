...
type: docs
weight: 40
url: /es/androidjava/examples/elements/text-box/
keywords:
- ejemplo de código
- cuadro de texto
- PowerPoint
...
- Java
- Aspose.Slides
description: "Trabaja con cuadros de texto en Aspose.Slides para Android: agrega, da formato, alinea, ajusta, autoajusta y estiliza texto usando Java para presentaciones PPT, PPTX y ODP."
---
