...
- Java
- Aspose.Slides
description: "Descubra todos los formatos de archivo que Aspose.Slides para Android mediante Java puede abrir, guardar y convertir, incluidos PPT, PPTX y ODP, con notas claras de soporte de importación/exportación."
---
...
Esta tabla contiene los formatos de archivo que Aspose.Slides para Android mediante Java puede cargar y guardar:
...
|[PPS](https://docs.fileformat.com/presentation/pps/)|Show de PowerPoint 97-2003|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
...
|[PPSX ](https://docs.fileformat.com/presentation/ppsx/)|Show de PowerPoint|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|Presentación de PowerPoint con macros|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|Show de PowerPoint con macros|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
|[POTM](https://docs.fileformat.com/presentation/potm/)|Plantilla de PowerPoint con macros|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Formato de archivo de imagen con etiqueta| |{{< emoticons/tick >}}||
...
Sí. Aspose.Slides admite la exportación a PDF con niveles de cumplimiento como PDF/A-2a, PDF/A-2b, PDF/A-2u, PDF/A-3a, PDF/A-3b, así como PDF/UA mediante la configuración [cumplimiento](https://reference.aspose.com/slides/androidjava/com.aspose.slides/pdfoptions/#setCompliance-int-) en [opciones de exportación PDF](https://reference.aspose.com/slides/androidjava/com.aspose.slides/pdfoptions/).

**¿La biblioteca admite la incrustación de fuentes al exportar a PDF, con control granular sobre lo que se incrusta?**

Sí. Puede controlar si las fuentes se incrustan totalmente o en subconjunto (solo los glifos usados), especificar cómo se tratan las fuentes del sistema comunes y configurar el comportamiento del texto ASCII mediante [opciones de exportación PDF](https://reference.aspose.com/slides/androidjava/com.aspose.slides/pdfoptions/).

**¿Puedo detectar si un archivo está protegido con contraseña antes de cargarlo realmente?**

Sí. Usando la [API de inspección basada en factoría](https://reference.aspose.com/slides/androidjava/com.aspose.slides/presentationfactory/), puede consultar un archivo de presentación para determinar si está protegido con contraseña sin abrirlo completamente.

**¿Existen mecanismos de respaldo de fuentes y soporte para fuentes personalizadas?**

Sí. La biblioteca admite la [carga](/slides/es/androidjava/custom-font/) y la [incrustación](/slides/es/androidjava/embedded-font/) de fuentes personalizadas y proporciona [reglas de respaldo de fuentes](/slides/es/androidjava/fallback-font/) para evitar glifos faltantes durante el renderizado y la conversión.

**¿Puedo exportar diapositivas a XPS, y hay opciones para ajustar la salida XPS?**

Sí. [Exportar a XPS](/slides/es/androidjava/convert-powerpoint-to-xps/) es compatible, y puede ajustar las [opciones de guardado](https://reference.aspose.com/slides/androidjava/com.aspose.slides/xpsoptions/) relevantes para controlar la calidad y el contenido del documento XPS.