...
Puede que necesite averiguar los efectos de animación añadidos a un párrafo; por ejemplo, en un caso, desea obtener los efectos de animación de un párrafo porque planea aplicar esos efectos a otro párrafo o forma.
...
Las animaciones de texto controlan el comportamiento de los objetos a lo largo del tiempo en una diapositiva, mientras que [transiciones](/slides/es/androidjava/slide-transition/) controla cómo cambian las diapositivas. Son independientes y pueden usarse juntas; el orden de reproducción lo determina la línea de tiempo de la animación y la configuración de la transición.

**¿Se conservan las animaciones de texto al exportar a PDF o imágenes?**

No. PDF e imágenes raster son estáticas, por lo que verás un único estado de la diapositiva sin movimiento. Para conservar el movimiento, usa la exportación a [video](/slides/es/androidjava/convert-powerpoint-to-video/) o [HTML](/slides/es/androidjava/export-to-html5/).
