...
[Aspose.Slides for Android via Java](https://products.aspose.com/slides/es/androidjava/) le permite insertar objetos OLE en diapositivas como marcos de objetos OLE ([OleObjectFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/OleObjectFrame)).
...
1. Cree una instancia de la [Presentation](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/Presentation) clase.  
1. Obtenga una referencia a una diapositiva mediante su índice.  
1. Lea el archivo de Excel como una matriz de bytes.  
1. Añada el [OleObjectFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/OleObjectFrame) a la diapositiva que contenga la matriz de bytes y otra información sobre el objeto OLE.  
1. Guarde la presentación modificada como un archivo PPTX.  

En el ejemplo siguiente, añadimos un gráfico de un archivo de Excel a una diapositiva como un marco de objeto OLE usando Aspose.Slides for Android via Java.  
**Nota** que el constructor de [OleEmbeddedDataInfo](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/OleEmbeddedDataInfo) recibe una extensión de objeto incrustable como segundo parámetro. Esta extensión permite a PowerPoint interpretar correctamente el tipo de archivo y elegir la aplicación adecuada para abrir este objeto OLE.
...
Aspose.Slides for Android via Java le permite añadir un [OleObjectFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/OleObjectFrame) sin incrustar datos, sino solo con un enlace al archivo.

Este código Java le muestra cómo añadir un [OleObjectFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/OleObjectFrame) con un archivo Excel enlazado a una diapositiva:
...
1. Cargue una presentación con el objeto OLE incrustado creando una instancia de la [Presentation](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/Presentation) clase.  
2. Obtenga la referencia de la diapositiva usando su índice.  
3. Acceda a la forma [OleObjectFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/OleObjectFrame).  
   En nuestro ejemplo, utilizamos el PPTX creado previamente que tiene solo una forma en la primera diapositiva. Luego *cast* ese objeto como un [IOleObjectFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ioleobjectframe/). Este era el marco de objeto OLE deseado para acceder.  
...
Aspose.Slides le permite acceder a las propiedades del marco de objeto OLE enlazado.

Este código Java le muestra cómo comprobar si un objeto OLE está enlazado y luego obtener la ruta al archivo enlazado:
...
3. Acceda a la forma del marco del objeto OLE.  
   En nuestro ejemplo, utilizamos el PPTX creado previamente que tiene una forma en la primera diapositiva. Luego *cast* ese objeto como un [IOleObjectFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ioleobjectframe/). Este era el marco de objeto OLE deseado para acceder.  
4. Una vez que se accede al marco del objeto OLE, puede realizar cualquier operación sobre él.  
...
Al trabajar con presentaciones, puede necesitar sustituir objetos OLE antiguos por otros nuevos o reemplazar un objeto OLE no compatible por uno compatible. Aspose.Slides for Android via Java le permite establecer el tipo de archivo para un objeto incrustado, lo que permite actualizar los datos del marco OLE o su extensión.
...
Este código Java le muestra cómo establecer la imagen de icono y el título para un objeto incrustado:
...
1. Cree una instancia de la clase [Presentation](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/Presentation) que contenga los objetos OLE que desea extraer.  
2. Recorra todas las formas de la presentación y acceda a las formas [OLEObjectFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/oleobjectframe).  
...
Lo que es visible en la diapositiva se renderiza: el icono o la imagen sustituta (vista previa). El contenido OLE “en vivo” no se ejecuta durante el renderizado. Si es necesario, establezca su propia imagen de vista previa para asegurar la apariencia esperada en el PDF exportado.
