---
title: Administrar Zoom de presentación en Android
...
2.	Cree nuevas diapositivas a las que tiene la intención de enlazar los marcos de zoom. 
3.	Agregue un texto de identificación y fondo a las diapositivas creadas.
4.	Agregue marcos de zoom (conteniendo las referencias a las diapositivas creadas) a la primera diapositiva.
...
Con Aspose.Slides para Android mediante Java, puede crear un marco de zoom con una imagen de vista previa de diapositiva diferente de esta manera:
1.	Cree una instancia de la clase [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) .
2.	Cree una nueva diapositiva a la que tiene la intención de enlazar el marco de zoom. 
3.	Agregue un texto de identificación y fondo a la diapositiva.
4.	Cree un objeto [IPPImage](https://reference.aspose.com/slides/androidjava/com.aspose.slides/IPPImage) añadiendo una imagen a la colección Images asociada con el objeto [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) que se utilizará para rellenar el marco.
...
1.	Cree una instancia de la clase [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) .
2.	Cree nuevas diapositivas a enlazar a las que tiene la intención de enlazar el marco de zoom. 
3.	Agregue algún texto de identificación y fondo a las diapositivas creadas.
4.	Agregue marcos de zoom (conteniendo las referencias a las diapositivas creadas) a la primera diapositiva.
5.	Cree un objeto [IPPImage](https://reference.aspose.com/slides/androidjava/com.aspose.slides/IPPImage) añadiendo una imagen a la colección Images asociada con el objeto [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) que se utilizará para rellenar el marco.
...
Un zoom de sección es un enlace a una sección en su presentación. Puede usar zoom de sección para volver a secciones que desea enfatizar realmente. O puede usarlos para resaltar cómo ciertas partes de su presentación se conectan. 

![overview_image](seczoomsel.png)

Para objetos de zoom de sección, Aspose.Slides proporciona la interfaz [ISectionZoomFrame](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ISectionZoomFrame) y algunos métodos bajo la interfaz [IShapeCollection](https://reference.aspose.com/slides/androidjava/com.aspose.slides/IShapeCollection) .
...
4.	Cree una nueva sección a la que tiene la intención de enlazar el marco de zoom. 
...
Usando Aspose.Slides para Android mediante Java, puede crear un marco de zoom de sección con una imagen de vista previa de diapositiva diferente de esta manera:
...
1.	Cree una instancia de la clase [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) .
2.	Cree una nueva diapositiva.
3.	Agregue fondo de identificación a la diapositiva creada.
4.	Cree una nueva sección a la que tiene la intención de enlazar el marco de zoom. 
5.	Agregue un marco de zoom de sección (conteniendo referencias a la sección creada) a la primera diapositiva.
6.	Cambie el tamaño y la posición del objeto de zoom de sección creado.
7.	Cree un objeto [IPPImage](https://reference.aspose.com/slides/androidjava/com.aspose.slides/IPPImage) añadiendo una imagen a la colección Images asociada con el objeto [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) que se utilizará para rellenar el marco.
...
Un zoom de resumen es como una página de inicio donde se muestran todas las piezas de su presentación a la vez. Cuando está presentando, puede usar el zoom para pasar de un lugar de su presentación a otro en cualquier orden que desee. Puede ser creativo, adelantar secciones o volver a visitar partes de su presentación sin interrumpir el flujo. 
...
Sí. El [Zoom frame](https://reference.aspose.com/slides/androidjava/com.aspose.slides/zoomframe/) o [section](https://reference.aspose.com/slides/androidjava/com.aspose.slides/sectionzoomframe/) tiene un comportamiento de retorno al padre que, cuando está habilitado, envía a los espectadores de vuelta a la diapositiva original después de visitar el contenido objetivo.
...
No hay un límite estricto de API documentado. Los límites prácticos dependen de la complejidad general de la presentación y del rendimiento del visor. Puede agregar muchos marcos de Zoom, pero tenga en cuenta el tamaño del archivo y el tiempo de renderizado.