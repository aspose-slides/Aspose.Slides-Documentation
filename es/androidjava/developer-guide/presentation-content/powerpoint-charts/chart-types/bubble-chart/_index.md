---
title: Personalizar gráficos de burbujas en presentaciones en Android
...
- Java
- Aspose.Slides
description: "Cree y personalice potentes gráficos de burbujas en PowerPoint con Aspose.Slides para Android a través de Java para mejorar su visualización de datos fácilmente."
---
...
Sí. Existe un tipo de gráfica separado, "Bubble with 3-D". Aplica estilo 3-D a las burbujas pero no añade un eje adicional; los datos siguen siendo X‑Y‑S (tamaño). El tipo está disponible en la clase [chart type](https://reference.aspose.com/slides/androidjava/com.aspose.slides/charttype/).
