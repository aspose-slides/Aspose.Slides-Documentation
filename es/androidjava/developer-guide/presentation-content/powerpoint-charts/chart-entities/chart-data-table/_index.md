...
Aspose.Slides para Android a través de Java proporciona soporte para cambiar el color de las categorías en el color de una serie.
...
1. Añadir gráfico en la diapositiva.
1. Configurar tabla del gráfico.
1. Establecer altura de la fuente.
