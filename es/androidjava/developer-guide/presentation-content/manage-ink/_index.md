---
title: Gestionar objetos de tinta de presentaciones en Android
...
- Java
- Aspose.Slides
description: "Gestiona los objetos de tinta de PowerPoint: crea, edita y da estilo a la tinta digital con Aspose.Slides para Android. Obtén ejemplos de código Java para trazos, color y tamaño del pincel."
---
...
Un rastro es un elemento básico o estándar utilizado para registrar la trayectoria de un lápiz mientras un usuario escribe tinta digital. Los rastros son grabaciones que describen secuencias de puntos conectados. 
...
Puede usar un pincel para dibujar líneas que conecten los puntos de los elementos de rastro. El pincel tiene su propio color y tamaño, correspondientes a las propiedades `Brush.Color` y `Brush.Size`. 
...
En general, el ancho y la altura de un pincel no coinciden, por lo que PowerPoint no muestra el tamaño del pincel (la sección de datos aparece atenuada). Pero cuando el ancho y la altura del pincel coinciden, PowerPoint muestra su tamaño de la siguiente manera:
...
Por lo tanto, para determinar el área visible de todo el objeto de tinta, debemos considerar el tamaño del pincel de los objetos de rastro. Aquí, el objeto objetivo (el objeto de rastro de texto manuscrito) se ha escalado al tamaño del contenedor (marco). Cuando el tamaño del contenedor (marco) cambia, el tamaño del pincel permanece constante y viceversa. 
