...
PowerPoint genera variantes más claras y más oscuras a partir de un color de tema aplicando transformaciones de color. Aspose.Slides expone estas transformaciones mediante el enumerado [ColorTransformOperation](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/colortransformoperation/).
...
Un esquema de fuentes del tema contiene un conjunto de fuentes mayor para encabezados y un conjunto de fuentes menor para el cuerpo del texto. Los métodos [IFontScheme.getMajor](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ifontscheme/) y [IFontScheme.getMinor](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ifontscheme/) exponen esos conjuntos.
...
El encabezado sigue la fuente mayor y el texto del cuerpo sigue la fuente menor. Un texto que tiene un nombre de fuente explícito en lugar de un identificador de tema no cambiará automáticamente cuando el esquema de fuentes del tema cambie.
...
Para obtener más información sobre fuentes de presentación, consulte [PowerPoint Fonts](/slides/es/androidjava/powerpoint-fonts/).
{{% /alert %}}
...
1. Devuelve el nuevo [IMasterSlide](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/imasterslide/).
...
Solo las diapositivas que dependían del maestro seleccionado se reasignan. Las diapositivas asociadas a otros maestros conservan sus maestros y temas actuales. Los colores, fuentes, rellenos, líneas, fondos y efectos con conocimiento de tema se resuelven contra el tema externo. Los colores, fuentes, rellenos y demás formatos asignados directamente pueden permanecer sin cambios. Las anulaciones a nivel de diseño y de diapositiva también pueden tener prioridad sobre los valores heredados del nuevo maestro.

El tema puede referenciar fuentes que no estén disponibles en el entorno de ejecución. Para conseguir una renderización y exportación consistentes, instale las fuentes necesarias, proporciónelas mediante [fuentes personalizadas](/slides/es/androidjava/custom-font/) o configure la [sustitución de fuentes](/slides/es/androidjava/font-substitution/).
...
Si desea mover una diapositiva a otra presentación y conservar su diseño original, clone el maestro de origen en la presentación de destino con [IMasterSlideCollection.addClone](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/imasterslidecollection/), luego clone la diapositiva con [ISlideCollection.addClone](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/islidecollection/) y el maestro clonado. Esto transporta el maestro, sus diseños y el tema asociado juntos.
...
Este es el flujo de trabajo preferido cuando la diapositiva de origen debe verse idéntica en el destino. Clonar simplemente el contenido sobre un maestro de destino no relacionado puede modificar los colores, fuentes, fondos y efectos controlados por el tema.
...
Esto modifica el tema usado por esa diapositiva sin cambiar el tema heredado por las demás diapositivas. Para eliminar la anulación local y volver a los valores heredados, invoque [OverrideTheme.clear](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/overridetheme/).
...
No trate el índice de estilo como un índice de colección basado en cero. Además, evite codificar un número de estilo de un archivo y suponer que tiene la misma apariencia en otro archivo; las definiciones de estilo del tema son específicas de cada presentación.
{{% /alert %}}
...
Para las formas que referencian estas ranuras, el primer estilo de línea del tema se vuelve rojo, el tercer estilo de relleno del tema pasa a verde bosque sólido y el tercer estilo de efecto adquiere una sombra externa con una distancia de 10 puntos. El aspecto exacto sigue dependiendo de qué ranuras de estilo referencia cada forma y si el formato directo anula al tema.
...
Un relleno puede almacenarse directamente en un objeto o heredarse de un párrafo, diseño, maestro, estilo de tema u otro nivel de formato. Llame a [IFillFormat.getEffective](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ifillformat/) para resolver esa jerarquía en un objeto inmutable [IFillFormatEffectiveData](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ifillformateffectivedata/). Primero compruebe [IFillFormatEffectiveData.getFillType](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ifillformateffectivedata/). Solo cuando sea `FillType.Solid` debe leer las propiedades del relleno sólido.

Para un relleno sólido, [IFillFormatEffectiveData.getSolidFillColor](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ifillformateffectivedata/) devuelve el valor RGB final renderizado tras aplicar herencia, búsqueda en el tema y transformaciones de color. [IFillFormatEffectiveData.getSolidFillSchemeColor](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ifillformateffectivedata/) devuelve la ranura lógica correspondiente del [SchemeColor](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/schemecolor/), como `Text1` o `Accent6`. Un valor `SchemeColor.NotDefined` indica que el relleno sólido efectivo no se basa en un color de esquema. En un flujo donde los rellenos son colores de tema o colores RGB directos, este valor identifica un relleno RGB directo.

No utilice solo el valor local de [IColorFormat.getSchemeColor](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/icolorformat/) para clasificar un relleno. Por ejemplo, una porción de texto puede no tener un color de esquema definido localmente, por lo que su valor local es `NotDefined`, mientras que su relleno efectivo hereda un color de tema y se resuelve a `Text1` o `Accent6`. Por el contrario, `getSolidFillSchemeColor` indica qué ranura lógica del tema produjo el color efectivo, pero no dice si esa ranura provino del objeto, párrafo, diseño, maestro u otro nivel de la jerarquía de formato.

El siguiente ejemplo carga una presentación, audita tanto los rellenos de formas como los rellenos de porciones de texto, muestra cada valor RGB final y el color de esquema asociado, y marca los rellenos sólidos que no seguirán los cambios de color del tema:
...
Utilice los datos efectivos para diagnósticos de renderizado, validación y comparaciones. Si solo inspecciona [Presentation.getMasterTheme](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/presentation/), puede pasarse por alto una anulación de maestro, diseño, diapositiva o forma que modifique la apariencia final.

## **FAQ**

**¿Aplicar un tema externo afecta a todas las diapositivas de la presentación?**

No. [IMasterSlide.applyExternalThemeToDependingSlides](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/imasterslide/) reasigna solo las diapositivas que dependen del maestro seleccionado. Las diapositivas que usan otros maestros conservan sus temas actuales.
