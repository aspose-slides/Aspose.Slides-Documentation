...
- Java
- Aspose.Slides
description: "Domina los temas de presentación en Aspose.Slides para Android mediante Java para crear, personalizar y convertir archivos PowerPoint con una imagen corporativa coherente."
---
## **Introducción**
...
En PowerPoint, un tema comprende colores, [fonts](/slides/es/androidjava/powerpoint-fonts/), [background styles](/slides/es/androidjava/presentation-background/), y efectos.

![theme-constituents](theme-constituents.png)

## **Cambiar color del tema**

Un tema de PowerPoint utiliza un conjunto específico de colores para diferentes elementos en una diapositiva. Si no te gustan los colores, los cambias aplicando nuevos colores al tema. Para permitirte seleccionar un nuevo color del tema, Aspose.Slides ofrece valores bajo la enumeración [SchemeColor](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/SchemeColor).
...
Para demostrar más claramente la operación de cambio de color, creamos otro elemento y le asignamos el color de acento (del proceso inicial). Luego cambiamos el color en el tema:
...
Cuando aplicas transformaciones de luminancia al color principal del tema(1), se forman colores a partir de la paleta adicional(2). Entonces puedes establecer y obtener esos colores del tema.
...
Cuando trabajas con [SchemeColor](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/schemecolor/), puedes notar que contiene los siguientes valores de color del tema:

`Background1`, `Background2`, `Text1` y `Text2`.

Sin embargo, `Presentation.getMasterTheme().getColorScheme()` devuelve [IColorScheme](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/icolorscheme/), que expone los colores correspondientes como:
...
Esta diferencia de nombres proviene de la terminología de Microsoft Office. Las versiones antiguas de Office usaban `Dark 1`, `Light 1`, `Dark 2` y `Light 2`, mientras que las versiones UI más recientes muestran los mismos espacios como `Text 1`, `Background 1`, `Text 2` y `Background 2`.
...
* **+mj-lt** - Fuente de encabezado Latin (Fuente latina mayor)
* **+mn-ea** - Fuente del cuerpo East Asian (Fuente este‑asiática menor)
* **+mj-ea** - Fuente del cuerpo East Asian (Fuente este‑asiática mayor)
...
Puede que quieras consultar [PowerPoint fonts](/slides/es/androidjava/powerpoint-fonts/).
{{% /alert %}}
...
{{% alert color="info" title="TIP" %}} 
Puede que quieras consultar [PowerPoint Background](/slides/es/androidjava/presentation-background/).
{{% /alert %}}
...
Usando 3 propiedades ([FillStyles](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/FormatScheme#getFillStyles--), [LineStyles](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/FormatScheme#getLineStyles--), [EffectStyles](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/FormatScheme#getEffectStyles--)) de la clase [FormatScheme](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/FormatScheme) puedes cambiar los elementos en un tema (incluso con mayor flexibilidad que las opciones en PowerPoint).

Este código Java muestra cómo cambiar un efecto del tema alterando partes de los elementos:
...
Sí. Aspose.Slides admite sobrescrituras de tema a nivel de diapositiva, por lo que puedes aplicar un tema local solo a esa diapositiva manteniendo intacto el tema maestro (a través de [SlideThemeManager](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/slidethememanager/)).

### **¿Cuál es la forma más segura de trasladar un tema de una presentación a otra?**

[Clone slides](/slides/es/androidjava/clone-slides/) junto con su maestra en la presentación de destino. Esto conserva la maestra original, los diseños y el tema asociado, de modo que la apariencia permanezca consistente.

### **¿Cómo puedo ver los valores "efectivos" después de toda la herencia y sobrescrituras?**

Utiliza las vistas ["effective"](/slides/es/androidjava/shape-effective-properties/) de la API para tema/color/fuente/efecto. Estas devuelven las propiedades finales resueltas tras aplicar la maestra y cualquier sobrescritura local.