...
- Java
- Aspose.Slides
description: "Descubra las propiedades de vista de Aspose.Slides para Android mediante Java para personalizar diapositivas en los formatos PPT, PPTX y ODP—ajuste diseños, niveles de zoom y configuraciones de visualización."
---
## **Introducción**
...
A continuación se muestra un ejemplo de cómo acceder a las propiedades [ViewProperties.getNormalViewProperties](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ViewProperties#getNormalViewProperties--) de una presentación.
...
1. Configure las [View Properties](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ViewProperties) de la [Presentation](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/presentation).
...
Utilice [Presentation.getViewProperties](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/presentation/#getViewProperties--) para acceder a la configuración de vista a nivel de presentación. Utilice [IViewProperties.getShowComments](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/iviewproperties/#getShowComments--) y [IViewProperties.setShowComments](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/iviewproperties/#setShowComments-byte-) para leer o cambiar la preferencia almacenada acerca de si los comentarios deben mostrarse cuando la presentación se abre en PowerPoint u otro editor compatible.

Esta configuración solo controla la preferencia de vista almacenada. No añade, elimina, edita ni resuelve comentarios. Ocultar comentarios preserva su contenido, autores, posiciones, respuestas y estados. Consulte [Presentation Comments](/slides/es/androidjava/presentation-comments/) para operaciones que modifican los propios comentarios.

El siguiente ejemplo requiere un archivo `comments.pptx` existente que contenga comentarios. Muestra la configuración de visibilidad actual, solicita que los comentarios se oculten y guarda un nuevo PPTX sin eliminar ningún comentario. También utiliza [IViewProperties.setLastView](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/iviewproperties/#setLastView-int-) con [ViewType.SlideView](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/viewtype/#SlideView) para configurar la vista de edición inicial junto con la visibilidad de los comentarios.
...
Esta configuración no determina si los comentarios se incluyen en exportaciones a PDF, HTML, imagen, notas o folletos. Configure las opciones específicas de exportación por separado.
...
**¿Puedo establecer distintas configuraciones de vista para diferentes secciones de una presentación?**  
...
Sí. Como las [view properties](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/presentation/#getViewProperties--) se almacenan a nivel de presentación, puede incrustarlas en una plantilla y crear nuevos documentos a partir de ella con la misma configuración de vista inicial.