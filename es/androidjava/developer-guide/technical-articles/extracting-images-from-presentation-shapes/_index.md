---
title: Extraer imágenes de las formas de presentación en Android mediante Java
linktitle: Imagen de la forma
type: docs
weight: 100
...
- Java
- Aspose.Slides
description: "Extraer imágenes de las formas en presentaciones PowerPoint y OpenDocument con Aspose.Slides para Android mediante Java: solución rápida y fácil de usar."
---
## **Descripción general**
...
Utilice este enfoque para imágenes insertadas como objetos independientes. Un [IPictureFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ipictureframe/) almacena su imagen en `getPictureFormat().getPicture().getImage()`, que devuelve un objeto [IPPImage](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ippimage/). Tenga en cuenta que [IVideoFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ivideoframe/) y [IAudioFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/iaudioframe/) derivan de [IPictureFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ipictureframe/), por lo que esta comprobación `instanceof` también coincide con los marcos de medios y exporta sus imágenes de vista previa; pruebe esos tipos primero cuando desee tratarlos por separado, como hace el último ejemplo de esta página.
...
Un [IVideoFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ivideoframe/) también puede almacenar una imagen de vista previa en `getPictureFormat().getPicture().getImage()`. Esta es la imagen de póster o miniatura que se muestra en la diapositiva, no un fotograma decodificado del flujo de vídeo.
...
Las formas [IZoomFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/izoomframe/) y [ISectionZoomFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/isectionzoomframe/) pueden usar imágenes personalizadas. Lea `getZoomImage()` del marco de zoom.
...
Un [ITable](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/itable/) es una forma. Las imágenes en una tabla suelen almacenarse como rellenos de imagen en las celdas de la tabla.
...
Un objeto [ISmartArt](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ismartart/) es una forma. Según el diseño de SmartArt, las imágenes pueden almacenarse en los rellenos de viñetas de los nodos o en los formatos de relleno de las formas de los nodos.
...
Las formas agrupadas contienen sus propias colecciones de formas. El método auxiliar compartido `enumerateShapes` tiene una opción `includeGroupedShapes`. Establécela en `true` cuando desee inspeccionar las formas dentro de objetos [IGroupShape](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/igroupshape/). El ejemplo a continuación extrae imágenes de marcos de imagen, formas rellenadas con imagen, vistas previas de objetos OLE, miniaturas de fotogramas de vídeo y miniaturas de fotogramas de audio. Para incluir también imágenes de tabla, gráfico, SmartArt y zoom de resumen, reutilice la lógica de extracción especializada de las secciones anteriores manteniendo el mismo recorrido recursivo de formas.
...
- **Imágenes duplicadas:** Varias formas pueden referenciar la misma imagen o imágenes distintas con bytes idénticos. Genere un hash con [IPPImage.getBinaryData](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ippimage/#getBinaryData--) antes de escribir los archivos si desea un archivo de salida por cada imagen única.
- **Datos originales vs. salida convertida:** Guardar [IPPImage.getBinaryData](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ippimage/#getBinaryData--) conserva los datos incrustados JPEG, PNG, GIF, SVG, EMF o WMF. Guardar [IPPImage.getImage](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ippimage/#getImage--) mediante [IImage.save](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/iimage/#save-java.lang.String-int-) es útil cuando se desea un formato de salida coherente.
- **Tipos de relleno no admitidos:** Las formas de relleno sólido, degradado, patrón o sin relleno no contienen un relleno de imagen. Verifique [FillType](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/filltype/) antes de leer `getPictureFillFormat()`.
- **Formas agrupadas:** La colección de formas de la diapositiva de nivel superior no aplana los grupos. Inspeccione recursivamente [IGroupShape.getShapes](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/igroupshape/#getShapes--) cuando el contenido agrupado sea relevante.
...
- **Miniaturas de fotogramas de vídeo:** Un [IVideoFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ivideoframe/) puede exponer una imagen de vista previa mediante `getPictureFormat()`, pero esa imagen es solo el póster que se muestra en la diapositiva. No se extrae del flujo de vídeo.
- **Miniaturas de fotogramas de audio:** Un [IAudioFrame](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/iaudioframe/) puede exponer un icono o miniatura mediante `getPictureFormat()`; no son los datos de audio incrustados.
...
- **Modelos de forma anidados:** Los objetos de tabla, gráfico y SmartArt implementan [IShape](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ishape/), pero sus imágenes a menudo se almacenan en objetos de formato anidados de celdas de tabla, elementos de gráfico o nodos de SmartArt.
...
Sí. Acceda al objeto [IPPImage](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ippimage/) y escriba [IPPImage.getBinaryData](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ippimage/#getBinaryData--) en disco. Esto conserva la imagen codificada original almacenada en la presentación, no la forma en que la imagen se representa en la diapositiva.
...
Los marcos de imagen, las formas rellenadas con imagen, los marcos de objetos OLE, los marcos de medios, los marcos de zoom, las tablas, los gráficos y los objetos SmartArt pueden referenciar imágenes. Algunos tipos de forma exponen imágenes a través de objetos de formato anidados, por lo que una simple comprobación `getPictureFormat()` o `getFillFormat()` de la forma no siempre es suficiente.

### ¿Puedo extraer la miniatura mostrada para un fotograma de vídeo?

Sí. Utilice [IVideoFrame.getPictureFormat](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ivideoframe/#getPictureFormat--) y lea `getPictureFormat().getPicture().getImage()`. Esto extrae la imagen de póster almacenada con el fotograma de vídeo, no un fotograma generado a partir del archivo de vídeo.

### ¿Cómo puedo determinar qué formas usan una imagen específica de la colección de imágenes de la presentación?

Aspose.Slides no almacena enlaces inversos de [IPPImage](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ippimage/) a las formas. Construya un mapeo durante el recorrido: cada vez que encuentre una referencia a una imagen, registre el número de diapositiva, la ruta de la forma y el hash de la imagen o el elemento de la colección.

### ¿Puedo extraer imágenes incrustadas dentro de objetos OLE, como documentos adjuntos?

Puede extraer la vista previa de la diapositiva del objeto OLE mediante [IOleObjectFrame.getSubstitutePictureFormat](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/ioleobjectframe/#getSubstitutePictureFormat--). Sin embargo, esa vista previa no es el documento incrustado en sí. Para extraer imágenes del interior del archivo incrustado, extraiga los datos OLE y examínelos con herramientas adecuadas para ese tipo de archivo.