...
type: docs
weight: 70
url: /es/androidjava/create-a-chart-in-a-microsoft-powerpoint-presentation/
---

{{% alert color="primary" %}} 

 Los gráficos son representaciones visuales de datos que se utilizan ampliamente en presentaciones. Este artículo muestra el código para crear un gráfico en Microsoft PowerPoint programáticamente utilizando [VSTO](/slides/es/androidjava/create-a-chart-in-a-microsoft-powerpoint-presentation/) y [Aspose.Slides for Android vía Java](/slides/es/androidjava/create-a-chart-in-a-microsoft-powerpoint-presentation/).

{{% /alert %}} 
## **Creación de un Gráfico**
Los ejemplos de código a continuación describen el proceso de agregar un gráfico de columnas agrupadas en 3D. Creas una instancia de presentación, le agregas un gráfico predeterminado. Luego usas un libro de Microsoft Excel para acceder y modificar los datos del gráfico junto con establecer las propiedades del gráfico. Por último, guardas la presentación.
### **Ejemplo de VSTO**
...
1. Acceder a la hoja de datos del gráfico usando la instancia de Microsoft Excel Workbook.
1. Establecer el rango del gráfico en la hoja de trabajo y eliminar las series 2 y 3 del gráfico.
1. Modificar los datos de la categoría del gráfico en la hoja de datos del gráfico.
...
1. Acceder al eje de valores del gráfico y establecer la unidad mayor, las unidades menores, el valor máximo y el valor mínimo.
1. Acceder a la profundidad del gráfico o al eje de la serie y eliminar eso ya que en este ejemplo, solo se utiliza una serie.
...
### **Ejemplo de Aspose.Slides for Android vía Java**
Usando Aspose.Slides for Android vía Java, se realizan los siguientes pasos:

1. Crear una instancia de una presentación de Microsoft PowerPoint.
1. Agregar una diapositiva en blanco a la presentación.
1. Agregar un gráfico de **columnas agrupadas en 3D** y acceder a ese.
1. Acceder a la hoja de datos del gráfico usando una instancia de Microsoft Excel Workbook.
