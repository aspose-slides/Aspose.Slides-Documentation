...
- Java
- Aspose.Slides
description: "Convierta presentaciones PPT heredadas a PPTX modernos rápidamente en Java con Aspose.Slides para Android — tutorial claro, ejemplos de código gratuitos, sin dependencia de Microsoft Office."
---
## **Visión general**

Este artículo explica cómo convertir una presentación de PowerPoint en formato PPT a formato PPTX usando Java y con la aplicación en línea de conversión de PPT a PPTX. Se cubren los siguientes temas.

- Convertir PPT a PPTX en Java

## **Convertir PPT a PPTX en Android**

Para obtener el código de ejemplo en Java que convierte PPT a PPTX, consulte la sección a continuación, es decir, [Convertir PPT a PPTX](#convert-ppt-to-pptx). Solo carga el archivo PPT y lo guarda en formato PPTX. Al especificar diferentes formatos de guardado, también puede guardar el archivo PPT en muchos otros formatos, como PDF, XPS, ODP, HTML, etc., como se discute en estos artículos.
...
- Convertir presentaciones que contienen texturas y estilos de relleno de imágenes para autoformas.
- Convertir presentaciones con marcadores de posición, marcos de texto y contenedores de texto.

{{% alert color="info" %}} 

Eche un vistazo a la aplicación [**Aspose.Slides PPT a PPTX Conversion**](https://products.aspose.app/slides/es/conversion/ppt-to-pptx):
...
Esta aplicación está construida sobre la [**API Aspose.Slides**](https://products.aspose.com/slides/es/androidjava/), por lo que puede ver un ejemplo activo de las capacidades básicas de conversión de PPT a PPTX. Aspose.Slides Conversion es una aplicación web que permite arrastrar un archivo de presentación en formato PPT y descargarlo convertido a PPTX.

Encuentre otros ejemplos activos de [**Aspose.Slides Conversion**](https://products.aspose.app/slides/es/conversion/).
{{% /alert %}} 

## **Convertir PPT a PPTX**
Aspose.Slides para Android mediante Java permite ahora a los desarrolladores acceder al PPT mediante la clase [Presentation](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/presentation) y convertirlo al formato [PPTX](https://docs.fileformat.com/presentation/pptx/). Actualmente, admite la conversión parcial de [PPT](https://docs.fileformat.com/presentation/ppt/) a PPTX.

Aspose.Slides para Android mediante Java ofrece la clase [Presentation](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/presentation) que representa un archivo de presentación **PPTX**. La clase Presentation ahora también puede acceder a **PPT** cuando el objeto se instancia. El siguiente ejemplo muestra cómo convertir una presentación PPT en una presentación PPTX.
...
El fragmento de código anterior genera la siguiente presentación PPTX tras la conversión
...
PPT es el formato binario antiguo utilizado por Microsoft PowerPoint, mientras que PPTX es el formato basado en XML más reciente introducido con Microsoft Office 2007. Los archivos PPTX ofrecen mejor rendimiento, tamaño de archivo reducido y recuperación de datos mejorada.

### ¿Aspose.Slides admite la conversión por lotes de varios archivos PPT a PPTX?

Sí, puede usar Aspose.Slides dentro de un bucle para convertir programáticamente varios archivos PPT a PPTX, lo que lo hace adecuado para escenarios de conversión por lotes.

### ¿Se preservarán el contenido y el formato tras la conversión?
...
Sí, Aspose.Slides admite la conversión de archivos PPT a [múltiples formatos](https://reference.aspose.com/slides/es/androidjava/com.aspose.slides/saveformat/), incluidos PDF, XPS, HTML, ODP y formatos de imagen como PNG y JPEG.
...
Sí, puede utilizar la aplicación web gratuita [Aspose.Slides PPT a PPTX Converter](https://products.aspose.app/slides/es/conversion/ppt-to-pptx) para realizar la conversión directamente en su navegador sin escribir código.