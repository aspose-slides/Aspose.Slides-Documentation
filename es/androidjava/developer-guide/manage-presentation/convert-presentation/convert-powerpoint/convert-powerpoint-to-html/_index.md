...
- Java
- Aspose.Slides
description: "Convierte presentaciones de PowerPoint a HTML responsivo en Java. Mantén el diseño, los enlaces y las imágenes con la guía de conversión de Aspose.Slides para Android, para obtener resultados rápidos y sin fallos."
---
...
Para ver el código de ejemplo en Java que convierte PowerPoint a HTML, consulte la sección a continuación, es decir, [Convertir PowerPoint a HTML](#convert-powerpoint-to-html). El código puede cargar varios formatos como PPT, PPTX y ODP en el objeto Presentation y guardarlo en formato HTML.
...
Usando su propia API, Aspose desarrolló convertidores gratuitos de presentación a HTML: [PPT a HTML](https://products.aspose.app/slides/conversion/ppt-to-html), [PPTX a HTML](https://products.aspose.app/slides/conversion/pptx-to-html), [ODP a HTML](https://products.aspose.app/slides/conversion/odp-to-html), etc. 
...
1. Utilice el [Save](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides.ISaveOptions-) método para guardar el objeto como un archivo HTML.
...
Aspose.Slides proporciona la clase [EmbedAllFontsHtmlController](https://reference.aspose.com/slides/androidjava/com.aspose.slides/EmbedAllFontsHtmlController) que le permite incrustar todas las fuentes en una presentación mientras la convierte a HTML.
...
La clase [EmbedAllFontsHtmlController](https://reference.aspose.com/slides/androidjava/com.aspose.slides/EmbedAllFontsHtmlController) admite herencia y proporciona el método [WriteFont](https://reference.aspose.com/slides/androidjava/com.aspose.slides/EmbedAllFontsHtmlController#writeFont-com.aspose.slides.IHtmlGenerator-com.aspose.slides.IFontData-com.aspose.slides.IFontData-java.lang.String-java.lang.String-byte:A-) que está destinado a sobrescribirse.
```java
...
Este código en Java muestra cómo generar HTML con imágenes a plena calidad:
```java
Presentation pres = new Presentation("InputDoc.pptx");
try {
    HtmlOptions htmlOpts = new HtmlOptions();
...
public class LinkAllFontsHtmlController extends EmbedAllFontsHtmlController
{
            ...
            byte[] fontData)
    {
        try {
            ...
            String path = fontName + ".woff"; // es posible que se necesite sanitizar la ruta
...
Usando Aspose.Slides for Android via Java, puede exportar archivos multimedia de esta manera:
