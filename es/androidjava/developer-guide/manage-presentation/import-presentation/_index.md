---
title: Importar presentaciones de PDF o HTML en Android
...
- Java
- Aspose.Slides
description: "Importe documentos PDF y HTML a presentaciones PowerPoint y OpenDocument en Java con Aspose.Slides para Android para un procesamiento de diapositivas sin interrupciones y de alto rendimiento."
---
...
Puede que quieras probar la aplicación web **Aspose free** [PDF a PowerPoint](https://products.aspose.app/slides/import/pdf-to-powerpoint) porque es una implementación en vivo del proceso descrito aquí. 
