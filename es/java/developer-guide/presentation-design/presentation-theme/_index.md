...
![colores de paleta adicional](additional-palette-colors.png)
...
Cuando trabajas con [SchemeColor](https://reference.aspose.com/slides/es/java/com.aspose.slides/schemecolor/), puedes notar que contiene los siguientes valores de color del tema:

`Background1`, `Background2`, `Text1` y `Text2`.

Sin embargo, `Presentation.getMasterTheme().getColorScheme()` devuelve [IColorScheme](https://reference.aspose.com/slides/es/java/com.aspose.slides/icolorscheme/), que expone los colores correspondientes como:
...
Quizá quieras ver [fuentes de PowerPoint](/slides/es/java/powerpoint-fonts/).
{{% /alert %}}
...
{{% alert color="info" title="TIP" %}} 
Quizá quieras ver [Fondo de PowerPoint](/slides/es/java/presentation-background/).
{{% /alert %}}
...
### ¿Puedo aplicar un tema a una sola diapositiva sin cambiar la master?

Sí. Aspose.Slides admite anulaciones de tema a nivel de diapositiva, por lo que puedes aplicar un tema local solo a esa diapositiva mientras mantienes intacto el tema master (a través del [SlideThemeManager](https://reference.aspose.com/slides/es/java/com.aspose.slides/slidethememanager/)).

### ¿Cuál es la forma más segura de trasladar un tema de una presentación a otra?

[Clonar diapositivas](/slides/es/java/clone-slides/) junto con su master en la presentación de destino. Esto preserva el master original, los diseños y el tema asociado, de modo que el aspecto sigue siendo consistente.

### ¿Cómo puedo ver los valores "efectivos" después de toda la herencia y anulaciones?

Utiliza las vistas ["efectivas"](/slides/es/java/shape-effective-properties/) de la API para tema/color/fuente/efecto. Estas devuelven las propiedades resueltas y finales después de aplicar el master más cualquier anulación local.