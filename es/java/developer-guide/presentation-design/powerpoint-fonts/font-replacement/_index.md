...
Para establecer reglas que determinen qué sucede en ciertas condiciones (si una fuente no puede ser accedida, por ejemplo), consulta [**Sustitución de fuentes**](/slides/es/java/font-substitution/). 
