...
Aspose.Slides for Java ofrece soporte para cambiar el color de las categorías en un color de serie.  
...
Sí. La tabla de datos admite [claves de leyenda](https://reference.aspose.com/slides/java/com.aspose.slides/datatable/#setShowLegendKey-boolean-), y puedes activarlas o desactivarlas.
...
Sí. Para cualquier gráfico cargado desde una presentación o plantilla existente, puedes verificar y cambiar si una tabla de datos [se muestra](https://reference.aspose.com/slides/java/com.aspose.slides/chart/#hasDataTable--) usando las propiedades del gráfico.

**¿Cómo puedo encontrar rápidamente qué gráficos en un archivo tienen la tabla de datos habilitada?**

Inspecciona la propiedad de cada gráfico que indica si la tabla de datos [se muestra](https://reference.aspose.com/slides/java/com.aspose.slides/chart/#hasDataTable--) e itera a través de las diapositivas para identificar los gráficos donde está habilitada.