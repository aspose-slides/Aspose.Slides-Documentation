...
- Java
- Aspose.Slides
description: "Descubra Aspose.Slides para Java: gestione sin esfuerzo los libros de trabajo de gráficos en formatos PowerPoint y OpenDocument para simplificar los datos de su presentación."
---
## **Resumen**
...
Para celdas de libros de trabajo que representan datos ausentes, consulte [Control the Display of Empty Cells](/slides/es/java/chart-series/) para conocer la diferencia entre una celda vacía y cero, y una comparación de gráficos de líneas de los modos de visualización disponibles.
...
Cuando reemplaza un libro de trabajo incrustado por uno modificado, el gráfico conserva sus colecciones originales de series y categorías. Esta inconsistencia puede provocar que [IChart.validateChartLayout](https://reference.aspose.com/slides/es/java/com.aspose.slides/ichart/#validateChartLayout--) lance una `ArgumentOutOfRangeException` (parámetro: index). Para evitar la excepción, limpie las series y categorías existentes **antes** de escribir el libro de trabajo actualizado de nuevo en el gráfico.
...
Limpiar las colecciones asegura que la estructura de datos del gráfico se alinee con el nuevo libro de trabajo, permitiendo que `validateChartLayout` se complete sin errores.
...
1. Añada un gráfico de burbuja con algunos datos.
1. Acceda a las series del gráfico.
1. Establezca la celda del libro de trabajo como una etiqueta de datos.
1. Guarde la presentación.

Este código Java le muestra cómo establecer una celda de libro de trabajo como etiqueta de datos del gráfico:
...
Utilizando el método **`setExternalWorkbook`**, puede asignar un libro de trabajo externo a un gráfico como su fuente de datos. Este método también puede usarse para actualizar la ruta al libro de trabajo externo (si este se ha movido).

Aunque no puede editar los datos en libros de trabajo almacenados en ubicaciones o recursos remotos, puede seguir utilizando dichos libros de trabajo como una fuente de datos externa. Si se proporciona una ruta relativa para un libro de trabajo externo, se convierte automáticamente en una ruta completa.
...
El segundo parámetro (`boolean`) del método `setExternalWorkbook` se utiliza para especificar si se cargará o no un libro de trabajo Excel. 
...
Sí, dichos libros de trabajo pueden utilizarse como una fuente de datos externa. No obstante, la edición de libros de trabajo remotos directamente desde Aspose.Slides no está soportada; solo pueden usarse como fuente.

**¿Aspose.Slides sobrescribe el XLSX externo al guardar la presentación?**

No. La presentación almacena un [enlace al archivo externo](https://reference.aspose.com/slides/es/java/com.aspose.slides/chartdata/#getExternalWorkbookPath--) y lo utiliza para leer los datos. El archivo externo en sí no se modifica cuando se guarda la presentación.

**¿Qué debo hacer si el archivo externo está protegido con contraseña?**

Aspose.Slides no acepta una contraseña al crear el enlace. Un enfoque común es quitar la protección con antelación o preparar una copia descifrada (por ejemplo, usando [Aspose.Cells](/cells/java/)) y enlazar a esa copia.
