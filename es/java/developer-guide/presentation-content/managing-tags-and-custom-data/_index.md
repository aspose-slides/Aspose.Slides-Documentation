...
Con una *diapositiva* como uno de los elementos en las presentaciones, una *parte de diapositiva* contiene el contenido de una sola diapositiva. A una parte de diapositiva se le permiten relaciones explícitas a muchas partes—como las Etiquetas definidas por el usuario—definidas por ISO/IEC 29500. 
...
## Añadiendo etiquetas a presentaciones
...
Este código de ejemplo muestra cómo agregar una etiqueta a una [Presentation](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation) usando Aspose.Slides para Java:
```java
Presentation pres = new Presentation("pres.pptx");
try {
...
Sí. La [tag collection](https://reference.aspose.com/slides/java/com.aspose.slides/tagcollection/) admite una operación [clear](https://reference.aspose.com/slides/java/com.aspose.slides/tagcollection/#clear--) que elimina todos los pares clave‑valor de una sola vez.
