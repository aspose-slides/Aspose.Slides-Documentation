...
- Java
- Aspose.Slides
description: "Aprenda cómo Aspose.Slides for Java utiliza ActiveX para automatizar y mejorar las presentaciones de PowerPoint, proporcionando a los desarrolladores un control potente sobre las diapositivas."
---
## **Introducción**

Los controles ActiveX se utilizan en presentaciones. Aspose.Slides for Java permite agregar y gestionar controles ActiveX, pero son un poco más complejos de manejar en comparación con las formas normales de la presentación. Hemos implementado soporte para agregar el control Active Media Player en Aspose.Slides. Tenga en cuenta que los controles ActiveX no son formas; no forman parte de la [IShapeCollection](https://reference.aspose.com/slides/es/java/com.aspose.slides/ishapecollection/). Forman parte de la [IControlCollection](https://reference.aspose.com/slides/es/java/com.aspose.slides/icontrolcollection/) por separado. En este artículo, le mostraremos cómo trabajar con ellos. 

## **Agregar un control ActiveX Media Player a una diapositiva**
Para agregar un control ActiveX Media Player, haga lo siguiente:

1. Cree una instancia de la clase [Presentation](https://reference.aspose.com/slides/es/java/com.aspose.slides/presentation) y genere una presentación vacía.
1. Acceda a la diapositiva objetivo en [Presentation](https://reference.aspose.com/slides/es/java/com.aspose.slides/presentation).
1. Agregue el control ActiveX Media Player usando el método [addControl](https://reference.aspose.com/slides/es/java/com.aspose.slides/IControlCollection#addControl-int-float-float-float-float-) expuesto por [IControlCollection](https://reference.aspose.com/slides/es/java/com.aspose.slides/icontrolcollection/).
...
Este código de ejemplo, basado en los pasos anteriores, muestra cómo agregar un control ActiveX Media Player a una diapositiva:
...
Aspose.Slides for Java 7.1.0 y versiones posteriores incluyen componentes para gestionar controles ActiveX. Puede acceder al control ActiveX ya añadido en su presentación y modificarlo o eliminarlo a través de sus propiedades.
...
1. Cree una instancia de la clase [Presentation](https://reference.aspose.com/slides/es/java/com.aspose.slides/presentation) y cargue la presentación que contiene los controles ActiveX.
1. Obtenga una referencia a la diapositiva por su índice.
1. Acceda a los controles ActiveX en la diapositiva mediante la [IControlCollection](https://reference.aspose.com/slides/es/java/com.aspose.slides/icontrolcollection/).
1. Acceda al control ActiveX TextBox1 usando el objeto [IControl](https://reference.aspose.com/slides/es/java/com.aspose.slides/icontrol/).
