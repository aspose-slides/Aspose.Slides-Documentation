...
- Java
- Aspose.Slides
description: "Domine el formato de párrafos con Aspose.Slides para Java—optimice la alineación, el espaciado y el estilo en presentaciones PPT, PPTX y ODP en Java."
---
...
* Aspose.Slides ofrece la interfaz [ITextFrame](https://reference.aspose.com/slides/java/com.aspose.slides/itextframe/) para permitirle añadir objetos que representan un párrafo. Un objeto `ITextFame` puede contener uno o varios párrafos (cada párrafo se crea mediante un retorno de carro).
* Aspose.Slides ofrece la interfaz [IParagraph](https://reference.aspose.com/slides/java/com.aspose.slides/iparagraph/) para permitirle añadir objetos que representan porciones. Un objeto `IParagraph` puede contener una o varias porciones (colección de objetos iPortions).
* Aspose.Slides ofrece la interfaz [IPortion](https://reference.aspose.com/slides/java/com.aspose.slides/iportion/) para permitirle añadir objetos que representan textos y sus propiedades de formato. 
...
4. Obtenga el ITextFrame asociado con el [IAutoShape](https://reference.aspose.com/slides/java/com.aspose.slides/iautoshape/).
5. Cree dos objetos [IParagraph](https://reference.aspose.com/slides/java/com.aspose.slides/iparagraph/) y añádalos a la colección `IParagraphs` del [ITextFrame](https://reference.aspose.com/slides/java/com.aspose.slides/itextframe/).
6. Cree tres objetos [IPortion](https://reference.aspose.com/slides/java/com.aspose.slides/iportion/) para cada nuevo `IParagraph` (dos objetos Portion para el párrafo predeterminado) y añada cada objeto `IPortion` a la colección IPortion de cada `IParagraph`.
7. Asigne algún texto a cada porción.
...
Las listas con viñetas le ayudan a organizar y presentar información de forma rápida y eficiente. Los párrafos con viñetas siempre son más fáciles de leer y entender.
...
9. Defina el `Indent` del párrafo para la viñeta.
...
Las listas con viñetas le ayudan a organizar y presentar información de forma rápida y eficiente. Los párrafos con imágenes son fáciles de leer y entender.
...
8. Establezca el tipo de viñeta a [Picture](https://reference.aspose.com/slides/java/com.aspose.slides/ippimage/) y asigne la imagen.
9. Asigne el `Text` al párrafo.
...
Las listas con viñetas le ayudan a organizar y presentar información de forma rápida y eficiente. Las viñetas multinivel son fáciles de leer y entender.
...
4. Acceda al [TextFrame](https://reference.aspose.com/slides/java/com.aspose.slides/itextframe/) de la autoshape. 
5. Elimine el párrafo predeterminado en el `TextFrame`.
6. Cree la primera instancia de párrafo a través de la clase [Paragraph](https://reference.aspose.com/slides/java/com.aspose.slides/paragraph/) y establezca la profundidad a 0.
...
4. Acceda al [TextFrame](https://reference.aspose.com/slides/java/com.aspose.slides/itextframe/) de la autoshape.
5. Elimine el párrafo predeterminado en el `TextFrame`.
6. Cree la primera instancia de párrafo a través de la clase [Paragraph](https://reference.aspose.com/slides/java/com.aspose.slides/paragraph/) y establezca [NumberedBulletStartWith](https://reference.aspose.com/slides/java/com.aspose.slides/ibulletformat/#setNumberedBulletStartWith-short-) en 2.
...
1. Agregue una [autoshape](https://reference.aspose.com/slides/java/com.aspose.slides/iautoshape/) rectangular a la diapositiva.
1. Añada un [TextFrame](https://reference.aspose.com/slides/java/com.aspose.slides/itextframe/) con tres párrafos al rectángulo autoshape.
1. Oculte las líneas del rectángulo.
1. Establezca la sangría para cada [Paragraph](https://reference.aspose.com/slides/java/com.aspose.slides/paragraph/) mediante su propiedad `BulletOffset`.
...
1. Agregue una [autoshape](https://reference.aspose.com/slides/java/com.aspose.slides/iautoshape/) rectangular a la diapositiva.
1. Añada un [TextFrame](https://reference.aspose.com/slides/java/com.aspose.slides/itextframe/) con dos párrafos al rectángulo.
1. Establezca `FontHeight` y el tipo de fuente para los párrafos.
1. Defina las propiedades de Fin para los párrafos.
...
2. Acceda a la referencia de la diapositiva correspondiente mediante su índice.
3. Agregue una [autoshape](https://reference.aspose.com/slides/java/com.aspose.slides/iautoshape/) a la diapositiva.
4. Añada y acceda al [ITextFrame](https://reference.aspose.com/slides/java/com.aspose.slides/itextframe/) de la autoshape.
5. Elimine el párrafo predeterminado en el `ITextFrame`.
6. Lea el archivo HTML origen en un `TextReader`.
7. Cree la primera instancia de párrafo a través de la clase [Paragraph](https://reference.aspose.com/slides/java/com.aspose.slides/paragraph/).
...
try {
    ...
    // Limpiar todos los párrafos del marco de texto agregado
...
4. Acceda al [TextFrame](https://reference.aspose.com/slides/java/com.aspose.slides/textframe/) de la forma.
...
try {
    ...
    // Escribiendo datos de los párrafos a HTML proporcionando el índice inicial del párrafo, total de párrafos a copiar
...
Sí. Utilice la configuración de ajuste del marco de texto ([setWrapText](https://reference.aspose.com/slides/java/com.aspose.slides/textframeformat/#setWrapText-byte-)) para desactivar el ajuste y que las líneas no se interrumpan en los bordes del marco.
