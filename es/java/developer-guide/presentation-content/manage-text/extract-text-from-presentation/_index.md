...
Para escanear texto de toda la presentación, utiliza el método estático [SlideUtil.getAllTextFrames](https://reference.aspose.com/slides/es/java/com.aspose.slides/slideutil/#getAllTextFrames-com.aspose.slides.IPresentation-boolean-) expuesto por la clase [SlideUtil](https://reference.aspose.com/slides/es/java/com.aspose.slides/slideutil/). Acepta dos parámetros:

1. Primero, un objeto [IPresentation](https://reference.aspose.com/slides/es/java/com.aspose.slides/ipresentation/) que representa una presentación de PowerPoint o OpenDocument de la que se extraerá el texto.  
...
El método devuelve una matriz de objetos del tipo [ITextFrame](https://reference.aspose.com/slides/es/java/com.aspose.slides/itextframe/), incluyendo información de formato del texto. El código a continuación escanea el texto y los detalles de formato de una presentación, incluidas las diapositivas maestras.
...
La clase [PresentationFactory](https://reference.aspose.com/slides/es/java/com.aspose.slides/presentationfactory/) también ofrece métodos para extraer todo el texto de presentaciones:
...
El argumento de enumeración [TextExtractionArrangingMode](https://reference.aspose.com/slides/es/java/com.aspose.slides/textextractionarrangingmode/) indica el modo para organizar el resultado de la extracción de texto y puede establecerse en los siguientes valores:

- `Unarranged` - El texto crudo sin consideración de su posición en la diapositiva.  
...
[IPresentationText](https://reference.aspose.com/slides/es/java/com.aspose.slides/ipresentationtext/) representa el texto crudo extraído de la presentación. Su método `getSlidesText` devuelve una matriz de objetos del tipo [ISlideText](https://reference.aspose.com/slides/es/java/com.aspose.slides/islidetext/). Cada objeto representa el texto de la diapositiva correspondiente. El objeto del tipo [ISlideText](https://reference.aspose.com/slides/es/java/com.aspose.slides/islidetext/) tiene los siguientes métodos:
