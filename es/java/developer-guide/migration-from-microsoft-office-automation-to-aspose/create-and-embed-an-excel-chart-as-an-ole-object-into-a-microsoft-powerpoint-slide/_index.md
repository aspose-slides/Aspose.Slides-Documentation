...
1. Copiar el gráfico de la hoja de cálculo de Excel al portapapeles.
1. Pegar el gráfico en la presentación de PowerPoint.
1. Colocar el gráfico en la diapositiva.
...
1. Incrustar el gráfico de Excel como un Objeto OLE dentro de la presentación PPTX utilizando Aspose.Slides para Java.
