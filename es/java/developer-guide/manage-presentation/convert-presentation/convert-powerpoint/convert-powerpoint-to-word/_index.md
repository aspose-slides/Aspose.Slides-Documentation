...
type: docs
weight: 110
url: /es/java/convert-powerpoint-to-word/
...
Puedes querer probar nuestro [**Convertidor de Presentación a Word en Línea**](https://products.aspose.app/slides/conversion/ppt-to-word) para ver qué podrías ganar al trabajar con contenido textual de las diapositivas.

{{% /alert %}} 

## **Aspose.Slides y Aspose.Words**

Para convertir un archivo de PowerPoint (PPTX o PPT) a Word (DOCX o DOC), necesitas tanto [Aspose.Slides para Java](https://products.aspose.com/slides/java/) como [Aspose.Words para Java](https://products.aspose.com/words/java/).
...
1. Descarga las bibliotecas [Aspose.Slides para Java](https://downloads.aspose.com/slides/java) y [Aspose.Words para Java](https://downloads.aspose.com/words/java).
