...
type: docs
weight: 70
url: /es/java/examples/elements/audio/
keywords:
- ejemplo de código
- audio
- PowerPoint
...
- Java
- Aspose.Slides
description: "Descubra ejemplos de audio de Aspose.Slides para Java: inserción, reproducción, recorte y extracción de sonido en presentaciones PPT, PPTX y ODP con código Java claro."
---
Este artículo muestra cómo incrustar marcos de audio y controlar la reproducción con **Aspose.Slides for Java**. Los siguientes ejemplos muestran operaciones básicas de audio.
