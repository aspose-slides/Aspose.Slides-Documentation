...
type: docs
weight: 140
url: /es/java/examples/elements/smart-art/
keywords:
- ejemplo de código
- SmartArt
- PowerPoint
...
- Java
- Aspose.Slides
description: "Trabaje con SmartArt en Aspose.Slides for Java: cree, edite, convierta y dé estilo a diagramas con Java para presentaciones de PowerPoint y OpenDocument."
---
Este artículo muestra cómo agregar gráficos SmartArt, acceder a ellos, eliminarlos y cambiar los diseños utilizando **Aspose.Slides for Java**.
