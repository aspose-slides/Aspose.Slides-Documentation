...
type: docs
weight: 230
url: /es/java/examples/elements/comment/
keywords:
- ejemplo de código
- comentario
- PowerPoint
...
- Java
- Aspose.Slides
description: "Trabaje con los comentarios de diapositivas en Aspose.Slides for Java: añada, responda, edite, resuelva y exporte comentarios en presentaciones PPT, PPTX y ODP con ejemplos de código Java."
---
Este artículo muestra cómo agregar, leer, eliminar y responder a comentarios modernos utilizando **Aspose.Slides for Java**.
