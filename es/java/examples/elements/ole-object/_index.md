...
type: docs
weight: 210
url: /es/java/examples/elements/ole-object/
keywords:
- ejemplo de código
- objeto OLE
- PowerPoint
...
- Java
- Aspose.Slides
description: "Manipule objetos OLE en Aspose.Slides para Java: inserte, vincule, actualice y extraiga contenido incrustado con Java en presentaciones PPT, PPTX y ODP."
---
Este artículo muestra cómo incrustar un archivo como un objeto OLE y actualizar sus datos usando **Aspose.Slides for Java**.
...
Recuperar el primer marco de objeto OLE en una diapositiva.
...
Eliminar un objeto OLE incrustado de la diapositiva.
...
Reemplazar los datos incrustados en un objeto OLE existente.
