...
type: docs
weight: 200
url: /es/java/examples/elements/activex/
keywords:
- ejemplo de código
- ActiveX
- PowerPoint
...
- Java
- Aspose.Slides
description: "Vea ejemplos de ActiveX de Aspose.Slides for Java: inserte, configure y controle objetos ActiveX en presentaciones PPT y PPTX con código Java claro."
---
Este artículo muestra cómo agregar, acceder, eliminar y configurar controles ActiveX en una presentación usando **Aspose.Slides for Java**.
...
static void addActiveX() {
    ...
    try {
        ...
        // Opcionalmente establezca algunas propiedades.
...
public static void setActiveXProperties() {
    ...
    try {
        ...
        // Agregar un control de Windows Media Player y configurar propiedades.
