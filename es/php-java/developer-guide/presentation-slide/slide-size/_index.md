...
{{% alert color="primary" %}} 
 ...
 Cuando usas Aspose.Slides para crear una presentación, todas las diapositivas en la presentación obtienen automáticamente el tamaño estándar o relación de aspecto 4:3.
