---
title: Administrar objetos de tinta de presentación en PHP
...
- PHP
- Aspose.Slides
description: "Administrar objetos de tinta de PowerPoint — crear, editar y dar estilo a la tinta digital con Aspose.Slides para PHP a través de Java. Obtén ejemplos de código para trazos, color y tamaño del pincel."
---
...
Aspose.Slides proporciona todos los tipos de Ink (por ejemplo, la clase [Ink](https://reference.aspose.com/slides/php-java/aspose.slides/ink/)) que necesita para crear y administrar objetos de tinta.
...
Este código PHP le muestra cómo establecer el color para un pincel:
```php
...
Este código PHP le muestra cómo establecer el tamaño para un pincel:
```php
  $pres = new Presentation("pres.pptx");
  try {
    $ink = $pres->getSlides()->get_Item(0)->getShapes()->get_Item(0);
...
* Para leer sobre formas en general, consulte la sección [PowerPoint Shapes](https://docs.aspose.com/slides/php-java/powerpoint-shapes/).
* Para obtener más información sobre valores efectivos, consulte [Shape Effective Properties](https://docs.aspose.com/slides/php-java/shape-effective-properties/#getting-effective-font-height-value).