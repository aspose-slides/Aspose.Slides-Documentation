...
- PHP
- Aspose.Slides
description: "Convierta presentaciones de PowerPoint y OpenDocument a PPTX, PDF, HTML, imágenes, XPS, TIFF y más con Aspose.Slides para PHP vía Java."
---
## **Visión general**

Aspose.Slides for PHP via Java puede cargar presentaciones de PowerPoint y OpenDocument y guardarlas o renderizarlas a muchos otros formatos sin Microsoft PowerPoint, OpenOffice o LibreOffice. Puede convertir archivos PPT heredados a PPTX modernos, exportar presentaciones a documentos de diseño fijo como PDF y XPS, publicar diapositivas como HTML, o renderizar diapositivas como archivos de imagen para vistas previas, miniaturas y archivos.
...
| PPTX a PPT | Guardar una presentación moderna de PowerPoint en el formato binario PPT antiguo para compatibilidad con flujos de trabajo más antiguos. | [Convertir PPTX a PPT](/slides/es/php-java/convert-pptx-to-ppt/) |
...
| PPT/PPTX/ODP a PDF con notas | Exportar notas del presentador junto con el contenido de la diapositiva. | [Convertir PowerPoint a PDF con notas](/slides/es/php-java/convert-powerpoint-to-pdf-with-notes/) |
...
| PPT/PPTX/ODP a HTML5 | Exportar diapositivas a HTML5 para visualización en el navegador con formato e interactividad preservados. | [Convertir presentaciones a HTML5](/slides/es/php-java/export-to-html5/) |
...
| PPT/PPTX/ODP a TIFF | Guardar una presentación como un archivo TIFF multipágina para impresión, escaneo, fax o flujos de trabajo de archivo. | [Convertir PowerPoint a TIFF](/slides/es/php-java/convert-powerpoint-to-tiff/) |
| PPT/PPTX/ODP a TIFF con notas | Guardar diapositivas con notas del presentador en TIFF. | [Convertir PowerPoint a TIFF con notas](/slides/es/php-java/convert-powerpoint-to-tiff-with-notes/) |
...
| PPT/PPTX a video | Construir un flujo de trabajo de exportación a vídeo a partir de diapositivas de la presentación. | [Convertir PowerPoint a Video](/slides/es/php-java/convert-powerpoint-to-video/) |
...
Aspose.Slides for PHP via Java admite la conversión a partir de formatos de presentación de uso común como PPT, PPTX, PPS, PPSX, POT, POTX y ODP. La misma API de conversión se utiliza para los archivos PowerPoint y OpenDocument, por lo que un flujo de trabajo que guarda un archivo PPTX a PDF normalmente puede aplicarse a un archivo ODP cambiando solo el archivo de entrada.
...
PPT es el formato binario más antiguo de PowerPoint, mientras que PPTX es el formato moderno Office Open XML. Aspose.Slides for PHP via Java admite la conversión de PPT a PPTX con alta fidelidad, preservando estructuras complejas de la presentación como maestros, diseños, diapositivas, gráficos, formas agrupadas, marcadores de posición, marcos de texto, texturas y rellenos de imagen.

Para obtener más información, consulte [Convertir PPT a PPTX](/slides/es/php-java/convert-ppt-to-pptx/) y [PPT vs PPTX](/slides/es/php-java/ppt-vs-pptx/).
...
La exportación a HTML y HTML5 es útil para la visualización en el navegador, la publicación web y el intercambio ligero. La exportación de imágenes es útil cuando cada diapositiva debe convertirse en una vista previa, miniatura o recurso rasterizado independiente. Utilice los artículos sobre PNG, JPG y SVG para obtener orientación específica del formato sobre el renderizado.
...
Sí. Cargue cada presentación, guárdela en el formato requerido y deseche el objeto de presentación después del procesamiento. Para procesamiento en paralelo, utilice instancias de presentación separadas y siga la guía de [multithreading](/slides/es/php-java/multithreading/).
...
Sí. Utilice la configuración de exportación de diapositivas ocultas descrita en los artículos de conversión de [PDF](/slides/es/php-java/convert-powerpoint-to-pdf/) y [XPS](/slides/es/php-java/convert-powerpoint-to-xps/).

**¿Puedo crear salida PDF/A?**

Sí. Hay configuraciones de cumplimiento de PDF disponibles para la exportación a PDF. Consulte [Convertir PowerPoint a PDF](/slides/es/php-java/convert-powerpoint-to-pdf/) para más detalles.

**¿Cómo se gestionan las fuentes durante la conversión?**

Aspose.Slides puede usar fuentes incrustadas, fuentes de respaldo y configuraciones de sustitución de fuentes. Consulte [Fuente incrustada](/slides/es/php-java/embedded-font/), [Fuente de respaldo](/slides/es/php-java/fallback-font/), y [Sustitución de fuentes](/slides/es/php-java/font-substitution/).