---
title: API Pública y Cambios Incompatibles con Versiones Anteriores en Aspose.Slides para PHP vía Java 15.10.0
type: docs
weight: 180
url: /es/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/
---

{{% alert color="primary" %}} 

Esta página lista todas las clases, métodos, propiedades, etc., [agregadas](/slides/es/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/) o [eliminadas](/slides/es/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/) y otros cambios introducidos con el API de Aspose.Slides para PHP vía Java 15.10.0.

{{% /alert %}} 
## **Cambios en la API Pública**
#### **Se ha agregado la API de animación de series de gráficos a ISequence**
Se han agregado 2 nuevos métodos a la interfaz com.aspose.slides.ISequence.
...
Animación por elementos de series:
...
Animación por elementos de categorías:
...
```
#### **Nueva clase com.aspose.slides.VideoPlayerHtmlController añadida para soportar la exportación de archivos multimedia a HTML**
Se ha añadido la nueva clase pública com.aspose.slides.VideoPlayerHtmlController. Utilizando la instancia de esta clase, el usuario puede exportar archivos de video y audio a HTML.

El constructor de VideoPlayerHtmlController acepta los siguientes parámetros:
