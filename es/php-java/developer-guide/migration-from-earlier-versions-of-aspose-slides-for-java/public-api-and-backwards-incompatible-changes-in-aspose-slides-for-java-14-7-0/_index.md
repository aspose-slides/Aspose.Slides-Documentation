...
Esta página enumera todas las [clases añadidas](/slides/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-14-7-0/), métodos, propiedades, etc., así como cualquier nueva restricción y otros cambios introducidos con el API de Aspose.Slides para PHP a través de Java 14.7.0.
