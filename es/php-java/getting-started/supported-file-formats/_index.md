...
Esta tabla contiene los formatos de archivo que Aspose.Slides para PHP a través de Java puede cargar y guardar:
...
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|Presentación de PowerPoint habilitada para macro|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|Presentación de PowerPoint habilitada para macro|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[POTM](https://docs.fileformat.com/presentation/potm/)|Plantilla de PowerPoint habilitada para macro|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
