...
Puede descargar fácilmente Aspose.Slides para evaluación. El paquete de evaluación es el mismo que el paquete adquirido. La versión de evaluación simplemente se vuelve licenciada después de agregar unas pocas líneas de código para aplicar la licencia. 
