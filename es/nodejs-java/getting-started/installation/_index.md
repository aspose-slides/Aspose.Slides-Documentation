...
- JavaScript
- Node.js
description: "Instalar Aspose.Slides para Node.js mediante Java en Windows, Linux o macOS"
---

Aspose.Slides para Node.js mediante Java es una API independiente de la plataforma y puede usarse en cualquier sistema (Windows, Linux y macOS) donde `Node.js` y el puente [`java`](https://www.npmjs.com/package/java) estén instalados.

## **Instalar desde NPM**

Puede instalar fácilmente Aspose.Slides para Node.js mediante Java desde [NPM](https://www.npmjs.com/).
...
3. Instale Aspose.Slides para Node.js mediante Java usando el siguiente comando:
	```
...
Para instalar y usar Aspose.Slides para Node.js mediante Java desde un archivo ZIP, siga estas instrucciones:

### **Windows**

1. Instale JDK8 y configure la variable de entorno `JAVA_HOME`.
1. Instale Node.js (https://nodejs.org/en/download/) y agregue node.exe a `PATH`.
1. Instale node-gyp.
...
1. Instale el puente [`java`](https://www.npmjs.com/package/java) y ejecute estos comandos en el Símbolo del sistema como administrador:
	...
	$ npm install java
	```
6. [Descargue Aspose.Slides para Node.js mediante Java](https://releases.aspose.com/slides/nodejs-java/) y extráigalo a `aspose.slides.nodejs/node_modules/aspose.slides.via.java`.
...
1. Instale el puente [`java`](https://www.npmjs.com/package/java). Puede ejecutar estos comandos en la terminal:
	...
	$ npm install java
	```
5. [Descargue Aspose.Slides para Node.js mediante Java](https://releases.aspose.com/slides/nodejs-java/) y extráigalo a `aspose.slides.nodejs/node_modules/aspose.slides.via.java`.
...
1. Modifique la sección JVMCapabilities en `/Library/Java/JavaVirtualMachines/jdk1.8.x_xxx.jdk/Contents/Info.plist` con privilegios de administrador. `jdk1.8.x_xxx.jdk` depende de su versión de JDK. Déjela como sigue:
	```xml
	<key>JavaVM</key>
		<dict>
...
6. Instale el puente [`java`](https://www.npmjs.com/package/java). Puede ejecutar los siguientes comandos en la terminal:
	...
	$ npm install java
	```
7. Descargue Aspose.Slides para Node.js mediante Java y extráigalo en `aspose.slides.nodejs/node_modules/aspose.slides.via.java`.
...
{{% alert color="primary" %}}
Utilice el siguiente [artículo](https://docs.aspose.com/slides/nodejs-java/troubleshooting-installation/) si encuentra errores de compilación durante la instalación de Aspose.Slides para Node.js mediante Java.
{{% /alert %}}
...
Sí, por defecto, Aspose.Slides se ejecuta en modo de evaluación, lo que coloca marcas de agua y puede tener otras limitaciones. Para eliminar las restricciones, debe aplicar una [licencia](/slides/es/nodejs-java/licensing/) válida.