...
- Node.js
- Aspose.Slides
description: "Exportar presentaciones PowerPoint y OpenDocument a HTML en JavaScript usando Aspose.Slides para Node.js a través de Java con imágenes y otros recursos guardados como archivos vinculados externos."
---
## **Visión general**
...
Para el flujo de trabajo general de conversión a HTML, consulte [Convert PowerPoint Presentations to HTML](/slides/es/nodejs-java/convert-powerpoint-to-html/). Este artículo se centra en la parte de vinculación de recursos de la exportación.
