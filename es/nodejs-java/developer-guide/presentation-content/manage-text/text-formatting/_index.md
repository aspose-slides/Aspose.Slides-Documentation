---
title: Formatear texto de la presentación en JavaScript
...
Use [ParagraphFormat.setAlignment](https://reference.aspose.com/slides/es/nodejs-java/aspose.slides/paragraphformat/#setAlignment-byte-) para establecer la alineación de párrafos dentro de un marco de texto. El valor puede ser centrado, alineado a la izquierda, a la derecha, justificado, etc.
...
Use [BasePortionFormat.setSpacing](https://reference.aspose.com/slides/es/nodejs-java/aspose.slides/baseportionformat/#setSpacing-float-) para expandir o contraer el espacio entre caracteres en un cuadro de texto.
...
Use [TextFrameFormat.setTextVerticalType](https://reference.aspose.com/slides/es/nodejs-java/aspose.slides/textframeformat/#setTextVerticalType-byte-) para establecer una orientación de texto predefinida dentro de una forma.
...
[TextFrameFormat.setAutofitType](https://reference.aspose.com/slides/es/nodejs-java/aspose.slides/textframeformat/#setAutofitType-byte-) determina cómo se comporta el texto cuando excede los límites de su contenedor. Utilícelo para controlar si el texto se reduce, desborda o redimensiona la forma automáticamente.
...
Use [ParagraphFormat.setDefaultTabSize](https://reference.aspose.com/slides/es/nodejs-java/aspose.slides/paragraphformat/#setDefaultTabSize-float-) y [ParagraphFormat.getTabs](https://reference.aspose.com/slides/es/nodejs-java/aspose.slides/paragraphformat/#getTabs--) para configurar las tabulaciones en un párrafo.
...
Use [LoadOptions.setDefaultTextLanguage](https://reference.aspose.com/slides/es/nodejs-java/aspose.slides/loadoptions/#setDefaultTextLanguage-java.lang.String-) para definir el idioma predeterminado para el texto creado al cargar o crear una presentación.
