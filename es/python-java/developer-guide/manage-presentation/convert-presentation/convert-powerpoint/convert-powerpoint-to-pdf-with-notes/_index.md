...
**¿Cómo puedo evitar que las notas del orador largas se corten?**
...
Utilice [NotesPositions.BottomTruncated](https://reference.aspose.com/slides/es/python-java/aspose.slides/notespositions/#BottomTruncated). Esta configuración limita las notas a una página, por lo que las notas que no quepan pueden truncarse.

**¿Cómo exporto diapositivas sin notas del orador?**

Omitir la configuración del diseño de notas y utilizar la exportación estándar a PDF descrita en [Convert PowerPoint to PDF](/slides/es/python-java/convert-powerpoint-to-pdf/).