...
- Java
- Aspose.Slides
description: "Convierta archivos PPT heredados a PPTX en Python con Aspose.Slides. Incluye ejemplos en Python para conversión de un solo archivo y por lotes, manejo de errores y notas de fidelidad."
---
## **Visión general**
...
Cada ejemplo inicia la máquina virtual Java si es necesario y libera la presentación después de su uso. Reemplace las rutas de ejemplo con sus propias rutas de archivo o de directorio.
...
La extensión del archivo no selecciona el formato de salida por sí sola; lo hace el argumento [SaveFormat.Pptx](https://reference.aspose.com/slides/es/python-java/aspose.slides/saveformat/#Pptx). Mantenga diferentes las rutas de entrada y salida si necesita conservar el archivo PPT original.

## **Convertir varios archivos PPT**

El siguiente ejemplo convierte cada archivo `.ppt` en un directorio. Cada archivo se procesa de manera independiente, por lo que una conversión fallida no detiene el resto del lote.
...
Para un archivo ocasional o una comparación rápida, puede usar el [online PPT to PPTX converter](https://products.aspose.app/slides/es/conversion/ppt-to-pptx). Para conversiones repetibles, procesamiento por lotes o manejo de errores a nivel de aplicación, utilice la API Python via Java.
...
- [Formatos de archivo admitidos](/slides/es/python-java/supported-file-formats/)
...
Sí, si proporciona la contraseña correcta al cargar el archivo. Una contraseña ausente o incorrecta provoca que la operación de carga falle.

**¿Debo eliminar el archivo PPT después de la conversión?**

Conserve el original hasta que haya verificado el PPTX en los visores y flujos de trabajo que le importan. Esto proporciona una copia de respaldo si una característica heredada se convierte de forma distinta.