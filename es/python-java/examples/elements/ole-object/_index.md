...
- Java
- Aspose.Slides
description: "Utilice Aspose.Slides for Python a través de Java para agregar, acceder, eliminar y actualizar objetos OLE en presentaciones de PowerPoint y OpenDocument."
---
Este artículo muestra cómo incrustar un archivo como objeto OLE y actualizar sus datos utilizando **Aspose.Slides for Python via Java**.
