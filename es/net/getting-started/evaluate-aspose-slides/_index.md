...
Puede descargar fácilmente Aspose.Slides para evaluación. El paquete de evaluación es idéntico al paquete adquirido. La versión de evaluación simplemente se convierte en licenciada después de agregar unas pocas líneas de código para aplicar la licencia. 
...
No. Aspose.Slides es un motor independiente y no requiere que PowerPoint esté instalado, ya sea para evaluación o producción.
