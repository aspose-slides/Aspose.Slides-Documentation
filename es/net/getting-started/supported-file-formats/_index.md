...
Esta tabla contiene los formatos de archivo que Aspose.Slides para .NET puede cargar y guardar:
...
|[XAML](https://docs.fileformat.com/web/xaml/)|Lenguaje de marcado de aplicación extensible| |{{< emoticons/tick >}}| |
