...
El siguiente ejemplo crea una presentación y la guarda en el formato Strict Office Open XML.
```cs
...
La propiedad [IPptxOptions.Zip64Mode](https://reference.aspose.com/slides/net/aspose.slides.export/ipptxoptions/zip64mode/) le permite elegir cuándo usar las extensiones del formato ZIP64 al guardar un archivo Office Open XML.
...
No. Cada guardado crea el archivo de destino completo; el “guardado rápido” incremental no está admitido.

**¿Es seguro guardar la misma instancia de Presentation desde varios subprocesos?**
...
**¿Qué ocurre con los hipervínculos y archivos vinculados externamente al guardar?**
