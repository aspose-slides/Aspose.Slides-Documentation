...
- C#
- Aspose.Slides
description: "Importa sin esfuerzo documentos PDF y HTML a presentaciones PowerPoint y OpenDocument en .NET con Aspose.Slides para un procesamiento de diapositivas sin problemas y de alto rendimiento."
---

Usando [**Aspose.Slides for .NET**](https://products.aspose.com/slides/net/), puede importar presentaciones desde archivos en otros formatos. Aspose.Slides proporciona la clase [SlideCollection](https://reference.aspose.com/slides/net/aspose.slides/slidecollection/) para permitirle importar presentaciones desde documentos PDF.
...
2. Llame al método [AddFromPdf](https://reference.aspose.com/slides/net/aspose.slides.slidecollection/addfrompdf/methods/1) y pase el archivo PDF. 
3. Utilice el método [Save](https://reference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) para guardar el archivo en formato PowerPoint.
...
Puede que desee probar la aplicación web **Aspose free** [PDF to PowerPoint](https://products.aspose.app/slides/import/pdf-to-powerpoint) porque es una implementación en vivo del proceso descrito aquí. 
{{% /alert %}} 
...
1. Cree una instancia de la clase [Presentation](https://reference.aspose.com/slides/net/aspose.slides/presentation/) . 
2. Llame al método [AddFromHtml](https://reference.aspose.com/slides/net/aspose.slides/slidecollection/addfromhtml/#addfromhtml) y pase el archivo HTML. 
3. Utilice el método [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) para guardar el archivo como documento PowerPoint.
