...
- C#
- Aspose.Slides
description: "Cree presentaciones en .NET con Aspose.Slides: genere archivos PPT, PPTX y ODP, aproveche la compatibilidad con OpenDocument y guárdelos programáticamente para obtener resultados fiables."
---
...
1. Cree una instancia de [Presentation](https://reference.aspose.com/slides/net/aspose.slides/presentation/) class con cualquier formato, por ejemplo PPT, PPTX, ODP, etc.
2. Guarde _Presentation_ en cualquier formato admitido por [SaveFormat](https://reference.aspose.com/slides/net/aspose.slides.export/saveformat/)
```c#
...
Sí. Las [firmas digitales](/slides/es/net/digital-signature-in-powerpoint/) (añadir y verificar) son compatibles con presentaciones.
