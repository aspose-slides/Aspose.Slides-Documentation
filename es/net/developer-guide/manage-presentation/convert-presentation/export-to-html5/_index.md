...
Este código C# muestra el proceso estándar de exportar PowerPoint a HTML:
```c#
using (Presentation pres = new Presentation("pres.pptx"))
{
...
Sí, HTML5 ofrece opciones separadas para habilitar o desactivar las [animaciones de formas](https://reference.aspose.com/slides/net/aspose.slides.export/html5options/animateshapes/) y las [transiciones de diapositivas](https://reference.aspose.com/slides/net/aspose.slides.export/html5options/animatetransitions/).
