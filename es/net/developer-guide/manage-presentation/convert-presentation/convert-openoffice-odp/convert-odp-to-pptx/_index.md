...
- C#
- Aspose.Slides
description: "Convertir ODP a PPTX con Aspose.Slides para .NET. Ejemplos de código C# claros, consejos para procesamiento por lotes y resultados de alta calidad—sin necesidad de PowerPoint."
---
...
Aspose.Slides para .NET ofrece la clase **Presentation** que representa un archivo de presentación. La clase [**Presentation**](https://reference.aspose.com/slides/net/aspose.slides/presentation) ahora también puede acceder a ODP mediante el constructor Presentation cuando se instancia el objeto. El siguiente ejemplo muestra cómo convertir una presentación ODP a una presentación PPTX.
