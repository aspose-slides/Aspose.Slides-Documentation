...
- C#
- Aspose.Slides
description: "Convertir presentaciones a folletos en .NET. Establecer diapositivas por página, mantener notas, exportar a PDF o imágenes con Aspose.Slides, con código de muestra en C#. Pruébalo gratis."
---
...
Aspose.Slides admite [preajustes](https://reference.aspose.com/slides/net/aspose.slides.export/handouttype/) hasta 9 miniaturas por página con ordenación horizontal o vertical: 1, 2, 3, 4 (horizontal/vertical), 6 (horizontal/vertical) y 9 (horizontal/vertical).
