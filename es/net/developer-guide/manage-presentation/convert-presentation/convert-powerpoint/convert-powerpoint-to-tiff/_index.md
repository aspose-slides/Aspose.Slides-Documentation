...
- .NET
- Aspose.Slides
description: "Aprenda cómo convertir fácilmente presentaciones de PowerPoint (PPT, PPTX) y OpenDocument (ODP) a imágenes TIFF de alta calidad usando Aspose.Slides para .NET. Guía paso a paso con ejemplos de código incluidos."
---
...
Este código C# demuestra cómo convertir la diapositiva a color en un TIFF en blanco y negro:
```cs
...
Consulta el [convertidor GRATUITO de PowerPoint a póster](https://products.aspose.app/slides/conversion/convert-ppt-to-poster-online) de Aspose.
{{% /alert %}}
