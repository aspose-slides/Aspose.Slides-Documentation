...
- C#
- Aspose.Slides
description: "Convertir presentaciones de PowerPoint a HTML responsivo en .NET. Conservar el diseño, los enlaces y las imágenes con la guía de conversión de Aspose.Slides para obtener resultados rápidos y sin errores."
---
...
Aspose.Slides proporciona muchas opciones—principalmente de la clase [**HtmlOptions**](https://reference.aspose.com/slides/net/aspose.slides.export/htmloptions)—que definen el proceso de conversión de PowerPoint (o OpenDocument) a HTML:
...
Con Aspose.Slides, puede convertir una presentación completa de PowerPoint u OpenDocument a HTML de la siguiente manera:
...
Al convertir una presentación de PowerPoint u OpenDocument a HTML con notas del presentador, es fundamental capturar la esencia completa del documento original. Este proceso asegura que no solo los elementos visuales de las diapositivas se representen con precisión, sino que también se conserven las notas del presentador, enriqueciendo el contenido con contexto e ideas adicionales.
...
Este código muestra cómo convertir una presentación de PowerPoint a HTML con notas del presentador en C#:
```c#
using (Presentation presentation = new Presentation("presentation.pptx"))
{
    // Establecer opciones para las notas del presentador.
...
Con los nuevos archivos de estilo CSS, puede cambiar fácilmente la apariencia del archivo HTML generado por el proceso de conversión de PowerPoint a HTML.
...
Este código C# muestra cómo convertir una presentación de PowerPoint a HTML enlazando todas las fuentes y excluyendo “Calibri” y “Arial” (ya que están instaladas en el sistema):
```c#
using (Presentation presentation = new Presentation("pres.pptx"))
{
