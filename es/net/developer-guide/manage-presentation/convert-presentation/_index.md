...
- C#
- Aspose.Slides
description: "Convierta presentaciones de PowerPoint y OpenDocument a PPTX, PDF, HTML, imágenes, XPS, TIFF y más con Aspose.Slides para .NET."
---
## **Visión general**
...
| PPTX a PPT | Guardar una presentación moderna de PowerPoint en el formato binario PPT más antiguo para compatibilidad con flujos de trabajo anteriores. | [Convertir PPTX a PPT](/slides/es/net/convert-pptx-to-ppt/) |
...
| PPT/PPTX/ODP a PDF con notas | Exportar notas del orador junto con el contenido de la diapositiva. | [Convertir PowerPoint a PDF con notas](/slides/es/net/convert-powerpoint-to-pdf-with-notes/) |
...
| PPT/PPTX/ODP a HTML5 | Exportar diapositivas a HTML5 para visualización basada en navegador con formato e interactividad preservados. | [Convertir presentaciones a HTML5](/slides/es/net/export-to-html5/) |
...
| PPT/PPTX/ODP a TIFF con notas | Guardar diapositivas con notas del orador en TIFF. | [Convertir PowerPoint a TIFF con notas](/slides/es/net/convert-powerpoint-to-tiff-with-notes/) |
...
| PPT/PPTX/ODP a XML | Crear una presentación PowerPoint XML basada en texto para inspección, comparación, solución de problemas o flujos de trabajo basados en XML. | [Convertir PowerPoint a XML](/slides/es/net/convert-powerpoint-to-xml/) |
| PPT/PPTX a GIF animado | Crear un GIF animado a partir de diapositivas. | [Convertir PowerPoint a GIF animado](/slides/es/net/convert-powerpoint-to-animated-gif/) |
| PPT/PPTX a video | Construir un flujo de trabajo de exportación a video a partir de diapositivas de presentación. | [Convertir PowerPoint a video](/slides/es/net/convert-powerpoint-to-video/) |
...
Al convertir archivos ODP, recuerde que las aplicaciones PowerPoint y OpenDocument no admiten cada diseño y característica de formato exactamente de la misma manera. Si un archivo ODP se creó en LibreOffice o OpenOffice Impress, revise la salida y utilice las opciones descritas en [Convertir presentaciones OpenDocument](/slides/es/net/convert-openoffice-odp/) cuando necesite orientación específica del formato.

## **Conversión de PPT a PPTX**

PPT es el formato binario antiguo de PowerPoint, mientras que PPTX es el formato moderno Office Open XML. Aspose.Slides for .NET admite la conversión de alta fidelidad de PPT a PPTX preservando estructuras complejas de la presentación como maestros, diseños, diapositivas, gráficos, formas agrupadas, marcadores de posición, marcos de texto, texturas y rellenos de imagen.
...
Sí. Cargue cada presentación, guárdela en el formato requerido y libere el objeto `Presentation` después del procesamiento. Para procesamiento en paralelo, utilice instancias de presentación separadas y siga la guía de [multithreading](/slides/es/net/multithreading/).
...
Sí. Utilice la propiedad `ShowHiddenSlides` en [PdfOptions](https://reference.aspose.com/slides/es/net/aspose.slides.export/pdfoptions/) o [XpsOptions](https://reference.aspose.com/slides/es/net/aspose.slides.export/xpsoptions/).
