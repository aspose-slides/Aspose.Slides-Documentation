---
title: Agregar marcas de agua a presentaciones en .NET
...
Puedes diseñar la marca de agua como desees; sin embargo, suelen existir características comunes en las marcas de agua, como alineación centrada, rotación, posición frontal, etc. Consideraremos cómo usar estas opciones en los ejemplos a continuación.

## **Marca de agua de texto**

### **Agregar una marca de agua de texto a una diapositiva**

Para agregar una marca de agua de texto en PPT, PPTX o ODP, puedes primero añadir una forma a la diapositiva y, a continuación, añadir un marco de texto a esa forma. El marco de texto está representado por la interfaz [ITextFrame](https://reference.aspose.com/slides/es/net/aspose.slides/itextframe). Este tipo no hereda de [IShape](https://reference.aspose.com/slides/es/net/aspose.slides/ishape/), que dispone de un amplio conjunto de propiedades para posicionar la marca de agua de forma flexible. Por ello, el objeto [ITextFrame](https://reference.aspose.com/slides/es/net/aspose.slides/itextframe) se envuelve en un objeto [IAutoShape](https://reference.aspose.com/slides/es/net/aspose.slides/iautoshape/) . Para añadir texto de marca de agua a la forma, usa el método [AddTextFrame](https://reference.aspose.com/slides/es/net/aspose.slides/iautoshape/methods/addtextframe) como se muestra a continuación.
...
// Añadir la marca de agua a la diapositiva.
...
// Añadir la marca de agua a la diapositiva maestra.
...
Por defecto, la forma rectangular tiene colores de relleno y de línea. Esto significa que, cuando se añade la marca de agua, puede aparecer con un fondo sólido o un borde que potencialmente distraiga del contenido de la diapositiva. Para asegurarte de que la marca de agua permanezca discreta y no interfiera con el diseño visual de la presentación, puedes hacer que la forma sea completamente transparente.

Las siguientes líneas de código hacen que la forma sea transparente al eliminar tanto su color de relleno como el del borde:
...
Antes de aplicar la marca de agua de texto a tu diapositiva, es importante personalizar su apariencia para que armonice con el diseño general. Puedes cambiar el tipo y el tamaño de la fuente para garantizar que la marca de agua sea legible y estéticamente agradable. Personalizar la fuente también ayuda a reforzar la identidad de marca o simplemente a adaptar el estilo a la presentación.

El fragmento de código a continuación muestra cómo ajustar la configuración de fuente de la marca de agua seleccionando una fuente latina específica y estableciendo una altura de fuente apropiada:
...
Antes de aplicar tu marca de agua, es fundamental asegurarse de que el color del texto esté configurado adecuadamente para que se mezcle bien con el contenido de la diapositiva sin sobrecargarlo. Ajustar la transparencia (alfa) del color junto con los componentes rojo, verde y azul permite crear una marca de agua sutil, semi‑transparente, visible pero discreta. Este enfoque ayuda a mantener la atención en la presentación principal mientras protege tu contenido.
...
Centrar correctamente tu marca de agua de texto puede mejorar significativamente la estética general de tu presentación al garantizar que la marca de agua esté posicionada de forma simétrica, sin importar las dimensiones de la diapositiva. Este enfoque no solo aporta un aspecto profesional a tus diapositivas, sino que también asegura que la marca de agua no interfiera con el contenido principal.

El fragmento de código a continuación muestra cómo calcular la posición central de una diapositiva y colocar la marca de agua de texto en consecuencia:
...
En muchos casos, una marca de agua de imagen puede proporcionar un elemento de marca único o una alternativa visualmente más atractiva que una marca de agua de texto. Antes de añadir la marca de agua, asegúrate de que el archivo de imagen esté disponible (p.ej., PNG para transparencia). El siguiente ejemplo muestra cómo cargar una imagen desde el sistema de archivos, añadirla a la presentación y luego aplicarla como marca de agua mediante las propiedades de relleno de la forma.
...
Si es necesario impedir que una marca de agua sea editada, usa la propiedad [IAutoShape.ShapeLock](https://reference.aspose.com/slides/es/net/aspose.slides/iautoshape/properties/shapelock) de la forma. Con esta propiedad, puedes proteger la forma contra la selección, el cambio de tamaño, el reposicionamiento, la agrupación con otros elementos, bloquear su texto contra la edición y mucho más:
...
En Aspose.Slides, el orden Z de las formas puede establecerse mediante el método [IShapeCollection.Reorder](https://reference.aspose.com/slides/es/net/aspose.slides/ishapecollection/reorder/#reorder). Para hacerlo, debes llamar a este método desde la lista de diapositivas de la presentación y pasar la referencia de la forma y su número de orden al método. De esta manera, es posible traer una forma al frente o enviarla al fondo de la diapositiva. Esta funcionalidad es especialmente útil si necesitas colocar una marca de agua delante del contenido de la presentación:
...
Ajustar la rotación de tu marca de agua puede mejorar significativamente el impacto visual y la sutileza de tu presentación. Una marca de agua diagonal, por ejemplo, puede resultar menos invasiva mientras sigue ofreciendo una protección robusta contra el uso no autorizado. El siguiente ejemplo calcula el ángulo apropiado basándose en las dimensiones de la diapositiva para que la marca de agua quede posicionada diagonalmente a lo largo de la diapositiva. Este cálculo dinámico garantiza que la marca de agua siga siendo eficaz sin importar los tamaños de diapositiva variables.
...
Aspose.Slides permite establecer el nombre de una forma. Al usar el nombre de la forma, puedes acceder a ella en el futuro para modificarla o eliminarla. Para asignar un nombre a la forma de la marca de agua, establézcalo en la propiedad [IAutoShape.Name](https://reference.aspose.com/slides/es/net/aspose.slides/ishape/properties/name):
...
Puedes probar las herramientas en línea gratuitas de **Aspose.Slides** [Agregar marca de agua](https://products.aspose.app/slides/es/watermark) y [Eliminar marca de agua](https://products.aspose.app/slides/es/watermark/remove-watermark).
...
Puedes ajustar la transparencia de la marca de agua modificando la configuración de relleno ([FillFormat](https://reference.aspose.com/slides/es/net/aspose.slides/shape/fillformat/)) de la forma. Esto asegura que la marca de agua sea sutil y no distraiga del contenido de la diapositiva.
