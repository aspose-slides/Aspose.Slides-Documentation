---
title: Gestionar gráficos SmartArt en presentaciones con .NET
...
- C#
- Aspose.Slides
description: "Automatice la creación, edición y estilo de SmartArt en PowerPoint con .NET usando Aspose.Slides, con ejemplos de código concisos y orientación centrada en el rendimiento."
---
...
Sí. SmartArt es una forma, por lo que puede aplicar [animaciones estándar](/slides/es/net/powerpoint-animation/) a través de la API de animaciones (entrada, salida, énfasis, rutas de movimiento) al igual que con otras formas.
