...
- C#
- Aspose.Slides
description: "Aprenda cómo exportar gráficos de presentación con Aspose.Slides para .NET, compatible con los formatos PPT y PPTX, y simplifique la generación de informes en cualquier flujo de trabajo."
---
...
Sí. Un gráfico es una forma, y su contenido se puede guardar en SVG utilizando el [método de guardado shape-to-SVG](https://reference.aspose.com/slides/net/aspose.slides/shape/writeassvg/).
...
[Cargue las fuentes necesarias](/slides/es/net/custom-font/) mediante [FontsLoader](https://reference.aspose.com/slides/net/aspose.slides/fontsloader/) para que el renderizado del gráfico conserve las métricas y la apariencia del texto.
