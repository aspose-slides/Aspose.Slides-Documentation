...
- [**Creando gráfico Sunburst**](/slides/es/net/adding-charts/#addingcharts-creatingsunburstchart)
{{% /alert %}}
...
Sí. Después de validar la disposición del gráfico, `ActualX`/`ActualY` están disponibles para los elementos (por ejemplo, una [DataLabel](https://reference.aspose.com/slides/net/aspose.slides.charts/datalabel/)), lo que ayuda a posicionar con precisión las superposiciones.