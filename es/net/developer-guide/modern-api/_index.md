...
Tenga en cuenta que IImage es desechable (implementa la interfaz IDisposable y su uso debe envolver‑se en using o liberarse de otra forma conveniente).
...
## **El soporte de la API para Graphics y PrinterSettings será descontinuado**

La clase [Graphics](https://learn.microsoft.com/en-us/dotnet/api/system.drawing.graphics) no se admite para versiones multiplataforma de .NET6 y superiores. En Aspose Slides, la parte de la API que la usa será eliminada:
