...
- C#
- Aspose.Slides
description: "Modernice el procesamiento de imágenes de diapositivas reemplazando las API de imágenes obsoletas con la API moderna de .NET para una automatización fluida de PowerPoint y OpenDocument."
---

## **Introducción**

Históricamente, Aspose Slides tiene una dependencia de System.Drawing y en la API pública contiene las siguientes clases:
...
Dado que el soporte de System.Drawing en las versiones .NET6 y superiores se elimina para versiones que no son Windows ([cambio crítico](https://learn.microsoft.com/en-us/dotnet/core/compatibility/core-libraries/6.0/system-drawing-common-windows-only)), Slides ha implementado un enfoque de dos versiones de biblioteca:
...
- Aspose.Slides.IImage – representa la imagen raster o vector.
...
Tenga en cuenta que IImage es desechable (implementa la interfaz IDisposable y su uso debe envolver‑se en using o disponer‑se de otra forma conveniente).
...
{
    IPPImage ppImage;
    // instanciar una instancia desechable de IImage del archivo en el disco.  
...
## **Reemplazar código antiguo con API moderna**

Para facilitar la transición, la interfaz de la nueva IImage repite las firmas separadas de las clases Image y Bitmap. En general, solo deberá reemplazar la llamada al método antiguo que usa System.Drawing por la nueva.
...
## **El soporte de la API para Graphics y PrinterSettings será discontinuado**

La clase [Graphics](https://learn.microsoft.com/en-us/dotnet/api/system.drawing.graphics) no es compatible con versiones multiplataforma de .NET6 y superiores. En Aspose Slides, la parte de la API que la utiliza se eliminará:
