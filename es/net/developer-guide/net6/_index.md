...
A partir de [Aspose.Slides 23.2](https://www.nuget.org/packages/Aspose.Slides.NET/23.2.0), se implementó soporte para .NET6. La peculiaridad de este soporte es que .NET6 ya no admite System.Drawing.Common en Linux ([cambio importante](https://learn.microsoft.com/en-us/dotnet/core/compatibility/core-libraries/6.0/system-drawing-common-windows-only)) y Slides implementa este subsistema gráfico por sí mismo como un componente C++.

Aspose.Slides para .NET ahora funciona sin dependencias de GDI/libgdiplus en:
* Windows
* Linux

_El soporte para _MacOS_ está en progreso._

## Usar Slides para .NET6 en AWS y Azure

.NET6 es la versión preferida para Aspose.Slides utilizada en la nube (AWS, Azure u otras soluciones en la nube).

Anteriormente, cuando Aspose.Slides se usaba en un host Linux, había que instalar dependencias adicionales (libgdiplus) y esto a menudo resultaba inconveniente o poco práctico (por ejemplo, al usar [AWS Lambda](https://aws.amazon.com/lambda)). Con Slides para .NET6, esas dependencias ya no son necesarias, por lo que la implementación es mucho más fácil.

Otro factor a considerar son los problemas que surgían cuando Aspose.Slides se utilizaba en una solución en la nube con un host Windows. Por ejemplo, [Azure Functions](https://learn.microsoft.com/en-us/azure/azure-functions/functions-overview) tienen limitaciones para el proceso y generan problemas durante una operación de exportación a PDF (ver [esto](https://github.com/projectkudu/kudu/wiki/Azure-Web-App-sandbox#unsupported-frameworks)). El uso de Aspose.Slides para .NET6 resuelve este problema.

## Usar el paquete System.Drawing.Common y las clases de Slides para .NET6 (error CS0433: El tipo existe tanto en Slides como en System.Drawing.Common)
...
A partir de la versión 24.8, la API pública obsoleta con dependencias de System.Drawing ha sido eliminada. En cuanto al ejemplo de código anterior, puedes obtener la imagen de la diapositiva de la siguiente manera.
```cs
