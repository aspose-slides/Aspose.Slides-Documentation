...
type: docs
weight: 10
url: /es/net/object-changed-issue-when-adding-oleobjectframe/
---
...
Para obtener más información sobre cómo trabajar con objetos OLE, consulta [Gestionar OLE](/slides/es/net/manage-ole/). 
