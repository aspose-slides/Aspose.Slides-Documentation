...
- C#
- Aspose.Slides
description: "Aprenda a redimensionar rápidamente las diapositivas en archivos PPT, PPTX y ODP con .NET y Aspose.Slides, optimice las presentaciones para cualquier pantalla sin perder calidad."
---
## **Introducción**

Aspose.Slides para .NET ofrece herramientas completas para ajustar el tamaño de la diapositiva y la relación de aspecto en presentaciones de PowerPoint, algo crucial tanto para la impresión como para la visualización en pantalla.

Tamaños de diapositivas y relaciones de aspecto populares:
...
## **Gestionar el contenido de la diapositiva tras el cambio de tamaño**
