---
title: Personalizar tamaño de diapositiva
linktitle: Tamaño de diapositiva
type: docs
weight: 70
url: /es/net/slide-size/
keywords: "Establecer tamaño de diapositiva, personalizar dimensiones de la presentación, relación de aspecto de PowerPoint, C#, Csharp, .NET, Aspose.Slides"
description: "Aprenda cómo personalizar y ajustar tamaños de diapositiva o relaciones de aspecto en PowerPoint usando C# o .NET con Aspose.Slides."
---

## **Personalización de tamaños de diapositivas y relaciones de aspecto en PowerPoint**

Aspose.Slides for .NET ofrece herramientas completas para ajustar el tamaño de la diapositiva y la relación de aspecto en presentaciones de PowerPoint, lo que es fundamental tanto para la impresión como para la visualización en pantalla. 

### **Tamaños de diapositiva y relaciones más populares**

- **Estándar (relación de aspecto 4:3)**: Ideal para pantallas y dispositivos más antiguos.
  
- **Panorámica (relación de aspecto 16:9)**: Recomendada para proyectores y pantallas modernas.
...
Ajustar el tamaño de la diapositiva a sus necesidades específicas, como diseños de papel únicos o especificaciones de pantalla, puede ser beneficioso. A continuación se muestra cómo establecer un tamaño de diapositiva personalizado con Aspose.Slides para .NET:
```csharp
...
## **Manejo del contenido de la diapositiva después de cambiar el tamaño**

Después de cambiar el tamaño, el contenido de la diapositiva puede distorsionarse. Puede controlar cómo Aspose.Slides gestiona este cambio de tamaño:
...
- **`Maximize`**: Ampliar los objetos para que se ajusten a diapositivas más grandes, manteniendo la consistencia estética.
...
No puedes [combinar presentaciones](/slides/es/net/merge-presentation/) mientras tengan diferentes tamaños de diapositiva — primero, redimensiona una presentación para que coincida con la otra. Al cambiar el tamaño de la diapositiva, puedes elegir cómo se maneja el contenido existente mediante la opción [SlideSizeScaleType](https://reference.aspose.com/slides/net/aspose.slides/slidesizescaletype/). Después de alinear los tamaños, puedes combinar diapositivas preservando el formato.
