...
- C#
- Aspose.Slides
description: "Convertir diapositivas de PPT, PPTX y ODP a imágenes en C# usando Aspose.Slides para .NET—rápida, renderización de alta calidad con ejemplos de código claros."
---
## **Introducción**
...
1. Defina la configuración de conversión deseada y seleccione las diapositivas que desea exportar mediante:
    - La interfaz [ITiffOptions](https://reference.aspose.com/slides/es/net/aspose.slides.export/itiffoptions/), o
    - La interfaz [IRenderingOptions](https://reference.aspose.com/slides/es/net/aspose.slides.export/irenderingoptions/).
2. Genere la imagen de la diapositiva llamando al método [GetImage](https://reference.aspose.com/slides/es/net/aspose.slides/islide/getimage/).

En .NET, un [Bitmap](https://docs.microsoft.com/en-us/dotnet/api/system.drawing.bitmap?view=net-5.0) es un objeto que le permite trabajar con imágenes definidas por datos de píxeles. Puede utilizar una instancia de esta clase para guardar imágenes en una amplia gama de formatos (BMP, JPG, PNG, etc.).
...
Puede que necesite obtener una imagen de un tamaño determinado. Utilizando una sobrecarga del método [GetImage](https://reference.aspose.com/slides/es/net/aspose.slides/islide/getimage/), puede convertir una diapositiva a una imagen con dimensiones específicas (ancho y alto). 
...
Aspose.Slides proporciona dos interfaces—[ITiffOptions](https://reference.aspose.com/slides/es/net/aspose.slides.export/itiffoptions/) y [IRenderingOptions](https://reference.aspose.com/slides/es/net/aspose.slides.export/irenderingoptions/)—que le permiten controlar la representación de las diapositivas de la presentación en imágenes. Ambas interfaces incluyen la propiedad `SlidesLayoutOptions`, que le permite configurar la representación de notas y comentarios en una diapositiva al convertirla en una imagen.

Con la clase [NotesCommentsLayoutingOptions](https://reference.aspose.com/slides/es/net/aspose.slides.export/notescommentslayoutingoptions/) puede especificar la posición que prefiera para las notas y los comentarios en la imagen resultante.
...
En cualquier proceso de conversión de diapositiva a imagen, la propiedad [NotesPosition](https://reference.aspose.com/slides/es/net/aspose.slides.export/inotescommentslayoutingoptions/notesposition/) no puede establecerse en `BottomFull` (para especificar la posición de las notas) porque el texto de una nota puede ser demasiado largo, lo que impide que quepa dentro del tamaño de imagen especificado.
{{% /alert %}} 

## **Convertir diapositivas a imágenes usando opciones TIFF**

La interfaz [ITiffOptions](https://reference.aspose.com/slides/es/net/aspose.slides.export/itiffoptions/) ofrece un mayor control sobre la imagen TIFF resultante al permitir especificar parámetros como el tamaño, la resolución, la paleta de colores y más.
...
Este código de ejemplo muestra cómo convertir todas las diapositivas de una presentación a imágenes en C#:
...
{{% alert title="Note" color="warning" %}} 
Para renderizar correctamente los emojis en color al convertir diapositivas de presentación a imágenes, las fuentes emoji utilizadas en la presentación deben estar instaladas y disponibles en el sistema que realiza la conversión. Por ejemplo, si la presentación utiliza **Segoe UI Emoji** y esa fuente falta, los emojis pueden aparecer en monocromo en las imágenes de salida.
{{% /alert %}}
...
Sí, las diapositivas ocultas pueden procesarse como las normales. Simplemente asegúrese de que estén incluidas en el bucle de procesamiento.

**¿Se pueden guardar las imágenes con sombras y efectos?**

Sí, Aspose.Slides admite el renderizado de sombras, transparencia y otros efectos gráficos al guardar diapositivas como imágenes.