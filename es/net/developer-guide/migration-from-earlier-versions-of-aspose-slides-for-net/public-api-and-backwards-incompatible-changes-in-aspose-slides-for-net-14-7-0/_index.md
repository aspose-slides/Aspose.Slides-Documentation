---
title: Cambios en la API pública y incompatibles hacia atrás en Aspose.Slides para .NET 14.7.0
...
Los constructores de algunos subtipos de TransitionValueBase (específicamente CornerDirectionTransition, EightDirectionTransition, EmptyTransition, InOutTransition, OptionalBlackTransition, OrientationTransition, SideDirectionTransition, SplitTransition, WheelTransition) son inútiles en la API pública y por ello se han eliminado. 
...
La enumeración Aspose.Slides.SlideShow.TransitionPattern se utiliza en esta clase y especifica un patrón geométrico que se repite para cubrir un área mayor.
