---
title: Cambios de API pública y de incompatibilidad retroactiva en Aspose.Slides para .NET 14.8.0
...
#### **Añadida la interfaz IVbaProject, modificada la propiedad Presentation.VbaProject**
...
Utilice la propiedad IVbaProject para administrar los proyectos VBA incrustados en una presentación. Puede agregar nuevas referencias de proyecto, editar módulos existentes y crear nuevos.

Además, puede crear un nuevo proyecto VBA usando la clase VbaProject que implementa la interfaz IVbaProject.
...
La propiedad Aspose.Slides.Charts.IChartSeries.Overlap especifica cuánto se solapan las barras y columnas en los gráficos 2D (rango de -100 a 100).

Esta propiedad no solo pertenece a esta serie sino a todas las series del grupo de series padre; es una proyección de la propiedad del grupo correspondiente. Por lo tanto, esta propiedad es de solo lectura.
...
La propiedad Aspose.Slides.Charts.IChartSeriesGroup.Overlap especifica cuánto se solapan las barras y columnas en los gráficos 2D (de -100 a 100).
...
Este método de creación de miniaturas de forma le permite generar una miniatura dentro de los límites de su apariencia. Tiene en cuenta todos los efectos de la forma. La miniatura generada está restringida por los límites de la diapositiva.
