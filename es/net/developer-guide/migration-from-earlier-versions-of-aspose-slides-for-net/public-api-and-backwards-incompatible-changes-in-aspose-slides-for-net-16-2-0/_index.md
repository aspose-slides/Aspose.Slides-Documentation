...
#### **Las propiedades UpdateDateTimeFields y UpdateSlideNumberFields se han eliminado**
...
CategoryAxisType.Auto - el tipo de eje de categoría se determinará automáticamente durante la serialización (este comportamiento no está implementado aún)
...
El argumento enum ExtractionMode indica el modo de organizar la salida del resultado de texto y puede establecerse en los siguientes valores:
...
El nuevo API puede usarse de la siguiente manera:
...
La interfaz Aspose.Slides.ILegacyDiagram y la clase Aspose.Slides.LegacyDiagram se han añadido para representar objetos de diagramas heredados. El objeto de diagrama heredado es un formato antiguo de diagramas de PowerPoint 97-2003.
...
JustifyLow - Justificación baja tipo Kashida.
