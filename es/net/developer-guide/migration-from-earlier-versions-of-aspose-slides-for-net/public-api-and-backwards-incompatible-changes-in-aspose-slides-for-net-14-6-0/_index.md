...
Representa barras de error de series de gráficos.
...
``` 
#### **Añadido el enum ViewType, la interfaz IViewProperties, la clase ViewProperties y la propiedad IPresentation.ViewProperties**
