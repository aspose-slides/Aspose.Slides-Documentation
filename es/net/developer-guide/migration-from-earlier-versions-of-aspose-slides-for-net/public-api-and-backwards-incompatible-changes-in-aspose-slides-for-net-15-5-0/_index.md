...
#### **Clase CommonSlideViewProperties y la interfaz ICommonSlideViewProperties se han añadido**
...
Cambiar esta propiedad puede producir una cierta influencia solo en estas partes del gráfico: DataLabel y DataLabelFormat (soporte completo en PowerPoint 2013; en PowerPoint 2007 no tiene efecto en la renderización).
...
Cambiar estas propiedades puede producir una cierta influencia solo en estas partes del gráfico: DataLabel y DataLabelFormat (soporte completo en PowerPoint 2013; en PowerPoint 2007 no tiene efecto en la renderización).
