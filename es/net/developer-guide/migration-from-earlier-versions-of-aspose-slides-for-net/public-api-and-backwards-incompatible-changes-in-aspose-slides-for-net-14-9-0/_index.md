---
title: API pública y cambios incompatibles hacia atrás en Aspose.Slides para .NET 14.9.0
...
La clase Aspose.Slides.SmartArt.SmartArtShape (y su interfaz Aspose.Slides.SmartArt.ISmartArtShape) brinda acceso a formas individuales en un diagrama SmartArt. SmartArtShape puede usarse para cambiar FillFormat, LineFormat, agregar hipervínculos y otras tareas.
...
{{% /alert %}} 
#### **Métodos para guardar diapositivas con números de página mantenidos añadidos**
...
Estos métodos permiten a los desarrolladores guardar diapositivas específicas de una presentación en formatos PDF, XPS, TIFF, HTML. La matriz **slides** se usa para especificar los números de página, comenzando desde 1.
