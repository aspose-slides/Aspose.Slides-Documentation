...
### **Se ha añadido la propiedad UniqueId a Aspose.Slides.IShape**
...
### **Se ha cambiado la firma del método SetGroupingItem en IChartCategoryLevelsManager**
...
está obsoleta ahora y se ha reemplazado por la firma
...
Pase un valor como "Group 1" a SetGroupingItem pero no un valor del tipo IChartDataCell. Construir un IChartDataCell con una hoja de cálculo, fila y columna definidas para los niveles de categoría debe cumplir ciertos requisitos y se ha encapsulado en el método SetGroupingItem(int, object).
...
La propiedad ChartSeriesGroup.Type ha cambiado de la enumeración ChartType a la nueva enumeración CombinableSeriesTypesGroup. La enumeración CombinableSeriesTypesGroup representa los grupos de tipos de series combinables.
### **Se ha añadido soporte para generar miniaturas de formas individuales**
