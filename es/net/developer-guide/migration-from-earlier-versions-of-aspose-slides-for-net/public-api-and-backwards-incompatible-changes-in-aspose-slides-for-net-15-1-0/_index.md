...
Se ha añadido la posibilidad de reemplazar fuentes de forma global en toda la presentación y de forma temporal para el renderizado.
...
Se usa para reemplazar de forma permanente una fuente en la presentación. 
...
Otro ejemplo muestra la sustitución de fuentes para el renderizado cuando no están accesibles:
