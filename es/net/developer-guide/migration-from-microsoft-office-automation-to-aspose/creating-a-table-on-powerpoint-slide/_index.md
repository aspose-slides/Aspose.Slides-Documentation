...
- C#
- Aspose.Slides
description: "Migra de la automatización de Microsoft Office a Aspose.Slides para .NET y crea tablas en diapositivas de PowerPoint (PPT, PPTX) en C# con formato flexible."
---
...
foreach (IRow row in tbl.Rows)
{
	foreach (ICell cell in row)
	{
		...
		//Establecer el tamaño de fuente a 10
