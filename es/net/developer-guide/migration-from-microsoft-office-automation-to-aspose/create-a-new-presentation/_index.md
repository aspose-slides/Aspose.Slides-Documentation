...
- Aspose.Slides solo contiene código administrado y no requiere que el tiempo de ejecución de Microsoft Office esté instalado.
- Puede usarse como componente del lado del cliente o como componente del lado del servidor.
- El despliegue es sencillo ya que Aspose.Slides está contenido en una única DLL.

{{% /alert %}} 
## **Crear una presentación**
Abajo hay dos ejemplos de código que ilustran cómo VSTO y Aspose.Slides for .NET pueden usarse para lograr el mismo objetivo. El primer ejemplo es [VSTO](/slides/es/net/create-a-new-presentation/); [el segundo ejemplo](/slides/es/net/create-a-new-presentation/) usa Aspose.Slides.
### **Ejemplo VSTO**
**La salida de VSTO** 
