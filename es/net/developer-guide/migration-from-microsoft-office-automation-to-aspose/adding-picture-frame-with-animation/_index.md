---
title: Agregar marcos de imagen con animación usando VSTO y Aspose.Slides para .NET
...
- C#
- Aspose.Slides
description: "Migra de la automatización de Microsoft Office a Aspose.Slides para .NET y anima marcos de imagen en diapositivas de PowerPoint (PPT, PPTX) con código C# limpio."
---
...
//Aplicando animación al marco de imagen
...
using (Presentation pres = new Presentation())
{
    ...
    // Agregar el efecto de animación Desplazamiento desde la izquierda al marco de imagen
