...
- C#
- Aspose.Slides
description: "Aprenda cómo automatizar la creación de gráficos en PowerPoint con C#. Esta guía paso a paso muestra por qué Aspose.Slides para .NET es una alternativa más rápida y poderosa a Microsoft.Office.Interop."
---

## **Resumen**

Este artículo muestra cómo crear y personalizar gráficos en presentaciones de Microsoft PowerPoint de forma programática usando C#. Con Aspose.Slides para .NET, puedes automatizar la generación de gráficos profesionales basados en datos sin depender de Microsoft Office ni de bibliotecas Interop. La API ofrece un amplio conjunto de funciones para crear gráficos de columnas, de sectores, de líneas y más, con control total sobre la apariencia, los datos y el diseño. Ya sea que generes informes, paneles de control o presentaciones empresariales, Aspose.Slides te ayuda a ofrecer visualizaciones de alta calidad directamente desde tus aplicaciones .NET.

## **Ejemplo VSTO**

Esta sección muestra cómo crear un gráfico en una presentación de Microsoft PowerPoint usando **VSTO (Visual Studio Tools for Office)**. Con VSTO, puedes generar y personalizar gráficos de forma programática combinando la automatización de PowerPoint y Excel. El ejemplo proporcionado muestra cómo añadir un **gráfico de columnas agrupadas 3D**, rellenarlo con datos de una hoja de cálculo de Excel, ajustar el formato y el diseño, y guardar la presentación final, todo desde una aplicación .NET.

1. Crear una instancia de una presentación de Microsoft PowerPoint.  
2. Añadir una diapositiva en blanco a la presentación.  
3. Añadir un gráfico de columnas agrupadas 3D y acceder a él.  
4. Crear una nueva instancia de libro de Microsoft Excel y cargar los datos del gráfico.  
5. Acceder a la hoja de datos del gráfico usando la instancia del libro de Excel.  
...
9. Acceder al título del gráfico y establecer sus propiedades relacionadas con la fuente.  
10. Acceder al eje de valores del gráfico y establecer la unidad mayor, la unidad menor, el valor máximo y el valor mínimo.  
11. Acceder al eje de profundidad (series) del gráfico y eliminarlo; solo se utiliza una serie en este ejemplo.  
12. Establecer los ángulos de rotación del gráfico en las direcciones X e Y.  
...
// Añadir un gráfico predeterminado a la diapositiva.
...
// Crear una instancia del libro de Excel para trabajar con los datos del gráfico.
...
// Cerrar el libro y la presentación.
...
public static void EnsurePowerPointIsRunning(bool blnAddPresentation, bool blnAddSlide)
{
    ...
    // Intenta acceder a la propiedad Name. Si lanza una excepción, inicia una nueva instancia de PowerPoint.
    try
    {
        strName = objPPT.Name;
    }
...
5. Eliminar las series no utilizadas Serie 2 y Serie 3.  
...
9. Configurar el eje de valores del gráfico, incluyendo la unidad mayor, la unidad menor, los valores máximo y mínimo.  
...
**¿Puedo crear otros tipos de gráficos como de pastel, de línea o de barras con Aspose.Slides?**

Sí. Aspose.Slides para .NET admite una amplia variedad de [tipos de gráficos](https://docs.aspose.com/slides/net/create-chart/), incluidos gráficos de pastel, de línea, de barras, de dispersión, de burbujas y más. Puedes especificar el tipo de gráfico deseado mediante la enumeración [ChartType](https://reference.aspose.com/slides/net/aspose.slides.charts/charttype/) al añadir un gráfico.

**¿Puedo aplicar estilos o temas personalizados al gráfico?**

Sí. Puedes personalizar completamente la apariencia del gráfico, incluidos colores, fuentes, rellenos, contornos, líneas de cuadrícula y diseño. Sin embargo, aplicar los temas de Office exactamente como aparecen en PowerPoint requiere configurar manualmente los estilos individualmente.

**¿Puedo exportar el gráfico como una imagen separada de la diapositiva?**

Sí, Aspose.Slides permite exportar cualquier forma —incluidos los gráficos— como una imagen independiente (por ejemplo, PNG, JPEG) usando el método `GetImage` en la [forma](https://reference.aspose.com/slides/net/aspose.slides/ishape/) del gráfico.