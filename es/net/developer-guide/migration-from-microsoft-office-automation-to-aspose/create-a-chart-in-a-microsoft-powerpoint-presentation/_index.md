...
- C#
- Aspose.Slides
description: "Aprenda cómo automatizar la creación de gráficos de PowerPoint en C#. Esta guía paso a paso muestra por qué Aspose.Slides para .NET es una alternativa más rápida y poderosa a Microsoft.Office.Interop."
---

## **Descripción general**

Este artículo muestra cómo crear y personalizar gráficos en presentaciones de Microsoft PowerPoint de forma programática usando C#. Con Aspose.Slides para .NET, puedes automatizar la generación de gráficos profesionales basados en datos sin depender de Microsoft Office ni de bibliotecas Interop. La API ofrece un conjunto amplio de características para construir gráficos de columnas, gráficos circulares, gráficos de líneas y más, con control total sobre la apariencia, los datos y el diseño. Tanto si generas informes, paneles de control o presentaciones empresariales, Aspose.Slides te ayuda a ofrecer visualizaciones de alta calidad directamente desde tus aplicaciones .NET.

## **Ejemplo VSTO**

Esta sección muestra cómo crear un gráfico en una presentación de Microsoft PowerPoint usando **VSTO (Visual Studio Tools for Office)**. Con VSTO, puedes generar y personalizar gráficos de forma programática combinando la automatización de PowerPoint y Excel. El ejemplo proporcionado muestra cómo agregar un **gráfico de columnas agrupadas 3D**, completarlo con datos de una hoja de cálculo de Excel, ajustar el formato y el diseño, y guardar la presentación final, todo desde una aplicación .NET.

1. Crear una instancia de una presentación de Microsoft PowerPoint.
1. Agregar una diapositiva en blanco a la presentación.
1. Agregar un gráfico de columnas agrupadas 3D y acceder a él.
1. Crear una nueva instancia de un libro de trabajo de Microsoft Excel y cargar los datos del gráfico.
1. Acceder a la hoja de datos del gráfico usando la instancia del libro de Excel.
...
1. Modificar los datos de la serie 1 en la hoja de datos del gráfico.
1. Acceder al título del gráfico y establecer sus propiedades de fuente.
1. Acceder al eje de valores del gráfico y establecer la unidad mayor, la unidad menor, el valor máximo y el valor mínimo.
1. Acceder al eje de profundidad (series) del gráfico y eliminarlo; solo se utiliza una serie en este ejemplo.
1. Establecer los ángulos de rotación del gráfico en las direcciones X e Y.
...
// Establecer los valores de las unidades del eje.
...
public static void EnsurePowerPointIsRunning(bool blnAddPresentation, bool blnAddSlide)
{
    ...
    // blnAddPresentation se utiliza para garantizar que se cargue una presentación.
    ...
    // blnAddSlide se utiliza para garantizar que haya al menos una diapositiva en la presentación.
    if (blnAddSlide)
    {
        try
        {
...
El siguiente ejemplo muestra cómo crear un gráfico sencillo en una presentación de PowerPoint usando Aspose.Slides para .NET. Este código demuestra cómo agregar un **gráfico de columnas agrupadas 3D**, completarlo con datos de muestra y personalizar su apariencia. Con solo unas pocas líneas de código, puedes generar gráficos de forma dinámica e integrarlos en tus presentaciones sin usar Microsoft Office.

1. Crear una instancia de la clase [Presentation](https://reference.aspose.com/slides/net/aspose.slides/presentation/).
1. Obtener una referencia a la primera diapositiva.
1. Agregar un gráfico de columnas agrupadas 3D y acceder a él.
1. Acceder a los datos del gráfico.
1. Eliminar las Series 2 y Series 3 no utilizadas.
1. Modificar las categorías del gráfico actualizando las etiquetas.
1. Actualizar los valores de la Serie 1.
1. Acceder al título del gráfico y establecer sus propiedades de fuente.
1. Configurar el eje de valores del gráfico, incluida la unidad mayor, la unidad menor, los valores máximo y mínimo.
1. Establecer los ángulos de rotación del gráfico en los ejes X e Y.
...
using (Presentation presentation = new Presentation())
{
    ...
    // Configurar las opciones del eje.
...
**¿Puedo crear otros tipos de gráficos como circulares, de líneas o de barras con Aspose.Slides?**

Sí. Aspose.Slides para .NET soporta una amplia variedad de [tipos de gráfico](https://docs.aspose.com/slides/net/create-chart/), incluidos los gráficos circulares, de líneas, de barras, de dispersión, de burbujas y más. Puedes especificar el tipo de gráfico deseado usando la enumeración [ChartType](https://reference.aspose.com/slides/net/aspose.slides.charts/charttype/) al agregar un gráfico.

**¿Puedo aplicar estilos o temas personalizados al gráfico?**

Sí. Puedes personalizar completamente la apariencia del gráfico, incluidas colores, fuentes, rellenos, contornos, líneas de cuadrícula y diseño. Sin embargo, aplicar los temas de Office exactamente como se ven en PowerPoint requiere configurar manualmente los estilos individuales.

**¿Puedo exportar el gráfico como una imagen separada de la diapositiva?**

Sí, Aspose.Slides permite exportar cualquier forma —incluidos los gráficos— como una imagen separada (por ejemplo, PNG, JPEG) usando el método `GetImage` en la [shape](https://reference.aspose.com/slides/net/aspose.slides/ishape/) del gráfico.