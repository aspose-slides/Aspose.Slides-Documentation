...
- C#
- Aspose.Slides
description: "Migra de la automatización de Microsoft Office a Aspose.Slides para .NET e incrusta gráficos de Excel como objetos OLE en diapositivas de PowerPoint (PPT, PPTX) con C#."
---

{{% alert color="primary" %}} 

 Los gráficos son representaciones visuales de sus datos y se utilizan ampliamente en diapositivas de presentación. Este artículo le mostrará el código para crear e incrustar un gráfico de Excel como un objeto OLE en la diapositiva de PowerPoint mediante [VSTO](/slides/es/net/create-and-embed-an-excel-chart-as-an-ole-object-into-a-microsoft-powerpoint-slide/) y [Aspose.Slides for .NET](/slides/es/net/create-and-embed-an-excel-chart-as-an-ole-object-into-a-microsoft-powerpoint-slide/).
...
static void CreateNewChartInExcel()
{
    ...
    try
    {
        ...
        //              A       B       C       D       E
        //     1                Q1      Q2      Q3      Q4
        //     2    Norteamérica  1.5     2       1.5     2.5
        //     3    Sudamérica    2       1.75    2       2
...
static void UseCopyPaste()
{
    ...
    try
    {
        ...
        // Abrir el libro de trabajo de Excel que contiene la hoja con los datos del gráfico.
...
Usando Aspose.Slides for .NET, se realizan los siguientes pasos:
...
1. Incrustar el gráfico de Excel como un objeto OLE dentro de la presentación PPTX usando Aspose.Slides for .NET.
1. Reemplazar la imagen del objeto cambiada con la imagen obtenida en el paso 3 para atender el problema del objeto cambiado.
1. Guardar la presentación de salida en disco en formato PPTX.
```c#
...
//Paso - 4 y 5
//-----------------------------------------------------------
//Paso - 4: Insertar el gráfico como un objeto OLE dentro de una presentación .ppt usando Aspose.Slides
//-----------------------------------------------------------
//Paso - 5: Reemplazar la imagen del objeto cambiado con la imagen obtenida en el paso 3 para solucionar el problema de objeto cambiado
//-----------------------------------------------------------
