...
Los gráficos son representaciones visuales de sus datos y se utilizan ampliamente en diapositivas de presentación. Este artículo le mostrará el código para crear e incrustar un gráfico de Excel como un objeto OLE en la diapositiva de PowerPoint de forma programática utilizando [VSTO](/slides/es/net/create-and-embed-an-excel-chart-as-an-ole-object-into-a-microsoft-powerpoint-slide/) y [Aspose.Slides for .NET](/slides/es/net/create-and-embed-an-excel-chart-as-an-ole-object-into-a-microsoft-powerpoint-slide/).
...
## **Ejemplo VSTO**
Al utilizar VSTO, se realizan los siguientes pasos:
...
1. Abrir el libro de trabajo de Excel que contiene la hoja con los datos del gráfico.
...
Al utilizar Aspose.Slides para .NET, se realizan los siguientes pasos:
...
1. Reemplazar la imagen del objeto cambiado con la imagen obtenida en el paso 3 para abordar el problema del objeto cambiado.
...
//-----------------------------------------------------------
//Paso - 5: Reemplazar la imagen del objeto cambiado con la imagen obtenida en el paso 3 para abordar el problema de Object Changed
//-----------------------------------------------------------
...
static int AddExcelChartInWorkbook(Aspose.Cells.Workbook wb, int chartRows, int chartCols)
{
 ...
 24,40,38,25
    ...
    //Agregar una nueva hoja de cálculo para poblar celdas con datos
