...
{{% alert color="primary" %}} 
Lea más sobre cómo [Renderizar presentación con fuente de reserva](/slides/es/net/render-presentation-with-fallback-font/).
{{% /alert %}}