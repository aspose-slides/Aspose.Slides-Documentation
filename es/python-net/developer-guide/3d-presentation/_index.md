...
- Python
- Aspose.Slides
description: "Genere presentaciones 3D interactivas en Python con Aspose.Slides sin esfuerzo. Exporte rápidamente a formatos PowerPoint y OpenDocument para uso versátil."
---

## **Visión general**

¿Cómo sueles crear una presentación 3D en PowerPoint? Microsoft PowerPoint te permite añadir modelos 3D, aplicar efectos 3D a formas, crear texto 3D, insertar gráficos 3D y crear animaciones 3D.
...
- [bevel_bottom](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/bevel_bottom/) y [bevel_top](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/bevel_top/): establece biseles, elige un tipo de bisel (por ejemplo, Angle, Circle, SoftRound) y define la altura y el ancho del bisel.
- [camera](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/camera/): simula el movimiento de la cámara alrededor del objeto; al ajustar la rotación, el zoom y otras propiedades de la cámara, puedes manipular las formas como modelos 3D en PowerPoint.
- [contour_color](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/contour_color/) y [contour_width](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/contour_width/): define las propiedades del contorno para que una forma parezca un objeto 3D de PowerPoint.
- [depth](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/depth/), [extrusion_color](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/extrusion_color/) y [extrusion_height](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/extrusion_height/): convierte una forma en tridimensional estableciendo su profundidad o extruyéndola.
- [light_rig](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/light_rig/): crea efectos de iluminación en una forma 3D; al igual que con la cámara, puedes establecer la rotación de la luz con respecto a la forma 3D y elegir un tipo de luz.
- [material](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/material/): selecciona un material para que la forma 3D parezca más realista. Los materiales predefinidos incluyen Metal, Plastic, Powder, Matte y más.
...
with open("image.png", "rb") as image_file:
    ...
    # ... configurar 3D: shape.three_d_format.camera, shape.three_d_format.light_rig, shape.three_d_format.Extrusion* propiedades
...
Aspose.Slides permite aplicar efectos 3D al texto también. Para crear texto 3D, puedes usar el efecto de transformación WordArt:
...
Sí. Slides proporciona APIs para [leer valores efectivos](/slides/es/python-net/shape-effective-properties/) (incluidos los de 3D—iluminación, biseles, etc.) para que puedas ver la configuración final aplicada.
