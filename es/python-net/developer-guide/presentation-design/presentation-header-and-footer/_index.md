---
title: Administrar encabezados y pies de página de la presentación con Python
...
- Python
- Aspose.Slides
description: "Utilice Aspose.Slides para Python vía .NET para agregar y personalizar encabezados y pies de página en presentaciones PowerPoint y OpenDocument, logrando un aspecto profesional."
---

## **Visión general**

Aspose.Slides para Python le permite controlar los marcadores de posición de encabezado y pie de página en toda la presentación con un alcance preciso. El texto del pie de página, la fecha/hora y los números de diapositiva se gestionan desde el nivel maestro y pueden aplicarse globalmente o ajustarse por diapositiva. Los encabezados se admiten en notas y folletos, donde puede alternar su visibilidad y establecer texto para encabezado, pie de página, fecha/hora y números de página a través del administrador de encabezado y pie de página dedicado en la diapositiva maestra de notas o en diapositivas de notas individuales. Este artículo describe los patrones clave para actualizar estos marcadores de posición y propagar los cambios de forma coherente a lo largo de su presentación.

## **Administrar texto de encabezado y pie de página**

En esta sección, aprenderá a administrar el contenido de encabezado y pie de página en una presentación: habilitar o modificar el pie de página, la fecha y hora, y los números de diapositiva. Esbozaremos brevemente los alcances para aplicar estas configuraciones (toda la presentación, diapositivas individuales y vistas de notas/folletos) y mostraremos cómo usar la API de Aspose.Slides para actualizarlas de forma rápida y consistente.
...
En esta sección, aprenderá a administrar encabezados y pies de página específicamente para diapositivas de notas en Aspose.Slides. Cubriremos la habilitación de los marcadores de posición relevantes, la configuración de texto para pies de página, fecha/hora y números de página, y la aplicación coherente de estos cambios en el maestro de notas y en páginas de notas individuales.
...
3. En la diapositiva maestra de notas, habilite la visibilidad de Encabezado, Pie de página, Número de diapositiva y Fecha/hora para el maestro y todas las diapositivas de notas secundarias.  
4. En la diapositiva maestra de notas, establezca el texto para Encabezado, Pie de página y Fecha/hora para el maestro y todas las diapositivas de notas secundarias.  
...
Sí. Verifique la visibilidad a través del administrador de encabezado/pie de página y habilítela si es necesario. Estos indicadores y métodos de la API están diseñados para casos en que el marcador de posición falta o está oculto.

**¿Cómo hago que el número de diapositiva comience en un valor distinto de 1?**

Establezca el [primer número de diapositiva](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/first_slide_number/) de la presentación; después de eso, toda la numeración se recalcula. Por ejemplo, puede comenzar en 0 o 10, y ocultar el número en la diapositiva de título.
