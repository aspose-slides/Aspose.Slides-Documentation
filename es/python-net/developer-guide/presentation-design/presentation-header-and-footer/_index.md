...
- Python
- Aspose.Slides
description: "Use Aspose.Slides para Python a través de .NET para agregar y personalizar encabezados y pies de página en presentaciones de PowerPoint y OpenDocument, logrando un aspecto profesional."
---

## **Visión general**

Aspose.Slides para Python le permite controlar los marcadores de posición de encabezado y pie de página en toda una presentación con un alcance preciso. El texto del pie de página, la fecha/hora y los números de diapositiva en las diapositivas se gestionan a nivel de maestro y pueden aplicarse globalmente o ajustarse por diapositiva. Los encabezados son compatibles en notas y folletos, donde puede alternar la visibilidad y establecer texto para encabezado, pie de página, fecha/hora y números de página mediante el administrador dedicado de encabezado y pie de página en la diapositiva maestra de notas o en diapositivas de notas individuales. Este artículo describe los patrones clave para actualizar estos marcadores y propagar los cambios de forma coherente en toda la presentación.

## **Administrar texto de encabezado y pie de página**

En esta sección aprenderá a gestionar el contenido de encabezado y pie de página en una presentación: habilitar o modificar el pie de página, la fecha y hora, y los números de diapositiva. Resumiremos los alcances para aplicar estas configuraciones (toda la presentación, diapositivas individuales y vistas de notas/folletos) y mostraremos cómo usar la API de Aspose.Slides para actualizarlas rápidamente y de manera consistente.
...
En esta sección aprenderá a gestionar encabezados y pies de página específicamente para diapositivas de notas en Aspose.Slides. Cubriremos la habilitación de los marcadores de posición relevantes, el establecimiento de texto para pies de página, fecha/hora y números de página, y la aplicación coherente de estos cambios en el maestro de notas y en páginas de notas individuales.
...
with slides.Presentation("sample.pptx") as presentation:
    ...
    if master_notes_slide is not None:
        ...
        # Hacer visibles los marcadores de posición de encabezado, pie de página, número de diapositiva y fecha/hora del master de notas y de todos sus hijos.
        header_footer_manager.set_header_and_child_headers_visibility(True)
        header_footer_manager.set_footer_and_child_footers_visibility(True)
        header_footer_manager.set_slide_number_and_child_slide_numbers_visibility(True)
        header_footer_manager.set_date_time_and_child_date_times_visibility(True)

        # Establecer texto en el master de notas y en todos los marcadores de posición de encabezado, pie de página y fecha/hora de los hijos.
...
Establezca el [primer número de diapositiva](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/first_slide_number/) de la presentación; a partir de eso, toda la numeración se recalcula. Por ejemplo, puede comenzar en 0 o 10, y ocultar el número en la diapositiva de título.
