...
- Python
- Aspose.Slides
description: "Configure una colección de fuentes de reserva en Aspose.Slides para Python a través de .NET para mantener el texto consistente y nítido en presentaciones de PowerPoint y OpenDocument."
---
...
{{% alert color="primary" %}} 
Lea más sobre cómo [Renderizar presentación con fuente de reserva](/slides/es/python-net/render-presentation-with-fallback-font/).
{{% /alert %}}
