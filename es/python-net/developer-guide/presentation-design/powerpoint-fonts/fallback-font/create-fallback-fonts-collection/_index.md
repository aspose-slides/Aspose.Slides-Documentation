...
- Python
- Aspose.Slides
description: "Configure una colección de fuentes de reserva en Aspose.Slides para Python mediante .NET para mantener el texto coherente y nítido en presentaciones de PowerPoint y OpenDocument."
---
...
{{% alert color="primary" %}} 
Lee más sobre cómo [Renderizar presentación con fuente de reserva](/slides/es/python-net/render-presentation-with-fallback-font/).
{{% /alert %}}
