...
- Python
- Aspose.Slides
description: "Desbloquee una exportación fluida de ecuaciones matemáticas de PowerPoint a MathML usando Aspose.Slides para Python a través de .NET, mantenga el formato y mejore la compatibilidad."
---
...
Sí, si esos objetos contienen fragmentos de texto con un [MathParagraph](https://reference.aspose.com/slides/python-net/aspose.slides.mathtext/mathparagraph/) (es decir, fórmulas genuinas de PowerPoint), se exportan. Si una fórmula está incrustada como una imagen, no lo es.
