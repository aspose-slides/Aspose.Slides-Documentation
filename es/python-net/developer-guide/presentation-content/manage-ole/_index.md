...
- Python
- Aspose.Slides
description: "Optimiza la gestión de objetos OLE en archivos PowerPoint y OpenDocument con Aspose.Slides para Python mediante .NET. Incrusta, actualiza y exporta contenido OLE sin problemas."
---
...
**OLE (Object Linking & Embedding)** es una tecnología de Microsoft que permite que datos y objetos creados en una aplicación se vinculen o incrusten en otra.
...
- Un objeto OLE también puede mostrar su contenido (por ejemplo, un gráfico). En este caso, PowerPoint activa el objeto incrustado, carga la interfaz del gráfico y permite editar los datos del gráfico dentro de PowerPoint.
...
1. Agregue un [OleObjectFrame](https://reference.aspose.com/slides/python-net/aspose.slides/oleobjectframe/) a la diapositiva, suministrando la matriz de bytes y otros detalles del objeto OLE.
...
Aspose.Slides for Python le permite agregar un [OleObjectFrame](https://reference.aspose.com/slides/python-net/aspose.slides/oleobjectframe/) que vincula a un archivo en lugar de incrustar sus datos.
...
El ejemplo a continuación accede al marco del objeto OLE —un gráfico Excel incrustado— y recupera los datos del archivo. En este ejemplo usamos un PPTX que tiene una sola forma en la primera diapositiva.
...
En el ejemplo a continuación, se accede a un marco de objeto OLE (un gráfico Excel incrustado) y se modifica su datos de archivo para actualizar el gráfico. La muestra usa un PPTX creado previamente que contiene una sola forma en la primera diapositiva.
...
Además de gráficos Excel, Aspose.Slides for Python le permite incrustar otros tipos de archivo en diapositivas. Por ejemplo, puede insertar archivos HTML, PDF y ZIP como objetos. Cuando un usuario hace doble clic en un objeto insertado, se abre automáticamente en la aplicación asociada, o se le solicita que elija un programa adecuado.
...
Después de agregar un objeto OLE vinculado a una diapositiva, PowerPoint puede solicitarle que actualice los vínculos al abrir la presentación. Seleccionar *Actualizar vínculos* puede cambiar el tamaño y la posición del marco del objeto OLE porque PowerPoint actualiza la vista previa con datos del objeto vinculado. Para evitar que PowerPoint le solicite actualizar los datos del objeto, establezca la propiedad `update_automatic` de la clase [OleObjectFrame](https://reference.aspose.com/slides/python-net/aspose.slides/oleobjectframe/) en `False`:
...
1. Recorrer todas las formas de la presentación y localizar las formas OLEObjectFrame.
1. Recuperar los datos del archivo incrustado de cada [OLEObjectFrame](https://reference.aspose.com/slides/python-net/aspose.slides/oleobjectframe/) y escribirlos en disco.
...
Lo que se muestra en la diapositiva se renderiza: el ícono/imagen de sustitución (vista previa). El contenido "activo" de OLE no se ejecuta durante el renderizado. Si lo necesita, establezca su propia imagen de vista previa para garantizar la apariencia esperada en el PDF exportado.

**¿Cómo puedo bloquear un objeto OLE en una diapositiva para que los usuarios no puedan moverlo/editarlo en PowerPoint?**

Bloquee la forma: Aspose.Slides proporciona [bloqueos a nivel de forma](/slides/es/python-net/applying-protection-to-presentation/). No es cifrado, pero evita eficazmente ediciones o movimientos accidentales.

**¿Por qué un objeto Excel vinculado "salta" o cambia de tamaño al abrir la presentación?**

PowerPoint puede refrescar la vista previa del OLE vinculado. Para una apariencia estable, siga las prácticas de la [Solución de trabajo para el redimensionado de hojas de cálculo](/slides/es/python-net/working-solution-for-worksheet-resizing/): ajuste el marco al rango o escale el rango a un marco fijo y establezca una imagen de sustitución adecuada.

**¿Se conservarán las rutas relativas para objetos OLE vinculados en el formato PPTX?**

En PPTX, la información de "ruta relativa" no está disponible; solo la ruta completa. Las rutas relativas existen en el formato PPT más antiguo. Para portabilidad, prefiera rutas absolutas fiables/URI accesibles o incrustación.