...
- Python
- Aspose.Slides
description: "Cree y edite tablas en diapositivas PowerPoint y OpenDocument con Aspose.Slides para Python vía .NET. Descubra ejemplos de código simples para agilizar sus flujos de trabajo con tablas."
---

## **Descripción general**

Una tabla en PowerPoint es una forma eficaz de presentar información. La información organizada en una cuadrícula de celdas (filas y columnas) es directa y fácil de entender.
...
3. Definir un arreglo de anchos de columna.
4. Definir un arreglo de alturas de fila.
...
with slides.Presentation() as presentation:
    ...
    # Fusionar celdas de (fila 0, col 0) a (fila 1, col 1).
    table.merge_cells(table.rows[0][0], table.rows[1][1], False)

    # Añadir texto a la celda fusionada.
    table.rows[0][0].text_frame.text = "Celdas fusionadas"
...
El siguiente ejemplo en Python muestra cómo referenciar celdas utilizando esta numeración basada en cero:
...
with slides.Presentation("sample.pptx") as presentation:
    ...
    # Recorrer formas y referenciar la primera tabla encontrada.
    ...
    if table is not None:
        table.rows[0][0].text_frame.text = "Encontrada"
...
Esta sección muestra cómo controlar la alineación del texto dentro de las celdas de una tabla usando Aspose.Slides. Aprenderá a establecer la alineación horizontal y vertical de las celdas para que su contenido sea claro y coherente.
...
with slides.Presentation() as presentation:
    ...
    # Añadir una forma de tabla a la diapositiva.
    table = slide.shapes.add_table(100, 50, column_widths, row_heights)
    table.rows[0][0].text_frame.text = "Números"
...
Esta sección muestra cómo aplicar formato de texto a nivel de tabla en Aspose.Slides para que cada celda herede un estilo consistente y unificado. Aprenderá a definir tamaños de fuente, alineaciones y márgenes de forma global.
...
with slides.Presentation() as presentation:
    ...
    # Establecer texto alineado a la derecha y margen derecho para todas las celdas.
    paragraph_format = slides.ParagraphFormat()
    paragraph_format.alignment = slides.TextAlignment.RIGHT
    paragraph_format.margin_right = 20
    table.set_text_format(paragraph_format)

    # Establecer la orientación vertical del texto para todas las celdas.
...
Aspose.Slides le permite formatear tablas usando estilos predefinidos directamente en código. El ejemplo muestra cómo crear una tabla, aplicar un estilo incorporado y guardar el resultado, una forma eficiente de garantizar un formato consistente y profesional.
...
## **Bloquear relación de aspecto de las tablas**
...
with slides.Presentation() as presentation:
    ...
    print(f"Bloqueo de relación de aspecto activado: {table.shape_lock.aspect_ratio_locked}")
...
Sí. La tabla expone la propiedad [right_to_left](https://reference.aspose.com/slides/python-net/aspose.slides/table/right_to_left/), y los párrafos tienen [ParagraphFormat.right_to_left](https://reference.aspose.com/slides/python-net/aspose.slides/paragraphformat/right_to_left/). Usar ambos asegura el orden RTL correcto y la renderización adecuada dentro de las celdas.

**¿Cómo puedo evitar que los usuarios muevan o redimensionen una tabla en el archivo final?**

Utilice [bloqueos de forma](/slides/es/python-net/applying-protection-to-presentation/) para desactivar mover, redimensionar, seleccionar, etc. Estos bloqueos también se aplican a las tablas.

**¿Se admite la inserción de una imagen dentro de una celda como fondo?**

Sí. Puede establecer un [relleno de imagen](https://reference.aspose.com/slides/python-net/aspose.slides/picturefillformat/) para una celda; la imagen cubrirá el área de la celda según el modo elegido (estirar o mosaico).