...
- Python
- Aspose.Slides
description: "Descubra Aspose.Slides para Python vía .NET: administre sin esfuerzo los libros de trabajo de gráficos en formatos PowerPoint y OpenDocument para optimizar los datos de su presentación."
---
...
3. Añada un gráfico de burbujas con datos de ejemplo.
4. Acceda a la serie del gráfico.
5. Utilice una celda del libro de trabajo como etiqueta de datos.
...
Al usar el método [ChartData.set_external_workbook](https://reference.aspose.com/slides/python-net/aspose.slides.charts/chartdata/set_external_workbook/) puede asignar un libro de trabajo externo a un gráfico como su fuente de datos. Este método también puede actualizar la ruta a un libro de trabajo externo si ha sido movido.
...
El parámetro `update_chart_data` del método [set_external_workbook](https://reference.aspose.com/slides/python-net/aspose.slides.charts/chartdata/set_external_workbook/) especifica si el libro de Excel será cargado.

- Cuando `update_chart_data` se establece en `False`, solo se actualiza la ruta del libro de trabajo; los datos del gráfico no se cargan ni se actualizan desde el libro de trabajo de destino. Use esta configuración cuando el libro de trabajo de destino no exista o no esté disponible.
- Cuando `update_chart_data` se establece en `True`, los datos del gráfico se cargan y actualizan desde el libro de trabajo de destino.
...
### **Obtener la ruta del libro de trabajo externo como fuente de datos para un gráfico**
...
Puede editar datos en libros de trabajo externos de la misma manera que edita datos en libros internos. Si no se puede cargar un libro de trabajo externo, se lanza una excepción.
...
Sí. Un gráfico tiene un [tipo de fuente de datos](https://reference.aspose.com/slides/python-net/aspose.slides.charts/chartdata/data_source_type/) y una [ruta a un libro externo](https://reference.aspose.com/slides/python-net/aspose.slides.charts/chartdata/external_workbook_path/); si la fuente es un libro externo, puede leer la ruta completa para confirmar que se está usando un archivo externo.

**¿Se admiten rutas relativas a libros de trabajo externos, y cómo se almacenan?**  
Sí. Si especifica una ruta relativa, se convierte automáticamente en una ruta absoluta. Esto facilita la portabilidad del proyecto; sin embargo, tenga en cuenta que la presentación guardará la ruta absoluta en el archivo PPTX.
...
No. La presentación almacena un [enlace al archivo externo](https://reference.aspose.com/slides/python-net/aspose.slides.charts/chartdata/external_workbook_path/) y lo utiliza para leer datos. El archivo externo no se modifica al guardar la presentación.

**¿Qué debo hacer si el archivo externo tiene protección con contraseña?**  
Aspose.Slides no acepta una contraseña al crear el enlace. Una solución habitual es eliminar la protección con anterioridad o preparar una copia descifrada (por ejemplo, usando [Aspose.Cells](/cells/python-net/)) y enlazar a esa copia.
