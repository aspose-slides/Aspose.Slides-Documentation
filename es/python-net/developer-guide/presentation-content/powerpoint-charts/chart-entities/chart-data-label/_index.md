---
title: Gestión de etiquetas de datos del gráfico en presentaciones con Python
...
- Python
- Aspose.Slides
description: "Aprenda a agregar y dar formato a las etiquetas de datos de los gráficos en presentaciones de PowerPoint y OpenDocument usando Aspose.Slides para Python vía .NET para diapositivas más atractivas."
---

## **Descripción general**

Las etiquetas de datos en un gráfico muestran detalles sobre la serie de datos del gráfico o puntos de datos individuales. Permiten a los lectores identificar rápidamente la serie de datos y también hacen que los gráficos sean más fáciles de entender. En Aspose.Slides para Python, puede habilitar, personalizar y dar formato a las etiquetas de datos para cualquier gráfico—eligiendo qué mostrar (valores, porcentajes, nombres de serie o categoría), dónde posicionar las etiquetas y cómo se ven (fuente, formato numérico, separadores, líneas guías y más). Este artículo describe las API esenciales y ejemplos que necesita para agregar etiquetas claras e informativas a sus gráficos.

## **Establecer la precisión de las etiquetas de datos**

Las etiquetas de datos del gráfico a menudo muestran valores numéricos que requieren una precisión constante. Esta sección muestra cómo controlar el número de decimales para las etiquetas de datos en Aspose.Slides aplicando un formato numérico apropiado.
...
## **Mostrar el símbolo de porcentaje en las etiquetas de datos del gráfico**

Esta sección muestra cómo mostrar porcentajes en las etiquetas de datos del gráfico e incluir el símbolo de porcentaje usando Aspose.Slides. Aprenderá a habilitar los valores de porcentaje para series completas o puntos específicos (ideal para gráficos circulares, de rosquilla y apilados al 100 %) y a controlar el formato mediante opciones de etiqueta o un formato numérico personalizado.

El siguiente ejemplo en Python muestra cómo agregar un símbolo de porcentaje a la etiqueta de datos de un gráfico:
...
with slides.Presentation() as presentation:
    ...
    # Crear un gráfico de columnas apiladas con porcentajes en la diapositiva.
    ...
    # Establecer propiedades del formato de etiqueta.
    series.labels.default_data_label_format.show_value = True
...
## **Establecer la distancia de la etiqueta respecto al eje**
...
El siguiente código en Python muestra cómo establecer la distancia de la etiqueta respecto al eje de categorías al trabajar con un gráfico basado en ejes:
...
with slides.Presentation() as presentation:
    ...
    # Establecer la distancia de la etiqueta respecto al eje horizontal (categorías).
...
Cuando crea un gráfico que no usa ejes, como un gráfico circular, las etiquetas de datos pueden estar demasiado cerca del borde. En ese caso, ajuste la posición de la etiqueta para que las líneas guías se muestren claramente.

El siguiente código en Python muestra cómo ajustar la posición de la etiqueta en un gráfico circular:
...
Combine la colocación automática de etiquetas, líneas guías y reducción del tamaño de fuente; si es necesario, oculte algunos campos (por ejemplo, la categoría) o muestre etiquetas solo para los puntos extremos/clave.
