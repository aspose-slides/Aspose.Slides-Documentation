...
- Python
- Aspose.Slides
description: "Descubra cómo Aspose.Slides para Python vía .NET calcula y aplica propiedades efectivas de forma para una representación precisa de PowerPoint y OpenDocument."
---
...
with slides.Presentation("Presentation1.pptx") as presentation:
	...
	print("= Propiedades efectivas del sistema de iluminación =")
...
Usando Aspose.Slides para Python vía .NET, puede recuperar las propiedades efectivas de un marco de texto. La clase [ITextFrameFormatEffectiveData](https://reference.aspose.com/slides/python-net/aspose.slides/itextframeformateffectivedata/) contiene las propiedades de formato efectivas del marco de texto.
...
with slides.Presentation("Presentation1.pptx") as presentation:
	...
	print("Márgenes")
	print("   Izquierdo:", str(text_frame_format_effective_data.margin_left))
	print("   Superior:", str(text_frame_format_effective_data.margin_top))
	print("   Derecho:", str(text_frame_format_effective_data.margin_right))
	print("   Inferior:", str(text_frame_format_effective_data.margin_bottom))
```

## **Obtener propiedades efectivas del estilo de texto**

Usando Aspose.Slides para Python vía .NET, puede recuperar las propiedades efectivas de un estilo de texto. La clase [ITextStyleEffectiveData](https://reference.aspose.com/slides/python-net/aspose.slides/itextstyleeffectivedata/) contiene las propiedades efectivas del estilo de texto.
...
with slides.Presentation("Presentation1.pptx") as presentation:
    ...
    for i in range(8):
        ...
        print(f"= Formato efectivo del párrafo para el nivel de estilo #{str(i)} =")

        print("Profundidad:", str(effectiveStyleLevel.depth))
        print("Indentación:", str(effectiveStyleLevel.indent))
...
Usando Aspose.Slides para Python vía .NET, puede obtener la altura de fuente efectiva. El ejemplo a continuación demuestra cómo cambia la altura de fuente efectiva de una porción de texto a medida que establece valores locales de altura de fuente en diferentes niveles de la estructura de la presentación.
...
with slides.Presentation() as presentation:
    ...
    portion0 = slides.Portion("Texto de muestra con primera porción")
...
## **Obtener formato de relleno efectivo de la tabla**

Usando Aspose.Slides para Python vía .NET, puede recuperar el formato de relleno efectivo para diferentes partes lógicas de una tabla. La clase [IFillFormatEffectiveData](https://reference.aspose.com/slides/python-net/aspose.slides/ifillformateffectivedata/) contiene las propiedades de formato de relleno efectivas. Tenga en cuenta que el formato de celda siempre tiene prioridad sobre el formato de fila, una fila tiene prioridad sobre una columna y una columna tiene prioridad sobre toda la tabla.

Por lo tanto, las propiedades de [ICellFormatEffectiveData](https://reference.aspose.com/slides/python-net/aspose.slides/icellformateffectivedata/) se usan en última instancia para dibujar la tabla. El siguiente ejemplo muestra cómo obtener el formato de relleno efectivo para los diferentes niveles de la tabla:
...
**¿Cómo saber si obtuve una “instantánea” en lugar de un “objeto en vivo”, y cuándo debo volver a leer las propiedades efectivas?**  
...
**¿Cambiar la diapositiva de diseño/maestra afecta a las propiedades efectivas que ya se obtuvieron?**  
...
No. EffectiveData es de solo lectura. Realice los cambios en los objetos de formato local (forma/texto/3D, etc.) y luego vuelva a obtener los valores efectivos.
...
**¿Por qué los valores de EffectiveData a veces parecen idénticos a los locales?**  
