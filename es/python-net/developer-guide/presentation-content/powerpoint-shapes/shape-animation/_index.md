...
- Python
- Aspose.Slides
description: "Descubra cómo crear y personalizar animaciones de forma en presentaciones PowerPoint y OpenDocument con Aspose.Slides para Python a través de .NET. ¡Distíngase!"
---
...
* Aspose.Slides ofrece más de **150 efectos de animación** bajo la enumeración [EffectType](https://reference.aspose.com/slides/python-net/aspose.slides.animation/effecttype/). Estos efectos son esencialmente los mismos (o equivalentes) que los usados en PowerPoint.  
...
Este código Python muestra cómo aplicar el efecto `Fade` a AutoShape y establecer la animación de texto en el valor *By 1st Level Paragraphs*:
...
with slides.Presentation() as pres:
    ...
    # Añade un picture frame a la diapositiva
...
with slides.Presentation() as pres:
    ...
    # Crea una ruta de usuario personalizada. Nuestro objeto solo se moverá después de hacer clic en el botón.
...
Anteriormente aprendiste cómo añadir efectos de animación a formas en presentaciones PowerPoint. El siguiente código muestra cómo obtener los efectos aplicados a la primera forma de la primera diapositiva normal del archivo `AnimExample_out.pptx`.
...
![Efecto de animación de forma en layout](layout-shape-animation.png)

Y, por último, el efecto **Fly In** está aplicado al marcador de posición del pie de página en la diapositiva **master**.

![Efecto de animación de forma en master](master-shape-animation.png)
...
with slides.Presentation("sample.pptx") as presentation:
    ...
    # Obtiene los efectos de animación del marcador de posición en la diapositiva de layout.
    layout_shape = shape.get_base_placeholder()
    layout_shape_effects = slide.layout_slide.timeline.main_sequence.get_effects_by_shape(layout_shape)

    # Obtiene los efectos de animación del marcador de posición en la diapositiva master.
...
## **Cambiar propiedades de tiempo de los efectos de animación**
...
- **Duration** de PowerPoint coincide con la propiedad `Effect.Timing.Duration`. La duración de una animación (en segundos) es el tiempo total que tarda la animación en completar un ciclo.  
- **Delay** de PowerPoint coincide con la propiedad `Effect.Timing.TriggerDelayTime`.  

Así se cambian las propiedades de temporización del efecto:
...
with slides.Presentation("AnimExample_out.pptx") as pres:
    ...
    # Cambia TriggerType a iniciar al hacer clic
    effect.timing.trigger_type = slides.animation.EffectTriggerType.ON_CLICK

    # Cambia la duración del efecto
    effect.timing.duration = 3

    # Cambia el retraso de activación del efecto
...
with Presentation("AnimExample_out.pptx") as pres:
    ...
    # Comprueba el efecto para "No Sound"
...
- Propiedad `after_animation_type` que describe el tipo de After animation:  
  ...
  * **Don't Dim** de PowerPoint coincide con el tipo [DO_NOT_DIM](https://reference.aspose.com/slides/python-net/aspose.slides.animation/afteranimationtype/) (valor predeterminado);  
  * **Hide After Animation** de PowerPoint coincide con el tipo [HIDE_AFTER_ANIMATION](https://reference.aspose.com/slides/python-net/aspose.slides.animation/afteranimationtype/);  
  * **Hide on Next Mouse Click** de PowerPoint coincide con el tipo [HIDE_ON_NEXT_MOUSE_CLICK](https://reference.aspose.com/slides/python-net/aspose.slides.animation/afteranimationtype/);  
- Propiedad `after_animation_color` que define el formato de color después de la animación. Esta propiedad funciona junto con el tipo [COLOR](https://reference.aspose.com/slides/python-net/aspose.slides.animation/afteranimationtype/). Si cambias el tipo a otro, el color after animation se borrará.  
...
with slides.Presentation("AnimImage_out.pptx") as pres:
    ...
    # Cambia el tipo after animation a Color
    first_effect.after_animation_type = AfterAnimationType.COLOR

    # Establece el color after animation dim
...
- `delay_between_text_parts` establece un retraso entre las partes de texto animado (palabras o letras). Un valor positivo indica el porcentaje de la duración del efecto. Un valor negativo indica el retraso en segundos.  

Así se pueden cambiar las propiedades Animate text del efecto:
...
with slides.Presentation("AnimTextBox_out.pptx") as pres:
    ...
    # Cambia el tipo Animate text del efecto a "By word"
...
**¿Cómo puedo asegurarme de que las animaciones se conserven al publicar la presentación en la web?**
