...
- Python
- Aspose.Slides
description: "Cree y personalice formas en presentaciones de PowerPoint y OpenDocument con Aspose.Slides para Python a través de .NET: rutas de geometría, esquinas curvas, formas compuestas."
---
...
* mover la esquina de un cuadrado hacia dentro o fuera,
...
* Los puntos de anclaje pueden ser **esquina**, **suave** o **recto**:
  * Un punto de **esquina** es donde se encuentran dos segmentos rectos formando un ángulo.
  ...
  * Un punto **recto** también tiene dos manejadores colineales, pero los segmentos adyacentes forman una curva suave. En este caso, los manejadores no necesitan estar a la misma distancia del punto de anclaje.
...
**Agregar una curva de Bézier cúbica** al final de una ruta:
...
**Agregar una curva de Bézier cúbica** en una posición especificada de una ruta:
...
**Agregar una curva de Bézier cuadrática** al final de una ruta:
...
**Agregar una curva de Bézier cuadrática** en una posición especificada de una ruta:
...
Aquí aprenderá cómo definir una forma libre añadiendo su propia secuencia de puntos. Al especificar puntos ordenados y tipos de segmento (recto o curvo) y, opcionalmente, cerrar la ruta, puede dibujar gráficos personalizados precisos — polígonos, íconos, globos de texto o logotipos — directamente en sus diapositivas.

1. Crear una instancia de la clase [GeometryShape](https://reference.aspose.com/slides/python-net/aspose.slides/geometryshape/) y establecer su [ShapeType.RECTANGLE](https://reference.aspose.com/slides/python-net/aspose.slides/shapetype/).
2. Obtener una instancia de [GeometryPath](https://reference.aspose.com/slides/python-net/aspose.slides/geometrypath/) de la forma.
3. Insertar un nuevo punto entre los dos puntos superiores de la ruta.
4. Insertar un nuevo punto entre los dos puntos inferiores de la ruta.
5. Aplicar la ruta actualizada a la forma.
...
1. Crear una instancia de la clase [GeometryShape](https://reference.aspose.com/slides/python-net/aspose.slides/geometryshape/) y establecer su tipo [ShapeType.HEART](https://reference.aspose.com/slides/python-net/aspose.slides/shapetype/).
2. Obtener una instancia de [GeometryPath](https://reference.aspose.com/slides/python-net/aspose.slides/geometrypath/) de la forma.
3. Eliminar un segmento de la ruta.
4. Aplicar la ruta actualizada a la forma.
...
Cree formas vectoriales a medida definiendo un [GeometryPath](https://reference.aspose.com/slides/python-net/aspose.slides/geometrypath/) y componiéndolo a partir de líneas, arcos y curvas de Bézier. Esta sección muestra cómo construir una geometría personalizada desde cero y agregar la forma resultante a su diapositiva.

1. Calcular los puntos de la forma.
2. Crear una instancia de la clase [GeometryPath](https://reference.aspose.com/slides/python-net/aspose.slides/geometrypath/).
3. Poblar la ruta con los puntos.
4. Crear una instancia de la clase [GeometryShape](https://reference.aspose.com/slides/python-net/aspose.slides/geometryshape/).
...
Crear una forma compuesta personalizada le permite combinar múltiples rutas de geometría en una sola forma reutilizable en una diapositiva. Defina y fusione estas rutas para construir visuales complejos que van más allá del conjunto estándar de formas.

1. Crear una instancia de la clase [GeometryShape](https://reference.aspose.com/slides/python-net/aspose.slides/geometryshape/).
2. Crear la primera instancia de la clase [GeometryPath](https://reference.aspose.com/slides/python-net/aspose.slides/geometrypath/).
3. Crear la segunda instancia de la clase [GeometryPath](https://reference.aspose.com/slides/python-net/aspose.slides/geometrypath/).
4. Aplicar ambas rutas a la forma.

El siguiente código Python muestra cómo crear una forma compuesta personalizada:
...
Esta sección muestra cómo dibujar una forma personalizada con esquinas suavemente curvas usando una ruta de geometría. Combinará segmentos rectos y arcos circulares para formar el contorno y añadirá la forma terminada a su diapositiva.
...
Una forma cerrada se define como aquella en la que todos sus lados están conectados, formando un solo contorno sin huecos. Tal forma puede ser una forma geométrica simple o un contorno personalizado complejo. El siguiente ejemplo de código muestra cómo comprobar si la geometría de una forma está cerrada:
...
Utilice la propiedad [rotation](https://reference.aspose.com/slides/python-net/aspose.slides/geometryshape/rotation/) de la forma; la geometría gira con la forma porque está vinculada al propio sistema de coordenadas de la forma.
