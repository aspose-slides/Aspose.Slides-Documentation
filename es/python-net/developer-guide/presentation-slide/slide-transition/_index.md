...
- Python
- Aspose.Slides
description: "Descubra cómo personalizar las transiciones de diapositivas en Aspose.Slides para Python mediante .NET, con una guía paso a paso para presentaciones de PowerPoint y OpenDocument."
---

## **Visión general**

Aspose.Slides for Python brinda control total sobre las transiciones de diapositivas, desde la selección del tipo de transición hasta la configuración de tiempos y disparadores como parte de flujos de trabajo automatizados de presentaciones. Puede establecer que las diapositivas avancen al hacer clic y/o después de un retraso especificado, y refinar el comportamiento visual con efectos como cortes desde negro o entradas direccionales. La biblioteca también admite la transición Morph introducida en PowerPoint 2019, incluidos los modos que morph por objeto, palabra o carácter para crear un movimiento fluido y coherente entre diapositivas.

## **Agregar transiciones de diapositiva**

Para facilitar la comprensión, este ejemplo muestra cómo usar Aspose.Slides for Python para gestionar transiciones de diapositiva simples. Los desarrolladores pueden aplicar diferentes efectos de transición a las diapositivas y personalizar su comportamiento. Para crear una transición de diapositiva sencilla, siga estos pasos:

1. Cree una instancia de la [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/) class.
1. Aplique una transición de diapositiva usando uno de los efectos del enum [TransitionType](https://reference.aspose.com/slides/python-net/aspose.slides.slideshow/transitiontype/).
...
with slides.Presentation("sample.pptx") as presentation:
    # Aplicar una transición de círculo a la diapositiva 1.
...
## **Agregar transiciones de diapositiva avanzadas**
...
El fragmento de código siguiente muestra cómo clonar una diapositiva que contiene texto y aplicar una transición Morph a la segunda diapositiva.
...
with slides.Presentation() as presentation:
    ...
    # Clonar la primera diapositiva para crear una segunda diapositiva con las mismas formas para la continuidad Morph.
...
El enum [TransitionMorphType](https://reference.aspose.com/slides/python-net/aspose.slides.slideshow/transitionmorphtype/) representa los diferentes tipos de transiciones de diapositiva Morph.

El fragmento de código siguiente muestra cómo aplicar una transición Morph a una diapositiva y cambiar el tipo de morph:
...
En el ejemplo siguiente, establecemos varios efectos de transición.
...
with slides.Presentation("sample.pptx") as presentation:
    ...
    # Aplicar una transición de corte y habilitar From Black.
...
Sí. Establezca la [speed](https://reference.aspose.com/slides/python-net/aspose.slides.slideshow/slideshowtransition/speed/) de la transición mediante la configuración [TransitionSpeed](https://reference.aspose.com/slides/python-net/aspose.slides.slideshow/transitionspeed/) (por ejemplo, lento/medio/rápido).
...
Inspeccione la [transition settings](https://reference.aspose.com/slides/python-net/aspose.slides/slide/) de la diapositiva y lea su [transition type](https://reference.aspose.com/slides/python-net/aspose.slides.slideshow/slideshowtransition/type/); ese valor le indica exactamente qué efecto está aplicado.