...
2. Aplique una transición de diapositiva usando uno de los efectos del enum [TransitionType](https://reference.aspose.com/slides/python-net/aspose.slides.slideshow/transitiontype/).
