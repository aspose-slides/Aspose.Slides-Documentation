...
- Python
- Aspose.Slides
description: "Crear presentaciones de PowerPoint en Python con Aspose.Slides—generar archivos PPT, PPTX y ODP, beneficiarse del soporte OpenDocument y guardarlos programáticamente para obtener resultados fiables."
---
...
3. Añada un objeto [AutoShape](https://reference.aspose.com/slides/python-net/aspose.slides/autoshape/) de tipo `CLOUD` usando el método `add_auto_shape` expuesto por la colección `shapes`.
...
Puede guardarla en [PPTX, PPT y ODP](/slides/es/python-net/save-presentation/), y exportarla a [PDF](/slides/es/python-net/convert-powerpoint-to-pdf/), [XPS](/slides/es/python-net/convert-powerpoint-to-xps/), [HTML](/slides/es/python-net/convert-powerpoint-to-html/), [SVG](/slides/es/python-net/convert-powerpoint-to-png/), y [imágenes](/slides/es/python-net/convert-powerpoint-to-png/), entre otros.
...
Establezca el [tamaño de diapositiva](/slides/es/python-net/slide-size/) (incluyendo preajustes como 4:3 y 16:9 o dimensiones personalizadas) y elija cómo debe escalar el contenido.
...
No es posible operar sobre la misma instancia de [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/) desde [múltiples hilos](/slides/es/python-net/multithreading/). Ejecute instancias separadas e aisladas por hilo o proceso.

**¿Cómo elimino la marca de agua de prueba y las limitaciones?**

[Aplique una licencia](/slides/es/python-net/licensing/) una vez por proceso. El XML de la licencia debe permanecer sin modificar, y la configuración de la licencia debe sincronizarse si hay varios hilos involucrados.
