...
- Python
- Aspose.Slides
description: "Aprenda a gestionar marcas de agua de texto e imagen en presentaciones PowerPoint y OpenDocument con Python para indicar borrador, información confidencial, derechos de autor y más."
---

## **Acerca de las marcas de agua**

**Una marca de agua** en una presentación es un sello de texto o imagen que se usa en una diapositiva o en todas las diapositivas de la presentación. Normalmente, una marca de agua se utiliza para indicar que la presentación es un borrador (p. ej., una marca de agua “Borrador”), que contiene información confidencial (p. ej., una marca de agua “Confidencial”), para especificar a qué empresa pertenece (p. ej., una marca de agua “Nombre de la empresa”), para identificar al autor de la presentación, etc. Una marca de agua ayuda a prevenir violaciones de derechos de autor al indicar que la presentación no debe ser copiada. Las marcas de agua se usan tanto en formatos PowerPoint como OpenOffice. En Aspose.Slides, puede agregar una marca de agua a los archivos PPT, PPTX y ODP de PowerPoint y OpenOffice.

En [**Aspose.Slides**](https://products.aspose.com/slides/python-net/), existen diversas formas de crear marcas de agua en documentos PowerPoint u OpenOffice y de modificar su diseño y comportamiento. El aspecto común es que, para agregar marcas de agua de texto, debe usar la clase [TextFrame](https://reference.aspose.com/slides/python-net/aspose.slides/textframe/), y para agregar marcas de agua de imagen, use la clase [PictureFrame](https://reference.aspose.com/slides/python-net/aspose.slides/pictureframe/) o rellene una forma de marca de agua con una imagen. `PictureFrame` implementa la clase [Shape](https://reference.aspose.com/slides/python-net/aspose.slides/shape/), lo que le permite usar todas las configuraciones flexibles del objeto forma. Dado que `TextFrame` no es una forma y sus configuraciones son limitadas, se envuelve dentro de un objeto [Shape](https://reference.aspose.com/slides/python-net/aspose.slides/shape/).
...
Una marca de agua usualmente se considera no editable por otros usuarios. Para evitar que la marca de agua (o más bien la forma que la contiene) sea editada, Aspose.Slides ofrece la funcionalidad de bloqueo de formas. Una forma específica puede bloquearse en una diapositiva normal o en el Maestro de diapositivas. Cuando la forma de la marca de agua está bloqueada en el Maestro de diapositivas, se bloqueará en todas las diapositivas de la presentación.
...
{{% alert color="primary" title="Ver también" %}} 
- [Cómo usar el Maestro de diapositivas](/slides/es/python-net/slide-master/)
{{% /alert %}}
...
En Aspose.Slides, el orden Z de las formas puede establecerse mediante el método [ShapeCollection.reorder](https://reference.aspose.com/slides/python-net/aspose.slides/ishapecollection/reorder/#int-ishape). Para ello, debe llamar a este método desde la lista de diapositivas de la presentación y pasar la referencia de la forma y su número de orden. De este modo, es posible llevar una forma al frente o enviarla al fondo de la diapositiva. Esta característica es especialmente útil si necesita colocar una marca de agua delante del contenido de la presentación:
...
A continuación se muestra un ejemplo de código sobre cómo ajustar la rotación de la marca de agua para que quede diagonalmente a lo largo de la diapositiva:
...
Aspose.Slides le permite establecer el nombre de una forma. Al usar el nombre de la forma, podrá acceder a ella en el futuro para modificarla o eliminarla. Para asignar un nombre a la forma de la marca de agua, asígnele la propiedad [AutoShape.name](https://reference.aspose.com/slides/python-net/aspose.slides/autoshape/name/):
...
Puede probar las herramientas en línea gratuitas de **Aspose.Slides** **Agregar marca de agua** [Add Watermark](https://products.aspose.app/slides/watermark) y **Eliminar marca de agua** [Remove Watermark](https://products.aspose.app/slides/watermark/remove-watermark).
...
Una marca de agua es una superposición de texto o imagen aplicada a las diapositivas que ayuda a proteger la propiedad intelectual, reforzar el reconocimiento de marca o impedir el uso no autorizado de presentaciones.

**¿Puedo agregar una marca de agua a todas las diapositivas de una presentación?**

Sí, Aspose.Slides permite agregar una marca de agua a cada diapositiva de una presentación. Puede iterar por todas las diapositivas y aplicar la configuración de la marca de agua individualmente.

**¿Cómo puedo ajustar la transparencia de la marca de agua?**

Puede ajustar la transparencia modificando la configuración de relleno ([FillFormat](https://reference.aspose.com/slides/python-net/aspose.slides/fillformat/)) de la forma. Esto garantiza que la marca de agua sea sutil y no distraiga del contenido de la diapositiva.
...
Puede modificar la posición y orientación ajustando las coordenadas, el tamaño y las propiedades de rotación de la [forma](https://reference.aspose.com/slides/python-net/aspose.slides/shape/).