...
- Python
- Aspose.Slides
description: "Aprenda a firmar digitalmente archivos PowerPoint y OpenDocument con Aspose.Slides para Python vía .NET. Proteja sus diapositivas en segundos con ejemplos de código claros."
---

**Certificado digital** se utiliza para crear una presentación de PowerPoint protegida con contraseña, marcada como creada por una organización o persona en particular. El certificado digital puede obtenerse contactando a una organización autorizada: una autoridad de certificación. Después de instalar el certificado digital en el sistema, puede usarse para añadir una firma digital a la presentación mediante Archivo → Información → Proteger presentación:
...
## **Añadir firma digital desde certificado PFX**
El siguiente ejemplo de código muestra cómo añadir una firma digital desde un certificado PFX:

1. Abra el archivo PFX y pase la contraseña PFX a un objeto [**DigitalSignature**](https://reference.aspose.com/slides/python-net/aspose.slides/digitalsignature/).
...
with slides.Presentation() as pres:
    ...
    signature.comments = "Prueba de firma digital con Aspose.Slides."
    ...
    if len(pres.digital_signatures) > 0:
        ...
        for signature in pres.digital_signatures :
            print(signature.certificate.subject_name.name + ", "
                    + signature.sign_time.strftime("yyyy-MM-dd HH:mm") + " -- " + "VÁLIDA" if signature.is_valid else "NO VÁLIDA")
        ...
        if allSignaturesAreValid:
            ...
            print("La presentación ha sido modificada después de la firma.")
```
...
No. Una firma preserva la integridad y la autoría, pero no bloquea las ediciones. Para restringir la edición, combínela con ["Solo lectura" o una contraseña](/slides/es/python-net/password-protected-presentation/).
