...
- Python
- Aspose.Slides
description: "Empaquete Aspose.Slides for Python via .NET con PyInstaller. Siga esta guía para agrupar, configurar y solucionar problemas de su aplicación en un ejecutable independiente."
---
...
Sin embargo, PyInstaller a veces puede omitir importaciones ocultas —módulos que se importan dinámicamente o indirectamente en su código. Para incluir una importación oculta, use las opciones de PyInstaller. Las dependencias de la extensión se especifican en los hooks de PyInstaller que se entregan con Aspose.Slides for Python via .NET.
...
Puede guardar el archivo XML de licencia junto al ejecutable o incorporarlo como recurso y cargarlo desde una ruta accesible antes de la primera llamada a la API. Importante: no modifique el contenido del XML (ni siquiera los saltos de línea).
