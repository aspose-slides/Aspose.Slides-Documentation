---
title: Solución funcional para el redimensionamiento de la hoja de cálculo
type: docs
weight: 40
...
- Python
- Aspose.Slides
description: "Soluciona el redimensionamiento OLE de la hoja de cálculo de Excel en presentaciones: dos formas de mantener los marcos de los objetos consistentes - escalar el marco o la hoja - en los formatos PPT y PPTX."
---
...
Existen dos enfoques para solucionar el problema de cambio de tamaño de la hoja de cálculo. La selección del enfoque apropiado depende de los requisitos específicos y del caso de uso. Ambos enfoques funcionan de la misma manera, ya sea que las presentaciones se creen a partir de una plantilla o desde cero. Además, no hay límite en el tamaño del marco del objeto OLE en esta solución.
