...
{{% alert color="primary" %}} 
Lee más sobre cómo [Renderizar Presentación con Fuente de Respaldo](/slides/es/cpp/render-presentation-with-fallback-font/).
{{% /alert %}}