...
Cuando trabajas con [SchemeColor](https://reference.aspose.com/slides/es/cpp/aspose.slides/schemecolor/), puedes observar que contiene los siguientes valores de color del tema:
...
Esta diferencia es solo de denominación. Estos valores se refieren a los mismos espacios de color del tema y el mapeo es fijo:
...
Esta diferencia de nomenclatura proviene de la terminología de Microsoft Office. Las versiones antiguas de Office utilizaban `Dark 1`, `Light 1`, `Dark 2` y `Light 2`, mientras que las versiones más recientes de la interfaz presentan los mismos espacios como `Text 1`, `Background 1`, `Text 2` y `Background 2`.

## **Cambiar fuente del tema**

Para permitirte seleccionar fuentes para los temas y otros fines, Aspose.Slides usa estos identificadores especiales (similares a los que usa PowerPoint):
...
Puede que quieras ver [Fuentes de PowerPoint](/slides/es/cpp/powerpoint-fonts/).
...
Puede que quieras ver [Fondo de PowerPoint](/slides/es/cpp/presentation-background/).
...
Sí. Aspose.Slides soporta sobrescrituras de tema a nivel de diapositiva, por lo que puedes aplicar un tema local solo a esa diapositiva mientras mantienes intacto el tema master (a través del [SlideThemeManager](https://reference.aspose.com/slides/es/cpp/aspose.slides.theme/slidethememanager/)).

### ¿Cuál es la forma más segura de trasladar un tema de una presentación a otra?

[Clonar diapositivas](/slides/es/cpp/clone-slides/) junto con su master en la presentación de destino. Esto conserva el master original, los diseños y el tema asociado, de modo que la apariencia permanezca coherente.

### ¿Cómo puedo ver los valores “efectivos” después de toda la herencia y sobrescrituras?

Utiliza las vistas ["effective"](/slides/es/cpp/shape-effective-properties/) de la API para tema/color/fuente/efecto. Estas devuelven las propiedades resueltas y finales tras aplicar el master más cualquier sobrescritura local.