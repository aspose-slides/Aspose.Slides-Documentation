...
- C++
- Aspose.Slides
description: "Convertir ODP a PPTX con Aspose.Slides para C++. Ejemplos de código limpios, consejos para procesamiento por lotes y resultados de alta calidad—no se necesita PowerPoint."
---

## **Conversión de ODP a PPTX**

Aspose.Slides para .NET ofrece la clase **Presentation** que representa un archivo de presentación. [**Presentation**](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation) la clase ahora también puede acceder a ODP mediante el constructor Presentation cuando se instancia el objeto. El siguiente ejemplo muestra cómo convertir una presentación ODP en una presentación PPTX.
``` cpp
...
Sí. Aspose.Slides admite la detección de protección, la apertura y el trabajo con [presentaciones protegidas](/slides/es/cpp/password-protected-presentation/) (incluido ODP) cuando se proporciona la contraseña, así como la configuración del cifrado y el acceso a las propiedades del documento.
