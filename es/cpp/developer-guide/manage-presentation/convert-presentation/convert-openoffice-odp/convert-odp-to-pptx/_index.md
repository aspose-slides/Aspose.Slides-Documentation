...
- C++
- Aspose.Slides
description: "Convertir ODP a PPTX con Aspose.Slides para C++. Ejemplos de código limpios, consejos de procesamiento por lotes y resultados de alta calidad—sin necesidad de PowerPoint."
---
...
Sí. Aspose.Slides admite la detección de protección, la apertura y el trabajo con [presentaciones protegidas](/slides/es/cpp/password-protected-presentation/) (incluido ODP) cuando proporciona la contraseña, así como la configuración de cifrado y el acceso a las propiedades del documento.
