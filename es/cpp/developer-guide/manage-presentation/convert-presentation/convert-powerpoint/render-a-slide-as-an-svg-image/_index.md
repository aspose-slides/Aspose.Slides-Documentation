...
- **imprimir su presentación en un *formato muy grande*.** Las imágenes SVG pueden escalar a cualquier resolución o nivel. Puede cambiar el tamaño de las imágenes SVG tantas veces como sea necesario sin sacrificar calidad.  
- **usar gráficos y tablas de sus diapositivas en *diferentes medios o plataformas*.** La mayoría de los lectores pueden interpretar archivos SVG.  
...
Aspose.Slides for C++ le permite exportar las diapositivas de sus presentaciones como imágenes SVG. Siga estos pasos para generar imágenes SVG:
...
{{% alert color="primary" %}} 
Puede probar nuestra [aplicación web gratuita](https://products.aspose.app/slides/conversion/ppt-to-svg) en la que implementamos la función de conversión de PPT a SVG de Aspose.Slides para C++.  
{{% /alert %}} 

Este código de muestra en C++ le muestra cómo convertir PPT a SVG usando Aspose.Slides:
``` cpp
...
El soporte para características específicas de SVG se implementa de manera diferente en los motores de los navegadores. Los parámetros de [SVGOptions](https://reference.aspose.com/slides/cpp/aspose.slides.export/svgoptions/) ayudan a suavizar las incompatibilidades.  

**¿Es posible exportar no solo diapositivas sino también formas individuales a SVG?**  

Sí. Cualquier [forma puede guardarse como un SVG separado](https://reference.aspose.com/slides/cpp/aspose.slides/shape/writeassvg/), lo que resulta práctico para íconos, pictogramas y reutilización de gráficos.  
