...
Guardar una presentación PowerPoint o OpenDocument a TIFF con notas usando Aspose.Slides for C++ implica los siguientes pasos:
...
Sí. Las fuentes faltantes provocan una [sustitución](/slides/es/cpp/font-selection-sequence/), lo que puede cambiar las métricas y la apariencia del texto. Para evitarlo, [provea las fuentes requeridas](/slides/es/cpp/custom-font/) o configure una [fuente de respaldo predeterminada](/slides/es/cpp/fallback-font/) para que se usen los tipos de letra previstos.