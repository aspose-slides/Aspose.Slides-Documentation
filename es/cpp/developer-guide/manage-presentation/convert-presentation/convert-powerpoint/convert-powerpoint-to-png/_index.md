...
1. Instancie la clase [Presentation](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation).
2. Obtenga el objeto diapositiva de la colección [Presentation::get_Slides()](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#a9981b38f5a01d9fa5482f05b0a75974c) bajo la interfaz [ISlide](https://reference.aspose.com/slides/cpp/class/aspose.slides.i_slide). 
3. Utilice el método [ISlide::GetImage()](https://reference.aspose.com/slides/cpp/aspose.slides/islide/getimage) para obtener la miniatura de cada diapositiva. 
4. Utilice el método [IImage::Save(String, ImageFormatPtr](https://reference.aspose.com/slides/cpp/aspose.slides/iimage/save/#iimagesavesystemstring-imageformat-method) para guardar la miniatura de la diapositiva en formato PNG. 

Este código C++ le muestra cómo convertir una presentación de PowerPoint a PNG:
```cpp
...
Si desea obtener archivos PNG con una cierta escala, puede establecer los valores de `desiredX` y `desiredY`, que determinan las dimensiones de la miniatura resultante. 
...
Si desea obtener archivos PNG con un tamaño determinado, puede pasar los argumentos `width` y `height` preferidos para `ImageSize`. 
...
Aspose.Slides admite [generar miniaturas para formas individuales](/slides/es/cpp/create-shape-thumbnails/); puede renderizar una forma a una imagen PNG.

**¿Se admite la conversión paralela en un servidor?**

Sí, pero [no comparta](/slides/es/cpp/multithreading/) una única instancia de presentación entre hilos. Use una instancia separada por hilo o proceso.
