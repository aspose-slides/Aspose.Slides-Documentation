...
Este código de ejemplo le muestra cómo convertir una presentación a GIF animado usando configuraciones personalizadas en C++:
``` cpp
auto gifOptions = System::MakeObject<GifOptions>();
// el tamaño del GIF resultante 
gifOptions->set_FrameSize(Size(960, 720));
// cuánto tiempo se mostrará cada diapositiva antes de pasar a la siguiente 
...
Es posible que desee probar un conversor GRATUITO de [Texto a GIF](https://products.aspose.app/slides/text-to-gif) desarrollado por Aspose. 
{{% /alert %}}
...
Instale las fuentes faltantes o [configure fuentes de respaldo](/slides/es/cpp/powerpoint-fonts/). Aspose.Slides las sustituirá, pero la apariencia puede variar. Para la identidad de marca, asegúrese siempre de que los tipos de letra requeridos estén explícitamente disponibles.
