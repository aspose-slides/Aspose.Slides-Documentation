...
- C++
- Aspose.Slides
description: "Convierta diapositivas PPT y PPTX de PowerPoint en documentos Word editables en C++ usando Aspose.Slides, manteniendo el diseño, las imágenes y el formato precisos."
---
...
Como una API independiente, [Aspose.Slides](https://products.aspose.app/slides) para C++ ofrece funciones que le permiten extraer textos de las presentaciones. 
...
Solo necesita agregar los paquetes correspondientes de [Aspose.Slides for C++](https://releases.aspose.com/slides/cpp/) y [Aspose.Words for C++](https://releases.aspose.com/words/cpp/) a su proyecto. Ambas bibliotecas funcionan como APIs independientes, y no es necesario tener instalado Microsoft Office.
