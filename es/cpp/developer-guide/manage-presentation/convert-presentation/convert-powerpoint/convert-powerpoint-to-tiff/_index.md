...
- C++
- Aspose.Slides
description: "Aprende cómo convertir fácilmente presentaciones de PowerPoint (PPT, PPTX) a imágenes TIFF de alta calidad utilizando Aspose.Slides para C++, con ejemplos de código."
---
## **Introducción**
...
Este código C++ demuestra cómo convertir la diapositiva a color a un TIFF en blanco y negro:
...
Este código C++ demuestra cómo convertir una presentación de PowerPoint a una imagen TIFF con un formato de píxel personalizado:
...
No, Aspose.Slides no impone restricciones al número de diapositivas. Puedes convertir presentaciones de cualquier tamaño al formato TIFF.
