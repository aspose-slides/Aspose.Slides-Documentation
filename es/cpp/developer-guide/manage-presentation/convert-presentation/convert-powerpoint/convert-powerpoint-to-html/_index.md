...
- C++
- Aspose.Slides
description: "Convertir presentaciones de PowerPoint a HTML adaptativo en C++. Preserve el diseño, los enlaces y las imágenes con la guía de conversión de Aspose.Slides para obtener resultados rápidos y perfectos."
---

## **Acerca de la conversión de PowerPoint a HTML**
Usando [**Aspose.Slides for C++**](https://products.aspose.com/slides/cpp/), las aplicaciones y los desarrolladores pueden convertir una presentación de PowerPoint a HTML: **PPTX a HTML** o **PPT a HTML**. 
...
* Convertir una presentación de PowerPoint a HTML adaptable.  
...
## **Convertir PowerPoint a HTML adaptable**
Aspose.Slides ofrece la clase [ResponsiveHtmlController ](https://reference.aspose.com/slides/cpp/class/aspose.slides.export.responsive_html_controller) que permite generar archivos HTML adaptables. Este código muestra cómo convertir una presentación de PowerPoint a HTML adaptable en C++:
```cpp
// Instanciar un objeto Presentation que representa un archivo de presentación
auto presentation = System::MakeObject<Presentation>(u"Convert_HTML.pptx");
...
Aspose.Slides ofrece la clase [EmbedAllFontsHtmlController](https://reference.aspose.com/slides/cpp/aspose.slides.export/embedallfontshtmlcontroller/) que permite incrustar todas las fuentes de una presentación al convertirla a HTML.

Para evitar que se incrusten determinadas fuentes, puede pasar una matriz de nombres de fuente a un constructor parametrizado de la clase [EmbedAllFontsHtmlController](https://reference.aspose.com/slides/cpp/aspose.slides.export/embedallfontshtmlcontroller/). Fuentes populares, como Calibri o Arial, cuando se usan en una presentación, no tienen que incrustarse porque la mayoría de los sistemas ya las contienen. Cuando esas fuentes se incrustan, el documento HTML resultante se vuelve innecesariamente grande.

La clase [EmbedAllFontsHtmlController](https://reference.aspose.com/slides/cpp/aspose.slides.export/embedallfontshtmlcontroller/) admite herencia y proporciona el método [WriteFont](https://reference.aspose.com/slides/cpp/aspose.slides.export/embedallfontshtmlcontroller/writefont/) que está pensado para ser sobrescrito. 
```cpp
...
Este código en C++ muestra cómo generar HTML con imágenes a máxima calidad:
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
Este código C++ muestra cómo convertir una diapositiva de una presentación de PowerPoint a HTML:
``` cpp
...
El código C++ en este ejemplo muestra cómo usar métodos sobrescribibles para crear un documento HTML personalizado con un enlace a un archivo CSS:
``` cpp
...
Este código C++ muestra cómo convertir un PowerPoint a HTML vinculando todas las fuentes y excluyendo "Calibri" y "Arial" (ya que existen en el sistema):
```cpp
...
public:
        ...
        String fontStyle, String fontWeight, ArrayPtr<uint8_t> fontData)
    {
        ...
        String path = String::Format(u"{0}.woff", fontName); // puede ser necesario sanitizar la ruta
...
## **Convertir PowerPoint a HTML adaptable**
Este código C++ muestra cómo convertir una presentación de PowerPoint a HTML adaptable:
```cpp
...
Usando Aspose.Slides for C++, puede exportar archivos multimedia de esta manera:
...
1. Añada un vídeo a la diapositiva.  
1. Guarde la presentación como un archivo HTML.  

Este código C++ muestra cómo añadir un vídeo a la presentación y luego guardarla como HTML: 
```cpp
...
Sí, Aspose.Slides admite plenamente la exportación de hipervínculos incrustados a HTML. Cuando convierte presentaciones al formato HTML, los hipervínculos se conservan automáticamente y permanecen clicables.

**¿Existe algún límite en el número de diapositivas al convertir presentaciones a HTML?**

No hay límite en el número de diapositivas al usar Aspose.Slides. Puede convertir presentaciones de cualquier tamaño. Sin embargo, para presentaciones con un número muy elevado de diapositivas, el rendimiento puede depender de los recursos disponibles en su servidor o sistema.