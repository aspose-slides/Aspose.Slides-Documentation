...
- C++
- Aspose.Slides
description: "Convertir presentaciones PowerPoint a HTML responsivo en C++. Preservar el diseño, los enlaces y las imágenes con la guía de conversión de Aspose.Slides para obtener resultados rápidos y sin errores."
---

## **Descripción general**

Este artículo explica cómo convertir una presentación de PowerPoint a formato HTML usando C++. Cubre los siguientes temas.
...
Para obtener el código de ejemplo en C++ que convierte PowerPoint a HTML, consulte la sección a continuación, es decir, [Convertir PowerPoint a HTML](#convert-powerpoint-to-html). El código puede cargar varios formatos como PPT, PPTX y ODP en el objeto Presentation y guardarlo en formato HTML.
...
Es posible que también desee consultar otros [conversores gratuitos de Aspose](https://products.aspose.app/slides/conversion).
...
Aspose.Slides ofrece la clase [EmbedAllFontsHtmlController](https://reference.aspose.com/slides/cpp/class/aspose.slides.export.embed_all_fonts_html_controller) que permite incrustar todas las fuentes de una presentación al convertirla a HTML.

Para evitar que ciertas fuentes se incrusten, puede pasar una matriz de nombres de fuentes a un constructor parametrizado de la clase [EmbedAllFontsHtmlController](https://reference.aspose.com/slides/cpp/class/aspose.slides.export.embed_all_fonts_html_controller). Fuentes populares, como Calibri o Arial, cuando se usan en una presentación, no es necesario incrustarlas porque la mayoría de los sistemas ya las incluyen. Cuando esas fuentes se incrustan, el documento HTML resultante se vuelve innecesariamente grande.
...
Este código en C++ muestra cómo convertir una diapositiva de una presentación de PowerPoint a HTML:
``` cpp
...
Este código en C++ muestra cómo convertir un PowerPoint a HTML enlazando todas las fuentes y excluyendo “Calibri” y “Arial” (pues ya existen en el sistema): 
```cpp
...
Usando Aspose.Slides para C++, puede exportar archivos multimedia de esta manera:
...
Este código en C++ muestra cómo añadir un video a la presentación y luego guardarla como HTML: 
```cpp
...
Sí, Aspose.Slides admite plenamente la exportación de hipervínculos incrustados a HTML. Al convertir presentaciones a formato HTML, los hipervínculos se conservan automáticamente y siguen siendo clicables.
