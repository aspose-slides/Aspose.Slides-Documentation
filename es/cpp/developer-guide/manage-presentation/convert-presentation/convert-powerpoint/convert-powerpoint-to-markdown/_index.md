...
- C++
- Aspose.Slides
description: "Convierte diapositivas de PowerPoint—PPT, PPTX—a Markdown limpio con Aspose.Slides para C++, automatiza la documentación y conserva el formato."
---
...
La exportación de PowerPoint a markdown es **sin imágenes** por defecto. Si desea exportar un documento de PowerPoint que contenga imágenes, debe establecer `SaveOptions::MarkdownExportType::Visual)` y también especificar el `BasePath` donde se guardarán las imágenes referenciadas en el documento markdown.
...
Aspose.Slides le permite convertir PowerPoint a markdown (con sintaxis básica), CommonMark, GitHub flavored markdown, Trello, XWiki, GitLab y 17 sabores de markdown más.
...
Los 23 sabores de markdown compatibles se encuentran [listados en la enumeración Flavor](https://reference.aspose.com/slides/cpp/aspose.slides.dom.export.markdown.saveoptions/flavor/) de la clase [MarkdownSaveOptions](https://reference.aspose.com/slides/cpp/aspose.slides.dom.export.markdown.saveoptions/markdownsaveoptions/).

## **Convertir una Presentación que Contiene Imágenes a Markdown**

La clase [MarkdownSaveOptions](https://reference.aspose.com/slides/cpp/aspose.slides.dom.export.markdown.saveoptions/markdownsaveoptions/) ofrece propiedades y enumeraciones que le permiten usar ciertas opciones o configuraciones para el archivo markdown resultante. El enumerado [MarkdownExportType](https://reference.aspose.com/slides/cpp/aspose.slides.dom.export.markdown.saveoptions/markdownexporttype/), por ejemplo, puede establecerse en valores que determinan cómo se procesan las imágenes: `Sequential`, `TextOnly`, `Visual`.
...
Puede paralelizar por archivos, pero [no comparta](/slides/es/cpp/multithreading/) la misma instancia de [Presentation](https://reference.aspose.com/slides/cpp/aspose.slides/presentation/) entre hilos. Use instancias/procesos separados por archivo para evitar contenciones.

**¿Qué ocurre con las imágenes, dónde se guardan y son rutas relativas?**

Las [imágenes](/slides/es/cpp/image/) se exportan a una carpeta dedicada, y el archivo Markdown las referencia con rutas relativas por defecto. Puede configurar la ruta de salida base y el nombre de la carpeta de recursos para mantener una estructura de repositorio predecible.