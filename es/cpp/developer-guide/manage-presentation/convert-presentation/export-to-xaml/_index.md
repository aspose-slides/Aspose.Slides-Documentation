...
- C++
- Aspose.Slides
description: "Convierta diapositivas de PowerPoint y OpenDocument a XAML en C++ usando Aspose.Slides—solución rápida y sin Office que mantiene su diseño intacto."
---
...
XAML es un lenguaje de programación descriptivo que te permite crear o escribir interfaces de usuario para aplicaciones, especialmente aquellas que utilizan WPF (Windows Presentation Foundation), UWP (Universal Windows Platform) y Xamarin Forms.  
...
XAML es un lenguaje de marcado UI general usado en WPF, UWP y Xamarin.Forms. La exportación apunta a la compatibilidad con las pilas de XAML de Microsoft; el comportamiento exacto y el soporte para constructos específicos dependen de la plataforma de destino. Prueba el marcado en tu entorno.

**¿Se admiten las diapositivas ocultas y cómo puedo evitar que se exporten por defecto?**
