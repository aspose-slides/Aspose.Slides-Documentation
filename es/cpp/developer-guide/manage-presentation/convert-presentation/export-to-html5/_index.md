...
- C++
- Aspose.Slides
description: "Exporta presentaciones PowerPoint y OpenDocument a HTML5 responsivo con Aspose.Slides para C++. Conserva el formato, las animaciones y la interactividad."
---

{{% alert title="Info" color="info" %}}

En [Aspose.Slides 21.9](/slides/es/cpp/aspose-slides-for-cpp-21-9-release-notes/), implementamos el soporte para la exportación a HTML5.
...
El código C++ muestra cómo exportar una presentación a HTML5.
```cpp
...
En este caso, el contenido de la presentación se representa mediante SVG en una forma como esta:
```html
<body>
...
Al usar este método para exportar PowerPoint a HTML, debido a la representación SVG, no podrá aplicar estilos ni animar elementos específicos. 
...
**¿Se admite la salida de comentarios y dónde pueden colocarse con respecto a la diapositiva?**
