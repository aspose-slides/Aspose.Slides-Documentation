---
title: Gestionar hipervínculos de presentación en C++
...
- C++
- Aspose.Slides
description: "Gestiona fácilmente los hipervínculos en presentaciones de PowerPoint y OpenDocument con Aspose.Slides para C++ — mejora la interactividad y el flujo de trabajo en minutos."
---
## **Introducción**
...
Aspose.Slides for C++ le permite realizar muchas tareas relacionadas con hipervínculos en presentaciones. 

{{% alert color="info" %}} 

Puede que desee probar Aspose simple, [editor de PowerPoint en línea gratuito.](https://products.aspose.app/slides/es/editor)
...
Este código C++ le muestra cómo añadir un hipervínculo a un sitio web en un texto:
...
Este código de ejemplo en C++ le muestra cómo añadir un hipervínculo a un sitio web en una forma:
...
Este código de ejemplo muestra cómo añadir un hipervínculo a una **imagen**:
...
Este código de ejemplo muestra cómo añadir un hipervínculo a un **archivo de audio**:
...
Este código de ejemplo muestra cómo añadir un hipervínculo a un **vídeo**:
...
Puede que desee ver *[Administrar OLE](https://docs.aspose.com/slides/es/cpp/manage-ole/)*.
...
Este código de ejemplo muestra cómo crear una tabla de contenidos con hipervínculos:
...
Con los métodos [set_ColorSource()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink#ab739ae21025485366d44a3b72e0d7dac) y [get_ColorSource()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink#af5370af1ba9fba7b22fcc8a7ce344494) de la interfaz [IHyperlink](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink) puede establecer el color de los hipervínculos y también obtener la información de color de los mismos. La característica se introdujo por primera vez en PowerPoint 2019, por lo que los cambios relacionados con la propiedad no se aplican a versiones anteriores de PowerPoint.

Este código de ejemplo demuestra una operación en la que se añadieron hipervínculos con colores diferentes a la misma diapositiva:
...
Este código C++ le muestra cómo eliminar el hipervínculo de un texto en una diapositiva de la presentación:
...
Este código C++ le muestra cómo eliminar el hipervínculo de una forma en una diapositiva de la presentación: 
...
La clase [Hyperlink](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.hyperlink) es mutable. Con esta clase, puede cambiar los valores de los siguientes métodos:

- [IHyperlink::set_TargetFrame()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink#af2d9c5672517d98afe5868903a5a637f)
- [IHyperlink::set_Tooltip()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink#adf1c8eee89bd292292293e58da79a6f2)
- [IHyperlink.set_History()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink#a1a4a96d280f54b641e3ada3557b6688d)
- [IHyperlink.set_HighlightClick()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink#ac48a0fa4106cff14cb5772269399587e)
- [IHyperlink.set_StopSoundOnClick()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink#ad0db04da8009b329d2c79019642aaa43)
...
Puede acceder a IHyperlinkQueries desde una presentación, diapositiva o texto para el que se haya definido el hipervínculo. 

- [IPresentation::get_HyperlinkQueries()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_presentation#a7e84086f34ddc742ea9124ab11727691)
- [IBaseSlide::get_HyperlinkQueries()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_base_slide#a8593a5a5f6b7e051aa859ec373c66421)
- [ITextFrame::get_HyperlinkQueries()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_text_frame#a1303ef71d3c50d471e35434dcaaa2e4e)

La clase IHyperlinkQueries admite estos métodos: 

- [IHyperlinkQueries::GetHyperlinkClicks()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink_queries#aaea0b1b68ff2e65240612fb1f08361c1)
- [IHyperlinkQueries::GetHyperlinkMouseOvers()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink_queries#ac68ac55d183323f11e604b40760b0e4b)
- [IHyperlinkQueries::GetAnyHyperlinks()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink_queries#acaf9ded3920056054e0e70c24129d73a)
- [IHyperlinkQueries::RemoveAllHyperlinks()](https://reference.aspose.com/slides/es/cpp/class/aspose.slides.i_hyperlink_queries#a289f52c992f939fe46282536cec7222d)
...
En [PDF](/slides/es/cpp/convert-powerpoint-to-pdf/) y [HTML](/slides/es/cpp/convert-powerpoint-to-html/), sí—los enlaces suelen conservarse. Al exportar a [imágenes](/slides/es/cpp/convert-powerpoint-to-png/) y [vídeo](/slides/es/cpp/convert-powerpoint-to-video/), la posibilidad de hacer clic no se mantendrá debido a la naturaleza de esos formatos (los fotogramas rasterizados/vídeo no admiten hipervínculos).