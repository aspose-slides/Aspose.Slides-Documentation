---
title: Administrar marcadores de datos de gráficos en presentaciones usando C++
...
- C++
- Aspose.Slides
description: "Aprenda a personalizar los marcadores de datos de gráficos en Aspose.Slides para C++, incrementando el impacto de las presentaciones en formatos PPT y PPTX con claros ejemplos de código en C++."
---
...
Puede aplicar color a los puntos de datos en el gráfico usando Aspose.Slides for C++. Se han añadido las clases **[IChartDataPointLevelsManager](https://reference.aspose.com/slides/cpp/class/aspose.slides.charts.i_chart_data_point_levels_manager)** y **[IChartDataPointLevel](https://reference.aspose.com/slides/cpp/class/aspose.slides.charts.i_chart_data_point_level)** para acceder a las propiedades de los niveles de puntos de datos. Este artículo muestra cómo puede acceder y aplicar color a los puntos de datos en un gráfico.
