...
[Aspose.Slides](/slides/cpp/) para C++ te permite agregar archivos grandes (en este caso, un archivo de video grande) a través de un proceso que implica BLOBs para reducir el consumo de memoria.
