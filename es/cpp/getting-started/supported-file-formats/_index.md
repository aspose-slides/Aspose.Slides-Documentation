---
title: Formatos de Archivos Soportados
type: docs
weight: 20
url: /es/cpp/supported-file-formats/
keywords: Biblioteca C++ de PowerPoint, API C++ de PowerPoint, Formatos de PowerPoint
description: La biblioteca o API C++ de PowerPoint puede cargar y guardar varios formatos de archivo de PowerPoint, incluyendo PPT, PPTX, POT, PPS, PPSX, ODP, OTP, PDF, XPS, SVG, etc.
---
...
|**Formato**|**Descripción**|**Cargar**|**Guardar**|**Notas**|
| :- | :- | :- | :- | :- |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Formato de Archivo de Imagen de Tagged| |{{< emoticons/tick >}}| |
...
|[BMP](https://docs.fileformat.com/image/bmp/)|Mapa de Bits Independiente de Dispositivo| |{{< emoticons/tick >}}| |
...
|[HTML](https://docs.fileformat.com/web/html/)|Lenguaje de Marcas de Hipertexto|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[XAML](https://docs.fileformat.com/web/xaml/)|Lenguaje de Marcas de Aplicación Extensible| |{{< emoticons/tick >}}| |
