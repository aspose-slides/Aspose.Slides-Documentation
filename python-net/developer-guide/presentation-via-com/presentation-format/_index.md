...
Aspose.Slides for Python via .NET provides [**PresentationFactory** ](https://docs.aspose.com/slides/python-net/api-reference/aspose.slides/presentationfactory/)class that is used to get the presentation format before even loading.

In order to get presentation format. Please follow the steps below:

1. Create an instance of [**IPresentationInfo** ](https://docs.aspose.com/slides/python-net/api-reference/aspose.slides/ipresentationinfo/)class.
