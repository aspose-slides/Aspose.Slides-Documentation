...
2. Call the [add_from_pdf](https://apireference.aspose.com/slides/python-net/aspose.slides.slidecollection/addfrompdf/methods/1) method and pass the PDF file. 
3. Use the [save](https://apireference.aspose.com/slides/python-net/aspose.slides.presentation/save/methods/5) method to save the file in the PowerPoint format.
