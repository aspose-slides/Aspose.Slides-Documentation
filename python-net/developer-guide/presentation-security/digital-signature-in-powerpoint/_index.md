...
To sign presentation or check the authenticity of presentation signatures, **Aspose.Slides API** provides [**IDigitalSignature** ](https://docs.aspose.com/slides/python-net/api-reference/aspose.slides/idigitalsignature/)interface, [**IDigitalSignatureCollection** ](https://docs.aspose.com/slides/python-net/api-reference/aspose.slides/IDigitalSignatureCollection/)interface and[ **IPresentation.DigitalSignatures**](https://docs.aspose.com/slides/python-net/api-reference/aspose.slides/ipresentation/) property. Currently, digital signatures are supported for PPTX format only.
...
1. Open PFX file and pass PFX password to [**DigitalSignature** ](https://docs.aspose.com/slides/python-net/api-reference/aspose.slides/digitalsignature/)object.
