...
With methods from the [**IImageCollection**](https://docs.aspose.com/slides/python-net/api-reference/aspose.slides/iimagecollection/) interface and [**ImageCollection** ](https://docs.aspose.com/slides/python-net/api-reference/aspose.slides/imagecollection/)class, you can add a large image as a stream to get it treated as a BLOB. 
