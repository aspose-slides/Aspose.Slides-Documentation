...
## **Supported Platforms**
The platforms Aspose.Slides for Python via .NET can be used on Windows (x64 or x86), Mac OS X (intel-based processors only), and a wide range of Linux distributions with Python 3.5 or later installed. For more information, see [System Requirements](https://docs.aspose.com/slides/python-net/system-requirements/).
