---
title: IFlyThroughTransition Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 90
url: /python-net/api-reference/aspose.slides.slideshow/iflythroughtransition/
---
