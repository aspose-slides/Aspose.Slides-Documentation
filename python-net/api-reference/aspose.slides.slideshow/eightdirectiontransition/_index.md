...
|**Name**|**Description**|
| :- | :- |
|direction|Direction of transition.<br/>            Read/write [TransitionEightDirectionType](/python-net/api-reference/aspose.slides.slideshow/transitioneightdirectiontype/).|
