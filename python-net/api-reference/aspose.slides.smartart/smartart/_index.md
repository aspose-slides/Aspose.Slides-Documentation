...
|all_nodes|Returns collections of all nodes in the SmartArt object.<br/>            Read-only [ISmartArtNodeCollection](/python-net/api-reference/aspose.slides.smartart/ismartartnodecollection/).|
...
|layout|Returns or sets layout of the SmartArt object.<br/>            Read/write [SmartArtLayoutType](/python-net/api-reference/aspose.slides.smartart/smartartlayouttype/).|
|quick_style|Returns or sets quick style of SmartArt object.<br/>            Read/write [SmartArtQuickStyleType](/python-net/api-reference/aspose.slides.smartart/smartartquickstyletype/).|
|color_style|Returns or sets color style of SmartArt object.<br/>            Read/write [SmartArtColorType](/python-net/api-reference/aspose.slides.smartart/smartartcolortype/).|
