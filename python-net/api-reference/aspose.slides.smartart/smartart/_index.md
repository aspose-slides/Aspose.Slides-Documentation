...
|all_nodes|Returns collections of all nodes in the SmartArt object.<br/>            Read-only [ISmartArtNodeCollection](/slides/python-net/api-reference/aspose.slides.smartart/ismartartnodecollection/).|
...
|layout|Returns or sets layout of the SmartArt object.<br/>            Read/write [SmartArtLayoutType](/slides/python-net/api-reference/aspose.slides.smartart/smartartlayouttype/).|
|quick_style|Returns or sets quick style of SmartArt object.<br/>            Read/write [SmartArtQuickStyleType](/slides/python-net/api-reference/aspose.slides.smartart/smartartquickstyletype/).|
|color_style|Returns or sets color style of SmartArt object.<br/>            Read/write [SmartArtColorType](/slides/python-net/api-reference/aspose.slides.smartart/smartartcolortype/).|
