---
title: ISmartArt Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 10
...
|**Name**|**Description**|
| :- | :- |
|all_nodes|Returns collections of all nodes in SmartArt object.<br/>            Read-only [ISmartArtNodeCollection](/python-net/api-reference/aspose.slides.smartart/ismartartnodecollection/).|
|nodes|Returns collections of root nodes in SmartArt object.<br/>            Read-only [ISmartArtNodeCollection](/python-net/api-reference/aspose.slides.smartart/ismartartnodecollection/).|
|layout|Return or set layout of the SmartArt object.<br/>            Read/write [SmartArtLayoutType](/python-net/api-reference/aspose.slides.smartart/smartartlayouttype/).|
|quick_style|Return or set quick style of the SmartArt object.<br/>            Read/write [SmartArtQuickStyleType](/python-net/api-reference/aspose.slides.smartart/smartartquickstyletype/).|
|color_style|Return or set color style of the SmartArt object.<br/>            Read/write [SmartArtColorType](/python-net/api-reference/aspose.slides.smartart/smartartcolortype/).|
|is_reversed|Return or set the state of the SmartArt diagram with regard to (left-to-right) LTR or (right-to-left) RTL, if the diagram supports reversal.<br/>            Read/write bool.|
