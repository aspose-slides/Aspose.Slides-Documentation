...
|text_inheritance_limit|Returns or sets inhering depth for text properties.<br/>            Read/write [text_inheritance_limit](/python-net/api-reference/aspose.slides.export/itexttohtmlconversionoptions/).|
