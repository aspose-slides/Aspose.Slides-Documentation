...
|simple|Returns settings for simpliest and smallest SVG file generation.<br/>            Read-only [SVGOptions](/slides/python-net/api-reference/aspose.slides.export/svgoptions/).|
|wysiwyg|Returns settings for most accurate SVG file generation.<br/>            Read-only [SVGOptions](/slides/python-net/api-reference/aspose.slides.export/svgoptions/).|
