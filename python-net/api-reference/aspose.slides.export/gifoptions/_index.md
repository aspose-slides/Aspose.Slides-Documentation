---
title: GifOptions Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 40
...
|default_delay|Gets or sets default delay time [ms]. This value will be used if [advance_after_time](/python-net/api-reference/aspose.slides/islideshowtransition/) is not set.<br/>            The default value is 1000.|
