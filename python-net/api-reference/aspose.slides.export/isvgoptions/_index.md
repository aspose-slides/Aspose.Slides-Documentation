...
|pictures_compression|Represents the pictures compression level<br/>            Read/write [pictures_compression](/python-net/api-reference/aspose.slides.export/isvgoptions/).|
