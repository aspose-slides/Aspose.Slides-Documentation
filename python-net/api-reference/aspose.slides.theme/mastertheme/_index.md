...
|extra_color_schemes|Returns the collection of additional color schemes.<br/>            These schemes don't affect presentation's look, they can be selected as main color scheme for a slide.<br/>            Read-only [IExtraColorSchemeCollection](/slides/python-net/api-reference/aspose.slides.theme/iextracolorschemecollection/).|
