---
title: IMasterTheme Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 280
...
|**Name**|**Description**|
| :- | :- |
|extra_color_schemes|Returns the collection of additional color schemes.<br/>            These schemes don't affect presentation's look, they can be selected as main color scheme for a slide.<br/>            Read-only [IExtraColorSchemeCollection](/python-net/api-reference/aspose.slides.theme/iextracolorschemecollection/).|
