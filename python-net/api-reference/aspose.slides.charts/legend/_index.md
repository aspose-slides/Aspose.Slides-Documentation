---
title: Legend Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 980
...
|text_format|Text format.<br/>            Read-only [IChartTextFormat](/python-net/api-reference/aspose.slides.charts/icharttextformat/).|
|position|Specifies the position of the legend on a chart.<br/>            Non-NaN values of X, Y, Width, Heigt properties override effect of this property.<br/>            Read/write [LegendPositionType](/python-net/api-reference/aspose.slides.charts/legendpositiontype/).|
|format|Returns the format of a legend.<br/>            Read-only [IFormat](/python-net/api-reference/aspose.slides.charts/iformat/).|
|chart|Returns the chart.<br/>            Read-only [IChart](/python-net/api-reference/aspose.slides.charts/ichart/).|
|entries|Gets legend entries.<br/>            Read-only [ILegendEntryCollection](/python-net/api-reference/aspose.slides.charts/ilegendentrycollection/).|
|as_ilayoutable|Allows to get base ILayoutable interface.<br/>            Read-only [ILayoutable](/python-net/api-reference/aspose.slides.charts/ilayoutable/).|
