...
|text_format|Text format.<br/>            Read-only [IChartTextFormat](/slides/python-net/api-reference/aspose.slides.charts/icharttextformat/).|
...
|format|Returns the format of a legend.<br/>            Read-only [IFormat](/slides/python-net/api-reference/aspose.slides.charts/iformat/).|
|chart|Returns the chart.<br/>            Read-only [IChart](/slides/python-net/api-reference/aspose.slides.charts/ichart/).|
|entries|Gets legend entries.<br/>            Read-only [ILegendEntryCollection](/slides/python-net/api-reference/aspose.slides.charts/ilegendentrycollection/).|
