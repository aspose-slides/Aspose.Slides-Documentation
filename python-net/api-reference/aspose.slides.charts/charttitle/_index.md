---
title: ChartTitle Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 280
...
|format|Returns the fill, line, effect styles of a title.<br/>            Read-only [IFormat](/python-net/api-reference/aspose.slides.charts/iformat/).|
...
|as_ioverridable_text|Allows to get base IOverridableText interface.<br/>            Read-only [IOverridableText](/python-net/api-reference/aspose.slides.charts/ioverridabletext/).|
