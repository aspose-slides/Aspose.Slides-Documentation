---
title: Chart Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 70
...
|display_blanks_as|Returns or sets the way to plot blank cells on a chart.<br/>            Read/write [DisplayBlanksAsType](/python-net/api-reference/aspose.slides.charts/displayblanksastype/).|
|chart_data|Returns information about the linked or embedded data associated with a chart.<br/>            Read-only [IChartData](/python-net/api-reference/aspose.slides.charts/ichartdata/).|
|has_title|Determines whether a chart has a visible title.<br/>            Read/write bool.|
|chart_title|Returns or sets a chart title.<br/>            Read-only [IChartTitle](/python-net/api-reference/aspose.slides.charts/icharttitle/).|
...
|legend|Returns or sets a legend for a chart.<br/>            Read-only [ILegend](/python-net/api-reference/aspose.slides.charts/ilegend/).|
|chart_data_table|Returns a data table of a chart.<br/>            Read-only [IDataTable](/python-net/api-reference/aspose.slides.charts/idatatable/).|
|style|Returns or sets the chart style.<br/>            Read/write [StyleType](/python-net/api-reference/aspose.slides.charts/styletype/).|
|type|Returns or sets the chart type.<br/>            Read/write [ChartType](/python-net/api-reference/aspose.slides.charts/charttype/).|
|plot_area|Represents the plot area of a chart.<br/>            Read-only [IChartPlotArea](/python-net/api-reference/aspose.slides.charts/ichartplotarea/).|
|rotation3_d|Returns a 3D rotation of a chart.<br/>            Read-only [IRotation3D](/python-net/api-reference/aspose.slides.charts/irotation3d/).|
|back_wall|Returns an object which allows to change format of the back wall of a 3D chart.<br/>            Read-only [IChartWall](/python-net/api-reference/aspose.slides.charts/ichartwall/).|
|side_wall|Returns an object which allows to change format of the side wall of a 3D chart.<br/>            Read-only [IChartWall](/python-net/api-reference/aspose.slides.charts/ichartwall/).|
|floor|Returns an object which allows to change format of the floor of a 3D chart.<br/>            Read-only [IChartWall](/python-net/api-reference/aspose.slides.charts/ichartwall/).|
...
|theme_manager|Returns theme manager.<br/>            Read-only [IOverrideThemeManager](/python-net/api-reference/aspose.slides.theme/ioverridethememanager/).|
|user_shapes|Specify the shapes drawn on top of the chart.<br/>            Read-only [IGroupShape](/python-net/api-reference/aspose.slides/igroupshape/).|
|axes|Provide access to chart axes.<br/>            Read-only [IAxesManager](/python-net/api-reference/aspose.slides.charts/iaxesmanager/).|
...
|as_ithemeable|Allows to get base IThemeable interface.<br/>            Read-only [IThemeable](/python-net/api-reference/aspose.slides.theme/ithemeable/).|
