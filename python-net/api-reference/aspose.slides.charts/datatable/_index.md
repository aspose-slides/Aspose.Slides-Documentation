...
|**Name**|**Description**|
| :- | :- |
|format|Returns the line, fill, and effect styles of an object.<br/>            Read-only [IFormat](/python-net/api-reference/aspose.slides.charts/iformat/).|
...
|chart|Returns chart.<br/>            Read-only [IChart](/python-net/api-reference/aspose.slides.charts/ichart/).|
