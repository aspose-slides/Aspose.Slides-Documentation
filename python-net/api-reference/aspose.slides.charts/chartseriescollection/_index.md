...
|add(cells_with_series_name, type)|Creates new chart series from [ChartCellCollection](/slides/python-net/api-reference/aspose.slides.charts/chartcellcollection/) and adds it to the collection.|
...
|index_of(value)|Searches for the specified [ChartSeries](/slides/python-net/api-reference/aspose.slides.charts/chartseries/) and returns the zero-based index of the first occurrence within the entire Collection|
