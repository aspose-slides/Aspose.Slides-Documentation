...
|parent_series_group|Returns parent series group.<br/>            Read-only [IChartSeriesGroup](/slides/python-net/api-reference/aspose.slides.charts/ichartseriesgroup/).|
|format|Returns the format of a series.<br/>            Read-only [IFormat](/slides/python-net/api-reference/aspose.slides.charts/iformat/).|
