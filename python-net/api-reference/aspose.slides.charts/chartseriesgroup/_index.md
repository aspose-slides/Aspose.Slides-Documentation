...
|series|Returns a collection of series.<br/>            Read-only [IChartSeriesReadonlyCollection](/python-net/api-reference/aspose.slides.charts/ichartseriesreadonlycollection/).|
