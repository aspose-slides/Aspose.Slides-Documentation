...
|perspective|Returns or sets the perspective value (field of view angle) for 3D charts (between 0 and 100).<br/>            Ignored if RightAngleAxes property value is true.<br/>            Read/write int.|
