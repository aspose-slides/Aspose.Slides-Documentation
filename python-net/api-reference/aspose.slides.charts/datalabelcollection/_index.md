...
|default_data_label_format|Gets the default data label format.<br/>            Read-only [IDataLabelFormat](/python-net/api-reference/aspose.slides.charts/idatalabelformat/).|
|parent_series|Gets the parent series.<br/>            Read-only [IChartSeries](/python-net/api-reference/aspose.slides.charts/ichartseries/).|
