---
title: DataLabel Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 310
...
|data_label_format|Returns data label format.<br/>            Read-only [IDataLabelFormat](/python-net/api-reference/aspose.slides.charts/idatalabelformat/).|
