...
|category_axis_type|Specifies the type of the category axis.<br/>            Read/write [category_axis_type](/slides/python-net/api-reference/aspose.slides.charts/iaxis/).|
