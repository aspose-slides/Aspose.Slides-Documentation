...
|**Name**|**Description**|
| :- | :- |
|instance|VBA project references factory static instance.<br/>            Read-only [VbaReferenceFactory](/python-net/api-reference/aspose.slides.vba/vbareferencefactory/).|
## **Methods**
|**Name**|**Description**|
| :- | :- |
