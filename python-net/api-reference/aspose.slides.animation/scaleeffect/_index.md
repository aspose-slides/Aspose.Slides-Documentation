---
title: ScaleEffect Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 430
...
|zoom_content|Determines whether a content should be zoomed.<br/>            Read/write [NullableBool](/python-net/api-reference/aspose.slides/nullablebool/).|
