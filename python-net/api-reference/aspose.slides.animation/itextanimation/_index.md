...
| Name | Description |
| :- | :- |
|build_type|List of build type (for exp. Paragraph 1,2,3, All at Once) of text animation.<br/>            Read/write [build_type](/slides/python-net/api-reference/aspose.slides.animation/itextanimation/).|
