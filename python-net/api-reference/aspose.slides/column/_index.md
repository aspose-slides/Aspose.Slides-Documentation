...
|column_format|Returns the ColumnFormat object that contains formatting properties for this column.<br/>            Read-only [IColumnFormat](/slides/python-net/api-reference/aspose.slides/icolumnformat/).|
...
|**Name**|**Description**|
| :- | :- |
|[index]|Returns a cell by it's position.<br/>            Read-only [Cell](/slides/python-net/api-reference/aspose.slides/cell/).|
## **Methods**
|**Name**|**Description**|
| :- | :- |
