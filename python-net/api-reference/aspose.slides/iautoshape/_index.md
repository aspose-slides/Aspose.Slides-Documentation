---
title: IAutoShape Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 810
...
**Full Class Name:** aspose.slides.IAutoShape
...
|text_frame|Returns TextFrameEx object for the AutoShapeEx.<br/>            Read-only [ITextFrame](/python-net/api-reference/aspose.slides/itextframe/).|
...
|add_text_frame(text)|Adds a new TextFrameEx to a shape.<br/>            If shape already has TextFrameEx then simply changes its text.|
