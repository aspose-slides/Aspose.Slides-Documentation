...
type: docs
weight: 2620
url: /python-net/api-reference/aspose.slides/isummaryzoomsectioncollection/
---
...
| Name | Description |
| :- | :- |
|[index]|Gets the element at the specified index.<br/>            Read-only [ISummaryZoomSection](/slides/python-net/api-reference/aspose.slides/isummaryzoomsection/).|
## Methods
| Name | Description |
| :- | :- |
