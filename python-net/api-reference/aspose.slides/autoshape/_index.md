---
title: AutoShape Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 60
...
|shape_lock|Returns shape's locks.<br/>            Read-only [IAutoShapeLock](/python-net/api-reference/aspose.slides/iautoshapelock/).|
...
|auto_shape_lock|Returns autoshape's locks.<br/>            Read-only [IAutoShapeLock](/python-net/api-reference/aspose.slides/iautoshapelock/).|
|text_frame|Returns TextFrame object for the AutoShape.<br/>            Read-only [ITextFrame](/python-net/api-reference/aspose.slides/itextframe/).|
