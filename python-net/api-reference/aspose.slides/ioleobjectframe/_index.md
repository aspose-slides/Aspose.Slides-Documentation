---
title: IOleObjectFrame Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 2010
...
|embedded_data|Gets information about OLE embedded data.<br/>            Read only [IOleEmbeddedDataInfo](/python-net/api-reference/aspose.slides/ioleembeddeddatainfo/).|
