...
|system_color|Returns or sets the color identified by the system color table.<br/>            Read/write [SystemColor](/slides/python-net/api-reference/aspose.slides/systemcolor/).|
|scheme_color|Returns or sets the color identified by a color scheme.<br/>            Read/write [SchemeColor](/slides/python-net/api-reference/aspose.slides/schemecolor/).|
