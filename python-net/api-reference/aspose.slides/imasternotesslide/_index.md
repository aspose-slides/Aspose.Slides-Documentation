---
title: IMasterNotesSlide Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 1860
...
|**Name**|**Description**|
| :- | :- |
|header_footer_manager|Returns HeaderFooter manager of the master notes slide.<br/>            Read-only [IMasterNotesSlideHeaderFooterManager](/python-net/api-reference/aspose.slides/imasternotesslideheaderfootermanager/).|
