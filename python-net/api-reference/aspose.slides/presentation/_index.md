---
title: Presentation Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 3450
...
|header_footer_manager|Returns actual HeaderFooter manager.<br/>            Read-only [IPresentationHeaderFooterManager](/python-net/api-reference/aspose.slides/ipresentationheaderfootermanager/).|
...
|vba_project|Gets or sets VBA project with presentation macros.<br/>            Read/write [IVbaProject](/python-net/api-reference/aspose.slides.vba/ivbaproject/).|
...
|source_format|Returns information about from which format presentation was loaded.<br/>            Read-only [SourceFormat](/python-net/api-reference/aspose.slides/sourceformat/).|
|master_theme|Returns master theme.<br/>            Read-only [IMasterTheme](/python-net/api-reference/aspose.slides.theme/imastertheme/).|
