---
title: ICommentAuthorCollection Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 1130
...
|**Name**|**Description**|
| :- | :- |
|[index]|Gets the element at the specified index.<br/>            Read-only [ICommentAuthor](/python-net/api-reference/aspose.slides/icommentauthor/).|
## **Methods**
|**Name**|**Description**|
| :- | :- |
