---
title: MasterNotesSlide Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 3000
...
|header_footer_manager|Returns HeaderFooter manager of the master notes slide.<br/>            Read-only [IMasterHandoutSlideHeaderFooterManager](/python-net/api-reference/aspose.slides/imasterhandoutslideheaderfootermanager/).|
...
|notes_style|Returns the style of a notes text.<br/>            Read-only [ITextStyle](/python-net/api-reference/aspose.slides/itextstyle/).|
