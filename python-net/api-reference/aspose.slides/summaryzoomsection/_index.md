...
type: docs
weight: 3780
url: /python-net/api-reference/aspose.slides/summaryzoomsection/
---
...
|target_section|Gets or sets the section object that the Section Zoom object links to.<br/>            Read/write [ISection](/slides/python-net/api-reference/aspose.slides/isection/).|
...
|as_i_section_zoom_frame|Returns ISectionZoomFrame interface.|
## Methods
| Name | Description |
| :- | :- |
