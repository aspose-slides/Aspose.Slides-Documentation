---
title: LineFormat Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 2950
...
|sketch_format|Returns the sketch format of a line.<br/>            Read-only [ILineFillFormat](/python-net/api-reference/aspose.slides/ilinefillformat/).|
