...
|play_mode|Returns or sets the video play mode.<br/>            Read/write [VideoPlayModePreset](/slides/python-net/api-reference/aspose.slides/videoplaymodepreset/).|
...
|embedded_video|Returns or sets embedded video object.<br/>            Read/write [IVideo](/slides/python-net/api-reference/aspose.slides/ivideo/).|
