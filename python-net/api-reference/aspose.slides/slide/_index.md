---
title: Slide Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 3640
...
|slide_number|Returns a number of slide.<br/>            Index of slide in [slides](/python-net/api-reference/aspose.slides/presentation/) collection is always equal to SlideNumber - Presentation.FirstSlideNumber.<br/>            Read/write|
