...
|BACK_LEFT_LONG_PERSPECTIVE_SHADOW|Represents Back Left Long Perspective Shadow|
|BACK_RIGHT_LONG_PERSPECTIVE_SHADOW|Represents Back Right Long Perspective Shadow|
|TOP_LEFT_DOUBLE_DROP_SHADOW|Represents Top Left Double Drop Shadow.|
...
|BACK_LEFT_PERSPECTIVE_SHADOW|Represents Back Left Perspective Shadow.|
|BACK_RIGHT_PERSPECTIVE_SHADOW|Represents Back Right Perspective Shadow.|
|BOTTOM_LEFT_DROP_SHADOW|Represents Bottom Left Drop Shadow.|
|BOTTOM_RIGHT_DROP_SHADOW|Represents Bottom Right Drop Shadow.|
