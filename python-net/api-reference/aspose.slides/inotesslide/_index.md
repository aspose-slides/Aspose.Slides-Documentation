---
title: INotesSlide Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 1970
...
|parent_slide|Returns a ParentSlide<br/>            Read-only [ISlide](/python-net/api-reference/aspose.slides/islide/).|
