---
title: MathRightSubSuperscriptElement Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 790
...
**Full Class Name:** aspose.slides.mathtext.MathRightSubSuperscriptElement

**Assembly:**  Aspose.Slides Version: 21.12.0.0

The MathRightSubSuperscriptElement type exposes the following members:
## **Constructors**
|**Name**|**Description**|
| :- | :- |
|MathRightSubSuperscriptElement(base_arg, sub_script, super_script)|Initializes a new instance of the MathRightSubSuperscriptElement class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|base|Base argument|
