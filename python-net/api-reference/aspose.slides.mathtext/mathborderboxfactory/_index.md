---
title: MathBorderBoxFactory Class - Aspose.Slides for Python via .NET - API Reference
type: docs
weight: 550
url: /python-net/api-reference/aspose.slides.mathtext/mathborderboxfactory/
---
