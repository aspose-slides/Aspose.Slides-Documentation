...
- Java
- Aspose.Slides
description: "Découvrez tous les formats de fichier qu'Aspose.Slides pour Java peut ouvrir, enregistrer et convertir — y compris PPT, PPTX et ODP — avec des notes claires sur la prise en charge de l'import/export."
---
...
Ce tableau répertorie les formats de fichier qu'Aspose.Slides for Java peut charger et enregistrer :
...
|[EMF](https://docs.fileformat.com/image/emf/)|Format métafile amélioré| |{{< emoticons/tick >}}||
|[PDF](https://docs.fileformat.com/pdf/)|Format de document portable|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|Spécification de papier XML| |{{< emoticons/tick >}}||
...
Oui. Vous pouvez contrôler si les polices sont entièrement incorporées ou sous-ensemble (seuls les glyphes utilisés), spécifier comment les polices système courantes sont traitées et configurer le comportement du texte ASCII via les [options d'exportation PDF](https://reference.aspose.com/slides/java/com.aspose.slides/pdfoptions/).

**Puis-je détecter si un fichier est protégé par mot de passe avant de le charger réellement ?**

Oui. En utilisant l'[API d'inspection basée sur les usines](https://reference.aspose.com/slides/java/com.aspose.slides/presentationfactory/), vous pouvez interroger un fichier de présentation pour déterminer s'il est protégé par mot de passe sans l'ouvrir complètement.

**Existe-t-il des mécanismes de secours de polices et une prise en charge des polices personnalisées ?**

Oui. La bibliothèque prend en charge le [chargement](/slides/fr/java/custom-font/) et l'[incorporation](/slides/fr/java/embedded-font/) de polices personnalisées et fournit des [règles de secours de police](/slides/fr/java/fallback-font/) pour éviter les glyphes manquants lors du rendu et de la conversion.

**Puis-je exporter des diapositives vers XPS, et existe-t-il des options pour ajuster la sortie XPS ?**

Oui. L'[exportation vers XPS](/slides/fr/java/convert-powerpoint-to-xps/) est prise en charge, et vous pouvez ajuster les [options d'enregistrement](https://reference.aspose.com/slides/java/com.aspose.slides/xpsoptions/) pertinentes pour contrôler la qualité et le contenu de la sortie XPS.