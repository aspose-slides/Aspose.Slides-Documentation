...
| [Collect](https://reference.aspose.com/slides/fr/java/com.aspose.slides/collect/) | Récupération des formes de toute la présentation pour un traitement ou une analyse répétés. |
| [Compress](https://reference.aspose.com/slides/fr/java/com.aspose.slides/compress/) | Suppression des maîtres et dispositions inutilisés et réduction des données de polices incorporées. |
...
La classe [Convert](https://reference.aspose.com/slides/fr/java/com.aspose.slides/convert/) propose également des méthodes dédiées pour la sortie PDF, SVG, JPEG, PNG et TIFF. Utilisez le modèle d'objet complet lorsque vous devez inspecter ou modifier la présentation avant l'exportation ou configurer une option d'exportation qui n'est pas exposée par l'assistant sélectionné. Consultez [Convert Presentation](/slides/fr/java/convert-presentation/) pour les flux de travail et options spécifiques à chaque format.

## **Fusionner des présentations**

Utilisez [Merger.process](https://reference.aspose.com/slides/fr/java/com.aspose.slides/merger/#process-java.lang.String:A-java.lang.String-) pour combiner des fichiers de présentation complets en un seul appel. Les présentations d'entrée doivent avoir le même format de fichier.
...
Par défaut, le parcours des formes et du texte à l'échelle de la présentation inclut les diapositives normales, maîtres et de disposition. Les surcharges avec un paramètre `includeNotes` peuvent également traiter les diapositives de notes. Utilisez des boucles de collection directes lorsque l'ordre de parcours, une sortie anticipée, un filtrage avant l'invocation du rappel ou un contrôle détaillé parent‑enfant est important.
...
La classe [Compress](https://reference.aspose.com/slides/fr/java/com.aspose.slides/compress/) peut supprimer les éléments structurels inutilisés et réduire les données de polices incorporées :

- [Compress.removeUnusedLayoutSlides](https://reference.aspose.com/slides/fr/java/com.aspose.slides/compress/#removeUnusedLayoutSlides-com.aspose.slides.Presentation-) supprime les diapositives de disposition qui ne sont référencées par aucune diapositive normale.
- [Compress.removeUnusedMasterSlides](https://reference.aspose.com/slides/fr/java/com.aspose.slides/compress/#removeUnusedMasterSlides-com.aspose.slides.Presentation-) supprime les maîtres qui ne sont plus utilisés.
- [Compress.compressEmbeddedFonts](https://reference.aspose.com/slides/fr/java/com.aspose.slides/compress/#compressEmbeddedFonts-com.aspose.slides.Presentation-) supprime les caractères inutilisés des polices incorporées.
...
Supprimez d'abord les dispositions inutilisées, puis les maîtres inutilisés afin qu'un maître devenant non référencé après le nettoyage des dispositions puisse également être supprimé. Enregistrez la présentation optimisée dans un nouveau fichier si vous devez éventuellement conserver les maîtres, les dispositions ou les données complètes des polices incorporées d'origine. Pour plus de détails, consultez [Slide Master](/slides/fr/java/slide-master/) et [Embedded Font](/slides/fr/java/embedded-font/).

## **FAQ**

**Quand faut‑il utiliser l'API à faible code plutôt que le modèle d'objet complet ?**
...
- [Convert Presentation](/slides/fr/java/convert-presentation/)
- [Merge Presentations](/slides/fr/java/merge-presentation/)
- [Slide Master](/slides/fr/java/slide-master/)
- [Manage Text Box](/slides/fr/java/manage-textbox/)
- [Embedded Font](/slides/fr/java/embedded-font/)