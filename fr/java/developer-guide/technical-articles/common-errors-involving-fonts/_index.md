...
Ce problème survient dans les systèmes soumis aux restrictions suivantes :

1. Lorsqu'aucune police n’est installée ou que le dossier de polices du processus Java ne peut pas être accédé
...
{{% alert color="warning" %}}
Dans certains cas, il se peut que vous ne puissiez pas accorder l’accès aux dossiers en raison de restrictions imposées par l’environnement ou une politique de sécurité. Essayez ces solutions de contournement :
{{% /alert %}}
...
3. Installez les polices.
   ...
   * En utilisant [FontsLoader](https://reference.aspose.com/slides/fr/java/com.aspose.slides/FontsLoader): 
