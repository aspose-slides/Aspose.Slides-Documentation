...
Cette page liste toutes les [classes ajoutées](/slides/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-14-6-0/), méthodes, propriétés, etc., toutes les nouvelles restrictions et autres changements introduits avec l'API Aspose.Slides pour Java 14.6.0.
