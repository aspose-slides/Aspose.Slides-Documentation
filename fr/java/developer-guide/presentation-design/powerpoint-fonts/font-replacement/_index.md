...
Pour définir des règles qui déterminent ce qui se passe dans certaines conditions (si une police ne peut pas être accédée, par exemple), consultez [**Substitution de police**](/slides/fr/java/font-substitution/). 
