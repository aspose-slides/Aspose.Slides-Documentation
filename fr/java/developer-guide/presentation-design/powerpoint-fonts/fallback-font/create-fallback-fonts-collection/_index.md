...
- Java
- Aspose.Slides
description: "Configurez une collection de polices de secours dans Aspose.Slides pour Java afin de garder le texte cohérent et net dans les présentations PowerPoint et OpenDocument."
---
...
Voici un exemple de création d'une collection de règles de police de secours et de son affectation au [FontsManager](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation#getFontsManager--) d’une présentation donnée :  
```java
