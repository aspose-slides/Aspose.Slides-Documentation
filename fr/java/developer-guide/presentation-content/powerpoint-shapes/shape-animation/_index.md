---
title: Appliquer des animations de forme dans les présentations en Java
...
- Java
- Aspose.Slides
description: "Découvrez comment créer et personnaliser des animations de forme dans les présentations PowerPoint avec Aspose.Slides pour Java. Démarquez-vous!"
---
## **Introduction**

Les animations sont des effets visuels qui peuvent être appliqués aux textes, images, formes ou [diagrammes](https://docs.aspose.com/slides/fr/java/animated-charts/). Elles donnent vie aux présentations ou à leurs éléments. 
...
PowerPoint offre de nombreuses options et outils pour les animations et les effets d'animation dans les catégories **entrance**, **exit**, **emphasis** et **motion paths**. 
...
* Aspose.Slides propose plus de **150 effets d'animation** sous l'énumération [EffectType](https://reference.aspose.com/slides/fr/java/com.aspose.slides/effecttype). Ces effets sont essentiellement les mêmes (ou équivalents) que ceux utilisés dans PowerPoint.

## **Appliquer une animation à une zone de texte**

Aspose.Slides for Java vous permet d'appliquer une animation au texte d'une forme. 
...
3. Ajoutez un `rectangle` [IAutoShape](https://reference.aspose.com/slides/fr/java/com.aspose.slides/iautoshape). 
4. Ajoutez du texte à [IAutoShape.TextFrame](https://reference.aspose.com/slides/fr/java/com.aspose.slides/IAutoShape#addTextFrame-java.lang.String-).
5. Obtenez une séquence principale d'effets.
6. Ajoutez un effet d'animation à [IAutoShape](https://reference.aspose.com/slides/fr/java/com.aspose.slides/iautoshape). 
...
En plus d'appliquer des animations au texte, vous pouvez également appliquer des animations à un seul [Paragraph](https://reference.aspose.com/slides/fr/java/com.aspose.slides/iparagraph). Voir [**Animated Text**](/slides/fr/java/animated-text/).
...
3. Ajoutez ou récupérez un [PictureFrame](https://reference.aspose.com/slides/fr/java/com.aspose.slides/pictureframe) sur la diapositive. 
4. Obtenez la séquence principale d'effets.
5. Ajoutez un effet d'animation à [PictureFrame](https://reference.aspose.com/slides/fr/java/com.aspose.slides/pictureframe).
...
2. Obtenez une référence à la diapositive par son index.
3. Ajoutez un `rectangle` [IAutoShape](https://reference.aspose.com/slides/fr/java/com.aspose.slides/iautoshape). 
4. Ajoutez un `Bevel` [IAutoShape](https://reference.aspose.com/slides/fr/java/com.aspose.slides/iautoshape). (lorsque cet objet est cliqué, l'animation est déclenchée).
...
Ce code Java montre comment appliquer l'effet `PathFootball` (path football) à une forme :
...
Les exemples suivants montrent comment utiliser la méthode `getEffectsByShape` de l'interface [ISequence](https://reference.aspose.com/slides/fr/java/com.aspose.slides/isequence/) pour obtenir tous les effets d'animation appliqués à une forme.
...
Aspose.Slides for Java vous permet de modifier les propriétés de synchronisation d'un effet d'animation.

Voici le panneau de synchronisation d'animation dans Microsoft PowerPoint :

![volet de synchronisation d'animation](shape-animation.png)

- Le menu déroulant **Start** du synchronisation PowerPoint correspond à la propriété [Effect.Timing.TriggerType](https://reference.aspose.com/slides/fr/java/com.aspose.slides/ITiming#getTriggerType--).
- Le champ **Duration** du synchronisation PowerPoint correspond à la propriété [Effect.Timing.Duration](https://reference.aspose.com/slides/fr/java/com.aspose.slides/ITiming#getDuration--). La durée d'une animation (en secondes) représente le temps total nécessaire pour qu'une animation effectue un cycle complet. 
- Le champ **Delay** du synchronisation PowerPoint correspond à la propriété [Effect.Timing.TriggerDelayTime](https://reference.aspose.com/slides/fr/java/com.aspose.slides/ITiming#getTriggerDelayTime--). 
...
2. Définissez de nouvelles valeurs pour les propriétés [Effect.Timing](https://reference.aspose.com/slides/fr/java/com.aspose.slides/IEffect#getTiming--) dont vous avez besoin. 
...
- [setSound(IAudio value)](https://reference.aspose.com/slides/fr/java/com.aspose.slides/effect/#setSound-com.aspose.slides.IAudio-) 
- [setStopPreviousSound(boolean value)](https://reference.aspose.com/slides/fr/java/com.aspose.slides/effect/#setStopPreviousSound-boolean-) 
...
4. Extrayez le [setSound(IAudio value)](https://reference.aspose.com/slides/fr/java/com.aspose.slides/effect/#setSound-com.aspose.slides.IAudio-) intégré à chaque effet d'animation. 
...
Aspose.Slides for Java vous permet de modifier la propriété After animation d'un effet d'animation.

Voici le panneau des effets d'animation et le menu étendu dans Microsoft PowerPoint :

![panneau des effets d'animation](shape-after-animation.png)

La liste déroulante **After animation** de PowerPoint correspond aux propriétés suivantes :

- La propriété [setAfterAnimationType(int value)](https://reference.aspose.com/slides/fr/java/com.aspose.slides/ieffect/#setAfterAnimationType-int-) qui décrit le type After animation :
  * PowerPoint **More Colors** correspond au type [AfterAnimationType.Color](https://reference.aspose.com/slides/fr/java/com.aspose.slides/afteranimationtype/#Color);
  * PowerPoint **Don't Dim** correspond au type [AfterAnimationType.DoNotDim](https://reference.aspose.com/slides/fr/java/com.aspose.slides/afteranimationtype/#DoNotDim) (type After animation par défaut);
  * PowerPoint **Hide After Animation** correspond au type [AfterAnimationType.HideAfterAnimation](https://reference.aspose.com/slides/fr/java/com.aspose.slides/afteranimationtype/#HideAfterAnimation);
  * PowerPoint **Hide on Next Mouse Click** correspond au type [AfterAnimationType.HideOnNextMouseClick](https://reference.aspose.com/slides/fr/java/com.aspose.slides/afteranimationtype/#HideOnNextMouseClick);
- La propriété [setAfterAnimationColor(IColorFormat value)](https://reference.aspose.com/slides/fr/java/com.aspose.slides/ieffect/#setAfterAnimationColor-com.aspose.slides.IColorFormat-) qui définit un format de couleur After animation. Cette propriété fonctionne en conjonction avec le type [AfterAnimationType.Color](https://reference.aspose.com/slides/fr/java/com.aspose.slides/afteranimationtype/#Color). Si vous changez le type, la couleur After animation sera réinitialisée.
...
- [setAnimateTextType(int value)] qui décrit le type d'animation du texte de l'effet. Le texte de la forme peut être animé :
  - Tout d'un coup ([AnimateTextType.AllAtOnce] type)
  - Par mot ([AnimateTextType.ByWord] type)
  - Par lettre ([AnimateTextType.ByLetter] type)
- [setDelayBetweenTextParts(float value)] définit un délai entre les parties du texte animé (mots ou lettres). Une valeur positive indique le pourcentage de la durée de l'effet. Une valeur négative indique le délai en secondes.
...
[Export to HTML5](/slides/fr/java/export-to-html5/) et activez les [options](https://reference.aspose.com/slides/fr/java/com.aspose.slides/html5options/) responsables des animations de [shape](https://reference.aspose.com/slides/fr/java/com.aspose.slides/html5options/#setAnimateShapes-boolean-) et de [transition](https://reference.aspose.com/slides/fr/java/com.aspose.slides/html5options/#setAnimateTransitions-boolean-). Le HTML simple ne lit pas les animations de diapositive, tandis que le HTML5 le fait.

### Comment le changement de l'ordre Z (ordre des calques) des formes affecte-t-il l'animation ?

L'ordre d'animation et l'ordre de dessin sont indépendants : un effet contrôle la synchronisation et le type d'apparition/disparition, tandis que le [z-order](https://reference.aspose.com/slides/fr/java/com.aspose.slides/shape/#getZOrderPosition--) détermine ce qui recouvre quoi. Le résultat visible est défini par leur combinaison. (Ceci est le comportement général de PowerPoint ; le modèle d'effets et de formes d'Aspose.Slides suit la même logique.)

### Existe-t-il des limitations lors de la conversion des animations en vidéo pour certains effets ?

En général, les [animations sont prises en charge](/slides/fr/java/convert-powerpoint-to-video/), mais des cas rares ou des effets spécifiques peuvent être rendus différemment. Il est recommandé de tester avec les effets que vous utilisez et avec la version de la bibliothèque.