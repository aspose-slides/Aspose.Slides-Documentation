...
- Java
- Aspose.Slides
description: "Apprenez à gérer les portions de texte dans les présentations PowerPoint en utilisant Aspose.Slides pour Java, améliorant les performances et la personnalisation."
---

## **Obtenir les coordonnées d'une partie de texte**
La méthode [**getCoordinates()**](https://reference.aspose.com/slides/java/com.aspose.slides/IPortion#getCoordinates--) a été ajoutée aux classes [IPortion](https://reference.aspose.com/slides/java/com.aspose.slides/iportion/) et [Portion](https://reference.aspose.com/slides/java/com.aspose.slides/portion/) qui permet de récupérer les coordonnées du début de la portion.
```java
