...
Dans l'exemple donné ci-dessous, nous avons animé une catégorie de graphique.
...
Si vous souhaitez animer les éléments de série, écrivez le code selon les étapes listées ci-dessous :
