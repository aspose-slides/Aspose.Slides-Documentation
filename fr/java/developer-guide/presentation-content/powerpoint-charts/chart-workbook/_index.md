...
- Java
- Aspose.Slides
description: "Découvrez Aspose.Slides pour Java : gérez facilement les classeurs de graphiques dans les formats PowerPoint et OpenDocument pour simplifier les données de votre présentation."
---
## **Vue d'ensemble**
...
3. Ajouter un graphique en bulles avec des données.
...
Aspose.Slides n’accepte pas de mot de passe lors du lien. Une approche courante consiste à enlever la protection à l’avance ou à préparer une copie déchiffrée (par exemple avec [Aspose.Cells](/cells/java/)) et à créer le lien vers cette copie.
