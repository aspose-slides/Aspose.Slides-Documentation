---
title: Gérer les lignes et les colonnes des tableaux PowerPoint avec Java
...
- Java
- Aspose.Slides
description: "Gérez les lignes et colonnes des tableaux PowerPoint avec Aspose.Slides pour Java et accélérez la modification des présentations ainsi que les mises à jour des données."
---
...
3. Créez un objet [ITable](https://reference.aspose.com/slides/java/com.aspose.slides/ITable) et affectez-lui la valeur null. 
4. Parcourez tous les objets [IShape](https://reference.aspose.com/slides/java/com.aspose.slides/ishape/) afin de trouver le tableau concerné. 
...
1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/java/com.aspose.slides/presentation/) et chargez la présentation, 
2. Obtenez une référence à la diapositive via son indice. 
3. Accédez à l'objet [ITable](https://reference.aspose.com/slides/java/com.aspose.slides/ITable) pertinent depuis la diapositive. 
