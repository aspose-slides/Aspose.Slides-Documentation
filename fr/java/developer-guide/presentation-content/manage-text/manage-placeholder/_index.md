...
1. Instanciez la classe [`Presentation`](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation) et passez la présentation comme argument.
2. Obtenez une référence à la diapositive par son index.
3. Itérez à travers les formes pour trouver le placeholder.
4. Transformez la forme du placeholder en un [`AutoShape`](https://reference.aspose.com/slides/java/com.aspose.slides/AutoShape) et modifiez le texte en utilisant le [`TextFrame`](https://reference.aspose.com/slides/java/com.aspose.slides/TextFrame) associé à l'[`AutoShape`](https://reference.aspose.com/slides/java/com.aspose.slides/AutoShape).
