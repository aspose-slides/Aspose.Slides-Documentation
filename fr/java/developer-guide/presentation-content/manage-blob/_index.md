...
[Aspose.Slides](/slides/java/) pour Java vous permet d'ajouter de gros fichiers (dans ce cas, un gros fichier vidéo) à travers un processus impliquant des BLOB pour réduire la consommation de mémoire.
