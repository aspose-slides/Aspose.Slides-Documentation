...
{{% alert color="primary" %}} 
 ...
 Les graphiques sont des représentations visuelles de données largement utilisées dans les présentations. Cet article montre le code pour créer un graphique dans Microsoft PowerPoint de manière programmatique en utilisant [VSTO](/slides/java/create-a-chart-in-a-microsoft-powerpoint-presentation/) et [Aspose.Slides pour Java](/slides/java/create-a-chart-in-a-microsoft-powerpoint-presentation/).
