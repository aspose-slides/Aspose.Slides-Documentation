...
type: docs
weight: 230
url: /fr/java/examples/elements/comment/
keywords:
- exemple de code
- commentaire
- PowerPoint
...
- Java
- Aspose.Slides
description: "Travaillez avec les commentaires de diapositives dans Aspose.Slides for Java : ajoutez, répondez, modifiez, résolvez et exportez les commentaires dans les présentations PPT, PPTX et ODP avec des exemples de code Java."
---
Cet article démontre comment ajouter, lire, supprimer et répondre aux commentaires modernes en utilisant **Aspose.Slides for Java**.
