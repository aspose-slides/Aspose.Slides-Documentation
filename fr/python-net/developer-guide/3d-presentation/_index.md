...
Comment crée‑vous habituellement une présentation PowerPoint 3D ? Microsoft PowerPoint vous permet d’ajouter des modèles 3D, d’appliquer des effets 3D aux formes, de créer du texte 3D, d’insérer des graphiques 3D et de créer des animations 3D.

Créer des effets 3D a un fort impact et est souvent la façon la plus simple de transformer un diaporama standard en présentation 3D. Depuis Aspose.Slides 20.9, un nouveau **moteur 3D multiplateforme** a été ajouté. Ce moteur permet d’exporter et de rasteriser les formes et le texte avec des effets 3D. Dans les versions antérieures, les formes avec effets 3D étaient rendues à plat ; maintenant elles peuvent être rendues avec **un véritable 3D**. Vous pouvez également créer des formes avec des effets 3D via l’API Aspose.Slides.
...
- [bevel_bottom](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/bevel_bottom/) et [bevel_top](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/bevel_top/) : définir des chanfreins, choisir un type de chanfrein (par ex. Angle, Cercle, SoftRound) et définir la hauteur et la largeur du chanfrein.
...
- [light_rig](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/light_rig/)\: créer des effets d’éclairage sur une forme 3D ; comme pour la caméra, vous pouvez définir la rotation de la lumière par rapport à la forme 3D et choisir un type de lumière.
- [material](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/material/)\: sélectionner un matériau pour rendre la forme 3D plus réaliste. Les matériaux prédéfinis incluent Metal, Plastic, Powder, Matte, etc.

Toutes les fonctionnalités 3D peuvent être appliquées aux formes et au texte. Les sections ci‑dessus montrent comment accéder à ces propriétés et les examiner étape par étape.
...
Oui. Slides propose des API pour [lire les valeurs effectives](/slides/fr/python-net/shape-effective-properties/) (y compris pour le 3D — éclairage, chanfreins, etc.) afin que vous puissiez voir les paramètres finaux appliqués.
