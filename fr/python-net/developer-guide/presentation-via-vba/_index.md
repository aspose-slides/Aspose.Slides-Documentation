...
type: docs
weight: 250
url: /fr/python-net/developer-guide/presentation-via-vba/
keywords:
- macro
- VBA
- macro VBA
...
- Simplifier la maintenance — la gestion centralisée des macros facilite l'application de modifications et la mise à jour des présentations.
...
Lorsque vous convertissez une présentation contenant des macros vers un autre format (PDF, HTML, etc.), Aspose.Slides ignore les macros — elles ne sont pas transférées vers le fichier de sortie.
...
Aspose.Slides fournit la classe [VbaProject](https://reference.aspose.com/slides/python-net/aspose.slides.vba/vbaproject/) pour créer des projets VBA (et des références de projet) et pour modifier des modules existants.
...
1. Ajoutez un module au projet VBA.
1. Définissez le code source du module.
1. Ajoutez une référence à `<stdole>`.
1. Ajoutez une référence à **Microsoft Office**.
...
1. Vérifiez si la présentation contient un [projet VBA](https://reference.aspose.com/slides/python-net/aspose.slides.vba/vbaproject/).
1. Vérifiez si le projet VBA est protégé par mot de passe pour afficher ses propriétés.
...
Oui, vous pouvez accéder aux [contrôles ActiveX](/slides/fr/python-net/activex/), modifier leurs propriétés et les supprimer. Cela est utile lorsque les macros interagissent avec des contrôles ActiveX.