...
- Python
- Aspose.Slides
description: "Découvrez comment générer et manipuler des présentations PowerPoint et OpenDocument via VBA avec Aspose.Slides for Python via .NET afin de rationaliser votre flux de travail."
---
