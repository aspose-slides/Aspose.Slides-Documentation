...
{{% alert color="primary" %}}
Vous pouvez essayer le **Aspose** [Macro Remover](https://products.aspose.app/slides/remove-macros), une application web gratuite permettant de supprimer les macros de documents PowerPoint, Excel et Word.
{{% /alert %}}
...
3. Vérifiez si le projet VBA est protégé par un mot de passe pour visualiser ses propriétés.
```py
import aspose.slides as slides
...
Oui, vous pouvez accéder aux [contrôles ActiveX](/slides/fr/python-net/activex/) existants, modifier leurs propriétés et les supprimer. Cela est utile lorsque les macros interagissent avec ActiveX.