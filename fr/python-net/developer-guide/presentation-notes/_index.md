...
- Python
- Aspose.Slides
description: "Personnalisez les notes de présentation avec Aspose.Slides for Python via .NET. Travaillez sans effort avec les notes PowerPoint et OpenDocument pour augmenter votre productivité."
---
...
La propriété [notes_style](https://reference.aspose.com/slides/python-net/aspose.slides/masternotesslide/notes_style/) a été ajoutée à la classe [MasterNotesSlide](https://reference.aspose.com/slides/python-net/aspose.slides/masternotesslide/). Cette propriété spécifie le style du texte des notes. L'implémentation est démontrée dans l'exemple ci-dessous.
```py
import aspose.slides as slides
