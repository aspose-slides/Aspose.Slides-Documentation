...
- Python
- Aspose.Slides
description: "Aspose.Slides pour Python via .NET facilite la création, la modification et le clonage de zones de texte dans les fichiers PowerPoint et OpenDocument, améliorant ainsi votre automatisation de présentations."
---

## **Aperçu**

Les textes sur les diapositives existent généralement dans des zones de texte ou des formes. Ainsi, pour ajouter du texte à une diapositive, vous devez ajouter une zone de texte puis placer du texte à l'intérieur. Aspose.Slides pour Python fournit la classe [AutoShape](https://reference.aspose.com/slides/python-net/aspose.slides/autoshape/) qui vous permet d'ajouter une forme contenant du texte.
...
Par conséquent, lorsqu'il s'agit d'une forme à laquelle vous voulez ajouter du texte, vous devez vérifier qu'elle a bien été castée via la classe [AutoShape](https://reference.aspose.com/slides/python-net/aspose.slides/autoshape/). Ce n'est qu'alors que vous pourrez travailler avec [TextFrame](https://reference.aspose.com/slides/python-net/aspose.slides/textframe/), qui est une propriété de [AutoShape](https://reference.aspose.com/slides/python-net/aspose.slides/autoshape/). Voir la section [Mettre à jour le texte](/slides/fr/python-net/manage-textbox/#update-text) de cette page.
...
3. Ajoutez une [AutoShape](https://reference.aspose.com/slides/python-net/aspose.slides/autoshape/) avec `ShapeType.RECTANGLE` à la position souhaitée sur la diapositive.
...
Aspose.Slides fournit la propriété [is_text_box](https://reference.aspose.com/slides/python-net/aspose.slides/autoshape/is_text_box/) sur la classe [AutoShape](https://reference.aspose.com/slides/python-net/aspose.slides/autoshape/), qui permet de déterminer si une forme est une zone de texte.
...
with slides.Presentation() as presentation:
	...
	# Obtenir le format de texte du TextFrame.
...
with slides.Presentation() as presentation:
    ...
    # Définir un hyperlien pour le texte du segment.
...
Un [placeholder](/slides/fr/python-net/manage-placeholder/) hérite du style/position de la [master](https://reference.aspose.com/slides/python-net/aspose.slides/masterslide/) et peut être remplacé sur les [layouts](https://reference.aspose.com/slides/python-net/aspose.slides/layoutslide/), alors qu’une zone de texte ordinaire est un objet indépendant sur une diapositive spécifique et ne change pas lorsqu’on change de mise en page.
