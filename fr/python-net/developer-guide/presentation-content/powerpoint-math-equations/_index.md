...
- Python
- Aspose.Slides
description: "Insérer et modifier des équations mathématiques dans PowerPoint PPT et PPTX avec Aspose.Slides pour Python via .NET, prenant en charge OMML, les contrôles de formatage et des exemples de code Python clairs."
---
## **Vue d'ensemble**
...
Dans PowerPoint, les utilisateurs ajoutent généralement les équations depuis **Insert > Equation** :
...
Pour les scénarios d’exportation MathML, consultez [Export Math Equations from Presentations in Python via .NET](/slides/fr/python-net/exporting-math-equations/).
...
{{% alert color="primary" %}}
`add_math_shape` crée une forme qui contient déjà un paragraphe mathématique. Accédez au premier `MathPortion`, récupérez son `MathParagraph` et ajoutez‑y des blocs mathématiques ou des éléments mathématiques.
{{% /alert %}}
...
Utilisez [`radical`](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/imathelement/radical/) pour créer une racine carrée, une racine cubique ou toute autre racine. L’élément actuel devient la base, et l’argument devient le degré.

![Une expression radicaux d’ordre n avec x sous le signe radical](powerpoint-math-equations_5.png)
...
Utilisez [MathMatrix](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/mathmatrix/) pour les lignes et colonnes. Les matrices n’incluent pas de crochets par défaut, il faut donc les entourer lorsque vous avez besoin de parenthèses, crochets ou accolades.
...
Utilisez les assistants d’indice et d’exposant pour les index et les puissances. Lorsque les index doivent apparaître du côté gauche de la base, utilisez [`set_sub_superscript_on_the_left`](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/imathelement/set_sub_superscript_on_the_left/).
...
Utilisez [`enclose`](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/imathelement/enclose/) pour placer une expression entre délimiteurs. Vous pouvez également définir un caractère séparateur pour les expressions délimitées contenant plusieurs éléments.
...
![Une équation encadrée montrant a au carré égal à b au carré plus c au carré](powerpoint-math-equations_12.png)
...
Utilisez [`group`](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/imathelement/group/) pour placer un caractère de regroupement au‑dessus ou au‑dessous d’une expression. Ajoutez une limite pour étiqueter les termes regroupés.

![L’expression x + y groupée avec l’étiquette texte quelconque en dessous](powerpoint-math-equations_15.png)
...
| Ajouter des scripts du côté gauche | [set_sub_superscript_on_the_left](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/imathelement/set_sub_superscript_on_the_left/) |
...
| Ajouter des barres et des encadrements | [overbar](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/imathelement/overbar/), [to_border_box](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/imathelement/to_border_box/) |
...
Oui. Lors de l’enregistrement au format PPTX, Aspose.Slides écrit l’équation sous forme de contenu Office mathématique modifiable.

**Puis‑je exporter les équations vers LaTeX ?**

Oui. Récupérez le [MathParagraph](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/mathparagraph/) de l’équation à partir de son [MathPortion](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/mathportion/), et appelez [MathParagraph.to_latex](https://reference.aspose.com/slides/fr/python-net/aspose.slides.mathtext/mathparagraph/to_latex/) pour l’exporter directement. Pour un exemple complet, consultez [Export Math Equations from Presentations in Python via .NET](/slides/fr/python-net/exporting-math-equations/#export-math-equations-to-latex).