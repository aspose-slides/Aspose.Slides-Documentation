...
- Python
- Aspose.Slides
description: "Déverrouillez une exportation fluide des équations mathématiques de PowerPoint vers MathML à l'aide d'Aspose.Slides pour Python via .NET—préservez la mise en forme et améliorez la compatibilité."
---
...
## **Enregistrer les équations mathématiques en MathML**

Bien que les humains puissent facilement écrire du LaTeX, le MathML est généralement généré automatiquement par les applications. Comme le MathML est basé sur XML, les programmes peuvent le lire et le parser de façon fiable, ce qui en fait un format de sortie et d’impression couramment employé dans de nombreux domaines.
