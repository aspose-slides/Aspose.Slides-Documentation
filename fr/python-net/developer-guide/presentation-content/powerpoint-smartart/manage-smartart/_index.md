...
- Python
- Aspose.Slides
description: "Apprenez à créer et modifier SmartArt PowerPoint avec Aspose.Slides pour Python via .NET en utilisant des exemples de code clairs qui accélèrent la conception de diapositives et l'automatisation."
---

## **Aperçu**

Ce guide montre comment créer et manipuler SmartArt dans Aspose.Slides pour Python. Vous apprendrez à extraire le texte de SmartArt (y compris le contenu du [TextFrame](https://reference.aspose.com/slides/python-net/aspose.slides/textframe/) à l’intérieur des formes de nœuds), ajouter SmartArt aux diapositives et changer sa disposition, détecter et gérer les nœuds cachés, configurer les dispositions d’organigramme, et créer des organigrammes image—le tout avec des exemples Python concis, prêts à copier‑coller, qui ouvrent une [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/), travaillent avec les diapositives et les nœuds SmartArt, et enregistrent les résultats au format PPTX. 

## **Obtenir du texte depuis SmartArt**
...
**SmartArt prend‑il en charge le miroir/l’inversion pour les langues RTL ?**
