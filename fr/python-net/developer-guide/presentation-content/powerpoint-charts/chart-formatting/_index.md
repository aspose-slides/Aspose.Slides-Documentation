...
Aspose.Slides fournit une API simple pour gérer les éléments du graphique et appliquer une mise en forme personnalisée :
...
1. Accédez à l'axe des valeurs du graphique et définissez les éléments suivants :
   ...
   1. Définissez les **propriétés de texte** pour les étiquettes de l'axe des valeurs.
...
1. Accédez à l'axe des catégories du graphique et définissez les éléments suivants :
   ...
   1. Définissez les **propriétés de texte** pour les étiquettes de l'axe des catégories.
   1. Définissez le **titre** de l'axe des catégories.
   1. Définissez le **positionnement des étiquettes** de l'axe des catégories.
   1. Définissez l'**angle de rotation** des étiquettes de l'axe des catégories.
...
1. Accédez à l'**axe des valeurs secondaire** du graphique et définissez les éléments suivants :
   1. Activez l'axe des **valeurs secondaire**.
   1. Définissez le **format de ligne** de l'axe des valeurs secondaire.
   1. Définissez le **format numérique** de l'axe des valeurs secondaire.
   1. Définissez les **unités min, max, majeures et mineures** de l'axe des valeurs secondaire.
...
1. Définissez la hauteur de police.
...
1. Définissez un format numérique prédéfini parmi les valeurs disponibles.
1. Parcourez les cellules de données du graphique dans chaque série et définissez le format numérique.
1. Enregistrez la présentation.
1. Définissez un format numérique personnalisé.
