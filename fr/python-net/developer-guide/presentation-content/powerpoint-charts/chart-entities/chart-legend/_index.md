...
- Python
- Aspose.Slides
description: "Personnalisez les légendes de graphiques avec Aspose.Slides pour Python via .NET afin d’optimiser les présentations PowerPoint et OpenDocument grâce à un formatage de légende adapté."
---

## **Vue d'ensemble**

Aspose.Slides pour Python offre un contrôle complet sur les légendes de graphiques afin que vous puissiez rendre les étiquettes de données claires et prêtes pour la présentation. Vous pouvez afficher ou masquer la légende, choisir sa position sur la diapositive et ajuster la mise en page pour éviter le chevauchement avec la zone du graphique. L’API vous permet de styliser le texte et les marqueurs, d’ajuster le remplissage et l’arrière‑plan, et de formater les bordures et les remplissages pour correspondre à votre thème. Les développeurs peuvent également accéder aux entrées individuelles de la légende pour les renommer ou les filtrer, garantissant que seules les séries les plus pertinentes sont affichées. Avec ces fonctionnalités, vos graphiques restent lisibles, cohérents et alignés avec les normes de conception de votre présentation.

## **Positionnement de la légende**

Avec Aspose.Slides, vous pouvez rapidement contrôler où la légende du graphique apparaît et comment elle s’intègre à la mise en page de votre diapositive. Apprenez à placer précisément la légende.
...
Aspose.Slides vous permet d’affiner l’apparence des légendes de graphiques en formatant les entrées individuelles. L’exemple ci‑dessous montre comment cibler un élément spécifique de la légende et définir ses propriétés sans modifier le reste de la légende.
...
**Puis‑je activer la légende afin que le graphique alloue automatiquement de l’espace pour elle au lieu de la superposer ?**

Oui. Utilisez le mode sans superposition ([overlay](https://reference.aspose.com/slides/python-net/aspose.slides.charts/legend/overlay/) = `false`) ; dans ce cas, la zone du graphique se réduira pour accueillir la légende.

**Puis‑je créer des libellés de légende sur plusieurs lignes ?**

Oui. Les libellés longs se renvoient automatiquement lorsqu’il n’y a pas assez d’espace ; les sauts de ligne forcés sont pris en charge via des caractères de fin de ligne dans le nom de la série.
