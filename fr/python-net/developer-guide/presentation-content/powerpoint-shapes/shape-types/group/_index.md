---
title: Présentation de formes groupées avec Python
...
- Python
- Aspose.Slides
description: "Apprenez à regrouper et dissocier des formes dans les présentations PowerPoint et OpenDocument avec Aspose.Slides pour Python — guide rapide, étape par étape, avec du code gratuit."
---

## **Vue d'ensemble**

Regrouper des formes vous permet de traiter plusieurs objets graphiques comme une seule entité afin de les déplacer, redimensionner, formater et transformer ensemble. Avec Aspose.Slides for Python, vous pouvez créer un [GroupShape](https://reference.aspose.com/slides/python-net/aspose.slides/groupshape/), ajouter et disposer des formes enfants à l'intérieur, puis enregistrer le résultat au format PPTX. Cet article montre comment ajouter une forme groupée sur une diapositive et comment accéder aux métadonnées d'accessibilité telles que le texte alternatif des formes contenues dans le groupe, offrant ainsi une structure plus claire et des présentations plus riches et maintenables.

## **Ajouter des formes groupées**

Aspose.Slides prend en charge la manipulation des formes groupées sur une diapositive. Cette fonctionnalité vous permet de créer des présentations plus riches en traitant plusieurs formes comme un seul objet. Vous pouvez ajouter de nouvelles formes groupées, accéder à celles existantes, les remplir de formes enfants et lire ou modifier n'importe laquelle de leurs propriétés. Pour ajouter une forme groupée à une diapositive :
...
4. Ajoutez des formes au nouveau groupe.
...
Cette section explique comment lire le texte alternatif des formes contenues dans une forme groupée sur une diapositive en utilisant Aspose.Slides. Pour accéder au texte alternatif des formes :
...
**Puis-je empêcher le déplacement/la modification/la dissociation ?**
