...
type: docs
weight: 20
url: /fr/python-net/developer-guide/presentation-content/powerpoint-shapes/shape-types/custom-shapes/
keywords: 
- forme personnalisée
- ajouter forme
- créer forme
...
- Python
- Aspose.Slides
description: "Créez et personnalisez des formes dans les présentations PowerPoint et OpenDocument avec Aspose.Slides pour Python via .NET : chemins géométriques, coins incurvés, formes composites."
---
...
Vous pouvez appliquer ces opérations à toute forme. Avec **Edit Points**, vous pouvez modifier une forme ou en créer une nouvelle à partir d’une forme existante.
...
* Une forme fermée n’a pas de point de départ ou d’arrivée ; une forme ouverte a un début et une fin.
...
* Les points d’ancrage peuvent être **corner**, **smooth** ou **straight** :
  * Un point **corner** est l’endroit où deux segments droits se rejoignent sous un angle.
...
* En déplaçant ou en modifiant les points d’ancrage (et ainsi en changeant les angles des segments), vous pouvez modifier l’apparence de la forme.
...
Vous apprendrez ici comment définir une forme libre en ajoutant votre propre séquence de points. En spécifiant des points ordonnés et les types de segments (droit ou courbe) et en fermant éventuellement le chemin, vous pouvez dessiner des graphiques personnalisés précis—polygones, icônes, annotations ou logos—directement sur vos diapositives.
...
Parfois, une forme personnalisée contient des points superflus qui compliquent sa géométrie ou affectent son rendu. Cette section montre comment supprimer des points spécifiques du chemin d’une forme afin de simplifier le contour et d’obtenir des résultats plus propres et précis.
...
Créer une forme personnalisée composite vous permet de combiner plusieurs chemins géométriques en une forme réutilisable sur une diapositive. Définissez et fusionnez ces chemins pour construire des visuels complexes qui dépassent l’ensemble de formes standard.
...
## **Créer des formes personnalisées avec coins incurvés**

Cette section montre comment dessiner une forme personnalisée avec des coins lisses incurvés à l’aide d’un chemin géométrique. Vous combinerez des segments droits et des arcs circulaires pour former le contour et ajouterez la forme terminée à votre diapositive.

Le code Python suivant montre comment créer une forme personnalisée avec des coins incurvés :
...
![Coins incurvés](custom_shape_6.png)
...
Utilisez la propriété [rotation](https://reference.aspose.com/slides/python-net/aspose.slides/geometryshape/rotation/) de la forme ; la géométrie pivote avec la forme car elle est liée au système de coordonnées de la forme.
