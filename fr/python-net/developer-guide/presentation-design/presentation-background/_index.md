---
title: Gestion des arrière-plans de présentation en Python
...
L'exemple Python suivant montre comment définir une couleur unie (vert forêt) comme arrière‑plan d'une diapositive maître :
...
L'exemple Python suivant montre comment définir une couleur en dégradé comme arrière‑plan d'une diapositive :
...
6. Utilisez la propriété `picture_fill_format` de [FillFormat](https://reference.aspose.com/slides/python-net/aspose.slides/fillformat/) pour assigner l'image à l'arrière‑plan.
...
L'exemple de code suivant montre comment définir le type de remplissage d'arrière‑plan sur une image mosaïquée et modifier les propriétés de mosaïquage :
...
Vous pouvez souhaiter ajuster la transparence de l'image d'arrière‑plan d'une diapositive afin de faire ressortir le contenu de la diapositive. Le code Python suivant vous montre comment modifier la transparence d'une image d'arrière‑plan de diapositive :
...
Oui. Supprimez le remplissage personnalisé de la diapositive, et l'arrière‑plan sera de nouveau hérité de la diapositive [mise en page](/slides/fr/python-net/slide-layout/)/[maître](/slides/fr/python-net/slide-master/) correspondante (c’est‑à‑dire de l'[arrière‑plan du thème](/slides/fr/python-net/presentation-theme/)).

**Qu'advient‑il de l'arrière‑plan si je change plus tard le thème de la présentation ?**
