...
- Python
- Aspose.Slides
description: "Apprenez à gérer les filigranes texte et image dans les présentations PowerPoint et OpenDocument avec Python pour indiquer un brouillon, des informations confidentielles, des droits d’auteur, et plus encore."
---
...
- [How to Use the TextFrame Class](/slides/fr/python-net/text-formatting/)
{{% /alert %}}
...
{{% alert color="primary" title="Voir aussi" %}} 
- [How to Use the Slide Master](/slides/fr/python-net/slide-master/)
{{% /alert %}}
...
Vous pouvez essayer les outils en ligne gratuits **Aspose.Slides** [Add Watermark](https://products.aspose.app/slides/watermark) et [Remove Watermark](https://products.aspose.app/slides/watermark/remove-watermark).
...
Vous pouvez ajuster la transparence du filigrane en modifiant les paramètres de remplissage ([FillFormat](https://reference.aspose.com/slides/python-net/aspose.slides/fillformat/)) de la forme. Cela garantit que le filigrane reste discret et ne détourne pas l’attention du contenu de la diapositive.
