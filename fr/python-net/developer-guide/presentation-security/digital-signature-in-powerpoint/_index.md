...
- Python
- Aspose.Slides
description: "Apprenez comment signer numériquement des fichiers PowerPoint et OpenDocument avec Aspose.Slides pour Python via .NET. Sécurisez vos diapositives en quelques secondes avec des exemples de code clairs."
---
...
Non. Une signature préserve l'intégrité et l'attribution, mais ne bloque pas les modifications. Pour restreindre l'édition, combinez-la avec ["Lecture seule" ou un mot de passe](/slides/fr/python-net/password-protected-presentation/).
