...
Ce tableau contient les formats de fichiers que Aspose.Slides pour Node.js via .NET peut charger et enregistrer :
...
|[EMF](https://docs.fileformat.com/image/emf/)|Format de Mét fichiers Améliorés| |{{< emoticons/tick >}}| |
...
|[JPEG](https://docs.fileformat.com/image/jpeg/)|Groupe d'Experts en Graphisme Photographique| |{{< emoticons/tick >}}| |
|[PNG](https://docs.fileformat.com/image/png/)|Graphiques de Réseau Portables| |{{< emoticons/tick >}}| |
...
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|Graphiques Vectoriels Scables| |{{< emoticons/tick >}}| |
|[SWF](https://docs.fileformat.com/page-description-language/swf/)|Format Web Petit| |{{< emoticons/tick >}}| |
|[HTML](https://docs.fileformat.com/web/html/)|Langage de Marquage Hypertexte|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[XAML](https://docs.fileformat.com/web/xaml/)|Langage de Marquage des Applications Extensibles| |{{< emoticons/tick >}}| |
