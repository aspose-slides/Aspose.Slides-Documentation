---
title: Extraire des objets Flash des présentations en .NET
linktitle: Flash
type: docs
weight: 10
url: /fr/net/flash/
...
- C#
- Aspose.Slides
description: "Apprenez comment extraire des objets Flash des diapositives PowerPoint et OpenDocument en .NET avec Aspose.Slides, avec des exemples de code C# complets et les meilleures pratiques."
---

## **Extraire des objets Flash d'une présentation**
Aspose.Slides for .NET offre une fonctionnalité permettant d'extraire des objets flash d'une présentation. Vous pouvez accéder au contrôle flash par son nom et l'extraire de la présentation, y compris les données d'objet SWF stockées.
```c#
...
**Puis-je convertir une présentation contenant du Flash en HTML5 tout en préservant l'interactivité du Flash ?**
...
Aspose.Slides prend en charge [extraction des objets OLE intégrés](/slides/fr/net/manage-ole/), ce qui vous permet de traiter tout le contenu intégré associé en une seule passe, en gérant les contrôles Flash et les autres documents intégrés via OLE ensemble.