...
- C#
- Aspose.Slides
description: "Apprenez à créer et personnaliser des graphiques circulaires en .NET avec Aspose.Slides, exportables vers PowerPoint, améliorant votre narration de données en quelques secondes."
---
...
Oui, vous pouvez [exporter le graphique lui‑même en tant qu'image](https://reference.aspose.com/slides/net/aspose.slides/shape/getimage/) (par exemple PNG) sans toute la présentation.