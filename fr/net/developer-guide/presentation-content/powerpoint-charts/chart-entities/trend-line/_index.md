---
title: Ajouter des lignes de tendance aux graphiques de présentation dans .NET
...
- C#
- Aspose.Slides
description: "Ajoutez rapidement et personnalisez les lignes de tendance dans les graphiques PowerPoint avec Aspose.Slides pour .NET — un guide pratique pour captiver votre audience."
---
...
9. Ajout d’une ligne de tendance de puissance pour la série 3 du graphique.
...
Oui. Aspose.Slides convertit les présentations en [PDF](/slides/fr/net/convert-powerpoint-to-pdf/)/[SVG](/slides/fr/net/render-a-slide-as-an-svg-image/) et rend les graphiques en images ; les lignes de tendance, faisant partie du graphique, sont conservées pendant ces opérations. Une méthode est également disponible pour [exporter une image du graphique](/slides/fr/net/create-shape-thumbnails/) lui‑même.