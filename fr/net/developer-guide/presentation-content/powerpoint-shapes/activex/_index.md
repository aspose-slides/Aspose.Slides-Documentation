...
weight: 80
url: /fr/net/activex/
keywords: "ActiveX, contrôles ActiveX, présentation PowerPoint, C#, Csharp, Aspose.Slides for .NET"
description: "Gérer les contrôles ActiveX dans une présentation PowerPoint en C# ou .NET"
---

Les contrôles ActiveX sont utilisés dans les présentations. Aspose.Slides for .NET vous permet de gérer les contrôles ActiveX, mais leur gestion est un peu plus compliquée et différente des formes classiques de la présentation. À partir d’Aspose.Slides for .NET 6.9.0, le composant prend en charge la gestion des contrôles ActiveX. Pour le moment, vous pouvez accéder aux contrôles ActiveX déjà ajoutés dans votre présentation et les modifier ou les supprimer en utilisant leurs diverses propriétés. Rappelez‑vous que les contrôles ActiveX ne sont pas des formes et ne font pas partie de l’IShapeCollection de la présentation, mais d’une IControlCollection distincte. Cet article montre comment les utiliser.  
...
1. Accédez aux contrôles ActiveX de la diapositive en récupérant l’IControlCollection.  
1. Accédez au contrôle ActiveX TextBox1 à l’aide de l’objet ControlEx.  
1. Modifiez les différentes propriétés du contrôle ActiveX TextBox1, notamment le texte, la police, la hauteur de la police et la position du cadre.  
...
Le fragment de code ci‑dessous met à jour les contrôles ActiveX sur les diapositives de la présentation comme illustré ci‑dessous.  
```c#
...
1. Créez une instance de la classe Presentation et chargez une présentation d’exemple contenant des contrôles Media Player ActiveX.  
1. Créez une instance de la classe Presentation cible et générez une présentation vide.  
...
**Aspose.Slides préserve‑t‑il les contrôles ActiveX lors de la lecture et du re‑sauvegarde s’ils ne peuvent pas être exécutés dans le runtime Python ?**  

Oui. Aspose.Slides les traite comme faisant partie de la présentation et peut lire/modifier leurs propriétés et cadres ; l’exécution des contrôles elle‑même n’est pas requise pour les conserver.  
