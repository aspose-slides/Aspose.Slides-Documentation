...
Bien que les effets dans PowerPoint puissent être utilisés pour faire ressortir une forme, ils diffèrent des [remplissages](/slides/fr/net/shape-formatting/#gradient-fill) ou des contours. En utilisant des effets PowerPoint, vous pouvez créer des réflexions convaincantes sur une forme, étendre l’éclat d’une forme, etc.
