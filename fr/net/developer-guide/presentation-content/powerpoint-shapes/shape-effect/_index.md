---
title: Appliquer des effets de forme dans les présentations en .NET
...
Certaines combinaisons d'effets sont plus esthétiques que d'autres. Pour cette raison, PowerPoint propose des options sous **Preset**. Les options Preset sont essentiellement une combinaison connue et esthétique de deux effets ou plus. Ainsi, en sélectionnant un preset, vous n'aurez pas à perdre du temps à tester ou à combiner différents effets pour trouver une belle combinaison.
...
Vous pouvez appliquer des effets à diverses formes, notamment les formes automatiques, les graphiques, les tableaux, les images, les objets SmartArt, les objets OLE, et plus encore.

**Puis-je appliquer des effets à des formes groupées ?**

Oui, vous pouvez appliquer des effets à des formes groupées. L'effet s'appliquera à l'ensemble du groupe.