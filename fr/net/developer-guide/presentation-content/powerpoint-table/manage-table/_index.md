...
keywords: "Tableau, créer tableau, accéder à la table, ratio d'aspect du tableau, présentation PowerPoint, C#, Csharp, Aspose.Slides for .NET"
description: "Créer et gérer des tableaux dans les présentations PowerPoint en C# ou .NET"
---

Un tableau dans PowerPoint est un moyen efficace d'afficher et de présenter des informations. Les informations dans une grille de cellules (arrangées en lignes et colonnes) sont simples et faciles à comprendre.
...
Ce code C# vous montre comment spécifier la numérotation des cellules d'un tableau:
```c#
// Instancie une classe Presentation qui représente un fichier PPTX
...
Ce code C# vous montre comment accéder à un tableau existant et le manipuler:
```c#
// Instancie une classe Presentation qui représente un fichier PPTX
...
5. Accédez au [IParagraph](https://reference.aspose.com/slides/net/aspose.slides/iparagraph/) de l'[ITextFrame](https://reference.aspose.com/slides/net/aspose.slides/itextframe/).  
...
Aspose.Slides vous permet de récupérer les propriétés de style d'un tableau afin que vous puissiez les réutiliser pour un autre tableau ou ailleurs. Ce code C# vous montre comment obtenir les propriétés de style d'un style de tableau prédéfini:
```c#
using (Presentation pres = new Presentation())
{
...
Le ratio d'aspect d'une forme géométrique correspond au rapport de ses dimensions. Aspose.Slides propose la propriété `AspectRatioLocked` pour vous permettre de verrouiller le réglage du ratio d'aspect pour les tableaux et autres formes. 
