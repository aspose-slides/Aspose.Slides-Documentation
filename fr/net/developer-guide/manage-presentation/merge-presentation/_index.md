---
title: Fusionner efficacement les présentations en .NET
...
* des présentations complètes. Toutes les diapositives des présentations sont regroupées dans une seule présentation
...
* [Images](https://products.aspose.com/slides/net/merger/image-to-image/), telles que [JPG en JPG](https://products.aspose.com/slides/net/merger/jpg-to-jpg/) ou [PNG en PNG](https://products.aspose.com/slides/net/merger/png-to-png/)
* Documents, tels que [PDF en PDF](https://products.aspose.com/slides/net/merger/pdf-to-pdf/) ou [HTML en HTML](https://products.aspose.com/slides/net/merger/html-to-html/)
...
## **Fusionner des présentations avec le maître des diapositives** 
...
## **Fusionner des présentations avec mise en page des diapositives** 

Ce code C# vous montre comment combiner des diapositives de présentations tout en appliquant la mise en page de diapositive de votre choix afin d’obtenir une présentation de sortie unique :
```c#
using (Presentation pres1 = new Presentation("pres1.pptx"),
    pres2 = new Presentation("pres2.pptx"))
{
...
Pour fusionner 2 présentations de tailles de diapositives différentes, vous devez redimensionner l’une des présentations afin que sa taille corresponde à celle de l’autre présentation. 
...
**Dans quelle mesure l’opération de fusion est‑elle sûre pour les threads ?**
