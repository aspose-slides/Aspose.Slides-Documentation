...
Lisez-en plus sur les formats de présentation [**PPT vs PPTX**](/slides/net/ppt-vs-pptx/) et comment [**Aspose.Slides prend en charge la conversion PPT en PPTX**](/slides/net/convert-ppt-to-pptx/).