...
Aspose.Slides propose de nombreuses options — principalement de la classe HtmlOptions — qui définissent le processus de conversion du format PowerPoint (ou OpenDocument) vers HTML :
...
* Convertir une présentation PowerPoint en HTML avec les polices originales ou embarquées.
* Convertir une présentation PowerPoint en HTML en utilisant le nouveau style CSS.

## **Convertir une présentation en HTML**

À l’aide d’Aspose.Slides, vous pouvez convertir une présentation PowerPoint ou OpenDocument complète en HTML comme suit :

1. Créez une instance de la classe Presentation.
2. Utilisez la méthode Save pour enregistrer l’objet au format HTML.

Ce code montre comment convertir une présentation PowerPoint en HTML en C# :
```c#
// Instanciez la classe Presentation qui représente un fichier de présentation (par ex., PPT, PPTX, ODP, etc.).
...
Aspose.Slides fournit la classe ResponsiveHtmlController qui vous permet de générer des fichiers HTML responsive.

Ce code montre comment convertir une présentation PowerPoint en HTML responsive en C# :
```c#
...
Lors de la conversion d’une présentation PowerPoint ou OpenDocument en HTML avec les notes du présentateur, il est essentiel de capturer l’essence complète du document original. Ce processus garantit que non seulement les éléments visuels des diapositives sont fidèlement reproduits, mais que les notes du présentateur sont également conservées, enrichissant le contenu avec un contexte et des informations supplémentaires.

Supposons que nous ayons une présentation PowerPoint contenant la diapositive suivante :
...
## **Convertir une présentation en HTML avec polices originales**

Aspose.Slides fournit la classe EmbedAllFontsHtmlController qui vous permet d’intégrer toutes les polices d’une présentation lors de sa conversion en HTML.

Pour empêcher l’intégration de certaines polices, vous pouvez passer un tableau de noms de polices à un constructeur paramétré de la classe EmbedAllFontsHtmlController. Les polices populaires, telles que Calibri ou Arial, n’ont pas besoin d’être intégrées car la plupart des systèmes les possèdent déjà. Les intégrer augmenterait inutilement la taille du document HTML résultant.

La classe EmbedAllFontsHtmlController supporte l’héritage et fournit la méthode WriteFont, qui est destinée à être remplacée.
```c#
...
## **Convertir une présentation en HTML avec images haute qualité**
...
Pour convertir une diapositive spécifique d’une présentation PowerPoint en HTML, vous devez créer une instance de la même classe Presentation (utilisée pour convertir des présentations complètes en HTML) puis utiliser la méthode Save pour enregistrer le fichier au format HTML. La classe HtmlOptions peut être utilisée pour spécifier des options de conversion supplémentaires.

Ce code C# montre comment convertir une diapositive avec notes du présentateur dans une présentation PowerPoint en HTML :
```c#
...
En utilisant de nouveaux fichiers de style CSS, vous pouvez facilement modifier l’apparence du fichier HTML généré par le processus de conversion PowerPoint‑vers‑HTML.

Le code C# de cet exemple montre comment utiliser des méthodes pouvant être remplacées pour créer un document HTML personnalisé incluant un lien vers un fichier CSS :
```c#
...
Si vous ne souhaitez pas intégrer les polices (pour éviter d’augmenter la taille du HTML généré), vous pouvez lier toutes les polices en implémentant votre propre version de LinkAllFontsHtmlController.
...
## **Convertir une présentation avec images SVG en HTML responsive**
...
À l’aide d’Aspose.Slides pour .NET, vous pouvez exporter des fichiers multimédia comme suit :
...
Aspose a développé des convertisseurs gratuits de présentation vers HTML : PPT vers HTML, PPTX vers HTML, ODP vers HTML, etc.

[![todo:image_alt_text](ppt-to-html.png)](https://products.aspose.app/slides/conversion/ppt-to-html)

Découvrez les autres convertisseurs gratuits d’Aspose.
...
Oui, Aspose.Slides prend pleinement en charge l’exportation des hyperliens intégrés vers HTML. Lors de la conversion des présentations au format HTML, les hyperliens sont automatiquement conservés et restent cliquables.
