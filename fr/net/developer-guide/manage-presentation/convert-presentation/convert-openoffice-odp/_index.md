...
Aspose.Slides for .NET fournit une API robuste pour convertir les présentations OpenDocument (ODP) vers divers autres formats. En suivant une approche similaire à celle utilisée pour les fichiers PowerPoint (PPT et PPTX), les développeurs peuvent facilement exporter les documents ODP vers des formats tels que HTML, PDF, TIFF, JPG, XPS, et plus encore.
...
- Le remplissage d’image, le remplissage en dégradé et le remplissage à motif pour le texte ne sont pas pris en charge dans LibreOffice/OpenOffice Impress.

MS PowerPoint et LibreOffice/OpenOffice Impress gèrent également les listes différemment. Un fichier ODP créé dans PowerPoint peut ne pas s’afficher correctement dans LibreOffice/OpenOffice Impress, et vice‑versa.
...
Aspose.Slides enregistre les listes ODP de manière à ce qu’elles s’affichent correctement dans LibreOffice/OpenOffice Impress.
...
Absolument. Aspose.Slides for .NET est conçu pour fonctionner tant sur des postes de travail que sur des environnements serveur, y compris les plateformes cloud telles qu’Azure, AWS et les conteneurs Docker, sans aucune dépendance UI.