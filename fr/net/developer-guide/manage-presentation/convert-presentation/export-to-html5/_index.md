---
title: Convertir les présentations en HTML5 avec .NET
...
- C#
- Aspose.Slides
description: "Exportez les présentations PowerPoint et OpenDocument en HTML5 responsive avec Aspose.Slides pour .NET. Conservez la mise en forme, les animations et l'interactivité."
---
...
**Puis-je contrôler si les animations d'objets et les transitions de diapositives seront exécutées en HTML5 ?**
