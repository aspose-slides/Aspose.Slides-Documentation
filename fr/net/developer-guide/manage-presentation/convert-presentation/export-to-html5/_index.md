...
- C#
- Aspose.Slides
description: "Exportez les présentations PowerPoint et OpenDocument vers du HTML5 réactif avec Aspose.Slides pour .NET. Conservez la mise en forme, les animations et l'interactivité."
---
## **Vue d'ensemble**

Cet article explique comment convertir des présentations PowerPoint en HTML5 à l'aide d'Aspose.Slides. Il couvre l'exportation HTML5 de base, ainsi que les options de contrôle des animations de formes et des transitions de diapositives. L'article montre également le processus d'exportation standard de PowerPoint vers HTML, explique comment générer une sortie HTML5 en mode vue des diapositives, et démontre comment inclure des commentaires dans le document exporté en configurant leur disposition.
...
{{% alert color="info" %}} 
En plus du document HTML, l'exportation écrit les fichiers de prise en charge qu'elle référence : `pres.css`, `master.css`, `animation.js`, `effects.js` et `navigation.js`. La page générée charge également jQuery et Anime.js depuis des CDN publics ; sans eux, la navigation entre les diapositives et les animations ne fonctionnent pas. 
{{% /alert %}}
...
Lorsque vous convertissez une présentation PowerPoint en document HTML5, vous pouvez facilement spécifier s'il faut inclure les commentaires de la présentation dans le document de sortie. Pour cela, vous devez spécifier les paramètres d'affichage des commentaires dans la propriété `NotesCommentsLayouting` de la classe [Html5Options](https://reference.aspose.com/slides/fr/net/aspose.slides.export/html5options/).
...
Oui, HTML5 offre des options séparées pour activer ou désactiver les [animations de formes](https://reference.aspose.com/slides/fr/net/aspose.slides.export/html5options/animateshapes/) et les [transitions de diapositives](https://reference.aspose.com/slides/fr/net/aspose.slides.export/html5options/animatetransitions/).

### La sortie des commentaires est‑elle prise en charge, et où peuvent‑ils être placés par rapport à la diapositive ?

Oui, les commentaires peuvent être ajoutés en HTML5 et positionnés (par exemple, à droite de la diapositive) via les [paramètres de mise en page](https://reference.aspose.com/slides/fr/net/aspose.slides.export/html5options/notescommentslayouting/) pour les notes et les commentaires.

### Puis‑je ignorer les liens qui invoquent du JavaScript pour des raisons de sécurité ou de CSP ?

Oui, il existe un [paramètre](https://reference.aspose.com/slides/fr/net/aspose.slides.export/saveoptions/skipjavascriptlinks/) qui vous permet d'ignorer les hyperliens contenant des appels JavaScript lors de l'enregistrement. Cela aide à respecter des politiques de sécurité strictes.