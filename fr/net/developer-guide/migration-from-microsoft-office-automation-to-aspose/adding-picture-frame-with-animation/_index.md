---
title: Ajout de cadres d'image avec animation à l'aide de VSTO et Aspose.Slides pour .NET
...
- C#
- Aspose.Slides
description: "Migrer de l'automatisation Microsoft Office vers Aspose.Slides pour .NET et animer les cadres d'image dans les diapositives PowerPoint (PPT, PPTX) avec du code C# propre."
---

{{% alert color="primary" %}} 

Les cadres d'image sont appliqués aux formes ou aux images dans Microsoft PowerPoint pour encadrer les images dans une présentation. Cet article montre comment créer un cadre d'image et appliquer une animation dessus de manière programmatique en utilisant d'abord [VSTO 2008](/slides/fr/net/adding-picture-frame-with-animation/) puis [Aspose.Slides for .NET](/slides/fr/net/adding-picture-frame-with-animation/). Tout d'abord, nous vous montrons comment appliquer un cadre et une animation à l'aide de VSTO 2008. Nous vous montrons ensuite comment réaliser les mêmes étapes avec Aspose.Slides for .NET.
