...
Les cadres d'image sont appliqués aux formes ou aux images dans Microsoft PowerPoint pour encadrer les images d'une présentation. Cet article montre comment créer un cadre d'image et appliquer une animation de manière programmatique en utilisant d'abord [VSTO 2008](/slides/fr/net/adding-picture-frame-with-animation/) puis [Aspose.Slides for .NET](/slides/fr/net/adding-picture-frame-with-animation/). Tout d'abord, nous vous montrons comment appliquer un cadre et une animation avec VSTO 2008. Nous vous montrons ensuite comment effectuer les mêmes étapes avec Aspose.Slides for .NET.
...
//Application d'une animation au cadre d'image
