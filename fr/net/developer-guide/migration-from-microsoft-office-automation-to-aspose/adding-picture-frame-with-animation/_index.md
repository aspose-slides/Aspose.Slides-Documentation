---
title: Ajout de cadres d'images avec animation en utilisant VSTO et Aspose.Slides pour .NET
linktitle: Cadres d'images avec animation
type: docs
weight: 60
...
- C#
- Aspose.Slides
description: "Migrez de l'automatisation Microsoft Office vers Aspose.Slides pour .NET et animez les cadres d'images dans les diapositives PowerPoint (PPT, PPTX) avec un code C# propre."
---
{{% alert color="info" %}} 

Les cadres d'image sont appliqués aux formes ou aux images dans Microsoft PowerPoint pour encadrer les images dans une présentation. Cet article montre comment créer un cadre d'image et appliquer une animation programmatiquement en utilisant d'abord [VSTO 2008](/slides/fr/net/adding-picture-frame-with-animation/) puis [Aspose.Slides for .NET](/slides/fr/net/adding-picture-frame-with-animation/). D'abord, nous vous montrons comment appliquer un cadre et une animation avec VSTO 2008. Nous vous montrons ensuite comment effectuer les mêmes étapes avec Aspose.Slides for .NET.

{{% /alert %}} 
## **Ajout de cadres d'images avec animation**
...
Avec Aspose.Slides pour .NET, effectuez les étapes suivantes :
