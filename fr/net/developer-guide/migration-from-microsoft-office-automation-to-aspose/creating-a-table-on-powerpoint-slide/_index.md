...
Les tableaux sont largement utilisés pour afficher des données sur des diapositives de présentation. Cet article montre comment créer un tableau 15 x 15 avec une taille de police de 10 de manière programmatique en utilisant d'abord [VSTO 2008](/slides/fr/net/creating-a-table-on-powerpoint-slide/) puis [Aspose.Slides pour .NET](/slides/fr/net/creating-a-table-on-powerpoint-slide/).
