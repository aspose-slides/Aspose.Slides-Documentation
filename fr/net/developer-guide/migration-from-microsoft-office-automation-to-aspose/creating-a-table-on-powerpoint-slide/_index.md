...
1. Ajouter un tableau de 15 × 15 à la diapositive.
...
foreach (PowerPoint.Row row in tbl.Rows)
{
    ...
    //Boucler sur toutes les cellules de la ligne
...
1. Créer une présentation.
1. Ajouter un tableau de 15 × 15 à la première diapositive.
1. Ajouter du texte à chaque cellule du tableau avec une taille de police de 10.
