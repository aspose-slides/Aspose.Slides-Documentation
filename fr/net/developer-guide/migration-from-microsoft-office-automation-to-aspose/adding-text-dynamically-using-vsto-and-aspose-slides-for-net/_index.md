...
Les extraits de code ci‑dessous produisent une présentation contenant une diapositive vierge et une chaîne de texte.
...
Les extraits de code ci‑dessus utilisent Aspose.Slides pour créer une présentation contenant une diapositive vierge et une chaîne de texte.

**La présentation telle qu’elle est créée avec Aspose.Slides pour .NET** 
...
//La diapositive vierge est ajoutée par défaut, lors de la création
//d'une présentation depuis le constructeur par défaut
