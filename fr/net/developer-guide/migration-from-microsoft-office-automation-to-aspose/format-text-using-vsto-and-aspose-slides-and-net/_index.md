...
Parfois, vous devez formater le texte des diapositives de manière programmatique. Cet article montre comment lire une présentation d'exemple contenant du texte sur la première diapositive en utilisant soit [VSTO](/slides/fr/net/format-text-using-vsto-and-aspose-slides-and-net/) soit [Aspose.Slides for .NET](/slides/fr/net/format-text-using-vsto-and-aspose-slides-and-net/). Le code formate le texte de la troisième zone de texte de la diapositive pour qu'il ressemble au texte de la dernière zone de texte.

{{% /alert %}}
## **Mise en forme du texte**
Les méthodes VSTO et Aspose.Slides suivent les étapes suivantes :

1. Ouvrez la présentation source.
1. Accédez à la première diapositive.
1. Accédez à la troisième zone de texte.
1. Modifiez la mise en forme du texte dans la troisième zone de texte.
1. Enregistrez la présentation sur le disque.

Les captures d'écran ci-dessous montrent la diapositive d'exemple avant et après l'exécution du code VSTO et Aspose.Slides for .NET.
...
```c#
//Remarque : PowerPoint est un espace de noms qui a été défini ci‑dessus de cette façon
...
//Changer la police du texte en Verdana et la taille à 32
...
//Écrire le résultat sur le disque
