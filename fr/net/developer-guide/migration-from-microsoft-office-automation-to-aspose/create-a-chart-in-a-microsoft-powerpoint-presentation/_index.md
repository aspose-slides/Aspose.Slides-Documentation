...
Cet article montre comment créer et personnaliser des graphiques dans des présentations Microsoft PowerPoint de manière programmatique à l’aide de C#. Avec Aspose.Slides pour .NET, vous pouvez automatiser la génération de graphiques professionnels et basés sur des données sans dépendre de Microsoft Office ou des bibliothèques Interop. L’API offre un ensemble complet de fonctionnalités pour créer des graphiques en colonnes, des graphiques circulaires, des graphiques en courbes, et bien plus encore — avec un contrôle total sur l’apparence, les données et la mise en page. Que vous génériez des rapports, des tableaux de bord ou des présentations d’entreprise, Aspose.Slides vous aide à fournir des visualisations de haute qualité directement depuis vos applications .NET.

## **Exemple VSTO**

Cette section montre comment créer un graphique dans une présentation Microsoft PowerPoint en utilisant **VSTO (Visual Studio Tools for Office)**. Avec VSTO, vous pouvez générer et personnaliser des graphiques de façon programmatique en combinant l’automatisation de PowerPoint et d’Excel. L’exemple fourni montre comment ajouter un **graphique à colonnes groupées 3D**, le remplir avec des données provenant d’une feuille de calcul Excel, ajuster le formatage et la mise en page, puis enregistrer la présentation finale — le tout depuis une application .NET.

1. Créez une instance d’une présentation Microsoft PowerPoint.  
2. Ajoutez une diapositive vierge à la présentation.  
3. Ajoutez un graphique à colonnes groupées 3D et accédez‑y.  
4. Créez une nouvelle instance d’un classeur Microsoft Excel et chargez les données du graphique.  
5. Accédez à la feuille de données du graphique à l’aide de l’instance du classeur Excel.  
6. Définissez la plage du graphique dans la feuille de calcul et supprimez les séries 2 et 3 du graphique.  
7. Modifiez les données de catégorie du graphique dans la feuille de données du graphique.  
8. Modifiez les données de la série 1 dans la feuille de données du graphique.  
9. Accédez au titre du graphique et définissez ses propriétés de police.  
10. Accédez à l’axe des valeurs du graphique et définissez l’unité majeure, l’unité mineure, la valeur maximale et la valeur minimale.  
11. Accédez à l’axe de profondeur (séries) du graphique et supprimez‑le — une seule série est utilisée dans cet exemple.  
12. Définissez les angles de rotation du graphique sur les axes X et Y.  
13. Enregistrez la présentation.  
14. Fermez les instances de Microsoft Excel et PowerPoint.  
```c#
...
// Sélectionner la première diapositive et définir sa disposition.
objSlide.Select();
...
L’exemple suivant montre comment créer un graphique simple dans une présentation PowerPoint en utilisant Aspose.Slides pour .NET. Ce code démontre comment ajouter un **graphique à colonnes groupées 3D**, le remplir avec des données d’exemple et personnaliser son apparence. En quelques lignes de code, vous pouvez générer des graphiques dynamiquement et les intégrer à vos présentations sans utiliser Microsoft Office.

1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/net/aspose.slides/presentation/).  
2. Obtenez une référence à la première diapositive.  
3. Ajoutez un graphique à colonnes groupées 3D et accédez‑y.  
4. Accédez aux données du graphique.  
5. Supprimez les séries inutilisées 2 et 3.  
6. Modifiez les catégories du graphique en mettant à jour les étiquettes.  
7. Mettez à jour les valeurs de la Série 1.  
8. Accédez au titre du graphique et définissez ses propriétés de police.  
9. Configurez l’axe des valeurs du graphique, y compris l’unité majeure, l’unité mineure, les valeurs maximale et minimale.  
10. Définissez les angles de rotation du graphique sur les axes X et Y.  
11. Enregistrez la présentation au format PPTX.  
```cs
...
**Puis‑je créer d’autres types de graphiques comme des graphiques à secteurs, en courbes ou à barres avec Aspose.Slides ?**

Oui. Aspose.Slides pour .NET prend en charge un large éventail de [types de graphiques](https://docs.aspose.com/slides/net/create-chart/), y compris les graphiques à secteurs, les graphiques en courbes, les graphiques à barres, les nuages de points, les graphiques à bulles, et bien plus. Vous pouvez spécifier le type de graphique souhaité à l’aide de l’énumération [ChartType](https://reference.aspose.com/slides/net/aspose.slides.charts/charttype/) lors de l’ajout d’un graphique.

**Puis‑je appliquer des styles ou des thèmes personnalisés au graphique ?**

Oui. Vous pouvez personnaliser entièrement l’apparence du graphique, y compris les couleurs, les polices, les remplissages, les contours, les lignes de grille et la mise en page. Cependant, appliquer exactement les thèmes Office tels qu’ils apparaissent dans PowerPoint nécessite de définir manuellement chaque style individuellement.

**Puis‑je exporter le graphique en tant qu’image séparée de la diapositive ?**

Oui, Aspose.Slides vous permet d’exporter n’importe quelle forme — y compris les graphiques — en tant qu’image séparée (par ex. PNG, JPEG) à l’aide de la méthode `GetImage` sur la [forme](https://reference.aspose.com/slides/net/aspose.slides/ishape/) du graphique.