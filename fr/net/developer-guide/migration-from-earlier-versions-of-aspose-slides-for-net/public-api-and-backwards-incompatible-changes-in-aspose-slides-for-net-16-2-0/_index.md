...
Cette page répertorie toutes les [ajoutées](/slides/fr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-16-2-0/) ou [supprimées](/slides/fr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-16-2-0/) classes, méthodes, propriétés, etc., ainsi que les autres changements introduits avec l'API Aspose.Slides for .NET 16.2.0 API.

{{% /alert %}} 
## **Modifications de l'API publique**
#### **Propriétés UpdateDateTimeFields et UpdateSlideNumberFields ont été supprimées**
...
#### **Enum Slides.Charts.CategoryAxisType est passée en public**
...
L'argument enum ExtractionMode indique le mode d'organisation du résultat texte et peut être défini sur les valeurs suivantes :
...
``` 
#### **Interface ILegacyDiagram et classe LegacyDiagram ont été ajoutées**
...
#### **Nouvel élément JustifyLow ajouté à l'énumération Aspose.Slides.TextAlignment**
...
EmbeddedFileExtension - Renvoie l'extension du fichier de l'objet intégré actuel ou une chaîne vide si l'objet n'est pas un lien
...
La propriété ShowLabelAsDataCallout détermine si le libellé de données d'un graphique spécifié sera affiché comme appel de données ou comme libellé de données.
