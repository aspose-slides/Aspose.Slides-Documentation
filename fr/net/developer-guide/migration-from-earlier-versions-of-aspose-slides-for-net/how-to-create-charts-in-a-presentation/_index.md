...
- C#
- Aspose.Slides
description: "Apprenez à créer des graphiques dans les présentations PowerPoint PPT, PPTX et ODP en .NET avec Aspose.Slides en utilisant les API de graphiques legacy et modernes."
---
...
Afin d'utiliser le code hérité développé avec les versions d'Aspose.Slides pour .NET antérieures à la 13.x, vous devez apporter quelques modifications mineures à votre code et celui‑ci fonctionnera comme auparavant. Toutes les classes qui existaient dans l'ancienne Aspose.Slides pour .NET sous les espaces de noms Aspose.Slide et Aspose.Slides.Pptx sont désormais rassemblées dans un seul espace de noms Aspose.Slides. Veuillez consulter le fragment de code simple suivant pour créer un graphique normal à partir de zéro dans une présentation en utilisant l'API Aspose.Slides legacy et suivre les étapes décrivant comment migrer vers la nouvelle API fusionnée.
...
using (PresentationEx pres = new PresentationEx())
{
	...
	//Populer maintenant les données de la série
	series.Values.Add(fact.GetCell(defaultWorksheetIndex, 1, 1, 20));
	series.Values.Add(fact.GetCell(defaultWorksheetIndex, 2, 1, 50));
	series.Values.Add(fact.GetCell(defaultWorksheetIndex, 3, 1, 30));

	//Définir la couleur de remplissage de la série
	...
	//Afficher la valeur et un texte personnalisé
	lbl = new DataLabelEx(series);
...
``` csharp
//Instancier la classe Presentation qui représente le fichier PPTX//Instancier la classe Presentation qui représente le fichier PPTX
...
Veuillez consulter le fragment de code simple suivant pour créer un graphique en nuage de points à partir de zéro dans une présentation en utilisant l'API Aspose.Slides legacy et découvrir comment le réaliser avec la nouvelle API fusionnée.
...
using (PresentationEx pres = new PresentationEx())
{
    ...
    //Obtenir l'index de la feuille de données du graphique par défaut
    int defaultWorksheetIndex = 0;
