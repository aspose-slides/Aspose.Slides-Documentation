...
Pour utiliser le code hérité développé avec les versions d'Aspose.Slides for .NET antérieures à 13.x, vous devez apporter quelques modifications mineures à votre code et il fonctionnera comme auparavant. Toutes les classes qui se trouvaient dans les anciens espaces de noms Aspose.Slides for .NET sous Aspose.Slide et Aspose.Slides.Pptx sont maintenant fusionnées dans un seul espace de noms Aspose.Slides. Veuillez consulter l'extrait de code simple suivant qui crée un graphique normal à partir de zéro dans une présentation en utilisant l'API Aspose.Slides héritée et suivre les étapes décrivant comment migrer vers la nouvelle API fusionnée.
...
using (PresentationEx pres = new PresentationEx())
{
	...
	//Affiche le nom de la série pour le deuxième libellé
	...
	//Affiche la valeur et le texte personnalisé
	lbl = new DataLabelEx(series);
...
``` csharp
//Instancie la classe Presentation qui représente le fichier PPTX//Instancie la classe Presentation qui représente le fichier PPTX
...
Veuillez consulter l'extrait de code simple suivant qui crée un graphique en nuage de points à partir de zéro dans une présentation en utilisant l'API Aspose.Slides héritée et voir comment le réaliser avec la nouvelle API fusionnée.
