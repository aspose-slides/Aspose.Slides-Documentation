...
Cette page répertorie toutes les classes, méthodes, propriétés, etc. [ajoutés](/slides/fr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-4-0/) ou [supprimés](/slides/fr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-4-0/) ainsi que les autres changements introduits avec l'API Aspose.Slides for .NET 15.4.0.

{{% /alert %}} 
## **Modifications de l'API publique**
#### **Enum OrganizationChartLayoutType a été ajouté**
L'énumération Aspose.Slides.SmartArt.OrganizationChartLayoutType représente le type de mise en forme des nœuds enfants d'un organigramme.
#### **Méthode IBulletFormat.ApplyDefaultParagraphIndentsShifts a été ajoutée**
La méthode Aspose.Slides.IBulletFormat.ApplyDefaultParagraphIndentsShifts définit les décalages non nuls par défaut pour l'indentation effective du paragraphe et la marge gauche lorsque les puces sont activées (comme le fait PowerPoint si les puces/numérotation de paragraphe sont activées). Si les puces sont désactivées, elle réinitialise simplement l'indentation du paragraphe et la marge gauche (comme le fait PowerPoint si les puces/numérotation de paragraphe sont désactivées).
...
La méthode Aspose.Slides.IConnector.Reroute re‑trace le connecteur afin qu’il emprunte le chemin le plus court possible entre les formes qu’il relie. Pour ce faire, la méthode Reroute() peut modifier les propriétés StartShapeConnectionSiteIndex et EndShapeConnectionSiteIndex.
