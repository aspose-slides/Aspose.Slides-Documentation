---
title: API publique et changements incompatibles rétroactifs dans Aspose.Slides for .NET 14.7.0
...
L'élément SoundAction était incorrect et inutilisé. Les paramètres sonores sont définis par les propriétés SlideShowTransition.SoundMode, .Sound, .SoundLoop, .SoundIsBuiltIn, .SoundName.
...
L'énumération Aspose.Slides.SlideShow.TransitionPattern est utilisée dans cette classe et spécifie un motif géométrique qui s'imbrique pour couvrir une plus grande surface.
