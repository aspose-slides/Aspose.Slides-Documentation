---
title: API publique et modifications incompatibles rétroactives dans Aspose.Slides pour .NET 15.6.0
...
Cette page répertorie toutes les classes, méthodes, propriétés et ainsi de suite [added](/slides/fr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-6-0/) ou [removed](/slides/fr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-6-0/), ainsi que les autres changements introduits avec l'API Aspose.Slides for .NET 15.6.0.
...
La méthode ICommentAuthorCollection.RemoveAt a été ajoutée pour supprimer un auteur à l'index spécifié.
...
|InverseGray |Rendu avec coloration gris inverse |
