...
Cette page répertorie toutes les classes, méthodes, propriétés et ainsi de suite ajoutées, ainsi que toutes les nouvelles [restrictions](/slides/fr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-14-5-0/) et autres [changes](/slides/fr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-14-5-0/) introduites avec l'API Aspose.Slides pour .NET 14.5.0.
...
La taille et la position du cadre du GroupShape seront ajustées au contenu lorsqu'une nouvelle forme est ajoutée.
#### **Ajout des méthodes IPresentationFactory.GetPresentationInfo(string file) et IPresentatoinFactory.GetPresentationInfo(Stream stream)**
...
Cette propriété permet aux développeurs d'utiliser la fonctionnalité de fabrique sans instanciation.
### **Restrictions**
...
// maintenant la forme hérite des valeurs x, y, height, flipH, flipV du espace réservé et remplace width=100 et rotationAngle=0.
...
- La propriété IShape.RawFrame renvoie une instance d'IShapeFrame dont chaque propriété peut être indéfinie (en particulier FlipH ou FlipV peuvent avoir la valeur NullableBool.NotDefined).