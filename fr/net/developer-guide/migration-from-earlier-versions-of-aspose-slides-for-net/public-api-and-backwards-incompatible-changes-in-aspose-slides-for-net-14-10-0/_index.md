...
Le type de champ Footer a été ajouté afin de permettre la création de champs de ce type et la sérialisation valide des présentations.
...
#### **Des méthodes de suppression des points de données et des catégories de graphique ont été ajoutées**
...
``` 
#### **Les propriétés obsolètes d'Aspose.Slides.ParagraphFormat ont été supprimées**
