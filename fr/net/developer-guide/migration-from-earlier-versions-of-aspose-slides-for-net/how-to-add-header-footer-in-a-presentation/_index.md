...
- C#
- Aspose.Slides
description: "Apprenez comment ajouter des en-têtes et pieds de page aux présentations PowerPoint PPT, PPTX et ODP en .NET en utilisant les API Aspose.Slides héritées et modernes."
---
...
using (Presentation sourcePres = new Presentation())
{
    ...
    //Afficher le placeholder de date et d'heure
    sourcePres.HeaderFooterManager.SetAllDateTimesVisibility(true);
