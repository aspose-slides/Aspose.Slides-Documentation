...
{{% alert color="primary" %}} 
En savoir plus comment [Rendre la présentation avec une police de secours](/slides/fr/net/render-presentation-with-fallback-font/).
{{% /alert %}}
