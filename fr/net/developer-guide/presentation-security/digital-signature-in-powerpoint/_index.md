...
- C#
- Aspose.Slides
description: "Apprenez comment signer numériquement les fichiers PowerPoint & OpenDocument avec Aspose.Slides pour .NET. Sécurisez vos diapositives en quelques secondes avec des exemples de code clairs."
---
...
1. Ouvrez le fichier PFX et transmettez le mot de passe PFX à l'objet **DigitalSignature**[https://reference.aspose.com/slides/net/aspose.slides/digitalsignature]object.
1. Ajoutez la signature créée à l'objet présentation.
```c#
using (Presentation pres = new Presentation())
{
    // Créez l'objet DigitalSignature avec le fichier PFX et le mot de passe PFX 
