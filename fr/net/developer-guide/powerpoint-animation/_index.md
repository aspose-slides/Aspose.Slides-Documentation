...
{{% alert color="primary" %}} 
Lire la suite sur [**L'Animation de Formes**](/slides/net/shape-animation/).
{{% /alert %}}
...
{{% alert color="primary" %}} 
Lire la suite sur [**Les Graphiques Animés**](/slides/net/animated-charts/).
{{% /alert %}}
...
{{% alert color="primary" %}} 
Lire la suite sur [**Le Texte Animé**](/slides/net/animated-text/).
{{% /alert %}}