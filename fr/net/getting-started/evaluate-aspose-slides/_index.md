...
Oui. Vous pouvez traiter différents documents en parallèle ; vous ne devez pas partager le même objet de présentation [à travers les threads](/slides/fr/net/multithreading/). Le mode d'évaluation n'affecte pas cela.
...
**Puis‑je tester complètement la conversion de PPT/PPTX en PDF et en images en mode évaluation ?**
