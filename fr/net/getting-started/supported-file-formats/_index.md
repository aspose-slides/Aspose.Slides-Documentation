...
Ce tableau contient les formats de fichier que Aspose.Slides pour .NET peut charger et sauvegarder :
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Format de Fichier d'Image Tagué| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|Format de Metafile Amélioré| |{{< emoticons/tick >}}| |
|[PDF](https://docs.fileformat.com/pdf/)|Format de Document Portable|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|Spécification XML pour Papier| |{{< emoticons/tick >}}| |
|[JPEG](https://docs.fileformat.com/image/jpeg/)|Groupe d'Experts Photographiques à Joint| |{{< emoticons/tick >}}| |
|[PNG](https://docs.fileformat.com/image/png/)|Images Réseau Portables| |{{< emoticons/tick >}}| |
...
|[XAML](https://docs.fileformat.com/web/xaml/)|Langage de Marquage Applicatif Extensible| |{{< emoticons/tick >}}| |
