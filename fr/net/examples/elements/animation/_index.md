...
- C#
- Aspose.Slides
description: "Maîtrisez les animations de diapositives en C# avec Aspose.Slides : ajoutez, modifiez et supprimez les effets, les minuteries et les déclencheurs pour créer des présentations dynamiques au format PPT, PPTX et ODP."
---
...
Créez une forme rectangulaire et appliquez un effet d'apparition progressive déclenché au clic.
```csharp
