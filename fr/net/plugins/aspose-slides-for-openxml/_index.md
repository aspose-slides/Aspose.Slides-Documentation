...
## **Installation**
Pour ouvrir le projet, vous devez télécharger et installer la dernière version d'Aspose.Slides pour .NET [ici](http://www.aspose.com/.net/powerpoint-component.aspx) et l'inclure dans le projet.
...
- [Comparaison de code pour des fonctionnalités communes avec OpenXML](/slides/net/code-comparison-for-common-features-with-openxml/)
  - [Ajouter un commentaire à une diapositive](/slides/net/add-a-comment-to-a-slide/)
  - [Ajouter une diapositive à une présentation](/slides/net/adding-slide-to-presentation/)
  - [Appliquer un thème à une présentation](/slides/net/apply-a-theme-to-a-presentation/)
  - [Changer la couleur de remplissage d'une forme dans une présentation](/slides/net/change-the-fill-color-of-a-shape-in-a-presentation/)
  - [Compter le nombre de diapositives](/slides/net/count-the-number-of-slides/)
  - [Créer un document de présentation](/slides/net/create-a-presentation-document/)
  - [Supprimer tous les commentaires d'un auteur](/slides/net/delete-all-the-comments-by-an-author/)
  - [Supprimer une diapositive](/slides/net/delete-a-slide/)
  - [Obtenir tous les hyperliens externes dans une présentation](/slides/net/get-all-the-external-hyperlinks-in-a-presentation/)
  - [Obtenir tout le texte dans toutes les diapositives](/slides/net/get-all-the-text-in-all-the-slides/)
  - [Obtenir tout le texte dans une diapositive](/slides/net/get-all-the-text-in-a-slide/)
  - [Obtenir les titres de toutes les diapositives](/slides/net/get-the-titles-of-all-the-slides/)
  - [Déplacer un paragraphe d'une présentation à une autre](/slides/net/move-a-paragraph-from-one-presentation-to-another/)
  - [Déplacer une diapositive à une nouvelle position](/slides/net/move-a-slide-to-a-new-position/)
- [Fonctionnalités manquantes dans OpenXML](/slides/net/missing-features-in-openxml/)
  - [Accéder à une présentation OpenDocument](/slides/net/access-opendocument-presentation/)
  - [Ajouter des diapositives de mise en page à la présentation](/slides/net/add-layout-slides-to-presentation/)
  - [Conversion de PPT vers différents formats](/slides/net/conversion-from-ppt-to-different-formats/)
    - [Conversion de PPT vers le format PPTX dans Aspose.Slides](/slides/net/conversion-from-ppt-to-pptx-format-in-aspose-slides/)
    - [Conversion en HTML](/slides/net/conversion-to/)
    - [Conversion en PDF](/slides/net/conversion-to-pdf/)
    - [Conversion en XPS](/slides/net/conversion-to-xps/)
  - [Exporter des fichiers multimédias vers un fichier HTML](/slides/net/export-media-files-to-file/)
  - [Obtenir le format de fichier de la présentation](/slides/net/get-the-file-format-of-presentation/)
  - [Programmation de haut niveau avec le modèle d'objet document de présentation](/slides/net/high-level-programming-with-presentation-document-object-model/)
  ...
  - [Rendu et impression de la présentation](/slides/net/rendering-and-printing-of-presentation/)
    - [Conversion en Tiff avec notes](/slides/net/conversion-to-tiff-with-notes/)
    - [Rendu en Tiff](/slides/net/rendered-as-tiff/)
    - [Rendu en Tiff par dimension définie par l'utilisateur](/slides/net/rendered-as-tiff-by-user-defined-dimension/)
    - [Rendre la diapositive en tant qu'image SVG](/slides/net/render-slide-as-svg-image/)
    - [Rendre la diapositive en tant que miniature en JPEG](/slides/net/render-slide-as-thumbnail-to-jpeg/)
    - [Rendre la diapositive en tant que miniature en JPEG par valeurs définies par l'utilisateur](/slides/net/render-slide-as-thumbnail-to-jpeg-by-user-defined-values/)
  - [Transitions de diapositives](/slides/net/slide-transitions/)
  - [Travailler avec la taille et la mise en page de la présentation](/slides/net/working-with-size-and-layout-of-presentation/)