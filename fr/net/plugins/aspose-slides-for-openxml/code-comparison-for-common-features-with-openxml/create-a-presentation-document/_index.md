---
title: Créer un document de présentation
type: docs
weight: 60
url: /fr/net/create-a-presentation-document/
---
...
string FileName = FilePath + "Créer un document de présentation.pptx";
...

{
    ...
    // Créer une présentation à un chemin de fichier spécifié. Le type de document de présentation est pptx, par défaut.
    ...
    //Fermer la poignée de la présentation
                ...
                new ShapeTree(
                    ...
                    new P.Shape(
                        ...
                        new P.NonVisualShapeProperties(
                            ...
                            new P.NonVisualDrawingProperties() { Id = (UInt32Value)2U, Name = "Titre 1" },
                        ...
                        new P.TextBody(
                            ...
                            new Paragraph(new EndParagraphRunProperties() { Language = "fr-FR" }))))),
...

{
    ...
    new CommonSlideData(new ShapeTree(
      ...
      new P.NonVisualShapeProperties(
        ...
        new P.NonVisualDrawingProperties() { Id = (UInt32Value)2U, Name = "Espace réservé au titre 1" },
...

{
    ...
    D.Theme theme1 = new D.Theme() { Name = "Thème Office" };
    ...
    new D.ColorScheme(
      ...
      new D.FollowedHyperlinkColor(new D.RgbColorModelHex() { Val = "800080" })) { Name = "Bureau" },
      ...
      new D.ComplexScriptFont() { Typeface = "" })) { Name = "Bureau" },
      ...
      new D.GradientFill(
        ...
        new D.LinearGradientFill() { Angle = 16200000, Scaled = true }))) { Name = "Bureau" });
...

{
...

    {
        ...
        //Instancier la classe SlideExCollection

        ISlideCollection slds = pres.Slides;

        //Ajouter une diapositive vide à la collection SlidesEx
