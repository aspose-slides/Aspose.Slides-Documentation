...
- Java
- Aspose.Slides
description: "Insérer et modifier des équations mathématiques dans les fichiers PowerPoint PPT et PPTX avec Aspose.Slides pour Android, en prenant en charge OMML, les contrôles de formatage et des exemples de code Java clairs."
---
## **Vue d'ensemble**
...
La plupart des exemples ci‑dessous utilisent [MathematicalText](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/mathematicaltext/) et les méthodes fluides de [IMathElement](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/imathelement/) afin de garder le code court et lisible.

Pour les scénarios d'exportation MathML, voir [Exporter des équations mathématiques depuis des présentations sur Android](/slides/fr/androidjava/exporting-math-equations/).

## **Créer une équation**

Cet exemple crée une forme mathématique et ajoute le théorème de Pythagore :

![L'équation c au carré vaut a au carré plus b au carré](powerpoint-math-equations_3.png)
...
![Une expression radicaux de n‑ième racine avec x sous le signe radical](powerpoint-math-equations_5.png)
...
Utilisez `nary` pour les sommes, les unions, les intersections et autres grands opérateurs. Utilisez `integral` pour les intégrales. Les deux méthodes vous permettent de définir les limites inférieure et supérieure.
...
Les opérateurs n‑aires sont destinés aux grands opérateurs avec limites optionnelles. Les opérateurs simples tels que `+`, `-` et `=` sont généralement ajoutés comme `MathematicalText` et combinés dans l'expression.
...
Utilisez [MathMatrix](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/mathmatrix/) pour les lignes et les colonnes. Les matrices n’incluent pas de crochets par défaut, il faut donc encadrer la matrice lorsque vous avez besoin de parenthèses, de crochets ou d’accolades.
...
Utilisez `group` pour placer un caractère de groupement au-dessus ou au-dessous d’une expression. Ajoutez une limite pour étiqueter les termes regroupés.

![L'expression x plus y groupée avec le libellé tout texte en dessous](powerpoint-math-equations_15.png)
...
| Ajouter des scripts à gauche | [setSubSuperscriptOnTheLeft](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/imathelement/) |
...
| Regrouper des termes | [group](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/imathelement/) |
...
**Les équations sont‑elles enregistrées comme du math de PowerPoint modifiable ?**

Oui. Lors de l’enregistrement au format PPTX, Aspose.Slides écrit l’équation en tant que contenu mathématique Office modifiable.

**Puis‑je exporter des équations vers LaTeX ?**

Oui. Récupérez le [IMathParagraph](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/imathparagraph/) de son [IMathPortion](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/imathportion/), puis appelez [IMathParagraph.toLatex](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/imathparagraph/#toLatex--) pour l’exporter directement. Pour un exemple complet, voir [Exporter des équations mathématiques depuis des présentations sur Android via Java](/slides/fr/androidjava/exporting-math-equations/#export-math-equations-to-latex).