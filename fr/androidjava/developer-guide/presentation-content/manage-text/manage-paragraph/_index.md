...
4. Récupérez le ITextFrame associé à l’[IAutoShape](https://reference.aspose.com/slides/androidjava/com.aspose.slides/iautoshape/).
...
8. Appliquez les propriétés de mise en forme souhaitées à chaque portion en utilisant les propriétés exposées par l’objet `IPortion`.
...
6. Créez la première instance de paragraphe à l’aide de la classe [Paragraph](https://reference.aspose.com/slides/androidjava/com.aspose.slides/paragraph/).
...
8. Définissez le type de puce sur [Picture](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ippimage/) et indiquez l’image.
...
Ce code Java vous montre comment ajouter et gérer des puces image :
```java
// Instancie une classe Presentation qui représente un fichier PPTX
...
Ce code Java vous montre comment ajouter et gérer des puces à plusieurs niveaux :
```java
// Instancie une classe Presentation qui représente un fichier PPTX
Presentation pres = new Presentation();
try {
...
Ce code Java vous montre comment ajouter et gérer des paragraphes avec une numérotation ou une mise en forme personnalisées :
```java
Presentation presentation = new Presentation();
try {
...
1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/presentation/).
1. Accédez à la diapositive concernée via son indice.
...
2. Accédez à la diapositive concernée via son indice.
3. Ajoutez une [autoshape](https://reference.aspose.com/slides/androidjava/com.aspose.slides/iautoshape/) à la diapositive.
4. Ajoutez et accédez à l’[ITextFrame](https://reference.aspose.com/slides/androidjava/com.aspose.slides/itextframe/) de l’autoshape.
...
Aspose.Slides propose une prise en charge améliorée de l’exportation de textes (contenus dans des paragraphes) vers HTML.
...
Ce code Java vous montre comment exporter des textes de paragraphes PowerPoint vers HTML :
```java
...
try {
    ...
    // Recadrer le bitmap de la forme pour ne conserver que le bitmap du paragraphe.
    BufferedImage paragraphBitmap = shapeBitmap.getSubimage(imageX, imageY, imageWidth, imageHeight);
...
Oui. Utilisez le paramètre de retour à la ligne du cadre de texte ([setWrapText](https://reference.aspose.com/slides/androidjava/com.aspose.slides/textframeformat/#setWrapText-byte-)) pour désactiver le retour à la ligne afin que les lignes ne se coupent pas aux bords du cadre.

**Comment obtenir les limites exactes d’un paragraphe spécifique sur la diapositive ?**

Vous pouvez récupérer le rectangle englobant du paragraphe (et même d’une portion unique) afin de connaître sa position et sa taille précises sur la diapositive.
...
Oui. La langue est définie au niveau de la portion ([PortionFormat.setLanguageId](https://reference.aspose.com/slides/androidjava/com.aspose.slides/baseportionformat/#setLanguageId-java.lang.String-)), de sorte que plusieurs langues peuvent coexister au sein d’un même paragraphe.