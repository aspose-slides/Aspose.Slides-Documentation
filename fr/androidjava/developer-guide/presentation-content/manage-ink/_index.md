...
- Java
- Aspose.Slides
description: "Gérer les objets d'encre PowerPoint — créer, modifier et styliser l'encre numérique avec Aspose.Slides pour Android. Obtenez des exemples de code Java pour les tracés, la couleur du pinceau et la taille du pinceau."
---
...
Aspose.Slides fournit tous les types d'encre (par ex. la classe [Ink](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ink/)) dont vous avez besoin pour créer et gérer des objets d'encre.

## **Différences entre les objets normaux et les objets d'encre**

Les objets d'une diapositive PowerPoint sont généralement représentés par des objets forme. Un objet forme, dans sa forme la plus simple, est un conteneur qui définit la zone de l'objet lui-même (son cadre) ainsi que ses propriétés. Ces dernières incluent la taille de la zone du conteneur, la forme du conteneur, l'arrière‑plan du conteneur, etc. Pour plus d'informations, voir [Shape Layout Format](https://docs.aspose.com/slides/androidjava/shape-manipulations/#access-layout-formats-for-shape).
...
* Pour en savoir plus sur les formes en général, consultez la section [PowerPoint Shapes](https://docs.aspose.com/slides/androidjava/powerpoint-shapes/).
* Pour plus d'informations sur les valeurs effectives, consultez [Shape Effective Properties](https://docs.aspose.com/slides/androidjava/shape-effective-properties/#getting-effective-font-height-value).