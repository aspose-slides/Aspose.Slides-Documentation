---
title: Gestion des contrôles ActiveX dans les présentations sur Android
linktitle: ActiveX
type: docs
weight: 80
...
Les contrôles ActiveX sont utilisés dans les présentations. Aspose.Slides for Android via Java vous permet d’ajouter et de gérer les contrôles ActiveX, mais ils sont un peu plus complexes à gérer comparés aux formes normales d’une présentation. Nous avons implémenté la prise en charge de l’ajout du contrôle Active Media Player dans Aspose.Slides. Notez que les contrôles ActiveX ne sont pas des formes ; ils ne font pas partie de la présentation’s [IShapeCollection](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/ishapecollection/). Ils font partie de la [IControlCollection](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/icontrolcollection/) séparée. Dans cet article, nous vous montrerons comment les utiliser.
...
1. Créez une instance de la classe [Presentation] et générez une présentation vide.
1. Accédez à la diapositive cible dans [Presentation].
1. Ajoutez le contrôle ActiveX Media Player en utilisant la méthode [addControl](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/IControlCollection#addControl-int-float-float-float-float-) exposée par [IControlCollection](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/icontrolcollection/).
...
Aspose.Slides for Android via Java 7.1.0 et les versions ultérieures sont équipés de composants permettant de gérer les contrôles ActiveX. Vous pouvez accéder au contrôle ActiveX déjà ajouté dans votre présentation et le modifier ou le supprimer via ses propriétés.
...
1. Accédez aux contrôles ActiveX de la diapositive en accédant à la [IControlCollection](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/icontrolcollection/).
1. Accédez au contrôle ActiveX TextBox1 en utilisant l’objet [IControl](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/icontrol/).
...
try {
    ...
    if (control.getName().equalsIgnoreCase("TextBox1") && control.getProperties() != null) {
        ...
        // Modifier l'image de remplacement. PowerPoint remplacera cette image lors de l'activation du contrôle ActiveX,
...
### Aspose.Slides conserve-t-il les contrôles ActiveX lors de la lecture et du resauvegarde s’ils ne peuvent pas être exécutés dans le runtime Java ?
...
Les contrôles ActiveX sont des contrôles interactifs gérés (boutons, zones de texte, lecteur multimédia), tandis que [OLE](/slides/fr/androidjava/manage-ole/) désigne des objets d’application intégrés (par exemple, une feuille de calcul Excel). Ils sont stockés et gérés différemment et possèdent des modèles de propriétés distincts.
