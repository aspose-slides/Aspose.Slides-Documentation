...
- Java
- Aspose.Slides
description: "Apprenez à ajouter et formater les étiquettes de données de graphique dans les présentations PowerPoint en utilisant Aspose.Slides pour Android via Java pour des diapositives plus attrayantes."
---

Les étiquettes de données sur un graphique affichent les détails concernant les séries de données du graphique ou les points de données individuels. Elles permettent aux lecteurs d’identifier rapidement les séries de données et facilitent également la compréhension des graphiques.

## **Définir la précision des données dans les étiquettes de données du graphique**

Ce code Java vous montre comment définir la précision des données dans une étiquette de données du graphique :
```java
...
## **Afficher les pourcentages sous forme d’étiquettes**

Aspose.Slides for Android via Java vous permet de définir des étiquettes de pourcentage sur les graphiques affichés. Ce code Java démontre le fonctionnement :
```java
...
## **Ajouter le signe de pourcentage aux étiquettes de données du graphique**

Ce code Java vous montre comment ajouter le signe de pourcentage à une étiquette de données du graphique :
```java
// Crée une instance de la classe Presentation
Presentation pres = new Presentation();
try {
...
Lorsque vous créez un graphique qui ne dépend d’aucun axe, comme un diagramme circulaire, les étiquettes de données du graphique peuvent se retrouver trop proches de son bord. Dans ce cas, il faut ajuster l’emplacement de l’étiquette afin que les lignes de repère s’affichent clairement.

Ce code Java vous montre comment ajuster l’emplacement de l’étiquette sur un diagramme circulaire :
```java
Presentation pres = new Presentation();
try {
...
Combinez le placement automatique des étiquettes, les segments de repère et une taille de police réduite ; si nécessaire, masquez certains champs (par exemple la catégorie) ou n’affichez les étiquettes que pour les points extrêmes/clé.
