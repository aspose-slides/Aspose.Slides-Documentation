...
| [ISensitivityLabel.getAssignmentMethodType](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/isensitivitylabel/#getAssignmentMethodType--) et [ISensitivityLabel.setAssignmentMethodType](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/isensitivitylabel/#setAssignmentMethodType-int-) | Obtenir ou définir si l’étiquette a été appliquée automatiquement ou par décision de l’utilisateur. |
| [ISensitivityLabel.getContentMarkTypes](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/isensitivitylabel/#getContentMarkTypes--) | Obtenir les types de marquage de contenu associés à l’étiquette. |

La classe [SensitivityLabelAssignmentType](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/sensitivitylabelassignmenttype/) définit comment une étiquette a été attribuée :
...
- [SensitivityLabelAssignmentType.Privileged](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/sensitivitylabelassignmenttype/) représente une étiquette appliquée par décision de l’utilisateur, incluant les étiquettes appliquées manuellement, recommandées et obligatoires.
...
| [SensitivityLabelContentType.Header](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/sensitivitylabelcontenttype/) | Le marquage du contenu d’en‑tête est associé à l’étiquette. |
| [SensitivityLabelContentType.Footer](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/sensitivitylabelcontenttype/) | Le marquage du contenu de pied de page est associé à l’étiquette. |
| [SensitivityLabelContentType.Watermark](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/sensitivitylabelcontenttype/) | Le marquage du contenu de filigrane est associé à l’étiquette. |
| [SensitivityLabelContentType.Encryption](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/sensitivitylabelcontenttype/) | La protection par chiffrement est associée à l’étiquette. |
...
Enregistrez la présentation au format PPTX en appelant [IPresentation.save](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/ipresentation/#save-java.lang.String-int-) avec [SaveFormat.Pptx](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/saveformat/), comme présenté dans les exemples ci‑dessus.