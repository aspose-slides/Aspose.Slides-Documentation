...
- Java
- Aspose.Slides
description: "Découvrez comment générer et manipuler des présentations PowerPoint et OpenDocument via VBA avec Aspose.Slides pour Android en Java afin d'optimiser votre flux de travail."
---

{{% alert title="Note" color="warning" %}} 

Lorsque vous convertissez une présentation contenant des macros vers un autre format de fichier (PDF, HTML, etc.), Aspose.Slides ignore toutes les macros (les macros ne sont pas transférées dans le fichier résultat).

Lorsque vous ajoutez des macros à une présentation ou réenregistrez une présentation contenant des macros, Aspose.Slides écrit simplement les octets des macros.

Aspose.Slides **never** exécute les macros d’une présentation.
...
Vous pouvez consulter **Aspose** [Macro Remover](https://products.aspose.app/slides/remove-macros), qui est une application Web gratuite permettant de supprimer les macros de documents PowerPoint, Excel et Word. 
...
Ce code Java vous montre comment extraire les macros VBA d’une présentation contenant des macros :
```java
// Charge la présentation contenant la macro
Presentation pres = new Presentation("VBA.pptm");
try {
...
En utilisant la méthode [IVbaProject.isPasswordProtected](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ivbaproject/#isPasswordProtected--), vous pouvez déterminer si les propriétés d’un projet sont protégées par un mot de passe.

1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/presentation/) et chargez une présentation qui contient une macro.
2. Vérifiez si la présentation contient un [projet VBA](https://reference.aspose.com/slides/androidjava/com.aspose.slides/vbaproject/).
...
Oui, vous pouvez accéder aux [contrôles ActiveX](/slides/fr/androidjava/activex/), modifier leurs propriétés et les supprimer. Ceci est utile lorsque les macros interagissent avec ActiveX.