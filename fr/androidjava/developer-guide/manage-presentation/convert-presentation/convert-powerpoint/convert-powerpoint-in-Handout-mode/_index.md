---
title: Convertir des présentations PowerPoint en mode Livret sur Android
...
- Java
- Aspose.Slides
description: "Convertir des présentations en livrets en Java. Définir le nombre de diapositives par page, conserver les notes, exporter en PDF ou images avec Aspose.Slides pour Android, avec du code d'exemple. Essayez gratuitement."
---
## **Introduction**

Aspose.Slides offre la possibilité de convertir des présentations en divers formats, y compris la création de livrets à imprimer en mode Livret. Ce mode vous permet de configurer la façon dont plusieurs diapositives apparaissent sur une même page, ce qui est utile pour les conférences, séminaires et autres événements. Vous pouvez activer ce mode en définissant la méthode `setSlidesLayoutOptions` dans les interfaces [IPdfOptions](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/ipdfoptions/), [IRenderingOptions](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/irenderingoptions/), [IHtmlOptions](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/ihtmloptions/) et [ITiffOptions](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/itiffoptions/).

Pour définir les dimensions et l’orientation de la page du livret avant l’exportation, consultez [Notes Page Size](/slides/fr/androidjava/notes-size/).

## **Exportation du mode Livret**

Pour configurer le mode Livret, utilisez l’objet [HandoutLayoutingOptions](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/handoutlayoutingoptions/), qui détermine le nombre de diapositives placées sur une même page ainsi que d’autres paramètres d’affichage.
...
Non. Le nombre et l’ordre des vignettes sont contrôlés strictement par la classe [HandoutType](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/handouttype/) ; les mises en page arbitraires ne sont pas prises en charge.

**Puis‑je inclure des diapositives masquées dans la sortie du Livret ?**

Oui. Activez les diapositives masquées à l’aide de la méthode `setShowHiddenSlides` dans les paramètres d’exportation du format cible, tel que [PdfOptions](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/pdfoptions/), [HtmlOptions](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/htmloptions/) ou [TiffOptions](https://reference.aspose.com/slides/fr/androidjava/com.aspose.slides/tiffoptions/).