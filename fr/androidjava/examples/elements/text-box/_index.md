...
type: docs
weight: 40
url: /fr/androidjava/examples/elements/text-box/
keywords:
- exemple de code
- zone de texte
- PowerPoint
...
- Java
- Aspose.Slides
description: "Travaillez avec les zones de texte dans Aspose.Slides pour Android : ajoutez, formatez, alignez, enroulez, ajustez automatiquement et stylisez le texte à l'aide de Java pour les présentations PPT, PPTX et ODP."
---
...
public static void addTextBox() {
    ...
    try {
        ...
        // Créez une forme rectangulaire (par défaut remplie avec bordure et sans texte).
