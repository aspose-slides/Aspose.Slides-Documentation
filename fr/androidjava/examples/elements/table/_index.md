...
type: docs
weight: 120
url: /fr/androidjava/examples/elements/table/
keywords:
- exemple de code
- tableau
- PowerPoint
...
- Java
- Aspose.Slides
description: "Travaillez avec des tableaux dans Aspose.Slides pour Android : créez, formatez, fusionnez des cellules, appliquez des styles, importez des données et exportez avec des exemples Java pour PPT, PPTX et ODP."
---
Exemples d'ajout de tableaux, d'accès à ceux-ci, de suppression et de fusion de cellules en utilisant **Aspose.Slides for Android via Java**.
