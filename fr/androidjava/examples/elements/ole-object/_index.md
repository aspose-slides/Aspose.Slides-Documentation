...
type: docs
weight: 210
url: /fr/androidjava/examples/elements/ole-object/
keywords:
- exemple de code
- objet OLE
- PowerPoint
...
- Java
- Aspose.Slides
description: "Gérez les objets OLE dans Aspose.Slides pour Android : insérez, liez, mettez à jour et extrayez le contenu intégré avec Java dans les présentations PPT, PPTX et ODP."
---
Cet article montre comment incorporer un fichier en tant qu'objet OLE et mettre à jour ses données en utilisant **Aspose.Slides for Android via Java**.
