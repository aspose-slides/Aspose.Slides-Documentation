...
type: docs
weight: 100
url: /fr/androidjava/examples/elements/animation/
keywords:
- exemple de code
- animation
- PowerPoint
...
- Java
- Aspose.Slides
description: "Découvrez des exemples d'animation Aspose.Slides pour Android: ajoutez, séquencez et personnalisez les effets et les transitions avec Java pour les présentations PPT, PPTX et ODP."
---
Cet article montre comment créer des animations simples et gérer leur séquence en utilisant **Aspose.Slides for Android via Java**.
