...
type: docs
weight: 140
url: /fr/androidjava/examples/elements/smart-art/
keywords:
- exemple de code
- SmartArt
- PowerPoint
...
- Java
- Aspose.Slides
description: "Travaillez avec SmartArt dans Aspose.Slides pour Android: créez, modifiez, convertissez et stylisez des diagrammes avec Java pour les présentations PowerPoint et OpenDocument."
---
Cet article montre comment ajouter des graphiques SmartArt, y accéder, les supprimer et modifier les dispositions à l’aide de **Aspose.Slides for Android via Java**.
