...
- C++
- Aspose.Slides
description: "Découvrez tous les formats de fichiers qu’Aspose.Slides pour C++ peut ouvrir, enregistrer et convertir — y compris PPT, PPTX et ODP — avec des notes claires de prise en charge d’import/export."
---
...
Ce tableau contient les formats de fichiers qu'Aspose.Slides pour C++ peut charger et enregistrer :
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Format de fichier d'image| |{{< emoticons/tick >}}| |
...
|[JPEG](https://docs.fileformat.com/image/jpeg/)|Groupe d'experts photographiques conjoint| |{{< emoticons/tick >}}| |
...
**La bibliothèque prend‑elle en charge l'incorporation de polices lors de l'exportation en PDF, avec un contrôle granulaire sur ce qui est incorporé ?**

Oui. Vous pouvez contrôler si les polices sont entièrement incorporées ou sous‑ensemble (seuls les glyphes utilisés), spécifier la façon dont les polices système courantes sont traitées, et configurer le comportement du texte ASCII via les [options d'exportation PDF](https://reference.aspose.com/slides/cpp/aspose.slides.export/pdfoptions/).

**Puis‑je détecter si un fichier est protégé par mot de passe avant de le charger réellement ?**

Oui. En utilisant l'[API d'inspection basée sur la fabrique](https://reference.aspose.com/slides/cpp/aspose.slides/presentationfactory/), vous pouvez interroger un fichier de présentation pour déterminer s'il est protégé par mot de passe sans l'ouvrir complètement.

**Existe‑t‑il des mécanismes de secours de police et une prise en charge des polices personnalisées ?**

Oui. La bibliothèque prend en charge le [chargement](/slides/fr/cpp/custom-font/) et l'[incorporation](/slides/fr/cpp/embedded-font/) de polices personnalisées et fournit des [règles de secours](/slides/fr/cpp/fallback-font/) de police pour éviter les glyphes manquants lors du rendu et de la conversion.

**Puis‑je exporter des diapositives au format XPS, et existe‑t‑il des options pour ajuster la sortie XPS ?**

Oui. L'[Exporter vers XPS](/slides/fr/cpp/convert-powerpoint-to-xps/) est pris en charge, et vous pouvez ajuster les [options d'enregistrement](https://reference.aspose.com/slides/cpp/aspose.slides.export/xpsoptions/) pertinentes pour contrôler la qualité de sortie et le contenu du document XPS.