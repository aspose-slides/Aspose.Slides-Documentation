...
## **Formats de Fichier Prisés en Charge**
Ce tableau contient les formats de fichiers que Aspose.Slides pour С++ peut charger et enregistrer :
...
|[PPS](https://docs.fileformat.com/presentation/pps/)|Présentation PowerPoint 97-2003|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|Show PowerPoint activée par macro|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[PNG](https://docs.fileformat.com/image/png/)|Graphiques Portables en Réseau| |{{< emoticons/tick >}}| |
|[GIF](https://docs.fileformat.com/image/gif/)|Format d'Interchange de Graphiques| |{{< emoticons/tick >}}| |
...
|[HTML](https://docs.fileformat.com/web/html/)|Langage de Balise Hypertexte|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[XAML](https://docs.fileformat.com/web/xaml/)|Langage de Balise d'Application Extensible| |{{< emoticons/tick >}}| |
