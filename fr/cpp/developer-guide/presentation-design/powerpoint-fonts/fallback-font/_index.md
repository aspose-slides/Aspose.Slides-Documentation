...
- C++
- Aspose.Slides
description: "Découvrez comment Aspose.Slides pour C++ utilise les polices de secours afin de maintenir la lisibilité du texte dans les présentations PowerPoint et OpenDocument lorsque les polices d'origine ne sont pas disponibles."
---
## **Introduction**

Les polices de secours sont utilisées lorsque la police spécifiée pour le texte est disponible dans le système mais ne contient pas le glyphe requis. Dans ce cas, Aspose.Slides peut utiliser l'une des polices de secours spécifiées pour remplacer le glyphe manquant.
