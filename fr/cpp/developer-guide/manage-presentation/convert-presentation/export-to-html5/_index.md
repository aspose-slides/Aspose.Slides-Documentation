...
- C++
- Aspose.Slides
description: "Exportez les présentations PowerPoint et OpenDocument vers du HTML5 adaptatif avec Aspose.Slides pour C++. Conservez la mise en forme, les animations et l'interactivité."
---
...
Oui, il existe un [paramètre](https://reference.aspose.com/slides/cpp/aspose.slides.export/saveoptions/set_skipjavascriptlinks/) qui vous permet d'ignorer les hyperliens contenant des appels JavaScript lors de l'enregistrement. Cela aide à se conformer à des politiques de sécurité strictes.