...
- C++
- Aspose.Slides
description: "Convertissez ODP en PPTX avec Aspose.Slides pour C++. Exemples de code clairs, astuces de traitement par lots et résultats de haute qualité—pas besoin de PowerPoint."
---
...
**Ai-je besoin d'installer Microsoft PowerPoint ou LibreOffice pour convertir un ODP en PPTX ?**
