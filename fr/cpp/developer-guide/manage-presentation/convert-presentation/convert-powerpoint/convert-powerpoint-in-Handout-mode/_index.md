---
title: Convertir des présentations PowerPoint en mode Handout à l'aide de C++
...
- C++
- Aspose.Slides
description: "Convertissez des présentations en notes de distribution avec C++. Définissez le nombre de diapositives par page, conservez les notes, exportez en PDF ou en images avec Aspose.Slides, avec du code d'exemple. Essayez-le gratuitement."
---
## **Introduction**
...
Aspose.Slides prend en charge les [presets](https://reference.aspose.com/slides/fr/cpp/aspose.slides.export/handouttype/) jusqu'à 9 vignettes par page avec un ordre horizontal ou vertical : 1, 2, 3, 4 (horizontal/vertical), 6 (horizontal/vertical) et 9 (horizontal/vertical).
