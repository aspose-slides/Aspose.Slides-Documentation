...
Pas toujours. Le format PPT ne prend pas en charge certaines capacités récentes (par exemple, certains effets, objets et comportements), de sorte que les fonctionnalités peuvent être simplifiées ou rasterisées lors de la conversion.
