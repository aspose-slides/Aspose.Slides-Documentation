...
- C++
- Aspose.Slides
description: "Convertir des présentations PowerPoint en HTML responsive en C++. Conservez la mise en page, les liens et les images grâce au guide de conversion Aspose.Slides pour des résultats rapides et impeccables."
---
...
Pour le code d'exemple C++ permettant de convertir PowerPoint en HTML, veuillez consulter la section ci‑dessous, c’est‑à‑dire [Convertir PowerPoint en HTML](#convert-powerpoint-to-html). Le code peut charger plusieurs formats tels que PPT, PPTX et ODP dans l’objet Presentation et les enregistrer au format HTML.
...
**Aspose.Slides** offre de nombreuses options (principalement de la classe [**HtmlOptions**](https://reference.aspose.com/slides/cpp/class/aspose.slides.export.html_options)) qui définissent le processus de conversion PowerPoint en HTML :
...
1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation).
   * Chargez le **.ppt** dans la classe _Presentation_ pour **Convertir PPT en HTML en C++**
   * Chargez le **.pptx** dans la classe _Presentation_ pour **Convertir PPTX en HTML en C++**
   * Chargez le **.odp** dans la classe _Presentation_ pour **Convertir ODP en HTML en C++**
...
Aspose.Slides fournit la classe [ResponsiveHtmlController](https://reference.aspose.com/slides/cpp/class/aspose.slides.export.responsive_html_controller) qui permet de générer des fichiers HTML responsive. Ce code montre comment convertir une présentation PowerPoint en HTML responsive en C++ :
```cpp
// Instancier un objet Presentation qui représente un fichier de présentation
auto presentation = System::MakeObject<Presentation>(u"Convert_HTML.pptx");
...
Aspose.Slides fournit la classe [EmbedAllFontsHtmlController](https://reference.aspose.com/slides/cpp/class/aspose.slides.export.embed_all_fonts_html_controller) qui permet d’incorporer toutes les polices d’une présentation lors de sa conversion en HTML.
...
Ce code en C++ montre comment générer du HTML avec des images en pleine qualité :
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
En utilisant les nouveaux fichiers de style CSS, vous pouvez facilement modifier le style du fichier HTML résultant du processus de conversion PowerPoint en HTML. 

Le code C++ de cet exemple montre comment utiliser des méthodes sur‑chargables pour créer un document HTML personnalisé avec un lien vers un fichier CSS :
``` cpp
...
Ce code C++ montre comment convertir un PowerPoint en HTML tout en liant toutes les polices et en excluant « Calibri » et « Arial » (puisqu’elles existent déjà dans le système) :
```cpp
...
public:
        ...
        String fontStyle, String fontWeight, ArrayPtr<uint8_t> fontData)
    {
        ...
        String path = String::Format(u"{0}.woff", fontName); // un certain nettoyage du chemin peut être nécessaire
...
En utilisant Aspose.Slides for C++, vous pouvez exporter des fichiers multimédia de la manière suivante :
...
Oui, Aspose.Slides prend pleinement en charge l’exportation des hyperliens incorporés vers HTML. Lorsque vous convertissez des présentations au format HTML, les hyperliens sont automatiquement conservés et restent cliquables.
