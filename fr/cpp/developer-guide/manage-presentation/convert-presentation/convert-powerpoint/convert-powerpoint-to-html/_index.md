...
- enregistrer la diapositive au format HTML
...
- C++
- Aspose.Slides
description: "Convertir des présentations PowerPoint en HTML responsive avec C++. Conservez la disposition, les liens et les images grâce au guide de conversion Aspose.Slides pour des résultats rapides et impeccables."
---
...
- [Convertir PowerPoint en HTML en C++](#convert-powerpoint-to-html)
- [Convertir PowerPoint en HTML en C++](#convert-powerpoint-to-html)
- [Convertir la diapositive PowerPoint en HTML en C++](#convert-slide-to-html)

## **PowerPoint en HTML en C++**

Pour le code d'exemple C++ permettant de convertir PowerPoint en HTML, veuillez consulter la section ci‑dessous, c’est‑à‑dire [Convertir PowerPoint en HTML](#convert-powerpoint-to-html). Le code peut charger plusieurs formats comme PPT, PPTX et ODP dans l’objet Presentation et les enregistrer au format HTML.
...
public:
        ...
        String fontStyle, String fontWeight, ArrayPtr<uint8_t> fontData)
    {
        ...
        String path = String::Format(u"{0}.woff", fontName); // il peut être nécessaire de nettoyer le chemin
...
En utilisant Aspose.Slides for C++, vous pouvez exporter des fichiers multimédia de cette façon :

1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation).
2. Obtenez une référence à la diapositive.
3. Ajoutez une vidéo à la diapositive.
4. Écrivez la présentation sous forme de fichier HTML.
...
Il n’y a aucune limitation du nombre de diapositives avec Aspose.Slides. Vous pouvez convertir des présentations de toute taille. Cependant, pour des présentations contenant un très grand nombre de diapositives, les performances peuvent dépendre des ressources disponibles sur votre serveur ou système.