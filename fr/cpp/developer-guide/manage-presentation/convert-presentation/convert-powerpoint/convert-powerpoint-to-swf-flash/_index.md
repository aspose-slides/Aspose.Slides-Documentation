...
- C++
- Aspose.Slides
description: "Convertir PowerPoint (PPT/PPTX) en SWF Flash en C++ avec Aspose.Slides. Exemples de code étape par étape, sortie rapide de qualité, sans automatisation PowerPoint."
---
...
``` cpp
// Le chemin du répertoire documents.
