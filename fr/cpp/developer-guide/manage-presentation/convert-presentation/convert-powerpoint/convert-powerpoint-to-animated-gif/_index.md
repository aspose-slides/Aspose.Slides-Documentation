...
Vous pourriez vouloir découvrir un convertisseur GRATUIT [Text to GIF](https://products.aspose.app/slides/text-to-gif) développé par Aspose. 
{{% /alert %}}
...
Installez les polices manquantes ou [configurez les polices de secours](/slides/fr/cpp/powerpoint-fonts/). Aspose.Slides effectuera une substitution, mais l'apparence peut différer. Pour le branding, assurez-vous toujours que les polices requises sont explicitement disponibles.
