---
title: Convertir les présentations PowerPoint en GIF animés en C++
...
Si vous préférez personnaliser les paramètres du GIF, vous pouvez utiliser la classe [GifOptions](https://reference.aspose.com/slides/cpp/class/aspose.slides.export.gif_options). Voir le code d'exemple ci‑dessous. 
...
Vous pouvez consulter gratuitement le convertisseur [Text to GIF](https://products.aspose.app/slides/text-to-gif) développé par Aspose. 
...
Installez les polices manquantes ou [configurez des polices de secours](/slides/fr/cpp/powerpoint-fonts/). Aspose.Slides les remplacera, mais l’apparence peut différer. Pour le branding, assurez‑vous toujours que les polices requises sont explicitement disponibles.

**Puis‑je superposer un filigrane sur les images du GIF ?**

Oui. [Ajoutez un objet/logo semi‑transparent](/slides/fr/cpp/watermark/) à la diapositive maître ou aux diapositives individuelles avant l’exportation — le filigrane apparaîtra sur chaque image.