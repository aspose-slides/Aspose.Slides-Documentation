...
Aspose.Slides ne impose aucune limite stricte au nombre de diapositives que vous pouvez traiter. Cependant, vous pouvez rencontrer une erreur de manque de mémoire lors du traitement de présentations volumineuses ou d'images haute résolution.