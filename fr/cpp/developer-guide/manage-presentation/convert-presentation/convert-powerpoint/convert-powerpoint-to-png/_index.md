...
- C++
- Aspose.Slides
description: "Convertissez les présentations PowerPoint en images PNG de haute qualité rapidement avec Aspose.Slides pour C++, en garantissant des résultats précis et automatisés."
---
...
Ce code C++ montre comment convertir une présentation PowerPoint en PNG :
```cpp
...
Oui, mais [ne partagez pas](/slides/fr/cpp/multithreading/) une même instance de présentation entre plusieurs threads. Utilisez une instance séparée par thread ou processus.
