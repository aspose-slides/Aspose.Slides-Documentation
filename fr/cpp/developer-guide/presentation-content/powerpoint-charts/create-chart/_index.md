...
Les graphiques aident les personnes à visualiser rapidement les données et à en tirer des informations, ce qui peut ne pas être immédiatement apparent à partir d’un tableau ou d’une feuille de calcul. 
...
* repérer les valeurs aberrantes, les écarts, les erreurs, les données absurdes, etc.  
...
1. Obtenez la référence d’une diapositive à l’aide de son index.  
1. Ajoutez un graphique avec certaines données et spécifiez le type de graphique souhaité.  
...
Ce code C++ montre comment créer un graphique dispersé avec une série différente de marqueurs : 
...
// Le chemin du répertoire des documents.
	...
	// Définit l'angle de rotation des secteurs du diagramme circulaire
...
Les graphiques circulaires sont les plus adaptés pour montrer la relation partie‑pour‑tout dans les données, en particulier lorsque les données contiennent des libellés catégoriels associés à des valeurs numériques. Cependant, si vos données comprennent de nombreuses parties ou libellés, vous pouvez envisager d’utiliser un diagramme à barres à la place. 

1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/fr/cpp/class/aspose.slides.presentation).  
1. Obtenez la référence d’une diapositive à son index.  
1. Ajoutez un graphique avec les données par défaut ainsi que le type souhaité (dans ce cas, `ChartType.Pie`).  
1. Accédez aux données du graphique via IChartDataWorkbook.  
1. Effacez les séries et catégories par défaut.  
1. Ajoutez de nouvelles séries et catégories.  
1. Ajoutez de nouvelles données de graphique pour les séries.  
1. Ajoutez de nouveaux points pour les graphiques et définissez des couleurs personnalisées pour les secteurs du diagramme circulaire.  
1. Définissez les libellés pour les séries.  
1. Définissez des lignes de repère pour les libellés de séries.  
1. Définissez l’angle de rotation pour les diapositives du diagramme circulaire.  
1. Enregistrez la présentation modifiée sous forme de fichier PPTX.  

Ce code C++ montre comment créer un diagramme circulaire :
...
Par défaut, les points d’un graphique en courbes sont reliés par des lignes continues droites. Si vous souhaitez que les points soient reliés par des tirets, vous pouvez spécifier le type de tiret souhaité de cette manière :
...
### **Créer des graphiques en diagramme d’arbre**
Les graphiques en diagramme d’arbre sont les plus adaptés aux données de ventes lorsque vous voulez montrer la taille relative des catégories de données et, simultanément, attirer rapidement l’attention sur les éléments qui contribuent le plus à chaque catégorie.  

1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/fr/cpp/class/aspose.slides.presentation).  
1. Obtenez la référence d’une diapositive à son index.  
1. Ajoutez un graphique avec les données par défaut ainsi que le type souhaité (dans ce cas, `ChartType.TreeMap`).  
1. Accédez aux données du graphique via IChartDataWorkbook.  
1. Effacez les séries et catégories par défaut.  
1. Ajoutez de nouvelles séries et catégories.  
1. Ajoutez de nouvelles données de graphique pour les séries.  
...
Ce code C++ montre comment créer un diagramme d’arbre :
...
1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/fr/cpp/class/aspose.slides.presentation).  
1. Obtenez la référence d’une diapositive à son index.  
1. Ajoutez un graphique avec les données par défaut ainsi que le type souhaité (`ChartType.OpenHighLowClose`).  
1. Accédez aux données du graphique via IChartDataWorkbook.  
1. Effacez les séries et catégories par défaut.  
1. Ajoutez de nouvelles séries et catégories.  
1. Ajoutez de nouvelles données de graphique pour les séries.  
...
1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/fr/cpp/class/aspose.slides.presentation).  
1. Obtenez la référence d’une diapositive à son index.  
1. Ajoutez un graphique avec les données par défaut ainsi que le type souhaité (`ChartType.BoxAndWhisker`).  
1. Accédez aux données du graphique via IChartDataWorkbook.  
1. Effacez les séries et catégories par défaut.  
1. Ajoutez de nouvelles séries et catégories.  
1. Ajoutez de nouvelles données de graphique pour les séries.  
...
1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/fr/cpp/class/aspose.slides.presentation).  
1. Obtenez la référence d’une diapositive à son index.  
1. Ajoutez un graphique avec les données par défaut ainsi que le type souhaité (`ChartType.Funnel`).  
1. Enregistrez la présentation modifiée sous forme de fichier PPTX.  
...
1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/fr/cpp/class/aspose.slides.presentation).  
1. Obtenez la référence d’une diapositive à son index.  
1. Ajoutez un graphique avec les données par défaut ainsi que le type souhaité (dans ce cas, `ChartType.sunburst`).  
1. Enregistrez la présentation modifiée sous forme de fichier PPTX.  
...
1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/fr/cpp/class/aspose.slides.presentation).  
1. Obtenez la référence d’une diapositive à son index.  
1. Ajoutez un graphique avec certaines données et spécifiez le type souhaité (`ChartType.Histogram` dans ce cas).  
1. Accédez aux données du graphique via `IChartDataWorkbook`.  
1. Effacez les séries et catégories par défaut.  
1. Ajoutez de nouvelles séries et catégories.  
1. Enregistrez la présentation modifiée sous forme de fichier PPTX.  
...
1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/fr/cpp/class/aspose.slides.presentation).  
1. Obtenez la référence d’une diapositive à son index.  
1. Ajoutez un graphique avec certaines données et spécifiez le type souhaité (`ChartType.Radar` dans ce cas).  
1. Enregistrez la présentation modifiée sous forme de fichier PPTX.  
...
1. Créez une instance de la classe [Presentation](https://reference.aspose.com/slides/fr/cpp/class/aspose.slides.presentation).  
1. Obtenez la référence d’une diapositive à son index.  
1. Ajoutez un graphique avec les données par défaut ainsi que le type souhaité (`ChartType.ClusteredColumn`).  
1. Accédez aux données du graphique via IChartDataWorkbook.  
1. Effacez les séries et catégories par défaut.  
1. Ajoutez de nouvelles séries et catégories.  
1. Ajoutez de nouvelles données de graphique pour les séries.  
...
Un graphique cartographique est une visualisation d’une zone contenant des données. Les graphiques cartographiques sont les plus adaptés pour comparer des données ou des valeurs à travers des régions géographiques.  
...
Lorsque vous utilisez un marqueur par défaut dans les graphiques, chaque série de graphique obtient automatiquement des symboles de marqueur différents.  
...
Aspose.Slides prend en charge une large gamme de types de graphiques, notamment les graphiques à barres, lignes, circulaires, en aires, dispersés, histogrammes, radars et bien d’autres. Cette flexibilité vous permet de choisir le type de graphique le plus approprié à vos besoins de visualisation de données.
