---
title: Extraire du texte des présentations
type: docs
weight: 60
url: /fr/cpp/extracting-text-from-the-presentation/
keywords:
- extraire du texte
- récupérer du texte
- diapositive
...
- C++
- Aspose.Slides
description: "Apprenez à extraire le texte des diapositives ou de l'ensemble des présentations avec Aspose.Slides pour C++ et à traiter le contenu des fichiers PPT, PPTX et ODP de manière programmatique."
---
...
Pour analyser le texte de l'ensemble de la présentation, utilisez la méthode statique [GetAllTextFrames](https://reference.aspose.com/slides/cpp/aspose.slides.util/slideutil/getalltextframes/) exposée par la classe PresentationScanner. Elle prend deux paramètres :
...
ISlideText.LayoutText - Le texte des formes de la page de disposition pour cette diapositive
