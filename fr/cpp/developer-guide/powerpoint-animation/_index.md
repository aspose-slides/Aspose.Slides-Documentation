...
**Animation PowerPoint** joue un rôle important pour rendre une présentation attrayante et captivante pour les spectateurs. Aspose.Slides offre un large éventail d’opérations pour ajouter des animations aux présentations PowerPoint :
...
- Exploiter la chronologie des animations pour contrôler les effets d’animation.  
...
L’espace de noms [Aspose::Slides::Animation](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/) fournit des classes pour travailler avec les animations PowerPoint.

## **Effets d'animation**
Aspose.Slides prend en charge **plus de 150 effets d’animation**, y compris des effets de base tels que Bounce, PathFootball et Zoom, ainsi que des effets spécifiques comme OLEObjectShow et OLEObjectOpen. Vous pouvez trouver la liste complète dans l’énumération [EffectType](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/effecttype/).
...
- [CommandEffect](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/commandeffect/)
- [FilterEffect](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/filtereffect/)
- [MotionEffect](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/motioneffect/)
- [PropertyEffect](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/propertyeffect/)
- [RotationEffect](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/rotationeffect/)
- [ScaleEffect](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/scaleeffect/)
- [SetEffect](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/seteffect/)

## **Animation personnalisée**
Pour des exemples C++ complets qui créent, inspectent et modifient les comportements et les trajectoires de mouvement éditables, consultez [Animation personnalisée](/slides/fr/cpp/custom-animation/).
...
[Behavior](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/behavior/) est un élément de base d’un effet d’animation PowerPoint. Combinez des comportements pour personnaliser un effet, ou ajoutez un comportement pour étendre un effet prédéfini. La répétition est configurée via les paramètres de synchronisation plutôt que par un comportement de répétition distinct.

[Animation Point](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/point/) est un point où un comportement doit être appliqué.

## **Chronologie d'animation**
[Sequence](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/sequence/) est une collection d’effets d’animation qui peuvent cibler différentes formes.

[IAnimationTimeLine](https://reference.aspose.com/slides/fr/cpp/aspose.slides/ianimationtimeline/) est un ensemble de séquences utilisé dans une diapositive spécifique. C’est un moteur d’animation introduit dans PowerPoint 2002. Dans les versions antérieures de PowerPoint, l’ajout d’effets d’animation aux présentations était difficile et ne pouvait être réalisé qu’avec divers contournements. La chronologie offre un modèle d’objet plus clair pour les animations PowerPoint. Une diapositive ne peut contenir qu’une seule chronologie d’animation.

## **Animation interactive**
[Trigger](https://reference.aspose.com/slides/fr/cpp/aspose.slides.animation/effecttriggertype/) vous permet de définir des actions utilisateur, comme un clic de bouton, qui déclenchent une animation particulière.
...
Oui. Vous pouvez [rendre la présentation en images](/slides/fr/cpp/convert-powerpoint-to-video/) et les encoder en vidéo (par ex., avec ffmpeg), en choisissant le nombre d’images par seconde et la résolution. Les animations et les transitions de diapositive sont lues pendant le rendu.

**Les animations resteront‑elles intactes lors du travail avec ODP (et pas seulement PPTX) ?**

PPT, PPTX et ODP sont pris en charge pour la [lecture](/slides/fr/cpp/open-presentation/) et l’[écriture](/slides/fr/cpp/save-presentation/), mais cela ne garantit pas la préservation des animations. Les données d’animation personnalisée peuvent être perdues lors de la conversion en ODP. Consultez [Animation personnalisée](/slides/fr/cpp/custom-animation/) pour des exemples et des conseils sur la vérification de la compatibilité des formats.