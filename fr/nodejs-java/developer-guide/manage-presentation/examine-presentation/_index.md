...
- JavaScript
- Aspose.Slides
description: "Explorez les diapositives, la structure et les métadonnées des présentations PowerPoint et OpenDocument en JavaScript pour obtenir des informations plus rapides et des audits de contenu plus intelligents."
---
## **Vue d'ensemble**
...
L'exemple suivant lit ces valeurs sans créer d'objet [Presentation](https://reference.aspose.com/slides/fr/nodejs-java/aspose.slides/presentation/) et imprime un inventaire compact. Il combine également [DocumentProperties.getHeadingPairs](https://reference.aspose.com/slides/fr/nodejs-java/aspose.slides/documentproperties/#getHeadingPairs) avec [DocumentProperties.getTitlesOfParts](https://reference.aspose.com/slides/fr/nodejs-java/aspose.slides/documentproperties/#getTitlesOfParts) pour afficher les groupes de contenu tels que les polices, les thèmes et les titres de diapositives.
...
L'image suivante montre les propriétés de document mises à jour de la présentation PowerPoint.
...
**Comment puis‑je vérifier si les polices sont intégrées et quelles sont‑elles ?**

Chargez la présentation et utilisez [Presentation.getFontsManager](https://reference.aspose.com/slides/fr/nodejs-java/aspose.slides/presentation/getfontsmanager/). Appelez [FontsManager.getEmbeddedFonts](https://reference.aspose.com/slides/fr/nodejs-java/aspose.slides/fontsmanager/getembeddedfonts/) pour obtenir les polices intégrées et [FontsManager.getFonts](https://reference.aspose.com/slides/fr/nodejs-java/aspose.slides/fontsmanager/getfonts/) pour obtenir les polices utilisées par la présentation. Comparez les deux résultats pour identifier les polices nécessaires au rendu mais non intégrées.
