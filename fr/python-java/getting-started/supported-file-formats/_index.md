...
## **Formats de Fichiers Prise en Charge**
Ce tableau contient les formats de fichiers que Aspose.Slides pour Python via Java peut charger et sauvegarder :
...
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|Présentation PowerPoint Macro-Enabled|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|Diaporama PowerPoint Macro-Enabled|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[POTM](https://docs.fileformat.com/presentation/potm/)|Modèle PowerPoint Macro-Enabled|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Format de Fichier d'Image Tagged| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|Format de Métafile Amélioré| |{{< emoticons/tick >}}| |
...
|[JPEG](https://docs.fileformat.com/image/jpeg/)|Groupe d'Experts Photographiques Combinés| |{{< emoticons/tick >}}| |
...
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|Graphiques Vectoriels Scalables| |{{< emoticons/tick >}}| |
