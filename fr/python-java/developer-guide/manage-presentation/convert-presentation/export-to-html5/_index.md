...
- Java
- Aspose.Slides
description: "Exportez les présentations PowerPoint et OpenDocument en HTML5 responsive avec Aspose.Slides pour Python via Java. Conservez la mise en forme, les animations et l'interactivité."
---
## **Vue d'ensemble**
...
Les exemples nécessitent Aspose.Slides pour Python via Java et un runtime Java compatible. Placez `pres.pptx` (ou `sample.pptx` pour l'exemple des commentaires) dans le répertoire de travail actuel. Chaque exemple démarre la JVM uniquement si elle n'est pas déjà en cours d'exécution.
...
Utilisez [SaveFormat.Html](https://reference.aspose.com/slides/fr/python-java/aspose.slides/saveformat/#Html) pour l'exportation HTML standard. Voir [Convertir PowerPoint en HTML](/slides/fr/python-java/convert-powerpoint-to-html/) pour plus d'options :
```python
import jpype
import asposeslides
...
L'exportation HTML standard rend le contenu des diapositives via SVG et ne fournit pas les options d'animation de formes et de transition de diapositives HTML5. 
{{% /alert %}}
...
Ce code Python illustre le processus d'exportation PowerPoint vers la vue diapositive HTML5 :
```python
import jpype
import asposeslides
...
**Les commentaires peuvent-ils être exportés, et où peuvent-ils être placés par rapport à la diapositive ?**  
