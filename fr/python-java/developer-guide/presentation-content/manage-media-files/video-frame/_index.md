...
Pour vous permettre d’ajouter des vidéos (objets vidéo) à une présentation, Aspose.Slides fournit les classes [Video](https://reference.aspose.com/slides/fr/python-java/aspose.slides/video/) et [VideoFrame](https://reference.aspose.com/slides/fr/python-java/aspose.slides/videoframe/), ainsi que d’autres types pertinents.
...
1. Obtenir la référence d’une diapositive à l’aide de son index.
1. Ajouter un objet [Video](https://reference.aspose.com/slides/fr/python-java/aspose.slides/video/) et transmettre les données du fichier vidéo pour intégrer la vidéo à la présentation.
...
Sinon, vous pouvez ajouter une vidéo en transmettant son chemin de fichier directement à la méthode [addVideoFrame](https://reference.aspose.com/slides/fr/python-java/aspose.slides/shapecollection/#addVideoFrame) :
```python
import jpype
import asposeslides
...
1. Définir une miniature pour le cadre vidéo.
...
Aspose.Slides vous permet de contrôler quelle partie d’une vidéo est lue en définissant les valeurs trim‑from‑start et trim‑from‑end via [VideoFrame.setTrimFromStart](https://reference.aspose.com/slides/fr/python-java/aspose.slides/videoframe/#setTrimFromStart) et [VideoFrame.setTrimFromEnd](https://reference.aspose.com/slides/fr/python-java/aspose.slides/videoframe/#setTrimFromEnd). Les deux valeurs sont spécifiées en millisecondes et définissent la durée à ignorer au début et à la fin de la vidéo, respectivement. Ces paramètres modifient les réglages de lecture de la vidéo dans la présentation ; ils ne coupent ni ne modifient les données binaires de la vidéo intégrée.
...
L’exemple de code suivant saute les 2,5 premières secondes et la dernière seconde d’une vidéo intégrée lors de la lecture :
```python
from pathlib import Path
...
1. Ajouter un objet [VideoFrame](https://reference.aspose.com/slides/fr/python-java/aspose.slides/videoframe/) à une diapositive.
1. Utiliser la [CaptionsCollection](https://reference.aspose.com/slides/fr/python-java/aspose.slides/captionscollection/) renvoyée par [getCaptionTracks](https://reference.aspose.com/slides/fr/python-java/aspose.slides/videoframe/#getCaptionTracks) pour ajouter une piste de sous‑titres WebVTT.
1. Enregistrer la présentation modifiée.
...
La classe [CaptionsCollection](https://reference.aspose.com/slides/fr/python-java/aspose.slides/captionscollection/) propose également une surcharge qui vous permet d’ajouter des sous‑titres à partir d’un flux.
...
1. Trouver l’objet [VideoFrame](https://reference.aspose.com/slides/fr/python-java/aspose.slides/videoframe/) cible.
1. Parcourir les pistes de sous‑titres dans la [CaptionsCollection](https://reference.aspose.com/slides/fr/python-java/aspose.slides/captionscollection/).
...
Chaque objet [Captions](https://reference.aspose.com/slides/fr/python-java/aspose.slides/captions/) expose l’identifiant du sous‑titre, le libellé, les données binaires et le texte du sous‑titre sous forme de chaîne UTF‑8.
...
1. Charger la présentation contenant la vidéo.
1. Obtenir l’objet [VideoFrame](https://reference.aspose.com/slides/fr/python-java/aspose.slides/videoframe/) cible.
1. Supprimer les pistes de sous‑titres de la [CaptionsCollection](https://reference.aspose.com/slides/fr/python-java/aspose.slides/captionscollection/).
1. Enregistrer la présentation modifiée.
...
1. Parcourir tous les objets [Slide](https://reference.aspose.com/slides/fr/python-java/aspose.slides/slide/).
1. Parcourir tous les objets [Shape](https://reference.aspose.com/slides/fr/python-java/aspose.slides/shape/) pour trouver un [VideoFrame](https://reference.aspose.com/slides/fr/python-java/aspose.slides/videoframe/).
1. Enregistrer la vidéo sur le disque.
...
Oui. Vous pouvez échanger le [contenu vidéo](https://reference.aspose.com/slides/fr/python-java/aspose.slides/videoframe/#setEmbeddedVideo) à l’intérieur du cadre tout en conservant la géométrie de la forme ; c’est un scénario courant pour mettre à jour les médias dans une mise en page existante.

**Peut‑on déterminer le type de contenu (MIME) d’une vidéo intégrée ?**

Oui. Une vidéo intégrée possède un [type de contenu](https://reference.aspose.com/slides/fr/python-java/aspose.slides/video/#getContentType) que vous pouvez lire et utiliser, par exemple lors de son enregistrement sur le disque.