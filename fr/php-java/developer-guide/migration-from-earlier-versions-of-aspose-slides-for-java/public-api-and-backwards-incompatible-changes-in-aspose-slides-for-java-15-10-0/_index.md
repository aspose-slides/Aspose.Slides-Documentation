---
title: API public et Changements incompatibles avec les versions précédentes dans Aspose.Slides pour PHP via Java 15.10.0
type: docs
weight: 180
...
Cette page répertorie toutes les classes, méthodes, propriétés, etc. [ajoutées](/slides/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/) ou [supprimées](/slides/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/), ainsi que d'autres changements introduits avec l'API Aspose.Slides pour PHP via Java 15.10.0.
...
Ces méthodes sont destinées à soutenir les animations des éléments du graphique :
...
```
#### **Nouvelle classe com.aspose.slides.VideoPlayerHtmlController ajoutée pour prendre en charge l'exportation des fichiers multimédias en HTML**
La nouvelle classe publique com.aspose.slides.VideoPlayerHtmlController a été ajoutée. En utilisant une instance de cette classe, l'utilisateur peut exporter des fichiers vidéo et audio en HTML.
