---
title: Gérer les objets d'encre de présentation en PHP
...
- PHP
- Aspose.Slides
description: "Gérez les objets encre de PowerPoint — créez, éditez et stylisez l'encre numérique avec Aspose.Slides pour PHP via Java. Obtenez des exemples de code pour les traces, la couleur et la taille du pinceau."
---
...
Aspose.Slides fournit tous les types d’encre (par exemple la classe [Ink](https://reference.aspose.com/slides/php-java/aspose.slides/ink/)) dont vous avez besoin pour créer et gérer des objets encre.

## **Différences entre les objets normaux et les objets encre**

Les objets sur une diapositive PowerPoint sont généralement représentés par des objets forme. Un objet forme, dans sa forme la plus simple, est un conteneur qui définit la zone de l’objet lui‑même (son cadre) ainsi que ses propriétés. Ces dernières comprennent la taille de la zone du conteneur, la forme du conteneur, l’arrière‑plan du conteneur, etc. Pour plus d’informations, voir [Format de mise en page de forme](https://docs.aspose.com/slides/php-java/shape-manipulations/#access-layout-formats-for-shape).
...
* Pour en savoir plus sur les formes en général, consultez la section [Formes PowerPoint](https://docs.aspose.com/slides/php-java/powerpoint-shapes/).
* Pour plus d’informations sur les valeurs effectives, consultez [Propriétés effectives de la forme](https://docs.aspose.com/slides/php-java/shape-effective-properties/#getting-effective-font-height-value).