---
title: Ajouter du texte dynamiquement en utilisant VSTO et Aspose.Slides pour PHP via Java
type: docs
weight: 20
url: /fr/php-java/adding-text-dynamically-using-vsto-and-aspose-slides-for-java/
---

{{% alert color="primary" %}} 

Une tâche courante que les développeurs doivent accomplir est d'ajouter du texte aux diapositives de manière dynamique. Cet article présente des exemples de code pour ajouter du texte dynamiquement en utilisant [VSTO](/slides/fr/php-java/adding-text-dynamically-using-vsto-and-aspose-slides-for-java/) et [Aspose.Slides pour PHP via Java](/slides/fr/php-java/adding-text-dynamically-using-vsto-and-aspose-slides-for-java/).
...
Les extraits de code ci-dessous aboutissent à une présentation avec une diapositive simple et une chaîne de texte dessus.
...
## **Exemple d'Aspose.Slides pour PHP via Java**
...
**La présentation créée en utilisant Aspose.Slides pour PHP via Java**
