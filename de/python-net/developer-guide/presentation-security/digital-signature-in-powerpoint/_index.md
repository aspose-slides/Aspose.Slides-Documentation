...
Das folgende Code‑Beispiel zeigt, wie eine digitale Signatur aus einem PFX‑Zertifikat hinzugefügt wird:
...
2. Fügen Sie die erstellte Signatur dem Präsentations‑Objekt hinzu.
...
Nun kann geprüft werden, ob die Präsentation digital signiert ist und nicht verändert wurde:
...
Nein. Eine Signatur bewahrt Integrität und Urheberschaft, blockiert jedoch keine Bearbeitungen. Um das Bearbeiten zu beschränken, kombinieren Sie sie mit ["Schreibgeschützt" oder einem Passwort](/slides/de/python-net/password-protected-presentation/).
