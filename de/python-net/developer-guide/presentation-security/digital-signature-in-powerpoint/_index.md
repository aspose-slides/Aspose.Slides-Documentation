...
type: docs
weight: 10
url: /de/python-net/developer-guide/presentation-security/digital-signature-in-powerpoint/
keywords:
- digitale Signatur
...
- Python
- Aspose.Slides
description: "Erfahren Sie, wie Sie PowerPoint‑ und OpenDocument‑Dateien mit Aspose.Slides für Python via .NET digital signieren. Sichern Sie Ihre Folien in Sekunden mit klaren Code‑Beispielen."
---
...
Um eine Präsentation zu signieren oder die Authentizität von Präsentationssignaturen zu überprüfen, stellt die Aspose.Slides‑API das Interface **IDigitalSignature**, das Interface **IDigitalSignatureCollection** und die Eigenschaft **IPresentation.DigitalSignatures** bereit. Derzeit werden digitale Signaturen nur für das PPTX‑Format unterstützt.

## **Digitale Signatur aus PFX‑Zertifikat hinzufügen**
Der folgende Code‑Beispiel zeigt, wie eine digitale Signatur aus einem PFX‑Zertifikat hinzugefügt wird:
...
Jetzt ist es möglich zu prüfen, ob die Präsentation digital signiert wurde und nicht verändert ist:
...
Nein. Eine Signatur bewahrt Integrität und Urheberschaft, blockiert jedoch keine Bearbeitungen. Um das Bearbeiten einzuschränken, kombinieren Sie sie mit ["Read-only" oder einem Passwort](/slides/de/python-net/password-protected-presentation/).
