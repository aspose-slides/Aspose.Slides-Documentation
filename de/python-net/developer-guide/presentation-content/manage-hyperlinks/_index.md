...
- presentation
- Python
description: "Verwalten Sie mühelos Hyperlinks in PowerPoint‑ und OpenDocument‑Präsentationen mit Aspose.Slides for Python via .NET – erhöhen Sie Interaktivität und Arbeitsabläufe in wenigen Minuten."
---

## **Übersicht**

Ein Hyperlink ist ein Verweis auf eine externe Ressource, ein Objekt oder Datenelement bzw. auf einen bestimmten Ort innerhalb einer Datei. Übliche Hyperlink‑Typen in PowerPoint‑Präsentationen umfassen:

* Links zu Websites, eingebettet in Text, Formen oder Medien
* Links zu Folien

Aspose.Slides for Python via .NET ermöglicht ein breites Spektrum an hyperlink‑bezogenen Vorgängen in Präsentationen.

## **URL-Hyperlinks hinzufügen**

Dieser Abschnitt erklärt, wie URL‑Hyperlinks zu Folienelementen hinzugefügt werden, wenn mit Aspose.Slides gearbeitet wird. Er behandelt das Zuweisen von Link‑Adressen zu Text, Formen und Bildern, um eine reibungslose Navigation während der Präsentation zu gewährleisten.
...
Da Hyperlinks Objekte oder Orte referenzieren können, lassen sie sich nutzen, um ein Inhaltsverzeichnis zu bauen.
...
Dieser Abschnitt zeigt, wie das Aussehen von Hyperlinks in Aspose.Slides formatiert werden kann. Sie lernen, Farbe und weitere Stiloptionen zu steuern, um ein einheitliches Hyperlink‑Design über Text, Formen und Bilder hinweg zu gewährleisten.

### **Hyperlink-Farbe**

Mit der [color_source](https://reference.aspose.com/slides/python-net/aspose.slides/hyperlink/color_source/)-Eigenschaft der [Hyperlink](https://reference.aspose.com/slides/python-net/aspose.slides/hyperlink/)-Klasse können Sie die Farbe eines Hyperlinks festlegen und die Farbinformationen auslesen. Diese Funktion wurde in PowerPoint 2019 eingeführt, sodass Änderungen über diese Eigenschaft in früheren PowerPoint‑Versionen keine Wirkung zeigen.
...
Dieser Abschnitt erklärt, wie Hyperlinks aus Präsentationen entfernt werden können, wenn mit Aspose.Slides gearbeitet wird. Sie lernen, Linkziele aus Text, Formen und Bildern zu löschen, ohne den ursprünglichen Inhalt und das Layout zu verändern.

### **Hyperlinks aus Text entfernen**

Der folgende Beispielcode zeigt, wie Hyperlinks aus Text auf einer Folie entfernt werden:
...
Die [Hyperlink](https://reference.aspose.com/slides/python-net/aspose.slides/hyperlink/)-Klasse ist veränderbar. Mit dieser Klasse können Sie die Werte folgender Eigenschaften anpassen:
...
Der folgende Codeabschnitt zeigt, wie ein Hyperlink zu einer Folie hinzugefügt und anschließend sein Tooltip bearbeitet wird:
...
Sie können über die Präsentation, Folie oder den Text, der den Hyperlink enthält, auf [HyperlinkQueries](https://reference.aspose.com/slides/python-net/aspose.slides/hyperlinkqueries/) zugreifen.
...
Die [HyperlinkQueries](https://reference.aspose.com/slides/python-net/aspose.slides/hyperlinkqueries/)-Klasse unterstützt folgende Methoden:
...
Abschnitte in PowerPoint sind Gruppierungen von Folien; die Navigation zielt technisch auf eine bestimmte Folie ab. Um „zu einem Abschnitt zu springen“, verlinken Sie in der Regel auf dessen erste Folie.

**Kann ich einem Master‑Folienelement einen Hyperlink zuweisen, sodass er auf allen Folien funktioniert?**

Ja. Master‑Folien‑ und Layout‑Elemente unterstützen Hyperlinks. Derartige Links erscheinen auf den Kind‑F Folien und sind während der Bildschirmpräsentation anklickbar.

**Werden Hyperlinks beim Export nach PDF, HTML, Bildern oder Video beibehalten?**

In [PDF](/slides/de/python-net/convert-powerpoint-to-pdf/) und [HTML](/slides/de/python-net/convert-powerpoint-to-html/) ja – Links bleiben in der Regel erhalten. Beim Export nach [Bildern](/slides/de/python-net/convert-powerpoint-to-png/) und [Video](/slides/de/python-net/convert-powerpoint-to-video/) können Hyperlinks nicht übertragen werden, da Raster‑Frames bzw. Videos keine Hyperlink‑Funktion unterstützen.