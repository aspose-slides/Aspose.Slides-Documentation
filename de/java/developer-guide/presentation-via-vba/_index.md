---
title: Verwalten von VBA-Projekten in Präsentationen mit Java
...
- Java
- Aspose.Slides
description: "Entdecken Sie, wie Sie PowerPoint- und OpenDocument-Präsentationen über VBA mit Aspose.Slides für Java erstellen und manipulieren können, um Ihren Arbeitsablauf zu optimieren."
---
## **Einleitung**

Aspose.Slides stellt Klassen und Schnittstellen für die Arbeit mit Makros und VBA‑Code bereit.
...
Aspose.Slides stellt die Klasse [VbaProject](https://reference.aspose.com/slides/de/java/com.aspose.slides/vbaproject/) bereit, mit der Sie VBA‑Projekte (und Projektverweise) erstellen und vorhandene Module bearbeiten können. Sie können das Interface [IVbaProject](https://reference.aspose.com/slides/de/java/com.aspose.slides/ivbaproject/) verwenden, um VBA, das in einer Präsentation eingebettet ist, zu verwalten.
...
1. Verwenden Sie den [VbaProject](https://reference.aspose.com/slides/de/java/com.aspose.slides/vbaproject/#VbaProject--)‑Konstruktor, um ein neues VBA‑Projekt hinzuzufügen.
...
Dieser Java‑Code zeigt, wie Sie von Grund auf ein VBA‑Makro zu einer Präsentation hinzufügen:
...
Über die Eigenschaft [VbaProject](https://reference.aspose.com/slides/de/java/com.aspose.slides/presentation/#getVbaProject--) der Klasse [Presentation](https://reference.aspose.com/slides/de/java/com.aspose.slides/presentation) können Sie ein VBA‑Makro entfernen.

1. Erstellen Sie eine Instanz der Klasse [Presentation](https://reference.aspose.com/slides/de/java/com.aspose.slides/presentation) und laden Sie die Präsentation, die das Makro enthält.
...
Mit der Methode [IVbaProject.isPasswordProtected](https://reference.aspose.com/slides/de/java/com.aspose.slides/ivbaproject/#isPasswordProtected--) können Sie feststellen, ob die Eigenschaften eines Projekts passwortgeschützt sind.

1. Erstellen Sie eine Instanz der Klasse [Presentation](https://reference.aspose.com/slides/de/java/com.aspose.slides/presentation/) und laden Sie eine Präsentation, die ein Makro enthält.
2. Prüfen Sie, ob die Präsentation ein [VBA‑Projekt](https://reference.aspose.com/slides/de/java/com.aspose.slides/vbaproject/) enthält.
...
Ja, Sie können vorhandene [ActiveX controls](/slides/de/java/activex/) zugreifen, deren Eigenschaften ändern und sie entfernen. Dies ist nützlich, wenn Makros mit ActiveX interagieren.