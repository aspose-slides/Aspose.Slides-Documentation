...
Diese Tabelle enthält die Dateiformate, die Aspose.Slides für Python über Java laden und speichern kann:
...
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|PowerPoint-Makro-fähige Präsentation|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|PowerPoint-Makro-fähige Diashow|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[POTM](https://docs.fileformat.com/presentation/potm/)|PowerPoint-Makro-fähige Vorlage|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[HTML](https://docs.fileformat.com/web/html/)|Hypertextauszeichnungssprache|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[XAML](https://docs.fileformat.com/web/xaml/)|Erweiterbare Anwendungsmarkupsprache| |{{< emoticons/tick >}}| |
