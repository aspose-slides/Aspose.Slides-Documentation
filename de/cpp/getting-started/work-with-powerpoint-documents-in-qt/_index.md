...
Qt ist ein C++ basiertes plattformübergreifendes Anwendungsentwicklungs-Framework, das häufig zur Entwicklung verschiedener Desktop-, Mobile- und Embedded‑System‑Anwendungen verwendet wird. Aspose.Slides für C++ kann in Qt integriert werden, um PowerPoint‑Dokumente in Ihren Qt‑Anwendungen zu erstellen und zu manipulieren.

## **Verwendung von Aspose.Slides für C++ innerhalb von Qt Creator**

Um Aspose.Slides für C++ in Ihrer Qt‑Anwendung zu verwenden, laden Sie die neueste Version der API aus dem [Downloads](https://downloads.aspose.com/slides/de/cpp) Abschnitt herunter. Sobald die API heruntergeladen ist, können Sie die C++‑Bibliothek in Qt Creator oder Visual Studio integrieren.

Um die Aspose.Slides für C++‑Bibliothek in einer Qt‑Konsolenanwendung, die in Qt Creator entwickelt wurde, zu integrieren und zu verwenden, folgen Sie bitte den unten angegebenen Schritten:
...
- Um Pfade zu lib‑ und include‑Ordnern hinzuzufügen, klicken Sie mit der rechten Maustaste im linken Bereich des Projekts und wählen Sie *Add Library*.
...
- Nachdem Sie fertig sind, enthält Ihre *.pro*‑Projektdatei die folgenden Einträge:
...
## **Verwendung von Aspose.Slides für C++ in Qt‑Anwendungen innerhalb von Visual Studio**

Um eine Qt‑Anwendung mit Visual Studio zu entwickeln, müssen Sie [Qt Visual Studio Tools](https://marketplace.visualstudio.com/items?itemName=TheQtCompany.QtVisualStudioTools-19123) installieren. Sobald die Installation abgeschlossen ist, laden Sie die neueste Version der API aus dem [Downloads](https://downloads.aspose.com/slides/de/cpp) Abschnitt herunter und folgen Sie den unten angegebenen Schritten:
