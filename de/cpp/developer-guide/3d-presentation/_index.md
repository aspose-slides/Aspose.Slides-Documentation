---
title: Erstellen Sie 3D‑Präsentationen in C++
...
Um PowerPoint‑3D‑Modelle zu drehen, muss eine Kameraperspektive auf der Form erstellt werden. Dies erfolgt mit der Methode [IThreeDFormat.get_Camera()](https://reference.aspose.com/slides/cpp/class/aspose.slides.three_d_format#ad2f989bd1fd64fd4136e1f17660035d4) . Die Rotationsmethode wird aus der Kamera‑Klasse aufgerufen, als würden Sie die Kamera drehen. Tatsächlich drehen Sie die Form in der 3D‑Ebene, wenn Sie die Kamera relativ zur Form drehen.
``` cpp
auto shape = slide->get_Shapes()->AddAutoShape(ShapeType::Rectangle, 200.0f, 150.0f, 200.0f, 200.0f);
shape->get_ThreeDFormat()->get_Camera()->SetRotation(20.0f, 30.0f, 40.0f);
...
## **3D‑Verlauf**
Einen 3D‑Verlauf auf einem PowerPoint‑3D‑Modell kann man mit der Methode [Shape.get_FillFormat().get_GradientFormat()](https://reference.aspose.com/slides/cpp/class/aspose.slides.fill_format#a1f075336cb7a0e05cd5d7a706b6f4f58) zeichnen:
``` cpp
using namespace Aspose::Slides;
...
Ja. Die Slides‑3D‑Engine rendert 3D‑Effekte beim Export in unterstützte Formate ([images](/slides/de/cpp/convert-powerpoint-to-png/), [PDF](/slides/de/cpp/convert-powerpoint-to-pdf/), [HTML](/slides/de/cpp/convert-powerpoint-to-html/), usw.).

**Kann ich die „effektiven“ (endgültigen) 3D‑Parameterwerte abrufen, die Themen, Vererbung usw. berücksichtigen?**

Ja. Slides stellt APIs zum [read effective values](/slides/de/cpp/shape-effective-properties/) bereit (einschließlich für 3D – Beleuchtung, Abschrägungen usw.), sodass Sie die endgültig angewendeten Einstellungen sehen können.

**Funktionieren 3D‑Effekte beim Konvertieren einer Präsentation in ein Video?**

Ja. Beim [generating frames for the video](/slides/de/cpp/convert-powerpoint-to-video/) werden 3D‑Effekte genau wie bei [exported images](/slides/de/cpp/convert-powerpoint-to-png/) gerendert.