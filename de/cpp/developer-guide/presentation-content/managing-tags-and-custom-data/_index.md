...
Benutzerdefinierte Daten (spezifisch für eine Präsentation) oder Benutzer können als Tags ([ITagCollection](https://reference.aspose.com/slides/cpp/aspose.slides/itagcollection/)) und CustomXmlParts ([ICustomXmlPartCollection](https://reference.aspose.com/slides/cpp/aspose.slides/icustomxmlpartcollection/)) existieren. 
...
In Folien entspricht ein Tag der Eigenschaft IDocumentProperties.Keywords. Dieser Beispielcode zeigt, wie Sie den Wert eines Tags mit Aspose.Slides für C++ für [Presentation](https://reference.aspose.com/slides/cpp/aspose.slides/presentation/): 
``` cpp
...
Dieser Beispielcode zeigt, wie Sie ein Tag zu einer [Presentation](https://reference.aspose.com/slides/cpp/aspose.slides/presentation/) mit Aspose.Slides für C++ hinzufügen: 
``` cpp
auto pres = System::MakeObject<Presentation>(u"pres.pptx");
...
Tags können auch für [Slide](https://reference.aspose.com/slides/cpp/aspose.slides/slide/) festgelegt werden: 
``` cpp
...
Oder für jede einzelne [Shape](https://reference.aspose.com/slides/cpp/aspose.slides/shape/): 
``` cpp
auto pres = System::MakeObject<Presentation>();
...
Ja. Die [tag collection](https://reference.aspose.com/slides/cpp/aspose.slides/tagcollection/) unterstützt die [clear](https://reference.aspose.com/slides/cpp/aspose.slides/tagcollection/clear/)‑Operation, die alle Schlüssel‑Wert‑Paare auf einmal löscht.
...
Verwenden Sie [GetNamesOfTags](https://reference.aspose.com/slides/cpp/aspose.slides/tagcollection/getnamesoftags/) auf der [tag collection](https://reference.aspose.com/slides/cpp/aspose.slides/tagcollection/); sie liefert ein Array aller Tag-Namen.