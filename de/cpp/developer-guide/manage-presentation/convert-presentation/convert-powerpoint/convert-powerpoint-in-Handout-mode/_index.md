...
slidesLayoutOptions->set_Handout(HandoutType::Handouts4Horizontal);  // 4 Folien pro Seite horizontal
...
Nein. Die Anzahl und Anordnung der Miniaturansichten werden strikt durch die [HandoutType](https://reference.aspose.com/slides/cpp/aspose.slides.export/handouttype/)‑Aufzählung gesteuert; beliebige Layouts werden nicht unterstützt.
