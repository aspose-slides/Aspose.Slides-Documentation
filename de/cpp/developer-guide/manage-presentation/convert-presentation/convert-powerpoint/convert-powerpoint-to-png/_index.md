...
- C++
- Aspose.Slides
description: "Konvertieren Sie PowerPoint-Präsentationen schnell in hochwertige PNG-Bilder mit Aspose.Slides für C++, wobei präzise und automatisierte Ergebnisse gewährleistet werden."
---

## **Über die PowerPoint-zu-PNG-Konvertierung**

Das PNG (Portable Network Graphics)-Format ist nicht so populär wie JPEG (Joint Photographic Experts Group), ist aber immer noch sehr verbreitet. 
...
Aspose.Slides unterstützt das [Erzeugen von Miniaturansichten einzelner Formen](/slides/de/cpp/create-shape-thumbnails/); Sie können eine Form als PNG‑Bild rendern.

**Wird die parallele Konvertierung auf einem Server unterstützt?**

Ja, aber [teilen](/slides/de/cpp/multithreading/) Sie keine einzelne Präsentationsinstanz über mehrere Threads hinweg. Verwenden Sie für jeden Thread oder Prozess eine separate Instanz.
