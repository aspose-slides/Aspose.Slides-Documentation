...
TIFF (**Tagged Image File Format**) ist ein weit verbreitetes, verlustfreies Rasterbildformat, das für seine außergewöhnliche Qualität und detailgetreue Wiedergabe von Grafiken bekannt ist. Designer, Fotografen und Desktop-Publisher wählen TIFF häufig, um Ebenen, Farbtauglichkeit und ursprüngliche Einstellungen in ihren Bildern beizubehalten.
...
Dieser C++‑Code zeigt, wie Sie eine PowerPoint‑Präsentation in TIFF konvertieren:
```cpp
// Erstellen Sie die Presentation-Klasse, die eine Präsentationsdatei (PPT, PPTX, ODP usw.) darstellt.
...
Wenn Sie ein TIFF‑Bild mit bestimmten Abmessungen benötigen, können Sie die gewünschten Werte mit den in [TiffOptions](https://reference.aspose.com/slides/cpp/aspose.slides.export/tiffoptions/) verfügbaren Methoden festlegen. Zum Beispiel ermöglicht die [set_ImageSize](https://reference.aspose.com/slides/cpp/aspose.slides.export/tiffoptions/set_imagesize/)‑Methode, die Größe des resultierenden Bildes zu definieren.

Dieser C++‑Code zeigt, wie Sie eine PowerPoint‑Präsentation in TIFF‑Bilder mit benutzerdefinierter Größe konvertieren:
```cpp
...
Mit der [set_PixelFormat](https://reference.aspose.com/slides/cpp/aspose.slides.export/tiffoptions/set_pixelformat/)‑Methode der Klasse [TiffOptions](https://reference.aspose.com/slides/cpp/aspose.slides.export/tiffoptions/) können Sie das gewünschte Pixel‑Format für das resultierende TIFF‑Bild festlegen.

Dieser C++‑Code zeigt, wie Sie eine PowerPoint‑Präsentation in ein TIFF‑Bild mit benutzerdefiniertem Pixel‑Format konvertieren:
```cpp
// Instanziieren Sie die Presentation-Klasse, die eine Präsentationsdatei (PPT, PPTX, ODP usw.) darstellt.
auto presentation = MakeObject<Presentation>(u"Demo_File.pptx");
