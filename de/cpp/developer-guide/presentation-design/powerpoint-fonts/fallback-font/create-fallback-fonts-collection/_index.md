...
Diese Sammlung kann dann an die [set_FontFallBackRulesCollection() ](https://reference.aspose.com/slides/cpp/class/aspose.slides.fonts_manager#a375fc71abd64891a39673751d127d924)Methode der [FontsManager](https://reference.aspose.com/slides/cpp/class/aspose.slides.fonts_manager) Klasse übergeben werden. FontsManager steuert die Schriften in der Präsentation. Erfahren Sie mehr [Über FontsManager und FontsLoader](/slides/de/cpp/about-fontsmanager-and-fontsloader/).
...
{{% alert color="primary" %}} 
Erfahren Sie mehr darüber, wie man eine [Präsentation mit Fallback-Schrift rendern](/slides/de/cpp/render-presentation-with-fallback-font/).
{{% /alert %}}