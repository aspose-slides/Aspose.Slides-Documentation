---
title: Öffentliche API und nicht rückwärtskompatible Änderungen in Aspose.Slides für PHP über Java 15.10.0
type: docs
weight: 180
url: /de/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/
---

{{% alert color="primary" %}} 

Diese Seite listet alle [hinzugefügten](/slides/de/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/) oder [entfernten](/slides/de/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/) Klassen, Methoden, Eigenschaften und so weiter auf, sowie andere Änderungen, die mit der Aspose.Slides für PHP über Java 15.10.0 API eingeführt wurden.

{{% /alert %}} 
## **Änderungen der öffentlichen API**
#### **API für die Animation von Diagrammserien wurde zu ISequence hinzugefügt**
Die neuen 2 Methoden wurden zu dem Interface com.aspose.slides.ISequence hinzugefügt.

```php

```

Diese Methoden sind dafür vorgesehen, die Animationen der Diagrammelemente zu unterstützen:

nach Serien
nach Kategorien
nach Serienelementen
nach Kategoriensystemen

Die beiden neuen Enums EffectChartMajorGroupingType und EffectChartMinorGroupingType in Bezug auf die Animation der Diagrammelemente wurden eingeführt.
...
Animation von Kategoriensystemen:
...
Die neue öffentliche Klasse com.aspose.slides.VideoPlayerHtmlController wurde hinzugefügt. Mit einer Instanz dieser Klasse kann der Benutzer Video- und Audiodateien in HTML exportieren.

Der Konstruktor von VideoPlayerHtmlController akzeptiert die folgenden Parameter:

path: Der Pfad, an dem Video- und Audiodateien generiert werden
