...
type: docs
weight: 30
url: /de/php-java/supported-file-formats/
---
...
Diese Tabelle enthält die Dateiformate, die Aspose.Slides für PHP über Java laden und speichern kann:
...
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|PowerPoint makrofähige Diashow|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[EMF](https://docs.fileformat.com/image/emf/)|Erweiterte Metadateiformat| |{{< emoticons/tick >}}| |
|[PDF](https://docs.fileformat.com/pdf/)|Portable Document Format|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|XML-Druckspezifikation| |{{< emoticons/tick >}}| |
