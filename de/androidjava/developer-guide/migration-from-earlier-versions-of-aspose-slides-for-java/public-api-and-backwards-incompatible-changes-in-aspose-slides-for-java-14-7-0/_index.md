...
type: docs
weight: 60
url: /de/androidjava/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-14-7-0/
---

{{% alert color="primary" %}} 

Diese Seite listet alle [hinzugefügten](/slides/de/androidjava/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-14-7-0/) Klassen, Methoden, Eigenschaften usw. auf, sowie alle neuen Einschränkungen und anderen Änderungen, die mit der Aspose.Slides für Java 14.7.0 API eingeführt wurden.
