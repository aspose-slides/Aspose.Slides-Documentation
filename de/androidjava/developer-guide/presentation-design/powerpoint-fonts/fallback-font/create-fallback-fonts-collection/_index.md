...
{{% alert color="primary" %}} 
Erfahren Sie mehr darüber, wie man eine [Präsentation mit Fallback-Schriftart rendern](/slides/androidjava/render-presentation-with-fallback-font/).
{{% /alert %}}