...
Diagramme sind visuelle Darstellungen Ihrer Daten und werden häufig in Präsentationsfolien verwendet. Dieser Artikel zeigt Ihnen den Code, um ein Excel‑Diagramm als OLE‑Objekt programmgesteuert in einer PowerPoint‑Folie zu erstellen und einzubetten, indem Sie [VSTO](/slides/de/net/create-and-embed-an-excel-chart-as-an-ole-object-into-a-microsoft-powerpoint-slide/) und [Aspose.Slides for .NET](/slides/de/net/create-and-embed-an-excel-chart-as-an-ole-object-into-a-microsoft-powerpoint-slide/) verwenden.

{{% /alert %}} 
## **Erstellen und Einbetten eines Excel‑Diagramms**
Die beiden untenstehenden Codebeispiele sind lang und detailliert, weil die beschriebene Aufgabe komplex ist. Sie erstellen eine Microsoft‑Excel‑Arbeitsmappe, erzeugen ein Diagramm und erstellen anschließend die Microsoft‑PowerPoint‑Präsentation, in die Sie das Diagramm einbetten. OLE‑Objekte enthalten Verknüpfungen zum Originaldokument, sodass ein Benutzer, der die eingebettete Datei doppelklickt, die Datei und ihre Anwendung startet.
## **VSTO‑Beispiel**
Mit VSTO werden die folgenden Schritte ausgeführt:

1. Eine Instanz des Microsoft‑Excel‑ApplicationClass‑Objekts erstellen.
1. Eine neue Arbeitsmappe mit einem Arbeitsblatt erstellen.
1. Ein Diagramm zum Arbeitsblatt hinzufügen.
1. Die Arbeitsmappe speichern.
1. Die Excel‑Arbeitsmappe öffnen, die das Arbeitsblatt mit den Diagrammdaten enthält.
1. Die ChartObjects‑Sammlung für das Arbeitsblatt abrufen.
1. Das zu kopierende Diagramm abrufen.
1. Eine Microsoft‑PowerPoint‑Präsentation erstellen.
1. Eine leere Folie zur Präsentation hinzufügen.
1. Das Diagramm vom Excel‑Arbeitsblatt in die Zwischenablage kopieren.
1. Das Diagramm in die PowerPoint‑Präsentation einfügen.
1. Das Diagramm auf der Folie positionieren.
...
static void CreateNewChartInExcel()
{
    ...
    try
    {
        ...
        // Ändere den Namen des Arbeitsblatts.
...
static void UseCopyPaste()
{
    ...
    try
    {
        ...
        // Hole die ChartObjects-Sammlung für das Arbeitsblatt.
        chartObjects =
    ...
    finally
    {
        ...
        // Schließe das Excel-Arbeitsmappenobjekt und gib es frei.
...
Mit Aspose.Slides for .NET werden die folgenden Schritte ausgeführt:

1. Eine Arbeitsmappe mit Aspose.Cells for .NET erstellen.
1. Ein Microsoft‑Excel‑Diagramm erstellen.
1. Die OLE‑Größe des Excel‑Diagramms festlegen.
1. Ein Bild des Diagramms erhalten.
1. Das Excel‑Diagramm als OLE‑Objekt in eine PPTX‑Präsentation einbetten, indem Aspose.Slides for .NET verwendet wird.
1. Das Bild für das geänderte Objekt durch das in Schritt 3 erhaltene Bild ersetzen, um das Problem des geänderten Objekts zu beheben.
1. Die erzeugte Präsentation im PPTX‑Format auf die Festplatte schreiben.
```c#
...
//-----------------------------------------------------------
//Schritt - 5: Ersetze das Bild des geänderten Objekts durch das in Schritt 3 erhaltene Bild, um das Objektänderungsproblem zu beheben
//-----------------------------------------------------------
...
static int AddExcelChartInWorkbook(Aspose.Cells.Workbook wb, int chartRows, int chartCols)
{
 ...
 24,40,38,25
    ...
    //Neues Arbeitsblatt hinzufügen, um Zellen mit Daten zu füllen
    int dataSheetIdx = wb.Worksheets.Add();
    Aspose.Cells.Worksheet dataSheet = wb.Worksheets[dataSheetIdx];
    string sheetName = "DataSheet";
    dataSheet.Name = sheetName;
    //DataSheet mit Daten füllen
    ...
    //Diagramm im ChartSheet hinzufügen, Datenreihen aus DataSheet
