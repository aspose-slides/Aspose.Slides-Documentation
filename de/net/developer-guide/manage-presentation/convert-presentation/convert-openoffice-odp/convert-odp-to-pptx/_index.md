...
- C#
- Aspose.Slides
description: "ODP mit Aspose.Slides für .NET in PPTX konvertieren. Saubere C#-Codebeispiele, Batch-Tipps und hochwertige Ergebnisse – PowerPoint nicht erforderlich."
---
...
Aspose.Slides für .NET bietet die Klasse **Presentation**, die eine Präsentationsdatei darstellt. Die Klasse kann nun ebenfalls ODP über den Presentation‑Konstruktor zugreifen, wenn das Objekt instanziiert wird. Das folgende Beispiel zeigt, wie man eine ODP‑Präsentation in eine PPTX‑Präsentation konvertiert.
...
Sie können die Web‑App [**Aspose.Slides-Konvertierung**](https://products.aspose.app/slides/conversion/) besuchen, die mit **Aspose.Slides‑API** erstellt wurde. Die App demonstriert, wie die ODP‑zu‑PPTX‑Konvertierung mit der Aspose.Slides‑API implementiert werden kann.
...
Ja. Die Bibliothek verwendet ein vollständiges Präsentations‑Objektmodell und behält die Struktur bei, einschließlich Masterfolien und Layouts, sodass das Design nach der Konvertierung korrekt bleibt.

**Kann ich passwortgeschützte ODP‑Dateien konvertieren?**

Ja. Aspose.Slides unterstützt die Erkennung von Schutz, das Öffnen und Arbeiten mit [geschützten Präsentationen](/slides/de/net/password-protected-presentation/) (einschließlich ODP), wenn Sie das Passwort bereitstellen, sowie die Konfiguration von Verschlüsselung und den Zugriff auf Dokumenteneigenschaften.
