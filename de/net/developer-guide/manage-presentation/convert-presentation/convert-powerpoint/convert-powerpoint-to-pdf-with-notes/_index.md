...
- C#
- Aspose.Slides
description: "Formate PPT und PPTX mit Notizen in PDF konvertieren mithilfe von Aspose.Slides für .NET. Layouts und Sprechernotizen für professionelle Präsentationen beibehalten."
---
## **Übersicht**

In diesem Artikel erfahren Sie, wie Sie PowerPoint‑Präsentationen mit Sprechernotizen mithilfe von Aspose.Slides in das PDF‑Format konvertieren. Diese Anleitung behandelt die erforderlichen Schritte und liefert Codebeispiele, die Ihnen dabei helfen, diese Aufgabe effizient zu erledigen. Am Ende dieses Artikels können Sie:
