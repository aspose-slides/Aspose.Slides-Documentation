---
title: Verbessere Bildverarbeitung mit der Modernen API
...
Da die Unterstützung von System.Drawing in .NET 6 und höheren Versionen für Nicht‑Windows‑Plattformen entfernt wurde ([breaking change](https://learn.microsoft.com/en-us/dotnet/core/compatibility/core-libraries/6.0/system-drawing-common-windows-only)), hat Slides einen zweistufigen Bibliotheksansatz implementiert:
...
Der Nachteil von [Aspose.Slides.NET6.CrossPlatform](https://www.nuget.org/packages/Aspose.Slides.NET6.CrossPlatform) ist, dass es eine eigene Version von System.Drawing im gleichen Namensraum implementiert (zur Unterstützung der Rückwärtskompatibilität der öffentlichen API). Wenn Aspose.Slides.NET6.CrossPlatform und System.Drawing aus .NETFramework oder dem System.Drawing.Common‑Paket gleichzeitig verwendet werden, entsteht ein Namenskonflikt, sofern kein Alias verwendet wird.

Um die Abhängigkeiten von System.Drawing im Hauptpaket Aspose.Slides.NET zu entfernen, haben wir die sogenannte „Modern API“ eingeführt – d. h. die API, die anstelle der veralteten verwendet werden soll und deren Signaturen keine Abhängigkeiten mehr von den Typen Image und Bitmap aus System.Drawing enthalten. PrinterSettings und Graphics sind als veraltet deklariert und ihr Support wurde aus der öffentlichen Slides‑API entfernt.
...
Bitte beachten Sie, dass IImage disposable ist (es implementiert das IDisposable‑Interface und sollte in einem using‑Block verwendet oder anderweitig korrekt disposed werden).
...
using (Presentation pres = new Presentation())
{
    ...
    {
        // Erstellen eines PowerPoint-Bildes durch Hinzufügen einer IImage‑Instanz zu den Bildern der Präsentation.
...
Zur Erleichterung der Migration wiederholt das Interface von IImage die separaten Signaturen der Klassen Image und Bitmap. Im Allgemeinen müssen Sie lediglich den Aufruf der alten Methode, die System.Drawing verwendet, durch den neuen Aufruf ersetzen.
...
## **Methoden/Eigenschaften, die entfernt werden, und ihre Ersatzmethoden in der Modernen API**
...
## **API‑Support für Graphics und PrinterSettings wird eingestellt**
