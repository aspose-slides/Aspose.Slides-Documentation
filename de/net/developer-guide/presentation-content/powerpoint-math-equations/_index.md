...
- C#
- Aspose.Slides
description: "Mathematische Gleichungen in PowerPoint PPT und PPTX mit Aspose.Slides für .NET einfügen und bearbeiten, unterstützt OMML, Formatierungsoptionen und klare C#-Beispiele."
---
## **Übersicht**

PowerPoint speichert Gleichungen als Office Math Markup Language (OMML). Mit Aspose.Slides für .NET können Sie denselben mathematischen Inhalt programmgesteuert erstellen: Brüche, Radikale, Funktionen, Grenzwerte, N‑äre Operatoren, Matrizen, Arrays und formatierte mathematische Blöcke.
...
![Eine PowerPoint‑Folien, die eine editierbare mathematische Gleichung enthält](powerpoint-math-equations_2.png)
...
Für MathML‑Export‑Szenarien siehe [Mathematische Gleichungen aus Präsentationen in .NET exportieren](/slides/de/net/exporting-math-equations/).
...
Verwenden Sie `Radical`, um eine Quadratwurzel, Kubikwurzel oder andere Wurzel zu erstellen. Das aktuelle Element wird zur Basis, das Argument zur Gradzahl.

![Ein n‑ter Wurzel‑Radikal‑Ausdruck mit x unter dem Wurzelzeichen](powerpoint-math-equations_5.png)
...
Verwenden Sie `AsArgumentOfFunction` oder `Function` für Funktionen wie `sin(x)`, `log(x)` oder benutzerdefinierte Funktionsnamen. Für Grenzwerte setzen Sie `lim` in ein [MathLimit](https://reference.aspose.com/slides/de/net/aspose.slides.mathtext/mathlimit/) oder verwenden `SetLowerLimit`.
...
Verwenden Sie `Nary` für Summen, Vereinigungen, Schnittmengen und andere große Operatoren. Verwenden Sie `Integral` für Integrale. Beide Methoden ermöglichen das Festlegen von Unter‑ und Obergrenzen.
...
Verwenden Sie [MathMatrix](https://reference.aspose.com/slides/de/net/aspose.slides.mathtext/mathmatrix/) für Zeilen und Spalten. Matrizen enthalten standardmäßig keine Klammern, daher sollten Sie die Matrix einschließen, wenn Sie Klammern, eckige Klammern oder geschweifte Klammern benötigen.
...
Verwenden Sie `Enclose`, um einen Ausdruck in Begrenzungszeichen zu setzen. Sie können zudem ein Trennzeichen‑Zeichen festlegen für Begrenzungsausdrücke, die mehrere Elemente enthalten.

![Ein begrenzter Ausdruck, der x, y und z enthält, getrennt durch vertikale Striche](powerpoint-math-equations_13.png)
...
Verwenden Sie Formatierungs‑Hilfsfunktionen nur dort, wo sie die Formel verdeutlichen. Zum Beispiel platziert `Overbar` einen Strich über einem mathematischen Element.
...
| Aufgabe | Haupt‑API |
| --- | --- |
| Mathe‑Text erstellen | [MathematicalText](https://reference.aspose.com/slides/de/net/aspose.slides.mathtext/mathematicaltext/) |
...
| Gleichungs‑Arrays hinzufügen | [ToMathArray](https://reference.aspose.com/slides/de/net/aspose.slides.mathtext/imathelement/tomatharray/) |
...
Ja. Holen Sie das [IMathParagraph](https://reference.aspose.com/slides/de/net/aspose.slides.mathtext/imathparagraph/) der Gleichung von ihrem [MathPortion](https://reference.aspose.com/slides/de/net/aspose.slides.mathtext/mathportion/) und rufen Sie [IMathParagraph.ToLatex](https://reference.aspose.com/slides/de/net/aspose.slides.mathtext/imathparagraph/tolatex/) auf, um es direkt zu exportieren. Ein vollständiges Beispiel finden Sie unter [Mathematische Gleichungen aus Präsentationen in .NET exportieren](/slides/de/net/exporting-math-equations/#export-math-equations-to-latex).