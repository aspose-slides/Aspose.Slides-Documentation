---
title: Öffentliche API und nicht abwärtskompatible Änderungen in Aspose.Slides für .NET 15.1.0
...
#### **Schriftart-Substitutionsfunktionalität wurde hinzugefügt**
Die Möglichkeit, Schriftarten global über die gesamte Präsentation hinweg und temporär für das Rendern zu ersetzen, wurde hinzugefügt.

Eine neue Eigenschaft "FontsManager" der Klasse Presentation wurde eingeführt. Die Klasse FontsManager verfügt über die folgenden Mitglieder:

**IFontSubstRuleCollection FontSubstRuleList** Eigenschaft

Diese Sammlung von IFontSubstRule-Instanzen wird zum Ersetzen von Schriftarten während des Renderns verwendet. IFontSubstRule verfügt über die Eigenschaften SourceFont und DestFont, die das IFontData‑Interface implementieren, sowie über die Eigenschaft ReplaceFontCondition, die die Wahl der Ersetzungsbedingung ermöglicht („WhenInaccessible“ oder „Always“).
...
Ein weiteres Beispiel demonstriert die Schriftart-Substitution beim Rendern, wenn sie nicht verfügbar ist:
...
using Aspose.Slides;
            ...
            // Arial-Schriftart wird anstelle von SomeRareFont verwendet, wenn diese nicht verfügbar ist
