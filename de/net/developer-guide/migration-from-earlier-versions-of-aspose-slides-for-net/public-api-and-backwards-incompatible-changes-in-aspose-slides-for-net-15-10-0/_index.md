...
Diese Seite listet alle [hinzugefügt](/slides/de/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) oder [entfernt](/slides/de/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) Klassen, Methoden, Eigenschaften usw. sowie weitere Änderungen, die mit der Aspose.Slides für .NET 15.10.0 API eingeführt wurden.

{{% /alert %}} 
## **Öffentliche API-Änderungen**
#### **Ein neuer VideoPlayerHtmlController hinzugefügt, um den Export von Mediendateien nach HTML zu unterstützen**
Die neue öffentliche Klasse VideoPlayerHtmlController wurde dem Namespace Aspose.Slides.Export hinzugefügt. Mit einer Instanz dieser Klasse kann der Benutzer Video‑ und Audiodateien nach HTML exportieren.
VideoPlayerHtmlController Konstruktoren akzeptieren die folgenden Parameter:

path: Der Pfad, an dem die Video‑ und Audiodateien generiert werden  
fileName: Der Name der HTML‑Datei  

baseUri: Die Basis‑URI, die zum Erzeugen der Links verwendet wird  
...
``` 
#### **Chart-Serienanimations-API wurde hinzugefügt**
Die neuen 2 Methoden wurden dem Interface Aspose.Slides.Animation.ISequence hinzugefügt.
...
Diese Methoden dienen dazu, die Animationen der Diagrammelemente zu unterstützen:
- nach Serie
- nach Kategorien
- nach Serienelementen
- nach Kategorieelementen

Die beiden neuen Enums EffectChartMajorGroupingType und EffectChartMinorGroupingType, die sich auf die Animation der Diagrammelemente beziehen, wurden eingeführt.
