...
- C#
- Aspose.Slides
description: "Erstellen Sie Xamarin‑Mobile‑Apps in C#, um Präsentationen mit Aspose.Slides anzuzeigen, zu bearbeiten und zu konvertieren. Unterstützt umfangreiche Funktionen für PPT, PPTX und ODP auf Android."
---
## **Einführung**

Xamarin ist ein Framework, das für die mobile Entwicklung in .NET C# verwendet wird. Xamarin verfügt über Tools und Bibliotheken, die die Fähigkeiten der .NET‑Plattform erweitern. Es ermöglicht Entwicklern, Anwendungen für das **Android**‑Betriebssystem zu erstellen.
...
Die Aspose.Slides‑API funktioniert auf der Xamarin‑Plattform. Dazu fügt das Aspose.Slides‑.NET‑Paket ein separates DLL für Xamarin hinzu. Aspose.Slides für Xamarin unterstützt die meisten Funktionen der .NET‑Version:
...
Wir haben einen Vergleich der Gesamtfunktionen in einem weiteren Abschnitt weiter unten auf dieser Seite bereitgestellt.

In der Aspose.Slides‑für‑Xamarin‑API sind Klassen, Namespaces, Logik und Verhalten so ähnlich wie möglich zur .NET‑Version gehalten. Sie können Ihre Aspose.Slides‑.NET‑Anwendungen mit minimalem Aufwand auf Xamarin migrieren.

## **Schnelles Beispiel**
Sie können Aspose.Slides für Xamarin verwenden, um Ihre C#‑Anwendung über Slides for Android zu erstellen und zu nutzen.

Wir stellen ein Beispiel einer Android‑via‑Xamarin‑Anwendung bereit, die Aspose.Slides nutzt, um Präsentationsfolien anzuzeigen und bei Berührung der Folie eine neue Form hinzuzufügen. Den vollständigen Quellcode der Beispiele finden Sie auf[GitHub](https://github.com/aspose-slides/Aspose.Slides-for-.NET/tree/master/Xamarin).

Beginnen wir mit der Erstellung einer Xamarin‑Android‑App:

![todo:image_alt_text](https://lh3.googleusercontent.com/sNkKZnuuGo8phWI-4g4jRA_ZESKpO9RXehPj46RVymXGPcCJuYooePXcBEcb7N6uUUxgocl4o9OjwnajzWKmL2i4MUz3gKKwXw6C0ow_VScN8vlyGBK3SpLKoE_m9BDJ3iNE4xPj)

Zuerst erstellen wir ein Inhalts‑Layout, das ein Image‑View sowie Vorher‑ und Nächste‑Buttons enthält:
...
Hier referenzieren wir die Bibliothek „Aspose.Slides.Droid.dll“, die eine Beispielpräsentation („HelloWorld.pptx“) in die Xamarin‑Anwendungs‑Assets einbindet und deren Initialisierung zu MainActivity hinzufügt:
...
Fügen wir nun die Funktion hinzu, die bei Tastendruck die Vorher‑ und Nächste‑Folien anzeigt:

**C# - MainActivity.cs - Folien bei Klick auf Vorherige‑ und Nächste‑Schaltfläche anzeigen**
``` csharp
using System.Diagnostics;
using Aspose.Slides.Theme;
...
Abschließend implementieren wir eine Funktion, um bei Berührung der Folie eine Ellipse hinzuzufügen:
...
|Einbetten von Schriften|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Rendering von Kommentaren|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Erstellen/Löschen von Master‑Folien|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
