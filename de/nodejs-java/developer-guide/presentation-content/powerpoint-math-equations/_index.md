...
- JavaScript
- Aspose.Slides
description: "Mathematische Gleichungen in PowerPoint PPT und PPTX mit Aspose.Slides für Node.js via Java einfügen und bearbeiten, unterstützt OMML, Formatierungssteuerungen und klare JavaScript-Codebeispiele."
---
## **Übersicht**

PowerPoint speichert Gleichungen als Office Math Markup Language (OMML). Mit Aspose.Slides für Node.js via Java können Sie dieselben mathematischen Inhalte programmgesteuert erstellen: Brüche, Wurzeln, Funktionen, Grenzwerte, N-äre Operatoren, Matrizen, Arrays und formatierte Mathematikblöcke.
...
![Eine PowerPoint-Folie mit einer bearbeitbaren mathematischen Gleichung](powerpoint-math-equations_2.png)

Aspose.Slides erstellt diesen mathematischen Text über drei Hauptobjekte:

- Ein mathematisches Shape, erstellt mit [addMathShape](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/shapecollection/#addMathShape), ist das Shape, das die Gleichung enthält.
...
Die meisten Beispiele unten verwenden [MathematicalText](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathematicaltext/) und die flüssigen Methoden von [MathElementBase](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/), um den Code kurz und lesbar zu halten.
...
{{% alert color="primary" %}}
`addMathShape` erstellt ein Shape, das bereits einen MathParagraph enthält. Greifen Sie auf das erste `MathPortion` zu, holen Sie dessen `MathParagraph` und fügen Sie MathBlocks oder MathElements hinzu.
{{% /alert %}}
...
Verwenden Sie [`radical`](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/) , um eine Quadratwurzel, Kubikwurzel oder eine andere Wurzel zu erstellen. Das aktuelle Element wird die Basis, und das Argument wird zum Grad.
...
Verwenden Sie [`nary`](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/) , für Summen, Vereinigungen, Schnittmengen und andere große Operatoren. Verwenden Sie [`integral`](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/) , für Integrale. Beide Methoden ermöglichen das Festlegen von unteren und oberen Grenzen.
...
N‑äre Operatoren sind für große Operatoren mit optionalen Grenzen. Einfache Operatoren wie `+`, `-` und `=` werden normalerweise als `MathematicalText` hinzugefügt und in den Ausdruck eingefügt.
...
Verwenden Sie [MathMatrix](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathmatrix/) , für Zeilen und Spalten. Matrizen enthalten standardmäßig keine Klammern, daher müssen Sie die Matrix einschließen, wenn Sie runde Klammern, eckige Klammern oder geschweifte Klammern benötigen.
...
Verwenden Sie die Hilfsfunktionen für Tief- und Hochstellung für Indizes und Potenzen. Wenn die Indizes links von der Basis erscheinen sollen, verwenden Sie [`setSubSuperscriptOnTheLeft`](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/) .
...
Verwenden Sie [`enclose`](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/) , um einen Ausdruck in Begrenzer zu setzen. Sie können auch ein Trennzeichen festlegen für Begrenzerausdrücke, die mehrere Elemente enthalten.
...
## **Eine Rahmenbox hinzufügen**

Verwenden Sie [`toBorderBox`](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/) , wenn die Gleichung selbst eingerahmt werden soll.

![Eine eingekastete Gleichung mit a² = b² + c²](powerpoint-math-equations_12.png)
...
Verwenden Sie Formatierungs‑Hilfsfunktionen nur dort, wo sie die Formel verdeutlichen. Zum Beispiel setzt [`overbar`](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/) einen Balken über ein Mathematik‑Element.
...
| Hochstellung oder Tiefstellung hinzufügen | [setSuperscript](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/), [setSubscript](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/) |
...
| Wurzeln hinzufügen | [radical](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathelementbase/) |
...
Ja. Öffnen Sie die Präsentation, finden Sie das Shape, das ein `MathPortion` enthält, holen Sie dessen `MathParagraph` und aktualisieren Sie die MathBlocks in diesem Paragraph.

**Werden Gleichungen als bearbeitbare PowerPoint‑Mathematik gespeichert?**

Ja. Beim Speichern als PPTX schreibt Aspose.Slides die Gleichung als bearbeitbaren Office‑Mathe‑Inhalt.

**Kann ich Gleichungen nach LaTeX exportieren?**

Ja. Holen Sie das [MathParagraph](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathparagraph/) der Gleichung aus ihrem [MathPortion](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathportion/), und rufen Sie [MathParagraph.toLatex](https://reference.aspose.com/slides/de/nodejs-java/aspose.slides/mathparagraph/#toLatex--) auf, um sie direkt zu exportieren. Für ein vollständiges Beispiel siehe [Export Math Equations from Presentations in Node.js via Java](/slides/de/nodejs-java/exporting-math-equations/#export-math-equations-to-latex).