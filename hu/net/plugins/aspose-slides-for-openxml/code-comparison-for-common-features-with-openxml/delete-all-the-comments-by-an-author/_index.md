---
title: Az összes megjegyzés törlése egy szerzőtől
type: docs
weight: 70
url: /hu/net/delete-all-the-comments-by-an-author/
---
## **OpenXML SDK**
``` csharp
...
// Az összes megjegyzés eltávolítása a diákban egy adott szerzőtől.
...

{
    ...
    // A megadott megjegyzés szerzőjének lekérése.
    ...
    // Az összes egyező szerző bejárása.
...

    {
        ...
        // Az összes dia bejárása és a dia részeinek lekérése.
...

        {
            ...
            // A megjegyzések listájának lekérése.
...

            {
...

                {
                    ...
                    // Az összes megjegyzés törlése a megadott szerzőtől.

                    slideCommentsPart.CommentList.RemoveChild<Comment>(comm);

                }

                // Ha a commentPart-nak nincs meglévő megjegyzése.

                if (slideCommentsPart.CommentList.ChildElements.Count == 0)

                    // Ennek a résznek a törlése.
        ...
        // A megjegyzés szerzőjének törlése a megjegyzés szerzők részéből.
...

{
    ...
    // Egy PresentationEx objektum példányosítása, amely egy PPTX fájlt képvisel
