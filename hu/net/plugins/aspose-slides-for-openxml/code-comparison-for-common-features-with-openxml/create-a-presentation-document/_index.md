---
title: Prezentációs dokumentum létrehozása
type: docs
weight: 60
url: /hu/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // Létrehoz egy prezentációt a megadott fájlútvonalon. A prezentációs dokumentum típusa alapértelmezés szerint pptx.
...

{
...

    {
        ...
        //Példányosít egy SlideExCollection osztályt

        ISlideCollection slds = pres.Slides;

        //Üres diát ad hozzá a SlidesEx gyűjteményhez
