...
- C#
- Aspose.Slides
description: "Tekintse át az Aspose.Slides for .NET nyilvános API frissítéseit és a visszafelé nem kompatibilis változásokat, hogy zökkenőmentesen migruálhassa PowerPoint PPT, PPTX és ODP prezentációs megoldásait."
---
{{% alert color="info" %}} 
Ez az oldal felsorolja az összes [added](/slides/hu/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) vagy [removed](/slides/hu/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) osztályt, metódust, tulajdonságot és így tovább, valamint az Aspose.Slides for .NET 15.10.0 API-val bevezetett egyéb változásokat.
{{% /alert %}} 
## **Public API Changes**
#### **A New VideoPlayerHtmlController Added to Support Export Media Files to HTML**
Az új nyilvános VideoPlayerHtmlController osztályt hozzáadták az Aspose.Slides.Export névtérhez. Ennek az osztálynak a példányával a felhasználó videó- és audiofájlokat exportálhat HTML-be.
A VideoPlayerHtmlController konstruktora a következő paramétereket fogadja:

path: Az útvonal, ahol a videó- és audiofájlok generálva lesznek  
...
Az új 2 metódust hozzáadták az Aspose.Slides.Animation.ISequence felülethez.
...
Bemutatták a diagram elemeinek animációjához kapcsolódó két új felsorolást (enum): EffectChartMajorGroupingType és EffectChartMinorGroupingType.
