...
type: docs
weight: 230
url: /hu/androidjava/examples/elements/comment/
keywords:
- kódpélda
- megjegyzés
- PowerPoint
...
- Java
- Aspose.Slides
description: "Dolgozzon a dia megjegyzésekkel az Aspose.Slides for Android-ban: adjon hozzá, válaszoljon, szerkesszen, oldjon fel, és exportálja a megjegyzéseket PPT, PPTX és ODP prezentációkból Java kódpéldákkal."
---
Ez a cikk bemutatja a modern megjegyzések hozzáadását, olvasását, eltávolítását és válaszolását a **Aspose.Slides for Android via Java** használatával.
...
Olvasson be egy modern megjegyzést egy meglévő prezentációból.
