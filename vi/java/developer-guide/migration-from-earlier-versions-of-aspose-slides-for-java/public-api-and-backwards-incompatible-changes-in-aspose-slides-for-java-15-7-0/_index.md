---
title: API công cộng và các thay đổi không tương thích ngược trong Aspose.Slides cho Java 15.7.0
...
Trang này liệt kê tất cả các lớp, phương thức, thuộc tính [được thêm](/slides/vi/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-7-0/) hoặc [được loại bỏ](/slides/vi/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-7-0/) và các thay đổi khác được giới thiệu trong API Aspose.Slides for Java 15.7.0.
...
Phương thức này trả về màu tự động của điểm dữ liệu dựa trên chỉ mục chuỗi, chỉ mục điểm dữ liệu, parentSeriesGroup, giá trị isColorVaried và kiểu biểu đồ. Màu này được sử dụng mặc định nếu fillType bằng NotDefined.
