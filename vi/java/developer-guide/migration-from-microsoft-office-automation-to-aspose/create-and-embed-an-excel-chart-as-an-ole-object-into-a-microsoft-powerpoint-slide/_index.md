---
title: Tạo và Nhúng Biểu Đồ Excel dưới dạng OLE Object bằng VSTO và Aspose.Slides cho Java
...
- Java
- Aspose.Slides
description: "Di chuyển từ tự động hoá Microsoft Office sang Aspose.Slides cho Java và nhúng biểu đồ Excel dưới dạng OLE object vào các slide PowerPoint (PPT, PPTX) trong Java."
---
{{% alert color="info" %}} 

Biểu đồ là các biểu diễn trực quan của dữ liệu và được sử dụng rộng rãi trong các slide thuyết trình. Bài viết này sẽ cho bạn thấy mã để tạo và nhúng một biểu đồ Excel dưới dạng OLE Object vào slide PowerPoint một cách lập trình bằng cách sử dụng [VSTO](/slides/vi/java/create-and-embed-an-excel-chart-as-an-ole-object-into-a-microsoft-powerpoint-slide/) và [Aspose.Slides for Java](/slides/vi/java/create-and-embed-an-excel-chart-as-an-ole-object-into-a-microsoft-powerpoint-slide/).

{{% /alert %}} 
## **Tạo và Nhúng Biểu Đồ Excel**
Hai ví dụ mã dưới đây dài và chi tiết vì nhiệm vụ chúng mô tả khá phức tạp. Bạn tạo một workbook Microsoft Excel, tạo một biểu đồ và sau đó tạo bản trình chiếu Microsoft PowerPoint mà bạn sẽ nhúng biểu đồ vào. Các đối tượng OLE chứa liên kết đến tài liệu gốc nên người dùng nhấn đúp vào tệp được nhúng sẽ khởi chạy tệp và ứng dụng của nó.
### **Ví Dụ VSTO**
...
1. Tạo một bản trình chiếu Microsoft PowerPoint.
1. Thêm một slide trống vào bản trình chiếu.
1. Sao chép biểu đồ từ worksheet Excel vào clipboard.
1. Dán biểu đồ vào bản trình chiếu PowerPoint.
1. Đặt vị trí cho biểu đồ trên slide.
...
1. Nhúng biểu đồ Excel dưới dạng OLE Object vào bản trình chiếu PPTX bằng Aspose.Slides for Java.
1. Thay thế hình ảnh đối tượng đã thay đổi bằng hình ảnh thu được ở bước 3 để khắc phục vấn đề đối tượng đã thay đổi.
1. Ghi bản trình chiếu đầu ra ra đĩa ở định dạng PPTX.
