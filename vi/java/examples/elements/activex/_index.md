...
type: docs
weight: 200
url: /vi/java/examples/elements/activex/
keywords:
- ví dụ mã
- ActiveX
- PowerPoint
...
- Java
- Aspose.Slides
description: "Xem các ví dụ ActiveX của Aspose.Slides for Java: chèn, cấu hình và điều khiển các đối tượng ActiveX trong các bài thuyết trình PPT và PPTX bằng mã Java rõ ràng."
---
Bài viết này trình bày cách thêm, truy cập, xóa và cấu hình các điều khiển ActiveX trong một bài thuyết trình bằng cách sử dụng **Aspose.Slides for Java**.
