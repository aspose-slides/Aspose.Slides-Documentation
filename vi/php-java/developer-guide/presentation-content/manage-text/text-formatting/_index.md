...
Bài viết này trình bày cách định dạng văn bản trong các bản trình chiếu PowerPoint và OpenDocument bằng Aspose.Slides cho PHP thông qua Java. Nó bao gồm màu nền, độ trong suốt, khoảng cách ký tự, thuộc tính phông chữ, xoay, khoảng cách đoạn văn, hành vi tự động điều chỉnh, neo văn bản, vị trí tab và cài đặt ngôn ngữ.

Trong các ví dụ dưới đây, chúng tôi sẽ sử dụng tệp có tên "sample.pptx", chứa một khung văn bản duy nhất trên slide đầu tiên với nội dung sau:

![Văn bản mẫu](sample_text.png)

Để tìm và làm nổi bật văn bản nguyên bản hoặc các khớp biểu thức chính quy, xem [Tìm kiếm và Thay thế Văn bản](/slides/vi/php-java/search-and-replace-text/).
...
Ví dụ mã dưới đây minh họa cách đặt màu nền cho **các phần văn bản với phông chữ đậm**:
...
Sử dụng [ParagraphFormat::setAlignment](https://reference.aspose.com/slides/vi/php-java/aspose.slides/paragraphformat/#setAlignment) để đặt căn chỉnh đoạn trong khung văn bản. Giá trị có thể là centered, left-aligned, right-aligned, justified, v.v.
...
Ví dụ mã sau cho thấy cách áp dụng độ trong suốt cho **các phần văn bản với phông chữ đậm**:
...
Sử dụng [BasePortionFormat::setSpacing](https://reference.aspose.com/slides/vi/php-java/aspose.slides/baseportionformat/#setSpacing) để mở rộng hoặc thu hẹp khoảng cách giữa các ký tự trong một khung văn bản.
...
Ví dụ mã dưới đây cho thấy cách mở rộng khoảng cách ký tự trong **các phần văn bản với phông chữ đậm**:
...
Để đưa kết quả render gần hơn với PowerPoint trong các trường hợp này, bạn có thể vô hiệu hoá kerning cho các phần văn bản sử dụng phông chữ bị ảnh hưởng. Đặt [BasePortionFormat::setKerningMinimalSize](https://reference.aspose.com/slides/vi/php-java/aspose.slides/baseportionformat/#setKerningMinimalSize) thành giá trị đáng kể hơn kích thước phông chữ thực tế:
...
Cài đặt này ngăn kerning được áp dụng cho các phần văn bản khớp và có thể giúp đồng bộ việc render của Aspose.Slides với đầu ra trực quan của PowerPoint cho các phông chữ bị ảnh hưởng bởi hành vi đặc thù của PowerPoint.
...
Mã sau đặt phông chữ và kiểu văn bản cho toàn bộ đoạn: nó áp dụng kích thước phông chữ, đậm, nghiêng, gạch chân chấm và phông Times New Roman cho tất cả các phần trong đoạn.
...
Ví dụ mã dưới đây áp dụng các thuộc tính tương tự cho **các phần văn bản với phông chữ đậm**:
...
Sử dụng [TextFrameFormat::setTextVerticalType](https://reference.aspose.com/slides/vi/php-java/aspose.slides/textframeformat/#setTextVerticalType) để đặt một hướng văn bản định sẵn trong một hình.

Ví dụ mã sau đặt hướng văn bản trong hình thành `Vertical270`, xoay văn bản **90 degrees counterclockwise**:
...
Sử dụng [TextFrameFormat::setRotationAngle](https://reference.aspose.com/slides/vi/php-java/aspose.slides/textframeformat/#setRotationAngle) để đặt góc xoay tuỳ chỉnh cho một [TextFrame](https://reference.aspose.com/slides/vi/php-java/aspose.slides/textframe/).
...
[TextFrameFormat::setAutofitType](https://reference.aspose.com/slides/vi/php-java/aspose.slides/textframeformat/#setAutofitType) xác định cách văn bản hành xử khi vượt quá giới hạn của vùng chứa. Sử dụng nó để kiểm soát liệu văn bản thu nhỏ, tràn hoặc tự động thay đổi kích thước hình.
...
Để đếm số dòng sau khi bọc tự động và xem cách chiều rộng văn bản hoặc hình thay đổi kết quả, xem [Count Rendered Lines](/slides/vi/php-java/manage-paragraph/). Số dòng chỉ không cho biết liệu văn bản có tràn vùng chứa hay không.

## **Đặt Neo cho Khung Văn Bản**

[TextFrameFormat::setAnchoringType](https://reference.aspose.com/slides/vi/php-java/aspose.slides/textframeformat/#setAnchoringType) xác định cách văn bản được định vị theo chiều dọc bên trong một hình, ví dụ ở trên, giữa hoặc dưới.
...
Aspose.Slides cung cấp [BasePortionFormat::setLanguageId](https://reference.aspose.com/slides/vi/php-java/aspose.slides/baseportionformat/#setLanguageId), cho phép bạn đặt ngôn ngữ kiểm tra chính tả cho một phần văn bản. Ngôn ngữ kiểm tra xác định ngôn ngữ được sử dụng cho việc kiểm tra chính tả và ngữ pháp trong PowerPoint.
...
Để áp dụng định dạng văn bản mặc định ở mức toàn bộ bản trình chiếu, sử dụng [Presentation::getDefaultTextStyle](https://reference.aspose.com/slides/vi/php-java/aspose.slides/presentation/#getDefaultTextStyle).

Ví dụ mã sau cho thấy cách đặt phông chữ đậm mặc định kích thước 14 pt cho tất cả văn bản trên các slide trong một bản trình chiếu mới.

```php
$presentation = new Presentation();
try {
    // Lấy định dạng đoạn văn cấp độ cao nhất.
...
Giả sử chúng ta có khung văn bản sau trên slide đầu tiên của tệp sample2.pptx.
