...
type: docs
weight: 230
url: /vi/python-java/examples/elements/comment/
keywords:
- bình luận
- bình luận hiện đại
- thêm bình luận
...
- Java
- Aspose.Slides
description: "Quản lý các bình luận trên slide hiện đại trong Aspose.Slides cho Python qua Java: thêm, đọc, xóa và trả lời các bình luận trong các bản trình chiếu PowerPoint và OpenDocument."
---
Bài viết này trình bày cách thêm, đọc, xóa và trả lời các bình luận hiện đại bằng **Aspose.Slides for Python via Java**.

Cài đặt gói theo hướng dẫn trong [Installation](/slides/vi/python-java/installation/). Mỗi ví dụ sẽ nhập `asposeslides` trước khi khởi động JVM, sau đó nhập API và các kiểu Java cần thiết khi JVM đã chạy. Các ví dụ truy cập và xóa sử dụng tệp `modern_comment.pptx`, được tạo bởi ví dụ đầu tiên.
...
Đọc bình luận hiện đại đầu tiên từ một bản trình chiếu hiện có.
...
Xóa bình luận đầu tiên và lưu bản trình chiếu đã cập nhật.
...
Tạo một bình luận gốc, thêm hai phản hồi, và lưu bản trình chiếu.
