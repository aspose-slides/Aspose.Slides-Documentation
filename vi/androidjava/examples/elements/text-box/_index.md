...
type: docs
weight: 40
url: /vi/androidjava/examples/elements/text-box/
keywords:
- ví dụ mã
- hộp văn bản
- PowerPoint
...
- Java
- Aspose.Slides
description: "Làm việc với các hộp văn bản trong Aspose.Slides cho Android: thêm, định dạng, căn chỉnh, gói, tự động vừa, và tạo kiểu văn bản bằng Java cho các bản trình chiếu PPT, PPTX và ODP."
---
