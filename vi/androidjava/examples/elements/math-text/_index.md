...
type: docs
weight: 160
url: /vi/androidjava/examples/elements/math-text/
keywords:
- ví dụ mã
- văn bản toán học
- PowerPoint
...
- Java
- Aspose.Slides
description: "Khám phá các ví dụ về MathematicalText của Aspose.Slides for Android: tạo và định dạng các phương trình, phân số, ma trận và ký hiệu bằng Java trong các bản trình bày PPT, PPTX và ODP."
---
Bài viết này trình bày cách làm việc với các hình dạng văn bản toán học và định dạng các phương trình bằng **Aspose.Slides for Android via Java**.
...
Đặt thuộc tính phông chữ cho một phần toán học.
