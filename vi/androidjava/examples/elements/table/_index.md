...
type: docs
weight: 120
url: /vi/androidjava/examples/elements/table/
keywords:
- ví dụ mã
- bảng
- PowerPoint
...
- Java
- Aspose.Slides
description: "Làm việc với các bảng trong Aspose.Slides cho Android: tạo, định dạng, hợp nhất ô, áp dụng kiểu dáng, nhập dữ liệu và xuất với các ví dụ Java cho PPT, PPTX và ODP."
---
Các ví dụ về việc thêm bảng, truy cập chúng, xóa chúng và hợp nhất các ô bằng cách sử dụng **Aspose.Slides for Android via Java**.
