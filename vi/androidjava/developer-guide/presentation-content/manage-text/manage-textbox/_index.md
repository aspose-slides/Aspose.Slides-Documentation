---
title: Quản lý Hộp Văn Bản trong Bài Thuyết Trình trên Android
...
- Java
- Aspose.Slides
description: "Aspose.Slides cho Android qua Java cho phép dễ dàng tạo, chỉnh sửa và sao chép các hộp văn bản trong tệp PowerPoint và OpenDocument, nâng cao tính tự động hoá bài thuyết trình của bạn."
---
## **Giới thiệu**

Văn bản trên các slide thường tồn tại trong các hộp văn bản hoặc hình dạng. Do đó, để thêm văn bản vào một slide, bạn phải thêm một hộp văn bản và sau đó đặt một số văn bản bên trong hộp văn bản. Aspose.Slides cho Android qua Java cung cấp giao diện [IAutoShape](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/IAutoShape) cho phép bạn thêm một hình dạng chứa một số văn bản.
...
3. Thêm một đối tượng [IAutoShape](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/IAutoShape) với [ShapeType](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/IGeometryShape#setShapeType-int-) được đặt là `Rectangle` tại vị trí xác định trên slide và lấy tham chiếu tới đối tượng `IAutoShape` mới được thêm.
...
Lưu ý rằng nếu bạn chỉ thêm một autoshape bằng phương thức `addAutoShape` từ giao diện [IShapeCollection](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/ishapecollection/) , phương thức `isTextBox` của autoshape sẽ trả về `false`. Tuy nhiên, sau khi bạn thêm văn bản vào autoshape bằng phương thức `addTextFrame` hoặc `setText`, thuộc tính `isTextBox` sẽ trả về `true`.
...
6. Gán đối tượng `IHyperlinkManager` vào thuộc tính [HyperlinkClick](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/Shape#getHyperlinkClick--) liên quan đến phần bạn muốn trong `TextFrame`.
...
Một [placeholder](/slides/vi/androidjava/manage-placeholder/) thừa hưởng kiểu dáng/vị trí từ [master](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/masterslide/) và có thể được ghi đè trên [layouts](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/layoutslide/), trong khi một hộp văn bản thông thường là một đối tượng độc lập trên một slide cụ thể và không thay đổi khi bạn chuyển đổi giữa các layout.
...
Giới hạn việc lặp lại của bạn chỉ đối với các auto-shape có khung văn bản và loại trừ các đối tượng nhúng ([biểu đồ](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/chart/), [bảng](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/table/), [SmartArt](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/smartart/)) bằng cách duyệt các bộ sưu tập của chúng riêng biệt hoặc bỏ qua các loại đối tượng đó.