...
- Java
- Aspose.Slides
description: "Tìm hiểu cách dễ dàng chuyển đổi bản trình chiếu PowerPoint (PPT, PPTX) sang ảnh TIFF chất lượng cao bằng Aspose.Slides cho Android, với các ví dụ mã Java."
---
## **Giới thiệu**

TIFF (**Tagged Image File Format**) là một định dạng ảnh raster không mất dữ liệu, được sử dụng rộng rãi và nổi tiếng với chất lượng xuất sắc cùng khả năng bảo tồn chi tiết đồ họa. Các nhà thiết kế, nhiếp ảnh gia và người biên tập desktop thường chọn TIFF để duy trì các lớp, độ chính xác màu và các cài đặt gốc trong ảnh của họ.

Với Aspose.Slides, bạn có thể dễ dàng chuyển đổi các slide PowerPoint (PPT, PPTX) và slide OpenDocument (ODP) trực tiếp sang ảnh TIFF chất lượng cao, đảm bảo bản trình bày của bạn giữ được độ trung thực hình ảnh tối đa.

## **Chuyển đổi bản trình bày sang TIFF**

Sử dụng phương thức [save](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/presentation/#save-java.lang.String-int-) được cung cấp bởi lớp [Presentation](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/presentation/), bạn có thể nhanh chóng chuyển đổi toàn bộ bản trình chiếu PowerPoint sang TIFF. Các ảnh TIFF tạo ra sẽ tương ứng với kích thước slide mặc định.
...
// Tạo một đối tượng lớp Presentation đại diện cho tệp bản trình chiếu (PPT, PPTX, ODP, v.v.).
...
[TiffOptions.setBwConversionMode](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/tiffoptions/#setBwConversionMode-int-) là một cài đặt cấp xuất khẩu, chọn thuật toán chuyển đổi pixel cho toàn bộ ảnh TIFF. Để xác định cách một hình dạng riêng lẻ hiển thị khi chế độ hiển thị đen‑trắng được bật, hãy sử dụng [IShape.setBlackWhiteMode](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/ishape/#setBlackWhiteMode-byte-). Xem [Control Black-and-White Rendering for Shapes](/slides/vi/androidjava/shape-formatting/#control-black-and-white-rendering-for-shapes) để biết ví dụ.
{{% /alert %}}
...
Nếu bạn cần ảnh TIFF có kích thước cụ thể, có thể đặt các giá trị mong muốn bằng các phương thức có sẵn trong [TiffOptions](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/tiffoptions/). Ví dụ, phương thức [setImageSize](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/tiffoptions/#setImageSize-com.aspose.slides.android.Size-) cho phép bạn xác định kích thước của ảnh kết quả.

Đoạn mã dưới đây minh họa cách chuyển đổi một bản trình bày PowerPoint sang ảnh TIFF với kích thước tùy chỉnh:
...
Sử dụng phương thức [setPixelFormat](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/tiffoptions/#setPixelFormat-int-) từ lớp [TiffOptions](https://reference.aspose.com/slides/vi/androidjava/com.aspose.slides/tiffoptions/) bạn có thể chỉ định định dạng pixel ưa thích cho ảnh TIFF tạo ra.
...
Có. Aspose.Slides cho phép bạn chuyển đổi từng slide từ các bản trình bày PowerPoint và OpenDocument sang ảnh TIFF một cách riêng biệt.

**Có giới hạn nào về số lượng slide khi chuyển đổi bản trình bày sang TIFF không?**

Không, Aspose.Slides không đặt bất kỳ hạn chế nào về số lượng slide. Bạn có thể chuyển đổi bản trình bày với bất kỳ kích thước nào sang định dạng TIFF.

**Các hiệu ứng hoạt ảnh và chuyển tiếp của PowerPoint có được giữ lại khi chuyển đổi slide sang TIFF không?**

Không, TIFF là định dạng ảnh tĩnh. Do đó, các hoạt ảnh và hiệu ứng chuyển tiếp sẽ không được bảo tồn; chỉ có các hình ảnh tĩnh của slide được xuất ra.