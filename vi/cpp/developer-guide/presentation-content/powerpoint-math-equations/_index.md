---
title: Thêm Phương Trình Toán Học vào Bản Trình Chiếu PowerPoint bằng C++
linktitle: Phương Trình Toán PowerPoint
type: docs
weight: 80
...
- [MathPortion](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/mathportion/) lưu trữ nội dung toán học trong khung văn bản của hình dạng.
...
Hầu hết các ví dụ dưới đây sử dụng [MathematicalText](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/mathematicaltext/) và các phương thức fluent từ [IMathElement](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/) để giữ cho mã ngắn gọn và dễ đọc.

Đối với các kịch bản xuất MathML, xem [Xuất các Phương Trình Toán từ Bản Trình Chiếu trong C++](/slides/vi/cpp/exporting-math-equations/).
...
Sử dụng `Radical` để tạo căn bậc hai, căn bậc ba hoặc các căn bậc khác. Phần tử hiện tại trở thành mẫu, và đối số trở thành độ bậc.
...
![Giới hạn của x khi x tiến đến vô cực](powerpoint-math-equations_8.png)
...
Sử dụng `Nary` cho các phép cộng, hợp, giao và các toán tử lớn khác. Sử dụng `Integral` cho các tích phân. Cả hai phương pháp đều cho phép bạn đặt giới hạn dưới và trên.
...
Sử dụng các trợ trợ chỉ số dưới và chỉ số trên cho chỉ mục và lũy thừa. Khi các chỉ số phải xuất hiện ở phía trái của mẫu, sử dụng `SetSubSuperscriptOnTheLeft`.

![Chữ Y in hoa với chỉ số dưới bên trái là 1 và chỉ số trên là n](powerpoint-math-equations_9.png)
...
![Một phương trình trong hộp cho thấy a bình phương bằng b bình phương cộng c bình phương](powerpoint-math-equations_12.png)
...
Sử dụng `Group` để đặt ký tự nhóm ở trên hoặc dưới một biểu thức. Thêm giới hạn để gắn nhãn cho các thuật ngữ đã nhóm.
...
Chỉ sử dụng các trợ trợ định dạng khi chúng làm rõ công thức. Ví dụ, `Overbar` đặt một thanh trên một phần tử toán học.
...
| Thêm phép cộng tổng và tích phân | [Nary](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/nary/), [Integral](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/integral/) |
...
Có. Khi lưu thành PPTX, Aspose.Slides ghi phương trình dưới dạng nội dung Office math có thể chỉnh sửa.

**Tôi có thể xuất các phương trình ra LaTeX không?**

Có. Lấy [IMathParagraph](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathparagraph/) của phương trình từ [IMathPortion](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathportion/), và gọi [IMathParagraph::ToLatex](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathparagraph/tolatex/) để xuất trực tiếp. Đối với một ví dụ đầy đủ, xem [Xuất các Phương Trình Toán từ Bản Trình Chiếu trong C++](/slides/vi/cpp/exporting-math-equations/#export-math-equations-to-latex).