...
- C++
- Aspose.Slides
description: "Chèn và chỉnh sửa các phương trình toán học trong PowerPoint PPT và PPTX bằng Aspose.Slides cho C++, hỗ trợ OMML, các điều khiển định dạng và các mẫu mã C++ rõ ràng."
---
## **Tổng quan**

PowerPoint lưu các phương trình dưới dạng Office Math Markup Language (OMML). Với Aspose.Slides cho C++, bạn có thể tạo nội dung toán học tương tự một cách lập trình: phân số, căn bậc, hàm, giới hạn, toán tử N-ary, ma trận, mảng và các khối toán học được định dạng.
...
- Một hình dạng toán học, được tạo bằng [AddMathShape](https://reference.aspose.com/slides/vi/cpp/aspose.slides/shapecollection/), là hình dạng chứa phương trình.
- [MathPortion](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/mathportion/) lưu trữ nội dung toán học bên trong khung văn bản của hình dạng.
...
Hầu hết các ví dụ dưới đây sử dụng [MathematicalText](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/mathematicaltext/) và các phương thức linh hoạt từ [IMathElement](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/) để giữ cho mã ngắn gọn và dễ đọc.

Đối với các kịch bản xuất MathML, xem [Xuất các phương trình toán học từ bản trình chiếu trong C++](/slides/vi/cpp/exporting-math-equations/).
...
{{% alert color="info" %}}
`AddMathShape` tạo một hình dạng đã chứa sẵn một đoạn toán học. Truy cập `MathPortion` đầu tiên, lấy `MathParagraph` của nó và thêm các khối toán học hoặc các thành phần toán học vào đó.
{{% /alert %}}
...
Sử dụng `Radical` để tạo căn bậc hai, căn bậc ba hoặc các căn bậc khác. Thành phần hiện tại trở thành cơ sở, và đối số trở thành độ bậc.
...
Đối với tên hàm tùy chỉnh, đặt tên hàm làm thành phần hiện tại:
...
Sử dụng `Nary` cho các phép cộng, hợp, giao và các toán tử lớn khác. Sử dụng `Integral` cho tích phân. Cả hai phương thức đều cho phép bạn đặt giới hạn dưới và trên.
...
Các toán tử N-ary dùng cho các toán tử lớn có giới hạn tùy chọn. Các toán tử đơn giản như `+`, `-` và `=` thường được thêm dưới dạng `MathematicalText` và ghép lại trong biểu thức.
...
Sử dụng [MathMatrix](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/mathmatrix/) cho các hàng và cột. Ma trận mặc định không bao gồm ngoặc, vì vậy hãy bao quanh ma trận khi bạn cần dấu ngoặc tròn, ngoặc vuông hoặc ngoặc nhọn.
...
Sử dụng `AsArgumentOfFunction` khi đối số là thành phần hiện tại và tên hàm đã biết.
...
Sử dụng các trợ giúp chỉ số dưới và chỉ số mũ cho chỉ mục và lũy thừa. Khi chỉ mục phải xuất hiện ở phía trái của cơ sở, sử dụng `SetSubSuperscriptOnTheLeft`.

![Chữ Y hoa với chỉ số dưới bên trái là 1 và chỉ số mũ n](powerpoint-math-equations_9.png)
...
Sử dụng `Enclose` để đặt một biểu thức bên trong các dấu phân tách. Bạn cũng có thể đặt ký tự phân tách cho các biểu thức có nhiều thành phần.

![Một biểu thức có dấu phân cách chứa x, y và z được ngăn cách bằng các dấu gạch đứng](powerpoint-math-equations_13.png)
...
Sử dụng `ToBorderBox` khi phương trình cần được bao quanh bằng một khung.
...
![Biểu thức x cộng y được nhóm với nhãn bất kỳ ở phía dưới](powerpoint-math-equations_15.png)
...
Sử dụng các trợ giúp định dạng chỉ khi chúng làm rõ công thức. Ví dụ, `Overbar` đặt một đường gạch trên một thành phần toán học.

![Một biểu thức toán học ABC với dấu gạch trên](powerpoint-math-equations_14.png)
...
| Kết hợp các thành phần | [IMathElement.Join](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/join/) |
| Tạo phân số | [IMathElement.Divide](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/divide/) |
| Thêm chỉ số mũ hoặc chỉ số dưới | [SetSuperscript](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/setsuperscript/), [SetSubscript](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/setsubscript/) |
...
| Thêm tổng và tích phân | [Nary](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/nary/), [Integral](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/integral/) |
...
| Thêm dấu phân tách | [Enclose](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/enclose/) |
| Thêm gạch trên và viền | [Overbar](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/overbar/), [ToBorderBox](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/toborderbox/) |
| Nhóm các thành phần | [Group](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathelement/group/) |
...
Có. Lấy [IMathParagraph](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathparagraph/) của phương trình từ [IMathPortion](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathportion/), sau đó gọi [IMathParagraph::ToLatex](https://reference.aspose.com/slides/vi/cpp/aspose.slides.mathtext/imathparagraph/tolatex/) để xuất trực tiếp. Đối với ví dụ đầy đủ, xem [Xuất các phương trình toán học từ bản trình chiếu trong C++](/slides/vi/cpp/exporting-math-equations/#export-math-equations-to-latex).