...
- C#
- Aspose.Slides
description: Aspose.Slides for .NET là một API quản lý Microsoft PowerPoint® cho phép các ứng dụng .NET đọc và ghi tài liệu PowerPoint® mà không cần sử dụng Microsoft PowerPoint®.
is_root: true
---
{{% alert color="primary" %}}

**Chào mừng đến với Aspose.Slides for .NET**
