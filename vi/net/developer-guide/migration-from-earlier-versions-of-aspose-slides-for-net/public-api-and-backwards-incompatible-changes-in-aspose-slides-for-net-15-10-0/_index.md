---
title: Thay đổi API công khai và không tương thích ngược trong Aspose.Slides cho .NET 15.10.0
...
- C#
- Aspose.Slides
description: "Xem xét các cập nhật API công khai và các thay đổi gây lỗi trong Aspose.Slides cho .NET để di chuyển suôn sẻ các giải pháp trình chiếu PowerPoint PPT, PPTX và ODP của bạn."
---
{{% alert color="info" %}} 

Trang này liệt kê tất cả các lớp, phương thức, thuộc tính và các thay đổi khác đã được **thêm**[/slides/vi/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/] hoặc **xóa**[/slides/vi/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/] và các thay đổi khác được giới thiệu trong API Aspose.Slides for .NET 15.10.0.

{{% /alert %}} 
## **Thay đổi API công khai**
#### **Đã thêm VideoPlayerHtmlController mới để hỗ trợ xuất tệp media sang HTML**
Lớp công cộng mới VideoPlayerHtmlController đã được thêm vào không gian tên Aspose.Slides.Export. Sử dụng thể hiện của lớp này, người dùng có thể xuất tệp video và âm thanh sang HTML.  
...
- **baseUri**: URI cơ sở sẽ được dùng để tạo các liên kết
