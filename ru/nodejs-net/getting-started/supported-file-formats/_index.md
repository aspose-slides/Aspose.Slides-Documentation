...
type: docs
weight: 30
url: /ru/nodejs-net/supported-file-formats/
---
...
В этой таблице перечислены форматы файлов, которые Aspose.Slides для Node.js через .NET может загружать и сохранять:

|**Формат**|**Описание**|**Загрузить**|**Сохранить**|**Примечания**|
| :- | :- | :- | :- | :- |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Формат файла с адресами меток| |{{< emoticons/tick >}}| |
...
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|Спецификация XML для бумаги| |{{< emoticons/tick >}}| |
|[JPEG](https://docs.fileformat.com/image/jpeg/)|Объединенная группа фотографов| |{{< emoticons/tick >}}| |
...
|[BMP](https://docs.fileformat.com/image/bmp/)|Битовая карта независимых устройств| |{{< emoticons/tick >}}| |
