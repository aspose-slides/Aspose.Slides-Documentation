...
{{% alert color="primary" %}} 
Читать далее [**О анимации фигур**](/slides/ru/php-java/shape-animation/).
{{% /alert %}}
...
{{% alert color="primary" %}} 
Читать далее [**О анимированных диаграммах**](/slides/ru/php-java/animated-charts/).
{{% /alert %}}
...
{{% alert color="primary" %}} 
Читать далее [**О анимированном тексте**](/slides/ru/php-java/animated-text/).
{{% /alert %}}