---
title: Публичный API и несовместимые изменения в Aspose.Slides для PHP через Java 14.6.0
type: docs
weight: 50
...
Эта страница перечисляет все [добавленные](/slides/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-14-6-0/) классы, методы, свойства и так далее, любые новые ограничения и другие изменения, внесенные в API Aspose.Slides для PHP через Java 14.6.0.
...
добавляют/вставляют копию указанной формы в коллекцию. 
...
Этот интерфейс представляет собой погрешности серий графиков.
