...
Для получения дополнительной информации о добавлении изображений на слайд, смотрите статью [Рамка для изображения](/slides/php-java/picture-frame/#create-picture-frame).
{{% /alert %}}
