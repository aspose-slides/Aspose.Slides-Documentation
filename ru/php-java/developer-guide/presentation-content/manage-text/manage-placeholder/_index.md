...
С помощью [Aspose.Slides для PHP через Java](/slides/ru/php-java/) вы можете находить и изменять заполнители на слайдах в презентациях. Aspose.Slides позволяет вносить изменения в текст в заполнителе.
