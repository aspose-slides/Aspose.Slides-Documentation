---
title: Настройка кольцевых диаграмм в презентациях с использованием PHP
...
- PHP
- Aspose.Slides
description: "Узнайте, как создавать и настраивать кольцевые диаграммы в Aspose.Slides for PHP via Java, поддерживая форматы PowerPoint для динамических презентаций."
---

## **Укажите центральный промежуток в кольцевой диаграмме**
{{% alert color="primary" %}} 

Aspose.Slides for PHP via Java теперь поддерживает указание размера отверстия в кольцевой диаграмме. В этой статье мы посмотрим на примере, как задать размер отверстия в кольцевой диаграмме.
...
Да. Существует тип диаграммы Exploded Doughnut [chart type](https://reference.aspose.com/slides/php-java/aspose.slides/charttype/) и свойство взрыва для точек данных; вы можете отделять отдельные срезы.

**Как получить изображение кольцевой диаграммы (PNG/SVG) для отчёта?**

Диаграмма является фигурой; вы можете отрисовать её в [raster image](https://reference.aspose.com/slides/php-java/aspose.slides/shape/#getImage) или экспортировать диаграмму в [SVG image](https://reference.aspose.com/slides/php-java/aspose.slides/shape/#writeAsSvg).