...
Вы можете регулировать существующий соединитель через его точки регулировки. Только соединители с точками регулировки могут быть изменены таким образом. См. таблицу под **[Типами соединителей.](/slides/ru/php-java/connector/#types-of-connectors)**
...
* Для расчетов, которые определяют координаты точек регулировки соединителя, вы должны учитывать поворот соединителя и его отражение. **Примечание**: угол поворота для всех соединителей, показанных в разделе **[Типы соединителей](/slides/ru/php-java/connector/#types-of-connectors)**, равен 0.
