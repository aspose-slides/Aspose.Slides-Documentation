...
В этой таблице перечислены форматы файлов, которые Aspose.Slides для PHP через Java может загружать и сохранять:
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Формат файла изображения TIFF| |{{< emoticons/tick >}}| |
...
|[JPEG](https://docs.fileformat.com/image/jpeg/)|Совместимый графический формат JPEG| |{{< emoticons/tick >}}| |
|[PNG](https://docs.fileformat.com/image/png/)|Портативная сеть графики| |{{< emoticons/tick >}}| |
...
|[SWF](https://docs.fileformat.com/page-description-language/swf/)|Малый веб-файл| |{{< emoticons/tick >}}| |
