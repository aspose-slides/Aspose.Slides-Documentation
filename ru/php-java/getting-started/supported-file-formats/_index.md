...
- PHP
- Aspose.Slides
description: "Узнайте обо всех форматах файлов, которые Aspose.Slides for PHP via Java может открывать, сохранять и конвертировать — включая PPT, PPTX и ODP — с ясными примечаниями о поддержке импорта/экспорта."
---
...
Эта таблица содержит форматы файлов, которые Aspose.Slides for PHP via Java может загружать и сохранять:
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Теговый формат изображений||{{< emoticons/tick >}}||
|[EMF](https://docs.fileformat.com/image/emf/)|Расширенный формат метафайлов||{{< emoticons/tick >}}||
|[PDF](https://docs.fileformat.com/pdf/)|Портативный формат документов|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|Спецификация XML Paper||{{< emoticons/tick >}}||
...
Да. Aspose.Slides поддерживает экспорт в PDF с уровнями соответствия, такими как PDF/A-2a, PDF/A-2b, PDF/A-2u, PDF/A-3a, PDF/A-3b, а также PDF/UA, через параметр [compliance](https://reference.aspose.com/slides/php-java/aspose.slides/pdfoptions/setcompliance/) в [PDF export options](https://reference.aspose.com/slides/php-java/aspose.slides/pdfoptions/).

**Поддерживает ли библиотека встраивание шрифтов при экспорте в PDF с тонкой настройкой того, какие шрифты встраиваются?**

Да. Вы можете контролировать, будут ли шрифты полностью встраиваться или лишь субсетироваться (только используемые глифы), задавать правила обработки распространённых системных шрифтов и настраивать поведение для ASCII‑текста через [PDF export options](https://reference.aspose.com/slides/php-java/aspose.slides/pdfoptions/).

**Можно ли определить, защищён ли файл паролем, до его загрузки?**

Да. С помощью [factory-based inspection API](https://reference.aspose.com/slides/php-java/aspose.slides/presentationfactory/) можно запросить информацию о презентации и узнать, защищён ли файл паролем, не открывая его полностью.

**Есть ли механизмы резервных шрифтов и поддержка пользовательских шрифтов?**

Да. Библиотека поддерживает [loading](/slides/ru/php-java/custom-font/) и [embedding](/slides/ru/php-java/embedded-font/) пользовательских шрифтов и предоставляет правила [fallback](/slides/ru/php-java/fallback-font/) для предотвращения отсутствия глифов при рендеринге и конвертации.

**Могу ли я экспортировать слайды в XPS и есть ли настройки для тонкой настройки вывода XPS?**

Да. [Export to XPS](/slides/ru/php-java/convert-powerpoint-to-xps/) поддерживается, и вы можете настроить соответствующие [save options](https://reference.aspose.com/slides/php-java/aspose.slides/xpsoptions/) для управления качеством и содержимым XPS‑документа.