...
С помощью [Aspose.Slides для C++](/slides/ru/cpp/) вы можете находить и изменять заполнители на слайдах в презентациях. Aspose.Slides позволяет вам вносить изменения в текст заполнителя.
