---
title: Управление подписями данных диаграммы в презентациях с помощью C++
...
- C++
- Aspose.Slides
description: "Узнайте, как добавлять и форматировать подписи данных диаграмм в презентациях PowerPoint с помощью Aspose.Slides для C++ для более привлекательных слайдов."
---
## **Введение**

Подписи данных на диаграмме показывают детали о сериях данных диаграммы или отдельных точках данных. Они позволяют читателям быстро идентифицировать серии данных и делают диаграммы легче для понимания.

## **Установить точность данных в подписях диаграммы**

Этот код на C++ показывает, как установить точность данных в подписи диаграммы:
...
```c++
	...
	// Устанавливает формат чисел для серии
...
Aspose.Slides для C++ позволяет задавать процентные подписи на отображаемых диаграммах. Этот код на C++ демонстрирует операцию:
...
Этот код на C++ показывает, как установить знак процента для подписи данных диаграммы:
...
Этот код на C++ показывает, как задать расстояние подписи от категориальной оси при работе с диаграммой, построенной по осям:
...
Когда вы создаёте диаграмму, не зависящую от осей, например круговую диаграмму, подписи данных диаграммы могут оказаться слишком близко к её краю. В таком случае необходимо настроить расположение подписи, чтобы линии‑выноски отображались чётко.

Этот код на C++ показывает, как настроить расположение подписи на круговой диаграмме:
...
Сочетайте автоматическое размещение подписей, линии‑выноски и уменьшенный размер шрифта; при необходимости скрывайте некоторые поля (например, категорию) или отображайте подписи только для экстремальных/ключевых точек.
