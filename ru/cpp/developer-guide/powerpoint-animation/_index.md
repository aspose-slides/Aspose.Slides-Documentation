...
{{% alert color="primary" %}} 
Узнайте больше [**Об анимации форм**](/slides/cpp/shape-animation/).
{{% /alert %}}
...
{{% alert color="primary" %}} 
Узнайте больше [**Об анимированных диаграммах**](/slides/cpp/animated-charts/).
{{% /alert %}}
...
{{% alert color="primary" %}} 
Узнайте больше [**Об анимированном тексте**](/slides/cpp/animated-text/).
{{% /alert %}}