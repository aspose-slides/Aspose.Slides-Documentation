...
{{% alert color="primary" %}} 
Читать далее, как [Рендерить презентацию с запасным шрифтом](/slides/ru/cpp/render-presentation-with-fallback-font/).
{{% /alert %}}