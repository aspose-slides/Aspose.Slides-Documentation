...
Таблица содержит форматы файлов, которые Aspose.Slides для C++ может загружать и сохранять:
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Формат файлов тегированной графики| |{{< emoticons/tick >}}| |
...
|[JPEG](https://docs.fileformat.com/image/jpeg/)|Совместный фотографический экспертный формат| |{{< emoticons/tick >}}| |
...
|[BMP](https://docs.fileformat.com/image/bmp/)|Независимый от устройства растровый рисунок| |{{< emoticons/tick >}}| |
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|Векторная графика| |{{< emoticons/tick >}}| |
...
|[XAML](https://docs.fileformat.com/web/xaml/)|Язык разметки расширяемых приложений| |{{< emoticons/tick >}}| |
