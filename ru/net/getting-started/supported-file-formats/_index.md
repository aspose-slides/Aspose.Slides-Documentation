...
В этой таблице представлены форматы файлов, которые Aspose.Slides для .NET может загружать и сохранять:
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Формат файла обмена изображениями| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|Расширенный графический формат| |{{< emoticons/tick >}}| |
|[PDF](https://docs.fileformat.com/pdf/)|Переносимый формат документов|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|XML-спецификация бумаги| |{{< emoticons/tick >}}| |
|[JPEG](https://docs.fileformat.com/image/jpeg/)|Совместный фотографический экспертный совет| |{{< emoticons/tick >}}| |
|[PNG](https://docs.fileformat.com/image/png/)|Переносимые сетевые графики| |{{< emoticons/tick >}}| |
|[GIF](https://docs.fileformat.com/image/gif/)|Формат графического обмена| |{{< emoticons/tick >}}| |
|[BMP](https://docs.fileformat.com/image/bmp/)|Независимое от устройства растровое изображение| |{{< emoticons/tick >}}| |
...
|[XML](https://docs.fileformat.com/web/xml/)|XML-презентация PowerPoint| |{{< emoticons/tick >}}| |
