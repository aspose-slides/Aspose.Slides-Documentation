---
title: Публичный API и обратно несовместимые изменения в Aspose.Slides для .NET 14.7.0
...
- C#
- Aspose.Slides
description: "Обзор обновлений публичного API и критических изменений в Aspose.Slides для .NET для плавной миграции ваших решений презентаций PowerPoint PPT, PPTX и ODP."
---
{{% alert color="info" %}} 

Эта страница перечисляет все [добавленные](/slides/ru/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-14-7-0/) или [удалённые](/slides/ru/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-14-7-0/) классы, методы, свойства и т. д., а также другие изменения, внесённые в API Aspose.Slides для .NET 14.7.0.
...
Элемент SoundAction был некорректным и не использовался. Настройки звука задаются свойствами SlideShowTransition.SoundMode, .Sound, .SoundLoop, .SoundIsBuiltIn, .SoundName.
...
Перечисление Aspose.Slides.SlideShow.TransitionPattern используется в этом классе и определяет геометрический узор, который размещается рядом, заполняя большую область.
