---
title: Общедоступный API и несовместимые изменения в Aspose.Slides для .NET 14.6.0
...
IPresentation.ViewProperty позволяет разработчикам изменять тип представления презентации и видимость заметок при открытии презентации в PowerPoint.
