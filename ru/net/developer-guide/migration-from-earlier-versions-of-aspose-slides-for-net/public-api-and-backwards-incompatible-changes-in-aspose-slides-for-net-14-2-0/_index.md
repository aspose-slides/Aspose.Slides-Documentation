...
- C#
- Aspose.Slides
description: "Обзор обновлений публичного API и несовместимых изменений в Aspose.Slides для .NET, чтобы плавно перенести ваши решения для презентаций PowerPoint PPT, PPTX и ODP."
---
...
### **Изменения с Aspose.Slides for .NET 8.X.0**
Функции Aspose.Slides for .NET 8.4 добавлены в Aspose.Slides for .NET 14.2.0