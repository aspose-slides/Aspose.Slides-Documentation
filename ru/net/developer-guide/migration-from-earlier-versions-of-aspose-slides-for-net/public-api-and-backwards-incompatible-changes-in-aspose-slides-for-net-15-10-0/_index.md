---
title: Общедоступный API и несовместимые изменения в Aspose.Slides для .NET 15.10.0
...
keywords:
  ...
  - C#
  - Aspose.Slides
description: "Обзор обновлений публичного API и разрушающих изменений в Aspose.Slides для .NET, позволяющих плавно мигрировать ваши решения презентаций PowerPoint PPT, PPTX и ODP."
---
...
#### **Добавлен новый VideoPlayerHtmlController для поддержки экспорта мультимедийных файлов в HTML**
...
path: Путь, по которому будут созданы видео‑ и аудиофайлы  
fileName: Имя HTML‑файла  

baseUri: Базовый URI, который будет использоваться для формирования ссылок  
...
Были введены два новых перечисления EffectChartMajorGroupingType и EffectChartMinorGroupingType, связанных с анимацией элементов диаграммы.
