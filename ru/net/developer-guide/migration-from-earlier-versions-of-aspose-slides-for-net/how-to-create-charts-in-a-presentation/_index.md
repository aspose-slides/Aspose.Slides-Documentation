...
Новый [Aspose.Slides for .NET API](/slides/ru/net/) был выпущен, и теперь этот единый продукт поддерживает возможность создания PowerPoint‑документов с нуля и редактирования существующих.

{{% /alert %}} 
## **Поддержка устаревшего кода**
Чтобы использовать устаревший код, разработанный с Aspose.Slides for .NET версиями ранее 13.x, необходимо внести небольшие изменения в ваш код, и он будет работать так же, как раньше. Все классы, которые находились в старых пространствах имен Aspose.Slides for .NET ‑ Aspose.Slide и Aspose.Slides.Pptx, теперь объединены в едином пространстве имен Aspose.Slides. Просмотрите следующий простой пример кода для создания обычной диаграммы с нуля в презентации с использованием устаревшего API Aspose.Slides и следуйте шагам, описывающим миграцию к новому объединённому API.
...
## **Подход Aspose.Slides for .NET 13.x**
``` csharp
...
Просмотрите следующий простой пример кода для создания диаграммы рассеяния с нуля в презентации с использованием устаревшего API Aspose.Slides и того, как реализовать это с новым объединённым API.
