---
title: Публичный API и обратные несовместимые изменения в Aspose.Slides для .NET 15.7.0
...
- C#
- Aspose.Slides
description: "Обзор обновлений публичного API и разрушительных изменений в Aspose.Slides для .NET для плавной миграции ваших решений презентаций PowerPoint PPT, PPTX и ODP."
---

{{% alert color="primary" %}} 

Эта страница перечисляет все [добавленные](/slides/ru/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-7-0/) или [удалённые](/slides/ru/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-7-0/) классы, методы, свойства и т.д., а также другие изменения, внесённые в API Aspose.Slides для .NET 15.7.0.

{{% /alert %}} 
## **Изменения публичного API**
#### **Добавлен перечисление ImagePixelFormat**
Перечисление Aspose.Slides.Export.ImagePixelFormat добавлено для указания формата пикселей генерируемых изображений.
...
Метод RenderToGraphics (и его перегрузки) добавлен в Aspose.Slides.Slide для рендеринга слайда в объект Graphics.
