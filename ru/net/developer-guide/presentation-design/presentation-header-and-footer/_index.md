...
[Aspose.Slides](/slides/net/) предоставляет поддержку для работы с текстами заголовков и нижних колонтитулов слайдов, которые фактически поддерживаются на уровне мастер-слайда.

{{% /alert %}} 

[Aspose.Slides для .NET](/slides/net/) предоставляет возможность управления заголовками и нижними колонтитулами внутри слайдов презентации. Они фактически управляются на уровне мастер-презентации.
