---
title: Конвертация презентаций PowerPoint в XPS в .NET
...
- C#
- Aspose.Slides
description: "Конвертируйте PowerPoint PPT/PPTX в высококачественный, независимый от платформы XPS в .NET с помощью Aspose.Slides. Получите пошаговое руководство и пример кода на C#."
---
...
Чтобы увидеть, как Aspose.Slides преобразует презентацию PPT или PPTX в формат XPS, вы можете воспользоваться [этим бесплатным онлайн‑конвертером](https://products.aspose.app/slides/conversion). 

{{% /alert %}} 

Если вы хотите сократить расходы на хранение, можете конвертировать вашу презентацию Microsoft PowerPoint в формат XPS. Так будет проще сохранять, делиться и печатать ваши документы. 

Microsoft продолжает активно поддерживать XPS в Windows (в том числе в Windows 10), поэтому стоит рассмотреть возможность сохранения файлов в этом формате. Если вы работаете с Windows 8.1, Windows 8, Windows 7 и Windows Vista, XPS может стать лучшим вариантом для определённых операций. 
...
- **Windows 8** использует формат OXPS (Open XPS) для файлов XPS. OXPS — стандартизированная версия оригинального формата XPS. Windows 8 обеспечивает лучшую поддержку файлов XPS, чем PDF. 
  - **XPS:** встроенный просмотрщик/чтение XPS и функция печати в XPS доступны. 
  - **PDF:** доступен просмотрщик PDF, но функции печати в PDF нет. 

- **Windows 7 и Windows Vista** используют оригинальный формат XPS. Эти ОС также предоставляют более лучшую поддержку XPS, чем PDF. 
...
Microsoft в конечном итоге реализовал поддержку печати в PDF через функцию Печать в PDF в Windows 10. Ранее пользователи ожидали печатать документы через формат XPS. 
...
При конвертации презентации в XPS необходимо сохранять презентацию, используя один из этих вариантов:
