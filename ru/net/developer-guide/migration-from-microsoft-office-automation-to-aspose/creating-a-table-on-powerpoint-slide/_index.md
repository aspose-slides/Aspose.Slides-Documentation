...
- C#
- Aspose.Slides
description: "Перенесите автоматизацию Microsoft Office на Aspose.Slides для .NET и создавайте таблицы в слайдах PowerPoint (PPT, PPTX) на C# с гибким форматированием."
---
{{% alert color="info" %}} 

Таблицы широко используют для отображения данных на слайдах презентаций. В этой статье показано, как программно создать таблицу 15 × 15 с размером шрифта 10, сначала используя [VSTO 2008](/slides/ru/net/creating-a-table-on-powerpoint-slide/) , а затем [Aspose.Slides for .NET](/slides/ru/net/creating-a-table-on-powerpoint-slide/) .

{{% /alert %}} 
## **Создание таблиц**
#### **Пример VSTO 2008**
Следующие шаги добавляют таблицу в слайд Microsoft PowerPoint с помощью VSTO:

1. Создать презентацию.
1. Добавить пустой слайд в презентацию.
1. Добавить таблицу 15 × 15 на слайд.
...
Следующие шаги добавляют таблицу в слайд Microsoft PowerPoint с помощью Aspose.Slides:

1. Создать презентацию.
1. Добавить таблицу 15 × 15 на первый слайд.
1. Добавить текст в каждую ячейку таблицы с размером шрифта 10.
