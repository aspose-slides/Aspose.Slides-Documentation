---
title: Форматирование текста с использованием VSTO и Aspose.Slides для .NET
...
Иногда требуется программно форматировать текст на слайдах. В этой статье показано, как открыть пример презентации с некоторым текстом на первом слайде, используя либо [VSTO](/slides/ru/net/format-text-using-vsto-and-aspose-slides-and-net/) и [Aspose.Slides for .NET](/slides/ru/net/format-text-using-vsto-and-aspose-slides-and-net/). Код форматирует текст в третьем текстовом поле слайда так, чтобы он выглядел как текст в последнем текстовом поле.
...
1. Доступ к третьему текстовому полю.
