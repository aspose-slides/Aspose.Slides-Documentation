...
- C#
- Aspose.Slides
description: "Добавляйте, редактируйте и удаляйте гиперссылки в C# с Aspose.Slides: текст ссылки, фигуры, слайды, URL-адреса и электронную почту; задавайте цели и действия для PPT, PPTX и ODP."
---

Продемонстрированы добавление, доступ, удаление и обновление гиперссылок на фигурах с использованием **Aspose.Slides for .NET**.
