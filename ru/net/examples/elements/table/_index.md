...
- C#
- Aspose.Slides
description: "Создавайте и форматируйте таблицы в C# с помощью Aspose.Slides: вставляйте данные, объединяйте ячейки, задавайте стиль границ, выравнивайте содержимое и импортируйте/экспортируйте для PPT, PPTX и ODP."
---
