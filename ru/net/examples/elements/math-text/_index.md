...
- C#
- Aspose.Slides
description: "Работа с математическим текстом в C# с использованием Aspose.Slides: создание и редактирование уравнений, дробей, радикалов, скриптов, форматирование и рендеринг результатов для PPT и PPTX."
---
