...
- C#
- Aspose.Slides
description: "Управляйте разделами слайдов в C# с помощью Aspose.Slides: создавайте, переименовывайте, легко переупорядочивайте, перемещайте слайды между разделами и контролируйте их видимость для PPT, PPTX и ODP."
---
