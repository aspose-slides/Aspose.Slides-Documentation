...
Для получения дополнительной информации посетите [Добавление слайдов макета в презентацию](/slides/net/adding-and-editing-slides/#working-with-slide-size-and-layout).
