...
- [Добавить изображение в ячейку таблицы](/slides/ru/net/add-image-in-table-cell/)
...
- [Добавить рамку для изображения в презентацию](/slides/ru/net/add-picture-frame-to-presentation/)
- [Создание диаграммы](/slides/ru/net/create-a-chart/)
- [Создать и встроить диаграмму Excel как OLE-объект](/slides/ru/net/create-and-embed-an-excel-chart-as-an-ole-object/)
...
- [Поиск и замена текста без потери формата в презентации](/slides/ru/net/find-and-replace-text-without-losing-format-in-presentation/)
...
- [Настройка цвета фона главного слайда](/slides/ru/net/setting-background-color-of-master-slide/)
