...
**Добро пожаловать в Aspose.Slides для Python через Java**

![Логотип продукта Aspose.Slides для Python через Java](aspose_slides-for-python-via-java.png)

Aspose.Slides для Python через Java — это библиотека классов, которая позволяет вашим приложениям читать и записывать документы PowerPoint® без использования Microsoft PowerPoint®.

Aspose.Slides для Python через Java является первым и единственным компонентом, который предоставляет функциональность для управления документами PowerPoint®.

Aspose.Slides для Python через Java предоставляет множество ключевых функций, таких как управление текстом, фигурами, таблицами и анимациями, добавление аудио и видео на слайды, предварительный просмотр слайдов, экспорт слайдов в формат SVG, PDF и многое другое.

{{% /alert %}}

## Ресурсы Aspose.Slides для Python через Java

{{% alert color="primary" %}}

Aspose.Slides для Python через Java был портирован с Aspose.Slides для Java, поэтому вы можете использовать документацию и справочник API последнего.
