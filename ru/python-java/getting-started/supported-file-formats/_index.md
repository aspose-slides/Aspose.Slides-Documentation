...
type: docs
weight: 30
url: /ru/python-java/supported-file-formats/
---
...
В этой таблице представлены форматы файлов, которые Aspose.Slides для Python через Java может загружать и сохранять:
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Формат файла изображения тегов| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|Формат улучшенного метафайла| |{{< emoticons/tick >}}| |
|[PDF](https://docs.fileformat.com/pdf/)|Переносимый документный формат|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|Спецификация бумаги XML| |{{< emoticons/tick >}}| |
|[JPEG](https://docs.fileformat.com/image/jpeg/)|Совместная группа фотографов| |{{< emoticons/tick >}}| |
|[PNG](https://docs.fileformat.com/image/png/)|Переносимая сетевая графика| |{{< emoticons/tick >}}| |
|[GIF](https://docs.fileformat.com/image/gif/)|Формат обмена графикой| |{{< emoticons/tick >}}| |
|[BMP](https://docs.fileformat.com/image/bmp/)|Независимый от устройства растровый файл| |{{< emoticons/tick >}}| |
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|Масштабируемая векторная графика| |{{< emoticons/tick >}}| |
|[SWF](https://docs.fileformat.com/page-description-language/swf/)|Малый формат для веба| |{{< emoticons/tick >}}| |
|[HTML](https://docs.fileformat.com/web/html/)|Язык разметки гипертекста|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[XAML](https://docs.fileformat.com/web/xaml/)|Язык разметки приложений| |{{< emoticons/tick >}}| |
