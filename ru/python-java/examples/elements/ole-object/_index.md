...
- Java
- Aspose.Slides
description: "Используйте Aspose.Slides for Python via Java для добавления, доступа, удаления и обновления объектов OLE в презентациях PowerPoint и OpenDocument."
---
Эта статья демонстрирует, как внедрить файл как объект OLE и обновить его данные с помощью **Aspose.Slides for Python via Java**.
...
## **Добавление объекта OLE**

Внедрите PDF-файл в презентацию.
