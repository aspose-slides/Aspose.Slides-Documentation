...
Эта таблица содержит форматы файлов, которые Aspose.Slides для Android через Java может загружать и сохранять:
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Формат файлов изображений Tag| |{{< emoticons/tick >}}| |
...
|[JPEG](https://docs.fileformat.com/image/jpeg/)|Совместная группа экспертов по фотографии| |{{< emoticons/tick >}}| |
|[PNG](https://docs.fileformat.com/image/png/)|Портативная сетевная графика| |{{< emoticons/tick >}}| |
|[GIF](https://docs.fileformat.com/image/gif/)|Формат графической обменной информации| |{{< emoticons/tick >}}| |
|[BMP](https://docs.fileformat.com/image/bmp/)|Битмап независимый от устройства| |{{< emoticons/tick >}}| |
