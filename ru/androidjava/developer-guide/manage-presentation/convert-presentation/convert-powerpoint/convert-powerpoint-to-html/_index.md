---
title: Преобразовать презентации PowerPoint в HTML на Android
...
- Java
- Aspose.Slides
description: "Преобразовать презентации PowerPoint в HTML на Android. Используйте Aspose.Slides для Android через Java для экспорта файлов PPT и PPTX, выбранных слайдов, заметок, шрифтов, изображений, SVG и медиа."
---
## **Обзор**

Aspose.Slides for Android via Java может сохранять презентации PowerPoint в HTML без Microsoft PowerPoint. Базовое преобразование состоит из одиночной загрузки [Presentation](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/presentation/) и вызова `save` с [SaveFormat](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/saveformat/). Используйте [HtmlOptions](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/htmloptions/) когда нужно контролировать экспортируемый макет, шрифты, изображения, заметки, комментарии, вывод SVG или связанные ресурсы.
...
Чтобы экспортировать презентацию в HTML, загрузите её с помощью [Presentation](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/presentation/) и сохраните её с помощью [SaveFormat.Html](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/saveformat/).
...
[HtmlOptions](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/htmloptions/) — основной класс конфигурации экспорта HTML. Часто используемые параметры включают:
...
Используйте этот шаблон, когда веб‑сайт или приложение требует одну HTML‑страницу на каждый слайд. Если каждый слайд должен иметь одинаковый макет, создайте один экземпляр [HtmlOptions](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/htmloptions/) и передайте его каждому вызову `save`.

## **Создать адаптивный HTML**

[ResponsiveHtmlController](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/responsivehtmlcontroller/) предоставляет адаптивный HTML‑вывод через [HtmlFormatter](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/htmlformatter/). Используйте его, когда экспортированная страница должна лучше адаптироваться к ширине браузера.
...
Для адаптивного макета на основе SVG задайте `SvgResponsiveLayout` в [HtmlOptions](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/htmloptions/). Это полезно, когда содержимое слайда экспортируется как масштабируемая SVG‑разметка.
...
Используйте [NotesCommentsLayoutingOptions](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/notescommentslayoutingoptions/) через `HtmlOptions.SlidesLayoutOptions`, чтобы включить примечания докладчика или комментарии. По умолчанию заметки и комментарии скрыты, если только вы не зададите их позиции.
...
Экспорт HTML может сжимать изображения слайдов для уменьшения размера вывода. Установите `PicturesCompression` в значение из [PicturesCompression](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/picturescompression/), когда требуется более высокое качество изображения.
...
Для пользовательского заголовка документа, подключённого CSS‑файла или пользовательской разметки вокруг слайдов и фигур реализуйте [IHtmlFormattingController](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/ihtmlformattingcontroller/) и передайте его в [HtmlFormatter](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/htmlformatter/) через `createCustomFormatter`.

## **Встраивание шрифтов**

Если в целевой среде шрифты презентации могут быть не установлены, встраивайте шрифты в HTML с помощью [EmbedAllFontsHtmlController](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/embedallfontshtmlcontroller/). Встраивание повышает визуальное соответствие, но увеличивает размер вывода.
...
Чтобы уменьшить размер HTML‑файла, можно записать данные шрифтов в отдельные файлы WOFF и добавить правила `@font-face` в HTML. Ниже приведён помощник, расширяющий [EmbedAllFontsHtmlController](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/embedallfontshtmlcontroller/) и переопределяющий `writeFont`.
...
Автономный HTML легко перемещать, но встроенные ресурсы Base64 могут сделать файл громоздким. Если вашему приложению нужны внешние файлы изображений, реализуйте [ILinkEmbedController](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/ilinkembedcontroller/) и передайте его в конструктор [HtmlOptions](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/htmloptions/).
...
[VideoPlayerHtmlController](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/videoplayerhtmlcontroller/) экспортирует видео и аудио файлы и записывает HTML, который может воспроизводить их в браузере. Его конструктор принимает:
...
- Сразу освобождайте каждый экземпляр [Presentation](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/presentation/).
...
Да, но не используйте один экземпляр [Presentation](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/presentation/) в разных потоках. Обрабатывайте разные файлы отдельными экземплярами презентаций, отдельными потоками и отдельными каталогами вывода. См. руководство по [multithreading](/slides/ru/androidjava/multithreading/) для деталей.

**Является ли объект Presentation потокобезопасным?**

Нет. Один экземпляр [Presentation](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/presentation/) должен быть загружен, изменён, сохранён и освобождён в одном потоке. Для параллельной работы создавайте независимый экземпляр на каждый поток или процесс.
...
Да. Установите `ShowHiddenSlides` в `true` на [HtmlOptions](https://reference.aspose.com/slides/ru/androidjava/com.aspose.slides/htmloptions/), когда скрытые слайды должны быть экспортированы.