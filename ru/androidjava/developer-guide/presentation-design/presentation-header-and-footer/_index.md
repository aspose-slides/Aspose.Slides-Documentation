...
[Aspose.Slides](/slides/androidjava/) предоставляет поддержку работы с текстом заголовков и нижних колонтитов слайдов, которые фактически управляются на уровне главного слайда.

{{% /alert %}} 

[Aspose.Slides для Android через Java](/slides/androidjava/) предоставляет возможность управления заголовками и нижними колонтитулами внутри слайдов презентации. Эти элементы действительно управляются на уровне главной презентации.
