...
1. Мы [создаем коллекцию правил запасного шрифта](/slides/androidjava/create-fallback-fonts-collection/).
...
{{% alert color="primary" %}} 
Подробнее о [Сохранении и Конвертации в Презентации](/slides/androidjava/creating-saving-and-converting-a-presentation/).
{{% /alert %}}