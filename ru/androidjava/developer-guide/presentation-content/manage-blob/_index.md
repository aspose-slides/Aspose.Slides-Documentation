...
[Aspose.Slides](/slides/ru/androidjava/) для Java позволяет вам добавлять большие файлы (в данном случае, большой видеофайл) через процесс, связанный с BLOB, чтобы уменьшить потребление памяти.
