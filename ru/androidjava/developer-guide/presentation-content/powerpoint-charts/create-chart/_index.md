---
title: Создание или обновление диаграмм презентации PowerPoint в Java
linktitle: Создать диаграмму
type: docs
weight: 10
url: /ru/androidjava/create-chart/
keywords: "Создание диаграммы, точечная диаграмма, круговая диаграмма, диаграмма с деревом, фондовая диаграмма, диаграмма «коробка и усы», гистограмма, воронкообразная диаграмма, диаграмма-солнечный свет, многокатегориальная диаграмма, презентация PowerPoint, Java, Aspose.Slides для Android через Java"
...
- [Java Создать точечную диаграмму презентации PowerPoint](#java-create-powerpoint-presentation-scattered-chart)
...
_Диаграмма_: **Диаграмма с деревом**
- [Java Создать диаграмму с деревом](#java-create-tree-map-chart)
- [Java Создать диаграмму с деревом PowerPoint](#java-create-powerpoint-tree-map-chart)
- [Java Создать диаграмму с деревом презентации PowerPoint](#java-create-powerpoint-presentation-tree-map-chart)
...
- [Java Создать диаграмму «коробка и усы»](#java-create-box-and-whisker-chart)
- [Java Создать диаграмму «коробка и усы» PowerPoint](#java-create-powerpoint-box-and-whisker-chart)
- [Java Создать диаграмму «коробка и усы» презентации PowerPoint](#java-create-powerpoint-presentation-box-and-whisker-chart)
...
_Диаграмма_: **Солнечный свет**
- [Java Создать диаграмму солнечного света](#java-create-sunburst-chart)
- [Java Создать диаграмму солнечного света PowerPoint](#java-create-powerpoint-sunburst-chart)
- [Java Создать диаграмму солнечного света презентации PowerPoint](#java-create-powerpoint-presentation-sunburst-chart)
...
- [Java Создать гистограмму презентации PowerPoint](#java-create-powerpoint-presentation-histogram-chart)
...
- [Java Создать многокатегориальную диаграмму презентации PowerPoint](#java-create-powerpoint-presentation-multi-category-chart)
...
Чтобы позволить вам создавать диаграммы, Aspose.Slides предоставляет класс [ChartType](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ChartType). Поля в этом классе соответствуют различным типам диаграмм.
...
- <a name="java-create-powerpoint-presentation-chart" id="java-create-powerpoint-presentation-chart"><strong><em>Шаги:</em> Создание диаграммы презентации PowerPoint на Java</strong></a>
...
<a name="java-create-powerpoint-presentation-scattered-chart" id="java-create-powerpoint-presentation-scattered-chart"><strong><em>Шаги:</em> Создать точечную диаграмму презентации PowerPoint на Java</strong></a>
...
2. На третьем шаге добавьте диаграмму с некоторыми данными и укажите тип вашей диаграммы как один из следующих
   1. [ChartType.ScatterWithMarkers](https://reference.aspose.com/slides/androidjava/com.aspose.slides/charttype/#ScatterWithMarkers) - _Представляет точечную диаграмму._
   2. [ChartType.ScatterWithSmoothLinesAndMarkers](https://reference.aspose.com/slides/androidjava/com.aspose.slides/charttype/#ScatterWithSmoothLinesAndMarkers) - _Представляет точечную диаграмму, соединенную кривыми с маркерами данных._
   3. [ChartType.ScatterWithSmoothLines](https://reference.aspose.com/slides/androidjava/com.aspose.slides/charttype/#ScatterWithSmoothLines) - _Представляет точечную диаграмму, соединенную кривыми без маркеров данных._
   4. [ChartType.ScatterWithStraightLinesAndMarkers](https://reference.aspose.com/slides/androidjava/com.aspose.slides/charttype/#ScatterWithStraightLinesAndMarkers) - _Представляет точечную диаграмму, соединенную линиями с маркерами данных._
   5. [ChartType.ScatterWithStraightLines](https://reference.aspose.com/slides/androidjava/com.aspose.slides/charttype/#ScatterWithStraightLines) - _Представляет точечную диаграмму, соединенную линиями без маркеров данных._
...
<a name="java-create-powerpoint-presentation-pie-chart" id="java-create-powerpoint-presentation-pie-chart"><strong><em>Шаги:</em> Создать круговую диаграмму презентации PowerPoint на Java</strong></a>

1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation).
2. Получите ссылку на слайд по индексу.
3. Добавьте диаграмму с стандартными данными вместе с желаемым типом (в данном случае, [ChartType](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ChartType).Pie).
4. Получите доступ к данным диаграммы [IChartDataWorkbook](https://reference.aspose.com/slides/androidjava/com.aspose.slides/IChartDataWorkbook).
...
1. Добавьте диаграмму с стандартными данными и желаемым типом (в данном случае, `ChartType.Line`).
...
<a name="java-create-tree-map-chart" id="java-create-tree-map-chart"><strong><em>Шаги:</em> Создать диаграмму с деревом на Java</strong></a> |
<a name="java-create-powerpoint-tree-map-chart" id="java-create-powerpoint-tree-map-chart"><strong><em>Шаги:</em> Создать диаграмму с деревом PowerPoint на Java</strong></a> |
<a name="java-create-powerpoint-presentation-tree-map-chart" id="java-create-powerpoint-presentation-tree-map-chart"><strong><em>Шаги:</em> Создать диаграмму с деревом презентации PowerPoint на Java</strong></a>

1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation).
2. Получите ссылку на слайд через его индекс.
3. Добавьте диаграмму с стандартными данными вместе с желаемым типом (в данном случае, [ChartType](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ChartType).TreeMap).
4. Получите доступ к данным диаграммы [IChartDataWorkbook](https://reference.aspose.com/slides/androidjava/com.aspose.slides/IChartDataWorkbook).
5. Очистите стандартные серии и категории.
6. Добавьте новые серии и категории.
7. Добавьте новые данные диаграммы для серий диаграммы.
...
<a name="java-create-stock-chart" id="java-create-stock-chart"><strong><em>Шаги:</em> Создать фондовую диаграмму на Java</strong></a> |
<a name="java-create-powerpoint-stock-chart" id="java-create-powerpoint-stock-chart"><strong><em>Шаги:</em> Создать фондовую диаграмму PowerPoint на Java</strong></a> |
<a name="java-create-powerpoint-presentation-stock-chart" id="java-create-powerpoint-presentation-stock-chart"><strong><em>Шаги:</em> Создать фондовую диаграмму презентации PowerPoint на Java</strong></a>

1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) .
2. Получите ссылку на слайд по индексу.
3. Добавьте диаграмму с стандартными данными вместе с желаемым типом ([ChartType](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ChartType).OpenHighLowClose).
4. Получите доступ к данным диаграммы [IChartDataWorkbook](https://reference.aspose.com/slides/androidjava/com.aspose.slides/IChartDataWorkbook).
5. Очистите стандартные серии и категории.
6. Добавьте новые серии и категории.
7. Добавьте новые данные диаграммы для серий диаграммы.
...
<a name="java-create-box-and-whisker-chart" id="java-create-box-and-whisker-chart"><strong><em>Шаги:</em> Создать диаграмму «коробка и усы» на Java</strong></a> |
<a name="java-create-powerpoint-box-and-whisker-chart" id="java-create-powerpoint-box-and-whisker-chart"><strong><em>Шаги:</em> Создать диаграмму «коробка и усы» PowerPoint на Java</strong></a> |
<a name="java-create-powerpoint-presentation-box-and-whisker-chart" id="java-create-powerpoint-presentation-box-and-whisker-chart"><strong><em>Шаги:</em> Создать диаграмму «коробка и усы» презентации PowerPoint на Java</strong></a>

1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) .
2. Получите ссылку на слайд по индексу.
3. Добавьте диаграмму с стандартными данными вместе с желаемым типом ([ChartType](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ChartType).BoxAndWhisker).
4. Получите доступ к данным диаграммы [IChartDataWorkbook](https://reference.aspose.com/slides/androidjava/com.aspose.slides/IChartDataWorkbook).
5. Очистите стандартные серии и категории.
6. Добавьте новые серии и категории.
7. Добавьте новые данные диаграммы для серий диаграммы.
...
<a name="java-create-powerpoint-presentation-funnel-chart" id="java-create-powerpoint-presentation-funnel-chart"><strong><em>Шаги:</em> Создать воронкообразную диаграмму презентации PowerPoint на Java</strong></a>

1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) .
2. Получите ссылку на слайд по индексу.
3. Добавьте диаграмму с стандартными данными вместе с желаемым типом ([ChartType](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ChartType).Funnel).
...
<a name="java-create-sunburst-chart" id="java-create-sunburst-chart"><strong><em>Шаги:</em> Создать диаграмму солнечного света на Java</strong></a> |
<a name="java-create-powerpoint-sunburst-chart" id="java-create-powerpoint-sunburst-chart"><strong><em>Шаги:</em> Создать диаграмму солнечного света PowerPoint на Java</strong></a> |
<a name="java-create-powerpoint-presentation-sunburst-chart" id="java-create-powerpoint-presentation-sunburst-chart"><strong><em>Шаги:</em> Создать диаграмму солнечного света презентации PowerPoint на Java</strong></a>

1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) .
2. Получите ссылку на слайд по индексу.
3. Добавьте диаграмму с стандартными данными вместе с желаемым типом (в данном случае,[ChartType](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ChartType).sunburst).
4. Запишите измененную презентацию в файл PPTX.
...
<a name="java-create-powerpoint-presentation-histogram-chart" id="java-create-powerpoint-presentation-histogram-chart"><strong><em>Шаги:</em> Создать гистограмму презентации PowerPoint на Java</strong></a>

1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) .
2. Получите ссылку на слайд по индексу.
3. Добавьте диаграмму с стандартными данными и желаемым типом ([ChartType](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ChartType).Histogram).
4. Получите доступ к данным диаграммы [IChartDataWorkbook](https://reference.aspose.com/slides/androidjava/com.aspose.slides/IChartDataWorkbook).
5. Очистите стандартные серии и категории.
6. Добавьте новые серии и категории.
...
<a name="java-create-powerpoint-presentation-radar-chart" id="java-create-powerpoint-presentation-radar-chart"><strong><em>Шаги:</em> Создать радарную диаграмму презентации PowerPoint на Java</strong></a>
...
<a name="java-create-powerpoint-presentation-multi-category-chart" id="java-create-powerpoint-presentation-multi-category-chart"><strong><em>Шаги:</em> Создать многокатегориальную диаграмму презентации PowerPoint на Java</strong></a>

1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation) .
2. Получите ссылку на слайд по индексу. 
3. Добавьте диаграмму с стандартными данными вместе с желаемым типом ([ChartType](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ChartType).ClusteredColumn).
4. Получите доступ к данным диаграммы [IChartDataWorkbook](https://reference.aspose.com/slides/androidjava/com.aspose.slides/IChartDataWorkbook).
5. Очистите стандартные серии и категории.
6. Добавьте новые серии и категории.
7. Добавьте новые данные диаграммы для серий диаграммы.
...
<a name="java-create-powerpoint-presentation-map-chart" id="java-create-powerpoint-presentation-map-chart"><strong><em>Шаги:</em> Создать картографическую диаграмму презентации PowerPoint на Java</strong></a>
...
![составная-диаграмма-ппт](составная-диаграмма-ппт.png)
...
<a name="java-update-powerpoint-presentation-chart" id="java-update-powerpoint-presentation-chart"><strong><em>Шаги:</em> Обновить диаграмму презентации PowerPoint на Java</strong></a>

1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation), который представляет презентацию, содержащую диаграмму, которую вы хотите обновить.
...
1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/Presentation), который представляет презентацию, содержащую диаграмму.
2. Получите ссылку на слайд по индексу.
3. Пройдите через все фигуры, чтобы найти нужную диаграмму.
