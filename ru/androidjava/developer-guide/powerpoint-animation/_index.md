...
{{% alert color="primary" %}} 
Читать подробнее [**О анимации фигур**](/slides/ru/androidjava/shape-animation/).
{{% /alert %}}
...
{{% alert color="primary" %}} 
Читать подробнее [**О анимированных графиках**](/slides/ru/androidjava/animated-charts/).
{{% /alert %}}
...
{{% alert color="primary" %}} 
Читать подробнее [**О анимированном тексте**](/slides/ru/androidjava/animated-text/).
{{% /alert %}}