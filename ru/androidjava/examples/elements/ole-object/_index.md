...
type: docs
weight: 210
url: /ru/androidjava/examples/elements/ole-object/
keywords:
- пример кода
- OLE‑объект
- PowerPoint
...
- Java
- Aspose.Slides
description: "Работайте с OLE‑объектами в Aspose.Slides для Android: вставляйте, связывайте, обновляйте и извлекайте встроенный контент с помощью Java в презентациях PPT, PPTX и ODP."
---
В этой статье демонстрируется встраивание файла в виде OLE‑объекта и обновление его данных с использованием **Aspose.Slides for Android via Java**.
