...
- Python
- Aspose.Slides
description: "Генерируйте интерактивные 3D‑презентации в Python с помощью Aspose.Slides без усилий. Быстро экспортируйте в форматы PowerPoint и OpenDocument для универсального использования."
---
...
Создание 3D‑эффектов оказывает сильное визуальное воздействие и часто является самым простым способом превратить обычную колоду в 3D‑презентацию. Начиная с Aspose.Slides 20.9 добавлен новый **кроссплатформенный 3D‑двигатель**. Этот движок позволяет экспортировать и растеризовать фигуры и текст с 3D‑эффектами. В более ранних версиях фигуры с 3D‑эффектами отображались плоско; теперь они могут рендериться с **полноценным 3D**. Вы также можете создавать фигуры с 3D‑эффектами через API Aspose.Slides.
...
- [camera](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/camera/): симулируйте движение камеры вокруг объекта; регулируя вращение камеры, масштаб и другие свойства, можно манипулировать фигурами как 3D‑моделями в PowerPoint.
...
- [depth](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/depth/), [extrusion_color](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/extrusion_color/) и [extrusion_height](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/extrusion_height/): сделайте фигуру трёхмерной, задав её глубину или выполнив выдавливание.
- [light_rig](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/light_rig/): создайте эффекты освещения на 3D‑фигуре; аналогично камере, можно задать вращение света относительно 3D‑фигуры и выбрать тип света.
- [material](https://reference.aspose.com/slides/python-net/aspose.slides/threedformat/material/): выберите материал, чтобы 3D‑фигура выглядела более реалистично. Предустановленные материалы включают Metal, Plastic, Powder, Matte и другие.

Все 3D‑возможности можно применять как к фигурам, так и к тексту. Ниже показано, как получить доступ к этим свойствам и шаг за шагом их использовать.
...
Отрендеренный миниатюрный образ выглядит так:

![todo:image_alt_text](img_01_01.png)

## **3D‑вращение**

Можно вращать 3D‑фигуры PowerPoint в трёхмерном пространстве, добавляя интерактивность. Чтобы повернуть 3D‑фигуру в PowerPoint, используйте следующую панель меню:
...
В PowerPoint обычно используют меню **Depth** для установки глубины 3D‑фигуры:
...
Помимо градиентных заливок, фигуры можно заливать изображением:
...
Aspose.Slides позволяет применять 3D‑эффекты и к тексту. Чтобы создать 3D‑текст, можно использовать трансформ‑эффект WordArt:
...
with slides.Presentation() as presentation:
    ...
    # задать трансформ‑эффект WordArt «Arch Up»
...
**Можно ли получить «эффективные» (окончательные) значения 3D‑параметров с учётом тем, наследования и т.п.?**

Да. Slides предоставляет API для [чтения эффективных значений](/slides/ru/python-net/shape-effective-properties/) (включая 3D‑освещение, фаски и прочее), чтобы увидеть окончательные применённые настройки.
