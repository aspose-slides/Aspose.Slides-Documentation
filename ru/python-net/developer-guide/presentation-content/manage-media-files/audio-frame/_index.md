---
title: Встраивайте аудио в презентации с помощью Python
title: Аудио Фрейм
type: docs
weight: 10
...
- Python
- Aspose.Slides
description: "Легко добавляйте, извлекайте и управляйте аудиокадрами в PPT, PPTX и ODP с помощью Aspose.Slides for Python via .NET. Изучите примеры кода и улучшите свои презентации уже сегодня."
---
