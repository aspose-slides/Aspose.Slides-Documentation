...
1. Добавьте диаграмму с данными по умолчанию требуемого типа (в этом примере `ChartType.LINE_WITH_MARKERS`).
1. Доступ к оси значений диаграммы и настройте следующее:
   ...
   1. Установите **свойства текста** для меток оси значений.
...
1. Доступ к оси категорий диаграммы и настройте следующее:
   ...
   1. Установите **свойства текста** для меток оси категорий.
   1. Установите **заголовок** для оси категорий.
   1. Установите **позиционирование меток** для оси категорий.
   1. Установите **угол вращения** для меток оси категорий.
1. Доступ к легенде диаграммы и настройте её **свойства текста**.
1. Покажите легенду диаграммы без наложения на саму диаграмму.
...
1. Пройдитесь по ячейкам данных диаграммы в каждой серии и задайте другой числовой формат.
1. Сохраните презентацию.
```py
import aspose.slides.charts as charts
import aspose.slides as slides
