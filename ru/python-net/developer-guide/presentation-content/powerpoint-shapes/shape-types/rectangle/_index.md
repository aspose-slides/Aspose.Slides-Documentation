---
title: Добавляйте прямоугольники в презентации на Python
...
- Python
- Aspose.Slides
description: "Усильте свои презентации PowerPoint и OpenDocument, добавляя прямоугольники с помощью Aspose.Slides for Python via .NET — легко создавайте и изменяйте фигуры программно."
---
