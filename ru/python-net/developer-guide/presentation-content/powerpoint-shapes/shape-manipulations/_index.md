---
title: Управляйте фигурами в презентациях с помощью Python
...
- получить идентификатор фигуры interop
- альтернативный текст фигуры
- форматы расположения фигур
- фигура как SVG
- конвертировать фигуру в SVG
- выровнять фигуру
- PowerPoint
- OpenDocument
- презентация
- Python
- Aspose.Slides
description: "Узнайте, как создавать, редактировать и оптимизировать фигуры в Aspose.Slides for Python via .NET и создавать высокопроизводительные презентации PowerPoint и OpenDocument."
---
