...
- презентация
- Python
description: "Легко управляйте гиперссылками в презентациях PowerPoint и OpenDocument с помощью Aspose.Slides for Python via .NET — повышайте интерактивность и ускоряйте рабочий процесс за считанные минуты."
---

## **Обзор**

Гиперссылка — это ссылка на внешний ресурс, объект или элемент данных, либо на конкретное место в файле. Распространённые типы гиперссылок в презентациях PowerPoint включают:
...
В этом разделе объясняется, как добавить URL‑гиперссылки к элементам слайда при работе с Aspose.Slides. Описывается назначение адресов ссылок тексту, формам и изображениям для обеспечения плавной навигации во время показа.

### **Добавление URL‑гиперссылок к тексту**

Следующий пример кода показывает, как добавить гиперссылку на сайт к тексту:
...
### **Добавление URL‑гиперссылок к формам или кадрам**

Следующий пример кода показывает, как добавить гиперссылку на сайт к форме:
...
with slides.Presentation() as presentation:
    ...
    # Создаём кадр изображения на слайде 1, используя добавленное изображение.
...
В этом разделе показано, как оформить внешний вид гиперссылок в Aspose.Slides. Вы узнаете, как управлять цветом и другими параметрами стиля, чтобы оформление гиперссылок оставалось единообразным в тексте, формах и изображениях.

### **Цвет гиперссылки**

Используя свойство [color_source](https://reference.aspose.com/slides/python-net/aspose.slides/hyperlink/color_source/) класса [Hyperlink](https://reference.aspose.com/slides/python-net/aspose.slides/hyperlink/), можно задать цвет гиперссылки и получить информацию о её текущем цвете. Эта возможность появилась в PowerPoint 2019, поэтому изменения через это свойство не применяются к более ранним версиям PowerPoint.

Ниже пример, демонстрирующий добавление гиперссылок разных цветов на один слайд:
...
В этом разделе объясняется, как удалять гиперссылки из презентаций при работе с Aspose.Slides. Вы узнаете, как очистить ссылки в тексте, формах и изображениях, при этом сохранив исходный контент и оформление.

### **Удаление гиперссылок из текста**

Пример кода, показывающий, как удалить гиперссылки из текста на слайде презентации:
...
### **Удаление гиперссылок из форм или кадров**

Пример кода, показывающий, как удалить гиперссылки из форм на слайде презентации:
...
Ниже пример кода, показывающий добавление гиперссылки к слайду и последующее изменение её подсказки:
...
{{% alert color="primary" %}}
Вам может быть интересно бесплатное онлайн‑приложение Aspose для редактирования PowerPoint: [PowerPoint editor](https://products.aspose.app/slides/editor).
{{% /alert %}}
...
В [PDF](/slides/ru/python-net/convert-powerpoint-to-pdf/) и [HTML](/slides/ru/python-net/convert-powerpoint-to-html/) — да, ссылки, как правило, сохраняются. При экспорте в [изображения](/slides/ru/python-net/convert-powerpoint-to-png/) и [видео](/slides/ru/python-net/convert-powerpoint-to-video/) кликабельность не переносится из‑за особенностей этих форматов (растровые кадры/видео не поддерживают гиперссылки).