...
- Python
- Aspose.Slides
description: "Создавайте и редактируйте таблицы в слайдах PowerPoint и OpenDocument с помощью Aspose.Slides для Python через .NET. Откройте простые примеры кода для упрощения работы с таблицами."
---

## **Обзор**

Таблица в PowerPoint — это эффективный способ представить информацию. Информация, расположенная в сетке ячеек (строк и столбцов), воспринимается просто и легко понимается.
...
В этом разделе показано, как создать таблицу с нуля в Aspose.Slides, добавив форму таблицы на слайд, задав её строки и столбцы и установив точные размеры. Вы также увидите, как заполнить ячейки текстом, настроить выравнивание и границы, а также изменить внешний вид таблицы.
...
6. Пройдитесь по каждой [Cell](https://reference.aspose.com/slides/python-net/aspose.slides/cell/) и отформатируйте её верхние, нижние, правые и левый границы.
...
Ниже приведён пример на Python, показывающий, как создать таблицу в презентации:
...
Ниже приведён пример на Python, показывающий, как обращаться к ячейкам, используя эту нулевую нумерацию:
...
3. Пройдитесь по всем объектам [Shape](https://reference.aspose.com/slides/python-net/aspose.slides/shape/) до тех пор, пока не найдёте таблицу.
...
Ниже приведён пример на Python, показывающий, как получить доступ к существующей таблице и работать с ней:
...
В этом разделе показано, как управлять выравниванием текста внутри ячеек таблицы с помощью Aspose.Slides. Вы научитесь задавать горизонтальное и вертикальное выравнивание ячеек, чтобы ваш контент был чётким и последовательным.
...
Ниже пример на Python, показывающий, как выравнивать текст в таблице:
...
В этом разделе показано, как применить форматирование текста на уровне таблицы в Aspose.Slides, чтобы каждый элемент наследовал единый стиль. Вы научитесь задавать размер шрифта, выравнивания и отступы глобально.

1. Создайте экземпляр класса [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/).
2. Получите ссылку на слайд по его индексу.
3. Добавьте [Table](https://reference.aspose.com/slides/python-net/aspose.slides/table/) на слайд.
4. Установите размер шрифта (высоту шрифта) для текста.
5. Задайте выравнивание абзаца и отступы.
6. Установите вертикальную ориентацию текста.
7. Сохраните изменённую презентацию.

Ниже пример на Python, показывающий, как применить желаемые параметры форматирования к тексту в таблице:
...
Aspose.Slides позволяет форматировать таблицы, используя предопределённые стили прямо в коде. В примере показано создание таблицы, применение встроенного стиля и сохранение результата — эффективный способ обеспечить согласованное, профессиональное оформление.
...
Ниже пример на Python, показывающий, как заблокировать соотношение сторон у таблицы:
...
Да. Таблица имеет свойство [right_to_left](https://reference.aspose.com/slides/python-net/aspose.slides/table/right_to_left/), а абзацы — [ParagraphFormat.right_to_left](https://reference.aspose.com/slides/python-net/aspose.slides/paragraphformat/right_to_left/). Использование обоих обеспечивает корректный RTL‑порядок и рендеринг внутри ячеек.

**Как предотвратить перемещение или изменение размеров таблицы пользователями в конечном файле?**

Используйте [блокировки форм](/slides/ru/python-net/applying-protection-to-presentation/), чтобы отключить перемещение, изменение размеров, выделение и т.д. Эти блокировки применимы и к таблицам.
