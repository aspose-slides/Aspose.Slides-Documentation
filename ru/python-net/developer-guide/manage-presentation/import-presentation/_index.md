...
- Python
- Aspose.Slides
description: "Без усилий импортируйте PDF и HTML документы в презентации PowerPoint и OpenDocument на Python с помощью Aspose.Slides для бесшовной и высокопроизводительной обработки слайдов."
---
...
## **Конвертировать PDF в презентацию**

В этом разделе показано, как преобразовать PDF в презентацию с помощью Aspose.Slides. Он пошагово описывает импорт PDF, преобразование его страниц в слайды и сохранение результата в файл PPTX.
...
Следующий пример на Python демонстрирует конвертацию PDF в презентацию:
...
Возможно, вам захочется попробовать **бесплатное** приложение Aspose [PDF to PowerPoint](https://products.aspose.app/slides/import/pdf-to-powerpoint) — это живой пример процесса, описанного здесь.
{{% /alert %}}

## **Конвертировать HTML в презентацию**
...
Следующий пример на Python демонстрирует конвертацию HTML в презентацию:
