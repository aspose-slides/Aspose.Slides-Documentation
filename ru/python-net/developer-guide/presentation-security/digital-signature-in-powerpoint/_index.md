...
- Python
- Aspose.Slides
description: "Узнайте, как цифрово подписывать файлы PowerPoint & OpenDocument с помощью Aspose.Slides для Python через .NET. Защитите свои слайды за секунды с понятными примерами кода."
---
...
Нет. Подпись сохраняет целостность и авторство, но не блокирует редактирование. Чтобы ограничить редактирование, комбинируйте её с ["Read-only" or a password](/slides/ru/python-net/password-protected-presentation/) .
