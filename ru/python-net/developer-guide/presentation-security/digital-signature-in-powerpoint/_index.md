...
- Python
- Aspose.Slides
description: "Узнайте, как цифрово подписать файлы PowerPoint и OpenDocument с помощью Aspose.Slides для Python через .NET. Защитите свои слайды за секунды с ясными примерами кода."
---
...
Для подписи презентации или проверки подлинности её подписей **Aspose.Slides API** предоставляет класс [**DigitalSignature**](https://reference.aspose.com/slides/python-net/aspose.slides/digitalsignature/) , класс [**DigitalSignatureCollection**](https://reference.aspose.com/slides/python-net/aspose.slides/DigitalSignatureCollection/) и свойство [**Presentation.digital_signatures**](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/digital_signatures/) . В настоящее время цифровые подписи поддерживаются только для формата PPTX.
...
Нет. Подпись сохраняет целостность и авторство, но не блокирует редактирование. Чтобы ограничить редактирование, сочетайте её с ["Только для чтения" или паролем](/slides/ru/python-net/password-protected-presentation/).
