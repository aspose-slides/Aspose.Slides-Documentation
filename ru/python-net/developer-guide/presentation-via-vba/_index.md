...
- Python
- Aspose.Slides
description: "Узнайте, как генерировать и изменять презентации PowerPoint и OpenDocument через VBA с помощью Aspose.Slides для Python via .NET, чтобы оптимизировать рабочий процесс."
---

## **Обзор**

В этой статье рассматриваются основные возможности Aspose.Slides для Python via .NET при работе с макросами в презентациях PowerPoint. Библиотека предоставляет удобные инструменты для добавления, удаления и извлечения макросов, что позволяет автоматизировать создание и модификацию презентаций.
...
В статье представлены практические примеры использования Aspose.Slides для эффективной работы с макросами в PowerPoint.

Пространство имен [aspose.slides.vba](https://reference.aspose.com/slides/python-net/aspose.slides.vba/) предоставляет классы для работы с макросами и кодом VBA.

{{% alert title="Примечание" color="warning" %}}
При конвертации презентации, содержащей макросы, в другой формат (PDF, HTML и т.п.) Aspose.Slides игнорирует макросы — они не копируются в файл‑результат.

При добавлении макросов в презентацию или повторном сохранении презентации, содержащей макросы, Aspose.Slides записывает байты макросов без изменений.

Aspose.Slides **никогда** не исполняет макросы в презентации.
{{% /alert %}}

## **Добавить макросы VBA**

Aspose.Slides предоставляет класс [VbaProject](https://reference.aspose.com/slides/python-net/aspose.slides.vba/vbaproject/) для создания проектов VBA (и их ссылок) и редактирования существующих модулей.
...
Ниже приведён пример кода на Python, показывающий, как добавить макрос VBA в презентацию «с нуля»:
...
Ниже показан код на Python, удаляющий макрос VBA:
...
Пример кода на Python для извлечения макросов VBA из презентации:
...
Нет. Библиотека никогда не исполняет VBA‑код; выполнение возможно только в PowerPoint при соответствующих настройках безопасности.

**Поддерживается ли работа с элементами управления ActiveX, связанными с кодом VBA?**

Да, вы можете обращаться к существующим [ActiveX‑элементам](/slides/ru/python-net/activex/), изменять их свойства и удалять их. Это полезно, когда макросы взаимодействуют с ActiveX.