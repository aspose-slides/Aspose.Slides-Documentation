...
[Aspose.Slides](/slides/ru/java/) предоставляет поддержку работы с текстом заголовков и подвалов слайдов, которые фактически поддерживаются на уровне мастера слайдов.

{{% /alert %}} 

[Aspose.Slides для Java](/slides/ru/java/) предоставляет возможность управления заголовками и подвалами внутри слайдов презентации. Эти настройки фактически управляются на уровне мастера презентации.
