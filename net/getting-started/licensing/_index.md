...
In Aspose.Slides for .NET, the license can be loaded from a **file**, **stream**, or an **embedded resource**. Aspose.Slides for .NET typically tries to find the license in these locations:
...
1. In Visual Studio .NET, add the license (.lic) file to the project by selecting **File**, then **Add Existing Item** and finally **Add**.
