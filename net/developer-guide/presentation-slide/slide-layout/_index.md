...
[SlideSize.Type](https://reference.aspose.com/slides/net/aspose.slides/slidesize/properties/type) and [SlideSize.Size](https://reference.aspose.com/slides/net/aspose.slides/slidesize/properties/size) are the properties of presentation class which could be set or get as shown below in the example.
...
1. Set text to master slide and all child footer placeholder by using [SetFooterAndChildFootersText ](https://reference.aspose.com/slides/net/aspose.slides/imasterslideheaderfootermanager/methods/setfooterandchildfootersvisibility)method.
