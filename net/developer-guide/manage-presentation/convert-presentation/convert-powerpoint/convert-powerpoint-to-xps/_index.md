...
In [**Aspose.Slides**](https://products.aspose.com/slides/net/) for .NET, you can use the [**Save**](https://apireference.aspose.com/slides/net/aspose.slides/presentation/methods/save/index) method exposed by the [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation) class to convert the entire presentation into an XPS document. 

When converting a presentation to XPS, you have to save the presentation using either of these settings:

- Default settings (without [**XPSOptions**](https://apireference.aspose.com/slides/net/aspose.slides.export/xpsoptions))
- Custom settings (with [**XPSOptions**](https://apireference.aspose.com/slides/net/aspose.slides.export/xpsoptions))
