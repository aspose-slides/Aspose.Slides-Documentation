...
keywords: "C# Convert PPT to PPTX, Convert PowerPoint Presentation, PPT to PPTX, C#, Csharp, .NET, Aspose.Slides"
...
For C# sample code to convert PPT to PPTX, please see the section below i.e. [Convert PPT to PPTX](https://docs.aspose.com/slides/net/convert-ppt-to-pptx/#convert-ppt-to-pptx). It just loads the PPT file and saves in PPTX format. By specifiying different save formats. you can also save PPT file into many other formats like PDF, XPS, ODP, HTML etc.
