---
title: ایجاد یک سند ارائه
type: docs
weight: 60
url: /fa/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // ایجاد یک ارائه در مسیر فایل مشخص شده. نوع سند ارائه به صورت پیش‌فرض pptx است.
...

{
    ...
    //یک شیء Presentation که نمایانگر یک فایل PPT است ایجاد کنید
    using (Presentation pres = new Presentation())
    {

        //کلاس SlideExCollection را نمونه‌سازی کنید
        ISlideCollection slds = pres.Slides;
        //یک اسلاید خالی به مجموعه SlidesEx اضافه کنید
