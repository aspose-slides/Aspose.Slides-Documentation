---
title: Vytvořit prezentační dokument
type: docs
weight: 60
url: /cs/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // Vytvořit prezentaci na zadané cestě k souboru. Typ dokumentu prezentace je pptx, ve výchozím nastavení.
...

{
    ...
    //Instancujte objekt Presentation, který představuje soubor PPT
    using (Presentation pres = new Presentation())
    {

        //Instancujte třídu SlideExCollection
        ISlideCollection slds = pres.Slides;
        //Přidejte prázdný snímek do kolekce SlidesEx
