...
Tato barva se použije jako výchozí, pokud je FillType roven NotDefined.
...
Vlastnost PixelFormat byla přaddedá do Aspose.Slides.Export.ITiffOptions a Aspose.Slides.Export.TiffOptions pro určení formátu pixelů pro generované TIFF obrázky.