...
- C++
- Aspose.Slides
description: "Naučte se formátování grafů v Aspose.Slides pro C++ a vylepšete svou PowerPoint prezentaci profesionálním, poutavým stylem."
---
## **Přehled**

Tento článek vysvětluje, jak pomocí Aspose.Slides formátovat grafy v prezentacích PowerPoint. Ukazuje, jak přizpůsobit klíčové prvky grafu, jako jsou osy, čáry mřížky, nadpisy, popisky, oblast vykreslení a výplně stěn, aby se zlepšil vzhled a čitelnost dat v grafu.

Také ukazuje, jak nastavit vlastnosti písma pro text v grafu, použít předdefinované i vlastní číselné formáty na data grafu a povolit zaoblené rohy oblasti grafu. Tyto příklady společně ukazují, jak řídit jak vizuální styl, tak prezentaci dat grafu v prezentaci.

## **Formátování entit grafu**

Aspose.Slides pro C++ umožňuje vývojářům přidávat vlastní grafy do snímků od základu. Tento článek vysvětluje, jak formátovat různé entity grafu včetně kategoriální a hodnotové osy.

Aspose.Slides pro C++ poskytuje jednoduché API pro správu různých entit grafu a jejich formátování pomocí vlastních hodnot:
...
1. Přistupte k legendě grafu a nastavte **Text Properties** pro ní
1. Nastavte zobrazení legend grafu tak, aby nepřekrývaly graf
...
1. Nastavte výplň zadní stěny grafu na barvu
...
Aspose.Slides pro C++ poskytuje podporu pro nastavení vlastností souvisejících s písmem pro graf. Postupujte podle níže uvedených kroků pro nastavení vlastností písma pro graf.
...
Aspose.Slides pro C++ poskytuje podporu pro změnu barvy kategorií v barvě série.
...
Aspose.Slides pro C++ poskytuje podporu pro nastavení oblasti grafu. V Aspose.Slides byly přidány vlastnosti **IChart.HasRoundedCorners** a **Chart.HasRoundedCorners**.
...
Aspose.Slides pro C++ poskytuje jednoduché API pro správu formátu dat grafu:
...
1. Projděte buňky dat grafu v každé sérii a nastavte odlišný číselný formát dat grafu.
1. Uložte prezentaci.
...
**Mohu nastavit poloprůhledné výplně pro sloupce/oblasti a přitom udržet okraj neprůhledný?**
...
Zmenšete velikost písma, deaktivujte nepodstatné součásti popisků (například kategorie), nastavte posun/umístění popisku, zobrazte popisky jen pro vybrané body, pokud je to nutné, nebo přepněte formát na "value + legend".

**Mohu použít gradientní nebo vzorové výplně na sérii?**
