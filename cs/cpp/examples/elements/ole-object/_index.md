...
type: docs
weight: 210
url: /cs/cpp/examples/elements/ole-object/
keywords:
- ukázka kódu
- OLE objekt
- PowerPoint
...
- C++
- Aspose.Slides
description: "Pracujte s OLE objekty v Aspose.Slides for C++: vkládejte, propojujte, aktualizujte a extrahujte vložený obsah pomocí C++ v prezentacích PPT, PPTX a ODP."
---
Tento článek demonstruje vložení souboru jako OLE objektu a aktualizaci jeho dat pomocí **Aspose.Slides for C++**.
