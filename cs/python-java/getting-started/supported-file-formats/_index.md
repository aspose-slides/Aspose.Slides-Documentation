...
type: docs
weight: 30
url: /cs/python-java/supported-file-formats/
---
...
Tato tabulka obsahuje formáty souborů, které Aspose.Slides for Python via Java může načíst a uložit:
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Formát tagových souborů obrázků| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|Rozšířený metsouborový formát| |{{< emoticons/tick >}}| |
