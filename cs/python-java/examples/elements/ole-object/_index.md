...
- Java
- Aspose.Slides
description: "Použijte Aspose.Slides for Python via Java k přidání, přístupu, odstranění a aktualizaci OLE objektů v prezentacích PowerPoint a OpenDocument."
---
Tento článek demonstruje, jak vložit soubor jako OLE objekt a aktualizovat jeho data pomocí **Aspose.Slides for Python via Java**.

Nainstalujte balíček podle pokynů v [Instalace](/slides/cs/python-java/installation/). Každý příklad importuje `asposeslides` před spuštěním JVM a poté importuje API po spuštění JVM.
