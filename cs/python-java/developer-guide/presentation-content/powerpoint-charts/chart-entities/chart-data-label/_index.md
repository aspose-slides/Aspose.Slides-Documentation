---
title: Spravujte popisky dat v grafech v prezentacích pomocí Pythonu
...
- Java
- Aspose.Slides
description: "Naučte se přidávat a formátovat popisky dat v grafech v prezentacích PowerPoint pomocí Aspose.Slides for Python via Java pro poutavější snímky."
---
## **Úvod**

Popisky dat v grafu zobrazují podrobnosti o datových řadách grafu nebo jednotlivých bodech. Umožňují čtenářům rychle identifikovat datové řady a také usnadňují pochopení grafů.

## **Nastavení přesnosti dat v popiscích grafu**

Tento kód v Pythonu vám ukazuje, jak nastavit přesnost dat v popisku grafu:
...
Aspose.Slides for Python via Java umožňuje nastavit procentní popisky v zobrazených grafech. Tento kód v Pythonu demonstruje operaci:
...
Tento kód v Pythonu vám ukazuje, jak nastavit procentní znak pro popisek grafu:
...
Tento kód v Pythonu vám ukazuje, jak nastavit vzdálenost popisku od kategoriální osy při práci s grafem vykresleným z os:
...
Když vytvoříte graf, který nezávisí na žádné ose, například koláčový graf, může se stát, že popisky dat budou příliš blízko jeho okraji. V takovém případě musíte upravit umístění popisku, aby byly čáry ukazatele (leader lines) zřetelně zobrazeny.

Tento kód v Pythonu vám ukazuje, jak upravit umístění popisku v koláčovém grafu:
...
![upravený-štítek-pizdiagramu](pie-chart-adjusted-label.png)

## **Často kladené otázky**

**Jak mohu zabránit překrývání popisků na hustých grafech?**

Kombinujte automatické umístění popisků, čáry ukazatele a zmenšení velikosti písma; pokud je to nutné, skryjte některá pole (například kategorii) nebo zobrazte popisky jen pro extrémní/klíčové body.
...
Explicitně nastavit písma (rodinu, velikost) a ověřit, že písmo je k dispozici na straně vykreslování, aby se předešlo náhradním písmům.