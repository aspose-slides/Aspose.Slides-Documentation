...
type: docs
weight: 160
url: /cs/nodejs-java/examples/elements/math-text/
keywords:
  - příklad kódu
  - matematický text
  - PowerPoint
  ...
  - JavaScript
  - Aspose.Slides
description: "Prozkoumejte příklady MathematicalText v Aspose.Slides pro Node.js: vytvářejte a formátujte rovnice, zlomky, matice a symboly v prezentacích PPT, PPTX a ODP."
---
Tento článek demonstruje práci s matematickými textovými tvary a formátování rovnic pomocí **Aspose.Slides for Node.js via Java**.

## **Přidat matematický text**

Vytvořte matematický tvar, který obsahuje zlomek a Pythagorovu větu.
...
## **Získat matematický text**

Vyhledejte tvar, který na snímku obsahuje matematický odstavec.
...
function removeMathText() {
    ...
    try {
        ...
        // Předpokládejme, že první tvar je matematický tvar.
