...
type: docs
weight: 180
url: /cs/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/
keywords:
- migrace
- starý kód
- moderní kód
...
```
#### **Nový com.aspose.slides.VideoPlayerHtmlController přidán pro podporu exportu mediálních souborů do HTML**
Byla přidána nová veřejná třída com.aspose.slides.VideoPlayerHtmlController. Pomocí instance této třídy může uživatel exportovat video a audio soubory do HTML.
