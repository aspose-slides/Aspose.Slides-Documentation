...
type: docs
weight: 140
url: /cs/java/examples/elements/smart-art/
keywords:
- ukázka kódu
- SmartArt
- PowerPoint
...
- Java
- Aspose.Slides
description: "Pracujte se SmartArt v Aspose.Slides pro Java: vytvářejte, upravujte, převádějte a stylizujte diagramy pomocí Javy pro prezentace PowerPoint a OpenDocument."
---
Tento článek ukazuje, jak pomocí **Aspose.Slides for Java** přidávat grafiku SmartArt, přistupovat k ní, odstraňovat ji a měnit rozvržení.
