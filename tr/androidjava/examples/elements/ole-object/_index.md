...
type: docs
weight: 210
url: /tr/androidjava/examples/elements/ole-object/
keywords:
- kod örneği
- OLE nesnesi
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Android'de OLE nesnelerini yönetin: Java ile PPT, PPTX ve ODP sunumlarında gömülü içeriği ekleyin, bağlayın, güncelleyin ve çıkarın."
---
Bu makale, bir dosyayı OLE nesnesi olarak yerleştirmeyi ve **Aspose.Slides for Android via Java** kullanarak verilerini güncellemeyi gösterir.

## **OLE Nesnesi Ekle**

Bir PDF dosyasını sunuma yerleştirin.
...
Mevcut bir OLE nesnesine gömülmüş verileri değiştirin.
