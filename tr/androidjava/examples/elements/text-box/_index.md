...
type: docs
weight: 40
url: /tr/androidjava/examples/elements/text-box/
keywords:
- kod örneği
- metin kutusu
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Android'de metin kutularıyla çalışın: PPT, PPTX ve ODP sunumları için Java kullanarak metni ekleyin, biçimlendirin, hizalayın, kaydırın, otomatik sığdırın ve stil verin."
---
Aspose.Slides'ta, bir **metin kutusu** `AutoShape` ile temsil edilir. Neredeyse her şekil metin içerebilir, ancak tipik bir metin kutusunun dolgusu veya kenarlığı yoktur ve yalnızca metin gösterir.

Bu kılavuz, metin kutularını programlı olarak nasıl ekleyeceğinizi, erişeceğinizi ve kaldıracağınızı açıklar.

## **Metin Kutusu Ekle**

Bir metin kutusu, sadece dolgusu ve kenarlığı olmayan ve biçimlendirilmiş metin içeren bir `AutoShape`'dir. İşte nasıl oluşturulacağı:
...
Belirli bir anahtar kelimeyi (ör. "Slide") içeren tüm metin kutularını bulmak için şekiller arasında dönün ve metinlerini kontrol edin:
...
public static void accessTextBox() {
    ...
    try {
        ...
        for (IShape shape : slide.getShapes()) {
            // Sadece AutoShape'ler düzenlenebilir metin içerebilir.
...
> 💡 **İpucu:** Döngü sırasında koleksiyonu değiştirmeden önce şekil koleksiyonunun bir kopyasını her zaman oluşturun; böylece koleksiyon değişikliği hatalarından kaçınırsınız.