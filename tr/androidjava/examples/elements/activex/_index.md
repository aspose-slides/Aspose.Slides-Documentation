...
type: docs
weight: 200
url: /tr/androidjava/examples/elements/activex/
keywords:
- kod örneği
- ActiveX
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Android ActiveX örneklerini inceleyin: PPT ve PPTX sunumlarında ActiveX nesnelerini ekleme, yapılandırma ve kontrol etme, net Java kodu ile."
---
