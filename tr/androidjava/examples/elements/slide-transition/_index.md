...
type: docs
weight: 110
url: /tr/androidjava/examples/elements/slide-transition/
keywords:
- kod örneği
- slayt geçişi
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Android'da slayt geçişlerini ustalıkla yönetin: Java örnekleriyle PPT, PPTX ve ODP sunumları için efektleri ve süreleri ekleyin, özelleştirin ve sıralayın."
---
Bu makale, **Aspose.Slides for Android via Java** kullanarak slayt geçiş efektleri ve zamanlamalarını uygulamayı göstermektedir.
...
static void removeSlideTransition() {
    ...
    try {
        ...
        // Geçişi none olarak ayarlayarak kaldır.
