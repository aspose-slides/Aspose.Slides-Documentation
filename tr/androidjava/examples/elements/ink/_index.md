...
type: docs
weight: 180
url: /tr/androidjava/examples/elements/ink/
keywords:
- kod örneği
- mürekkep
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Android'de Mürekkep ile çalışın: darbeleri çizin, içe aktarın ve düzenleyin, renk ve genişliği ayarlayın ve Java örnekleri kullanarak PPT, PPTX ve ODP'ye dışa aktarın."
---
