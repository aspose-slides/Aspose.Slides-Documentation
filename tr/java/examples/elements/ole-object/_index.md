...
type: docs
weight: 210
url: /tr/java/examples/elements/ole-object/
keywords:
- kod örneği
- OLE nesnesi
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java'da OLE nesnelerini yönetin: Java ile PPT, PPTX ve ODP sunumlarında gömülü içeriği ekleyin, bağlayın, güncelleyin ve çıkarın."
---
Bu makale, bir dosyayı OLE nesnesi olarak gömmeyi ve **Aspose.Slides for Java** kullanarak verilerini güncellemeyi göstermektedir.
...
Yerleşik OLE nesnesini slayttan sil.
...
Mevcut bir OLE nesnesine gömülü veriyi değiştir.
