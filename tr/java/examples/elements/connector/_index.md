...
type: docs
weight: 190
url: /tr/java/examples/elements/connector/
keywords:
- kod örneği
- Bağlayıcı
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java kullanarak şekiller arasına bağlayıcı ekleme, yönlendirme ve stil ayarlama hakkında öğrenin; PPT, PPTX ve ODP sunumları için Java örnekleri."
---
Bu makale, **Aspose.Slides for Java** kullanarak şekilleri bağlayıcılarla nasıl bağlayacağınızı ve hedeflerini nasıl değiştireceğinizi gösterir.

## **Bağlayıcı Ekle**

Slayt üzerindeki iki nokta arasında bir bağlayıcı şekli ekleyin.
