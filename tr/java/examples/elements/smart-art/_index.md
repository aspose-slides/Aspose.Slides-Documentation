...
type: docs
weight: 140
url: /tr/java/examples/elements/smart-art/
keywords:
- kod örneği
- SmartArt
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java ile SmartArt üzerinde çalışın: PowerPoint ve OpenDocument sunumları için Java kullanarak diyagramları oluşturun, düzenleyin, dönüştürün ve stil verin."
---
Bu makale, **Aspose.Slides for Java** kullanarak SmartArt grafikleri eklemeyi, onlara erişmeyi, kaldırmayı ve düzenleri değiştirmeyi gösterir.
