---
title: Java'da Özel Animasyon Davranışlarını Oluşturma ve Değiştirme
linktitle: Özel Animasyon
type: docs
weight: 151
url: /tr/java/custom-animation/
keywords:
- özel animasyon
- animasyon davranışı
- hareket yolu
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java ile PowerPoint sunumlarındaki özel animasyon davranışlarını ve düzenlenebilir hareket yollarını oluşturun, inceleyin ve değiştirin."
---
## **Genel Bakış**

Özel animasyon davranışları, bir renk değişikliği, bir şeklin döndürülmesi veya düzenlenebilir bir hareket yolu izlenmesi gibi bir animasyon etkisi içindeki bireysel işlemleri kontrol etmenizi sağlar. Bu kılavuz, davranışların nasıl oluşturulup birleştirileceğini, zamanlamalarının nasıl yapılandırılacağını, mevcut animasyonların nasıl inceleneceğini ve değiştirileceğini ve özelliklerin bir sunumun kaydedilip yeniden açılması sonrasında korunup korunmadığını gösterir.

Önceden tanımlı etkiler ve tıkla tetikleyiciler için [Şekil Animasyonu](/slides/tr/java/shape-animation/) bölümüne bakın.

## **Animasyon Modelini Anlama**

Bir animasyon **Zaman Çizelgesi → Sıra → Etki → Davranışlar** olarak düzenlenir:

- The [getTimeline](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibaseslide/#getTimeline--) method returns the slide timeline, which contains its main sequence and interactive sequences.
- An [ISequence](https://reference.aspose.com/slides/tr/java/com.aspose.slides/isequence/) contains effects, potentially targeting different shapes.
- An [IEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ieffect/) identifies a target shape, preset, subtype, and effect timing.
- The collection returned by [IEffect.getBehaviors](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ieffect/#getBehaviors--) contains the operations that implement the effect: changing color, moving, rotating, setting a property, and so on.

## **Bireysel Davranışları Oluşturma**

Call [ISequence.addEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/isequence/#addEffect-com.aspose.slides.IShape-int-int-int-) to create an effect and access the [getBehaviors](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ieffect/#getBehaviors--) collection. A preset can populate this collection automatically. Keep its operations when extending the preset, or use [clear](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorcollection/#clear--) when deliberately replacing them.

[IBehaviorFactory](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorfactory/) creates the eight behavior types illustrated below. Motion is covered in [Build a Motion Path](#build-a-motion-path). Each snippet includes its imports; place its executable statements inside a method. Later editing examples state which output file they use.

### **Dönme**

Use [createRotationEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorfactory/#createRotationEffect--) to create a rotation. [getBy](https://reference.aspose.com/slides/tr/java/com.aspose.slides/irotationeffect/#getBy--) specifies a relative angle in degrees; [getFrom](https://reference.aspose.com/slides/tr/java/com.aspose.slides/irotationeffect/#getFrom--) and [getTo](https://reference.aspose.com/slides/tr/java/com.aspose.slides/irotationeffect/#getTo--) specify endpoints.
...
Use [createScaleEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorfactory/#createScaleEffect--) with X/Y percentages: [getFrom](https://reference.aspose.com/slides/tr/java/com.aspose.slides/iscaleeffect/#getFrom--) and [getTo](https://reference.aspose.com/slides/tr/java/com.aspose.slides/iscaleeffect/#getTo--) describe the starting and ending size, while [getBy](https://reference.aspose.com/slides/tr/java/com.aspose.slides/iscaleeffect/#getBy--) describes a relative change. Here, 100 means the original size.
...
Use [createColorEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorfactory/#createColorEffect--) to change the fill from blue to orange. [getFrom](https://reference.aspose.com/slides/tr/java/com.aspose.slides/icoloreffect/#getFrom--) and [getTo](https://reference.aspose.com/slides/tr/java/com.aspose.slides/icoloreffect/#getTo--) are colors; [getBy](https://reference.aspose.com/slides/tr/java/com.aspose.slides/icoloreffect/#getBy--) is a color offset. [IBehavior.getProperties](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehavior/#getProperties--) identifies the attribute being animated.
...
Use [createFilterEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorfactory/#createFilterEffect--) to select a wipe. [getType](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ifiltereffect/#getType--), [getSubtype](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ifiltereffect/#getSubtype--), and [getReveal](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ifiltereffect/#getReveal--) specify the filter, direction, and whether to reveal or hide the shape.
...
Use [createPropertyEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorfactory/#createPropertyEffect--) to animate opacity. [getFrom](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ipropertyeffect/#getFrom--), [getTo](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ipropertyeffect/#getTo--), and [getBy](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ipropertyeffect/#getBy--) are strings interpreted using [getValueType](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ipropertyeffect/#getValueType--) and [getCalcMode](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ipropertyeffect/#getCalcMode--). Choose endpoints or a relative offset rather than setting all three indiscriminately.
...
Use [createSetEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorfactory/#createSetEffect--) to assign visibility through [getTo](https://reference.aspose.com/slides/tr/java/com.aspose.slides/iseteffect/#getTo--). A set behavior does not interpolate between endpoints.
...
Use [createCommandEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorfactory/#createCommandEffect--) and configure [getType](https://reference.aspose.com/slides/tr/java/com.aspose.slides/icommandeffect/#getType--), [getCommandString](https://reference.aspose.com/slides/tr/java/com.aspose.slides/icommandeffect/#getCommandString--), and [getShapeTarget](https://reference.aspose.com/slides/tr/java/com.aspose.slides/icommandeffect/#getShapeTarget--). Place a WAV recording named `sample.wav` in the working directory. This example embeds it with [addAudioFrameEmbedded](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ishapecollection/#addAudioFrameEmbedded-float-float-float-float-java.io.InputStream-) and attaches a play command to the audio frame.
...
[IBehaviorCollection](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorcollection/) supports [add](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorcollection/#add-com.aspose.slides.IBehavior-), [insert](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorcollection/#insert-int-com.aspose.slides.IBehavior-), [remove](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorcollection/#remove-com.aspose.slides.IBehavior-), and [removeAt](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorcollection/#removeAt-int-). This example opens `rotation.pptx`, adds scaling, moves it before rotation, and removes the rotation. Removing and reinserting the same object changes its stored position without making a copy.
...
[IBehavior.getTiming](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehavior/#getTiming--) exposes [ITiming](https://reference.aspose.com/slides/tr/java/com.aspose.slides/itiming/), independently of [IEffect.getTiming](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ieffect/#getTiming--). Effect timing schedules the enclosing effect; behavior timing describes an operation inside it.

### **Süre, Gecikme, Tekrar ve Hızlanma Ayarlama**

Open `rotation.pptx` and set the duration ([getDuration](https://reference.aspose.com/slides/tr/java/com.aspose.slides/itiming/#getDuration--)) and trigger delay ([getTriggerDelayTime](https://reference.aspose.com/slides/tr/java/com.aspose.slides/itiming/#getTriggerDelayTime--)) in seconds, then configure the repeat count through [setRepeatCount](https://reference.aspose.com/slides/tr/java/com.aspose.slides/itiming/#setRepeatCount-float-). [getAccelerate](https://reference.aspose.com/slides/tr/java/com.aspose.slides/itiming/#getAccelerate--) and [getDecelerate](https://reference.aspose.com/slides/tr/java/com.aspose.slides/itiming/#getDecelerate--) are fractions of the duration; keep their sum at most 1.
...
Other repeat policies include [getRepeatDuration](https://reference.aspose.com/slides/tr/java/com.aspose.slides/itiming/#getRepeatDuration--), [getRepeatUntilEndSlide](https://reference.aspose.com/slides/tr/java/com.aspose.slides/itiming/#getRepeatUntilEndSlide--), and [getRepeatUntilNextClick](https://reference.aspose.com/slides/tr/java/com.aspose.slides/itiming/#getRepeatUntilNextClick--); choose a policy rather than enabling them all together. [getAutoReverse](https://reference.aspose.com/slides/tr/java/com.aspose.slides/itiming/#getAutoReverse--) plays the animation backwards after the forward pass. Acceleration and deceleration apply to continuous changes, not discrete assignments or commands.

## **Bir Hareket Yolu Oluşturma**

Use [createMotionEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/ibehaviorfactory/#createMotionEffect--) to create motion. Its [getFrom](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioneffect/#getFrom--), [getTo](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioneffect/#getTo--), and [getBy](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioneffect/#getBy--) describe percentage-based coordinates or offsets. For an editable route, create a [MotionPath](https://reference.aspose.com/slides/tr/java/com.aspose.slides/motionpath/) and assign it with [IMotionEffect.setPath](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioneffect/#setPath-com.aspose.slides.IMotionPath-). [IMotionPath](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotionpath/) stores the path commands.

[MotionCommandPathType](https://reference.aspose.com/slides/tr/java/com.aspose.slides/motioncommandpathtype/) selects the operation:
...
[MotionPathPointsType](https://reference.aspose.com/slides/tr/java/com.aspose.slides/motionpathpointstype/) describes point-editing characteristics, such as corner or smooth points. It does not replace the command type. Use a curve point type for the curve example below, and a corner point type for the straight segments.

Path coordinates are normalized to slide dimensions: an X displacement of 0.25 represents one quarter of the slide width, not 0.25 points. Positive Y runs downward. Absolute commands specify positions in the path coordinate system; relative commands specify offsets from the current position. This is separate from [getOrigin](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioneffect/#getOrigin--), which selects the path's reference frame, and [getPathEditMode](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioneffect/#getPathEditMode--), which controls how the path moves when the shape is moved.

### **Düz Bir Yol Oluşturma**

Create a motion behavior with a starting point, one straight segment, and an end command. [IMotionPath.add](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotionpath/#add-int-java.awt.geom.Point2D.Float---int-boolean-) takes the command type, its points, the point type, and a relative-coordinate flag.
...
Each [IMotionCmdPath](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioncmdpath/) exposes [getPoints](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioncmdpath/#getPoints--), [getCommandType](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioncmdpath/#getCommandType--), [getPointsType](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioncmdpath/#getPointsType--), and [isRelative](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotioncmdpath/#isRelative--). The following examples use the known three-command path in `motion.pptx`. For arbitrary input, locate the intended effect and check command types and point counts before editing by index.
...
Use [insert](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotionpath/#insert-int-int-java.awt.geom.Point2D.Float---int-boolean-) and [removeAt](https://reference.aspose.com/slides/tr/java/com.aspose.slides/imotionpath/#removeAt-int-) to replace the line in `motion.pptx`. Inserting shifts the old line to index 2.
...
When the behavior's index is unknown, select it by type. This example opens `rotation.pptx`, finds its [IRotationEffect](https://reference.aspose.com/slides/tr/java/com.aspose.slides/irotationeffect/), changes the angle, and checks the saved value after reopening.
...
| [HTML5](/slides/tr/java/export-to-html5/) | Can play supported animations when shape animation is enabled in the export options. Test custom combinations in the browser. |
| [Animated GIF](/slides/tr/java/convert-powerpoint-to-animated-gif/) | Stores rendered frames, not editable behaviors or click-triggered interaction. Check the actual rendered motion. |
| [Video](/slides/tr/java/convert-powerpoint-to-video/) | Render animation frames and encode them as video. Support is limited to the renderer's [supported animations and effects](/slides/tr/java/convert-powerpoint-to-video/#supported-animations-and-effects); commands and interactive events do not become an editable timeline. |

## **SSS**

**Neden bir etki, hiç davranış eklemediğim halde davranışlar içeriyor?**
...
**Bir davranışı en başa taşımak, onu önce oynatılmasını sağlar mı?**
...
**Başarılı bir round‑trip, oynatmayı doğrulamak için yeterli mi?**
