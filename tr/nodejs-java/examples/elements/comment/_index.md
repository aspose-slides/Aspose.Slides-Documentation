...
type: docs
weight: 230
url: /tr/nodejs-java/examples/elements/comment/
keywords:
- kod örneği
- yorum
- PowerPoint
...
- JavaScript
- Aspose.Slides
description: "Aspose.Slides for Node.js'te slayt yorumlarıyla çalışın: yorum ekleyin, yanıtlayın, düzenleyin, çözümleyin ve kod örnekleriyle PPT, PPTX ve ODP sunumlarındaki yorumları dışa aktarın."
---
Bu makale, **Aspose.Slides for Node.js via Java** kullanarak modern yorumları ekleme, okuma, kaldırma ve yanıtlama işlemlerini göstermektedir.

## **Modern Yorum Ekle**
Bir kullanıcı tarafından oluşturulan bir yorum oluşturun ve sunumu kaydedin.
