---
title: C++'da Sunum Köprülerini Yönet
...
- C++
- Aspose.Slides
description: "Aspose.Slides for C++ ile PowerPoint ve OpenDocument sunumlarında köprüleri zahmetsizce yönetin—etkileşimi ve iş akışını dakikalar içinde artırın."
---
## **Giriş**

Bir köprü, bir nesneye, veriye veya bir yere referanstır. Bunlar PowerPoint Sunumlarındaki yaygın köprülerdir:

* Metin, şekil veya medya içindeki web sitelerine bağlantılar
* Slaytlara bağlantılar

Aspose.Slides for C++ sunumlardaki köprülerle ilgili birçok görevi gerçekleştirmenizi sağlar. 

{{% alert color="primary" %}} 

Aspose simple'ı kontrol etmek isteyebilirsiniz, [ücretsiz çevrimiçi PowerPoint düzenleyicisi.](https://products.aspose.app/slides/tr/editor)

{{% /alert %}} 

## **URL Köprüleri Ekle**

### **Metne URL Köprüsü Ekle**

Bu C++ kodu bir metne web sitesi köprüsü eklemeyi gösterir:
...
### **Şekillere veya Çerçevelere URL Köprüsü Ekle**

Bu örnek C++ kodu bir şekle web sitesi köprüsü eklemeyi gösterir:
...
Bu örnek kod bir **video'ya** köprü eklemeyi gösterir:
...
[IHyperlink](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.i_hyperlink) arayüzündeki [set_ColorSource()](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.i_hyperlink#ab739ae21025485366d44a3b72e0d7dac) ve [get_ColorSource()](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.i_hyperlink#af5370af1ba9fba7b22fcc8a7ce344494) yöntemleriyle köprülerin rengini ayarlayabilir ve köprülerin renk bilgilerini alabilirsiniz. Bu özellik ilk olarak PowerPoint 2019'da tanıtıldı, bu nedenle özellik ile ilgili değişiklikler eski PowerPoint sürümlerine uygulanmaz.

Bu örnek kod, aynı slayta farklı renkte köprüler eklenmesini gösterir:
...
### **Metinden Köprüleri Kaldır**

Bu C++ kodu, bir sunum slaytındaki metinden köprüyü kaldırmayı gösterir:
...
### **Şekillerden veya Çerçevelerden Köprüleri Kaldır**

Bu C++ kodu, bir sunum slaytındaki şekilden köprüyü kaldırmayı gösterir: 
...
[Hyperlink](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.hyperlink) sınıfı değiştirilebilir. Bu sınıfla aşağıdaki yöntemlerin değerlerini değiştirebilirsiniz:
...
Bir sunum, slayt veya köprünün tanımlandığı metinden IHyperlinkQueries'e erişebilirsiniz. 
...
IHyperlinkQueries sınıfı aşağıdaki yöntemleri destekler: 
...
**Bir slayta değil, bir "bölüm"e ya da bir bölümün ilk slaytına iç navigasyon nasıl oluşturabilirim?**

PowerPoint'te bölümler slayt gruplamalarıdır; navigasyon teknik olarak belirli bir slayta yönelir. "Bir bölüme gitmek" için genellikle o bölümün ilk slaytına bağlantı verilir.

**Master slayt öğelerine köprü ekleyebilir miyim, böylece tüm slaytlarda çalışır?**

Evet. Master slayt ve yerleşim öğeleri köprüleri destekler. Bu bağlantılar alt slaytlarda da görünür ve sunum sırasında tıklanabilir olur.

**Köprüler PDF, HTML, görüntüler veya video olarak dışa aktarıldığında korunur mu?**

[PDF](/slides/tr/cpp/convert-powerpoint-to-pdf/) ve [HTML](/slides/tr/cpp/convert-powerpoint-to-html/) dışa aktarımlarında evet—bağlantılar genellikle korunur. [görüntüler](/slides/tr/cpp/convert-powerpoint-to-png/) ve [video](/slides/tr/cpp/convert-powerpoint-to-video/) dışa aktarımlarında ise tıklanabilirlik yoktur; raster çerçeveler/video bu formatlarda köprüleri desteklemez.