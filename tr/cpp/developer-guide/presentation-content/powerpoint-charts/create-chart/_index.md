---
title: C++'ta PowerPoint Sunum Grafiklerini Oluşturma veya Güncelleme
...
- C++
- Aspose.Slides
description: "Aspose.Slides for C++ kullanarak PowerPoint sunumlarındaki grafikleri oluşturun ve özelleştirin. C++'ta pratik kod örnekleriyle grafik ekleyin, biçimlendirin ve düzenleyin."
---
## **Genel Bakış**

Bu makale, Aspose.Slides kullanarak grafik oluşturma ve özelleştirme konusunda kapsamlı bir rehber sunar. Programlı olarak bir slayta grafik eklemeyi, verilerle doldurmayı ve belirli tasarım gereksinimlerinize uygun çeşitli biçimlendirme seçeneklerini uygulamayı öğreneceksiniz. Makale boyunca, sunumu ve grafik nesnesini başlatmaktan serileri, eksenleri ve lejandları yapılandırmaya kadar her adımı gösteren ayrıntılı kod örnekleri yer alır. Bu rehberi izleyerek, dinamik grafik oluşturmayı uygulamalarınıza entegre etme konusunda sağlam bir anlayış elde edecek, veri odaklı sunumlar oluşturma sürecini kolaylaştıracaksınız.

## **Grafik Oluşturma**

Grafikler, insanlara verileri hızlı bir şekilde görselleştirmelerine ve bir tablo ya da elektronik tablodan hemen fark edilmeyen içgörüler elde etmelerine yardımcı olur. 
...
* verinin zaman içindeki yönünü ve ivmesini ya da belirli bir ölçü birimine göre değişimini çıkarmak
* aykırı değerleri, sapmaları, hataları, mantıksız verileri vb. tespit etmek 
* karmaşık verileri iletmek ya da sunmak

PowerPoint’te grafikleri ekle işlevi aracılığıyla oluşturabilirsiniz; bu işlev, birçok grafik türünü tasarlamak için kullanılan şablonları sağlar. Aspose.Slides kullanarak popüler grafik türlerine dayanan normal grafikler ve özel grafikler oluşturabilirsiniz. 

{{% alert color="primary" %}} 

Grafik oluşturmanıza olanak tanımak için, Aspose.Slides, [ChartType](https://reference.aspose.com/slides/tr/cpp/namespace/aspose.slides.charts#a23ba9ea390f5be4c8f5ab18baf4f8c05) enum sınıfını [Aspose::Slides::Charts](https://reference.aspose.com/slides/tr/cpp/namespace/aspose.slides.charts/) ad alanı altında sağlar. Bu enum sınıfındaki değerler farklı grafik türlerine karşılık gelir. 
...
1. Bir grafik ekleyin, bazı veri ekleyin ve istediğiniz grafik türünü belirtin.  
...
### **Dağılım Grafikler Oluşturma**
Dağılım grafikleri (dağılım diyagramları ya da x‑y grafikleri olarak da bilinir) genellikle iki değişken arasındaki desenleri kontrol etmek veya korelasyonları göstermek için kullanılır. 

Bir dağılım grafiği aşağıdaki durumlarda işe yarar:
...
Pasta grafikler, özellikle veriler kategorik etiketler ve sayısal değerler içerdiğinde parçanın bütün içindeki oranını göstermek için en uygunudur. Ancak veriniz çok sayıda parça veya etiket içeriyorsa çubuk grafik kullanmayı düşünebilirsiniz. 

1. [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfının bir örneğini oluşturun.  
1. Bir slaydın referansını indeks üzerinden alın.  
1. `ChartType.Pie` tipinde, varsayılan verilerle bir grafik ekleyin.  
1. Grafik veri `IChartDataWorkbook` nesnesine erişin.  
1. Varsayılan serileri ve kategorileri temizleyin.  
1. Yeni seriler ve kategoriler ekleyin.  
1. Grafik serileri için yeni veri ekleyin.  
1. Pasta dilimlerine özel renkler ekleyerek yeni noktalar oluşturun.  
1. Seri etiketleri için etiketler ayarlayın.  
...
Çizgi grafikler (çizgi diyagramları olarak da bilinir) zaman içinde değer değişimini göstermek istediğiniz durumlar için en uygunudur. Çizgi grafiği kullanarak aynı anda çok fazla veriyi karşılaştırabilir, zaman içindeki değişim ve eğilimleri izleyebilir, veri serilerindeki olağandışılıkları vurgulayabilirsiniz. 

1. [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfının bir örneğini oluşturun.  
1. Bir slaydın referansını indeks üzerinden alın.  
1. `ChartType::Line` tipinde, varsayılan verilerle bir grafik ekleyin.  
1. Grafik veri `IChartDataWorkbook` nesnesine erişin.  
1. Varsayılan serileri ve kategorileri temizleyin.  
1. Yeni seriler ve kategoriler ekleyin.  
1. Grafik serileri için yeni veri ekleyin.  
...
Varsayılan olarak, çizgi grafiğindeki noktalar kesintisiz düz çizgilerle birleştirilir. Noktaların kesikli çizgilerle birleştirilmesini istiyorsanız, tercih ettiğiniz kesik çizgi tipini şu şekilde belirtebilirsiniz:
...
Ağaç haritası grafikler, satış verileri gibi veri kategorilerinin göreli boyutlarını göstermek ve aynı anda her kategoriye en çok katkıda bulunan öğelere hızlıca dikkat çekmek istediğinizde en uygunudur. 

1. [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfının bir örneğini oluşturun.  
1. Bir slaydın referansını indeks üzerinden alın.  
1. `ChartType.TreeMap` tipinde, varsayılan verilerle bir grafik ekleyin.  
1. Grafik veri `IChartDataWorkbook` nesnesine erişin.  
1. Varsayılan serileri ve kategorileri temizleyin.  
1. Yeni seriler ve kategoriler ekleyin.  
1. Grafik serileri için yeni veri ekleyin.  
...
1. [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfının bir örneğini oluşturun.  
1. Bir slaydın referansını indeks üzerinden alın.  
1. `ChartType.OpenHighLowClose` tipinde, varsayılan verilerle bir grafik ekleyin.  
1. Grafik veri `IChartDataWorkbook` nesnesine erişin.  
1. Varsayılan serileri ve kategorileri temizleyin.  
1. Yeni seriler ve kategoriler ekleyin.  
1. Grafik serileri için yeni veri ekleyin.  
...
### **Kutu ve Bıçak Grafikler Oluşturma**
1. [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfının bir örneğini oluşturun.  
1. Bir slaydın referansını indeks üzerinden alın.  
1. `ChartType.BoxAndWhisker` tipinde, varsayılan verilerle bir grafik ekleyin.  
1. Grafik veri `IChartDataWorkbook` nesnesine erişin.  
1. Varsayılan serileri ve kategorileri temizleyin.  
1. Yeni seriler ve kategoriler ekleyin.  
1. Grafik serileri için yeni veri ekleyin.  
...
Bu C++ kodu, bir kutu ve bıçak grafiği oluşturmayı gösterir:
...
1. [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfının bir örneğini oluşturun.  
1. Bir slaydın referansını indeks üzerinden alın.  
1. `ChartType.Funnel` tipinde, varsayılan verilerle bir grafik ekleyin.  
1. Değiştirilmiş sunumu bir PPTX dosyasına yazın.  
...
1. [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfının bir örneğini oluşturun.  
1. Bir slaydın referansını indeks üzerinden alın.  
1. `ChartType.sunburst` tipinde, varsayılan verilerle bir grafik ekleyin.  
1. Değiştirilmiş sunumu bir PPTX dosyasına yazın.  
...
1. [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfının bir örneğini oluşturun.  
1. Bir slaydın referansını indeks üzerinden alın.  
1. `ChartType.Histogram` tipinde, bazı veriyle bir grafik ekleyin.  
1. Grafik veri `IChartDataWorkbook` nesnesine erişin.  
1. Varsayılan serileri ve kategorileri temizleyin.  
1. Yeni seriler ve kategoriler ekleyin.  
1. Değiştirilmiş sunumu bir PPTX dosyasına yazın.  
...
1. [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfının bir örneğini oluşturun.  
1. Bir slaydın referansını indeks üzerinden alın.  
1. `ChartType.Radar` tipinde, bazı veriyle bir grafik ekleyin.  
1. Değiştirilmiş sunumu bir PPTX dosyasına yazın.  
...
1. [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfının bir örneğini oluşturun.  
1. Bir slaydın referansını indeks üzerinden alın.  
1. `ChartType.ClusteredColumn` tipinde, varsayılan verilerle bir grafik ekleyin.  
1. Grafik veri `IChartDataWorkbook` nesnesine erişin.  
1. Varsayılan serileri ve kategorileri temizleyin.  
1. Yeni seriler ve kategoriler ekleyin.  
1. Grafik serileri için yeni veri ekleyin.  
...
Harita grafiği, verileri içeren bir alanın görselleştirilmesidir. Harita grafikler, coğrafi bölgeler arasında veri veya değerleri karşılaştırmak için en uygunudur. 
...
Kombinasyon grafiği (veya combo grafiği), tek bir grafikte iki veya daha fazla grafik türünü birleştirir. Bu grafik, iki veya daha fazla veri kümesi arasındaki farklılıkları vurgulamanıza, karşılaştırmanıza veya incelemenize olanak tanır ve ilişkileri tanımlamanıza yardımcı olur.
...
1. Grafik içeren sunumu temsil eden bir [Presentation](https://reference.aspose.com/slides/tr/cpp/class/aspose.slides.presentation) sınıfı örneği oluşturun.  
2. Bir slaydın referansını indeks üzerinden alın.  
3. İstenilen grafiği bulmak için tüm şekiller arasında gezinin.  
...
Bu C++ kodu, bir grafik serisine otomatik olarak işaretçi eklemeyi gösterir:
...
Aspose.Slides, çubuk, çizgi, pasta, alan, dağılım, histogram, radar ve daha birçok grafik türünü destekler. Bu esneklik, veri görselleştirme ihtiyaçlarınıza en uygun grafik türünü seçmenize olanak tanır.

**Bir slayta yeni bir grafik nasıl eklenir?**

Grafik eklemek için önce bir [Presentation](https://reference.aspose.com/slides/tr/cpp/aspose.slides/presentation/) sınıfının bir örneğini oluşturur, istenen slaytı indeks üzerinden alır ve ardından grafik türü ve başlangıç verilerini belirterek grafik ekleme metodunu çağırırsınız. Bu işlem grafiği doğrudan sunumunuza entegre eder.

**Grafiğin gösterdiği veriler nasıl güncellenir?**

Grafiğin verilerini, veri çalışma kitabına ([IChartDataWorkbook](https://reference.aspose.com/slides/tr/cpp/aspose.slides.charts/ichartdataworkbook/)) erişerek, varsayılan serileri ve kategorileri temizleyip kendi özel verilerinizi ekleyerek güncelleyebilirsiniz. Böylece grafiği programlı olarak en son verilere göre yenilersiniz.

**Grafiğin görünümü özelleştirilebilir mi?**

Evet, Aspose.Slides kapsamlı özelleştirme seçenekleri sunar. Renkleri, yazı tiplerini, etiketleri, lejandları ve diğer biçimlendirme öğelerini ihtiyacınıza göre değiştirerek grafiğin görünümünü tasarım gereksinimlerinize uygun hale getirebilirsiniz.