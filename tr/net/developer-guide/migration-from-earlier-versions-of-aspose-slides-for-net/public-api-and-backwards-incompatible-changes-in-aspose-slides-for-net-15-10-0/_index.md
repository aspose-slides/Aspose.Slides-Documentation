---
title: Aspose.Slides for .NET 15.10.0'da Genel API ve Geriye Dönük Uyumsuz Değişiklikler
linktitle: Aspose.Slides for .NET 15.10.0
type: docs
weight: 200
url: /tr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/
keywords:
- göç
- eski kod
- modern kod
...
Bu sayfa, Aspose.Slides for .NET 15.10.0 API'siyle tanıtılan eklenen veya kaldırılan sınıfları, yöntemleri, özellikleri vb. ve diğer değişiklikleri listeler. [eklenen](/slides/tr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) veya [kaldırılan](/slides/tr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) sınıfları, yöntemleri, özellikleri ve benzeri öğeleri içerir.

{{% /alert %}} 
## **Genel API Değişiklikleri**
#### **HTML'ye Medya Dosyalarını Dışa Aktarmayı Desteklemek İçin Yeni VideoPlayerHtmlController Eklendi**
Yeni genel sınıf VideoPlayerHtmlController, Aspose.Slides.Export ad alanına eklendi. Bu sınıfın örneği kullanılarak kullanıcı video ve ses dosyalarını HTML'ye dışa aktarabilir.
...
``` 
#### **Grafik Seri Animasyonu API'si Eklendi**
Yeni iki yöntem Aspose.Slides.Animation.ISequence arayüzüne eklendi.
...
Bu yöntemler, grafiğin öğe animasyonlarını desteklemek için tasarlanmıştır:
seri bazında
kategori bazında
seri öğeleri bazında
kategori öğeleri bazında
