---
title: Aspose.Slides for .NET 15.10.0'da Genel API ve Geriye Uyumsuz Değişiklikler
...
---
{{% alert color="primary" %}} 
Bu sayfa, Aspose.Slides for .NET 15.10.0 API'si ile tanıtılan eklenen veya kaldırılan sınıfları, metodları, özellikleri vb. ve diğer değişiklikleri listeler. [added](/slides/tr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) veya [removed](/slides/tr/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) 
{{% /alert %}} 
## **Public API Changes**
#### **A New VideoPlayerHtmlController Added to Support Export Media Files to HTML**
Yeni genel sınıf VideoPlayerHtmlController, Aspose.Slides.Export ad alanına eklendi. Bu sınıfın bir örneği kullanılarak video ve ses dosyaları HTML olarak dışa aktarılabilir.  
...
Yeni 2 yöntem Aspose.Slides.Animation.ISequence arayüzüne eklendi.
...
Grafik öğelerinin animasyonuyla ilgili iki yeni enum olan EffectChartMajorGroupingType ve EffectChartMinorGroupingType tanıtıldı.

Grafiğe bir seri animasyonu eklemek için aşağıdaki kod kullanılabilir:
