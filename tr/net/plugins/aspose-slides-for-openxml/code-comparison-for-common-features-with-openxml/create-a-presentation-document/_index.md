---
title: Sunum belgesi oluşturma
type: docs
weight: 60
url: /tr/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // Belirli bir dosya yolunda bir sunum oluşturur. Sunum belgesi türü varsayılan olarak pptx'dir.
...

{
    ...
    using (Presentation pres = new Presentation())
    {
        ...
        //SlideExCollection sınıfını oluştur
        ISlideCollection slds = pres.Slides;

        //SlidesEx koleksiyonuna boş bir slayt ekle
