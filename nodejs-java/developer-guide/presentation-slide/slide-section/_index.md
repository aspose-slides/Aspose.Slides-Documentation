...
```javascript
    ...
    try {
        ...
        pres.save("pres-sections.pptx", com.aspose.slides.SaveFormat.Pptx);
        pres.getSections().reorderSectionWithSlides(section2, 0);
        pres.save("pres-sections-moved.pptx", com.aspose.slides.SaveFormat.Pptx);
        pres.getSections().removeSectionWithSlides(section2);
        pres.getSections().appendEmptySection("Last empty section");
        pres.save("pres-section-with-empty.pptx", com.aspose.slides.SaveFormat.Pptx);
    } finally {
        if (pres != null) {
            pres.dispose();
        }
