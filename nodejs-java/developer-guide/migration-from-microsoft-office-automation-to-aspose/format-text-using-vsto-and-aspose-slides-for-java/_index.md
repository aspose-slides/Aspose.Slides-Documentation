---
title: Format Text using VSTO and Aspose.Slides for Node.js via Java
type: docs
weight: 30
...
The screenshots below show the sample slide before and after the execution of the VSTO and Aspose.Slides for Node.js via Javascript code.
