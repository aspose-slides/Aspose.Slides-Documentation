...
type: docs
weight: 10
url: /nodejs-java/create-a-new-presentation/
---
...
Aspose.Slides for Node.js via Java is a component that can be used to manipulate Microsoft PowerPoint presentations, just like VSTO, but it has several advantages:
