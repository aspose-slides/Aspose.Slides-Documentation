...
type: docs
weight: 110
url: /nodejs-java/re-sizing-shapes-on-slide/
---

## **Re-sizing Shapes on Slide**
One of the most frequent questions asked by the Aspose.Slides for Node.js via Java customers is how to re-size shapes so that when Slide size is changed the data does not cut off. This short technical tip shows how to achieve that.
