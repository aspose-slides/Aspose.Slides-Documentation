...
```javascript
    ...
    try {
        ...
        sld.getShapes().addAutoShape(com.aspose.slides.ShapeType.Line, 50, 150, 300, 0);
        // Write the PPTX to Disk
        pres.save("LineShape.pptx", com.aspose.slides.SaveFormat.Pptx);
    } finally {
        if (pres != null) {
            pres.dispose();
        }
...
```javascript
    ...
    try {
        ...
        var sld = pres.getSlides().get_Item(0);
        // Add an AutoShape of type line
        var shp = sld.getShapes().addAutoShape(com.aspose.slides.ShapeType.Line, 50, 150, 300, 0);
        // Apply some formatting on the line
        shp.getLineFormat().setStyle(com.aspose.slides.LineStyle.ThickBetweenThin);
        shp.getLineFormat().setWidth(10);
        shp.getLineFormat().setDashStyle(com.aspose.slides.LineDashStyle.DashDot);
        shp.getLineFormat().setBeginArrowheadLength(com.aspose.slides.LineArrowheadLength.Short);
        shp.getLineFormat().setBeginArrowheadStyle(com.aspose.slides.LineArrowheadStyle.Oval);
        shp.getLineFormat().setEndArrowheadLength(com.aspose.slides.LineArrowheadLength.Long);
        shp.getLineFormat().setEndArrowheadStyle(com.aspose.slides.LineArrowheadStyle.Triangle);
        shp.getLineFormat().getFillFormat().setFillType(com.aspose.slides.FillType.Solid);
        shp.getLineFormat().getFillFormat().getSolidFillColor().setColor(java.newInstanceSync("java.awt.Color", com.aspose.slides.PresetColor.Maroon));
        // Write the PPTX to Disk
        pres.save("LineShape.pptx", com.aspose.slides.SaveFormat.Pptx);
    } finally {
        if (pres != null) {
