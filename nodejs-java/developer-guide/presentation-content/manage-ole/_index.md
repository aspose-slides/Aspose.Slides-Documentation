...
[Aspose.Slides for Java](https://products.aspose.com/slides/java/) allows you to insert OLE Objects into slides as OLE Object Frames ([OleObjectFrame](https://reference.aspose.com/slides/nodejs-java/aspose.slides/OleObjectFrame)).
        ...
        if (ole != null) {
            ...
            try {
                ...
                try {
                    ...
                    var so1 = java.newInstanceSync("OoxmlSaveOptions", java.getStaticFieldValue("aspose.cells.SaveFormat", "XLSX"));
                    Wb.save(msout, so1);
