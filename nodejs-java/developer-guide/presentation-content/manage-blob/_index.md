...
With methods from the [**IImageCollection**](https://reference.aspose.com/slides/nodejs-java/aspose.slides/ImageCollection) interface and [**ImageCollection** ](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mageCollection) class, you can add a large image as a stream to get it treated as a BLOB.
