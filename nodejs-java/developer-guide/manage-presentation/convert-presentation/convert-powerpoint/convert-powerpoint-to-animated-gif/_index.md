...
```javascript
    ...
    try {
        pres.save("pres.gif", com.aspose.slides.SaveFormat.Gif);
    } finally {
        if (pres != null) {
            pres.dispose();
        }
...
If you prefer to customize the parameters for the GIF, you can use the [GifOptions](https://reference.aspose.com/slides/java/com.aspose.slides/GifOptions) class. See the sample code below. 
...
```javascript
    var pres = new  com.aspose.slides.Presentation("pres.pptx");
    try {
        var gifOptions = new  com.aspose.slides.GifOptions();
        ...
        pres.save("pres.gif", com.aspose.slides.SaveFormat.Gif, gifOptions);
    } finally {
        if (pres != null) {
            pres.dispose();
        }
