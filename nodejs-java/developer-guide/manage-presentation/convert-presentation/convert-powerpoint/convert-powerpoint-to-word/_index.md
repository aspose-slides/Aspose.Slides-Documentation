...
As a standalone API, [Aspose.Slides](https://products.aspose.app/slides) for Javascript provides functions that allow you to extract texts from presentations. 
