...
To convert a PowerPoint file (PPTX or PPT) to Word (DOCX or DOCX), you need both [Aspose.Slides for Node.js via Java](https://products.aspose.com/slides/java/) and [Aspose.Words for Java](https://products.aspose.com/words/java/).
