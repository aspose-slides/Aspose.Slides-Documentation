...
2. Get the slide object from the [Presentation.getSlides()](https://reference.aspose.com/slides/nodejs-java/aspose.slides/Presentation#getSlides--) collection under the [Slide](https://reference.aspose.com/slides/nodejs-java/aspose.slides/ISlide) interface.
3. Use a [Slide.getImage()](https://reference.aspose.com/slides/nodejs-java/aspose.slides/ISlide) method to get the thumbnail for each slide.
