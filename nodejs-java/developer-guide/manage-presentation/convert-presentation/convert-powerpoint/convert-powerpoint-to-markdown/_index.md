...
```javascript
    ...
    try {
        pres.save("pres.md", com.aspose.slides.SaveFormat.Md);
    } finally {
        if (pres != null) {
            pres.dispose();
        }
...
```javascript
    var pres = new  com.aspose.slides.Presentation("pres.pptx");
    try {
        var markdownSaveOptions = new  com.aspose.slides.MarkdownSaveOptions();
        markdownSaveOptions.setFlavor(com.aspose.slides.Flavor.CommonMark);
        pres.save("pres.md", com.aspose.slides.SaveFormat.Md, markdownSaveOptions);
    } finally {
        if (pres != null) {
            pres.dispose();
        }
...
```javascript
    ...
    try {
        ...
        markdownSaveOptions.setFlavor(com.aspose.slides.Flavor.Github);
        markdownSaveOptions.setExportType(com.aspose.slides.MarkdownExportType.Sequential);
        markdownSaveOptions.setNewLineType(com.aspose.slides.NewLineType.Windows);
        pres.save("doc.md", new int[]{ 1, 2, 3, 4, 5, 6, 7, 8, 9 }, com.aspose.slides.SaveFormat.Md, markdownSaveOptions);
    } finally {
        if (pres != null) {
            pres.dispose();
        }
...
```javascript
    ...
    try {
        ...
        var markdownSaveOptions = new  com.aspose.slides.MarkdownSaveOptions();
        markdownSaveOptions.setExportType(com.aspose.slides.MarkdownExportType.Visual);
