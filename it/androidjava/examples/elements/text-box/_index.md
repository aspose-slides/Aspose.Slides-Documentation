...
type: docs
weight: 40
url: /it/androidjava/examples/elements/text-box/
keywords:
- esempio di codice
- casella di testo
- PowerPoint
...
- Java
- Aspose.Slides
description: "Lavora con le caselle di testo in Aspose.Slides per Android: aggiungi, formatta, allinea, avvolgi, adatta automaticamente e stila il testo usando Java per presentazioni PPT, PPTX e ODP."
---
...
public static void addTextBox() {
    ...
    try {
        ...
        // Crea una forma rettangolare (predefinita con riempimento, bordo e nessun testo).
...
Questo esempio trova e elimina tutte le caselle di testo nella prima diapositiva che contengono una parola chiave specifica:
