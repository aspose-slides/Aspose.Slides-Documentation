...
type: docs
weight: 140
url: /it/androidjava/examples/elements/smart-art/
keywords:
- esempio di codice
- SmartArt
- PowerPoint
...
- Java
- Aspose.Slides
description: "Lavora con SmartArt in Aspose.Slides per Android: crea, modifica, converti e personalizza diagrammi con Java per presentazioni PowerPoint e OpenDocument."
---
Questo articolo dimostra come aggiungere grafiche SmartArt, accedervi, rimuoverle e modificare i layout utilizzando **Aspose.Slides for Android via Java**.
...
Recupera il primo oggetto SmartArt in una diapositiva.
