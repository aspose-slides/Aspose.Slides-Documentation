...
- Java
- Aspose.Slides
description: "Converti le presentazioni in dispense in Java. Imposta le diapositive per pagina, mantieni le note, esporta in PDF o immagini con Aspose.Slides per Android, con codice di esempio. Provalo gratuitamente."
---
## **Introduzione**
...
Aspose.Slides supporta i [presets](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/handouttype/) fino a 9 miniature per pagina con ordine orizzontale o verticale: 1, 2, 3, 4 (orizzontale/verticale), 6 (orizzontale/verticale) e 9 (orizzontale/verticale).

**Posso definire una griglia personalizzata, ad esempio 5 o 8 diapositive per pagina?**

No. Il numero e l'ordine delle miniature sono controllati rigidamente dalla classe [HandoutType](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/handouttype/); i layout arbitrari non sono supportati.
