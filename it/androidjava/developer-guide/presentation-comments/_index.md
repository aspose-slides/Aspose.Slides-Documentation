---
title: Gestisci i commenti della presentazione su Android
linktitle: Commenti alla presentazione
type: docs
weight: 100
...
- Java
- Aspose.Slides
description: "Gestisci i commenti della presentazione con Aspose.Slides per Android tramite Java: aggiungi, leggi, modifica, rispondi e rimuovi i commenti nelle presentazioni PowerPoint in modo rapido e semplice."
---
## **Panoramica**

Questo articolo spiega come gestire i commenti della presentazione con Aspose.Slides per Android tramite Java. Introduce i principali tipi relativi ai commenti e dimostra come aggiungere commenti alle diapositive, accedere ai commenti esistenti, lavorare con le risposte e i commenti moderni, e rimuovere i commenti da una presentazione.

Gli esempi coprono scenari comuni di revisione e collaborazione in PowerPoint, come assegnare commenti agli autori, leggere il testo dei commenti e i metadati, costruire catene di risposte e rimuovere commenti selezionati o tutti i commenti.
...
Per richiedere che i commenti vengano mostrati o nascosti quando una presentazione si apre senza modificare i commenti stessi, vedere [Mostra o nascondi i commenti all'apertura di una presentazione](/slides/it/androidjava/presentation-view-properties/).
...
* L'interfaccia [IComment](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/icomment/) che fornisce informazioni su un commento, includendo autore, data di creazione, posizione e testo.
* La classe [CommentAuthor](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/commentauthor/) che fornisce informazioni su un autore, includendo nome, iniziali e commenti associati.
...
* Quando il metodo [IComment.remove](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/icomment/#remove--) viene usato per eliminare un commento, tutte le risposte a quel commento vengono eliminate.
* Se [IComment.setParentComment](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/icomment/#setParentComment-com.aspose.slides.IComment-) crea una referenza circolare, viene sollevata un'eccezione [PptxEditException](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/pptxeditexception/).
{{% /alert %}}
