...
Gli effetti WordArt ti consentono di aggiungere testo stilizzato e visivamente accattivante alle presentazioni PowerPoint. Con Aspose.Slides, gli sviluppatori possono creare, personalizzare e gestire WordArt in modo programmatico proprio come in Microsoft PowerPoint—senza necessità di installare Office. Questo articolo fornisce una panoramica sul lavoro con WordArt, includendo come applicare trasformazioni di testo, stili di riempimento, contorni, ombre e altre opzioni di formattazione per rendere il contenuto della presentazione più espressivo e coinvolgente. WordArt ti permette di trattare il testo come un oggetto grafico. Consiste in effetti o modifiche speciali applicate al testo per renderlo più attraente o evidente.

## **Crea un modello WordArt semplice e applicalo al testo**

**Utilizzando Aspose.Slides** 

Per prima cosa creiamo un semplice testo usando questo codice Java: 
...
Qui applichiamo il colore di pattern [SmallGrid](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/PatternStyle#SmallGrid) al testo e aggiungiamo un contorno nero di larghezza 1 al testo usando questo codice:
...
Ad esempio, gli effetti Ombra, Riflessione e Bagliore possono essere applicati a un testo; gli effetti Formato 3D e Rotazione 3D possono essere applicati a un blocco di testo; la proprietà Bordi morbidi può essere applicata a un oggetto Forma (ha comunque effetto quando la proprietà Formato 3D non è impostata). 
...
In PowerPoint puoi usare un unico tipo di ombra. Ecco un esempio:
...
### **Applica effetti di Riflessione al testo**

Aggiungiamo la visualizzazione al testo tramite questo esempio di codice Java:
...
### **Applica effetti di Bagliore al testo**

Applichiamo l’effetto di bagliore al testo per farlo brillare o risaltare usando questo codice:
...
Puoi modificare i parametri per ombra, visualizzazione e bagliore. Le proprietà degli effetti vengono impostate separatamente per ciascuna porzione del testo. 

{{% /alert %}} 

### **Usa trasformazioni in WordArt**

Utilizziamo la proprietà Transform (ereditaria dell’intero blocco di testo) tramite questo codice:
``` java 
import com.aspose.slides.*;
...
Sia Microsoft PowerPoint sia Aspose.Slides per Android via Java forniscono un certo numero di tipi di trasformazione predefiniti.
...
2. Ottieni il riferimento di una slide usando il suo indice.  
3. Aggiungi un AutoShape di tipo Rettangolo alla slide.  
...
10. Imposta RectangleAlign su TopLeft.  
11. Imposta PresetColor dell’ombra su Black.  
12. Scrivi la presentazione come file [PPTX](https://docs.fileformat.com/presentation/pptx/).  
...
Presentation pres = new Presentation();
try {
    // Ottieni il riferimento della slide
...
1. Crea un’istanza della classe [Presentation](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/presentation).  
2. Ottieni il riferimento della slide.  
...
8. Scrivi la presentazione come file [PPTX](https://docs.fileformat.com/presentation/pptx/).  

Questo codice di esempio (basato sui passaggi sopra) mostra come applicare l’effetto Ombra Interna a un testo in Java:
...
### Posso applicare gli effetti WordArt agli elementi del master della slide?

Sì, è possibile applicare effetti WordArt a forme nei master slide, inclusi segnaposto titolo, piè di pagina o testo di sfondo. Le modifiche apportate al layout master verranno propagate a tutte le slide associate.
