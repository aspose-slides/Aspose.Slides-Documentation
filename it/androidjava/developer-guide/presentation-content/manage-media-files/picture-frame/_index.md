---
title: Gestire i fotogrammi nelle presentazioni su Android
...
- Java
- Aspose.Slides
description: "Aggiungi fotogrammi alle presentazioni PowerPoint e OpenDocument con Aspose.Slides per Android via Java. Semplifica il tuo flusso di lavoro e migliora il design delle diapositive."
---
## **Introduzione**
...
Aspose fornisce convertitori gratuiti—[JPEG to PowerPoint](https://products.aspose.app/slides/it/import/jpg-to-ppt) e [PNG to PowerPoint](https://products.aspose.app/slides/it/import/png-to-ppt)—che consentono di creare rapidamente presentazioni dalle immagini. 
...
try {
    ...
    // Aggiunge un fotogramma con l'altezza e la larghezza equivalenti dell'immagine
...
Alterando la scala relativa di un'immagine, è possibile creare un fotogramma più complesso. 
...
try {
    ...
    // Aggiungi un fotogramma con altezza e larghezza equivalenti dell'immagine
    IPictureFrame pf = sld.getShapes().addPictureFrame(ShapeType.Rectangle, 50, 150, imgx.getWidth(), imgx.getHeight(), imgx);
    
    // Imposta la scala relativa di larghezza e altezza
...
## **Estrarre immagini raster da fotogrammi**
...
## **Estrarre immagini SVG da fotogrammi**

Quando una presentazione contiene grafica SVG inserita in forme [PictureFrame](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/pictureframe/), Aspose.Slides per Android via Java consente di recuperare le immagini vettoriali originali con piena fedeltà. Una volta che si dispone di un [PictureFrame](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/pictureframe/) il cui [IPPImage](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/ippimage/) contiene contenuto SVG, è possibile leggere quell'immagine SVG e salvarla su disco o su uno stream nel suo formato nativo SVG.
...
Aspose.Slides consente di ottenere gli effetti di luminosità e contrasto applicati a un'immagine. L'interfaccia [ILuminance](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/iluminance/) rappresenta questo effetto di trasformazione dell'immagine.
...
Aspose.Slides offre molte opzioni di formattazione che possono essere applicate a un fotogramma. Utilizzando queste opzioni, è possibile modificare un fotogramma per soddisfare requisiti specifici.
...
8. Imposta la larghezza della linea del fotogramma.
9. Ruota il fotogramma assegnandogli un valore positivo o negativo.
...
Aspose ha recentemente sviluppato un [Collage Maker gratuito](https://products.aspose.app/slides/it/collage). Se devi mai [unire immagini JPG/JPEG](https://products.aspose.app/slides/it/collage/jpg) o PNG, o [creare griglie da foto](https://products.aspose.app/slides/it/collage/photo-grid), puoi usare questo servizio. 

{{% /alert %}}

## **Aggiungere un'immagine come collegamento**

Per evitare dimensioni eccessive della presentazione, puoi aggiungere immagini (o video) tramite collegamenti invece di incorporare i file direttamente nella presentazione. Questo codice Java mostra come aggiungere un'immagine e un video in un segnaposto:
...
7. Aggiungi l'immagine di riempimento alla forma.
8. Specifica gli spostamenti dell'immagine rispetto al corrispondente bordo della bounding box della forma.
