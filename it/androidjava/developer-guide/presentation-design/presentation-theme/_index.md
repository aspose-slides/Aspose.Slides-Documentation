---
title: Gestisci i temi di presentazione su Android
...
- Java
- Aspose.Slides
description: "Gestisci i temi di presentazione in Aspose.Slides per Android tramite Java per creare, personalizzare e convertire file PowerPoint con un branding coerente."
---
## **Introduzione**

Un tema di presentazione definisce le proprietà degli elementi di design. Quando scegli un tema di presentazione, scegli essenzialmente un insieme specifico di elementi visivi e le loro proprietà.

In PowerPoint, un tema comprende colori, [font](/slides/it/androidjava/powerpoint-fonts/), [stili di sfondo](/slides/it/androidjava/presentation-background/), ed effetti.
...
Questo codice Java mostra come cambiare il colore di accento per un tema:
...
Per dimostrare ulteriormente l'operazione di cambio colore, creiamo un altro elemento e gli assegniamo il colore di accento (dall'operazione iniziale). Poi cambiamo il colore nel tema:
...
### **Imposta colore tema da una tavolozza aggiuntiva**

Quando applichi trasformazioni di luminanza al colore principale del tema(1), si formano i colori dalla tavolozza aggiuntiva(2). Puoi quindi impostare e recuperare quei colori del tema. 
...
Questo codice Java dimostra un'operazione in cui i colori della tavolozza aggiuntiva vengono ottenuti dal colore principale del tema e poi usati nelle forme:
...
Quando lavori con [SchemeColor](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/schemecolor/), potresti notare che contiene i seguenti valori di colore del tema:

`Background1`, `Background2`, `Text1`, and `Text2`.

Tuttavia, `Presentation.getMasterTheme().getColorScheme()` restituisce [IColorScheme](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/icolorscheme/), che espone i colori corrispondenti come:
...
Non esiste alcuna conversione dinamica tra `Text`/`Background` e `Dark`/`Light`. Sono semplicemente nomi alternativi per gli stessi colori del tema.
...
* **+mj-ea** - Font del corpo East Asian (Major East Asian Font)
...
Questo codice Java mostra come cambiare il font del tema della presentazione:
...
Potresti voler vedere [PowerPoint fonts](/slides/it/androidjava/powerpoint-fonts/).
{{% /alert %}}
...
{{% alert color="info" title="TIP" %}} 
Potresti voler vedere [PowerPoint Background](/slides/it/androidjava/presentation-background/).
{{% /alert %}}

## **Modifica effetto tema**
...
Utilizzando 3 proprietà ([FillStyles](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/FormatScheme#getFillStyles--), [LineStyles](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/FormatScheme#getLineStyles--), [EffectStyles](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/FormatScheme#getEffectStyles--)) dalla classe [FormatScheme](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/FormatScheme) puoi modificare gli elementi in un tema (in modo ancora più flessibile rispetto alle opzioni di PowerPoint).
...
Sì. Aspose.Slides supporta le sovrascritture del tema a livello di diapositiva, così puoi applicare un tema locale solo a quella diapositiva mantenendo intatto il tema master (tramite il [SlideThemeManager](https://reference.aspose.com/slides/it/androidjava/com.aspose.slides/slidethememanager/)).

### Qual è il modo più sicuro per trasferire un tema da una presentazione all'altra?

[Clona diapositive](/slides/it/androidjava/clone-slides/) insieme al loro master nella presentazione di destinazione. Questo preserva il master originale, i layout e il tema associato, così l'aspetto rimane coerente.

### Come posso vedere i valori "effettivi" dopo tutta l'ereditarietà e le sovrascritture?

Usa le ["visualizzazioni effettive"](/slides/it/androidjava/shape-effective-properties/) dell'API per tema/colore/font/effetto. Queste restituiscono le proprietà risolte e finali dopo aver applicato il master più eventuali sovrascritture locali.