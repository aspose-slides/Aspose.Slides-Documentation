---
title: API pubbliche e modifiche incompatibili retroattive in Aspose.Slides per .NET 15.10.0
linktitle: Aspose.Slides per .NET 15.10.0
type: docs
weight: 200
url: /it/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/
keywords:
- migrazione
- codice legacy
- codice moderno
...
---
{{% alert color="primary" %}} 
Questa pagina elenca tutte le classi, i metodi, le proprietà e così via [aggiunte](/slides/it/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) o [rimosse](/slides/it/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/), e altre modifiche introdotte con l'API Aspose.Slides per .NET 15.10.0.
{{% /alert %}} 
## **Modifiche API pubbliche**
#### **Aggiunto un nuovo VideoPlayerHtmlController per supportare l'esportazione di file multimediali in HTML**
La nuova classe pubblica VideoPlayerHtmlController è stata aggiunta allo spazio dei nomi Aspose.Slides.Export. Utilizzando un'istanza di questa classe, l'utente può esportare file video e audio in HTML.
Il costruttore VideoPlayerHtmlController accetta i seguenti parametri:

path: Il percorso in cui verranno generati i file video e audio  
fileName: Il nome del file HTML  

baseUri: L'URI di base che verrà utilizzato per generare i collegamenti  
Esempio d'uso:
...
``` 
#### **L'API di animazione delle serie di grafico è stata aggiunta**
I nuovi 2 metodi sono stati aggiunti all'interfaccia Aspose.Slides.Animation.ISequence.
...
per elementi di categoria

Sono stati introdotti i due nuovi enum EffectChartMajorGroupingType ed EffectChartMinorGroupingType relativi all'animazione degli elementi del grafico.

Per aggiungere un'animazione di serie al grafico, è possibile utilizzare il seguente codice:
...
Animazione degli elementi di categoria:
