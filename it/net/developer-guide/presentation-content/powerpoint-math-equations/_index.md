...
PowerPoint memorizza le equazioni come Office Math Markup Language (OMML). Con Aspose.Slides per .NET, è possibile creare lo stesso tipo di contenuto matematico in modo programmatico: frazioni, radici, funzioni, limiti, operatori N-ari, matrici, array e blocchi matematici formattati.
...
La maggior parte degli esempi seguenti utilizza [MathematicalText](https://reference.aspose.com/slides/it/net/aspose.slides.mathtext/mathematicaltext/) e i metodi fluenti di [IMathElement](https://reference.aspose.com/slides/it/net/aspose.slides.mathtext/imathelement/) per mantenere il codice breve e leggibile.
...
![Un'espressione radice n-esima con x sotto il segno radice](powerpoint-math-equations_5.png)
...
Gli operatori N-ari sono per grandi operatori con limiti opzionali. Operatori semplici come `+`, `-` e `=` sono solitamente aggiunti come `MathematicalText` e uniti all'espressione.
...
Usa [MathMatrix](https://reference.aspose.com/slides/it/net/aspose.slides.mathtext/mathmatrix/) per righe e colonne. Le matrici non includono parentesi di default, quindi racchiudi la matrice quando ti servono parentesi tonde, quadre o graffe.
...
Usa gli helper per pedici e apici per indici e potenze. Quando gli indici devono comparire sul lato sinistro della base, usa `SetSubSuperscriptOnTheLeft`.
...
Usa `ToBorderBox` quando l'equazione stessa deve essere racchiusa in una cornice.
...
## **Formato elementi matematici**

Usa gli helper di formattazione solo dove chiariscono la formula. Ad esempio, `Overbar` posiziona una barra sopra un elemento matematico.
...
| Aggiungi radici | [IMathElement.Radical](https://reference.aspose.com/slides/it/net/aspose.slides.mathtext/imathelement/radical/) |
