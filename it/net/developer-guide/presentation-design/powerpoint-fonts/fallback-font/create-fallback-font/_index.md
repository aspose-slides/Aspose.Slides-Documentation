---
title: Specificare i font di riserva per le presentazioni in .NET
...
- C#
- Aspose.Slides
description: "Gestisci Aspose.Slides per .NET per impostare i font di riserva nei file PPT, PPTX e ODP, garantendo una visualizzazione coerente del testo su qualsiasi dispositivo o sistema operativo."
---
## **Panoramica**
...
È anche possibile [Remove()](https://reference.aspose.com/slides/it/net/aspose.slides/ifontfallbackrule/methods/remove) il carattere di riserva o [AddFallBackFonts()](https://reference.aspose.com/slides/it/net/aspose.slides/fontfallbackrule/methods/addfallbackfonts) in un oggetto [FontFallBackRule] esistente.
...
- [Crea raccolta di caratteri di riserva](/slides/it/net/create-fallback-fonts-collection/)
{{% /alert %}}
...
Un carattere di riserva viene utilizzato solo per i caratteri mancanti nel carattere principale. La [sostituzione del carattere](/slides/it/net/font-substitution/) sostituisce l'intero carattere specificato con un altro carattere. L'[incorporamento del carattere](/slides/it/net/embedded-font/) incapsula i caratteri all'interno del file di output in modo che i destinatari possano visualizzare il testo come previsto.
...
No. Le regole di riserva sono impostazioni di rendering in fase di esecuzione nel tuo codice; non sono memorizzate all'interno del .pptx e non appariranno in PowerPoint.

### Il sistema operativo (Windows/Linux/macOS) e l'insieme delle cartelle dei caratteri influiscono sulla selezione del carattere di riserva?

Sì. Il motore risolve i caratteri dalle cartelle di sistema disponibili e da eventuali [percorsi aggiuntivi](/slides/it/net/custom-font/) forniti. Se un carattere non è fisicamente disponibile, una regola che lo riferisce non può avere effetto.

### La riserva funziona per WordArt, SmartArt e i grafici?
