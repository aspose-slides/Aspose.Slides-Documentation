...
- C#
- Aspose.Slides
description: "Crea app mobili Xamarin in C# per visualizzare, modificare e convertire presentazioni con Aspose.Slides, supportando funzionalità avanzate per PPT, PPTX e ODP su Android."
---
## **Introduzione**
...
L'API Aspose.Slides funziona sulla piattaforma Xamarin. Per ottenere ciò, il pacchetto Aspose.Slides .NET aggiunge una DLL separata per Xamarin. Aspose.Slides per Xamarin supporta la maggior parte delle funzionalità disponibili nella versione .NET:

- conversione e visualizzazione di presentazioni.
- modifica del contenuto nelle presentazioni: testo, forme, grafici, SmartArt, audio/video, caratteri, ecc.
- gestione/trattamento di animazioni, effetti 2D, WordArt, ecc.
- gestione/trattamento di metadati e proprietà del documento.
- stampa, clonazione, fusione, confronto, divisione, ecc.
...
## **Esempio rapido**
È possibile utilizzare Aspose.Slides per Xamarin per creare e utilizzare la propria applicazione C# tramite Slides per Android.

Stiamo fornendo un esempio di applicazione Android tramite Xamarin che utilizza Aspose.Slides per visualizzare le diapositive di presentazione e aggiunge una nuova forma sulla diapositiva al tocco. È possibile trovare il codice sorgente completo degli esempi su [GitHub](https://github.com/aspose-slides/Aspose.Slides-for-.NET/tree/master/Xamarin).

Iniziamo creando un'app Android Xamarin:

![todo:image_alt_text](https://lh3.googleusercontent.com/sNkKZnuuGo8phWI-4g4jRA_ZESKpO9RXehPj46RVymXGPcCJuYooePXcBEcb7N6uUUxgocl4o9OjwnajzWKmL2i4MUz3gKKwXw6C0ow_VScN8vlyGBK3SpLKoE_m9BDJ3iNE4xPj)

Per prima cosa, creiamo un layout di contenuto che conterrà una vista immagine, i pulsanti Prev e Next:
...
Qui, facciamo riferimento alla libreria "Aspose.Slides.Droid.dll" che contiene una presentazione di esempio ("HelloWorld.pptx") negli Asset dell'applicazione Xamarin e ne aggiungiamo l'inizializzazione a MainActivity:
...
**C# - MainActivity.cs - Visualizzare le diapositive al clic dei pulsanti Prev e Next**
``` csharp
using System.Diagnostics;
using Aspose.Slides.Theme;
...
Infine, implementiamo una funzione per aggiungere una forma ellissoide al tocco della diapositiva:
...
|**FUNZIONALITÀ** |**Aspose.Slides for .NET**  |**Aspose.Slides for Xamarin**|
| :- | :- | :- |
...
|Interruzione di operazioni a lunga esecuzione |{{< emoticons/tick >}}|{{< emoticons/tick >}} |
...
|**Funzionalità di diapositive master:** | | |
...
|**Funzionalità di diapositive layout:** | | |
...
|**Funzionalità delle diapositive:** | | |
...
|**Funzionalità delle diapositive note**: | | |
...
|**Funzionalità dei gruppi di forme:** | | |
...
|**Funzionalità effetti delle forme:** | | |
