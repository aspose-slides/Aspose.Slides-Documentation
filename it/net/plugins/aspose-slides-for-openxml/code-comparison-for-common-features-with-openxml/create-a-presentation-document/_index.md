---
title: Crea un documento di presentazione
type: docs
weight: 60
url: /it/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // Crea una presentazione in un percorso file specificato. Il tipo di documento della presentazione è pptx, per impostazione predefinita.
...

{
    ...
    using (Presentation pres = new Presentation())
    {
        ...
        //Istanzia la classe SlideExCollection
        ISlideCollection slds = pres.Slides;
        //Aggiungi una slide vuota alla collezione SlidesEx
