---
title: Elimina tutti i commenti di un autore
type: docs
weight: 70
url: /it/net/delete-all-the-comments-by-an-author/
---
## **OpenXML SDK**
``` csharp
...
// Rimuove tutti i commenti nelle diapositive di un certo autore.
...

{
    ...
    // Ottieni l'autore del commento specificato.
    ...
    // Itera su tutti gli autori corrispondenti.
...

    {
        ...
        // Itera su tutte le diapositive e ottieni le parti della diapositiva.
...

        {
...

            {
...

                {
                    ...
                    // Elimina tutti i commenti dell'autore specificato.

                    slideCommentsPart.CommentList.RemoveChild<Comment>(comm);

                }

                // Se il commentPart non ha commenti esistenti.
        ...
        // Elimina l'autore del commento dalla parte degli autori dei commenti.
...

{
    ...
    //Instanzia un oggetto PresentationEx che rappresenta un file PPTX.
