---
title: Genera diapositiva come miniatura JPEG con valori definiti dall'utente
type: docs
weight: 70
...
1. Ottenere l'immagine della miniatura della diapositiva di riferimento su una scala specificata.
1. Salvare l'immagine della miniatura in qualsiasi formato immagine desiderato.
...
using (Presentation pres = new Presentation(srcFileName))
{
    ...
    //Creare un'immagine a scala piena
