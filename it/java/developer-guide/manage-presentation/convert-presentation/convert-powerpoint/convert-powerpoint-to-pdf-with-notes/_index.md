...
- Java
- Aspose.Slides
description: "Converti i formati PPT e PPTX in PDF con note utilizzando Aspose.Slides per Java. Conserva i layout e le note del relatore per presentazioni professionali."
---
## **Panoramica**

In questo articolo imparerai come convertire le presentazioni PowerPoint in formato PDF con note del relatore utilizzando Aspose.Slides. Questa guida coprirà i passaggi necessari e fornirà esempi di codice per aiutarti a svolgere l'operazione in modo efficiente. Alla fine dell'articolo sarai in grado di:
...
- Personalizzare il PDF di output in modo che le note del relatore siano incluse e formattate secondo le tue esigenze.

Per impostare le dimensioni e l'orientamento della pagina delle note prima dell'esportazione, consulta [Dimensioni pagina note](/slides/it/java/notes-size/).
...
Potresti voler provare il [Convertitore online di PowerPoint in PDF](https://products.aspose.app/slides/it/conversion) di Aspose.
{{% /alert %}}