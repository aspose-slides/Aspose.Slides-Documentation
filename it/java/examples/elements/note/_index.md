...
type: docs
weight: 240
url: /it/java/examples/elements/note/
keywords:
- esempio di codice
- nota
- PowerPoint
...
- Java
- Aspose.Slides
description: "Lavora con le note delle diapositive in Aspose.Slides per Java: aggiungi, leggi, modifica ed esporta le note del relatore in PPT, PPTX e ODP usando chiari esempi Java."
---
Questo articolo dimostra come aggiungere, leggere, rimuovere e aggiornare le diapositive delle note utilizzando **Aspose.Slides for Java**.

## **Aggiungi una diapositiva di note**

Crea una diapositiva di note e assegna ad essa del testo.
