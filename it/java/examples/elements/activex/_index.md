...
type: docs
weight: 200
url: /it/java/examples/elements/activex/
keywords:
- esempio di codice
- ActiveX
- PowerPoint
...
- Java
- Aspose.Slides
description: "Vedi gli esempi ActiveX di Aspose.Slides for Java: inserisci, configura e controlla gli oggetti ActiveX in presentazioni PPT e PPTX con codice Java chiaro."
---
Questo articolo dimostra come aggiungere, accedere, rimuovere e configurare i controlli ActiveX in una presentazione utilizzando **Aspose.Slides for Java**.

## **Aggiungere un controllo ActiveX**

Inserisci un nuovo controllo ActiveX e, opzionalmente, imposta le sue proprietà.
