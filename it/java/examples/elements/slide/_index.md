...
type: docs
weight: 10
url: /it/java/examples/elements/slide/
keywords:
- esempio di codice
- diapositiva
- PowerPoint
...
- Java
- Aspose.Slides
description: "Gestisci le diapositive in Aspose.Slides per Java: crea, clona, riordina, ridimensiona, imposta gli sfondi e applica le transizioni con Java per presentazioni PPT, PPTX e ODP."
---
Questo articolo fornisce una serie di esempi che dimostrano come lavorare con le diapositive utilizzando **Aspose.Slides for Java**. Imparerai come aggiungere, accedere, clonare, riordinare e rimuovere le diapositive utilizzando la classe `Presentation`.

Ogni esempio di seguito include una breve spiegazione seguita da uno snippet di codice in Java.

## **Aggiungere una diapositiva**

Per aggiungere una nuova diapositiva, è necessario prima selezionare un layout. In questo esempio, utilizziamo il layout `Blank` e aggiungiamo una diapositiva vuota alla presentazione.
...
È possibile accedere alle diapositive usando il loro indice, o trovare l'indice di una diapositiva basandosi su un riferimento. Questo è utile per iterare o modificare diapositive specifiche.
...
È possibile modificare l'ordine delle diapositive spostandone una in un nuovo indice. In questo caso, spostiamo una diapositiva clonata nella prima posizione.
...
Per rimuovere una diapositiva, basta fare riferimento ad essa e chiamare `remove`. Questo esempio aggiunge una seconda diapositiva e poi rimuove quella originale, lasciando solo quella nuova.
