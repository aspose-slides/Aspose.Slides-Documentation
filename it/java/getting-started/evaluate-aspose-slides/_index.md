...
- Java
- Aspose.Slides
description: "Valuta Aspose.Slides per Java ed esplora le funzionalità dell'API per presentazioni PowerPoint (PPT, PPTX) e OpenDocument (ODP) — avvia la tua prova gratuita."
---
## **Valutazione di Aspose.Slides**

Puoi scaricare facilmente Aspose.Slides per la valutazione. Il download di valutazione è identico a quello acquistato. La versione di valutazione diventa semplicemente licenziata quando aggiungi alcune righe di codice per applicare la licenza.

La versione di valutazione di Aspose.Slides (senza una licenza specificata) fornisce tutte le funzionalità del prodotto, ma inserisce una filigrana di valutazione nella parte superiore del documento all'apertura e al salvataggio, e limita a una diapositiva l'estrazione del testo dalle diapositive della presentazione.
...
Sì. Puoi elaborare diversi documenti in parallelo; non dovresti condividere lo stesso oggetto presentazione [tra thread](/slides/it/java/multithreading/). La modalità valutazione non influisce su questo.
...
### Posso utilizzare una licenza temporanea per i test di carico senza una filigrana?
