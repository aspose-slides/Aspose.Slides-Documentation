...
type: docs
weight: 230
url: /it/python-java/examples/elements/comment/
keywords:
- commento
- commento moderno
- aggiungere commento
...
- Java
- Aspose.Slides
description: "Gestisci i commenti moderni delle diapositive in Aspose.Slides per Python via Java: aggiungi, leggi, rimuovi e rispondi ai commenti in presentazioni PowerPoint e OpenDocument."
---
Questo articolo dimostra come aggiungere, leggere, rimuovere e rispondere ai commenti moderni utilizzando **Aspose.Slides for Python via Java**.

Installa il pacchetto come descritto in [Installation](/slides/it/python-java/installation/). Ogni esempio importa `asposeslides` prima di avviare la JVM, quindi importa l'API e i tipi Java necessari dopo l'avvio della JVM. Gli esempi di accesso e rimozione utilizzano `modern_comment.pptx`, creato dal primo esempio.
