...
È possibile provare anche il [Online PowerPoint to PDF Converter](https://products.aspose.app/slides/it/conversion).
{{% /alert %}}

## **FAQ**

**Come posso evitare che le note del relatore lunghe vengano tagliate?**
...
**Posso tenere ogni diapositiva e le sue note su una sola pagina?**

Utilizzare [NotesPositions.BottomTruncated](https://reference.aspose.com/slides/it/python-java/aspose.slides/notespositions/#BottomTruncated). Questa impostazione limita le note a una pagina, quindi le note che non rientrano possono essere troncate.
