...
Questa tabella contiene i formati di file che Aspose.Slides per Python via Java può caricare e salvare:
...
|[XAML](https://docs.fileformat.com/web/xaml/)|Linguaggio di markup applicativo estensibile| |{{< emoticons/tick >}}||
