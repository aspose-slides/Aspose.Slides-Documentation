...
L'articolo risponde anche a domande comuni su conformità PDF, incorporamento dei font, file protetti da password, font personalizzati, fallback dei font e opzioni di esportazione XPS.
...
|[PNG](https://docs.fileformat.com/image/png/)|Grafica di rete portatile| |{{< emoticons/tick >}}||
...
|[HTML](https://docs.fileformat.com/web/html/)|Linguaggio di markup ipertestuale|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
|[XAML](https://docs.fileformat.com/web/xaml/)|Linguaggio di markup applicazione estensibile| |{{< emoticons/tick >}}||
...
Sì. Aspose.Slides supporta l'esportazione in PDF con livelli di conformità quali PDF/A-2a, PDF/A-2b, PDF/A-2u, PDF/A-3a, PDF/A-3b, così come PDF/UA tramite l'impostazione [compliance](https://reference.aspose.com/slides/it/cpp/aspose.slides.export/pdfoptions/set_compliance/) nelle [PDF export options](https://reference.aspose.com/slides/it/cpp/aspose.slides.export/pdfoptions/).

**La libreria supporta l'incorporamento dei font durante l'esportazione in PDF, con controllo fine su ciò che viene incorporato?**

Sì. È possibile controllare se i font sono completamente incorporati o sottogruppi (solo i glifi utilizzati), specificare come vengono trattati i font di sistema comuni e configurare il comportamento per il testo ASCII tramite le [PDF export options](https://reference.aspose.com/slides/it/cpp/aspose.slides.export/pdfoptions/).
...
**Esistono meccanismi di fallback dei font e supporto per i font personalizzati?**

Sì. La libreria supporta il [loading](/slides/it/cpp/custom-font/) e l'[embedding](/slides/it/cpp/embedded-font/) di font personalizzati e fornisce le [fallback rules](/slides/it/cpp/fallback-font/) per evitare glifi mancanti durante il rendering e la conversione.

**Posso esportare le diapositive in XPS e ci sono opzioni per regolare l'output XPS?**

Sì. L'[Export to XPS](/slides/it/cpp/convert-powerpoint-to-xps/) è supportato e è possibile regolare le relative [save options](https://reference.aspose.com/slides/it/cpp/aspose.slides.export/xpsoptions/) per controllare la qualità dell'output e il contenuto del documento XPS.