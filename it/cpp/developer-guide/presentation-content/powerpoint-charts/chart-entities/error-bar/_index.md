---
title: Personalizza le barre di errore nei grafici di presentazione usando C++
...
- C++
- Aspose.Slides
description: "Scopri come aggiungere e personalizzare le barre di errore nei grafici con Aspose.Slides per C++ — ottimizza la visualizzazione dei dati nelle presentazioni PowerPoint."
---
## **Panoramica**
...
2. Aggiungere un grafico a bolle nella diapositiva desiderata.
3. Accedere alla prima serie del grafico e impostare il formato della barra di errore X.
4. Accedere alla prima serie del grafico e impostare il formato della barra di errore Y.
5. Impostare i valori e il formato delle barre.
...
## **Aggiungere barre di errore personalizzate**
Aspose.Slides per C++ fornisce un'API semplice per gestire i valori delle barre di errore personalizzate. Il codice di esempio si applica quando la proprietà **IErrorBarsFormat.ValueType** è uguale a **Custom**. Per specificare un valore, utilizzare la proprietà **ErrorBarCustomValues** di un punto dati specifico nella raccolta **DataPoints** della serie:

1. Creare un'istanza della classe [Presentation](https://reference.aspose.com/slides/it/cpp/aspose.slides/presentation/) .
2. Aggiungere un grafico a bolle nella diapositiva desiderata.
3. Accedere alla prima serie del grafico e impostare il formato della barra di errore X.
4. Accedere alla prima serie del grafico e impostare il formato della barra di errore Y.
5. Accedere ai punti dati individuali della serie del grafico e impostare i valori della barra di errore per un punto dati individuale della serie.
6. Impostare i valori e il formato delle barre.
...
**Cosa succede alle barre di errore quando si esporta una presentazione in PDF o in immagini?**

Vengono renderizzate come parte del grafico e vengono preserve durante la conversione insieme al resto della formattazione del grafico, supponendo una versione o un renderer compatibile.
