...
type: docs
weight: 160
url: /it/nodejs-java/examples/elements/math-text/
keywords:
- esempio di codice
- testo matematico
- PowerPoint
...
- JavaScript
- Aspose.Slides
description: "Esplora gli esempi di MathematicalText di Aspose.Slides per Node.js: crea e formatta equazioni, frazioni, matrici e simboli nelle presentazioni PPT, PPTX e ODP."
---
Questo articolo dimostra come lavorare con forme di testo matematico e formattare le equazioni utilizzando **Aspose.Slides for Node.js via Java**.
...
Individua una forma che contiene un paragrafo di testo matematico nella diapositiva.
...
function removeMathText() {
    ...
    try {
        ...
        // Assumi che la prima forma sia la forma matematica.
...
Imposta le proprietà del font per una porzione matematica.
