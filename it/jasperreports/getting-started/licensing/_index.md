...
Aspose.Slides per JasperReports è disponibile come valutazione gratuita senza limite di tempo dalla [pagina di download](https://downloads.aspose.com/slides/it/jasperreport). La versione di valutazione e quella licenziata del prodotto sono lo stesso download.
...
La versione di valutazione di Aspose.Slides (senza licenza specificata) offre tutte le funzionalità del prodotto, ma (quando salvi le tue presentazioni) inserisce una filigrana di valutazione al centro di ogni diapositiva come mostrato nella figura seguente:
...
try {
    ...
    //Imposta la licenza mediante l'oggetto stream
