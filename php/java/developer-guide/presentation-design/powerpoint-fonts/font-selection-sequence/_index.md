...
keywords: "Font, Font selection, Font substitution, Font replacement, PowerPoint presentation, Java, Aspose.Slides for Java"
...
Aspose.Slides allows you to add fonts to Aspose runtime and then use those fonts. See [**Custom fonts**](https://docs.aspose.com/slides/java/custom-font/). 
