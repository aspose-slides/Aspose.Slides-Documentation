...
keywords:
- ส่วนหัว ส่วนท้าย
- เพิ่มส่วนหัว ส่วนท้าย
- อัปเดตส่วนหัว ส่วนท้าย
- ตัวอย่างโค้ด
- PowerPoint
- OpenDocument
- การนำเสนอ
...
- C#
- Aspose.Slides
description: "ควบคุมส่วนหัวและส่วนท้ายของสไลด์ด้วย Aspose.Slides for .NET: เพิ่มวันที่, หมายเลขสไลด์, และข้อความกำหนดเองใน PPT, PPTX, และ ODP ด้วยตัวอย่าง C#."
---
บทความนี้จะแสดงวิธีการเพิ่มส่วนท้ายและอัปเดตตัวยึดวันที่และเวลาโดยใช้ **Aspose.Slides for .NET**.
