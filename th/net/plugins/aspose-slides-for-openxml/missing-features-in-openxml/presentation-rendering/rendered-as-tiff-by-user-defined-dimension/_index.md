---
title: เรนเดอร์เป็น Tiff ด้วยมิติที่กำหนดโดยผู้ใช้
type: docs
weight: 40
...
//สร้างอ็อบเจ็กต์ Presentation ที่เป็นตัวแทนของไฟล์ Presentation
...
//Default - ระบุแผนการบีบอัดค่าเริ่มต้น (LZW).
...
//บันทึกไฟล์นำเสนอเป็น TIFF ด้วยขนาดภาพที่กำหนด
