---
title: สร้างเอกสารการนำเสนอ
type: docs
weight: 60
url: /th/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // สร้างงานนำเสนอที่เส้นทางไฟล์ที่ระบุ ประเภทเอกสารการนำเสนอคือ pptx เป็นค่าเริ่มต้น
...

{
    ...
    //สร้างอ็อบเจ็กต์ Presentation ที่แสดงไฟล์ PPT

    using (Presentation pres = new Presentation())

    {

        //สร้างคลาส SlideExCollection

        ISlideCollection slds = pres.Slides;

        //เพิ่มสไลด์เปล่าไปยังคอลเลกชัน SlidesEx
