...
หน้านี้แสดงรายการทั้งหมดของคลาส, เมธอด, คุณสมบัติ ฯลฯ ที่ [เพิ่ม](/slides/th/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) หรือ [ลบ](/slides/th/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) และการเปลี่ยนแปลงอื่น ๆ ที่แนะนำใน API ของ Aspose.Slides for .NET 15.10.0

{{% /alert %}} 
## **การเปลี่ยนแปลง Public API**
#### **เพิ่ม VideoPlayerHtmlController ใหม่เพื่อรองรับการส่งออกไฟล์สื่อเป็น HTML**
คลาสสาธารณะใหม่ VideoPlayerHtmlController ได้รับการเพิ่มเข้าไปในเนมสเปซ Aspose.Slides.Export ผู้ใช้สามารถใช้อินสแตนซ์ของคลาสนี้เพื่อส่งออกไฟล์วิดีโอและเสียงเป็น HTML ได้
...
baseUri: URI พื้นฐานที่ใช้ในการสร้างลิงก์
ตัวอย่างการใช้:
...
``` 
#### **Chart Series Animation API ได้รับการเพิ่ม**
เมธอดใหม่ 2 ตัวได้ถูกเพิ่มเข้าไปในอินเทอร์เฟซ Aspose.Slides.Animation.ISequence
...
เมธอดเหล่านี้มีวัตถุประสงค์เพื่อรองรับการเคลื่อนที่ขององค์ประกอบในแผนภูมิ:
ตามซีรีส์
ตามประเภท
ตามองค์ประกอบของซีรีส์
ตามองค์ประกอบของประเภท

ได้แนะนำ enum ใหม่สองตัวคือ EffectChartMajorGroupingType และ EffectChartMinorGroupingType ที่เกี่ยวข้องกับการเคลื่อนที่ขององค์ประกอบแผนภูมิ

เพื่อเพิ่มการเคลื่อนที่ของซีรีส์ในแผนภูมิ สามารถใช้โค้ดต่อไปนี้:
...
การเคลื่อนที่ขององค์ประกอบซีรีส์:
...
การเคลื่อนที่ขององค์ประกอบประเภท:
