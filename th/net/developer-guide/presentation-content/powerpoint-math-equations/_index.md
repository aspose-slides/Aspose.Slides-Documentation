...
- C#
- Aspose.Slides
description: "แทรกและแก้ไขสมการคณิตศาสตร์ใน PowerPoint PPT และ PPTX ด้วย Aspose.Slides สำหรับ .NET รองรับ OMML ควบคุมการจัดรูปแบบ และตัวอย่างโค้ด C# ที่ชัดเจน"
---
## **ภาพรวม**
...
- [MathParagraph](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/mathparagraph/) มีหนึ่งหรือมากกว่าอ็อบเจ็กต์ [MathBlock](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/mathblock/)  

ตัวอย่างส่วนใหญ่ด้านล่างใช้ [MathematicalText](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/mathematicaltext/) และเมธอดเชิง fluent จาก [IMathElement](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/) เพื่อให้โค้ดย่อและอ่านง่าย.

สำหรับกรณีการส่งออก MathML ดูที่ [Export Math Equations from Presentations in .NET](/slides/th/net/exporting-math-equations/).
...
{{% alert color="primary" %}}
`AddMathShape` สร้างรูปที่มีส่วนย่อคณิตศาสตร์อยู่แล้ว. เข้าถึง `MathPortion` ตัวแรก, รับ `MathParagraph` ของมัน, และเพิ่มบล็อกคณิตศาสตร์หรืออิลิเมนต์คณิตศาสตร์ไปยังนั้น.
{{% /alert %}}

## **เพิ่มเศษส่วน**

ใช้ `Divide` เพื่อสร้างเศษส่วน. คุณสามารถเลือกสไตล์ของเศษส่วนด้วย [MathFractionTypes](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/mathfractiontypes/).

![เศษส่วนคณิตศาสตร์เอียงที่แสดง 1 ÷ x](powerpoint-math-equations_4.png)
...
ใช้ `AsArgumentOfFunction` หรือ `Function` สำหรับฟังก์ชันเช่น `sin(x)`, `log(x)`, หรือชื่อฟังก์ชันที่กำหนดเอง. สำหรับขอบเขต, ใส่ `lim` ใน [MathLimit](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/mathlimit/) หรือใช้ `SetLowerLimit`.

![ขอบเขตของ x เมื่อ x ใกล้ถึงอนันต์](powerpoint-math-equations_8.png)
...
![ผลบวกที่มีขอบล่างและขอบบน](powerpoint-math-equations_7.png)
...
ใช้ [MathMatrix](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/mathmatrix/) สำหรับแถวและคอลัมน์. เมทริกซ์โดยค่าเริ่มต้นไม่มีวงเล็บ, ดังนั้นให้ล้อมเมทริกซ์เมื่อคุณต้องการวงเล็บ, โค้งเหลี่ยม, หรือวงโค้ง.
...
![อาร์เรย์คณิตศาสตร์แนวตั้งที่มี x ด้านบน y](powerpoint-math-equations_11.png)
...
![ตัวอักษร Y ตัวพิมพ์ใหญ่ที่มี subscript 1 ทางซ้ายและ superscript n](powerpoint-math-equations_9.png)
...
![นิพจน์ x + y ที่จัดกลุ่มพร้อมป้ายข้อความใด ๆ ใต้](powerpoint-math-equations_15.png)
...
| รวมอิลิเมนต์ | [IMathElement.Join](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/join/) |
| สร้างเศษส่วน | [IMathElement.Divide](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/divide/) |
| เพิ่ม superscript หรือ subscript | [SetSuperscript](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/setsuperscript/), [SetSubscript](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/setsubscript/) |
...
| เพิ่มขอบเขต | [SetLowerLimit](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/setlowerlimit/), [SetUpperLimit](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/setupperlimit/) |
...
| เพิ่มผลรวมและอินทิกรัล | [Nary](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/nary/), [Integral](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/integral/) |
| เพิ่มเมทริกซ์ | [MathMatrix](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/mathmatrix/) |
| เพิ่มอาร์เรย์สมการ | [ToMathArray](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/tomatharray/) |
| เพิ่มตัวแบ่งขอบเขต | [Enclose](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/enclose/) |
| เพิ่มบาร์และกรอบ | [Overbar](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/overbar/), [ToBorderBox](https://reference.aspose.com/slides/th/net/aspose.slides.mathtext/imathelement/toborderbox/) |
