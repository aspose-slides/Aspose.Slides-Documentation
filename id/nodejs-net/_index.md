...
**Selamat datang di Aspose.Slides untuk Node.js via .NET**

![Logo Produk Aspose.Slides untuk Node.js via .NET](aspose_slides-for-nodejs-via-net.png)
...
## Sumber Daya Aspose.Slides untuk Node.js via .NET
...
- [Instal Aspose.Slides untuk Node.js via .NET](/slides/id/nodejs-net/installation/)
- [Referensi API Aspose.Slides untuk Node.js via .NET](https://reference.aspose.com/slides/id/nodejs-net/)
- [Forum Dukungan Gratis Aspose.Slides untuk Node.js via .NET](https://forum.aspose.com/c/slides/id/11)
- [Helpdesk Dukungan Berbayar Aspose.Slides untuk Node.js via .NET](https://helpdesk.aspose.com/)