...
type: docs
weight: 100
url: /id/cpp/why-not-open-xml-sdk/
keywords:
- Open XML SDK
- membandingkan
...
- C++
- Aspose.Slides
description: "Lihat mengapa Aspose.Slides merupakan pilihan yang lebih baik dibandingkan Open XML SDK yang gratis: bandingkan fitur, konversi tanpa otomatisasi, dan dukungan luas untuk PPT, PPTX, dan ODP."
---
## **Gambaran Umum**

Artikel ini menjelaskan kapan pengembang mungkin memilih Open XML SDK atau Aspose.Slides untuk bekerja dengan dokumen presentasi. Artikel ini mendeskripsikan Open XML SDK sebagai pustaka untuk memanipulasi paket OOXML dan elemen XML yang mendasarinya, sementara Aspose.Slides dipresentasikan sebagai pustaka pemrosesan presentasi dengan model objek tingkat tinggi dan dukungan untuk banyak tugas terkait PowerPoint.
...
Kami kadang‑kadang mendengar pertanyaan ini: Mengapa harus menggunakan produk Aspose daripada Open XML SDK yang gratis? Pertanyaan ini mudah dijawab: fitur dan fungsionalitas. Menurut [MSDN Library](https://docs.microsoft.com/en-us/office/open-xml/open-xml-sdk), Open XML SDK didefinisikan sebagai: Open XML SDK 2.0 menyederhanakan tugas memanipulasi paket Open XML dan elemen skema Open XML yang mendasari dalam sebuah paket. Open XML SDK 2.0 mengenkapsulasi banyak tugas umum yang dilakukan pengembang pada paket Open XML, sehingga Anda dapat melakukan operasi kompleks hanya dengan beberapa baris kode. Dokumen OOXML pada dasarnya adalah file XML yang dikompresi, dan Open XML SDK adalah kumpulan kelas yang memungkinkan Anda bekerja dengan konten dokumen OOXML secara kuat‑tipe. Itu berarti alih‑alih mengekstrak file untuk mengambil XML, memuat XML itu ke dalam pohon DOM, dan bekerja langsung dengan elemen serta atribut XML, Open XML SDK menyediakan kelas‑kelas untuk melakukannya.
...
- Konversi berkualitas tinggi di antara semua format presentasi PowerPoint yang populer, termasuk konversi ke PDF dan XPS.
- Kemampuan menghasilkan thumbnail slide dalam format terkenal seperti PNG, JPEG, dan BMP serta mengekspor slide ke SVG.
- Kemampuan membangun presentasi dari awal atau dengan menggabungkan satu atau beberapa dokumen.
- Dukungan menambahkan animasi, Ole Frames, Tabel, serta membuat dan mengelola diagram.
- Ketersediaan kontrol ekstensif untuk mengelola pemformatan teks pada tingkat TextFrames, Paragraphs, dan Portions.

Untuk detail lebih lanjut tentang fitur yang didukung, silakan kunjungi [Aspose.Slides Features](/slides/id/cpp/product-overview/).

## **Bandingkan Open XML SDK dan Aspose.Slides**
...
|Akses langsung dan penuh tingkat rendah ke elemen XML serta atribut yang mendasari seperti pengidentifikasi relasi, pengidentifikasi daftar dalam dokumen OOXML.|Yes|No|
...
## **Kesimpulan**
Open XML SDK dan Aspose.Slides tidak bersaing secara langsung karena mereka melayani kebutuhan dan audiens yang cukup berbeda. Open XML SDK adalah pustaka kelas untuk memberikan cara kuat‑tipe bekerja dengan dokumen OOXML. Aspose.Slides adalah pustaka pemrosesan presentasi yang sangat berguna dengan dukungan luar biasa untuk hampir semua format file Microsoft PowerPoint. Jika yang Anda butuhkan hanyalah operasi pemrograman yang cukup dasar pada dokumen PPTX, maka Open XML SDK mungkin menjadi pilihan yang tepat. Dengan Open XML SDK, Anda akan cukup nyaman melakukan tugas sederhana seperti menghasilkan dokumen PPTX sederhana atau menghapus komentar, header/footer, mengekstrak gambar, atau hal lainnya. Beberapa tugas dapat dicapai dengan Open XML SDK, tetapi tidak dapat dicapai dengan Aspose.Slides. Misalnya, jika Anda perlu mengakses langsung elemen XML dan atribut dokumen OOXML, maka gunakan Open XML SDK. Namun, jika Anda perlu melakukan operasi kompleks pada dokumen, seperti beberapa tugas berikut, maka menggunakan Aspose.Slides adalah opsi terbaik Anda:

- Mendukung format PowerPoint lama selain PPTX.
- Menyalin atau menggandakan bentuk dalam slide dengan cara yang menggabungkan objek, gaya, dan pemformatan lain secara tepat.
- Mengganti teks yang diformat atau tidak diformat.
- Menerapkan Animasi dan menggunakan konektor pada bentuk yang dipakai.
- Mengonversi dokumen ke PDF atau XPS sehingga tampil persis seperti yang dilakukan Microsoft PowerPoint.
- Mengembangkan aplikasi C++ di lingkungan desktop dan konsol.