---
title: Konversi Presentasi PowerPoint ke XPS dengan C++
...
- C++
- Aspose.Slides
description: "Konversi PowerPoint PPT/PPTX ke XPS berkualitas tinggi dan platform-independen dengan C++ menggunakan Aspose.Slides. Dapatkan panduan langkah demi langkah dan contoh kode."
---
## **Gambaran Umum**
...
Microsoft terus memberikan dukungan kuat untuk XPS di Windows (bahkan di Windows 10), jadi Anda mungkin ingin mempertimbangkan menyimpan file dalam format ini. Jika Anda bekerja dengan Windows 8.1, Windows 8, Windows 7, dan Windows Vista, maka XPS mungkin menjadi pilihan terbaik Anda untuk operasi tertentu. 
...
|<p>**Masukan PPT(X):</p><p>**![todo:image_alt_text](convert-powerpoint-ppt-and-pptx-to-microsoft-xps-document_1.png)**</p>|<p>**Output XPS:</p><p>**![todo:image_alt_text](convert-powerpoint-ppt-and-pptx-to-microsoft-xps-document_2.png)**</p>|
| :- | :- |
...
### **Konversi Presentasi ke XPS Menggunakan Pengaturan Kustom**
...
**Bisakah saya menyimpan ke XPS ke dalam stream alih-alih file?**
...
**Apakah slide tersembunyi ikut dibawa ke XPS, dan dapatkah saya mengecualikannya?**

Secara default, hanya slide biasa (terlihat) yang dirender. Anda dapat [include or exclude hidden slides](https://reference.aspose.com/slides/id/cpp/aspose.slides.export/xpsoptions/set_showhiddenslides/) melalui [export settings](https://reference.aspose.com/slides/id/cpp/aspose.slides.export/xpsoptions/) sebelum menyimpan ke XPS, memastikan output berisi tepat halaman yang Anda inginkan.