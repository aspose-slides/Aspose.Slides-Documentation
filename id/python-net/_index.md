...
- Otomatisasi PowerPoint Python
- Perpustakaan PPT Python
- Ekspor PowerPoint ke PDF Python
- Ekspor PowerPoint ke SVG Python
- Edit PowerPoint dengan Python
- PowerPoint Python tanpa Microsoft Office
- Kelola PPTX dengan Python
- Pratinjau slide Python
- Python menambahkan audio ke slide
- PowerPoint
- OpenDocument
- Python
- Aspose.Slides
description: "Aspose.Slides untuk Python via .NET menawarkan rangkaian fitur lengkap, termasuk mengelola teks, bentuk, tabel, dan animasi, menambahkan audio dan video ke slide, meninjau slide, serta mengekspor ke SVG, PDF, dan lainnya."
---
{{% alert color="primary" %}}
...
Aspose.Slides for Python via .NET adalah perpustakaan kelas yang kuat yang memungkinkan aplikasi Anda membaca dan menulis presentasi PowerPoint® tanpa memerlukan Microsoft PowerPoint®.
...
Aspose.Slides for Python via .NET adalah perpustakaan Python yang kuat yang memungkinkan Anda membuat, mengedit, dan mengonversi presentasi PowerPoint (PPT, PPTX, ODP) secara programatik tanpa harus menginstal Microsoft PowerPoint.

### Fitur presentasi apa yang didukung oleh Aspose.Slides?

Perpustakaan ini mendukung pengelolaan teks, bentuk, tabel, diagram, animasi, master slide, audio, video, dan lainnya. Itu juga memungkinkan pratinjau slide, rendering, pencetakan, dan ekspor ke format seperti PDF, SVG, HTML, serta gambar.

### Bisakah saya mengonversi presentasi ke format lain menggunakan Aspose.Slides?

Ya. Aspose.Slides memungkinkan konversi file PowerPoint ke PDF, SVG, HTML, JPG, PNG, TIFF, dan format lain dengan akurasi tinggi serta kinerja yang baik.
...
Ini bersifat lintas platform dan dapat berjalan di lingkungan Windows, Linux, dan macOS.

### Bagaimana cara memulai dengan Aspose.Slides untuk Python?
