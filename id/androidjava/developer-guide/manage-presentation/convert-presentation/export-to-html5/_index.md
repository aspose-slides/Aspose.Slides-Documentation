...
- Java
- Aspose.Slides
description: "Ekspor presentasi PowerPoint & OpenDocument ke HTML5 responsif dengan Aspose.Slides untuk Android via Java. Pertahankan pemformatan, animasi, dan interaktivitas."
---
## **Gambaran Umum**
...
Contoh Java ini mendemonstrasikan proses standar PowerPoint ke HTML:
...
**Aspose.Slides** memungkinkan Anda mengonversi presentasi PowerPoint ke dokumen HTML5 di mana slide ditampilkan dalam mode tampilan slide. Dalam kasus ini, ketika Anda membuka file HTML5 yang dihasilkan di peramban, Anda melihat presentasi dalam mode tampilan slide di halaman web. 

Kode Java berikut mendemonstrasikan proses ekspor PowerPoint ke Tampilan Slide HTML5:
...
Saat Anda mengonversi presentasi PowerPoint ke dokumen HTML5, Anda dapat dengan mudah menentukan apakah akan menyertakan komentar dari presentasi dalam dokumen output. Untuk melakukan hal ini, Anda harus meneruskan parameter tampilan untuk komentar ke metode `setSlidesLayoutOptions` pada kelas [Html5Options](https://reference.aspose.com/slides/id/androidjava/com.aspose.slides/html5options/) .
...
Ya, ada [setting](https://reference.aspose.com/slides/id/androidjava/com.aspose.slides/saveoptions/#setSkipJavaScriptLinks-boolean-) yang memungkinkan Anda melewatkan hyperlink dengan panggilan JavaScript selama penyimpanan. Ini membantu mematuhi kebijakan keamanan yang ketat.