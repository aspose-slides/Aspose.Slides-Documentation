...
Microsoft terus menyediakan dukungan kuat untuk XPS di Windows (bahkan di Windows 10), jadi Anda mungkin ingin mempertimbangkan menyimpan file ke format ini. Jika Anda bekerja dengan Windows 8.1, Windows 8, Windows 7, dan Windows Vista, maka XPS mungkin menjadi pilihan terbaik Anda untuk operasi tertentu. 
...
Contoh kode ini menunjukkan cara mengonversi presentasi ke dokumen XPS menggunakan pengaturan khusus dalam Java:
