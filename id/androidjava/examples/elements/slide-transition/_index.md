...
type: docs
weight: 110
url: /id/androidjava/examples/elements/slide-transition/
keywords:
- contoh kode
- transisi slide
- PowerPoint
...
- Java
- Aspose.Slides
description: "Kuasai transisi slide di Aspose.Slides untuk Android: tambahkan, sesuaikan, dan urutkan efek serta durasi dengan contoh Java untuk presentasi PPT, PPTX, dan ODP."
---
Artikel ini menunjukkan cara menerapkan efek transisi slide dan penjadwalan dengan **Aspose.Slides for Android via Java**.
