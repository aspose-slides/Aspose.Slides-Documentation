...
type: docs
weight: 210
url: /id/androidjava/examples/elements/ole-object/
keywords:
- contoh kode
- objek OLE
- PowerPoint
...
- Java
- Aspose.Slides
description: "Kelola objek OLE di Aspose.Slides untuk Android: sisipkan, tautkan, perbarui, dan ekstrak konten yang disematkan dengan Java dalam presentasi PPT, PPTX, dan ODP."
---
Artikel ini menunjukkan cara menyematkan file sebagai objek OLE dan memperbarui datanya menggunakan **Aspose.Slides for Android via Java**.

## **Tambahkan OLE Object**
...
Ganti data yang disematkan dalam OLE object yang ada.
