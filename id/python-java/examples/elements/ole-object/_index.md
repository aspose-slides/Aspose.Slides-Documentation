...
---
Artikel ini menunjukkan cara menyematkan file sebagai objek OLE dan memperbarui datanya menggunakan **Aspose.Slides for Python via Java**.
...
Mengambil frame objek OLE pertama pada sebuah slide.
