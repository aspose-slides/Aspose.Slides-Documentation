...
type: docs
weight: 230
url: /id/python-java/examples/elements/comment/
keywords:
- komentar
- komentar modern
...
- Java
- Aspose.Slides
description: "Kelola komentar slide modern di Aspose.Slides untuk Python via Java: menambahkan, membaca, menghapus, dan membalas komentar dalam presentasi PowerPoint dan OpenDocument."
---
Artikel ini menjelaskan cara menambahkan, membaca, menghapus, dan membalas komentar modern menggunakan **Aspose.Slides for Python via Java**.

Instal paket seperti yang dijelaskan di [Instalasi](/slides/id/python-java/installation/). Setiap contoh mengimpor `asposeslides` sebelum memulai JVM, kemudian mengimpor API dan tipe Java yang diperlukan setelah JVM berjalan. Contoh akses dan penghapusan menggunakan `modern_comment.pptx`, yang dibuat oleh contoh pertama.
...
Baca komentar modern pertama dari presentasi yang sudah ada.
...
Hapus komentar pertama dan simpan presentasi yang telah diperbarui.
...
Buat komentar induk, tambahkan dua balasan, dan simpan presentasi.
