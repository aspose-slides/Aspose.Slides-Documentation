...
- Java
- Aspose.Slides
description: "Konversi presentasi menjadi handout di Java. Atur jumlah slide per halaman, pertahankan catatan, ekspor ke PDF atau gambar dengan Aspose.Slides, dengan contoh kode Java. Coba secara gratis."
---
## **Pendahuluan**

Aspose.Slides memungkinkan Anda mengonversi presentasi ke format keluaran yang mendukung mode Handout. Dalam mode ini, beberapa slide diatur pada satu halaman, yang berguna untuk mencetak materi presentasi untuk konferensi, seminar, dan acara serupa.
...
Perlu diingat bahwa metode `setSlidesLayoutOptions` hanya tersedia untuk format keluaran tertentu, seperti PDF, HTML, TIFF, dan saat merender sebagai gambar.
{{% /alert %}} 
...
Tidak. Jumlah dan urutan thumbnail dikendalikan secara ketat oleh kelas [HandoutType](https://reference.aspose.com/slides/id/java/com.aspose.slides/handouttype/); tata letak arbitrer tidak didukung.
