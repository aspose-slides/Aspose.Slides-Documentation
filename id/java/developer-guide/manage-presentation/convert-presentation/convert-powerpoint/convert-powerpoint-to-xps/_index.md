...
Untuk melihat bagaimana Aspose.Slides mengonversi presentasi PPT atau PPTX ke format XPS, Anda dapat mengunjungi [aplikasi konverter online gratis ini](https://products.aspose.app/slides/id/conversion). 
...
Microsoft terus menyediakan dukungan kuat untuk XPS di Windows (bahkan di Windows 10), jadi Anda mungkin ingin mempertimbangkan menyimpan file ke format ini. Jika Anda bekerja dengan Windows 8.1, Windows 8, Windows 7, dan Windows Vista, maka XPS mungkin menjadi pilihan terbaik untuk operasi tertentu. 
...
- Pengaturan kustom (dengan [**XPSOptions**](https://reference.aspose.com/slides/id/java/com.aspose.slides/xpsoptions))

### **Mengonversi Presentasi ke XPS Menggunakan Pengaturan Default**

Contoh kode Java ini menunjukkan cara mengonversi presentasi ke dokumen XPS menggunakan pengaturan standar:
...
Contoh kode ini menunjukkan cara mengonversi presentasi ke dokumen XPS menggunakan pengaturan kustom dalam Java:
...
### Dapatkah saya menyimpan ke XPS ke dalam stream alih-alih file?
...
### Apakah slide tersembunyi ikut terbawa ke XPS, dan dapatkah saya mengecualikannya?

Secara default, hanya slide biasa (yang terlihat) yang dirender. Anda dapat [sertakan atau kecualikan slide tersembunyi](https://reference.aspose.com/slides/id/java/com.aspose.slides/xpsoptions/#setShowHiddenSlides-boolean-) melalui [pengaturan ekspor](https://reference.aspose.com/slides/id/java/com.aspose.slides/xpsoptions/) sebelum menyimpan ke XPS, memastikan output berisi tepat halaman yang Anda inginkan.