...
- Java
- Aspose.Slides
description: "Migrasikan dari otomatisasi Microsoft Office ke Aspose.Slides untuk Java dan format teks dalam presentasi PowerPoint (PPT, PPTX) dengan kontrol yang tepat."
---
{{% alert color="info" %}} 
...
Tangkapan layar di bawah menunjukkan slide contoh sebelum dan sesudah menjalankan kode VSTO dan Aspose.Slides untuk Java.
