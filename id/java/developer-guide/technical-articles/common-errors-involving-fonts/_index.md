...
Saat Aspose.Slides digunakan di Linux, masalah terkait font dapat terjadi jika proses Java tidak dapat mengakses folder font yang diperlukan atau direktori sementara, jika tidak ada font yang terinstal di sistem, atau jika pustaka sistem yang diperlukan seperti fontconfig atau libfreetype tidak ada.

Artikel ini menjelaskan kesalahan dan pengecualian umum yang terkait dengan font di Linux serta memberikan solusi untuk mengatasinya. Artikel ini menjelaskan cara memeriksa akses ke direktori font dan TEMP, menginstal font serta pustaka yang diperlukan, dan menggunakan `FontsLoader` untuk memuat font tanpa menginstalnya secara sistem secara keseluruhan.

## **Teks atau Gambar yang Hilang (EMF atau WMF) Saat Kode Dijalankan di Linux**

Masalah ini terjadi pada sistem dengan batasan dalam kasus berikut:

1. Ketika tidak ada font yang terinstal atau ketika folder font untuk proses java tidak dapat diakses
...
{{% alert color="warning" %}}
Dalam beberapa kasus, Anda mungkin tidak dapat memberikan akses ke folder karena batasan yang diberlakukan oleh lingkungan atau kebijakan keamanan. Coba solusi berikut: 
{{% /alert %}}
...
## **Pengecualian: InvalidOperationException: Tidak Dapat Menemukan Font yang Terinstal di Sistem**

Pengecualian ini terjadi ketika

1) proses Java tidak dapat mengakses folder font
2) tidak ada font yang terinstal.
...
## **Pengecualian: UnsatisfiedLinkError: libfreetype.so.6: Tidak Dapat Membuka File Objek Bersama: Tidak Ada Berkas atau Direktori**
...
Jangan lupa menginstal font atau gunakan FontsLoader.
{{% /alert %}}