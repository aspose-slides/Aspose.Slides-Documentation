...
Aspose.Slides for Java memungkinkan Anda memperoleh nilai minimum dan maksimum pada sumbu vertikal. Ikuti langkah-langkah berikut:
...
Aspose.Slides memungkinkan Anda dengan cepat menukar data antar sumbu—data yang ditampilkan pada sumbu vertikal (y-axis) berpindah ke sumbu horizontal (x-axis) dan sebaliknya. 
...
Dengan menggunakan properti **CategoryAxisType**, Anda dapat menentukan tipe sumbu kategori yang diinginkan (**date** atau **text**). Kode ini dalam Java memperlihatkan operasi tersebut: 
...
Aspose.Slides for Java memungkinkan Anda mengatur format tanggal untuk nilai sumbu kategori. Operasi ini ditunjukkan dalam kode Java berikut:
...
Aspose.Slides for Java memungkinkan Anda mengatur sudut rotasi untuk judul sumbu diagram. Kode Java ini memperlihatkan operasi tersebut:
...
Aspose.Slides for Java memungkinkan Anda mengatur posisi sumbu pada sumbu kategori atau nilai. Kode Java ini menunjukkan cara melakukan tugas tersebut:
...
Aspose.Slides for Java memungkinkan Anda mengkonfigurasi diagram untuk menampilkan label satuan pada sumbu nilai diagramnya. Kode Java ini memperlihatkan operasi tersebut:
...
Sumbu menyediakan [pengaturan crossing](https://reference.aspose.com/slides/id/java/com.aspose.slides/axis/#setCrossType-int-): Anda dapat memilih untuk memotong di nol, pada kategori/nilai maksimum, atau pada nilai numerik tertentu. Ini berguna untuk menggeser sumbu X ke atas atau ke bawah atau untuk menekankan baseline.

**Bagaimana saya dapat memposisikan label tick relatif terhadap sumbu (sebelah, di luar, di dalam)?**

Atur [posisi label](https://reference.aspose.com/slides/id/java/com.aspose.slides/axis/#setMajorTickMark-int-) ke "cross", "outside", atau "inside". Ini memengaruhi keterbacaan dan membantu menghemat ruang, terutama pada diagram kecil.