...
type: docs
weight: 240
url: /id/java/examples/elements/note/
keywords:
- contoh kode
- catatan
- PowerPoint
...
- Java
- Aspose.Slides
description: "Bekerja dengan catatan slide di Aspose.Slides for Java: menambahkan, membaca, mengedit, dan mengekspor catatan pembicara dalam format PPT, PPTX, dan ODP menggunakan contoh Java yang jelas."
---
Artikel ini menunjukkan cara menambahkan, membaca, menghapus, dan memperbarui slide catatan menggunakan **Aspose.Slides for Java**.
