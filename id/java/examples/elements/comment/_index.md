...
type: docs
weight: 230
url: /id/java/examples/elements/comment/
keywords:
- contoh kode
- komentar
- PowerPoint
...
- Java
- Aspose.Slides
description: "Bekerja dengan komentar slide di Aspose.Slides untuk Java: menambah, membalas, mengedit, menyelesaikan, dan mengekspor komentar dalam presentasi PPT, PPTX, dan ODP dengan contoh kode Java."
---
Artikel ini menunjukkan cara menambah, membaca, menghapus, dan membalas komentar modern menggunakan **Aspose.Slides for Java**.
