...
type: docs
weight: 170
url: /id/java/examples/elements/group-shape/
keywords:
- contoh kode
- bentuk grup
- PowerPoint
...
- Java
- Aspose.Slides
description: "Kelola bentuk yang dikelompokkan dalam Aspose.Slides for Java: buat, susun bertingkat, sejajar, urutkan kembali, dan gaya bentuk grup dengan contoh Java dalam presentasi PPT, PPTX, dan ODP."
---
Contoh membuat grup bentuk, mengaksesnya, mengeluarkan grup, dan menghapus menggunakan **Aspose.Slides for Java**.
