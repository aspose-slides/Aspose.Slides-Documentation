...
type: docs
weight: 180
url: /id/java/examples/elements/ink/
keywords:
- contoh kode
- tinta
- PowerPoint
...
- Java
- Aspose.Slides
description: "Bekerja dengan Tinta di Aspose.Slides untuk Java: gambar, impor, dan edit goresan, sesuaikan warna dan lebar, serta ekspor ke PPT, PPTX, dan ODP menggunakan contoh Java."
---
Artikel ini memberikan contoh cara mengakses bentuk tinta yang ada dan menghapusnya menggunakan **Aspose.Slides for Java**.
