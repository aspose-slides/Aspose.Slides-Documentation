---
title: Buat dokumen presentasi
type: docs
weight: 60
url: /id/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // Buat presentasi pada jalur file yang ditentukan. Tipe dokumen presentasi adalah pptx, secara default.
...

{
    ...
    using (Presentation pres = new Presentation())
    {
        ...
        //Membuat instansi kelas SlideExCollection
        ISlideCollection slds = pres.Slides;

        //Menambahkan slide kosong ke koleksi SlidesEx
