---
title: Buat dan Modifikasi Perilaku Animasi Kustom di .NET
linktitle: Animasi Kustom
type: docs
weight: 151
url: /id/net/custom-animation/
keywords:
- animasi khusus
- perilaku animasi
- jalur gerak
...
- C#
- Aspose.Slides
description: "Buat, periksa, dan modifikasi perilaku animasi khusus serta jalur gerak yang dapat diedit dalam presentasi PowerPoint dengan Aspose.Slides untuk .NET."
---
## **Ikhtisar**
...
Untuk efek yang sudah ditentukan dan pemicu klik, lihat [Animasi Bentuk](/slides/id/net/shape-animation/).

## **Memahami Model Animasi**

An animation is organized as **Timeline → Sequence → Effect → Behaviors**:

- Slide's [Timeline](https://reference.aspose.com/slides/id/net/aspose.slides/ibaseslide/timeline/) contains its main sequence and interactive sequences.
- An [ISequence](https://reference.aspose.com/slides/id/net/aspose.slides.animation/isequence/) contains effects, potentially targeting different shapes.
- An [IEffect](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ieffect/) identifies a target shape, preset, subtype, and effect timing.
- [IEffect.Behaviors](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ieffect/behaviors/) contains the operations that implement the effect: changing color, moving, rotating, setting a property, and so on.

## **Membuat Perilaku Individual**

Call [ISequence.AddEffect](https://reference.aspose.com/slides/id/net/aspose.slides.animation/isequence/addeffect/) to create an effect and access its [Behaviors](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ieffect/behaviors/) collection. A preset can populate this collection automatically. Keep its operations when extending the preset, or use [Clear](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorcollection/clear/) when deliberately replacing them.

[IBehaviorFactory](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorfactory/) creates the eight behavior types illustrated below. Motion is covered in [Build a Motion Path](#build-a-motion-path). Each creation example is a complete program; later editing examples state which output file they use.

### **Rotasi**

Use [CreateRotationEffect](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorfactory/createrotationeffect/) to create a rotation. [By](https://reference.aspose.com/slides/id/net/aspose.slides.animation/irotationeffect/by/) specifies a relative angle in degrees; [From](https://reference.aspose.com/slides/id/net/aspose.slides.animation/irotationeffect/from/) and [To](https://reference.aspose.com/slides/id/net/aspose.slides.animation/irotationeffect/to/) specify endpoints.
...
Use [CreateScaleEffect](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorfactory/createscaleeffect/) with X/Y percentages: [From](https://reference.aspose.com/slides/id/net/aspose.slides.animation/iscaleeffect/from/) and [To](https://reference.aspose.com/slides/id/net/aspose.slides.animation/iscaleeffect/to/) describe the starting and ending size, while [By](https://reference.aspose.com/slides/id/net/aspose.slides.animation/iscaleeffect/by/) describes a relative change. Here, 100 means the original size.
...
Use [CreateFilterEffect](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorfactory/createfiltereffect/) to select a wipe. [Type](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ifiltereffect/type/), [Subtype](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ifiltereffect/subtype/), and [Reveal](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ifiltereffect/reveal/) specify the filter, direction, and whether to reveal or hide the shape.
...
Use [CreatePropertyEffect](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorfactory/createpropertyeffect/) to animate opacity. [From](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ipropertyeffect/from/), [To](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ipropertyeffect/to/), and [By](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ipropertyeffect/by/) are strings interpreted using [ValueType](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ipropertyeffect/valuetype/) and [CalcMode](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ipropertyeffect/calcmode/). Choose endpoints or a relative offset rather than setting all three indiscriminately.
...
Use [CreateSetEffect](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorfactory/createseteffect/) to assign visibility through [To](https://reference.aspose.com/slides/id/net/aspose.slides.animation/iseteffect/to/). A set behavior does not interpolate between endpoints.
...
Use [CreateCommandEffect](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorfactory/createcommandeffect/) and configure [Type](https://reference.aspose.com/slides/id/net/aspose.slides.animation/icommandeffect/type/), [CommandString](https://reference.aspose.com/slides/id/net/aspose.slides.animation/icommandeffect/commandstring/), and [ShapeTarget](https://reference.aspose.com/slides/id/net/aspose.slides.animation/icommandeffect/shapetarget/). Place a WAV recording named `sample.wav` in the working directory. This example embeds it with [AddAudioFrameEmbedded](https://reference.aspose.com/slides/id/net/aspose.slides/ishapecollection/addaudioframeembedded/) and attaches a play command to the audio frame.
...
[IBehaviorCollection](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorcollection/) supports [Add](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorcollection/add/), [Insert](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorcollection/insert/), [Remove](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorcollection/remove/), and [RemoveAt](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorcollection/removeat/). This example opens `rotation.pptx`, adds scaling, moves it before rotation, and removes the rotation. Removing and reinserting the same object changes its stored position without making a copy.
...
[IBehavior.Timing](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehavior/timing/) exposes [ITiming](https://reference.aspose.com/slides/id/net/aspose.slides.animation/itiming/), independently of [IEffect.Timing](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ieffect/timing/). Effect timing schedules the enclosing effect; behavior timing describes an operation inside it.

### **Atur Durasi, Penundaan, Pengulangan, dan Akselerasi**

Open `rotation.pptx` and set [Duration](https://reference.aspose.com/slides/id/net/aspose.slides.animation/itiming/duration/) and [TriggerDelayTime](https://reference.aspose.com/slides/id/net/aspose.slides.animation/itiming/triggerdelaytime/) in seconds, then configure [RepeatCount](https://reference.aspose.com/slides/id/net/aspose.slides.animation/itiming/repeatcount/). [Accelerate](https://reference.aspose.com/slides/id/net/aspose.slides.animation/itiming/accelerate/) and [Decelerate](https://reference.aspose.com/slides/id/net/aspose.slides.animation/itiming/decelerate/) are fractions of the duration; keep their sum at most 1.
...
Other repeat policies include [RepeatDuration](https://reference.aspose.com/slides/id/net/aspose.slides.animation/itiming/repeatduration/), [RepeatUntilEndSlide](https://reference.aspose.com/slides/id/net/aspose.slides.animation/itiming/repeatuntilendslide/), and [RepeatUntilNextClick](https://reference.aspose.com/slides/id/net/aspose.slides.animation/itiming/repeatuntilnextclick/); choose a policy rather than enabling them all together. [AutoReverse](https://reference.aspose.com/slides/id/net/aspose.slides.animation/itiming/autoreverse/) plays the animation backwards after the forward pass. Acceleration and deceleration apply to continuous changes, not discrete assignments or commands.

## **Membuat Jalur Gerak**

Use [CreateMotionEffect](https://reference.aspose.com/slides/id/net/aspose.slides.animation/ibehaviorfactory/createmotioneffect/) to create motion. Its [From](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioneffect/from/), [To](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioneffect/to/), and [By](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioneffect/by/) describe percentage-based coordinates or offsets. For an editable route, create a [MotionPath](https://reference.aspose.com/slides/id/net/aspose.slides.animation/motionpath/) and assign it to [IMotionEffect.Path](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioneffect/path/). [IMotionPath](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotionpath/) stores the path commands.

[MotionCommandPathType](https://reference.aspose.com/slides/id/net/aspose.slides.animation/motioncommandpathtype/) selects the operation:
...
[MotionPathPointsType](https://reference.aspose.com/slides/id/net/aspose.slides.animation/motionpathpointstype/) describes point-editing characteristics, such as corner or smooth points. It does not replace the command type. Use a curve point type for the curve example below, and a corner point type for the straight segments.

Path coordinates are normalized to slide dimensions: an X displacement of 0.25 represents one quarter of the slide width, not 0.25 points. Positive Y runs downward. Absolute commands specify positions in the path coordinate system; relative commands specify offsets from the current position. This is separate from [Origin](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioneffect/origin/), which selects the path's reference frame, and [PathEditMode](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioneffect/patheditmode/), which controls how the path moves when the shape is moved.

### **Buat Jalur Lurus**

Create a motion behavior with a starting point, one straight segment, and an end command. [IMotionPath.Add](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotionpath/add/) takes the command type, its points, the point type, and a relative-coordinate flag.
...
Each [IMotionCmdPath](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioncmdpath/) exposes [Points](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioncmdpath/points/), [CommandType](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioncmdpath/commandtype/), [PointsType](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioncmdpath/pointstype/), and [IsRelative](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotioncmdpath/isrelative/). The following examples use the known three-command path in `motion.pptx`. For arbitrary input, locate the intended effect and check command types and point counts before editing by index.
...
Use [Insert](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotionpath/insert/) and [RemoveAt](https://reference.aspose.com/slides/id/net/aspose.slides.animation/imotionpath/removeat/) to replace the line in `motion.pptx`. Inserting shifts the old line to index 2.
...
When the behavior's index is unknown, select it by type. This example opens `rotation.pptx`, finds its [IRotationEffect](https://reference.aspose.com/slides/id/net/aspose.slides.animation/irotationeffect/), changes the angle, and checks the saved value after reopening.
...
| [HTML5](/slides/id/net/export-to-html5/) | Dapat memutar animasi yang didukung ketika animasi bentuk diaktifkan dalam opsi ekspor. Uji kombinasi khusus di peramban. |
| [Animated GIF](/slides/id/net/convert-powerpoint-to-animated-gif/) | Menyimpan frame yang dirender, bukan perilaku yang dapat diedit atau interaksi pemicu-klik. Periksa gerakan yang sebenarnya dirender. |
| [Video](/slides/id/net/convert-powerpoint-to-video/) | Merender frame animasi dan mengenkodenya sebagai video. Dukungan terbatas pada [animasi dan efek yang didukung](/slides/id/net/convert-powerpoint-to-video/#supported-animations-and-effects) oleh renderer; perintah dan peristiwa interaktif tidak menjadi timeline yang dapat diedit. |
