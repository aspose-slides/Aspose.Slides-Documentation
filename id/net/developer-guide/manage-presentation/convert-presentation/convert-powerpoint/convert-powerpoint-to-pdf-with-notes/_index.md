...
- Menyesuaikan PDF output sehingga catatan pembicara disertakan dan diformat sesuai kebutuhan Anda.

Untuk mengatur dimensi dan orientasi halaman catatan sebelum ekspor, lihat [Ukuran Halaman Catatan](/slides/id/net/notes-size/).
...
{{% alert color="info" %}} 
Anda mungkin ingin memeriksa Aspose [Konverter PowerPoint ke PDF Online](https://products.aspose.app/slides/id/conversion). 
{{% /alert %}}