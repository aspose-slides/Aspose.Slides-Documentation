...
- PHP
- Aspose.Slides
description: "Pelajari cara memanipulasi pemformatan garis dalam presentasi PowerPoint dengan Aspose.Slides untuk PHP via Java. Temukan properti, metode, dan contoh."
---
## **Gambaran Umum**
...
Pada contoh di bawah ini, kami telah menambahkan sebuah garis ke slide pertama dari presentasi.
...
Aspose.Slides untuk PHP via Java juga memungkinkan pengembang mengkonfigurasi beberapa properti garis agar tampak lebih menarik. Mari coba mengatur beberapa properti garis sehingga tampak seperti panah. Ikuti langkah‑langkah berikut:
