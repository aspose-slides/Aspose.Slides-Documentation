...
- JavaScript
- Aspose.Slides
description: "Kuasi pemformatan paragraf dengan Aspose.Slides untuk Node.js via Java—optimalkan perataan, spasi & gaya dalam presentasi PPT, PPTX, dan ODP di JavaScript."
---
## **Pendahuluan**

Aspose.Slides menyediakan semua kelas yang Anda butuhkan untuk bekerja dengan teks, paragraf, dan bagian PowerPoint dalam Java.

* Aspose.Slides menyediakan kelas [TextFrame](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/textframe/) untuk memungkinkan Anda menambahkan objek yang mewakili sebuah paragraf. Sebuah objek `TextFame` dapat memiliki satu atau beberapa paragraf (setiap paragraf dibuat melalui carriage return).
* Aspose.Slides menyediakan kelas [Paragraph](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/paragraph/) untuk memungkinkan Anda menambahkan objek yang mewakili bagian. Sebuah objek `Paragraph` dapat memiliki satu atau beberapa bagian (koleksi objek bagian teks).
...
Sebuah objek `Paragraph` dapat menangani teks dengan properti format yang berbeda melalui objek `Portion` yang mendasarinya.
...
3. Tambahkan sebuah Rectangle [AutoShape](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/autoshape/) ke slide.
...
6. Buat tiga objek [Portion](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/portion/) untuk setiap `Paragraph` baru (dua objek Portion untuk Paragraph default) dan tambahkan setiap objek `Portion` ke koleksi IPortion dari masing-masing `Paragraph`.
7. Tetapkan beberapa teks untuk setiap bagian.
8. Terapkan fitur format pilihan Anda ke setiap bagian menggunakan properti format yang disediakan oleh objek `Portion`.
...
Daftar bullet membantu Anda mengatur dan menyajikan informasi dengan cepat dan efisien. Paragraf berbullet selalu lebih mudah dibaca dan dipahami.

1. Buat sebuah instance dari kelas [Presentation](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/presentation/).
2. Akses referensi slide yang relevan melalui indeksnya.
3. Tambahkan sebuah [AutoShape](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/autoshape/) ke slide terpilih.
...
try {
    ...
    // Menetapkan gaya bullet paragraf dan simbol
    para.getParagraphFormat().getBullet().setType(aspose.slides.BulletType.Symbol);
    para.getParagraphFormat().getBullet().setChar(8226);
    // Menetapkan teks paragraf
    para.setText("Welcome to Aspose.Slides");
    // Menetapkan indentasi bullet
    para.getParagraphFormat().setIndent(25);
    // Menetapkan warna bullet
    para.getParagraphFormat().getBullet().getColor().setColorType(aspose.slides.ColorType.RGB);
    para.getParagraphFormat().getBullet().getColor().setColor(java.getStaticFieldValue("java.awt.Color", "BLACK"));
    para.getParagraphFormat().getBullet().setBulletHardColor(aspose.slides.NullableBool.True);// set IsBulletHardColor ke true untuk menggunakan warna bullet sendiri
    ...
    var para2 = new aspose.slides.Paragraph();
    // Menetapkan tipe bullet paragraf dan gaya
    ...
    para2.getParagraphFormat().getBullet().setBulletHardColor(aspose.slides.NullableBool.True);// set IsBulletHardColor ke true untuk menggunakan warna bullet sendiri
    // Menetapkan tinggi bullet
...
1. Buat sebuah instance dari kelas [Presentation](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/presentation/).
2. Akses referensi slide yang relevan melalui indeksnya.
3. Tambahkan sebuah [AutoShape](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/autoshape/) di slide baru.
4. Akses [TextFrame](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/textframe/) milik autoshape.
5. Hapus paragraf default di `TextFrame`.
6. Buat instance paragraf pertama melalui kelas [Paragraph](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/paragraph/) dan atur kedalaman ke 0.
7. Buat instance paragraf kedua melalui kelas `Paragraph` dan atur kedalaman ke 1.
8. Buat instance paragraf ketiga melalui kelas `Paragraph` dan atur kedalaman ke 2.
9. Buat instance paragraf keempat melalui kelas `Paragraph` dan atur kedalaman ke 3.
...
4. Akses [TextFrame](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/textframe/) milik autoshape.
5. Hapus paragraf default di `TextFrame`.
6. Buat instance paragraf pertama melalui kelas [Paragraph](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/paragraph/) dan atur [NumberedBulletStartWith](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/bulletformat/#setNumberedBulletStartWith-short-) ke 2.
...
4. Tambahkan [TextFrame](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/textframe/) kosong ke shape dan hapus paragraf default.
...
## **Mengatur Indent Menggantung untuk Paragraf**

Indent menggantung adalah tata letak paragraf di mana baris pertama dimulai lebih ke kiri dibandingkan baris-baris berikutnya. Dalam Aspose.Slides, Anda membuat efek ini dengan metode [ParagraphFormat.setIndent](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/paragraphformat/setindent/). Atur indent ke nilai negatif untuk memindahkan baris pertama ke kiri relatif terhadap tubuh paragraf.
...
Format ini berguna untuk bibliografi, referensi, entri glosarium, dan paragraf lain dimana baris yang dibungkus harus sejajar di bawah tubuh paragraf, bukan di bawah karakter pertama baris pertama.

1. Buat sebuah instance dari kelas [Presentation](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/presentation/).
2. Akses slide target.
3. Tambahkan sebuah [AutoShape](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/autoshape/) berbentuk persegi panjang ke slide.
4. Tambahkan [TextFrame](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/textframe/) kosong ke shape dan hapus paragraf default.
5. Buat paragraf dan atur nilai [MarginLeft](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/paragraphformat/setmarginleft/) positif untuk setiap paragraf.
6. Atur nilai [Indent](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/paragraphformat/setindent/) negatif untuk menciptakan efek indent menggantung.
...
## **Mengelola Properti Run Akhir Paragraf untuk Paragraf**
...
1. Atur `FontHeight` dan tipe Font untuk paragraf.
...
Aspose.Slides menyediakan dukungan lanjutan untuk mengimpor teks HTML ke dalam paragraf.
...
8. Tambahkan konten file HTML yang dibaca oleh TextReader ke [ParagraphCollection](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/paragraphcollection/) TextFrame.
9. Simpan presentasi yang telah dimodifikasi.
...
Aspose.Slides menyediakan dukungan lanjutan untuk mengekspor teks (yang terdapat dalam paragraf) ke HTML.

1. Buat sebuah instance dari kelas [Presentation](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/presentation/) dan muat presentasi yang diinginkan.
2. Akses referensi slide yang relevan melalui indeksnya.
...
Di bagian ini, kami akan mengeksplorasi dua contoh yang menunjukkan cara menyimpan paragraf teks, yang diwakili oleh kelas [Paragraph](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/paragraph/), sebagai gambar. Kedua contoh mencakup memperoleh gambar shape yang berisi paragraf menggunakan metode `getImage` dari kelas [Shape](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/shape/), menghitung batas paragraf dalam shape, dan mengekspornya sebagai gambar bitmap. Pendekatan ini memungkinkan Anda mengekstrak bagian teks tertentu dari presentasi PowerPoint dan menyimpannya sebagai gambar terpisah, yang dapat berguna untuk penggunaan lebih lanjut dalam berbagai skenario.
...
Dalam contoh ini, kami memperoleh paragraf kedua sebagai gambar. Untuk melakukannya, kami mengekstrak gambar shape dari slide pertama presentasi, kemudian menghitung batas paragraf kedua dalam text frame shape. Paragraf tersebut kemudian digambar ulang pada bitmap baru yang disimpan dalam format PNG. Metode ini sangat berguna ketika Anda perlu menyimpan paragraf tertentu sebagai gambar terpisah sambil mempertahankan dimensi dan format teks yang tepat.
...
Dalam contoh ini, kami memperluas pendekatan sebelumnya dengan menambahkan faktor skala pada gambar paragraf. Shape diekstrak dari presentasi dan disimpan sebagai gambar dengan faktor skala `2`. Ini memungkinkan output resolusi lebih tinggi saat mengekspor paragraf. Batas paragraf kemudian dihitung dengan mempertimbangkan skala. Skala dapat sangat berguna ketika diperlukan gambar dengan detail lebih tinggi, misalnya untuk bahan cetak berkualitas tinggi.
...
Ya. Gunakan pengaturan pembungkusan text frame ([setWrapText](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/textframeformat/setwraptext/)) untuk mematikan pembungkusan sehingga baris tidak akan terpotong di tepi frame.

**Bagaimana saya dapat memperoleh batas tepat pada slide untuk paragraf tertentu?**

Anda dapat mengambil kotak pembatas (bounding rectangle) paragraf (bahkan untuk satu portion) untuk mengetahui posisi dan ukuran tepatnya pada slide.

**Di mana pengaturan perataan paragraf (kiri/kanan/tengah/justify) dikontrol?**

[setAlignment](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/paragraphformat/setalignment/) adalah metode untuk pengaturan pada tingkat paragraf di [ParagraphFormat](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/paragraphformat/); metode ini diterapkan pada seluruh paragraf terlepas dari format masing-masing portion.

**Apakah saya dapat mengatur bahasa pemeriksaan ejaan untuk hanya bagian dari paragraf (misalnya, satu kata)?**

Ya. Bahasa diatur pada tingkat portion ([PortionFormat.setLanguageId](https://reference.aspose.com/slides/id/nodejs-java/aspose.slides/baseportionformat/#setLanguageId)), sehingga beberapa bahasa dapat hidup berdampingan dalam satu paragraf.