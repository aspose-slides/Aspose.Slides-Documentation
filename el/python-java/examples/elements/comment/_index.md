...
type: docs
weight: 230
url: /el/python-java/examples/elements/comment/
keywords:
- σχόλιο
- σύγχρονο σχόλιο
- προσθήκη σχολίου
...
- Java
- Aspose.Slides
description: "Διαχειριστείτε τα σύγχρονα σχόλια διαφανειών στο Aspose.Slides για Python μέσω Java: προσθήκη, ανάγνωση, αφαίρεση και απάντηση σε σχόλια σε παρουσιάσεις PowerPoint και OpenDocument."
---
Αυτό το άρθρο δείχνει πώς να προσθέσετε, να διαβάσετε, να διαγράψετε και να απαντήσετε σε σύγχρονα σχόλια χρησιμοποιώντας **Aspose.Slides for Python via Java**.

Εγκαταστήστε το πακέτο όπως περιγράφεται στην [Installation](/slides/el/python-java/installation/). Κάθε παράδειγμα εισάγει το `asposeslides` πριν ξεκινήσει η JVM, και στη συνέχεια εισάγει το API και τους απαιτούμενους τύπους Java αφού η JVM είναι ενεργή. Τα παραδείγματα πρόσβασης και διαγραφής χρησιμοποιούν το `modern_comment.pptx`, το οποίο δημιουργήθηκε από το πρώτο παράδειγμα.

## **Προσθήκη σύγχρονου σχολίου**

Δημιουργήστε ένα σχόλιο που έχει γραφτεί από χρήστη και αποθηκεύστε την παρουσίαση.
...
Διαβάστε το πρώτο σύγχρονο σχόλιο από μια υπάρχουσα παρουσίαση.
...
Αφαιρέστε το πρώτο σχόλιο και αποθηκεύστε την ενημερωμένη παρουσίαση.
...
Δημιουργήστε ένα γονικό σχόλιο, προσθέστε δύο απαντήσεις και αποθηκεύστε την παρουσίαση.
