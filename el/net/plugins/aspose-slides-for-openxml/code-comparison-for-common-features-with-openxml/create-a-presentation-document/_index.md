---
title: Δημιουργία εγγράφου παρουσίασης
type: docs
weight: 60
url: /el/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // Δημιουργήστε μια παρουσίαση σε καθορισμένη διαδρομή αρχείου. Ο τύπος εγγράφου παρουσίασης είναι pptx, εξ ορισμού.
    ...
    //Κλείσιμο του χειριστηρίου παρουσίασης
...

{
...

    {
        ...
        //Δημιουργήστε την κλάση SlideExCollection

        ISlideCollection slds = pres.Slides;

        //Προσθέστε μια κενή διαφάνεια στη συλλογή SlidesEx
