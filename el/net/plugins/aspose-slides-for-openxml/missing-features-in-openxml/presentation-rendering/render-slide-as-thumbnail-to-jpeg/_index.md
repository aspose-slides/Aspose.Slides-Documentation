...
---
**Aspose.Slides for .NET** χρησιμοποιείται για τη δημιουργία αρχείων παρουσίασης που περιέχουν διαφάνειες. Αυτές οι διαφάνειες μπορούν να προβάλλονται ανοίγοντας τα αρχεία παρουσίασης με το Microsoft PowerPoint. Ωστόσο, μερικές φορές οι προγραμματιστές μπορεί να χρειαστεί να προβάλλουν τις διαφάνειες ως εικόνες χρησιμοποιώντας τον αγαπημένο τους προβολέα εικόνων. Σε τέτοιες περιπτώσεις, το Aspose.Slides for .NET σας βοηθά να δημιουργήσετε μικρογραφίες εικόνων των διαφανειών.
...
1. Αποκτήστε την αναφορά της επιθυμητής διαφάνειας χρησιμοποιώντας το ID ή το δείκτη της.
1. Λάβετε τη μικρογραφία της αναφερθείσας διαφάνειας σε καθορισμένη κλίμακα.
1. Αποθηκεύστε τη μικρογραφία εικόνας σε οποιαδήποτε επιθυμητή μορφή εικόνας.
