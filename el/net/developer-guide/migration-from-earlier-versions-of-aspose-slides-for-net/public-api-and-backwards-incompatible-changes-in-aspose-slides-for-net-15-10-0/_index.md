---
title: Δημόσιο API και Αλλαγές Μη Συμβατότητας με Παλαιότερες Εκδόσεις στο Aspose.Slides για .NET 15.10.0
linktitle: Aspose.Slides για .NET 15.10.0
type: docs
weight: 200
url: /el/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/
keywords:
- μετάβαση
- παλαιός κώδικας
- σύγχρονος κώδικας
...
- C#
- Aspose.Slides
description: "Ανασκόπηση των ενημερώσεων του δημόσιου API και των αλλαγών που διακόπτουν τη λειτουργία στο Aspose.Slides για .NET, ώστε να μεταβείτε ομαλά στις λύσεις παρουσίασης PowerPoint PPT, PPTX και ODP."
---
{{% alert color="primary" %}} 

Αυτή η σελίδα παραθέτει όλες τις [προστέθηκαν](/slides/el/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) ή [αφαιρέθηκαν](/slides/el/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) κλάσεις, μεθόδους, ιδιότητες κ.λπ., καθώς και άλλες αλλαγές που εισήχθησαν με το API του Aspose.Slides for .NET 15.10.0.

{{% /alert %}} 
## **Αλλαγές Δημοσίου API**
#### **Προστέθηκε Νέος VideoPlayerHtmlController για Υποστήριξη Εξαγωγής Αρχείων Πολυμέσων σε HTML**
Η νέα δημόσια κλάση VideoPlayerHtmlController προστέθηκε στο namespace Aspose.Slides.Export. Χρησιμοποιώντας ένα αντικείμενο αυτής της κλάσης, ο χρήστης μπορεί να εξάγει αρχεία βίντεο και ήχου σε HTML.
...
baseUri: Η βασική URI που θα χρησιμοποιηθεί για τη δημιουργία συνδέσμων  
Παράδειγμα χρήσης:
...
``` 
#### **Προστέθηκε API Ανίμασης Σειρών Διαγράμματος**
Οι νέες 2 μέθοδοι προστέθηκαν στη διεπαφή Aspose.Slides.Animation.ISequence.
...
Αυτές οι μέθοδοι προορίζονται για την υποστήριξη των αναπαραστάσεων των στοιχείων του γραφήματος:
κατά σειρά  
κατά κατηγορία  
κατά στοιχεία σειράς  
κατά στοιχεία κατηγορίας

Οι δύο νέοι απαριθμήσεις EffectChartMajorGroupingType και EffectChartMinorGroupingType, που σχετίζονται με την ανίμαση των στοιχείων του γραφήματος, εισήχθησαν.

Για να προσθέσετε ανίμαση σειράς στο γράφημα, μπορεί να χρησιμοποιηθεί ο ακόλουθος κώδικας:
