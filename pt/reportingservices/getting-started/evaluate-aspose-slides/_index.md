...
type: docs
weight: 80
url: /pt/reportingservices/evaluate-aspose-slides/
---
{{% alert color="primary" %}} 
...
A versão de avaliação do Aspose.Slides (sem uma licença especificada) fornece toda a funcionalidade do produto, mas insere uma marca d'água de avaliação em cada slide da apresentação gerada.
