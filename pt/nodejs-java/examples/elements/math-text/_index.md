...
type: docs
weight: 160
url: /pt/nodejs-java/examples/elements/math-text/
keywords:
- exemplo de código
- texto matemático
- PowerPoint
...
- JavaScript
- Aspose.Slides
description: "Explore exemplos de MathematicalText do Aspose.Slides for Node.js: crie e formate equações, frações, matrizes e símbolos em apresentações PPT, PPTX e ODP."
---
Este artigo demonstra como trabalhar com formas de texto matemático e formatar equações usando **Aspose.Slides for Node.js via Java**.
...
function addMathText() {
    ...
    try {
        ...
        // Adiciona uma forma Math ao slide.
...
function removeMathText() {
    ...
    try {
        ...
        // Assume que a primeira forma é a forma matemática.
        let mathShape = slide.getShapes().get_Item(0);

        // Remova a forma matemática.
...
function formatMathText() {
    ...
    try {
        ...
        // Assuma que a primeira forma é a forma matemática.
        let mathShape = slide.getShapes().get_Item(0);
