...
try {
    ...
    Tipos de compactação:
        Default - Especifica o esquema de compactação padrão (LZW).
        None - Especifica que não há compactação.
        CCITT3
        CCITT4
        LZW
        RLE
