---
title: Acessar Slides de Apresentação em Java
linktitle: Acessar Slide
type: docs
weight: 20
url: /pt/java/access-slide-in-presentation/
keywords:
- acessar slide
- índice do slide
- id do slide
...
- Java
- Aspose.Slides
description: "Aprenda como acessar e gerenciar slides em apresentações PowerPoint e OpenDocument com Aspose.Slides para Java. Aumente a produtividade com exemplos de código."
---
## **Visão geral**
...
Você também aprenderá como alterar a posição de um slide usando o método `setSlideNumber` e como definir o número inicial do slide para uma apresentação com o método `setFirstSlideNumber`. Os exemplos demonstram como carregar uma apresentação, obter referências de slides, atualizar a ordem ou a numeração dos slides e salvar a apresentação modificada.
...
A classe Presentation, que representa um arquivo de apresentação, expõe todos os slides como uma coleção [ISlideCollection](https://reference.aspose.com/slides/pt/java/com.aspose.slides/islidecollection/) (coleção de objetos [ISlide](https://reference.aspose.com/slides/pt/java/com.aspose.slides/islide/)). Este código Java mostra como acessar um slide pelo seu índice:
...
Cada slide em uma apresentação possui um ID exclusivo associado a ele. Você pode usar o método [getSlideById](https://reference.aspose.com/slides/pt/java/com.aspose.slides/presentation/#getSlideById-long-) (exposto pela classe [Presentation](https://reference.aspose.com/slides/pt/java/com.aspose.slides/presentation/)) para localizar esse ID. Este código Java mostra como fornecer um ID de slide válido e acessar esse slide através do método [getSlideById](https://reference.aspose.com/slides/pt/java/com.aspose.slides/presentation/#getSlideById-long-):
...
1. Obtenha a referência do slide (cuja posição você deseja alterar) pelo seu índice
1. Defina uma nova posição para o slide usando a propriedade [setSlideNumber](https://reference.aspose.com/slides/pt/java/com.aspose.slides/islide/#setSlideNumber-int-).
1. Salve a apresentação modificada.

Este código Java demonstra uma operação em que o slide na posição 1 é movido para a posição 2:
...
Usando a propriedade [setFirstSlideNumber](https://reference.aspose.com/slides/pt/java/com.aspose.slides/presentation/#setFirstSlideNumber-int-) (exposta pela classe [Presentation](https://reference.aspose.com/slides/pt/java/com.aspose.slides/presentation/)), você pode especificar um novo número para o primeiro slide em uma apresentação. Essa operação faz com que os demais números de slide sejam recalculados.
...
try {
    ...
    // Mostra os números dos slides para todos os slides
...
O número exibido em um slide pode começar a partir de um valor arbitrário (por exemplo, 10) e não precisa corresponder ao índice; o relacionamento é controlado pela configuração de [first slide number](https://reference.aspose.com/slides/pt/java/com.aspose.slides/presentation/#setFirstSlideNumber-int-) da apresentação.
