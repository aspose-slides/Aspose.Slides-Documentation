---
title: Converter apresentações PowerPoint para XPS em Java
...
- Java
- Aspose.Slides
description: "Converta PowerPoint PPT/PPTX para XPS de alta qualidade e independente de plataforma em Java usando Aspose.Slides. Obtenha um guia passo a passo e código de exemplo."
---
## **Visão geral**
...
## **Sobre XPS**
A Microsoft desenvolveu o [XPS](https://docs.fileformat.com/page-description-language/xps/) como uma alternativa ao [PDF](https://docs.fileformat.com/pdf/). Ele permite imprimir conteúdo gerando um arquivo muito similar a um PDF. O formato XPS baseia‑se em XML. O layout ou a estrutura de um arquivo XPS permanece o mesmo em todos os sistemas operacionais e impressoras. 
...
A Microsoft continua a oferecer forte suporte ao XPS no Windows (inclusive no Windows 10), portanto você pode considerar salvar arquivos neste formato. Se você está trabalhando com Windows 8.1, Windows 8, Windows 7 e Windows Vista, o XPS pode ser realmente sua melhor opção para determinadas operações. 

- **Windows 8** usa o formato OXPS (Open XPS) para arquivos XPS. OXPS é uma versão padronizada do formato XPS original. O Windows 8 fornece melhor suporte para arquivos XPS do que para arquivos PDF. 
  - **XPS:** Visualizador/leitor XPS integrado e recurso de impressão para XPS disponíveis. 
  - **PDF:** Leitor PDF disponível, porém sem recurso de impressão para PDF. 
...
A Microsoft acabou implementando suporte para operações de impressão em PDF através do recurso Imprimir em PDF no Windows 10. Anteriormente, esperava‑se que os usuários imprimissem documentos através do formato XPS. 

## **Conversão XPS com Aspose.Slides**

Em [**Aspose.Slides**](https://products.aspose.com/slides/pt/java/) para Java, você pode usar o método [**Save**](https://reference.aspose.com/slides/pt/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides.ISaveOptions-) exposto pela classe [Presentation](https://reference.aspose.com/slides/pt/java/com.aspose.slides/Presentation) para converter toda a apresentação em um documento XPS. 
...
try {
    ...
    // Salve Metafiles como PNG
    options.setSaveMetafilesAsPng(true);

    // Salve a apresentação em documento XPS
