...
- Java
- Aspose.Slides
description: "Converter apresentações em folhetos em Java. Defina slides por página, mantenha anotações, exporte para PDF ou imagens com Aspose.Slides, com código Java de exemplo. Experimente grátis."
---
## **Introdução**

Aspose.Slides permite converter apresentações para formatos de saída que suportam o modo Folheto. Nesse modo, vários slides são organizados em uma única página, o que é útil para imprimir materiais de apresentação para conferências, seminários e eventos similares.
...
Para definir as dimensões e a orientação da página de folhetos antes da exportação, veja [Tamanho da Página de Anotações](/slides/pt/java/notes-size/).
...
Lembre-se de que o método `setSlidesLayoutOptions` está disponível apenas para alguns formatos de saída, como PDF, HTML, TIFF, e ao renderizar como imagens.
{{% /alert %}} 
...
Aspose.Slides suporta [predefinições](https://reference.aspose.com/slides/pt/java/com.aspose.slides/handouttype/) de até 9 miniaturas por página com ordenação horizontal ou vertical: 1, 2, 3, 4 (horizontal/vertical), 6 (horizontal/vertical) e 9 (horizontal/vertical).
