...
- Java
- Aspose.Slides
description: "Otimize o gerenciamento de objetos OLE no PowerPoint e em arquivos OpenDocument com Aspose.Slides for Java. Incorpore, atualize e exporte conteúdo OLE de forma fluida."
---
## **Introdução**
...
[Aspose.Slides for Java](https://products.aspose.com/slides/pt/java/) permite inserir Objetos OLE em slides como quadros de objeto OLE ([OleObjectFrame](https://reference.aspose.com/slides/pt/java/com.aspose.slides/OleObjectFrame)).

## **Adicionar Quadros de Objeto OLE a Slides**

Assumindo que você já tenha criado um gráfico no Microsoft Excel e deseja incorporá-lo em um slide como um quadro de objeto OLE usando Aspose.Slides for Java, você pode fazer da seguinte maneira:
...
1. Adicione o [OleObjectFrame](https://reference.aspose.com/slides/pt/java/com.aspose.slides/OleObjectFrame) ao slide contendo o array de bytes e outras informações sobre o objeto OLE.  
...
Aspose.Slides for Java permite adicionar um [OleObjectFrame](https://reference.aspose.com/slides/pt/java/com.aspose.slides/OleObjectFrame) sem incorporar dados, mas apenas com um link para o arquivo.
...
3. Acesse a forma do quadro de objeto OLE. Em nosso exemplo, usamos o PPTX criado anteriormente que tem uma forma no primeiro slide. Em seguida, *convertimos* esse objeto para [IOleObjectFrame](https://reference.aspose.com/slides/pt/java/com.aspose.slides/IOleObjectFrame). Esse era o quadro de objeto OLE desejado para ser acessado.  
4. Depois que o quadro de objeto OLE for acessado, você pode executar qualquer operação nele.  
...
Além de gráficos Excel, Aspose.Slides for Java permite incorporar outros tipos de arquivos em slides. Por exemplo, você pode inserir arquivos HTML, PDF e ZIP como objetos. Quando um usuário clica duas vezes no objeto inserido, ele é aberto automaticamente no programa relevante, ou o usuário é solicitado a selecionar um programa apropriado para abri‑lo.
...
Ao trabalhar com apresentações, pode ser necessário substituir objetos OLE antigos por novos ou substituir um objeto OLE não suportado por um suportado. Aspose.Slides for Java permite definir o tipo de arquivo para um objeto incorporado, possibilitando a atualização dos dados do quadro OLE ou sua extensão.
...
1. Crie uma instância da classe [Presentation](https://reference.aspose.com/slides/pt/java/com.aspose.slides/Presentation) que contém os objetos OLE que você pretende extrair.  
2. Itere por todas as formas da apresentação e acesse as formas [OLEObjectFrame](https://reference.aspose.com/slides/pt/java/com.aspose.slides/oleobjectframe).  
...
### Como posso travar um objeto OLE em um slide para que os usuários não possam movê‑lo/editi‑lo no PowerPoint?

Trave a forma: Aspose.Slides fornece [travas em nível de forma](/slides/pt/java/applying-protection-to-presentation/). Isso não é criptografia, mas impede efetivamente edições e movimentações acidentais.
