---
title: Adicionar linhas de tendência a gráficos de apresentação em Java
linktitle: Linha de tendência
type: docs
url: /pt/java/trend-line/
keywords:
- gráfico
- linha de tendência
...
- Java
- Aspose.Slides
description: "Adicione e personalize rapidamente linhas de tendência em gráficos do PowerPoint com Aspose.Slides para Java — um guia prático para envolver seu público."
---
## **Visão geral**
...
Aspose.Slides for Java fornece uma API simples para gerenciar diferentes linhas de tendência em gráficos:
...
4. Adicione uma linha de tendência exponencial para a série 1 do gráfico.
5. Adicione uma linha de tendência linear para a série 1 do gráfico.
6. Adicione uma linha de tendência logarítmica para a série 2 do gráfico.
7. Adicione uma linha de tendência de média móvel para a série 2 do gráfico.
8. Adicione uma linha de tendência polinomial para a série 3 do gráfico.
9. Adicione uma linha de tendência de potência para a série 3 do gráfico.
...
Aspose.Slides for Java fornece uma API simples para adicionar linhas personalizadas em um gráfico. Para adicionar uma linha simples e plana a um slide selecionado da apresentação, siga os passos abaixo:
...
Sim. Aspose.Slides converte apresentações para [PDF](/slides/pt/java/convert-powerpoint-to-pdf/)/[SVG](/slides/pt/java/render-a-slide-as-an-svg-image/) e renderiza gráficos como imagens; as linhas de tendência, como parte do gráfico, são preservadas durante essas operações. Também há um método disponível para [exportar uma imagem do gráfico](/slides/pt/java/create-shape-thumbnails/) propriamente dito.