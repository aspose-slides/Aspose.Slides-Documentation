...
type: docs
weight: 180
url: /pt/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/
keywords:
- migração
- código legado
- código moderno
...
```
#### **Novo com.aspose.slides.VideoPlayerHtmlController adicionado para suportar a exportação de arquivos de mídia para HTML**
