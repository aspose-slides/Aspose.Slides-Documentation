---
title: API pública e alterações incompatíveis retroativas no Aspose.Slides para Java 15.6.0
...
- Java
- Aspose.Slides
description: "Confira as atualizações da API pública e as alterações incompatíveis no Aspose.Slides para Java para migrar suavemente suas soluções de apresentação PowerPoint PPT, PPTX e ODP."
---
{{% alert color="primary" %}} 
...
#### **Método com.aspose.slides.ISlide.getNotesSlideManager() foi adicionado. Métodos ISlide.getNotesSlide() e ISlide.addNotesSlide() foram marcados como obsoletos**
...
O método ICommentAuthor.Remove foi adicionado para remover o autor de comentários da coleção.
#### **Métodos clearCustomProperties() e clearBuiltInProperties() foram adicionados a com.aspose.slides.IDocumentProperties**
O método com.aspose.slides.IDocumentProperties.clearCustomProperties() foi adicionado para remover todas as propriedades personalizadas do documento. O método com.aspose.slides.IDocumentProperties.clearBuiltInProperties() foi adicionado para remover e definir valores padrão para todas as propriedades incorporadas do documento (Company, Subject, Author etc).
...
|InverseGray|Retorna com coloração cinza invertida|
