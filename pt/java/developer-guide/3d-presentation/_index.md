...
- Java
- Aspose.Slides
description: "Aplique e renderize efeitos 3D para formas e texto do PowerPoint em Java com Aspose.Slides. Configure câmera, iluminação, material, extrusão, preenchimentos e texto 3D."
---
## **Visão geral**

Aspose.Slides for Java pode criar, editar, preservar e renderizar formatação 3D no estilo PowerPoint para formas e texto. Este artigo cobre efeitos 3D como rotação, extrusão, chanfraduras, iluminação, material, preenchimentos em gradiente ou imagem e texto 3D.
...
Use [IShape](https://reference.aspose.com/slides/pt/java/com.aspose.slides/ishape/).`getThreeDFormat()` para aplicar formatação 3D a uma forma. O objeto de formato retornado controla a cena 3D para essa forma.

Para texto, use [ITextFrameFormat](https://reference.aspose.com/slides/pt/java/com.aspose.slides/itextframeformat/).`getThreeDFormat()`. Isso aplica formatação 3D ao quadro de texto em vez do corpo da forma.

Os membros de API mais importantes são:

| Membro da API | O que controla | Quando usar |
|---|---|---|
| [getCamera](https://reference.aspose.com/slides/pt/java/com.aspose.slides/ithreedformat/#getCamera--) | Ponto de vista, tipo de câmera predefinido, rotação, zoom e perspectiva. | Rotacionar o objeto no espaço 3D ou corresponder a um preset de rotação 3D do PowerPoint. |
| [getLightRig](https://reference.aspose.com/slides/pt/java/com.aspose.slides/ithreedformat/#getLightRig--) | Preset de luz, direção e rotação da luz. | Alterar como os realces e sombras aparecem na superfície 3D. |
| [getMaterial](https://reference.aspose.com/slides/pt/java/com.aspose.slides/ithreedformat/#getMaterial--) e [setMaterial](https://reference.aspose.com/slides/pt/java/com.aspose.slides/ithreedformat/#setMaterial-int-) | Material da superfície, como plano, fosco, plástico ou metal. | Fazer a mesma geometria parecer mais plana, macia, brilhante ou metálica. |
...
| [getExtrusionColor](https://reference.aspose.com/slides/pt/java/com.aspose.slides/ithreedformat/#getExtrusionColor--) | Cor das faces laterais extrudadas. | Tornar a profundidade visível ou coordenar a cor dos lados com o preenchimento frontal. |
| [getDepth](https://reference.aspose.com/slides/pt/java/com.aspose.slides/ithreedformat/#getDepth--) e [setDepth](https://reference.aspose.com/slides/pt/java/com.aspose.slides/ithreedformat/#setDepth-double-) | Profundidade 3D adicional usada pela formatação 3D do PowerPoint. | Ajustar finamente a profundidade para formas ou texto, especialmente combinado com configurações de chanfradura e material. |
...
No Aspose.Slides, defina o tipo de câmera e a rotação por meio do formato 3D retornado por `shape.getThreeDFormat()`:
...
Defina a altura da extrusão para a espessura e a cor da extrusão para a cor dos lados:
...
Use o ajuste de profundidade quando precisar trabalhar diretamente com o valor de profundidade do PowerPoint ou combinar profundidade com chanfradura, material e efeitos de texto. Em muitos cenários de forma, a altura da extrusão é a configuração mais clara, pois expressa diretamente a extrusão visível.
...
O exemplo a seguir cria texto com preenchimento de padrão, aplica uma transformação WordArt e configura as definições 3D em [ITextFrameFormat](https://reference.aspose.com/slides/pt/java/com.aspose.slides/itextframeformat/):
...
- Se precisar inspecionar valores de formatação herdados ou baseados em tema, leia as [propriedades efetivas da forma](/slides/pt/java/shape-effective-properties/).
...
### Pode o Aspose.Slides criar apresentações 3D interativas?

Aspose.Slides cria e renderiza efeitos 3D do PowerPoint para formas e texto. Ele não transforma imagens, PDFs ou páginas HTML exportadas em cenas 3D interativas que o visualizador possa rotacionar. No PPTX, a formatação 3D permanece editável no PowerPoint onde o formato a suporta.

### Qual é a diferença entre um modelo 3D e um efeito 3D?

Um modelo 3D é um objeto 3D separado inserido em uma apresentação. Um efeito 3D é uma formatação aplicada a uma forma ou texto regular do PowerPoint, como rotação, extrusão, chanfradura, iluminação e material. Este artigo aborda efeitos 3D.

### Quais configurações são necessárias para uma forma 3D visível?

No mínimo, defina uma rotação de câmera e extrusão ou profundidade. Na prática, também defina um rig de iluminação e material para que as faces renderizadas tenham realces e sombras claros.

### Posso aplicar efeitos 3D tanto a formas quanto a texto?

Sim. Use [IShape](https://reference.aspose.com/slides/pt/java/com.aspose.slides/ishape/).`getThreeDFormat()` para o corpo da forma e [ITextFrameFormat](https://reference.aspose.com/slides/pt/java/com.aspose.slides/itextframeformat/).`getThreeDFormat()` para o texto.

### Os efeitos 3D aparecerão ao exportar para imagens, PDF, HTML ou quadros de vídeo?

Sim. Aspose.Slides renderiza os efeitos 3D ao gerar imagens de slide, saída em PDF, saída em HTML e quadros usados para conversão de vídeo. A saída exportada contém a aparência renderizada, não um objeto 3D editável.

### Posso ler os valores finais 3D após a herança e aplicação das configurações de tema?

Sim. Use as APIs de formatação efetiva descritas em [Propriedades Efetivas da Forma](/slides/pt/java/shape-effective-properties/) para ler os valores finais de câmera, rig de iluminação, chanfradura e 3D relacionados.