...
type: docs
weight: 230
url: /pt/java/examples/elements/comment/
keywords:
- exemplo de código
- comentário
- PowerPoint
...
- Java
- Aspose.Slides
description: "Trabalhe com comentários de slides no Aspose.Slides for Java: adicione, responda, edite, resolva e exporte comentários em apresentações PPT, PPTX e ODP com exemplos de código Java."
---
Este artigo demonstra como adicionar, ler, remover e responder a comentários modernos usando **Aspose.Slides for Java**.
