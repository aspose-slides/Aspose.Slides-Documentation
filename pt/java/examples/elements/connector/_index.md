...
type: docs
weight: 190
url: /pt/java/examples/elements/connector/
keywords:
- exemplo de código
- Conector
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aprenda como adicionar, direcionar e estilizar conectores entre formas usando Aspose.Slides for Java, com exemplos em Java para apresentações PPT, PPTX e ODP."
---
Este artigo demonstra como conectar formas com conectores e alterar seus destinos usando **Aspose.Slides for Java**.
