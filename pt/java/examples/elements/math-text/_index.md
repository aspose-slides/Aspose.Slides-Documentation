...
type: docs
weight: 160
url: /pt/java/examples/elements/math-text/
keywords:
- exemplo de código
- texto matemático
- PowerPoint
...
- Java
- Aspose.Slides
description: "Explore exemplos de MathematicalText do Aspose.Slides for Java: crie e formate equações, frações, matrizes e símbolos com Java em apresentações PPT, PPTX e ODP."
---
Este artigo demonstra como trabalhar com formas de texto matemático e formatar equações usando **Aspose.Slides for Java**.
