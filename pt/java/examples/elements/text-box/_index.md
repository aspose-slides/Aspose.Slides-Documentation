...
type: docs
weight: 40
url: /pt/java/examples/elements/text-box/
keywords:
- exemplo de código
- caixa de texto
- PowerPoint
...
- Java
- Aspose.Slides
description: "Trabalhe com caixas de texto no Aspose.Slides para Java: adicione, formate, alinhe, quebre linha, ajuste automático e estilize texto usando Java para apresentações PPT, PPTX e ODP."
---
