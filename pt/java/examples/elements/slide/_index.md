...
type: docs
weight: 10
url: /pt/java/examples/elements/slide/
keywords:
- exemplo de código
- slide
- PowerPoint
...
- Java
- Aspose.Slides
description: "Controle slides no Aspose.Slides for Java: crie, clone, reordene, redimensione, defina fundos e aplique transições com Java para apresentações PPT, PPTX e ODP."
---
Este artigo fornece uma série de exemplos que demonstram como trabalhar com slides usando **Aspose.Slides for Java**. Você aprenderá como adicionar, acessar, clonar, reorganizar e remover slides usando a classe `Presentation`.

Cada exemplo abaixo inclui uma breve explicação seguida por um trecho de código em Java.
...
static void accessSlide() {
    ...
    try {
        ...
        // Obtenha o índice do slide a partir de uma referência e, em seguida, acesse-o por índice.
...
Para remover um slide, basta referenciá‑lo e chamar `remove`. Este exemplo adiciona um segundo slide e então remove o original, deixando somente o novo.
