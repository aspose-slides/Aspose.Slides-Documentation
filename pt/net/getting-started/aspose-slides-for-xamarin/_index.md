...
Aqui, referenciamos a biblioteca "Aspose.Slides.Droid.dll" que inclui uma apresentação de exemplo ("HelloWorld.pptx") nos Assets do aplicativo Xamarin e adicionamos sua inicialização ao MainActivity:
