...
- formatação de estilo de junção
...
No PowerPoint, você pode adicionar formas aos slides. Como as formas são compostas por linhas, você pode formatá‑las modificando ou aplicando efeitos aos seus contornos. Além disso, é possível formatar as formas especificando configurações que controlam como seus interiores são preenchidos.

![formatar forma no powerpoint](format-shape-powerpoint.png)
...
1. Defina o [estilo de tracejado](https://reference.aspose.com/slides/pt/net/aspose.slides/linedashstyle/) da linha.
...
using (Presentation presentation = new Presentation())
{
    ...
    // Defina a cor de preenchimento para a forma retângulo.
...
Por padrão, quando o PowerPoint junta duas linhas em um ângulo (por exemplo, no canto de uma forma), ele usa a configuração **Round**. No entanto, se você estiver desenhando uma forma com ângulos agudos, pode preferir a opção **Miter**.

![O estilo de junção na apresentação](join-style-powerpoint.png)

O código C# a seguir demonstra como três retângulos (conforme mostrados na imagem acima) foram criados usando as configurações de tipo de junção Miter, Bevel e Round:
...
No PowerPoint, Preenchimento Gradiente é uma opção de formatação que permite aplicar uma mistura contínua de cores a uma forma. Por exemplo, você pode aplicar duas ou mais cores de modo que uma gradualmente se funde na outra.
...
No PowerPoint, Preenchimento de padrão é uma opção de formatação que permite aplicar um design de duas cores — como pontos, listras, hachuras ou quadriculados — a uma forma. Você pode escolher cores personalizadas para o primeiro plano e o plano de fundo do padrão.
...
- [TileAlignment](https://reference.aspose.com/slides/pt/net/aspose.slides/ipicturefillformat/tilealignment/): Especifica o alinhamento dos blocos dentro da forma.
- [TileFlip](https://reference.aspose.com/slides/pt/net/aspose.slides/ipicturefillformat/tileflip/): Controla se o bloco é invertido horizontalmente, verticalmente ou ambos.
- [TileOffsetX](https://reference.aspose.com/slides/pt/net/aspose.slides/ipicturefillformat/tileoffsetx/): Define o deslocamento horizontal do bloco (em pontos) a partir da origem da forma.
- [TileOffsetY](https://reference.aspose.com/slides/pt/net/aspose.slides/ipicturefillformat/tileoffsety/): Define o deslocamento vertical do bloco (em pontos) a partir da origem da forma.
- [TileScaleX](https://reference.aspose.com/slides/pt/net/aspose.slides/ipicturefillformat/tilescalex/): Define a escala horizontal do bloco como porcentagem.
- [TileScaleY](https://reference.aspose.com/slides/pt/net/aspose.slides/ipicturefillformat/tilescaley/): Define a escala vertical do bloco como porcentagem.

O exemplo de código a seguir mostra como adicionar uma forma retangular com preenchimento de imagem em mosaico e configurar as opções de bloco:
...
Aspose.Slides permite aplicar efeitos de chanfro 3D a formas configurando suas propriedades [ThreeDFormat](https://reference.aspose.com/slides/pt/net/aspose.slides/threedformat/).

Para adicionar efeitos de chanfro 3D a uma forma, siga estas etapas:

1. Instancie a classe [Apresentação](https://reference.aspose.com/slides/pt/net/aspose.slides/presentation/).
1. Obtenha uma referência a um slide pelo seu índice.
1. Adicione um [IAutoShape](https://reference.aspose.com/slides/pt/net/aspose.slides/iautoshape/) ao slide.
1. Configure o [ThreeDFormat](https://reference.aspose.com/slides/pt/net/aspose.slides/threedformat/) da forma para definir as configurações de chanfro.
1. Salve a apresentação.
...
Aspose.Slides permite aplicar efeitos de rotação 3D a formas configurando suas propriedades [ThreeDFormat](https://reference.aspose.com/slides/pt/net/aspose.slides/threedformat/).
...
using (Presentation presentation = new Presentation("sample.pptx"))
{
    ...
    {
        // Redefinir cada forma no slide que possui um marcador de posição no layout.
        slide.Reset();
    }
...
Compare as propriedades chave de formatação de cada forma — preenchimento, linha e configurações de efeito. Se todos os valores correspondentes coincidirem, trate seus estilos como idênticos e agrupe logicamente essas formas, o que simplifica o gerenciamento de estilo posterior.
