...
Esta página lista todas as classes, métodos, propriedades e assim por diante [adicionados](/slides/pt/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) ou [removidos](/slides/pt/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/), e outras alterações introduzidas na API do Aspose.Slides for .NET 15.10.0.

{{% /alert %}} 
## **Alterações da API Pública**
#### **Um Novo VideoPlayerHtmlController Adicionado para Suportar Exportação de Arquivos de Mídia para HTML**
...
``` 
#### **A API de Animação de Série de Gráficos Foi Adicionada**
