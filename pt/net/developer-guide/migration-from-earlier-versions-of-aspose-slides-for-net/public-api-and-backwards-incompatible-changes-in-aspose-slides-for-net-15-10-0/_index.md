---
title: API Pública e Alterações Incompatíveis Retroativas no Aspose.Slides para .NET 15.10.0
linktitle: Aspose.Slides para .NET 15.10.0
type: docs
weight: 200
url: /pt/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/
keywords:
- migração
- código legado
- código moderno
...
Esta página lista todas as classes, métodos, propriedades etc. [adicionados](/slides/pt/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) ou [removidos](/slides/pt/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) e outras alterações introduzidas com a API do Aspose.Slides for .NET 15.10.0.

{{% /alert %}} 
## **Alterações na API Pública**
#### **Um Novo VideoPlayerHtmlController Adicionado para Suportar a Exportação de Arquivos de Mídia para HTML**
A nova classe pública VideoPlayerHtmlController foi adicionada ao namespace Aspose.Slides.Export. Usando uma instância desta classe, o usuário pode exportar arquivos de vídeo e áudio para HTML.  
Os construtores do VideoPlayerHtmlController aceitam os seguintes parâmetros:

path: O caminho onde os arquivos de vídeo e áudio serão gerados  
fileName: O nome do arquivo HTML  
baseUri: O URI base que será usado para gerar links  
...
``` 
#### **A API de Animação de Séries de Gráficos Foi Adicionada**
Os novos 2 métodos foram adicionados à interface Aspose.Slides.Animation.ISequence.
...
Foram introduzidos os dois novos enums EffectChartMajorGroupingType e EffectChartMinorGroupingType relacionados à animação dos elementos do gráfico.
