---
title: Criar um documento de apresentação
type: docs
weight: 60
url: /pt/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // Criar uma apresentação em um caminho de arquivo especificado. O tipo de documento de apresentação é pptx, por padrão.
    ...
    // Fechar o manipulador da apresentação
...

{
...

    {
        ...
        //Instanciar a classe SlideExCollection

        ISlideCollection slds = pres.Slides;

        //Adicionar um slide vazio à coleção SlidesEx
