...
A versão de avaliação do Aspose.Slides (sem uma licença especificada) oferece funcionalidade completa do produto, mas insere uma marca d'água de avaliação no topo do documento ao abrir e salvar. Você também está limitado a um slide ao extrair textos de slides de apresentação.
