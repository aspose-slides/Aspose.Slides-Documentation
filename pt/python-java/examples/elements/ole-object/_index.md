...
- Java
- Aspose.Slides
description: "Use o Aspose.Slides para Python via Java para adicionar, acessar, remover e atualizar objetos OLE em apresentações PowerPoint e OpenDocument."
---
...
Instale o pacote conforme descrito em [Instalação](/slides/pt/python-java/installation/). Cada exemplo importa `asposeslides` antes de iniciar a JVM, e então importa a API depois que a JVM está em execução.
