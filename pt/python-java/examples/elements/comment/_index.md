...
type: docs
weight: 230
url: /pt/python-java/examples/elements/comment/
keywords:
- comentário
- comentário moderno
...
- Java
- Aspose.Slides
description: "Gerencie comentários modernos de slides no Aspose.Slides para Python via Java: adicione, leia, remova e responda a comentários em apresentações PowerPoint e OpenDocument."
---
Este artigo demonstra como adicionar, ler, remover e responder a comentários modernos usando **Aspose.Slides for Python via Java**.

Instale o pacote conforme descrito em [Instalação](/slides/pt/python-java/installation/). Cada exemplo importa `asposeslides` antes de iniciar a JVM, depois importa a API e os tipos Java necessários após a JVM estar em execução. Os exemplos de acesso e remoção utilizam `modern_comment.pptx`, criado pelo primeiro exemplo.
...
Leia o primeiro comentário moderno de uma apresentação existente.
...
Remova o primeiro comentário e salve a apresentação atualizada.
...
Crie um comentário pai, adicione duas respostas e salve a apresentação.
