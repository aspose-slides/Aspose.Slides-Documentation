---
title: Converter apresentações PowerPoint em modo folheto usando Python
...
- Java
- Aspose.Slides
description: "Converter apresentações PowerPoint em folhetos em Python via Java. Organizar vários slides por página e exportar para PDF com Aspose.Slides."
---
## **Introdução**

Aspose.Slides for Python via Java permite exportar apresentações no modo folheto, organizando vários slides em uma única página. Isso é útil para imprimir materiais de apresentação para conferências, seminários e eventos semelhantes.
...
Para definir as dimensões e a orientação da página de folheto antes da exportação, veja [Notes Page Size](/slides/pt/python-java/notes-size/).
...
O exemplo a seguir carrega `sample.pptx` e o exporta para PDF com quatro slides por página em ordem horizontal. Ele inclui números dos slides e molduras ao redor dos slides, e exclui comentários.
...
try:
    # Configurar o layout do folheto.
...
Configurações de layout de folheto se aplicam aos formatos de saída suportados, como PDF, HTML, TIFF e imagens renderizadas. Elas não reorganizam os slides na apresentação original.
{{% /alert %}}
...
Aspose.Slides suporta até nove miniaturas por página. As predefinições [HandoutType](https://reference.aspose.com/slides/pt/python-java/aspose.slides/handouttype/) oferecem um, dois, três, quatro, seis ou nove slides por página. As predefinições de quatro, seis e nove slides oferecem ordenação horizontal e vertical.
...
Sim. Habilite slides ocultos nas configurações de exportação para o formato de destino. Para PDF, chame [PdfOptions.setShowHiddenSlides](https://reference.aspose.com/slides/pt/python-java/aspose.slides/pdfoptions/#setShowHiddenSlides) com `True` antes de salvar a apresentação.