...
- "C++"
- "Aspose.Slides"
description: "Descubra as propriedades de visualização do Aspose.Slides para C++ para personalizar formatos de slides PPT, PPTX e ODP — ajuste layouts, níveis de zoom e configurações de exibição."
---
## **Introdução**
...
O método [IViewProperties::get_NormalViewProperties](https://reference.aspose.com/slides/pt/cpp/aspose.slides/iviewproperties/get_normalviewproperties/) foi adicionado para fornecer acesso às propriedades da visualização normal da apresentação.  
...
A propriedade **SnapVerticalSplitter** especifica se o divisor vertical deve travar em um estado minimizado quando a região lateral estiver suficientemente pequena.
...
1. Defina as View [Properties](https://reference.aspose.com/slides/pt/cpp/aspose.slides/viewproperties/) da apresentação  
...
Sim. Como as [view properties](https://reference.aspose.com/slides/pt/cpp/aspose.slides/presentation/get_viewproperties/) são armazenadas ao nível da apresentação, você pode incorporá‑las em um modelo e criar novos documentos a partir dele com a mesma configuração de visualização inicial.