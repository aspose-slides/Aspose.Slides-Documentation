...
Aspose.Slides permite converter apresentações do PowerPoint em arquivos GIF animados com apenas algumas linhas de código. Isso é útil quando você precisa compartilhar o conteúdo dos slides em um formato animado leve, amplamente suportado, que pode ser incorporado em páginas da web, mensageiros ou documentação. Este artigo explica como exportar uma apresentação para GIF usando as configurações padrão e como personalizar a saída configurando opções como tamanho do quadro, atraso do slide e taxa de quadros de transição por meio da classe [GifOptions](https://reference.aspose.com/slides/pt/cpp/aspose.slides.export/gifoptions/).
...
// por quanto tempo cada slide será exibido até ser trocado para o próximo
gifOptions->set_DefaultDelay(2000);
// aumente o FPS para melhorar a qualidade da animação de transição
...
Você pode conferir um conversor GRATUITO de [Text to GIF](https://products.aspose.app/slides/pt/text-to-gif) desenvolvido pela Aspose. 
...
Instale as fontes ausentes ou [configure fallback fonts](/slides/pt/cpp/powerpoint-fonts/). Aspose.Slides fará a substituição, mas a aparência pode variar. Para branding, sempre garanta que as tipografias necessárias estejam disponíveis explicitamente.

### Posso sobrepor uma marca d'água nos quadros do GIF?

Sim. [Adicione um objeto/logo semitransparente](/slides/pt/cpp/watermark/) ao slide mestre ou a slides individuais antes da exportação — a marca d'água aparecerá em cada quadro.