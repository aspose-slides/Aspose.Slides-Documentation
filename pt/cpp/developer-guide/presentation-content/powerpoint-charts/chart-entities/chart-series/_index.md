...
Com o método [IChartSeries::get_Overlap()](https://reference.aspose.com/slides/pt/cpp/class/aspose.slides.charts.i_chart_series#a5ae56346bd11dc0a2264ff049a3e72bb) você pode especificar quanto barras e colunas devem se sobrepor em um gráfico 2D (intervalo: -100 a 100). Essa propriedade se aplica a todas as séries do grupo de séries principal: isso é uma projeção da propriedade de grupo apropriada.
...
Aspose.Slides for C++ permite que você altere a cor de uma série desta maneira:

1. Crie uma instância da classe [Presentation](https://reference.aspose.com/slides/pt/cpp/class/aspose.slides.presentation).
1. Adicione um gráfico no slide.
1. Acesse a série cuja cor deseja alterar. 
...
## **Alterar a cor de uma categoria da série de dados**
Aspose.Slides for C++ permite que você altere a cor de uma categoria de série desta maneira:

1. Crie uma instância da classe [Presentation](https://reference.aspose.com/slides/pt/cpp/class/aspose.slides.presentation).
1. Adicione um gráfico no slide.
1. Acesse a categoria da série cuja cor deseja alterar.
1. Defina o tipo de preenchimento e a cor de preenchimento desejados.
1. Salve a apresentação modificada.

Este código C++ mostra como alterar a cor de uma categoria de série:
...
Aspose.Slides for C++ permite que você atualize ou altere o nome de uma série nos dados do gráfico e na legenda. 

Este código C++ mostra como alterar o nome de uma série nos dados do gráfico `ChartDataWorkbook`:
...
Aspose.Slides for C++ permite que você defina a cor de preenchimento automática para séries de gráfico dentro de uma área de plotagem desta maneira:
...
## **Definir cores de preenchimento invertidas da série de dados**
Aspose.Slides permite que você defina a cor de preenchimento invertida para séries de gráfico dentro de uma área de plotagem desta maneira:
...
Aspose.Slides permite que você defina inversões através dos métodos `IChartDataPoint::set_InvertIfNegative()` e `ChartDataPoint.set_InvertIfNegative()`. Quando uma inversão é definida usando esses métodos, o ponto de dados inverte suas cores ao receber um valor negativo. 
...
Aspose.Slides for C++ permite que você limpe os dados de `DataPoints` de uma série de gráfico específica desta maneira:
...
Aspose.Slides for C++ permite que você defina a largura do intervalo de uma série através do método **`set_GapWidth()`** desta maneira:
...
Este código C++ mostra como definir a largura do intervalo de uma série:
...
Ajuste a configuração de largura do intervalo para essa série (ou seu grupo de séries pai). Aumentar o valor amplia o espaçamento entre as colunas, enquanto diminui‑lo as aproxima.