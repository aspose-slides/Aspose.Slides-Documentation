...
- C++
- Aspose.Slides
description: "Personalize tabelas de dados de gráficos em C++ para PPT e PPTX com Aspose.Slides para melhorar a eficiência e o apelo em apresentações."
---
## **Visão geral**
...
O Aspose.Slides para C++ permite alterar as propriedades de fonte de uma tabela de dados de gráfico.  
...
Sim. O Aspose.Slides renderiza o gráfico como parte do slide, portanto o exportado [PDF](/slides/pt/cpp/convert-powerpoint-to-pdf/)/[HTML](/slides/pt/cpp/convert-powerpoint-to-html/)/[image](/slides/pt/cpp/convert-powerpoint-to-png/) inclui o gráfico com sua tabela de dados.
...
Inspecione a propriedade de cada gráfico que indica se a tabela de dados [is shown](https://reference.aspose.com/slides/pt/cpp/aspose.slides.charts/chart/get_hasdatatable/) está habilitada e percorra os slides para identificar os gráficos onde está habilitada.