...
Este artigo explica como adicionar linhas de tendência a gráficos de apresentação usando Aspose.Slides. Ele demonstra como criar um gráfico, adicionar linhas de tendência às séries do gráfico e trabalhar com vários tipos de linha de tendência, incluindo exponencial, linear, logarítmica, média móvel, polinomial e de potência.

Também descreve como adicionar uma linha personalizada a um gráfico inserindo uma forma de linha e inclui um breve FAQ sobre os valores de projeção da linha de tendência para frente e para trás e se as linhas de tendência são preservadas durante a exportação para PDF ou SVG e ao renderizar gráficos como imagens.

## **Adicionar uma Linha de Tendência**
Aspose.Slides for C++ fornece uma API simples para gerenciar diferentes linhas de tendência em gráficos:
...
4. Adicionando a linha de tendência exponencial para a série 1 do gráfico.
5. Adicionando uma linha de tendência linear para a série 1 do gráfico.
6. Adicionando uma linha de tendência logarítmica para a série 2 do gráfico.
7. Adicionando uma linha de tendência de média móvel para a série 2 do gráfico.
8. Adicionando uma linha de tendência polinomial para a série 3 do gráfico.
9. Adicionando uma linha de tendência de potência para a série 3 do gráfico.
10. Salve a apresentação modificada em um arquivo PPTX.
...
O Aspose.Slides for C++ fornece uma API simples para adicionar linhas personalizadas em um gráfico. Para adicionar uma linha simples ao slide selecionado da apresentação, siga os passos abaixo:
...
Sim. Aspose.Slides converte apresentações para [PDF](/slides/pt/cpp/convert-powerpoint-to-pdf/)/[SVG](/slides/pt/cpp/render-a-slide-as-an-svg-image/) e renderiza gráficos em imagens; linhas de tendência, como parte do gráfico, são preservadas durante essas operações. Um método também está disponível para [exportar uma imagem do gráfico](/slides/pt/cpp/create-shape-thumbnails/) em si.