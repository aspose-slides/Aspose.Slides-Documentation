...
Um objeto `Paragraph` pode manipular texto com diferentes propriedades de formatação através de seus objetos subjacentes `Portion`.

## **Adicionar Vários Parágrafos Contendo Várias Porções**

Esses passos mostram como adicionar um quadro de texto que contém três parágrafos, cada um com três porções:
...
1. Adicione uma [AutoShape](https://reference.aspose.com/slides/pt/python-net/aspose.slides/autoshape/) retangular ao slide.
1. Obtenha o [TextFrame](https://reference.aspose.com/slides/pt/python-net/aspose.slides/textframe/) associado à [AutoShape](https://reference.aspose.com/slides/pt/python-net/aspose.slides/autoshape/).
...
with slides.Presentation() as presentation:
    ...
    # Adicionar uma AutoShape retangular.
    shape = slide.shapes.add_auto_shape(slides.ShapeType.RECTANGLE, 50, 150, 300, 150)

    # Acessar o TextFrame da AutoShape.
...
1. Adicione uma [AutoShape](https://reference.aspose.com/slides/pt/python-net/aspose.slides/autoshape/) ao slide.
...
1. Defina o recuo do marcador para o parágrafo.
...
with slides.Presentation() as presentation:
    ...
    # Adicionar e acessar uma AutoShape.
    shape = slide.shapes.add_auto_shape(slides.ShapeType.RECTANGLE, 200, 200, 400, 200)

    # Acessar o quadro de texto da AutoShape criada.
    text_frame = shape.text_frame
...
## **Gerenciar Marcadores com Imagem**

Listas de marcadores ajudam a organizar e apresentar informações de forma rápida e eficiente. Marcadores com imagem são fáceis de ler e entender.
...
1. Defina o texto do parágrafo.
1. Defina o recuo do parágrafo para o marcador.
1. Defina a cor do marcador.
...
1. Adicione um segundo parágrafo e repita os passos 8–12.
1. Salve a apresentação.
...
with slides.Presentation() as presentation:
    ...
    # Acessar o TextFrame da AutoShape criada.
...
1. Acesse o slide de destino pelo seu índice.
1. Adicione uma [AutoShape](https://reference.aspose.com/slides/pt/python-net/aspose.slides/autoshape/) ao slide.
1. Acesse o [TextFrame](https://reference.aspose.com/slides/pt/python-net/aspose.slides/textframe/) da [AutoShape](https://reference.aspose.com/slides/pt/python-net/aspose.slides/autoshape/).
1. Remova o parágrafo padrão do [TextFrame](https://reference.aspose.com/slides/pt/python-net/aspose.slides/textframe/).
...
A classe [BulletFormat](https://reference.aspose.com/slides/pt/python-net/aspose.slides/bulletformat/) fornece a propriedade `numbered_bullet_start_with` (e outras) para controlar a numeração e formatação personalizada de parágrafos.
...
Essa formatação é útil para bibliografias, referências, entradas de glossário e outros parágrafos onde as linhas quebradas precisam alinhar-se sob o corpo do parágrafo em vez de sob o primeiro caractere da primeira linha.
...
Quando precisar controlar o estilo do “fim” de um parágrafo (a formatação aplicada após a última porção de texto), use a propriedade `end_paragraph_portion_format`. O exemplo abaixo aplica uma fonte Times New Roman maior ao fim do segundo parágrafo.
...
1. Adicione uma [AutoShape](https://reference.aspose.com/slides/pt/python-net/aspose.slides/autoshape/) retangular ao slide.
1. Use o [TextFrame](https://reference.aspose.com/slides/pt/python-net/aspose.slides/textframe/) da forma e crie duas parágrafos.
1. Crie um [PortionFormat](https://reference.aspose.com/slides/pt/python-net/aspose.slides/portionformat/) definido para Times New Roman 48 pt e aplique-o como o formato de porção de fim de parágrafo do parágrafo.
...
with slides.Presentation() as presentation:
    ...
    # Adicionar uma AutoShape para acomodar o conteúdo HTML.
...
with slides.Presentation("exporting_HTML_text.pptx") as presentation:
    ...
    with open("output.html", "w") as html_stream:
        # Escrever os dados de parágrafos em HTML fornecendo o índice inicial do parágrafo e o número total de parágrafos a exportar.
...
**Posso desativar completamente a quebra de linha dentro de um TextFrame?**

Sim. Use a configuração de quebra de linha do TextFrame ([wrap_text](https://reference.aspose.com/slides/pt/python-net/aspose.slides/textframeformat/wrap_text/)) para desativar a quebra, de modo que as linhas não sejam interrompidas nas bordas do quadro.
...
**Onde o alinhamento de parágrafo (esquerda/direita/centralizado/justificado) é controlado?**
...
Sim. O idioma é definido ao nível da porção ([PortionFormat.language_id](https://reference.aspose.com/slides/pt/python-net/aspose.slides/portionformat/language_id/)), permitindo que múltiplos idiomas coexistam dentro de um único parágrafo.