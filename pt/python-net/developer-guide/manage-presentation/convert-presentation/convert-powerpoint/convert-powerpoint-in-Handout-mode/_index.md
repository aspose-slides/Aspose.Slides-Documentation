...
- Python
- Aspose.Slides
description: "Converta apresentações em folhetos com Python. Defina slides por página, mantenha notas, exporte para PDF ou imagens com Aspose.Slides, com código de exemplo. Experimente gratuitamente."
---
## **Introdução**

O Aspose.Slides fornece a capacidade de converter apresentações em vários formatos, incluindo a criação de folhetos para impressão no modo Handout. Este modo permite configurar como vários slides aparecem em uma única página, sendo útil para conferências, seminários e outros eventos. Você pode ativar este modo definindo a propriedade `slides_layout_options` nas classes [PdfOptions](https://reference.aspose.com/slides/pt/python-net/aspose.slides.export/pdfoptions/), [RenderingOptions](https://reference.aspose.com/slides/pt/python-net/aspose.slides.export/renderingoptions/), [HtmlOptions](https://reference.aspose.com/slides/pt/python-net/aspose.slides.export/htmloptions/) e [TiffOptions](https://reference.aspose.com/slides/pt/python-net/aspose.slides.export/tiffoptions/).

Para definir as dimensões e a orientação da página de folheto antes da exportação, veja [Tamanho da página de notas](/slides/pt/python-net/notes-size/).
...
Abaixo está um exemplo de código mostrando como converter uma apresentação para PDF no modo Handout.
...
Observe que a propriedade `slides_layout_options` está disponível apenas para determinados formatos de saída, como PDF, HTML, TIFF e ao renderizar como imagens.
{{% /alert %}} 
...
O Aspose.Slides oferece [predefinições](https://reference.aspose.com/slides/pt/python-net/aspose.slides.export/handouttype/) de até 9 miniaturas por página com ordenação horizontal ou vertical: 1, 2, 3, 4 (horizontal/vertical), 6 (horizontal/vertical) e 9 (horizontal/vertical).

**Posso definir uma grade personalizada, como 5 ou 8 slides por página?**

Não. O número e a ordem das miniaturas são controlados estritamente pela enumeração [HandoutType](https://reference.aspose.com/slides/pt/python-net/aspose.slides.export/handouttype/); layouts arbitrários não são suportados.
