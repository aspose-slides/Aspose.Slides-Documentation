...
type: docs
weight: 200
url: /pt/androidjava/examples/elements/activex/
keywords:
- exemplo de código
- ActiveX
- PowerPoint
...
- Java
- Aspose.Slides
description: "Veja exemplos de ActiveX do Aspose.Slides for Android: insira, configure e controle objetos ActiveX em apresentações PPT e PPTX com código Java claro."
---
Este artigo demonstra como adicionar, acessar, remover e configurar controles ActiveX em uma apresentação usando **Aspose.Slides for Android via Java**.
