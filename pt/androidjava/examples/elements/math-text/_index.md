...
type: docs
weight: 160
url: /pt/androidjava/examples/elements/math-text/
keywords:
- exemplo de código
- texto matemático
- PowerPoint
...
- Java
- Aspose.Slides
description: "Explore exemplos de Texto Matemático do Aspose.Slides para Android: crie e formate equações, frações, matrizes e símbolos com Java em apresentações PPT, PPTX e ODP."
---
Este artigo demonstra como trabalhar com formas de texto matemático e formatar equações usando **Aspose.Slides for Android via Java**.
...
static void accessMathText() {
    ...
    try {
        ...
        if (mathShape != null) {
            ...
            // Exemplo: crie uma fração (não adicionada aqui).
            IMathElement fraction = new MathematicalText("x").divide("y");
