...
type: docs
weight: 170
url: /pt/androidjava/examples/elements/group-shape/
keywords:
- exemplo de código
- forma de grupo
- PowerPoint
...
- Java
- Aspose.Slides
description: "Gerencie formas agrupadas no Aspose.Slides para Android: crie, aninhe, alinhe, reordene e estilize grupos de formas com exemplos Java em apresentações PPT, PPTX e ODP."
---
Exemplos de como criar grupos de formas, acessá‑los, desagrupar e remover usando **Aspose.Slides for Android via Java**.
