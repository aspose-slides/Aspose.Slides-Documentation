...
type: docs
weight: 240
url: /pt/androidjava/examples/elements/note/
keywords:
- exemplo de código
- nota
- PowerPoint
...
- Java
- Aspose.Slides
description: "Trabalhe com notas de slides no Aspose.Slides para Android: adicione, leia, edite e exporte notas do apresentador em PPT, PPTX e ODP usando exemplos claros em Java."
---
Este artigo demonstra como adicionar, ler, remover e atualizar slides de notas usando **Aspose.Slides for Android via Java**.
