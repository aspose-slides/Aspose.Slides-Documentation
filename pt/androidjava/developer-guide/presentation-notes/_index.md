...
- Java
- Aspose.Slides
description: "Personalize as notas da apresentação com Aspose.Slides para Android via Java. Trabalhe de forma contínua com notas do PowerPoint e OpenDocument para aumentar sua produtividade."
---
## **Visão geral**
...
Notas de todos os slides de uma apresentação podem ser removidas conforme o exemplo abaixo:
...
A biblioteca tem como alvo uma ampla variedade de formatos do Microsoft PowerPoint (97 ou posterior) e ODP; as notas são suportadas nesses formatos sem depender de uma cópia instalada do PowerPoint.