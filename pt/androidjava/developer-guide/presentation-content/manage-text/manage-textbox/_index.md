...
Os textos nos slides geralmente existem em caixas de texto ou formas. Portanto, para adicionar um texto a um slide, você precisa acrescentar uma caixa de texto e então inserir algum texto dentro da caixa. Aspose.Slides for Android via Java fornece a interface [IAutoShape](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/IAutoShape) que permite adicionar uma forma contendo texto.
...
Portanto, ao lidar com uma forma à qual você deseja adicionar texto, pode ser necessário verificar e confirmar que ela foi convertida pela interface `IAutoShape`. Só então você poderá trabalhar com [TextFrame](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/TextFrame), que é uma propriedade de `IAutoShape`. Consulte a seção [Update Text](https://docs.aspose.com/slides/pt/androidjava/manage-textbox/#update-text) nesta página.
{{% /alert %}}
...
5. Por fim, grave o arquivo PPTX usando o objeto `Presentation`. 
...
Em código genérico de processamento de texto, você pode receber um [ITextFrame](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/itextframe/) sem saber previamente qual objeto de apresentação o contém. Use o método [ITextFrame.getParentShape](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/itextframe/#getParentShape--) para navegar de volta ao [IShape](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/ishape/) proprietário.

Para um quadro de texto que pertence a um [IAutoShape](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/iautoshape/) ou outra forma que contenha texto, [ITextFrame.getParentShape](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/itextframe/#getParentShape--) devolve o proprietário e [ITextFrame.getParentCell](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/itextframe/#getParentCell--) devolve `null`. Ambos os métodos fornecem navegação somente‑leitura, portanto chamá‑los não altera a propriedade. Sempre verifique o valor retornado para `null` antes de acessar a forma.

Para um exemplo completo que identifica proprietários de formas e células de tabela, incluindo formas associadas a nós de SmartArt, veja [Pesquisar e Substituir Texto](/slides/pt/androidjava/search-and-replace-text/).

## **Adicionar Colunas a uma Caixa de Texto**

Aspose.Slides fornece as propriedades [ColumnCount](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/ITextFrameFormat#setColumnCount-int-) e [ColumnSpacing](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/ITextFrameFormat#setColumnSpacing-double-) (da interface [ITextFrameFormat](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/ITextFrameFormat) e da classe [TextFrameFormat](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/TextFrameFormat)) que permitem acrescentar colunas às caixas de texto. Você pode especificar o número de colunas em uma caixa de texto e definir o espaçamento, em pontos, entre as colunas.

Este código Java demonstra a operação descrita: 
...
Este código Java demonstra uma operação onde todos os textos de uma apresentação são atualizados ou modificados:
...
Você pode inserir um link dentro de uma caixa de texto. Quando a caixa de texto é clicada, o usuário é direcionado para abrir o link. 
...
5. Obtenha o objeto [IHyperlinkManager](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/ihyperlinkmanager/) a partir do `PortionFormat` da porção desejada do `TextFrame`.
6. Chame [setExternalHyperlinkClick](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/ihyperlinkmanager/#setExternalHyperlinkClick-java.lang.String-) nesse objeto para definir o link que será aberto quando o texto for clicado.
7. Por fim, grave o arquivo PPTX usando o objeto `Presentation`. 

Este código Java—uma implementação das etapas acima—mostra como adicionar uma caixa de texto com um hyperlink a um slide:
...
**Qual a diferença entre uma caixa de texto e um marcador de posição de texto ao trabalhar com slides mestres?**

Um [marcador](/slides/pt/androidjava/manage-placeholder/) herda estilo/posição do [mestre](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/masterslide/) e pode ser sobrescrito nos [layouts](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/layoutslide/), enquanto uma caixa de texto comum é um objeto independente em um slide específico e não muda quando você troca de layout.

**Como posso realizar uma substituição de texto em massa em toda a apresentação sem tocar no texto dentro de gráficos, tabelas e SmartArt?**

Limite sua iteração a formas automáticas que possuam quadros de texto e exclua objetos incorporados ([gráficos](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/chart/), [tabelas](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/table/), [SmartArt](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/smartart/)) percorrendo suas coleções separadamente ou ignorando esses tipos de objeto.