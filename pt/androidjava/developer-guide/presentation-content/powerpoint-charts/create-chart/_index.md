...
- Java
- Aspose.Slides
description: "Criar e personalizar gráficos em apresentações PowerPoint usando Aspose.Slides para Android. Adicionar, formatar e editar gráficos com exemplos práticos de código Java."
---
## **Visão Geral**

Este artigo fornece um guia abrangente sobre como criar e personalizar gráficos usando Aspose.Slides. Você aprenderá a adicionar programaticamente um gráfico a um slide, preenchê‑lo com dados e aplicar várias opções de formatação para atender aos requisitos de design específicos. Ao longo do artigo, exemplos de código detalhados ilustram cada etapa, desde a inicialização da apresentação e do objeto gráfico até a configuração de séries, eixos e legendas. Seguindo este guia, você obterá uma compreensão sólida de como integrar a geração dinâmica de gráficos em suas aplicações, simplificando o processo de criação de apresentações orientadas a dados.

## **Criar um Gráfico**

Gráficos ajudam as pessoas a visualizar rapidamente os dados e obter insights, que podem não ser imediatamente óbvios em uma tabela ou planilha. 


**Por que criar gráficos?**

Ao usar gráficos, você pode
...
* identificar outliers, anomalias, desvios, erros, dados sem sentido, etc. 
* comunicar ou apresentar dados complexos

No PowerPoint, você pode criar gráficos através da função inserir, que fornece modelos usados para projetar diversos tipos de gráficos. Usando Aspose.Slides, você pode criar gráficos regulares (baseados em tipos de gráfico populares) e gráficos personalizados. 
...
3. Adicione um gráfico com alguns dados e especifique o tipo de gráfico preferido. 
...
9. Adicione uma cor de preenchimento para as séries do gráfico.
...
Gráficos de pizza são melhores para mostrar a relação parte‑para‑todo nos dados, especialmente quando os dados contêm rótulos categóricos com valores numéricos. Contudo, se seus dados contêm muitas partes ou rótulos, você pode considerar usar um gráfico de barras em vez disso.
...
8. Adicione novos pontos ao gráfico e cores personalizadas para os setores do gráfico de pizza.
...
try {
    ...
    // Mostra linhas guias para o gráfico
...
Gráficos de linha (também conhecidos como diagramas de linha) são melhores em situações onde você deseja demonstrar mudanças de valor ao longo do tempo. Usando um gráfico de linha, você pode comparar muitos dados de uma vez, acompanhar mudanças e tendências ao longo do tempo, destacar anomalias em séries de dados, etc.
...
Por padrão, os pontos em um gráfico de linha são unidos por linhas contínuas retas. Se você quiser que os pontos sejam unidos por traços em vez disso, pode especificar seu tipo de traço preferido desta forma:
...
Gráficos de mapa de árvore são melhores para dados de vendas quando você deseja mostrar o tamanho relativo das categorias de dados e (ao mesmo tempo) chamar rapidamente a atenção para itens que são grandes contribuidores de cada categoria. 
...
<a name="java-create-stock-chart" id="java-create-stock-chart"><strong><em>Etapas:</em> Criar Gráfico de Ações em Java</strong></a> |
<a name="java-create-powerpoint-stock-chart" id="java-powerpoint-stock-chart"><strong><em>Etapas:</em> Criar Gráfico de Ações PowerPoint em Java</strong></a> |
<a name="java-create-powerpoint-presentation-stock-chart" id="java-create-powerpoint-presentation-stock-chart"><strong><em>Etapas:</em> Criar Gráfico de Ações de Apresentação PowerPoint em Java</strong></a>
...
<a name="java-create-box-and-whisker-chart" id="java-create-box-and-whisker-chart"><strong><em>Etapas:</em> Criar Gráfico de Caixa e Bigode em Java</strong></a> |
<a name="java-create-powerpoint-box-and-whisker-chart" id="java-powerpoint-box-and-whisker-chart"><strong><em>Etapas:</em> Criar Gráfico de Caixa e Bigode PowerPoint em Java</strong></a> |
<a name="java-create-powerpoint-presentation-box-and-whisker-chart" id="java-create-powerpoint-presentation-box-and-whisker-chart"><strong><em>Etapas:</em> Criar Gráfico de Caixa e Bigode de Apresentação PowerPoint em Java</strong></a>
...
<a name="java-create-funnel-chart" id="java-create-funnel-chart"><strong><em>Etapas:</em> Criar Gráfico de Funil em Java</strong></a> |
<a name="java-create-powerpoint-funnel-chart" id="java-create-powerpoint-funnel-chart"><strong><em>Etapas:</em> Criar Gráfico de Funil PowerPoint em Java</strong></a> |
<a name="java-create-powerpoint-presentation-funnel-chart" id="java-create-powerpoint-presentation-funnel-chart"><strong><em>Etapas:</em> Criar Gráfico de Funil de Apresentação PowerPoint em Java</strong></a>
...
O código Java mostra como criar um gráfico de funil:
...
<a name="java-create-histogram-chart" id="java-create-histogram-chart"><strong><em>Etapas:</em> Criar Gráfico de Histograma em Java</strong></a> |
<a name="java-create-powerpoint-histogram-chart" id="java-create-powerpoint-histogram-chart"><strong><em>Etapas:</em> Criar Gráfico de Histograma PowerPoint em Java</strong></a> |
<a name="java-create-powerpoint-presentation-histogram-chart" id="java-create-powerpoint-presentation-histogram-chart"><strong><em>Etapas:</em> Criar Gráfico de Histograma de Apresentação PowerPoint em Java</strong></a>
...
<a name="java-create-powerpoint-multi-category-chart" id="java-create-powerpoint-multi-category-chart"><strong><em>Etapas:</em> Criar Gráfico Multi‑Categoria PowerPoint em Java</strong></a> |
<a name="java-create-powerpoint-presentation-multi-category-chart" id="java-create-powerpoint-presentation-multi-category-chart"><strong><em>Etapas:</em> Criar Gráfico Multi‑Categoria de Apresentação PowerPoint em Java</strong></a>
...
Um gráfico de mapa é uma visualização de uma área contendo dados. Gráficos de mapa são melhores para comparar dados ou valores entre regiões geográficas.
...
1. Instancie a classe [Presentation](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/Presentation) que representa a apresentação contendo o gráfico que você deseja atualizar.
...
1. Instancie a classe [Presentation](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/Presentation) que representa a apresentação contendo o gráfico.
2. Obtenha a referência de um slide por seu índice.
3. Percorra todas as formas para encontrar o gráfico desejado.
...
Aspose.Slides suporta uma ampla gama de [tipos de gráficos](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/charttype/), incluindo barra, linha, pizza, área, dispersão, histograma, radar e muitos mais. Essa flexibilidade permite escolher o tipo de gráfico mais apropriado para suas necessidades de visualização de dados.
...
Você pode atualizar os dados de um gráfico acessando sua planilha de dados ([IChartDataWorkbook](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/ichartdataworkbook/)), limpando quaisquer séries e categorias padrão e, em seguida, adicionando seus dados personalizados. Isso permite refrescar o gráfico para refletir os dados mais recentes.

### É possível personalizar a aparência do gráfico?

Sim, Aspose.Slides fornece opções extensas de personalização. Você pode modificar cores, fontes, rótulos, legendas e outros [elementos de formatação](/slides/pt/androidjava/chart-entities/) para adequar a aparência do gráfico aos requisitos específicos de design.