---
title: Personalizar Barras de Erro em Gráficos de Apresentação no Android
linktitle: Barra de Erro
type: docs
url: /pt/androidjava/error-bar/
keywords:
- barra de erro
- valor personalizado
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aprenda a adicionar e personalizar barras de erro em gráficos com Aspose.Slides for Android via Java — otimize visualizações de dados em apresentações PowerPoint."
---
## **Visão Geral**
...
Aspose.Slides for Android via Java fornece uma API simples para gerenciar valores personalizados de barra de erro. O código de exemplo se aplica quando a propriedade [**IErrorBarsFormat.ValueType**](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/IErrorBarsFormat#getValue--) é igual a **Custom**. Para especificar um valor, use a propriedade **ErrorBarCustomValues** de um ponto de dados específico na coleção [**DataPoints**](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/IChartSeriesCollection) da série:
...
try {
    ...
    // Acessando o ponto de dados da série de gráfico e definindo valores das barras de erro para
    // ponto individual
...
Na referência da API: a classe [ErrorBarsFormat](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/errorbarsformat/) e as classes relacionadas [ErrorBarType](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/errorbartype/) e [ErrorBarValueType](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/errorbarvaluetype/).