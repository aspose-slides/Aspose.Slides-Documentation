---
title: "Formatar Gráficos de Apresentação no Android"
linktitle: "Formatação de Gráficos"
type: docs
weight: 60
url: /pt/androidjava/chart-formatting/
keywords:
  - "formatar gráfico"
  ...
  - "Java"
  - "Aspose.Slides"
description: "Aprenda a formatação de gráficos no Aspose.Slides para Android via Java e eleve sua apresentação PowerPoint com um estilo profissional e atraente."
---
## **Visão geral**

Este artigo explica como formatar gráficos em apresentações do PowerPoint usando o Aspose.Slides. Ele mostra como personalizar elementos importantes do gráfico, como eixos, linhas de grade, títulos, legendas, a área de plotagem e os preenchimentos de parede, para melhorar a aparência e a legibilidade dos dados do gráfico.
...
Aspose.Slides for Android via Java permite que desenvolvedores adicionem gráficos personalizados aos seus slides do zero. Este artigo explica como formatar diferentes entidades de gráfico, incluindo o eixo de categoria e o eixo de valores.

Aspose.Slides for Android via Java fornece uma API simples para gerenciar diferentes entidades de gráfico e formatá‑las usando valores personalizados:
...
1. Acesse o eixo de Valores do gráfico e defina as seguintes propriedades:
   1. Definir **Line format** para as linhas de grade principais do eixo de Valores
   1. Definir **Line format** para as linhas de grade secundárias do eixo de Valores
...
1. Acesse o eixo de Categoria do gráfico e defina as seguintes propriedades:
   1. Definir **Line format** para as linhas de grade principais do eixo de Categoria
   1. Definir **Line format** para as linhas de grade secundárias do eixo de Categoria
...
1. Agora trace a primeira série de gráfico no eixo de Valores secundário
...
try {
    ...
    // Defina a exibição das legendas do gráfico sem sobrepor o gráfico
...
Aspose.Slides for Android via Java oferece suporte para definir as propriedades relacionadas à fonte para o gráfico. Siga os passos abaixo para definir as propriedades de fonte do gráfico.

- Instancie o objeto da classe [Presentation](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/presentation/).
- Adicione um gráfico no slide.
- Defina a altura da fonte.
- Salve a apresentação modificada.

A seguir, exemplo de amostra é apresentado.
...
Aspose.Slides for Android via Java fornece uma API simples para gerenciar o formato de dados do gráfico:
...
1. Percorra a célula de dados do gráfico em cada série de gráfico e defina o formato numérico dos dados do gráfico.
1. Salve a apresentação.
1. Defina o formato numérico personalizado.
1. Percorra a célula de dados do gráfico em cada série de gráfico e defina um formato numérico de dados diferente.
1. Salve a apresentação.
...
try {
    ...
    {
        // Percorrendo todas as células de dados na série
...
Os possíveis valores de formato numérico predefinido, juntamente com seu índice predefinido e que podem ser usados, são apresentados abaixo:
...
Aspose.Slides for Android via Java oferece suporte para definir a área do gráfico. Métodos [**hasRoundedCorners**](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/IChart#hasRoundedCorners--) e [**setRoundedCorners**](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/IChart#setRoundedCorners-boolean-) foram adicionados à interface [IChart](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/IChart) e à classe [Chart](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/Chart).
