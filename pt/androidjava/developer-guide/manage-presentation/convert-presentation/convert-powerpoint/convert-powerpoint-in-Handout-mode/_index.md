...
- Java
- Aspose.Slides
description: "Converta apresentações em folhetos em Java. Defina slides por página, mantenha as notas, exporte para PDF ou imagens com Aspose.Slides para Android, com código de exemplo. Experimente grátis."
---
## **Introdução**
...
Para definir as dimensões e a orientação da página de folheto antes da exportação, veja [Tamanho da Página de Notas](/slides/pt/androidjava/notes-size/).
...
Abaixo está um exemplo de código que demonstra como converter uma apresentação em PDF no modo Handout.
...
Observe que o método `setSlidesLayoutOptions` está disponível apenas para certos formatos de saída, como PDF, HTML, TIFF e ao renderizar como imagens.
{{% /alert %}} 
...
Aspose.Slides suporta [presets](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/handouttype/) de até 9 miniaturas por página com ordenação horizontal ou vertical: 1, 2, 3, 4 (horizontal/vertical), 6 (horizontal/vertical) e 9 (horizontal/vertical).

**Posso definir uma grade personalizada, como 5 ou 8 slides por página?**

Não. O número e a ordenação das miniaturas são controlados estritamente pela classe [HandoutType](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/handouttype/); layouts arbitrários não são suportados.
