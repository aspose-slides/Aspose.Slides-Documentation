...
O Aspose.Slides suporta [predefinições](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/handouttype/) de até 9 miniaturas por página com ordenação horizontal ou vertical: 1, 2, 3, 4 (horizontal/vertical), 6 (horizontal/vertical) e 9 (horizontal/vertical).
