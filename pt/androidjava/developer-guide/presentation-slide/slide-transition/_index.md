...
- Java
- Aspose.Slides
description: "Descubra como personalizar transições de slides no Aspose.Slides para Android via Java, com orientação passo a passo para apresentações PowerPoint e OpenDocument."
---
## **Visão geral**
...
1. Aplique um Slide Transition Type no slide a partir de um dos efeitos de transição oferecidos pela Aspose.Slides para Android via Java por meio do enum TransitionType
1. Grave o arquivo de apresentação modificado.

```java
// Instanciar classe Presentation para carregar o arquivo de apresentação fonte
...
Na seção acima, aplicamos apenas um efeito de transição simples ao slide. Agora, para tornar esse efeito de transição simples ainda melhor e controlado, siga os passos abaixo:

1. Crie uma instância da classe [Presentation](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/presentation).
1. Aplique um Slide Transition Type no slide a partir de um dos efeitos de transição oferecidos pela Aspose.Slides para Android via Java
1. Você também pode definir a transição para Avançar ao Clicar, após um período de tempo específico ou ambos.
1. Se a transição de slide estiver habilitada para Avançar ao Clicar, a transição avançará somente quando alguém clicar o mouse. Além disso, se a propriedade Advance After Time estiver definida, a transição avançará automaticamente após o tempo especificado.
1. Grave a apresentação modificada como um arquivo de apresentação.

```java
// Instanciar classe Presentation que representa um arquivo de apresentação
...
Aspose.Slides para Android via Java agora suporta a [Morph Transition](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/IMorphTransition). Elas representam a nova transição morph introduzida no PowerPoint 2019.

{{% /alert %}} 

A transição Morph permite animar um movimento suave de um slide para o próximo. Este artigo descreve o conceito e como usar a transição Morph. Para usar a transição Morph de forma eficaz, você precisará ter dois slides com pelo menos um objeto em comum. A maneira mais fácil é duplicar o slide e depois mover o objeto no segundo slide para outro local.

O trecho de código a seguir mostra como adicionar um clone do slide com algum texto à apresentação e definir uma transição do [tipo morph](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/TransitionType) ao segundo slide.
...
Aspose.Slides para Android via Java suporta a definição dos efeitos de transição, como de preto, da esquerda, da direita etc. Para definir o Efeito de Transição, siga os passos abaixo:
