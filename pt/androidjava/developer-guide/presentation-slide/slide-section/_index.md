...
- Java
- Aspose.Slides
description: "Gerencie seções de slides com Aspose.Slides for Android via Java: criar, renomear, reordenar, recuperar e processar slides de seção em apresentações PPTX."
---
## **Introdução**

Seções organizam slides consecutivos em grupos nomeados sem alterar o conteúdo dos slides. Com Aspose.Slides for Android via Java, você pode criar, reordenar, renomear, inspecionar e remover seções através do método [Presentation.getSections](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/presentation/#getSections--).
...
Use [ISectionCollection.addSection](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isectioncollection/#addSection-java.lang.String-com.aspose.slides.ISlide-) para criar uma seção especificando seu nome e slide inicial. Aspose.Slides determina quais slides pertencem à seção a partir da estrutura de seções atual da apresentação.

A mesma [ISectionCollection](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isectioncollection/) também permite:

- mover uma seção junto com seus slides usando [ISectionCollection.reorderSectionWithSlides](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isectioncollection/#reorderSectionWithSlides-com.aspose.slides.ISection-int-);
- remover apenas a definição da seção com [ISectionCollection.removeSection](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isectioncollection/#removeSection-com.aspose.slides.ISection-), que mantém seus slides;
- remover uma seção e seus slides com [ISectionCollection.removeSectionWithSlides](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isectioncollection/#removeSectionWithSlides-com.aspose.slides.ISection-);
- adicionar uma seção vazia ao final com [ISectionCollection.appendEmptySection](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isectioncollection/#appendEmptySection-java.lang.String-).
...
Para renomear uma seção, chame o método [ISection.setName](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isection/#setName-java.lang.String-) dela. Os slides e a posição da seção permanecem inalterados.
...
O método [Presentation.getSections](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/presentation/#getSections--) retorna uma [ISectionCollection](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isectioncollection/) que pode ser iterada. Para cada [ISection](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isection/), chame [ISection.getSlidesListOfSection](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isection/#getSlidesListOfSection--) para obter os slides que atualmente pertencem a ela. O método retorna uma [ISectionSlideCollection](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isectionslidecollection/), que fornece contagem, acesso indexado e iteração.

O exemplo a seguir cria duas seções preenchidas e uma seção vazia, depois imprime o [nome](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isection/#getName--), [identificador](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isection/#getSectionId--), [slide inicial](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isection/#getStartedFromSlide--), contagem de slides e números dos slides de cada seção. Ele usa [ISectionSlideCollection.get_Item](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isectionslidecollection/#get_Item-int-) para ler o primeiro slide e uma instrução `for` aprimorada para processar cada slide. Para a seção vazia, a coleção retornada tem tamanho zero, o método não é chamado e a iteração não realiza nenhuma operação.
...
A associação de seção é determinada pela estrutura de seções da apresentação. Não calcule manualmente o intervalo de uma seção a partir de [ISection.getStartedFromSlide](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isection/#getStartedFromSlide--), índices de slides e do slide inicial da seção seguinte.
...
O formato PPT (PowerPoint 97–2003) não preserva metadados de seção. Use este fluxo de trabalho com um formato que suporte seções, como PPTX; converter para PPT remove a estrutura de seção necessária para iteração posterior.
...
Não. Uma seção não tem estado de visibilidade. Para ocultar seu conteúdo, chame [ISlide.setHidden](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/islide/#setHidden-boolean-) para cada slide na seção.

**Como posso encontrar a seção que contém um slide?**

Itere sobre a coleção retornada por [Presentation.getSections](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/presentation/#getSections--), chame [ISection.getSlidesListOfSection](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isection/#getSlidesListOfSection--) para cada seção e compare os slides retornados com o slide alvo. Para uma seção não vazia, [ISection.getStartedFromSlide](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/isection/#getStartedFromSlide--) retorna seu primeiro slide; para uma seção vazia, retorna `null`.