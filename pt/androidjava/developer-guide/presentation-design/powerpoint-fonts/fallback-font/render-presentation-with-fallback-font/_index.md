---
title: Renderizar apresentações com fontes de fallback no Android
...
- Java
- Aspose.Slides
description: "Renderize apresentações com fontes de fallback no Aspose.Slides para Android – mantenha o texto consistente em PPT, PPTX e ODP com exemplos de código Java passo a passo."
---
## **Visão geral**
...
1. Nós [criar coleção de regras de fonte de fallback](/slides/pt/androidjava/create-fallback-fonts-collection/).
1. [Remove](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/FontFallBackRule#remove-java.lang.String-) uma regra de fonte de fallback e [addFallBackFonts](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/FontFallBackRule#addFallBackFonts-java.lang.String-) a outra regra.
1. Defina a coleção de regras para [getFontsManager](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/Presentation#getFontsManager--).[getFontFallBackRulesCollection](https://reference.aspose.com/slides/pt/androidjava/com.aspose.slides/FontsManager#getFontFallBackRulesCollection--) método.
...
{{% alert color="primary" %}} 
Leia mais sobre [Converter PPT e PPTX para JPG no Android](/slides/pt/androidjava/convert-powerpoint-to-jpg/).
{{% /alert %}}