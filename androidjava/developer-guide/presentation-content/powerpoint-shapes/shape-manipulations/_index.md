...
## **Clone Shape**
To clone a shape to a slide using title: Aspose.Slides for Android via Java:
...
## **Remove Shape**
title: Aspose.Slides for Android via Java allows developers to remove any shape. To remove the shape from any slide, please follow the steps below:
...
## **Hide Shape**
title: Aspose.Slides for Android via Java allows developers to hide any shape. To hide the shape from any slide, please follow the steps below:
...
## **Change Shapes Order**
title: Aspose.Slides for Android via Java allows developers to reorder the shapes. Reordering the shape specifies which shape is on the front or which shape is at the back. To reorder the shape from any slide, please follow the steps below:
...
title: Aspose.Slides for Android via Java allows developers to set AlternateText of any shape.
...
title: Aspose.Slides for Android via Java provides a simple API to access layout formats for a shape. This article demonstrates how you can access layout formats.
