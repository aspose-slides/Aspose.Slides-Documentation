...
{{% alert color="primary" %}} 
اقرأ المزيد حول كيفية [عرض عرض تقديمي بخط احتياطي](/slides/python-net/render-presentation-with-fallback-font/).
{{% /alert %}}