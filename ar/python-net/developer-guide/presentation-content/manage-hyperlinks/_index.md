...
- presentation
- Python
description: "إدارة الروابط التشعبية بسهولة في عروض PowerPoint وOpenDocument باستخدام Aspose.Slides للغة Python عبر .NET—عزّز التفاعل وسير العمل في دقائق."
---

## **نظرة عامة**

الرابط التشعبي هو مرجع إلى مصدر خارجي، كائن أو عنصر بيانات، أو موقع محدد داخل ملف. تشمل أنواع الروابط التشعبية الشائعة في عروض PowerPoint:

* الروابط إلى المواقع الإلكترونية المدمجة في النص أو الأشكال أو الوسائط
* الروابط إلى الشرائح

تمكِّن Aspose.Slides للغة Python عبر .NET من تنفيذ مجموعة واسعة من العمليات المتعلقة بالروابط التشعبية في العروض التقديمية.

## **إضافة روابط URL**

تشرح هذه الفقرة كيفيّة إضافة روابط URL إلى عناصر الشريحة عند العمل مع Aspose.Slides. يغطي تعيين عناوين الروابط إلى النصوص، الأشكال، والصور لضمان تنقل سلس أثناء العرض.

### **إضافة روابط URL إلى النص**

يوضح مثال الشيفرة التالي كيفية إضافة رابط موقع ويب إلى نص:
...
يوضح مثال الشيفرة التالي كيفية إضافة رابط موقع ويب إلى شكل:
...
تسمح Aspose.Slides لك بإضافة روابط تشعبية إلى الصور، ملفات الصوت، وفيديو.

يوضح مثال الشيفرة التالي كيفية إضافة رابط تشعبي إلى **صورة**:
...
يوضح مثال الشيفرة التالي كيفية إضافة رابط تشعبي إلى **ملف صوتي**:
...
يوضح مثال الشيفرة التالي كيفية إضافة رابط تشعبي إلى **فيديو**:
...
نظرًا لأن الروابط التشعبية تسمح لك بالإشارة إلى كائنات أو مواقع، يمكنك استخدامها لبناء جدول محتويات.

يظهر الكود التالي كيفية إنشاء جدول محتويات مع روابط تشعبية:
...
تُظهر هذه الفقرة كيفية تنسيق مظهر الروابط التشعبية في Aspose.Slides. ستتعلم كيفية التحكم في اللون وخيارات النمط الأخرى للحفاظ على تنسيق الروابط موحدًا عبر النصوص، الأشكال، والصور.

### **لون الرابط**

باستخدام الخاصية [color_source](https://reference.aspose.com/slides/python-net/aspose.slides/hyperlink/color_source/) من فئة [Hyperlink](https://reference.aspose.com/slides/python-net/aspose.slides/hyperlink/)، يمكنك تعيين لون الرابط وقراءة معلومات اللون الخاصة به. تم تقديم هذه الميزة في PowerPoint 2019، لذا فإن التغييرات التي تُجرى عبر هذه الخاصية لا تُطبق على إصدارات PowerPoint السابقة.
...
## **إزالة الروابط من العروض التقديمية**

تشرح هذه الفقرة كيفية إزالة الروابط التشعبية من العروض التقديمية عند العمل مع Aspose.Slides. ستتعلم كيفية مسح أهداف الروابط من النصوص، الأشكال، والصور مع الحفاظ على المحتوى الأصلي وتنسيقه.

### **إزالة الروابط من النص**

يعرض الكود التالي كيفية إزالة الروابط التشعبية من نص داخل شريحة عرض تقديمي:
...
### **إزالة الروابط من الأشكال أو الإطارات**

يعرض الكود التالي كيفية إزالة الروابط التشعبية من الأشكال داخل شريحة عرض تقديمي:
...
يوضح الجزء التالي كيفية إضافة رابط إلى شريحة ثم تعديل تلميحه:
...
يمكنك الوصول إلى [HyperlinkQueries](https://reference.aspose.com/slides/python-net/aspose.slides/hyperlinkqueries/) من العرض التقديمي أو الشريحة أو النص الذي يحتوي على الرابط.
...
قد ترغب في تجربة محرر PowerPoint المجاني البسيط عبر الإنترنت من Aspose [PowerPoint editor](https://products.aspose.app/slides/editor).
...
الأقسام في PowerPoint هي تجميعات للشرائح؛ التنقل يستهدف تقنيًا شريحة محددة. للتنقل إلى قسم، عادةً ما تُربط بالشرائح الأولى في ذلك القسم.

**هل يمكنني إرفاق رابط تشعبي إلى عناصر الشريحة الرئيسية بحيث يعمل على جميع الشرائح؟**

نعم. تدعم عناصر الشريحة الرئيسية والقالب الروابط التشعبية. تظهر هذه الروابط على الشرائح الفرعية وتكون قابلة للنقر أثناء عرض الشرائح.

**هل سيتم الحفاظ على الروابط التشعبية عند التصدير إلى PDF أو HTML أو صور أو فيديو؟**

في [PDF](/slides/ar/python-net/convert-powerpoint-to-pdf/) و[HTML](/slides/ar/python-net/convert-powerpoint-to-html/)، نعم—عادةً ما تُحافظ على الروابط. عند التصدير إلى [الصور](/slides/ar/python-net/convert-powerpoint-to-png/) و[الفيديو](/slides/ar/python-net/convert-powerpoint-to-video/)، لن تُنقل قابلية النقر بسبب طبيعة هذه الصيغ (الإطارات النقطية/الفيديو لا تدعم الروابط).