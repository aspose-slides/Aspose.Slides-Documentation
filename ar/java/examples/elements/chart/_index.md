...
type: docs
weight: 60
url: /ar/java/examples/elements/chart/
keywords:
- مثال على الشيفرة
- مخطط
- PowerPoint
...
- Java
- Aspose.Slides
description: "إتقان المخططات باستخدام Aspose.Slides for Java: إنشاء، تنسيق، ربط البيانات، وتصدير المخططات بصيغ PPT و PPTX و ODP مع أمثلة Java."
---
أمثلة لإضافة، الوصول، إزالة، وتحديث أنواع المخططات المختلفة باستخدام **Aspose.Slides for Java**. تُظهر المقاطع البرمجية أدناه عمليات المخططات الأساسية.
...
الكود التالي يزيل مخططًا من الشريحة.
