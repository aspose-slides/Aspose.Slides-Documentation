...
ثم يمكن تعيين هذه المجموعة إلى [FontFallBackRulesCollection](https://reference.aspose.com/slides/php-java/aspose.slides/FontFallBackRulesCollection) طريقة من فئة [FontsManager](https://reference.aspose.com/slides/php-java/aspose.slides/FontsManager) . يتحكم FontsManager في الخطوط عبر العرض التقديمي. اقرأ المزيد [حول FontsManager و FontsLoader](/slides/php-java/about-fontsmanager-and-fontsloader/).
...
{{% alert color="primary" %}} 
اقرأ المزيد حول كيفية [عرض العرض التقديمي بخط احتياطي](/slides/php-java/render-presentation-with-fallback-font/).
{{% /alert %}}