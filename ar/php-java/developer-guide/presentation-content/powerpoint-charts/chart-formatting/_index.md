...
- PHP
- Aspose.Slides
description: "تعلم تنسيق المخططات في Aspose.Slides for PHP عبر Java ورفع عرض PowerPoint الخاص بك بتصميم محترف وجذاب."
---
...
1. الوصول إلى محور قيم المخطط وضبط الخصائص التالية:
   1. ضبط **Line format** لخطوط الشبكة الرئيسية لمحور القيم
   1. ضبط **Line format** لخطوط الشبكة الفرعية لمحور القيم
   1. ضبط **Number Format** لمحور القيم
   1. ضبط **Min, Max, Major and Minor units** لمحور القيم
   1. ضبط **Text Properties** لبيانات محور القيم
   1. ضبط **Title** لمحور القيم
   1. ضبط **Line Format** لمحور القيم
1. الوصول إلى محور الفئة للمخطط وضبط الخصائص التالية:
   1. ضبط **Line format** لخطوط الشبكة الرئيسية لمحور الفئة
   1. ضبط **Line format** لخطوط الشبكة الفرعية لمحور الفئة
...
1. الوصول إلى وسيلة إيضاح المخطط وضبط **Text Properties** لها
1. تعيين عرض وسيلة إيضاح المخطط دون تداخل المخطط
1. الوصول إلى **Secondary Value Axis** للمخطط وضبط الخصائص التالية:
   1. تمكين **Value Axis** الثانوي
   1. ضبط **Line Format** ل**Secondary Value Axis**
   1. ضبط **Number Format** ل**Secondary Value Axis**
   1. ضبط **Min, Max, Major and Minor units** ل**Secondary Value Axis**
1. الآن قم برسم السلسلة الأولى للمخطط على **Secondary Value Axis**
...
1. الحصول على مرجع الشريحة حسب فهرسها.
1. إضافة مخطط ببيانات افتراضية مع أي نوع مرغوب (في هذا المثال يستخدم **ChartType::ClusteredColumn**).
1. تعيين تنسيق الأرقام المسبق من القيم المسبقة المتاحة.
1. المرور عبر خلية بيانات المخطط في كل سلسلة مخطط وتعيين تنسيق رقم بيانات المخطط.
1. حفظ العرض.
1. تعيين تنسيق الأرقام المخصص.
1. المرور عبر خلية بيانات المخطط داخل كل سلسلة مخطط وتعيين تنسيق رقم بيانات مختلف.
1. حفظ العرض.
```php
  # إنشاء مثيل من فئة Presentation class
  $pres = new Presentation();
