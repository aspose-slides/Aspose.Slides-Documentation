...
تحتوي هذه الجدول على تنسيقات الملفات التي يمكن لـ Aspose.Slides لـ PHP عبر Java تحميلها وحفظها:
...
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|عرض PowerPoint مع الماكرو|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|عرض PowerPoint مع الماكرو|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[POTM](https://docs.fileformat.com/presentation/potm/)|قالب PowerPoint مع الماكرو|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|تنسيق ملف الصورة المقسم| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|تنسيق الملف المتقدم| |{{< emoticons/tick >}}| |
...
|[JPEG](https://docs.fileformat.com/image/jpeg/)|مجموعة الخبراء الفوتوغرافيين المشتركة| |{{< emoticons/tick >}}| |
|[PNG](https://docs.fileformat.com/image/png/)|رسوميات الشبكة المحمولة| |{{< emoticons/tick >}}| |
|[GIF](https://docs.fileformat.com/image/gif/)|تنسيق تبادل الرسومات| |{{< emoticons/tick >}}| |
|[BMP](https://docs.fileformat.com/image/bmp/)|بت مميز مستقل عن الجهاز| |{{< emoticons/tick >}}| |
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|رسوميات متجهة قابلة للتوسع| |{{< emoticons/tick >}}| |
...
|[XML](https://docs.fileformat.com/web/xml/)|عرض PowerPoint بصيغة XML| |{{< emoticons/tick >}}| |