...
## **تنسقات الملفات المدعومة**
تحتوي هذه الجدول على تنسيقات الملفات التي يمكن لـ Aspose.Slides لـ Node.js عبر .NET تحميلها وحفظها:
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|تنسيق ملف الصورة المميز| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|تنسيق ملف ميتا معزز| |{{< emoticons/tick >}}| |
|[PDF](https://docs.fileformat.com/pdf/)|تنسيق مستند قابل للنقل|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[BMP](https://docs.fileformat.com/image/bmp/)|صورة بتنسيق مستقل عن الجهاز| |{{< emoticons/tick >}}| |
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|رسومات متجهة قابلة للتوسع| |{{< emoticons/tick >}}| |
...
|[XAML](https://docs.fileformat.com/web/xaml/)|لغة ترميز التطبيقات الموسعة| |{{< emoticons/tick >}}| |
