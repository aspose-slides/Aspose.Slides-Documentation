...
**مرحبًا بكم في Aspose.Slides لـ Node.js عبر .NET**

![شعار منتج Aspose.Slides لـ Node.js عبر .NET](aspose_slides-for-nodejs-via-net.png)

Aspose.Slides لـ Node.js عبر .NET هي مكتبة فئة تمكن تطبيقاتك من قراءة وكتابة مستندات PowerPoint® بدون استخدام Microsoft PowerPoint®.

Aspose.Slides لـ Node.js عبر .NET هو المكون الأول والوحيد الذي يوفر الوظائف لإدارة مستندات PowerPoint®.

يوفر Aspose.Slides لـ Node.js عبر .NET الكثير من الميزات الرئيسية مثل إدارة النصوص والأشكال والجداول والرسوم المتحركة، وإضافة الصوت والفيديو إلى الشرائح، ومعاينة الشرائح، وتصدير الشرائح إلى SVG، وصيغة PDF والمزيد.

{{% /alert %}}

## موارد Aspose.Slides لـ Node.js عبر .NET

{{% alert color="primary" %}}

تم نقل Aspose.Slides لـ Node.js عبر .NET من Aspose.Slides لـ .NET، لذا يمكنك استخدام توثيق وآفاق API الأخيرة.
