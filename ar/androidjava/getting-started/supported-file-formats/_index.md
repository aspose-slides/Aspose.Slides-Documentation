...
- Microsoft PowerPoint لنظام ماك
- Office 365

## **تنسيقات الملفات المدعومة**
تحتوي هذه الجدول على تنسيقات الملفات التي يمكن لـ Aspose.Slides لنظام Android عبر Java تحميلها وحفظها:
...
|[EMF](https://docs.fileformat.com/image/emf/)|تنسيق ملف الميتا المحسن| |{{< emoticons/tick >}}| |
|[PDF](https://docs.fileformat.com/pdf/)|تنسيق المستندات القابل للنقل|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|مواصفات ورق XML| |{{< emoticons/tick >}}| |
|[JPEG](https://docs.fileformat.com/image/jpeg/)|مجموعة خبراء التصوير الرقمية| |{{< emoticons/tick >}}| |
...
|[BMP](https://docs.fileformat.com/image/bmp/)|صورة بدون اعتماد على الجهاز| |{{< emoticons/tick >}}| |
