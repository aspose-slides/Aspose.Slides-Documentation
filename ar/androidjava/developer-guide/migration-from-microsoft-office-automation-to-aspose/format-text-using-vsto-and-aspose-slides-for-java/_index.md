...
{{% /alert %}} 
## **تنسيق النصوص**
تتضمن طرق VSTO و Aspose.Slides الخطوات التالية:
...
تظهر لقطات الشاشة أدناه الشريحة النموذجية قبل وبعد تنفيذ كود VSTO و Aspose.Slides لأندرويد عبر جافا.
...
### **مثال Aspose.Slides لأندرويد عبر جافا**
