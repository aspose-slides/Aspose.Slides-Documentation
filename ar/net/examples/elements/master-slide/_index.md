...
- C#
- Aspose.Slides
description: "إدارة الشرائح الرئيسية في C# باستخدام Aspose.Slides: إنشاء، تعديل، استنساخ، وتنسيق السمات، الخلفيات، العناصر النائبة لتوحيد الشرائح في PowerPoint وOpenDocument."
---
