...
- C#
- Aspose.Slides
description: "العمل مع ماكرو VBA في C# باستخدام Aspose.Slides: إضافة أو تعديل المشاريع والوحدات، توقيع أو إزالة الماكرو، وحفظ العروض التقديمية بصيغ PPT و PPTX و ODP."
---

يوضح كيفية إضافة، الوصول، وإزالة وحدات ماكرو VBA باستخدام **Aspose.Slides for .NET**.
...
استرداد الوحدة الأولى من مشروع VBA.
```csharp
