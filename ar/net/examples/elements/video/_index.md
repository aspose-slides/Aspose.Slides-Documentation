...
- C#
- Aspose.Slides
description: "العمل مع الفيديو في C# باستخدام Aspose.Slides: إدراج، استبدال، قص، تعيين إطارات بوستر وخيارات التشغيل، وتصدير العروض التقديمية إلى PPT، PPTX و ODP."
---
...
تكوين الفيديو للتشغيل تلقائيًا عندما يتم عرض الشريحة.
```csharp
