...
{{% alert color="primary" %}} 
اقرأ المزيد عن كيفية [عرض العرض التقديمي باستخدام خط احتياطي](/slides/net/render-presentation-with-fallback-font/).
{{% /alert %}}