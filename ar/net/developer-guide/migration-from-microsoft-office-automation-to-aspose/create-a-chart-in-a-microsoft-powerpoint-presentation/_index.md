...
- C#
- Aspose.Slides
description: "تعلم كيفية أتمتة إنشاء مخططات PowerPoint في C#. يوضح هذا الدليل خطوة بخطوة لماذا Aspose.Slides لـ .NET هو بديل أسرع وأكثر قوة لـ Microsoft.Office.Interop."
---

## **نظرة عامة**

توضح هذه المقالة كيفية إنشاء المخططات وتخصيصها في عروض Microsoft PowerPoint برمجيًا باستخدام C#. باستخدام Aspose.Slides for .NET، يمكنك أتمتة إنشاء مخططات مهنية تعتمد على البيانات دون الاعتماد على Microsoft Office أو مكتبات Interop. توفر الواجهة مجموعة غنية من الميزات لبناء مخططات الأعمدة، مخططات الدائرة، المخططات الخطية، والمزيد — مع التحكم الكامل في المظهر والبيانات والتخطيط. سواء كنت تُنشئ تقارير أو لوحات تحكم أو عروض أعمال، تساعدك Aspose.Slides على تقديم تصورات عالية الجودة مباشرةً من تطبيقات .NET الخاصة بك.

## **مثال VSTO**

يعرض هذا القسم كيفية إنشاء مخطط في عرض Microsoft PowerPoint باستخدام **VSTO (Visual Studio Tools for Office)**. باستخدام VSTO، يمكنك إنشاء وتخصيص المخططات برمجيًا عن طريق دمج أتمتة PowerPoint وExcel. يوضح المثال المرفق كيفية إضافة **مخطط أعمدة ثلاثي الأبعاد مجمع**، تعبئته بالبيانات من ورقة عمل Excel، تعديل التنسيق والتخطيط، وحفظ العرض النهائي — كل ذلك من داخل تطبيق .NET.

1. إنشاء نسخة من عرض Microsoft PowerPoint.
1. إضافة شريحة فارغة إلى العرض.
1. إضافة مخطط أعمدة ثلاثي الأبعاد مجمع والوصول إليه.
1. إنشاء نسخة جديدة من دفتر عمل Microsoft Excel وتحميل بيانات المخطط.
1. الوصول إلى ورقة بيانات المخطط باستخدام نسخة دفتر عمل Excel.
1. تعيين نطاق المخطط في ورقة العمل وإزالة السلسلة 2 و3 من المخطط.
1. تعديل بيانات فئات المخطط في ورقة بيانات المخطط.
1. تعديل بيانات السلسلة 1 في ورقة بيانات المخطط.
1. الوصول إلى عنوان المخطط وتعيين خصائص الخط المتعلقة به.
1. الوصول إلى محور القيم للمخطط وتعيين الوحدة الكبرى، الوحدة الصغرى، القيمة العظمى، والقيمة الصغرى.
1. الوصول إلى محور العمق (السلاسل) للمخطط وإزالته — تُستخدم سلسلة واحدة فقط في هذا المثال.
...
public static void EnsurePowerPointIsRunning(bool blnAddPresentation, bool blnAddSlide)
{
    ...
    // حاول الوصول إلى الخاصية Name. إذا تم رفع استثناء، ابدأ نسخة جديدة من PowerPoint.
    try
    {
        strName = objPPT.Name;
    }
...
يوضح المثال التالي كيفية إنشاء مخطط بسيط في عرض PowerPoint باستخدام Aspose.Slides for .NET. يُظهر هذا الكود كيفية إضافة **مخطط أعمدة ثلاثي الأبعاد مجمع**، تعبئته ببيانات عينة، وتخصيص مظهره. ببضع أسطر من الشيفرة، يمكنك إنشاء مخططات ديناميكيًا وتضمينها في عروضك دون الحاجة إلى Microsoft Office.
...
1. إزالة السلسلة غير المستخدمة 2 و3.
1. تعديل فئات المخطط عن طريق تحديث التسميات.
1. تحديث قيم السلسلة 1.
1. الوصول إلى عنوان المخطط وتعيين خصائص الخط الخاصة به.
1. تكوين محور قيم المخطط، بما في ذلك الوحدة الكبرى، الوحدة الصغرى، القيم العظمى والصغرى.
1. تعيين زوايا دوران المخطط على محوري X وY.
1. حفظ العرض بتنسيق PPTX.
```cs
...
**هل يمكنني إنشاء أنواع أخرى من المخططات مثل مخطط الدائرة أو المخطط الخطّي أو مخطط الأعمدة باستخدام Aspose.Slides؟**

نعم. يدعم Aspose.Slides for .NET مجموعة واسعة من [أنواع المخططات](https://docs.aspose.com/slides/net/create-chart/)، بما في ذلك مخططات الدائرة، المخططات الخطية، مخططات الأعمدة، المخططات المبعثرة، مخططات الفقاعات، والمزيد. يمكنك تحديد نوع المخطط المطلوب باستخدام تعداد [ChartType](https://reference.aspose.com/slides/net/aspose.slides.charts/charttype/) عند إضافة المخطط.

**هل يمكنني تطبيق أنماط أو سمات مخصصة على المخطط؟**

نعم. يمكنك تخصيص مظهر المخطط تمامًا، بما في ذلك الألوان، الخطوط، التعبئات، الحدود، خطوط الشبكة، والتخطيط. ومع ذلك، يتطلب تطبيق سمات Office بالضبط كما تُرى في PowerPoint ضبط الأنماط الفردية يدويًا.
