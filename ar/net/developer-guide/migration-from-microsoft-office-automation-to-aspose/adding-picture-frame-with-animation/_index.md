...
تُطبق إطارات الصور على الأشكال أو الصور في Microsoft PowerPoint لتأطير الصور في عرض تقديمي. تُظهر هذه المقالة كيفية إنشاء إطار صورة وتطبيق حركة عليه برمجياً باستخدام أولاً [VSTO 2008](/slides/ar/net/adding-picture-frame-with-animation/) ثم [Aspose.Slides for .NET](/slides/ar/net/adding-picture-frame-with-animation/). أولاً، نوضح لك كيفية تطبيق إطار وحركة باستخدام VSTO 2008. ثم نوضح لك كيفية تنفيذ نفس الخطوات باستخدام Aspose.Slides for .NET.

{{% /alert %}} 
## **إضافة إطارات الصور مع الحركة**
تُنشئ عينات الشيفرة أدناه عرضًا تقديميًا مع شريحة، وتضيف صورة بإطار صورة وتطبق حركة عليها.
### **مثال VSTO 2008**
...
using (Presentation pres = new Presentation())
{
    ...
    // إضافة إطار صورة يتطابق ارتفاعه وعرضه مع ارتفاع وعرض الصورة
