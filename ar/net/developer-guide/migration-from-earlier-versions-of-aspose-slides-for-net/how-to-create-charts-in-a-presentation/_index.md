...
- C#
- Aspose.Slides
description: "تعرف على كيفية إنشاء المخططات في عروض PowerPoint بصيغة PPT و PPTX و ODP في .NET باستخدام Aspose.Slides عبر كل من واجهات برمجة التطبيقات للمخططات القديمة والحديثة."
---

{{% alert color="primary" %}} 

تم إصدار واجهة برمجة تطبيقات [Aspose.Slides for .NET API](/slides/ar/net/) جديدة الآن ويدعم هذا المنتج القدرة على إنشاء مستندات PowerPoint من الصفر وتعديل المستندات الموجودة.

{{% /alert %}} 
## **دعم الكود القديم**
لكي تستخدم الكود القديم الذي تم تطويره باستخدام إصدارات Aspose.Slides for .NET التي كانت أقدم من 13.x، تحتاج إلى إجراء بعض التعديلات البسيطة في الكود الخاص بك وسيعمل الكود كما كان سابقًا. جميع الفئات التي كانت موجودة في Aspose.Slides for .NET القديمة تحت مساحات الأسماء Aspose.Slide و Aspose.Slides.Pptx الآن مدمجة في مساحة الاسم الوحيدة Aspose.Slides. يرجى إلقاء نظرة على مقتطف الكود البسيط التالي لإنشاء مخطط عادي من الصفر في العرض التقديمي باستخدام واجهة برمجة تطبيقات Aspose.Slides القديمة واتبع الخطوات التي تصف كيفية الترحيل إلى واجهة برمجة التطبيقات المدمجة الجديدة.
...
```csharp
//إنشاء فئة Presentation التي تمثل ملف PPTX//إنشاء فئة Presentation التي تمثل ملف PPTX
...
يرجى إلقاء نظرة على مقتطف الكود البسيط التالي لإنشاء مخطط مبعثر من الصفر في العرض التقديمي باستخدام واجهة برمجة تطبيقات Aspose.Slides القديمة وكيفية تحقيق ذلك باستخدام واجهة برمجة التطبيقات المدمجة الجديدة.
## **نهج Aspose.Slides for .NET القديم**
```c#
using (PresentationEx pres = new PresentationEx())
{
