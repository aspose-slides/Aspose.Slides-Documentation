...
{{% alert color="primary" %}} 
اقرأ المزيد [**عن رسوم متحركة الأشكال**](/slides/net/shape-animation/).
{{% /alert %}}
...
{{% alert color="primary" %}} 
اقرأ المزيد [**عن المخططات المتحركة**](/slides/net/animated-charts/).
{{% /alert %}}
...
{{% alert color="primary" %}} 
اقرأ المزيد [**عن النص المتحرك**](/slides/net/animated-text/).
{{% /alert %}}