...
تحتوي هذه الجدول على تنسيقات الملفات التي يمكن لـ Aspose.Slides for .NET تحميلها وحفظها:
...
|[EMF](https://docs.fileformat.com/image/emf/)|تنسيق صورة متطور| |{{< emoticons/tick >}}| |
|[PDF](https://docs.fileformat.com/pdf/)|تنسيق وثيقة محمولة|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[BMP](https://docs.fileformat.com/image/bmp/)|صورة غير مرتبطة بالجهاز| |{{< emoticons/tick >}}| |
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|رسومات المتجهات القابلة للتوسع| |{{< emoticons/tick >}}| |
...
|[XAML](https://docs.fileformat.com/web/xaml/)|لغة توصيف التطبيق القابلة للتوسع| |{{< emoticons/tick >}}| |
