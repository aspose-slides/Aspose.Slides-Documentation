...
- [مقارنة كود للميزات الشائعة مع OpenXML](/slides/ar/net/code-comparison-for-common-features-with-openxml/)
  - [إضافة تعليق إلى شريحة](/slides/ar/net/add-a-comment-to-a-slide/)
  - [إضافة شريحة إلى العرض التقديمي](/slides/ar/net/adding-slide-to-presentation/)
  - [تطبيق سمة على عرض تقديمي](/slides/ar/net/apply-a-theme-to-a-presentation/)
  - [تغيير لون التعبئة في شكل ضمن عرض تقديمي](/slides/ar/net/change-the-fill-color-of-a-shape-in-a-presentation/)
  - [عد عدد الشرائح](/slides/ar/net/count-the-number-of-slides/)
  - [إنشاء مستند عرض تقديمي](/slides/ar/net/create-a-presentation-document/)
  - [حذف جميع التعليقات بواسطة كاتب](/slides/ar/net/delete-all-the-comments-by-an-author/)
  - [حذف شريحة](/slides/ar/net/delete-a-slide/)
  - [الحصول على جميع الارتباطات الخارجية في عرض تقديمي](/slides/ar/net/get-all-the-external-hyperlinks-in-a-presentation/)
  - [الحصول على جميع النصوص في جميع الشرائح](/slides/ar/net/get-all-the-text-in-all-the-slides/)
  - [الحصول على جميع النصوص في شريحة](/slides/ar/net/get-all-the-text-in-a-slide/)
  - [الحصول على عناوين جميع الشرائح](/slides/ar/net/get-the-titles-of-all-the-slides/)
  - [نقل فقرة من عرض تقديمي إلى آخر](/slides/ar/net/move-a-paragraph-from-one-presentation-to-another/)
  - [نقل شريحة إلى موضع جديد](/slides/ar/net/move-a-slide-to-a-new-position/)
- [ميزات مفقودة في OpenXML](/slides/ar/net/missing-features-in-openxml/)
  - [الوصول إلى عرض OpenDocument](/slides/ar/net/access-opendocument-presentation/)
  - [إضافة شرائح تصميم إلى عرض تقديمي](/slides/ar/net/add-layout-slides-to-presentation/)
  - [التحويل من PPT إلى تنسيقات مختلفة](/slides/ar/net/conversion-from-ppt-to-different-formats/)
    - [التحويل من PPT إلى تنسيق PPTX في Aspose.Slides](/slides/ar/net/conversion-from-ppt-to-pptx-format-in-aspose-slides/)
    - [التحويل إلى HTML](/slides/ar/net/conversion-to/)
    - [التحويل إلى PDF](/slides/ar/net/conversion-to-pdf/)
    - [التحويل إلى XPS](/slides/ar/net/conversion-to-xps/)
  - [تصدير ملفات الوسائط إلى ملف HTML](/slides/ar/net/export-media-files-to-file/)
  - [الحصول على تنسيق ملف العرض التقديمي](/slides/ar/net/get-the-file-format-of-presentation/)
  - [برمجة عالية المستوى مع نموذج كائن مستند العرض التقديمي](/slides/ar/net/high-level-programming-with-presentation-document-object-model/)
    - [تجميع الشرائح](/slides/ar/net/assemble-slides/)
    - [البحث والاستبدال في العرض التقديمي](/slides/ar/net/find-and-replace-in-presentation/)
  - [الرسم والطباعة للعرض التقديمي](/slides/ar/net/rendering-and-printing-of-presentation/)
    - [التحويل إلى Tiff مع ملاحظات](/slides/ar/net/conversion-to-tiff-with-notes/)
    - [التمثيل كـ Tiff](/slides/ar/net/rendered-as-tiff/)
    - [التمثيل كـ Tiff وفق أبعاد محددة من قبل المستخدم](/slides/ar/net/rendered-as-tiff-by-user-defined-dimension/)
    - [رسم الشريحة كصورة SVG](/slides/ar/net/render-slide-as-svg-image/)
    - [رسم الشريحة كصورة مصغرة إلى JPEG](/slides/ar/net/render-slide-as-thumbnail-to-jpeg/)
    - [رسم الشريحة كصورة مصغرة إلى JPEG حسب القيم المحددة من قبل المستخدم](/slides/ar/net/render-slide-as-thumbnail-to-jpeg-by-user-defined-values/)
  - [انتقالات الشرائح](/slides/ar/net/slide-transitions/)
  - [العمل مع حجم وتخطيط العرض التقديمي](/slides/ar/net/working-with-size-and-layout-of-presentation/)