...
تحتوي هذه الجدول على صيغ الملفات التي يمكن لـ Aspose.Slides لـ Python عبر Java تحميلها وحفظها:
...
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|عرض PowerPoint مع تمكين وحدات الماكرو|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|عرض PowerPoint مع تمكين وحدات الماكرو|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[POTM](https://docs.fileformat.com/presentation/potm/)|قالب PowerPoint مع تمكين وحدات الماكرو|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|صيغة ملف صورة التاج| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|صيغة ملف ميتا دقيق معزز| |{{< emoticons/tick >}}| |
|[PDF](https://docs.fileformat.com/pdf/)|صيغة مستند نقل|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[GIF](https://docs.fileformat.com/image/gif/)|صيغة تبادل الرسوميات| |{{< emoticons/tick >}}| |
|[BMP](https://docs.fileformat.com/image/bmp/)|خريطة البت المستقلة عن الجهاز| |{{< emoticons/tick >}}| |
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|رسومات المتجه القابلة للتوسع| |{{< emoticons/tick >}}| |
|[SWF](https://docs.fileformat.com/page-description-language/swf/)|صيغة الويب الصغيرة| |{{< emoticons/tick >}}| |
|[HTML](https://docs.fileformat.com/web/html/)|لغة ترميز النصوص الفائقة|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
