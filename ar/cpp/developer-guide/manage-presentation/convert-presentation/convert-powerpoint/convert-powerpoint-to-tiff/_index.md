...
TIFF (**Tagged Image File Format**) هو تنسيق صور نقطية غير مضغوط شائع الاستخدام، معروف بجودته الاستثنائية والحفاظ الدقيق على الرسومات. غالبًا ما يختار المصممون والمصورون والناشرون المكتبيون TIFF للحفاظ على الطبقات ودقة الألوان والإعدادات الأصلية في صورهم.

باستخدام Aspose.Slides، يمكنك بسهولة تحويل شرائح PowerPoint (PPT، PPTX) وشرائح OpenDocument (ODP) مباشرة إلى صور TIFF عالية الجودة، مما يضمن بقاء عروضك التقديمية بأقصى قدر من الدقة البصرية.
...
هذا كود C++ يوضح كيفية تحويل عرض تقديمي PowerPoint إلى TIFF:
```cpp
// إنشاء كائن فئة Presentation الذي يمثل ملف عرض تقديمي (PPT، PPTX، ODP، إلخ).
auto presentation = MakeObject<Presentation>(u"Demo_File.pptx");

// حفظ العرض التقديمي كصورة TIFF.
...
هذا كود C++ يوضح كيفية تحويل عرض تقديمي PowerPoint إلى صورة TIFF بصيغة بكسل مخصصة:
```cpp
// إنشاء كائن فئة Presentation الذي يمثل ملف عرض تقديمي (PPT، PPTX، ODP، إلخ).
auto presentation = MakeObject<Presentation>(u"Demo_File.pptx");
...
تحقق من أداة تحويل PowerPoint إلى بوستر المجانية من Aspose على [FREE PowerPoint to Poster converter](https://products.aspose.app/slides/conversion/convert-ppt-to-poster-online).
{{% /alert %}}
...
نعم. يتيح لك Aspose.Slides تحويل شرائح فردية من عروض PowerPoint و OpenDocument إلى صور TIFF بشكل منفصل.
