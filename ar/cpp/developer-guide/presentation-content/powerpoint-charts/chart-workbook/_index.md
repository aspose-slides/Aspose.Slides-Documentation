...
توضح هذه المقالة كيفية العمل مع دفاتر عمل المخططات في Aspose.Slides. تظهر كيفية قراءة وكتابة بيانات المخطط من خلال تدفقات دفتر العمل، واستخدام خلايا دفتر العمل كعلامات لبيانات المخطط، والوصول إلى مجموعات أوراق العمل، وتحديد نوع مصدر البيانات لقيم المخطط.
...
هذا الكود بلغ C++ يوضح العملية لتعيين دفتر عمل بيانات المخطط:
...
// قراءة دفتر العمل المُعد في Excel (أو في Aspose.Cells) وتعيينه كدفتر بيانات المخطط.
...
## **تعيين خلية دفتر عمل كعلامة بيانات مخطط**
...
هذا الكود بلغ C++ يوضح كيفية تعيين خلية دفتر عمل كعلامة بيانات مخطط:
...
هذا الكود بلغ C++ يوضح عملية يستخدم فيها الطريقة [IChartDataWorkbook::get_Worksheets](https://reference.aspose.com/slides/ar/cpp/aspose.slides.charts/ichartdataworkbook/get_worksheets/) للوصول إلى مجموعة أوراق العمل:
...
هذا الكود بلغ C++ يوضح كيفية تحديد نوع لمصدر البيانات:
...
لا تدعم Aspose.Slides صيغة دفتر العمل الثنائي Excel (.xlsb) التي يمكن تضمينها في بعض المخططات. يمكنك استخدام الطريقة `get_EmbeddedWorkbookType` على [IChartData](https://reference.aspose.com/slides/ar/cpp/aspose.slides.charts/ichartdata/) مع تعداد [WorkbookType](https://reference.aspose.com/slides/ar/cpp/aspose.slides.charts/workbooktype/) لاكتشاف الصيغ غير المدعومة وتخطي تلك المخططات.
...
هذا الكود بلغ C++ يوضح عملية إنشاء دفتر عمل خارجي:
...
في حين أنك لا تستطيع تحرير البيانات في دفاتر العمل المخزنة في المواقع أو الموارد البعيدة، لا يزال بإمكانك استخدام هذه الدفاتر كمصدر بيانات خارجي. إذا تم توفير مسار نسبي لدفتر عمل خارجي، يتم تحويله تلقائيًا إلى مسار كامل.

هذا الكود بلغ C++ يوضح كيفية تعيين دفتر عمل خارجي:
...
* عندما تُضبط قيمة `updateChartData` إلى `false`، يتم تحديث مسار دفتر العمل فقط — لا يتم تحميل أو تحديث بيانات المخطط من دفتر العمل الهدف. قد ترغب في استخدام هذا الإعداد عندما يكون دفتر العمل الهدف غير موجود أو غير متاح. 
* عندما تُضبط قيمة `updateChartData` إلى `true`، يتم تحديث بيانات المخطط من دفتر العمل الهدف.
...
يمكنك تحرير البيانات في دفاتر العمل الخارجية بنفس الطريقة التي تُجرى بها تغييرات على محتويات دفاتر العمل الداخلية. عندما لا يمكن تحميل دفتر عمل خارجي، يتم رمي استثناء.

هذا الكود بلغ C++ هو تنفيذ العملية الموصوفة:
...
### **استرداد دفتر عمل من ذاكرة التخزين المؤقت للمخطط**

إذا كان مخطط يستخدم دفتر عمل خارجي مفقود أو غير متاح، يمكن لـ Aspose.Slides إعادة بناء دفتر عمل المخطط من البيانات المخزنة مؤقتًا في العرض التقديمي. أنشئ [LoadOptions](https://reference.aspose.com/slides/ar/cpp/aspose.slides/loadoptions/)، اضبطه باستخدام [set_SpreadsheetOptions](https://reference.aspose.com/slides/ar/cpp/aspose.slides/loadoptions/set_spreadsheetoptions/)، واستدعِ [ISpreadsheetOptions::set_RecoverWorkbookFromChartCache](https://reference.aspose.com/slides/ar/cpp/aspose.slides/ispreadsheetoptions/set_recoverworkbookfromchartcache/) مع `true` قبل فتح العرض التقديمي.

المثال التالي بلغ C++ يفتح عرضًا تقديميًا يربط مخططًا بدفتر عمل خارجي غير متاح ويصل إلى البيانات المستردة عبر [IChart::get_ChartData](https://reference.aspose.com/slides/ar/cpp/aspose.slides.charts/ichart/get_chartdata/) و[IChartData::get_ChartDataWorkbook](https://reference.aspose.com/slides/ar/cpp/aspose.slides.charts/ichartdata/get_chartdataworkbook/):
...
إذا كان دفتر العمل الخارجي غير متاح وتم تعطيل الاسترداد، تقوم Aspose.Slides برمي استثناء `System::InvalidOperationException`. فعل الاسترداد فقط عندما يكون استخدام البيانات المخزنة مؤقتًا للمخطط خيارًا مقبولًا، لأن الذاكرة المؤقتة قد لا تحتوي على التغييرات التي أُجريت على دفتر العمل الخارجي بعد آخر تحديث للعرض التقديمي.
...
نعم. إذا قمت بتحديد مسار نسبي، يُحوَّل تلقائيًا إلى مسار مطلق. هذا مفيد لقابلية نقل المشروع؛ ومع ذلك، يجب أن تكون على علم بأن العرض التقديمي سيخزن المسار المطلق في ملف PPTX.
...
لا. يخزن العرض التقديمي [رابطًا إلى الملف الخارجي](https://reference.aspose.com/slides/ar/cpp/aspose.slides.charts/chartdata/get_externalworkbookpath/) ويستخدمه لقراءة البيانات. لا يتم تعديل الملف الخارجي نفسه عند حفظ العرض.

**ماذا أفعل إذا كان الملف الخارجي محميًا بكلمة مرور؟**

لا تقبل Aspose.Slides كلمة مرور عند إنشاء الرابط. يُنصح بإزالة الحماية مسبقًا أو إعداد نسخة غير مشفرة (مثلاً باستخدام [Aspose.Cells](/cells/cpp/)) وربط العرض بهذه النسخة.

**هل يمكن لعدة مخططات الإشارة إلى نفس دفتر العمل الخارجي؟**

نعم. كل مخطط يخزن رابطه الخاص. إذا كانت جميع الروابط تشير إلى نفس الملف، فإن تحديث ذلك الملف سيظهر في كل مخطط عند تحميل البيانات مرة أخرى.