...
يمكنك تعديل موصل موجود من خلال نقاط الضبط الخاصة به. يمكن تغيير الموصلات التي تحتوي على نقاط ضبط فقط بهذه الطريقة. راجع الجدول تحت **[أنواع الموصلات.](/slides/ar/cpp/connector/#types-of-connectors)** 
...
* لحسابات تحديد إحداثيات نقاط ضبط الموصل، عليك أن تأخذ في الاعتبار دوران الموصل وانعكاسه. **ملاحظة** أن زاوية الدوران لجميع الموصلات المعروضة تحت **[أنواع الموصلات](/slides/ar/cpp/connector/#types-of-connectors)** هي 0.
