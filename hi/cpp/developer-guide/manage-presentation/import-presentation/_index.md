...
- "C++"
- "Aspose.Slides"
description: "Aspose.Slides के साथ C++ में PDF और HTML दस्तावेज़ों को PowerPoint और OpenDocument प्रस्तुतियों में सहजता से आयात करें, जिससे उच्च-प्रदर्शन वाली स्लाइड प्रोसेसिंग प्राप्त हो।"
---
## **परिचय**

आप [**Aspose.Slides for C++**](https://products.aspose.com/slides/hi/cpp/) का उपयोग करके अन्य फ़ॉर्मेट की फ़ाइलों से प्रस्तुतियों को आयात कर सकते हैं। Aspose.Slides [SlideCollection](https://reference.aspose.com/slides/hi/cpp/class/aspose.slides.slide_collection) क्लास प्रदान करता है जिससे आप PDF, HTML दस्तावेज़ आदि से प्रस्तुतियों को आयात कर सकते हैं।

## **PDF से PowerPoint आयात करना**

इस मामले में, आप PDF को PowerPoint प्रस्तुति में बदल सकते हैं।

<img src="pdf-to-powerpoint.png" alt="pdf-to-powerpoint" style="zoom:50%;" />

1. Presentation क्लास का एक ऑब्जेक्ट बनाएं।  
...
यह C++ कोड PDF को PowerPoint में बदलने का प्रदर्शन करता है:
...
## **HTML से PowerPoint आयात करना**

इस मामले में, आप HTML दस्तावेज़ को PowerPoint प्रस्तुति में बदल सकते हैं।
...
यह C++ कोड HTML को PowerPoint में बदलने का प्रदर्शन करता है:
...
आयात के दौरान तालिकाओं की पहचान की जा सकती है; [PdfImportOptions](https://reference.aspose.com/slides/hi/cpp/aspose.slides.import/pdfimportoptions/) में एक [set_DetectTables](https://reference.aspose.com/slides/hi/cpp/aspose.slides.import/pdfimportoptions/set_detecttables/) मेथड शामिल है जो तालिका पहचान सक्षम करता है। प्रभावशीलता PDF की संरचना पर निर्भर करती है।