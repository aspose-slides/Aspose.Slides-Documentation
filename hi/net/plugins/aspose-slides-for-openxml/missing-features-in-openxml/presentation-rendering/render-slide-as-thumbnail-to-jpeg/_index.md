...
---
**Aspose.Slides for .NET** का उपयोग स्लाइड्स वाली प्रस्तुति फ़ाइलें बनाने के लिए किया जाता है। इन स्लाइड्स को Microsoft PowerPoint का उपयोग करके प्रस्तुति फ़ाइलें खोलकर देखा जा सकता है। लेकिन कभी‑कभी, डेवलपर्स को अपनी पसंदीदा इमेज व्यूअर का उपयोग करके स्लाइड्स को छवियों के रूप में देखना पड़ सकता है। ऐसे मामलों में, Aspose.Slides for .NET आपको स्लाइड्स की थंबनेल छवियाँ उत्पन्न करने में मदद करता है।
...
1. उसके ID या इंडेक्स का उपयोग करके किसी भी इच्छित स्लाइड का संदर्भ प्राप्त करें।
