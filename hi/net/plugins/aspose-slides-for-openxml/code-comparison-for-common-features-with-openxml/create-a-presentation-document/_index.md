---
title: प्रस्तुति दस्तावेज़ बनाएं
type: docs
weight: 60
url: /hi/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // निर्दिष्ट फ़ाइल पथ पर एक प्रस्तुति बनाएँ। प्रस्तुति दस्तावेज़ प्रकार डिफ़ॉल्ट रूप से pptx है।
...

{
    ...
    //एक PPT फ़ाइल का प्रतिनिधित्व करने वाला Presentation ऑब्जेक्ट इंस्टैंटिएट करें
    using (Presentation pres = new Presentation())
    {

        //SlideExCollection क्लास को इंस्टैंटिएट करें
        ISlideCollection slds = pres.Slides;

        //SlidesEx संग्रह में एक खाली स्लाइड जोड़ें
