---
title: नई स्थिति में स्लाइड को स्थानांतरित करें
type: docs
weight: 140
url: /hi/net/move-a-slide-to-a-new-position/
---
## **OpenXML SDK**
``` csharp
...
// स्लाइड को प्रस्तुति में स्लाइड क्रम में एक अलग स्थिति में ले जाएँ।

public static void MoveSlide(string presentationFile, int from, int to)

{

    // स्रोत PPTX फ़ाइल लोड करने के लिए PresentationEx क्लास का इंस्टैंसिएट करें

    using (Presentation pres = new Presentation(presentationFile))

    {

        // जिस स्लाइड की स्थिति बदलनी है, उसे प्राप्त करें
