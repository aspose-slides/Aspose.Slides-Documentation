...
- C#
- Aspose.Slides
description: "Aspose.Slides for .NET के साथ स्लाइड हेडर और फ़ूटर नियंत्रित करें: PPT, PPTX, और ODP में C# उदाहरणों के साथ तिथियां, स्लाइड नंबर, और कस्टम टेक्स्ट जोड़ें।"
---
यह लेख **Aspose.Slides for .NET** का उपयोग करके फ़ूटर जोड़ने और डेट और समय प्लेसहोल्डर को अपडेट करने का प्रदर्शन करता है।
...
## **डेट और समय अपडेट करें**

स्लाइड पर डेट और समय प्लेसहोल्डर को संशोधित करें।
