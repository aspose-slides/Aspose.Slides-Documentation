---
title: "Aspose.Slides for .NET 15.10.0 में सार्वजनिक API और असंगत परिवर्तन"
linktitle: "Aspose.Slides .NET 15.10.0 के लिये"
type: docs
weight: 200
...
यह पृष्ठ सभी [जोड़े गए](/slides/hi/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) या [हटाए गए](/slides/hi/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) वर्गों, विधियों, गुणों आदि को सूचीबद्ध करता है, और Aspose.Slides for .NET 15.10.0 API के साथ प्रस्तुत किए गए अन्य परिवर्तन।

{{% /alert %}} 
## **सार्वजनिक API परिवर्तन**
#### **वीडियोप्लेयरएचटीएमएलकंट्रोलर को HTML में मीडिया फ़ाइलें निर्यात करने के समर्थन के लिए जोड़ा गया**
नया सार्वजनिक वर्ग VideoPlayerHtmlController को Aspose.Slides.Export नेमस्पेस में जोड़ा गया है। इस वर्ग की इंस्टेंस का उपयोग करके उपयोगकर्ता वीडियो और ऑडियो फ़ाइलें HTML में निर्यात कर सकते हैं।  
VideoPlayerHtmlController कन्स्ट्रक्टर निम्नलिखित पैरामीटर स्वीकार करता है:

- path: वह पथ जहाँ वीडियो और ऑडियो फ़ाइलें उत्पन्न होंगी  
- fileName: HTML फ़ाइल का नाम  
- baseUri: वह बेस URI जिसका उपयोग लिंक उत्पन्न करने के लिये किया जाएगा  
...
``` 
#### **चार्ट सीरीज एनीमेशन API जोड़ा गया है**
नए दो विधियों को Aspose.Slides.Animation.ISequence इंटरफ़ेस में जोड़ा गया है।
...
इन विधियों का उद्देश्य चार्ट के तत्व एनीमेशन को समर्थन देना है:
by series  
by categories  
by series elements  
by categories elements  

चार्ट के तत्व एनीमेशन से संबंधित दो नए एन्नम EffectChartMajorGroupingType और EffectChartMinorGroupingType प्रस्तुत किए गए।  

चार्ट में सीरीज़ एनीमेशन जोड़ने के लिये निम्नलिखित कोड इस्तेमाल किया जा सकता है:
...

{
    ...
    ((Sequence)slide.Timeline.MainSequence).AddEffect(chart,
        ...
        EffectType.Appear, EffectSubtype.No
