...
type: docs
weight: 160
url: /nl/nodejs-java/examples/elements/math-text/
keywords:
- codevoorbeeld
- wiskundige tekst
- PowerPoint
...
- JavaScript
- Aspose.Slides
description: "Verken Aspose.Slides for Node.js MathematicalText-voorbeelden: maak en formatteer vergelijkingen, breuken, matrices en symbolen in PPT-, PPTX- en ODP-presentaties."
---
Dit artikel toont hoe u werkt met wiskundige tekstvormen en het opmaken van vergelijkingen met behulp van **Aspose.Slides for Node.js via Java**.
...
function removeMathText() {
    ...
    try {
        ...
        // Neem aan dat de eerste vorm de wiskundige vorm is.
