---
title: Lettertypen beheren in presentaties op Android
...
- Java
- Aspose.Slides
description: "Beheer lettertypen in Java met Aspose.Slides for Android: inbedden, vervangen en aangepaste lettertypen laden om PPT-, PPTX- en ODP-presentaties helder, merkveilig en consistent te houden."
---
## **Overzicht**

Aspose.Slides stelt je in staat om lettertype‑eigenschappen in de presentatietekst rechtstreeks vanuit je code te beheren. Je kunt tekst in dia's benaderen via vormen, tekstkaders, alinea’s en gedeelten, en vervolgens opmaak toepassen op de geselecteerde tekst.

Dit artikel legt uit hoe je lettertype‑gerelateerde eigenschappen voor bestaande tekst in een presentatie kunt configureren, inclusief lettertypefamilie, vet en cursief, alinea‑uitlijning en letterkleur. Het laat ook zien hoe je een tekstvak maakt, er tekst aan toevoegt en lettertype‑eigenschappen zoals lettertypefamilie, vet, cursief, onderstrepen, lettergrootte en kleur instelt voordat je het resultaat opslaat als een PPTX‑bestand.

## **Beheer lettertype‑gerelateerde eigenschappen**
{{% alert color="info" %}} 

Presentaties bevatten meestal zowel tekst als afbeeldingen. De tekst kan op verschillende manieren worden opgemaakt, bijvoorbeeld om specifieke secties en woorden te accentueren of om te voldoen aan de huisstijl. Tekstopmaak helpt gebruikers om de uitstraling van de presentatiewaarde te variëren. Dit artikel laat zien hoe je Aspose.Slides for Android via Java kunt gebruiken om de lettertype‑eigenschappen van tekstalinea’s op dia’s te configureren.
...
1. Haal de [Paragraph](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/paragraph/) uit het [TextFrame](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/textframe/) dat wordt blootgesteld door de [AutoShape](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/autoshape/).
1. Stel de alinea‑uitlijning in op uitvullen.
1. Benader de tekstdelen ([Portion](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/portion/)) van een [Paragraph](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/paragraph/).
...
try {
	// Toegang krijgen tot een dia via de positie van de dia
	ISlide slide = pres.getSlides().get_Item(0);

	// De eerste en tweede placeholder in de dia benaderen en deze casten naar AutoShape
...
## **Stel tekst‑lettertypeeigenschappen in**
{{% alert color="info" %}} 

Zoals genoemd in **Beheer lettertype‑gerelateerde eigenschappen**, wordt een [Portion](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/portion/) gebruikt om tekst met een vergelijkbare opmaakstijl in een alinea te bewaren. Dit artikel laat zien hoe je Aspose.Slides for Android via Java kunt gebruiken om een tekstvak met enige tekst te maken en vervolgens een specifiek lettertype en diverse andere eigenschappen van de lettertypefamiliecategorie te definiëren.
...
1. Verwijder de opvulstijl die gekoppeld is aan de [AutoShape](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/autoshape/).
...
1. Voeg wat tekst toe aan het [TextFrame](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/textframe/).
1. Benader het [Portion](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/portion/)‑object dat gekoppeld is aan het [TextFrame](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/textframe/).
1. Definieer het lettertype dat moet worden gebruikt voor de [Portion](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/portion/).
1. Stel overige lettertype‑eigenschappen in, zoals vet, cursief, onderstrepen, kleur en hoogte, via de relevante eigenschappen die door het [Portion](https://reference.aspose.com/slides/nl/androidjava/com.aspose.slides/portion/)‑object worden blootgesteld.
...
try {
	...
	// Toegang krijgen tot het TextFrame dat bij de AutoShape hoort
	ITextFrame tf = ashp.getTextFrame();
	tf.setText("Aspose TextBox");
	
	// Toegang krijgen tot het Portion dat bij het TextFrame hoort
