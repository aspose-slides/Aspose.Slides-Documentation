...
- C++
- Aspose.Slides
description: "Leer hoe u gegevenspunten in treemap- en sunburst-diagrammen kunt beheren met Aspose.Slides voor C++, compatibel met PowerPoint-formaten."
---
## **Introductie**

Naast andere typen PowerPoint‑diagrammen bestaan er twee “hiërarchische” typen – **Treemap** en **Sunburst** diagram (ook bekend als Sunburst‑grafiek, Sunburst‑diagram, Radiale diagram, Radiale grafiek of Multi‑level cirkeldiagram). Deze diagrammen tonen hiërarchische gegevens georganiseerd als een boom – van de bladeren tot de top van de tak. De bladeren worden gedefinieerd door de gegevenspunten van de serie, en elk volgend genest groeperingsniveau wordt gedefinieerd door de bijbehorende categorie. Aspose.Slides for C++ maakt het mogelijk om gegevenspunten van Sunburst‑diagram en Treemap in C++ te formatteren.

Hier is een Sunburst‑diagram, waarbij de gegevens in de kolom Series1 de bladknopen definiëren, terwijl andere kolommen hiërarchische gegevenspunten definiëren:
...
Als er behoefte is om gegevenspunten van het diagram te formatteren, moeten we het volgende gebruiken:
...
In feite is het een wrapper voor [**IChartCategoryLevelsManager**](https://reference.aspose.com/slides/nl/cpp/aspose.slides.charts/ichartcategorylevelsmanager/) met de eigenschappen die specifiek zijn toegevoegd voor gegevenspunten.  
De klasse [**IChartDataPointLevel**](https://reference.aspose.com/slides/nl/cpp/aspose.slides.charts/ichartdatapointlevel/) heeft twee methoden: [**get_Format()**](https://reference.aspose.com/slides/nl/cpp/aspose.slides.charts/ichartdatapointlevel/get_format/) en [**get_Label()**](https://reference.aspose.com/slides/nl/cpp/aspose.slides.charts/ichartdatapointlevel/get_label/) die toegang bieden tot de overeenkomstige instellingen.

## **Waarde van een gegevenspunt tonen**
Toon de waarde van het gegevenspunt “Leaf 4”:
...
## **Een gegevenspunt‑label en -kleur instellen**
...
## **Kleur van de tak van een gegevenspunt instellen**
Verander de kleur van de tak “Stem 4”:
...
De kleuren van het diagram erven het [thema/palet](/slides/nl/cpp/presentation-theme/) van de presentatie, tenzij je expliciet vullingen/fonten instelt. Voor consistente resultaten, vergrendel solide vullingen en tekstopmaak op de benodigde niveaus.
...
**Kan ik de werkelijke coördinaten van een label/element berekenen voor een aangepaste overlay bovenop het diagram?**
