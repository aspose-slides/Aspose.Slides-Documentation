...
type: docs
weight: 230
url: /nl/java/examples/elements/comment/
keywords:
- codevoorbeeld
- opmerking
- PowerPoint
...
- Java
- Aspose.Slides
description: "Werk met diaopmerkingen in Aspose.Slides for Java: voeg toe, beantwoord, bewerk, los op en exporteer opmerkingen in PPT-, PPTX- en ODP-presentaties met Java-codevoorbeelden."
---
Dit artikel laat zien hoe u moderne opmerkingen kunt toevoegen, lezen, verwijderen en beantwoorden met behulp van **Aspose.Slides for Java**.
