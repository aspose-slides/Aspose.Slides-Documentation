...
type: docs
weight: 210
url: /nl/java/examples/elements/ole-object/
keywords:
- codevoorbeeld
- OLE‑object
- PowerPoint
...
- Java
- Aspose.Slides
description: "Beheer OLE‑objecten in Aspose.Slides for Java: invoegen, koppelen, bijwerken en ingebedde inhoud extraheren met Java in PPT‑, PPTX‑ en ODP‑presentaties."
---
Dit artikel toont hoe u een bestand als OLE‑object kunt insluiten en de gegevens bijwerken met **Aspose.Slides for Java**.
