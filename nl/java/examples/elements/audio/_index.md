...
type: docs
weight: 70
url: /nl/java/examples/elements/audio/
keywords:
- code voorbeeld
- audio
- PowerPoint
...
- Java
- Aspose.Slides
description: "Ontdek audio-voorbeelden van Aspose.Slides for Java: invoegen, afspelen, bijsnijden en geluid extraheren in PPT-, PPTX- en ODP-presentaties met duidelijke Java-code."
---
Dit artikel toont hoe audio‑frames in te voegen en de weergave te regelen met **Aspose.Slides for Java**. De volgende voorbeelden laten basis‑audio‑bewerkingen zien.

## **Audioframe toevoegen**

Voeg een leeg audioframe toe dat later ingebedde geluidsgegevens kan bevatten.
