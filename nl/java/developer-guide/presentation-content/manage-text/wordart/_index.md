...
keywords:
  ...
  - Java
  - Aspose.Slides
description: "Maak en pas WordArt-effecten aan in Aspose.Slides voor Java. Deze stapsgewijze gids helpt ontwikkelaars om presentaties te verbeteren met professionele tekst in Java."
---
## **Overzicht**

WordArt‑effecten stellen u in staat om visueel aantrekkelijke, gestileerde tekst toe te voegen aan uw PowerPoint‑presentaties. Met Aspose.Slides kunnen ontwikkelaars programmatic WordArt maken, aanpassen en beheren, net zoals in Microsoft PowerPoint—zonder dat Office geïnstalleerd hoeft te zijn. Dit artikel geeft een overzicht van het werken met WordArt, inclusief hoe u teksttransformaties, vullingsstijlen, omtrekken, schaduwen en andere opmaakopties kunt toepassen om de inhoud van uw presentatie expressiever en aantrekkelijker te maken. WordArt stelt u in staat om tekst te behandelen als een grafisch object. Het bestaat uit effecten of speciale aanpassingen die op tekst worden toegepast om deze aantrekkelijker of opvallender te maken.

## **Een eenvoudig WordArt‑sjabloon maken en toepassen op tekst**
...
In het rechtermenu kunt u een vooraf gedefinieerd WordArt‑effect kiezen. In het linkermenu kunt u de instellingen voor een nieuw WordArt specificeren. 
...
Hier passen we de [SmallGrid](https://reference.aspose.com/slides/nl/java/com.aspose.slides/PatternStyle#SmallGrid) patroonkleur toe op de tekst en voegen we een zwarte tekstomranding van 1‑punts breedte toe met deze code:
...
Via de interface van het programma kunt u deze effecten toepassen op een tekst, tekstblok, vorm of een vergelijkbaar element:

![todo:image_alt_text](image-20200930114129-5.png)

Bijvoorbeeld, schaduw‑, reflectie‑ en gloed‑effecten kunnen op een tekst worden toegepast; 3D‑opmaak‑ en 3D‑rotatie‑effecten kunnen op een tekstblok worden toegepast; de eigenschap Zachte randen kan op een vormobject worden toegepast (deze blijft van kracht wanneer geen 3D‑opmaak‑eigenschap is ingesteld). 

### **Schaduweffecten toepassen**

Hier willen we alleen de eigenschappen instellen die betrekking hebben op tekst. We passen het schaduweffect toe op een tekst met deze Java‑code:
...
In PowerPoint kunt u één type schaduw gebruiken. Dit is een voorbeeld:
...
- Als OuterShadow en InnerShadow gelijktijdig worden gebruikt, hangt het resulterende of toegepaste effect af van de versie van PowerPoint. Bijvoorbeeld, in PowerPoint 2013 wordt het effect verdubbeld. Maar in PowerPoint 2007 wordt het OuterShadow‑effect toegepast. 

### **Weergave op teksten toepassen**

We voegen weergave toe aan de tekst met dit Java‑voorbeeld:
...
### **Gloeieffect op teksten toepassen**

We passen het gloeieffect toe op de tekst om deze te laten stralen of op te laten vallen met deze code:
...
U kunt de parameters voor schaduw, weergave en gloed aanpassen. De eigenschappen van de effecten worden afzonderlijk op elk deel van de tekst ingesteld. 
...
Om vooraf gedefinieerde transformatietypen te benaderen, ga naar: **Format** -> **TextEffect** -> **Transform**

**Gebruik Aspose.Slides**

Om een transformatietype te selecteren, gebruik de TextShapeType‑enum. 
...
- Wanneer de scène zowel voor de figuur als voor de tekst is ingesteld, heeft de figuur‑scène de hogere prioriteit — de tekst‑scène wordt genegeerd. 
...
## **Outer‑schaduweffecten op teksten toepassen**
Aspose.Slides voor Java biedt de klassen [**IOuterShadow**](https://reference.aspose.com/slides/nl/java/com.aspose.slides/ioutershadow/) en [**IInnerShadow**](https://reference.aspose.com/slides/nl/java/com.aspose.slides/iinnershadow/) die u in staat stellen schaduweffecten toe te passen op een tekst in een [TextFrame](https://reference.aspose.com/slides/nl/java/com.aspose.slides/textframe/). Doorloop de volgende stappen:
...
3. Voeg een AutoShape van het type Rechthoek toe aan de dia.  
...
try {
    ...
    // Deactiveer de vormvulling zodat we de schaduw van de tekst kunnen krijgen
...
## **Inner‑schaduweffect op vormen toepassen**
Doorloop de volgende stappen:

1. Maak een instantie van de [Presentation](https://reference.aspose.com/slides/nl/java/com.aspose.slides/presentation)‑klasse.  
2. Verkrijg een referentie van de dia.  
3. Voeg een AutoShape van het type Rechthoek toe.  
...
Deze voorbeeldcode (gebaseerd op de bovenstaande stappen) laat zien hoe u het inner‑shadow‑effect op de tekst in een vorm toepast in Java:
...
Ja, Aspose.Slides ondersteunt Unicode en werkt met alle gangbare lettertypen en scripts. WordArt‑effecten zoals schaduw, vulling en omtrek kunnen worden toegepast ongeacht de taal, hoewel de beschikbaarheid van lettertypen en weergave afhankelijk kan zijn van de systeemlettertypen.

### Kan ik WordArt‑effecten toepassen op elementen van de master‑dia?

Ja, u kunt WordArt‑effecten toepassen op vormen in master‑dia’s, inclusief titel‑placeholder‑objecten, voetteksten of achtergrondtekst. Aanpassingen in de master‑lay-out worden doorgevoerd in alle bijbehorende dia’s.

### Beïnvloeden WordArt‑effecten de bestandsgrootte van de presentatie?

Enigszins. WordArt‑effecten zoals schaduwen, gloed en verloopvullingen kunnen de bestandsgrootte licht verhogen door extra opmaak‑metadata, maar het verschil is doorgaans verwaarloosbaar.

### Kan ik het resultaat van WordArt‑effecten bekijken zonder de presentatie op te slaan?

Ja, u kunt dia’s met WordArt renderen naar afbeeldingen (bijv. PNG, JPEG) met behulp van de `getImage`‑methode van de [IShape](https://reference.aspose.com/slides/nl/java/com.aspose.slides/ishape/) of [ISlide](https://reference.aspose.com/slides/nl/java/com.aspose.slides/islide/) interfaces. Hiermee kunt u het resultaat in‑memory of op het scherm bekijken voordat u de volledige presentatie opslaat of exporteert.