...
- Java
- Aspose.Slides
description: "Vergelijkingen invoegen en bewerken in PowerPoint PPT en PPTX met Aspose.Slides for Java, met ondersteuning voor OMML, opmaakbesturingen en duidelijke Java-codevoorbeelden."
---
## **Overzicht**

PowerPoint slaat vergelijkingen op als Office Math Markup Language (OMML). Met Aspose.Slides for Java kun je dezelfde soort wiskundige inhoud programmatically maken: breuken, wortels, functies, limieten, N-ary operatoren, matrices, arrays en opgemaakte wiskundeblokken.

In PowerPoint voegen gebruikers normaal gesproken vergelijkingen toe via **Insert > Equation**:

![PowerPoint Insert-tabblad met de opdracht Vergelijking geselecteerd](powerpoint-math-equations_1.png)
...
- [MathPortion](https://reference.aspose.com/slides/nl/java/com.aspose.slides/mathportion/) slaat wiskundige inhoud op in het tekstkader van de vorm.
...
{{% alert color="primary" %}}
`addMathShape` maakt een vorm die al een wiskundige alinea bevat. Ga naar de eerste `MathPortion`, haal de `MathParagraph` op, en voeg wiskundige blokken of wiskunde‑elementen toe.
{{% /alert %}}
...
Gebruik `asArgumentOfFunction` of `function` voor functies zoals `sin(x)`, `log(x)`, of aangepaste functienamen. Voor limieten, plaats `lim` in een [MathLimit](https://reference.aspose.com/slides/nl/java/com.aspose.slides/mathlimit/) of gebruik `setLowerLimit`.
...
Gebruik `nary` voor somstellingen, unies, doorsnedes en andere grote operatoren. Gebruik `integral` voor integralen. Beide methoden laten je onder‑ en bovengrenzen instellen.
...
Gebruik [MathMatrix](https://reference.aspose.com/slides/nl/java/com.aspose.slides/mathmatrix/) voor rijen en kolommen. Matrices bevatten standaard geen haakjes, dus omring de matrix wanneer je ronde haakjes, vierkante haken of accolades nodig hebt.
...
Gebruik `enclose` om een uitdrukking binnen delimiters te plaatsen. Je kunt ook een scheidingsteken instellen voor delimiter‑uitdrukkingen die meerdere elementen bevatten.
