---
title: Een presentatiedocument maken
type: docs
weight: 60
url: /nl/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // Maak een presentatie op een opgegeven bestandspad. Het presentatiedocumenttype is pptx, standaard.
...

{
    ...
    {
        //Instantieer de SlideExCollection-klasse
        ISlideCollection slds = pres.Slides;
        //Voeg een lege dia toe aan de SlidesEx-collectie
        slds.AddEmptySlide(pres.LayoutSlides[0]);
        //Sla je presentatie op naar een bestand
