...
- Java
- Aspose.Slides
description: "Gebruik Aspose.Slides for Python via Java om OLE-objecten toe te voegen, te benaderen, te verwijderen en bij te werken in PowerPoint- en OpenDocument-presentaties."
---
Dit artikel laat zien hoe u een bestand als OLE‑object kunt insluiten en de gegevens ervan kunt bijwerken met **Aspose.Slides for Python via Java**.
...
Integreer een PDF‑bestand in de presentatie.
