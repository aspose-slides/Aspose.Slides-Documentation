...
Deze tabel bevat de bestandsformaten die Aspose.Slides voor Python via Java kan laden en opslaan:
...
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|Macro‑ondersteunde PowerPoint‑presentatie|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|Macro‑ondersteunde PowerPoint‑show|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
|[POTM](https://docs.fileformat.com/presentation/potm/)|Macro‑ondersteunde PowerPoint‑sjabloon|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|Tag‑afbeeldingsbestandformaat||{{< emoticons/tick >}}||
|[EMF](https://docs.fileformat.com/image/emf/)|Verbeterd Metabestandformaat||{{< emoticons/tick >}}||
|[PDF](https://docs.fileformat.com/pdf/)|Portable Document Format|{{< emoticons/tick >}}|{{< emoticons/tick >}}||
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|XML Paper Specificatie||{{< emoticons/tick >}}||
