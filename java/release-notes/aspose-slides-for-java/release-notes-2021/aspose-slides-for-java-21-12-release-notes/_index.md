...
type: docs
weight: 10
url: /java/aspose-slides-for-java-21-12-release-notes/
---

{{% alert color="primary" %}} 

This page contains release notes for [Aspose.Slides for Java 21.12](https://repository.aspose.com/repo/com/aspose/aspose-slides/21.12/)
...
|SLIDESJAVA-38256|[Use Aspose.Slides for Net 21.12 features](/slides/net/aspose-slides-for-net-21-12-release-notes/)|Enhancement||
...
Obsolete properties `ObjectData`, `EmbeddedFileExtension`, and `EmbeddedFileData` have been removed from [IOleObjectFrame](https://apireference.aspose.com/slides/java/com.aspose.slides/IOleObjectFrame) interface. Use the [setEmbeddedData](https://apireference.aspose.com/slides/java/com.aspose.slides/IOleObjectFrame#setEmbeddedData-com.aspose.slides.IOleEmbeddedDataInfo-) method and [getEmbeddedData](https://apireference.aspose.com/slides/java/com.aspose.slides/IOleObjectFrame#getEmbeddedData--) methods from the [IOleObjectFrame](https://apireference.aspose.com/slides/java/com.aspose.slides/IOleObjectFrame) interface instead.
