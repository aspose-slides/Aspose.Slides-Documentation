...
Method [**IPortion.getRect()**](https://apireference.aspose.com/slides/java/com.aspose.slides/IPortion#getRect--) has been added. This method extends and actually replaces method [IPortion.getCoordinates()](https://apireference.aspose.com/slides/java/com.aspose.slides/IPortion#getCoordinates--) which is marked as obsolete now.
Methods [IPortion.getRect()](https://apireference.aspose.com/slides/java/com.aspose.slides/IPortion#getRect--) and [IParagraph.getRect()](https://apireference.aspose.com/slides/java/com.aspose.slides/IParagraph#getRect--) can be applied to text within table cells.
...
```
 ...
 2) In the next step we're using [IParagrap.getRect()](https://apireference.aspose.com/slides/java/com.aspose.slides/IParagraph#getRect--) and [IPortion.getRect()](https://apireference.aspose.com/slides/java/com.aspose.slides/IPortion#getRect--) methods in order to add frame to portions and paragraphs.
