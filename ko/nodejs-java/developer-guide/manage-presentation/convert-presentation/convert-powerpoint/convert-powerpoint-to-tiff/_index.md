...
- JavaScript
- Aspose.Slides
description: "Aspose.Slides for Node.js를 사용하여 PowerPoint(PPT, PPTX) 프레젠테이션을 고품질 TIFF 이미지로 쉽게 변환하는 방법을 JavaScript 코드 예제와 함께 배우세요."
---
## **소개**

TIFF (**Tagged Image File Format**)은 널리 사용되는 손실 없는 래스터 이미지 형식으로, 뛰어난 품질과 그래픽의 세밀한 보존으로 알려져 있습니다. 디자이너, 사진작가 및 데스크톱 퍼블리셔는 종종 TIFF를 선택하여 이미지의 레이어, 색상 정확도 및 원본 설정을 유지합니다.
...
[save](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/presentation/#save-java.lang.String-int-) 메서드와 [Presentation](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/presentation/) 클래스를 사용하면 전체 PowerPoint 프레젠테이션을 빠르게 TIFF로 변환할 수 있습니다. 결과 TIFF 이미지는 기본 슬라이드 크기에 해당합니다.
...
[setBwConversionMode](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/tiffoptions/#setBwConversionMode-int-) 메서드는 [TiffOptions](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/tiffoptions/) 클래스에서 컬러 슬라이드나 이미지를 흑백 TIFF로 변환할 때 사용할 알고리즘을 지정할 수 있게 합니다. 이 설정은 [setCompressionType](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/tiffoptions/#setCompressionType-int-) 메서드가 `CCITT4` 또는 `CCITT3`로 설정된 경우에만 적용됩니다.

{{% alert color="info" title="Note" %}}
[TiffOptions.setBwConversionMode](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/tiffoptions/#setBwConversionMode-int-)은 전체 TIFF 이미지에 대한 픽셀 변환 알고리즘을 선택하는 내보내기 수준 설정입니다. 흑백 표시 모드가 활성화될 때 개별 도형이 어떻게 표시될지를 정의하려면 [Shape.setBlackWhiteMode](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/shape/#setBlackWhiteMode)를 사용하십시오. 예제는 [Control Black-and-White Rendering for Shapes](/slides/ko/nodejs-java/shape-formatting/#control-black-and-white-rendering-for-shapes)을 참고하세요.
{{% /alert %}}

예를 들어 `sample.pptx` 파일에 다음과 같은 슬라이드가 있다고 가정해 보겠습니다:
...
특정 크기의 TIFF 이미지가 필요하다면 [TiffOptions](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/tiffoptions/)에서 제공되는 메서드를 사용해 원하는 값을 설정할 수 있습니다. 예를 들어, [setImageSize](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/tiffoptions/#setImageSize) 메서드는 결과 이미지의 크기를 정의합니다.
...
try {
    ...
    */
    ...
    // 색 깊이는 픽셀 형식으로 제어됩니다(아래 예제 참고). CCITT3 및 CCITT4는 항상 픽셀당 1비트를 생성합니다.
...
[setPixelFormat](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/tiffoptions/#setPixelFormat) 메서드를 [TiffOptions](https://reference.aspose.com/slides/ko/nodejs-java/aspose.slides/tiffoptions/) 클래스에서 사용하면 결과 TIFF 이미지에 원하는 픽셀 형식을 지정할 수 있습니다.
