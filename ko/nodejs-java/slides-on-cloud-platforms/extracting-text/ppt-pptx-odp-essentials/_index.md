...
type: docs
weight: 10
url: /ko/nodejs-java/slide-text-extraction-ppt-pptx-odp-essentials/
keywords:
- 프레젠테이션 텍스트 추출
- 슬라이드 텍스트 추출
- PPT에서 텍스트 추출
...
- JavaScript
- Aspose.Slides
description: "슬라이드를 데이터로 변환: PPT, PPTX 및 ODP에서 텍스트를 추출하여 검색, 자동화 및 접근성에 활용하고, 포맷에 대한 인사이트 제공—JavaScript 및 클라우드 플랫폼에서 사용 가능."
---
## **소개**
