...
type: docs
weight: 100
url: /ko/python-java/examples/elements/animation/
keywords:
- 코드 예제
- 애니메이션
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Python via Java 애니메이션 예제를 살펴보고, PPT, PPTX 및 ODP 프레젠테이션에서 효과를 추가, 접근, 제거 및 순서 지정하는 방법을 확인하세요."
---
이 문서에서는 **Aspose.Slides for Python via Java**를 사용하여 간단한 애니메이션을 만들고 그 순서를 관리하는 방법을 보여줍니다.

패키지는 [Installation](/slides/ko/python-java/installation/)에 설명된 대로 설치합니다. 각 예제는 JVM을 시작하기 전에 `asposeslides`를 임포트하고, JVM이 실행된 후에 API를 임포트합니다.

## **애니메이션 추가**

사각형 도형을 만들고 클릭 시 트리거되는 페이드 효과를 적용합니다.
...
여러 효과를 추가하고 애니메이션이 발생하는 순서를 제어합니다.
