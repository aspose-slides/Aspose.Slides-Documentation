...
- C#
- Aspose.Slides
description: "Aspose.Slides for .NET의 공용 API 업데이트 및 주요 변경 사항을 검토하여 PowerPoint PPT, PPTX 및 ODP 프레젠테이션 솔루션을 원활하게 마이그레이션하세요."
---
## **공용 API 및 이전 버전과 호환되지 않는 변경 사항**
{{% alert color="info" %}} 

Aspose.Slides for .NET 14.2.0 API에 몇 가지 변경 사항을 적용했습니다. 일부 속성과 메서드가 삭제되고 일부는 다른 네임스페이스로 이동되었습니다.

{{% /alert %}} 
### **Aspose.Slides.IPresentation.Write(…) 메서드 제거**
이 메서드들은 Presentation 객체를 PPTX 형식 파일에만 저장했습니다. 새 API에서는 Presentation 클래스가 모든 형식 작업에 사용됩니다. Presentation.Save(…) 메서드를 사용하여 Presentation 객체를 모든 지원 형식으로 저장할 수 있습니다.
### **테마 스타일과 관련된 클래스가 Aspose.Slides.Theme 네임스페이스로 이동됨**
