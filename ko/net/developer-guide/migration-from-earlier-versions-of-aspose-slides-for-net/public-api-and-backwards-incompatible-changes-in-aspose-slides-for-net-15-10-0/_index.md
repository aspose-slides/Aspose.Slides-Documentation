---
title: Aspose.Slides for .NET 15.10.0의 공용 API 및 이전 버전과 호환되지 않는 변경 사항
linktitle: Aspose.Slides for .NET 15.10.0
type: docs
weight: 200
url: /ko/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/
keywords:
- 마이그레이션
- 레거시 코드
- 현대 코드
...
이 페이지에서는 Aspose.Slides for .NET 15.10.0 API와 함께 도입된 모든 [추가된](/slides/ko/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) 또는 [제거된](/slides/ko/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) 클래스, 메서드, 속성 등을 나열하고 기타 변경 사항을 보여줍니다.

{{% /alert %}} 
## **공용 API 변경 사항**
#### **HTML로 미디어 파일 내보내기를 지원하기 위해 새 VideoPlayerHtmlController 추가**
새 공개 클래스 VideoPlayerHtmlController가 Aspose.Slides.Export 네임스페이스에 추가되었습니다. 이 클래스의 인스턴스를 사용하여 사용자는 비디오 및 오디오 파일을 HTML로 내보낼 수 있습니다.
VideoPlayerHtmlController 생성자는 다음 매개변수를 허용합니다:

path: 비디오 및 오디오 파일이 생성될 경로  
fileName: HTML 파일 이름  

baseUri: 링크 생성에 사용할 기본 URI  
...
``` 
#### **차트 시리즈 애니메이션 API가 추가되었습니다**
새로운 2개의 메서드가 Aspose.Slides.Animation.ISequence 인터페이스에 추가되었습니다.
...
이 메서드들은 차트 요소 애니메이션을 지원하기 위해 설계되었습니다:
by series
by categories
by series elements
by categories elements

차트 요소 애니메이션과 관련된 두 개의 새로운 열거형 EffectChartMajorGroupingType 및 EffectChartMinorGroupingType이 도입되었습니다.

차트에 시리즈 애니메이션을 추가하려면 다음 코드를 사용할 수 있습니다:
