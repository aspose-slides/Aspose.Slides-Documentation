...
- C#
- Aspose.Slides
description: "Aspose.Slides for .NET 6을 구성하여 최신 크로스 플랫폼 C# 애플리케이션에서 PowerPoint PPT, PPTX 및 ODP 프레젠테이션을 만들고, 편집하고, 변환합니다."
---
## **소개**
...
1) Select Aspose.Slides assembly from the project's dependencies and then click **Properties**.
  ![Aspose Slides 패키지 속성](package_properties.png)
2) Set an alias (for example, "Slides").
  ![Aspose Slides 별칭](set_alias.png)
...
```
The new API is described in more detail in [Modern API](/slides/ko/net/modern-api/).