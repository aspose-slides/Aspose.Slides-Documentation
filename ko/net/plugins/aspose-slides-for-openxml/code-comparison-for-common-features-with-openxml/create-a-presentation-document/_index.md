...
type: docs
weight: 60
url: /ko/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // 지정된 파일 경로에 프레젠테이션을 생성합니다. 프레젠테이션 문서 유형은 기본적으로 pptx입니다.
...

{
    ...
    using (Presentation pres = new Presentation())
    {
        ...
        // SlideExCollection 클래스를 인스턴스화합니다
        ISlideCollection slds = pres.Slides;

        // SlidesEx 컬렉션에 빈 슬라이드를 추가합니다
