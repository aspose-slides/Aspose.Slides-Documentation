...
type: docs
weight: 240
url: /ko/java/examples/elements/note/
keywords:
- 코드 예제
- 노트
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java에서 슬라이드 노트를 사용합니다: 명확한 Java 예제를 사용하여 PPT, PPTX 및 ODP 형식으로 발표자 노트를 추가, 읽기, 편집 및 내보냅니다."
---
이 문서는 **Aspose.Slides for Java**를 사용하여 노트 슬라이드를 추가, 읽기, 제거 및 업데이트하는 방법을 보여줍니다.
