...
type: docs
weight: 160
url: /ko/java/examples/elements/math-text/
keywords:
- 코드 예제
- 수학 텍스트
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java 수학 텍스트 예제를 살펴보세요: Java를 사용하여 PPT, PPTX 및 ODP 프레젠테이션에서 방정식, 분수, 행렬 및 기호를 생성하고 서식 지정합니다."
---
이 문서에서는 **Aspose.Slides for Java**를 사용하여 수학 텍스트 도형을 작업하고 방정식을 서식 지정하는 방법을 보여줍니다.

## **수학 텍스트 추가**
분수와 피타고라스 정리를 포함하는 수학 도형을 생성합니다.
