---
title: Aspose.Slides for Java 15.10.0의 공개 API 및 이전 버전과 호환되지 않는 변경 사항
linktitle: Aspose.Slides for Java 15.10.0
type: docs
weight: 180
url: /ko/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/
keywords:
- 마이그레이션
- 레거시 코드
- 최신 코드
...
이 페이지는 Aspose.Slides for Java 15.10.0 API와 함께 도입된 모든 [added](/slides/ko/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/) 또는 [removed](/slides/ko/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/) 클래스, 메서드, 속성 등을 나열합니다.

{{% /alert %}} 
## **공용 API 변경 사항**
#### **Chart series animation API가 ISequence에 추가되었습니다**
새로운 2개의 메서드가 com.aspose.slides.ISequence 인터페이스에 추가되었습니다.
...
```
#### **미디어 파일을 HTML로 내보내기를 지원하기 위해 새로운 com.aspose.slides.VideoPlayerHtmlController가 추가되었습니다**
새로운 public 클래스 com.aspose.slides.VideoPlayerHtmlController가 추가되었습니다. 이 클래스의 인스턴스를 사용하면 사용자가 비디오 및 오디오 파일을 HTML로 내보낼 수 있습니다.

VideoPlayerHtmlController 생성자는 다음 매개변수를 받습니다:

- path: 비디오 및 오디오 파일이 생성될 경로
- fileName: HTML 파일의 이름
- baseUri: 링크를 생성하는 데 사용될 기본 URI
