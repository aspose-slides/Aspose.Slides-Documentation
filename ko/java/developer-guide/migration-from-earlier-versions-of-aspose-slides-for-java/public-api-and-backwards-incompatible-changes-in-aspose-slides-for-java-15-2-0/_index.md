---
title: Aspose.Slides for Java 15.2.0의 공개 API 및 뒤로 호환되지 않는 변경 사항
...
---
{{% alert color="info" %}}
이 페이지에서는 Aspose.Slides for Java 15.2.0 API와 함께 도입된 모든 [추가된](/slides/ko/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-2-0/) 클래스, 메서드, 속성 등을 나열하고, 새로운 제한 사항 및 기타 [변경 사항](/slides/ko/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-2-0/)을 보여줍니다.
{{% /alert %}} {{% alert color="info" %}}
일부 이미지 불릿 및 WordArt 개체에 대한 알려진 문제가 있으며, 이는 Aspose.Slides for Java 15.2.0에서 수정될 예정입니다.
{{% /alert %}}
## **공개 API 변경 사항**
### **addDataPointForDoughnutSeries 메서드가 추가되었습니다**
IChartDataPointCollection.addDataPointForDoughnutSeries() 메서드의 두 가지 오버로드가 도넛 유형 시리즈에 데이터 포인트를 추가하기 위해 추가되었습니다.
### **com.aspose.slides.SmartArtShape 클래스가 com.aspose.slides.GeometryShape 클래스로부터 상속받았습니다**
com.aspose.slides.SmartArtShape 클래스가 com.aspose.slides.GeometryShape 클래스로부터 상속받았습니다. 이 변경으로 Aspose.Slides 객체 모델이 개선되고 SmartArtShape 클래스에 새로운 기능이 추가됩니다.
...
### **com.aspose.slides.PropertyType 열거형에 PptXPptY 값이 추가되었습니다**
직렬화 문제 해결 범위 내에서 com.aspose.slides.PropertyType 열거형에 PptXPptY 값이 추가되었습니다.