---
title: Java를 사용하여 프레젠테이션에서 차트 만들기
linktitle: 차트 만들기
type: docs
weight: 30
url: /ko/java/how-to-create-charts-in-a-presentation/
keywords:
- 마이그레이션
- 차트 만들기
- 레거시 코드
...
- Java
- Aspose.Slides
description: "Java와 Aspose.Slides를 사용하여 PowerPoint PPT, PPTX 및 ODP 프레젠테이션에서 레거시 및 최신 차트 API를 이용해 차트를 만드는 방법을 알아보세요."
---
{{% alert color="info" %}} 
...
{{% /alert %}} 
## **Legacy Code 지원**
Aspose.Slides for Java 14.x.x 이전 버전으로 개발된 레거시 코드를 사용하려면 코드에 약간의 수정만 하면 이전과 동일하게 동작합니다. 이전 Aspose.Slides for Java에서 com.aspose.slides 및 com.aspose.slides.pptx 네임스페이스에 있던 모든 클래스가 이제 단일 com.aspose.slides 네임스페이스로 병합되었습니다. 레거시 Aspose.Slides API를 사용하여 프레젠테이션에서 처음부터 일반 차트를 생성하는 간단한 코드 스니펫을 살펴보고, 새로 병합된 API로 마이그레이션하는 방법을 확인하십시오.
## **Legacy Aspose.Slides for Java 접근 방식**
...
## **New Aspose.Slides for Java 14.x.x 접근 방식**
...
다음 간단한 코드 스니펫을 확인하여 레거시 Aspose.Slides API로 프레젠테이션에서 처음부터 산점도 차트를 생성하는 방법과 새로 병합된 API로 이를 구현하는 방법을 알아보세요.
## **Legacy Aspose.Slides for Java 접근 방식**
