---
title: Java에서 노트가 포함된 PDF로 PowerPoint 프레젠테이션 변환
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java를 사용하여 PPT 및 PPTX 형식을 노트가 포함된 PDF로 변환합니다. 전문적인 프레젠테이션을 위해 레이아웃과 발표자 노트를 보존합니다."
---
## **개요**
...
내보내기 전에 노트 페이지 크기와 방향을 설정하려면 [Notes Page Size](/slides/ko/java/notes-size/)를 참조하십시오.
...
Aspose [Online PowerPoint to PDF Converter](https://products.aspose.app/slides/ko/conversion)를 확인해 보실 수 있습니다.
{{% /alert %}}