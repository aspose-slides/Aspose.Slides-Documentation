...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java를 사용하여 PowerPoint 및 OpenDocument 프레젠테이션의 하이퍼링크를 손쉽게 관리하고, 몇 분만에 상호 작용성과 워크플로우를 향상시킵니다."
---
## **소개**

하이퍼링크는 객체나 데이터, 또는 어떤 위치에 대한 참조입니다. 아래는 PowerPoint 프레젠테이션에서 흔히 볼 수 있는 하이퍼링크 유형입니다:

* 텍스트, 도형 또는 미디어 안에 삽입된 웹사이트 링크
* 슬라이드 링크

Aspose.Slides for Java를 사용하면 프레젠테이션에서 하이퍼링크와 관련된 다양한 작업을 수행할 수 있습니다. 

{{% alert color="info" %}} 

Aspose의 간단하고 [무료 온라인 PowerPoint 편집기](https://products.aspose.app/slides/ko/editor)를 확인해 보세요.
...
try {
	...
	// 이미지를 기반으로 슬라이드 1에 그림 프레임을 생성합니다
...
*[OLE 관리](/slides/ko/java/manage-ole/)*를 확인해 보세요.
...
[IHyperlink](https://reference.aspose.com/slides/ko/java/com.aspose.slides/IHyperlink) 인터페이스의 [ColorSource](https://reference.aspose.com/slides/ko/java/com.aspose.slides/Hyperlink#setColorSource-int-) 속성을 사용하면 하이퍼링크의 색상을 설정하고 색상 정보를 가져올 수 있습니다. 이 기능은 PowerPoint 2019에서 처음 도입되었으며, 이 속성과 관련된 변경 사항은 이전 버전의 PowerPoint에는 적용되지 않습니다.

다음 샘플 코드는 동일한 슬라이드에 서로 다른 색상의 하이퍼링크가 추가되는 예를 보여줍니다:
...
[Hyperlink](https://reference.aspose.com/slides/ko/java/com.aspose.slides/Hyperlink) 클래스는 가변(mutable)입니다. 이 클래스를 사용하면 다음 속성 값을 변경할 수 있습니다:
...
프레젠테이션, 슬라이드 또는 하이퍼링크가 정의된 텍스트에서 [IHyperlinkQueries](https://reference.aspose.com/slides/ko/java/com.aspose.slides/IHyperlinkQueries)를 호출할 수 있습니다. 
...
### 슬라이드가 아니라 “섹션”이나 섹션의 첫 번째 슬라이드로 내부 네비게이션을 만들려면 어떻게 해야 하나요?

PowerPoint에서 섹션은 슬라이드 그룹이며, 네비게이션은 기술적으로 특정 슬라이드를 대상으로 합니다. “섹션으로 이동”하려면 일반적으로 해당 섹션의 첫 번째 슬라이드에 링크를 연결합니다.

### 마스터 슬라이드 요소에 하이퍼링크를 연결하면 모든 슬라이드에서 작동하나요?

예. 마스터 슬라이드와 레이아웃 요소는 하이퍼링크를 지원합니다. 이러한 링크는 자식 슬라이드에 표시되며 슬라이드쇼 중에 클릭할 수 있습니다.

### PDF, HTML, 이미지 또는 비디오로 내보낼 때 하이퍼링크가 유지되나요?

[PDF](/slides/ko/java/convert-powerpoint-to-pdf/)와 [HTML](/slides/ko/java/convert-powerpoint-to-html/)에서는 일반적으로 링크가 유지됩니다. [이미지](/slides/ko/java/convert-powerpoint-to-png/)와 [비디오](/slides/ko/java/convert-powerpoint-to-video/)로 내보낼 경우, 래스터 프레임/비디오 형식 특성상 클릭 가능성이 유지되지 않습니다.