---
title: Java에서 PowerPoint 프레젠테이션 차트 만들기 또는 업데이트하기
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java를 사용하여 PowerPoint 프레젠테이션에서 차트를 만들고 사용자 지정하십시오. 차트를 추가하고, 서식을 지정하며, Java 실용 코드 예제로 차트를 편집합니다."
---
## **개요**

이 문서는 Aspose.Slides를 사용하여 차트를 만들고 사용자 지정하는 방법에 대한 포괄적인 안내서를 제공합니다. 슬라이드에 차트를 프로그래밍 방식으로 추가하고, 데이터를 채우며, 특정 디자인 요구 사항에 맞게 다양한 서식 옵션을 적용하는 방법을 배울 수 있습니다. 전체 문서에서는 프레젠테이션 및 차트 객체 초기화부터 시리즈, 축, 레전드 구성까지 각 단계를 보여주는 상세 코드 예제가 포함되어 있습니다. 이 가이드를 따라 하면 동적 차트 생성을 애플리케이션에 통합하는 방법을 확실히 이해하게 되어 데이터 기반 프레젠테이션을 쉽게 만들 수 있습니다.

## **차트 만들기**
차트는 데이터를 빠르게 시각화하고 통찰을 얻는 데 도움이 되며, 표나 스프레드시트에서는 즉시 파악하기 어려운 정보를 드러낼 수 있습니다. 
...
* 프레젠테이션의 단일 슬라이드에 대량의 데이터를 집계, 압축 또는 요약할 수 있습니다
* 데이터의 패턴과 추세를 드러낼 수 있습니다
* 시간 경과에 따른 또는 특정 측정 단위에 대한 데이터의 방향과 모멘텀을 추론할 수 있습니다 
* 이상치, 변칙, 편차, 오류, 말도 안 되는 데이터를 찾을 수 있습니다 
* 복잡한 데이터를 효과적으로 전달하거나 프레젠테이션 할 수 있습니다

PowerPoint에서는 삽입 기능을 통해 차트를 만들 수 있으며, 다양한 차트 템플릿을 제공하여 여러 유형의 차트를 디자인할 수 있습니다. Aspose.Slides를 사용하면 일반 차트(일반적인 차트 유형 기반)와 사용자 정의 차트를 모두 만들 수 있습니다. 

{{% alert color="info" %}}Aspose.Slides는 차트를 만들 수 있도록 [ChartType](https://reference.aspose.com/slides/ko/java/com.aspose.slides/ChartType) 클래스를 제공합니다. 이 클래스의 필드는 다양한 차트 유형에 해당합니다.{{% /alert %}} 
...
### **산점도 차트 만들기**
산점도 차트(산점 플롯 또는 x‑y 그래프라고도 함)는 두 변수 간의 패턴을 확인하거나 상관관계를 보여줄 때 자주 사용됩니다. 
...
1. [일반 차트 만들기](#creating-normal-charts) 섹션의 단계를 따르세요
2. 세 번째 단계에서 차트를 추가하고 차트 유형을 다음 중 하나로 지정합니다
   1. [ChartType.ScatterWithMarkers](https://reference.aspose.com/slides/ko/java/com.aspose.slides/charttype/#ScatterWithMarkers) - _점이 표시된 산점 차트._
   2. [ChartType.ScatterWithSmoothLinesAndMarkers](https://reference.aspose.com/slides/ko/java/com.aspose.slides/charttype/#ScatterWithSmoothLinesAndMarkers) - _곡선으로 연결되고 데이터 마커가 있는 산점 차트._
   3. [ChartType.ScatterWithSmoothLines](https://reference.aspose.com/slides/ko/java/com.aspose.slides/charttype/#ScatterWithSmoothLines) - _곡선으로 연결되지만 데이터 마커가 없는 산점 차트._
   4. [ChartType.ScatterWithStraightLinesAndMarkers](https://reference.aspose.com/slides/ko/java/com.aspose.slides/charttype/#ScatterWithStraightLinesAndMarkers) - _직선으로 연결되고 데이터 마커가 있는 산점 차트._
   5. [ChartType.ScatterWithStraightLines](https://reference.aspose.com/slides/ko/java/com.aspose.slides/charttype/#ScatterWithStraightLines) - _직선으로 연결되지만 데이터 마커가 없는 산점 차트._

다음 Java 코드는 다양한 마커 시리즈를 사용한 산점도 차트를 만드는 방법을 보여 줍니다: 
...
원형 차트는 특히 범주형 레이블에 숫자 값이 있는 경우, 전체 대비 부분 관계를 보여줄 때 가장 적합합니다. 그러나 파트나 레이블이 많을 경우 막대 차트를 고려하는 것이 좋습니다.
...
3. 기본 데이터를 포함하고 원하는 유형([ChartType](https://reference.aspose.com/slides/ko/java/com.aspose.slides/ChartType).Pie)으로 차트를 추가합니다.
...
try {
    ...
    // 새로운 시리즈의 각 카테고리에 대한 맞춤 레이블을 생성합니다
...
꺾은선 차트(선 그래프라고도 함)는 시간 경과에 따른 값 변화를 보여줄 때 가장 적합합니다. 꺾은선 차트를 사용하면 여러 데이터를 한 번에 비교하고, 시간에 따른 변화와 추세를 추적하며, 데이터 시리즈의 이상 현상을 강조할 수 있습니다.
...
다음 Java 코드는 꺾은선 차트를 만드는 방법을 보여 줍니다:
...
기본적으로 꺾은선 차트의 포인트는 직선으로 연결됩니다. 포인트를 대시(점선)로 연결하려면 다음과 같이 원하는 대시 유형을 지정하면 됩니다:
...
트리맵 차트는 판매 데이터와 같이 카테고리별 크기 비율을 보여주면서 동시에 각 카테고리에서 큰 기여도를 차지하는 항목에 주목하고 싶을 때 가장 적합합니다. 
...
3. 기본 데이터를 포함하고 원하는 유형([ChartType](https://reference.aspose.com/slides/ko/java/com.aspose.slides/ChartType).TreeMap)으로 차트를 추가합니다.
4. 차트 데이터 [IChartDataWorkbook](https://reference.aspose.com/slides/ko/java/com.aspose.slides/IChartDataWorkbook)에 접근합니다.
5. 기본 시리즈와 카테고리를 삭제합니다.
6. 새 시리즈와 카테고리를 추가합니다.
7. 차트 시리즈에 새로운 차트 데이터를 추가합니다.
...
1. [Presentation](https://reference.aspose.com/slides/ko/java/com.aspose.slides/Presentation) 클래스의 인스턴스를 생성합니다.
2. 인덱스로 슬라이드의 참조를 얻습니다.
3. 기본 데이터를 포함하고 원하는 유형([ChartType](https://reference.aspose.com/slides/ko/java/com.aspose.slides/ChartType).OpenHighLowClose)으로 차트를 추가합니다.
4. 차트 데이터 [IChartDataWorkbook](https://reference.aspose.com/slides/ko/java/com.aspose.slides/IChartDataWorkbook)에 접근합니다.
5. 기본 시리즈와 카테고리를 삭제합니다.
6. 새 시리즈와 카테고리를 추가합니다.
7. 차트 시리즈에 새로운 차트 데이터를 추가합니다.
...
<a name="java-create-box-and-whisker-chart" id="java-create-box-and-whisker-chart"><strong><em>단계:</em> Java에서 상자·수염 차트 만들기</strong></a> |
<a name="java-create-powerpoint-box-and-whisker-chart" id="java-powerpoint-box-and-whisker-chart"><strong><em>단계:</em> Java에서 PowerPoint 상자·수염 차트 만들기</strong></a> |
<a name="java-create-powerpoint-presentation-box-and-whisker-chart" id="java-create-powerpoint-presentation-box-and-whisker-chart"><strong><em>단계:</em> Java에서 PowerPoint 프레젠테이션 상자·수염 차트 만들기</strong></a>

1. [Presentation](https://reference.aspose.com/slides/ko/java/com.aspose.slides/Presentation) 클래스의 인스턴스를 생성합니다.
2. 인덱스로 슬라이드의 참조를 가져옵니다.
3. 기본 데이터를 포함하고 원하는 유형([ChartType](https://reference.aspose.com/slides/ko/java/com.aspose.slides/ChartType).BoxAndWhisker)으로 차트를 추가합니다.
4. 차트 데이터 [IChartDataWorkbook](https://reference.aspose.com/slides/ko/java/com.aspose.slides/IChartDataWorkbook)에 접근합니다.
5. 기본 시리즈와 카테고리를 삭제합니다.
6. 새 시리즈와 카테고리를 추가합니다.
7. 차트 시리즈에 새로운 차트 데이터를 추가합니다.
...
다음 Java 코드는 상자·수염 차트를 만드는 방법을 보여 줍니다:
...
1. [Presentation](https://reference.aspose.com/slides/ko/java/com.aspose.slides/Presentation) 클래스의 인스턴스를 생성합니다.
2. 인덱스로 슬라이드의 참조를 가져옵니다.
3. 기본 데이터를 포함하고 원하는 유형([ChartType](https://reference.aspose.com/slides/ko/java/com.aspose.slides/ChartType).Funnel)으로 차트를 추가합니다.
...
1. [Presentation](https://reference.aspose.com/slides/ko/java/com.aspose.slides/Presentation) 클래스의 인스턴스를 생성합니다.
2. 인덱스로 슬라이드의 참조를 가져옵니다.
3. 기본 데이터를 포함하고 원하는 유형([ChartType](https://reference.aspose.com/slides/ko/java/com.aspose.slides/ChartType).sunburst)으로 차트를 추가합니다.
4. 수정된 프레젠테이션을 PPTX 파일로 저장합니다
...
1. [Presentation](https://reference.aspose.com/slides/ko/java/com.aspose.slides/Presentation) 클래스의 인스턴스를 생성합니다.
2. 인덱스로 슬라이드의 참조를 가져옵니다.
3. 기본 데이터를 포함하고 원하는 유형([ChartType](https://reference.aspose.com/slides/ko/java/com.aspose.slides/ChartType).Histogram)으로 차트를 추가합니다.
4. 차트 데이터 [IChartDataWorkbook](https://reference.aspose.com/slides/ko/java/com.aspose.slides/IChartDataWorkbook)에 접근합니다.
5. 기본 시리즈와 카테고리를 삭제합니다.
6. 새 시리즈와 카테고리를 추가합니다.
...
다음 Java 코드는 레이더 차트를 만드는 방법을 보여 줍니다:
...
1. [Presentation](https://reference.aspose.com/slides/ko/java/com.aspose.slides/Presentation) 클래스의 인스턴스를 생성합니다.
2. 인덱스로 슬라이드의 참조를 가져옵니다. 
3. 기본 데이터를 포함하고 원하는 유형([ChartType](https://reference.aspose.com/slides/ko/java/com.aspose.slides/ChartType).ClusteredColumn)으로 차트를 추가합니다.
4. 차트 데이터 [IChartDataWorkbook](https://reference.aspose.com/slides/ko/java/com.aspose.slides/IChartDataWorkbook)에 접근합니다.
5. 기본 시리즈와 카테고리를 삭제합니다.
6. 새 시리즈와 카테고리를 추가합니다.
7. 차트 시리즈에 새로운 차트 데이터를 추가합니다.
...
지도 차트는 데이터를 포함한 영역을 시각화한 것입니다. 지도 차트는 지리적 영역별로 데이터나 값을 비교할 때 가장 적합합니다.
...
다음 Java 코드는 지도 차트를 만드는 방법을 보여 줍니다:
...
콤보 차트(또는 복합 차트)는 하나의 그래프에 두 개 이상의 차트 유형을 결합합니다. 이 차트를 사용하면 두 개 이상의 데이터 집합을 강조, 비교 또는 차이를 검토하여 서로 간의 관계를 파악할 수 있습니다.

![The combination chart](combination_chart.png)

다음 Java 코드는 위에 표시된 콤보 차트를 PowerPoint 프레젠테이션에 만드는 방법을 보여 줍니다:
...
<a name="java-update-powerpoint-chart" id="java-update-powerpoint-chart"><strong><em>단계:</em> Java에서 PowerPoint 차트 업데이트하기</strong></a> |
<a name="java-update-presentation-chart" id="java-update-presentation-chart"><strong><em>단계:</em> Java에서 프레젠테이션 차트 업데이트하기</strong></a> |
<a name="java-update-powerpoint-presentation-chart" id="java-update-powerpoint-presentation-chart"><strong><em>단계:</em> Java에서 PowerPoint 프레젠테이션 차트 업데이트하기</strong></a>

1. 차트를 포함하고 있는 프레젠테이션을 나타내는 [Presentation](https://reference.aspose.com/slides/ko/java/com.aspose.slides/Presentation) 클래스를 인스턴스화합니다. 
2. 인덱스를 사용해 슬라이드의 참조를 얻습니다.
3. 모든 도형을 순회하면서 원하는 차트를 찾습니다.
...
다음 Java 코드는 차트 데이터 범위를 설정하는 방법을 보여 줍니다:
...
## **차트 기본 마커 사용**
차트에 기본 마커를 사용하면 각 차트 시리즈에 자동으로 서로 다른 기본 마커 기호가 지정됩니다.
...
Aspose.Slides는 바, 선, 원형, 영역, 산점, 히스토그램, 레이더 등 다양한 [차트 유형](https://reference.aspose.com/slides/ko/java/com.aspose.slides/charttype/)을 지원합니다. 이를 통해 데이터 시각화 요구에 가장 적합한 차트 유형을 선택할 수 있습니다.

### 슬라이드에 새 차트를 어떻게 추가합니까?

차트를 추가하려면 먼저 [Presentation](https://reference.aspose.com/slides/ko/java/com.aspose.slides/presentation/) 클래스의 인스턴스를 만들고, 인덱스로 원하는 슬라이드를 가져온 다음, 차트 유형과 초기 데이터를 지정하여 차트를 추가하는 메서드를 호출합니다. 이렇게 하면 차트가 프레젠테이션에 직접 삽입됩니다.

### 차트에 표시되는 데이터를 어떻게 업데이트합니까?

차트의 데이터를 업데이트하려면 차트 데이터 워크북([IChartDataWorkbook](https://reference.aspose.com/slides/ko/java/com.aspose.slides/ichartdataworkbook/))에 접근해 기본 시리즈와 카테고리를 삭제하고, 사용자 정의 데이터를 추가하면 됩니다. 이렇게 하면 최신 데이터가 반영된 차트를 얻을 수 있습니다.

### 차트의 외관을 사용자 지정할 수 있습니까?

예, Aspose.Slides는 광범위한 사용자 지정 옵션을 제공합니다. 색상, 글꼴, 레이블, 레전드 및 기타 [서식 요소](/slides/ko/java/chart-entities/)를 변경하여 차트를 특정 디자인 요구 사항에 맞게 조정할 수 있습니다.