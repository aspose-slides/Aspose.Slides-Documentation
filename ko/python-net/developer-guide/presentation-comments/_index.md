...
- Python
- Aspose.Slides
description: "Aspose.Slides for Python via .NET을 사용하여 PowerPoint 프레젠테이션에서 프레젠테이션 주석을 관리합니다: 주석 추가, 읽기, 편집, 회신 및 제거."
---
## **개요**

이 문서는 Aspose.Slides for Python via .NET을 사용하여 프레젠테이션 주석을 관리하는 방법을 설명합니다. 주요 주석 관련 타입을 소개하고 슬라이드에 주석을 추가하고, 기존 주석에 접근하고, 회신 및 최신 주석을 활용하며, 프레젠테이션에서 주석을 제거하는 방법을 보여줍니다.

예제는 PowerPoint에서 일반적인 검토 및 협업 시나리오를 다룹니다. 예를 들어 작성자에게 주석을 할당하고, 주석 텍스트 및 메타데이터를 읽고, 회신 체인을 구축하고, 선택된 주석 또는 모든 주석을 제거하는 방법 등을 포함합니다.

PowerPoint에서 주석은 슬라이드에 표시되는 주석(annotation) 형태로 나타납니다. 주석을 선택하면 해당 텍스트와 관련된 토론이 표시됩니다.

프레젠테이션을 열 때 주석을 변경하지 않고 주석을 표시하거나 숨기려면 [프레젠테이션 열 때 주석 표시 또는 숨기기](/slides/ko/python-net/presentation-view-properties/)를 참조하세요.

## **프레젠테이션에 주석을 추가하는 이유는?**

프레젠테이션을 검토할 때 피드백을 제공하고 동료와 협업하기 위해 주석을 사용할 수 있습니다.

Aspose.Slides for Python via .NET은 주석 작업을 위한 다음 API를 제공합니다:

* The [Presentation](https://reference.aspose.com/slides/ko/python-net/aspose.slides/presentation/) 클래스는 프레젠테이션의 주석 작성자에 대한 접근을 제공합니다.
* The [CommentCollection](https://reference.aspose.com/slides/ko/python-net/aspose.slides/commentcollection/) 클래스는 개별 작성자와 연관된 주석을 나타냅니다.
* The [Comment](https://reference.aspose.com/slides/ko/python-net/aspose.slides/comment/) 클래스는 작성자, 생성 시간, 위치 및 텍스트 등을 포함한 주석 정보를 제공합니다.
* The [CommentAuthor](https://reference.aspose.com/slides/ko/python-net/aspose.slides/commentauthor/) 클래스는 이름, 이니셜 및 연관된 주석을 포함한 작성자 정보를 제공합니다.
...
상위 주석은 회신 계층의 최상위 원본 주석입니다. [Comment](https://reference.aspose.com/slides/ko/python-net/aspose.slides/comment/) 클래스의 [parent_comment](https://reference.aspose.com/slides/ko/python-net/aspose.slides/comment/parent_comment/) 속성을 사용하여 주석의 상위 주석을 가져오거나 설정할 수 있습니다.

다음 예제는 회신을 추가하고 결과 주석 계층 구조를 조사하는 방법을 보여줍니다:
...
* [remove](https://reference.aspose.com/slides/ko/python-net/aspose.slides/comment/remove/) 메서드를 사용하여 주석을 삭제하면 해당 주석에 대한 모든 회신도 삭제됩니다.
* [parent_comment](https://reference.aspose.com/slides/ko/python-net/aspose.slides/comment/parent_comment/) 속성이 순환 참조를 생성하면 [PptxEditException](https://reference.aspose.com/slides/ko/python-net/aspose.slides/pptxeditexception/)이 발생합니다.
{{% /alert %}}

## **최신 주석 추가**

최신 주석은 슬라이드 자체, 특정 모양, 또는 AutoShape 내부의 텍스트 범위와 연관될 수 있습니다. [CommentCollection.add_modern_comment](https://reference.aspose.com/slides/ko/python-net/aspose.slides/commentcollection/add_modern_comment/) 메서드는 슬라이드와 주석 마커 좌표 외에 [Shape](https://reference.aspose.com/slides/ko/python-net/aspose.slides/shape/) 인수를 허용합니다.

`None`을 shape 인수로 전달하면 주석은 슬라이드 수준 주석이 됩니다. 마커는 제공된 좌표에 따라 배치되지만 특정 모양과 연결되지 않으므로 [ModernComment.shape](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncomment/shape/)은 `None`을 반환합니다. [Shape](https://reference.aspose.com/slides/ko/python-net/aspose.slides/shape/)가 제공되면 주석은 해당 모양에 고정됩니다. 좌표는 여전히 슬라이드상의 주석 마커 위치를 정의하고, 모양 연관성은 [ModernComment.shape](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncomment/shape/)을 통해 확인할 수 있습니다.

### **모양에 최신 주석 고정**

다음 예제는 슬라이드 수준 최신 주석과 특정 AutoShape에 고정된 최신 주석을 모두 생성하고, 각 주석에서 연관된 모양을 읽어옵니다.
...
[AutoShape](https://reference.aspose.com/slides/ko/python-net/aspose.slides/autoshape/)에 연관된 최신 주석의 경우, [ModernComment.text_selection_start](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncomment/text_selection_start/)은 모양의 텍스트 프레임에서 선택된 텍스트의 시작 위치를 지정하고, [ModernComment.text_selection_length](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncomment/text_selection_length/)은 선택 길이를 지정합니다. 이 두 속성을 함께 사용하면 AutoShape 내부의 특정 텍스트 범위에 주석을 연관시킬 수 있습니다.
...
- `NOT_DEFINED` — 특정 최신 주석 상태가 정의되지 않음.
- `ACTIVE` — 주석이 활성 상태임.
- `RESOLVED` — 주석이 해결됨.
- `CLOSED` — 주석이 닫힘.

다음 예제는 모양에 고정된 최신 주석을 생성하고, 텍스트 선택에 연관시키며, 해결된 상태로 표시하고, 프레젠테이션을 저장한 뒤 파일을 다시 열어 값을 확인합니다.
...
기존 프레젠테이션을 검사하려면 어떤 주석이 [ModernComment](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncomment/) 인스턴스인지 확인한 후, [ModernComment.shape](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncomment/shape/), [ModernComment.text_selection_start](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncomment/text_selection_start/), [ModernComment.text_selection_length](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncomment/text_selection_length/), 및 [ModernComment.status](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncomment/status/)를 조사합니다. `None` 모양은 슬라이드 수준 주석을 의미합니다. [AutoShape](https://reference.aspose.com/slides/ko/python-net/aspose.slides/autoshape/)에 고정된 경우 텍스트 선택 속성이 모양 텍스트 프레임 내의 연관된 범위를 식별합니다.
...
**Aspose.Slides는 최신 주석에 대한 해결된 상태를 지원합니까?**

예. [ModernComment.status](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncomment/status/)는 [ModernCommentStatus](https://reference.aspose.com/slides/ko/python-net/aspose.slides/moderncommentstatus/) 값을 사용하여 읽고 설정할 수 있으며, `RESOLVED`도 포함됩니다. 이 상태는 프레젠테이션에 저장되며 파일을 다시 연 후에도 읽을 수 있습니다.

**스레드형 토론(회신 체인)이 지원되며 중첩 제한이 있나요?**

예. 각 주석은 [parent comment](https://reference.aspose.com/slides/ko/python-net/aspose.slides/comment/parent_comment/)을 참조할 수 있어 회신 체인을 만들 수 있습니다. API에서는 특정 중첩 깊이 제한을 정의하지 않습니다.

**주석 마커 위치는 슬라이드의 어떤 좌표계로 정의되나요?**

마커 위치는 슬라이드 좌표계의 부동 소수점 좌표로 정의되어 슬라이드에서 정확히 배치할 수 있습니다.