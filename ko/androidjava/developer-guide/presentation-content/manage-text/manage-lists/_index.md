...
- Java
- Aspose.Slides
description: "Aspose.Slides for Android via Java를 사용하여 PowerPoint 및 OpenDocument 프레젠테이션에서 글머리표, 그림, 다중 수준 및 번호 매기기 목록을 만들고 서식 지정하는 방법을 배우세요."
---
## **개요**

Aspose.Slides for Android via Java를 사용하면 PowerPoint 및 OpenDocument 프레젠테이션에서 글머리표 및 번호 매기기 목록을 만들고 서식 지정할 수 있습니다. 목록 항목은 글머리표 설정이 해당 단락 형식을 통해 제어되는 단락입니다.

단락 수준 목록 설정에 접근하려면 [IParagraph.getParagraphFormat](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/iparagraph/#getParagraphFormat--) 메서드를 사용하십시오. 주요 진입점은 [IParagraphFormat.getBullet](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/iparagraphformat/#getBullet--)이며, 이는 [IBulletFormat](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/ibulletformat/) 객체를 반환합니다. 이 객체를 사용하여 글머리표 유형, 기호, 그림, 색상, 크기, 번호 매기기 스타일 및 시작 번호를 설정할 수 있습니다.
...
Aspose.Slides를 사용하면 일반 글머리표 기호를 이미지로 교체할 수 있습니다. 그림 글머리표는 아이콘이나 작은 투명 PNG 파일과 같이 작은 크기에서도 읽기 쉬운 단순 이미지에 가장 적합합니다.

{{% alert color="info" %}}
가능하면 일반 글머리표 기호를 이미지로 교체하려는 경우 투명 배경을 가진 단순 그래픽을 선택하는 것이 가장 좋습니다. 이러한 이미지는 사용자 지정 글머리표 기호로 잘 작동합니다.

이미지는 매우 작은 크기로 축소되므로, 목록에서 글머리표로 사용할 때도 선명하고 시각적으로 효과적인 이미지를 선택하는 것이 좋습니다.
{{% /alert %}}
...
[IParagraphFormat.setDepth](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/iparagraphformat/#setDepth-short-)를 사용하여 목록 항목을 서로 다른 수준에 배치합니다. 레벨 0은 최상위 수준이며, 레벨 1은 그 아래에 중첩되고, 그 이하로 계속됩니다.

다음 Java 코드는 다중 수준 목록을 만드는 방법을 보여줍니다:
...
기존 프레젠테이션에서 목록 서식을 변경하려면 대상 단락에 접근한 뒤 그 단락의 [IParagraphFormat.getBullet](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/iparagraphformat/#getBullet--) 설정을 업데이트합니다. 목록을 만들 때 사용한 동일한 메서드를 사용하여 PPT, PPTX 또는 ODP 파일에서 로드한 목록을 검사하거나 수정할 수 있습니다.
...
예. 프레젠테이션을 로드하고 대상 단락에 접근한 뒤 그 단락의 [IParagraphFormat.getBullet](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/iparagraphformat/#getBullet--) 설정을 검사하거나 업데이트한 후 프레젠테이션을 저장하면 됩니다.

### 목록에 비라틴 문자도 포함될 수 있나요?
