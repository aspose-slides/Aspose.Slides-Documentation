...
- Java
- Aspose.Slides
description: "Aspose.Slides를 사용하여 Android에서 PowerPoint 도형을 서식 지정하는 방법을 알아보세요—PPT, PPTX 및 ODP 파일에 대해 정확하고 완전한 제어로 채우기, 선 및 효과 스타일을 설정합니다."
---
## **소개**

PowerPoint에서는 슬라이드에 도형을 추가할 수 있습니다. 도형은 선으로 구성되어 있기 때문에 외곽선을 수정하거나 효과를 적용하여 서식 지정할 수 있습니다. 또한 내부를 채우는 방식을 지정하여 도형을 서식 지정할 수 있습니다.
...
Aspose.Slides를 사용하면 도형에 대해 사용자 지정 선 스타일을 지정할 수 있습니다. 다음 단계에 따라 진행합니다:
...
기본적으로 PowerPoint가 모서리와 같은 각도에서 두 선을 연결할 때 **Round** 설정을 사용합니다. 그러나 날카로운 각을 가진 도형을 그리는 경우 **Miter** 옵션을 선호할 수 있습니다.

![프레젠테이션의 연결 모양](join-style-powerpoint.png)

다음 Java 코드는 위 이미지와 같이 Miter, Bevel, Round 연결 유형 설정을 사용하여 세 개의 사각형을 만든 방법을 보여줍니다:
...
PowerPoint에서 그라디언트 채우기는 도형에 연속적인 색상 혼합을 적용할 수 있는 서식 옵션입니다. 예를 들어 두 가지 이상의 색상을 점진적으로 서로 섞이도록 적용할 수 있습니다.
...
1. [IGradientFormat](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/igradientformat/) 인터페이스에서 제공되는 그라디언트 스톱 컬렉션의 `add` 메서드를 사용하여 정의된 위치와 함께 원하는 두 색상을 추가합니다.
1. 수정된 프레젠테이션을 PPTX 파일로 저장합니다.
...
PowerPoint에서 패턴 채우기는 두 가지 색상으로 된 디자인(점, 줄무늬, 교차선, 체커 등)을 도형에 적용할 수 있는 서식 옵션입니다. 패턴의 전경색과 배경색을 사용자 지정할 수 있습니다.
...
PowerPoint에서 그림 채우기는 이미지를 도형 내부에 삽입하여 이미지가 도형의 배경처럼 사용되도록 하는 서식 옵션입니다.
...
다음 Java 코드는 도형을 그림으로 채우는 방법을 보여줍니다:
...
타일 그림을 텍스처로 설정하고 타일링 동작을 사용자 정의하려면 [IPictureFillFormat](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/ipicturefillformat/) 인터페이스와 [PictureFillFormat](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/picturefillformat/) 클래스의 다음 메서드를 사용할 수 있습니다:
...
- [setTileAlignment](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/ipicturefillformat/#setTileAlignment-byte-): 도형 내 타일 정렬을 지정합니다.
- [setTileFlip](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/ipicturefillformat/#setTileFlip-int-): 타일을 가로, 세로 또는 둘 다 뒤집을지 제어합니다.
- [setTileOffsetX](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/ipicturefillformat/#setTileOffsetX-float-): 도형 원점으로부터 타일의 가로 오프셋(포인트)을 설정합니다.
- [setTileOffsetY](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/ipicturefillformat/#setTileOffsetY-float-): 도형 원점으로부터 타일의 세로 오프셋(포인트)을 설정합니다.
- [setTileScaleX](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/ipicturefillformat/#setTileScaleX-float-): 타일의 가로 비율을 백분율로 정의합니다.
- [setTileScaleY](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/ipicturefillformat/#setTileScaleY-float-): 타일의 세로 비율을 백분율로 정의합니다.
...
PowerPoint에서 단색 채우기는 도형을 하나의 균일한 색상으로 채우는 서식 옵션입니다. 이 단순한 배경 색상은 그라디언트, 텍스처 또는 패턴 없이 적용됩니다.
...
다음 Java 코드는 사각형에 투명한 채우기 색상을 적용하는 방법을 보여줍니다:
...
다음 Java 코드는 도형을 5도 회전시키는 예시입니다:
...
다음 Java 코드는 슬라이드의 서식을 초기화하고 [LayoutSlide](https://reference.aspose.com/slides/ko/androidjava/com.aspose.slides/layoutslide/)에 있는 모든 플레이스홀더 도형의 위치, 크기 및 서식을 기본값으로 되돌리는 방법을 보여줍니다:
...
거의 영향을 주지 않습니다. 삽입된 이미지와 미디어가 대부분의 파일 용량을 차지하며, 색상, 효과, 그라디언트와 같은 도형 매개 변수는 메타데이터로 저장되어 실제 크기를 거의 증가시키지 않습니다.

**같은 서식을 가진 도형을 슬라이드에서 찾아 그룹화하려면 어떻게 해야 하나요?**

각 도형의 주요 서식 속성(채우기, 선, 효과 설정)을 비교합니다. 모든 해당 값이 일치하면 스타일이 동일하다고 판단하고 논리적으로 그룹화하면 이후 스타일 관리를 단순화할 수 있습니다.

**커스텀 도형 스타일 세트를 별도 파일에 저장해 다른 프레젠테이션에서 재사용할 수 있나요?**

예. 원하는 스타일이 적용된 샘플 도형을 템플릿 슬라이드 세트 또는 .POTX 템플릿 파일에 보관합니다. 새 프레젠테이션을 만들 때 템플릿을 열고 필요한 스타일의 도형을 복제한 뒤, 필요한 곳에 서식을 다시 적용하면 됩니다.