...
type: docs
weight: 100
url: /ko/androidjava/examples/elements/animation/
keywords:
- 코드 예제
- 애니메이션
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Android 애니메이션 예제를 탐색하십시오: Java를 사용하여 PPT, PPTX 및 ODP 프레젠테이션에 효과와 전환을 추가, 순서 지정 및 사용자 정의합니다."
---
이 문서에서는 **Aspose.Slides for Android via Java**를 사용하여 간단한 애니메이션을 만들고 순서를 관리하는 방법을 보여줍니다.
