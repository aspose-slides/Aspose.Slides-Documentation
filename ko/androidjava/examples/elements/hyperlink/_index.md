...
type: docs
weight: 130
url: /ko/androidjava/examples/elements/hyperlink/
keywords:
- 코드 예제
- 하이퍼링크
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Android에서 하이퍼링크를 추가하고 관리합니다: 텍스트, 도형 및 이미지에 대한 링크를 설정하고, PPT, PPTX 및 ODP에 대한 대상 및 동작을 Java 예제로 설정합니다."
---
이 문서는 **Aspose.Slides for Android via Java**를 사용하여 도형에 대한 하이퍼링크를 추가, 액세스, 제거 및 업데이트하는 방법을 보여줍니다.
