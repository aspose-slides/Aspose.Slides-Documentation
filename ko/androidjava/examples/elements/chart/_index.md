...
type: docs
weight: 60
url: /ko/androidjava/examples/elements/chart/
keywords:
- 코드 예제
- 차트
- 파워포인트
...
- 자바
- Aspose.Slides
description: "Aspose.Slides for Android를 사용하여 차트를 마스터하세요: 차트를 만들고, 형식 지정하고, 데이터를 바인딩하며, PPT, PPTX 및 ODP 형식으로 차트를 내보내는 Java 예제입니다."
---
**Aspose.Slides for Android via Java**를 사용하여 다양한 차트 유형을 추가, 액세스, 제거 및 업데이트하는 예제입니다. 아래 스니펫은 기본 차트 작업을 보여줍니다.
...
차트를 만든 후에는 shape 컬렉션을 통해 해당 차트를 가져올 수 있습니다.
