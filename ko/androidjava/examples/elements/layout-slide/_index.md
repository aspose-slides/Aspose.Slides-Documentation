...
type: docs
weight: 20
url: /ko/androidjava/examples/elements/layout-slide/
keywords:
- 코드 예제
- 레이아웃 슬라이드
- PowerPoint
...
- Java
- Aspose.Slides
description: "Android용 Aspose.Slides에서 레이아웃 마스터 슬라이드: PPT, PPTX 및 ODP 프레젠테이션을 위한 Java 예제로 슬라이드 레이아웃, 플레이스홀더 및 마스터를 선택하고 적용하며 사용자 지정합니다."
---
이 문서는 Java를 통해 Android용 Aspose.Slides에서 **Layout Slides**를 사용하는 방법을 보여줍니다. 레이아웃 슬라이드는 일반 슬라이드가 상속받는 디자인과 서식을 정의합니다. 레이아웃 슬라이드를 추가, 접근, 복제 및 제거하고, 사용되지 않는 슬라이드를 정리하여 프레젠테이션 크기를 줄일 수 있습니다.
...
필요하지 않게 된 경우 특정 레이아웃 슬라이드를 제거할 수 있습니다.
