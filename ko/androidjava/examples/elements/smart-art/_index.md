...
type: docs
weight: 140
url: /ko/androidjava/examples/elements/smart-art/
keywords:
- 코드 예제
- SmartArt
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Android에서 SmartArt를 사용하여 PowerPoint 및 OpenDocument 프레젠테이션을 위한 Java로 다이어그램을 생성, 편집, 변환 및 스타일을 지정합니다."
---
이 문서는 **Aspose.Slides for Android via Java**를 사용하여 SmartArt 그래픽을 추가하고, 접근하며, 제거하고, 레이아웃을 변경하는 방법을 보여줍니다.
