...
## **サポートされているファイル形式**
この表には、Aspose.Slides for Android via Javaが読み込みおよび保存できるファイル形式が含まれています：
...
|[JPEG](https://docs.fileformat.com/image/jpeg/)|共同写真専門家グループ| |{{< emoticons/tick >}}| |
|[PNG](https://docs.fileformat.com/image/png/)|ポータブルネットワークグラフィックス| |{{< emoticons/tick >}}| |
|[GIF](https://docs.fileformat.com/image/gif/)|グラフィックスインターチェンジフォーマット| |{{< emoticons/tick >}}| |
...
|[SWF](https://docs.fileformat.com/page-description-language/swf/)|小型ウェブ形式| |{{< emoticons/tick >}}| |
