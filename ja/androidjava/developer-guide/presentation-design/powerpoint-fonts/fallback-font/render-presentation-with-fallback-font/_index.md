...
1. [フォールバックフォントルールコレクションを作成](/slides/ja/androidjava/create-fallback-fonts-collection/)します。
...
{{% alert color="primary" %}} 
[プレゼンテーションの保存と変換について](/slides/ja/androidjava/creating-saving-and-converting-a-presentation/)もっと読む。
{{% /alert %}}