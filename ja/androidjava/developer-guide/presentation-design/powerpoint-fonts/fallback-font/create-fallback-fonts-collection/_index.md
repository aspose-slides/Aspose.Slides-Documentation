...
{{% alert color="primary" %}} 
フォールバックフォントでプレゼンテーションを[レンダリングする方法](/slides/ja/androidjava/render-presentation-with-fallback-font/)について詳しく読む。
{{% /alert %}}