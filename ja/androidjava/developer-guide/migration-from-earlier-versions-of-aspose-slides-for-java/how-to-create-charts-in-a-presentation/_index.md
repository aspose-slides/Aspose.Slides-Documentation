...
新しい[Aspose.Slides for Java API](https://docs.aspose.com/slides/androidjava/)がリリースされ、今ではこの単一の製品がゼロからPowerPointドキュメントを生成し、既存のものを編集する機能をサポートしています。

{{% /alert %}} 
## **レガシーコードのサポート**
Aspose.Slides for Javaの14.x.x以前のバージョンで開発されたレガシーコードを使用するには、コードにいくつかの小さな変更を加える必要がありますが、コードは以前と同様に動作します。com.aspose.slidesおよびcom.aspose.slides.pptx名前空間にあったすべてのクラスは、現在単一のcom.aspose.slides名前空間に統合されています。以下の簡単なコードスニペットを参照し、レガシーAspose.Slides APIを使用してプレゼンテーションに通常のチャートをゼロから作成する方法を確認し、新しい統合APIに移行する手順を追ってください。
...
以下の簡単なコードスニペットを参照し、レガシーAspose.Slides APIを使用してプレゼンテーションに散布図をゼロから作成する方法と、新しい統合APIを使用してそれを達成する方法を確認してください。
## **レガシーAspose.Slides for Javaアプローチ**
