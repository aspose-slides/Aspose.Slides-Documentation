...
type: docs
weight: 160
url: /ja/java/examples/elements/math-text/
keywords:
- コード例
- 数式テキスト
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java の MathematicalText の例を探求し、Java を使用して PPT、PPTX、ODP プレゼンテーションで方程式、分数、行列、記号を作成および書式設定します。"
---
