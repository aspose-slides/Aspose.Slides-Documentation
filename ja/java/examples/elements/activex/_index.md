...
type: docs
weight: 200
url: /ja/java/examples/elements/activex/
keywords:
- コード例
- ActiveX
- PowerPoint
...
- Java
- Aspose.Slides
description: "Aspose.Slides for Java の ActiveX の例をご覧ください。PPT および PPTX プレゼンテーションで ActiveX オブジェクトを挿入、構成、制御する方法を、明確な Java コードとともに示します。"
---
この記事では、**Aspose.Slides for Java** を使用してプレゼンテーションに ActiveX コントロールを追加、アクセス、削除、および構成する方法を示します。
