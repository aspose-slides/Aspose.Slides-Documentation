...
Aspose.Slides for Java は、ドーナツチャートの系列データラベルコールアウト形状を設定するサポートを提供します。以下にサンプル例を示します。
