...
このページでは、Aspose.Slides for Java 15.10.0 API で追加されたまたは削除されたすべての [追加された](/slides/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/) クラス、メソッド、プロパティなど、及びその他の変更点を一覧表示しています。
