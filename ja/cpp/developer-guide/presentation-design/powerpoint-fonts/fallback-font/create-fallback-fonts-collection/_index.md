...
{{% alert color="primary" %}} 
フォールバックフォントで[プレゼンテーションをレンダリングする方法](/slides/ja/cpp/render-presentation-with-fallback-font/)についてさらに読むことができます。
{{% /alert %}}