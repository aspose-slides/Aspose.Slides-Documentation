...
既存のコネクタは、その調整点を通じて調整できます。調整点を持つコネクタのみがこのように変更可能です。詳細は**[コネクタの種類](/slides/cpp/connector/#types-of-connectors)**の下にある表を参照してください。
...
* コネクタの調整ポイントの座標を決定する計算では、コネクタの回転とその反射を考慮する必要があります。**注意**：**[コネクタの種類](/slides/cpp/connector/#types-of-connectors)**の下にあるすべてのコネクタの回転角度は0です。
