---  
title: OpenXMLを使用した共通機能のコード比較  
type: docs  
weight: 10  
url: /ja/net/code-comparison-for-common-features-with-openxml/  
---  
...
- [プレゼンテーションの図形の塗りつぶし色を変更する](/slides/ja/net/change-the-fill-color-of-a-shape-in-a-presentation/)  
- [スライドの数をカウントする](/slides/ja/net/count-the-number-of-slides/)  
- [プレゼンテーションドキュメントを作成する](/slides/ja/net/create-a-presentation-document/)  
...
- [すべてのスライドのテキストを取得する](/slides/ja/net/get-all-the-text-in-all-the-slides/)  
