...
## **サポートされているファイル形式**
この表には、Aspose.Slides for .NET が読み込みおよび保存できるファイル形式が含まれています：
...
|[TIFF](https://docs.fileformat.com/image/tiff/)|タグ イメージ ファイル形式| |{{< emoticons/tick >}}| |
|[EMF](https://docs.fileformat.com/image/emf/)|拡張メタファイル形式| |{{< emoticons/tick >}}| |
|[PDF](https://docs.fileformat.com/pdf/)|ポータブル ドキュメント形式|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[SVG](https://docs.fileformat.com/page-description-language/svg/)|スケーラブルベクトルグラフィックス| |{{< emoticons/tick >}}| |
