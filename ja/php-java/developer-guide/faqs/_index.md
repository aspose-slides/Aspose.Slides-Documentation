...
**A**: Aspose.Slides for PHP via Javaは、[サポートされているファイル形式](/slides/php-java/supported-file-formats/)で説明されているファイル形式をサポートしています。
