...
このページでは、Aspose.Slides for PHP via Java 14.7.0 APIで追加されたすべての[クラス](/slides/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-14-7-0/)、メソッド、プロパティ、その他の変更点、追加された制限について説明しています。
