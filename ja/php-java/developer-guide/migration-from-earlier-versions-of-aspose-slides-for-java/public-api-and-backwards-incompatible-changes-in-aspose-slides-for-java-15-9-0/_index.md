...
このページでは、Aspose.Slides for PHP via Java 15.8.0 API に導入されたすべての[追加された](/slides/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-9-0/)または[削除された](/slides/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-9-0/)クラス、メソッド、プロパティなどおよびその他の変更を一覧表示します。
