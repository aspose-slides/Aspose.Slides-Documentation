...
![Logo produktu Aspose.Slides for PHP via Java](aspose_slides-for-php-via-java.png)

Aspose.Slides for PHP via Java to biblioteka klas, która umożliwia Twoim aplikacjom odczytywanie i zapisywanie dokumentów PowerPoint® bez użycia Microsoft PowerPoint®.
...
Aspose.Slides for PHP via Java został przeniesiony z Aspose.Slides for Java, więc możesz korzystać z dokumentacji i referencji API tego ostatniego.
...
- [Ograniczenia i różnice w API Aspose.Slides for PHP via Java](/slides/pl/php-java/limitations-and-api-differences/)
...
- [Forum wsparcia darmowego Aspose.Slides for PHP via Java](https://forum.aspose.com/c/slides/pl/11)
