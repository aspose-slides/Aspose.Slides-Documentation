---
title: Zarządzanie listami wypunktowanymi i numerowanymi w prezentacjach w Javie
...
- Java
- Aspose.Slides
description: "Dowiedz się, jak tworzyć i formatować listy wypunktowane, obrazkowe, wielopoziomowe i numerowane w prezentacjach PowerPoint i OpenDocument przy użyciu Aspose.Slides dla Javy."
---
## **Przegląd**
...
{{% alert color="primary" %}}
Najlepiej, jeśli planujesz zastąpić regularny symbol wypunktowania obrazem, wybrać prostą grafikę z przezroczystym tłem. Takie obrazy dobrze sprawdzają się jako niestandardowe symbole wypunktowania.
{{% /alert %}}
...
![Obraz do wypunktowań](picture_for_bullets.png)
...
![Wypunktowania obrazkowe](picture_bullets.png)

## **Utworzyć listę wielopoziomową**

Użyj [IParagraphFormat.setDepth](https://reference.aspose.com/slides/pl/java/com.aspose.slides/iparagraphformat/#setDepth-short-) , aby umieścić elementy listy na różnych poziomach. Poziom 0 to najwyższy poziom, poziom 1 jest zagnieżdżony pod nim, i tak dalej.
...
Tak. Załaduj prezentację, uzyskaj dostęp do docelowego akapitu, sprawdź lub zaktualizuj jego ustawienia [IParagraphFormat.getBullet](https://reference.aspose.com/slides/pl/java/com.aspose.slides/iparagraphformat/#getBullet--) i zapisz prezentację.
