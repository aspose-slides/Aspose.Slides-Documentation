...
type: docs
weight: 160
url: /pl/java/examples/elements/math-text/
keywords:
- przykład kodu
- tekst matematyczny
- PowerPoint
...
- Java
- Aspose.Slides
description: "Poznaj przykłady MathematicalText w Aspose.Slides for Java: twórz i formatuj równania, ułamki, macierze oraz symbole przy użyciu Javy w prezentacjach PPT, PPTX i ODP."
---
Ten artykuł demonstruje pracę z kształtami tekstu matematycznego oraz formatowaniem równań przy użyciu **Aspose.Slides for Java**.
