...
type: docs
weight: 190
url: /pl/java/examples/elements/connector/
keywords:
- przykład kodu
- Łącznik
- PowerPoint
...
- Java
- Aspose.Slides
description: "Dowiedz się, jak dodawać, prowadzić i stylizować łączniki między kształtami przy użyciu Aspose.Slides for Java, z przykładami Java dla prezentacji PPT, PPTX i ODP."
---
Ten artykuł pokazuje, jak łączyć kształty przy pomocy łączników i zmieniać ich cele przy użyciu **Aspose.Slides for Java**.
