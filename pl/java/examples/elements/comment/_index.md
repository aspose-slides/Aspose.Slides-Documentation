...
type: docs
weight: 230
url: /pl/java/examples/elements/comment/
keywords:
- przykład kodu
- komentarz
- PowerPoint
...
- Java
- Aspose.Slides
description: "Pracuj z komentarzami slajdów w Aspose.Slides for Java: dodawaj, odpisuj, edytuj, rozwiązuj i eksportuj komentarze w prezentacjach PPT, PPTX i ODP przy użyciu przykładów kodu w Javie."
---
Ten artykuł demonstruje dodawanie, odczytywanie, usuwanie i odpisywanie na nowoczesne komentarze przy użyciu **Aspose.Slides for Java**.
