...
type: docs
weight: 130
url: /pl/java/examples/elements/hyperlink/
keywords:
- przykład kodu
- hiperłącze
- PowerPoint
...
- Java
- Aspose.Slides
description: "Dodawaj i zarządzaj hiperłączami w Aspose.Slides for Java: łącz tekst, kształty i obrazy, ustaw cele i akcje dla PPT, PPTX i ODP przy użyciu przykładów w Javie."
---
Ten artykuł demonstruje dodawanie, dostęp, usuwanie i aktualizowanie hiperłączy na kształtach przy użyciu **Aspose.Slides for Java**.

## **Dodaj hiperłącze**

Utwórz prostokątny kształt z hiperłączem wskazującym na zewnętrzną stronę internetową.
