...
type: docs
weight: 120
url: /pl/java/examples/elements/table/
keywords:
- przykład kodu
- tabela
- PowerPoint
...
- Java
- Aspose.Slides
description: "Pracuj z tabelami w Aspose.Slides dla Javy: twórz, formatuj, scalaj komórki, stosuj style, importuj dane i eksportuj, z przykładami w Javie dla PPT, PPTX i ODP."
---
Przykłady dodawania tabel, uzyskiwania dostępu do nich, usuwania ich oraz scalania komórek przy użyciu **Aspose.Slides for Java**.
