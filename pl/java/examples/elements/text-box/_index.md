...
type: docs
weight: 40
url: /pl/java/examples/elements/text-box/
keywords:
- przykład kodu
- pole tekstowe
- PowerPoint
...
- Java
- Aspose.Slides
description: "Pracuj z polami tekstowymi w Aspose.Slides for Java: dodawaj, formatuj, wyrównuj, zawijaj, automatycznie dopasowuj i stylizuj tekst przy użyciu Javy dla prezentacji PPT, PPTX i ODP."
---
W Aspose.Slides pole **text box** jest reprezentowane przez `AutoShape`. Prawie każdy kształt może zawierać tekst, ale typowe pole tekstowe nie ma wypełnienia ani obramowania i wyświetla tylko tekst.
...
public static void addTextBox() {
    ...
    try {
        ...
        // Utwórz kształt prostokąta (domyślnie wypełniony obramowaniem i bez tekstu).
...
> 💡 **Note:** Każde `AutoShape`, które zawiera niepusty `TextFrame`, może pełnić funkcję pola tekstowego.
...
> 💡 **Tip:** Zawsze twórz kopię kolekcji kształtów przed modyfikacją podczas iteracji, aby uniknąć błędów modyfikacji kolekcji.