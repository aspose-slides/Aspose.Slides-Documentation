...
type: docs
weight: 200
url: /pl/androidjava/examples/elements/activex/
keywords:
- przykład kodu
- ActiveX
- PowerPoint
...
- Java
- Aspose.Slides
description: "Zobacz przykłady ActiveX w Aspose.Slides for Android: wstawianie, konfigurowanie i kontrolowanie obiektów ActiveX w prezentacjach PPT i PPTX przy użyciu przejrzystego kodu Java."
---
Ten artykuł demonstruje, jak dodawać, uzyskiwać dostęp, usuwać i konfigurować kontrolki ActiveX w prezentacji przy użyciu **Aspose.Slides for Android via Java**.
