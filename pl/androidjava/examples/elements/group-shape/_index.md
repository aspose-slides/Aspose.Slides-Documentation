...
type: docs
weight: 170
url: /pl/androidjava/examples/elements/group-shape/
keywords:
- przykład kodu
- grupa kształtów
- PowerPoint
...
- Java
- Aspose.Slides
description: "Zarządzaj grupowanymi kształtami w Aspose.Slides for Android: twórz, zagnieżdżaj, wyrównuj, zmieniaj kolejność i stylizuj grupy kształtów przy użyciu przykładów Java w prezentacjach PPT, PPTX i ODP."
---
Przykłady tworzenia grup kształtów, uzyskiwania do nich dostępu, rozgrupowywania i usuwania przy użyciu **Aspose.Slides for Android via Java**.
...
Pobierz pierwszy kształt grupowy ze slajdu.
