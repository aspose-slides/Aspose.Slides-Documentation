...
Do interfejsu Aspose.Slides.Animation.ISequence dodano nowe 2 metody.
...
Metody te służą do obsługi animacji elementów wykresu:
według serii
według kategorii
...
Aby dodać animację serii do wykresu, można użyć poniższego kodu:
