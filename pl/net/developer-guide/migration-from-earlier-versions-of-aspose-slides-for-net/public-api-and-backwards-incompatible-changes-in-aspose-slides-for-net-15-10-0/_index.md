---
title: "Publiczne API i zmiany niekompatybilne wstecz w Aspose.Slides dla .NET 15.10.0"
linktitle: "Aspose.Slides dla .NET 15.10.0"
type: docs
weight: 200
url: /pl/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/
keywords:
- migracja
- kod dziedziczony
- nowoczesny kod
...
Ta strona wymienia wszystkie [dodane](/slides/pl/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) lub [usunięte](/slides/pl/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/) klasy, metody, właściwości i tak dalej oraz inne zmiany wprowadzone w API Aspose.Slides for .NET 15.10.0.

{{% /alert %}} 
## **Zmiany w publicznym API**
#### **Dodano nowy VideoPlayerHtmlController, aby obsługiwać eksport plików multimedialnych do HTML**
Nowa publiczna klasa VideoPlayerHtmlController została dodana do przestrzeni nazw Aspose.Slides.Export. Korzystając z instancji tej klasy użytkownik może eksportować pliki wideo i audio do HTML.  
...
baseUri: Bazowy URI, który będzie używany do generowania odnośników  
Przykład użycia:
...
``` 
#### **Dodano API animacji serii wykresu**
Do interfejsu Aspose.Slides.Animation.ISequence dodano dwie nowe metody.
...
Wprowadzono dwa nowe wyliczenia EffectChartMajorGroupingType oraz EffectChartMinorGroupingType związane z animacją elementów wykresu.
