---
title: Utwórz dokument prezentacji
type: docs
weight: 60
url: /pl/net/create-a-presentation-document/
---
## **OpenXML SDK**
``` csharp
...

{
    ...
    // Utwórz prezentację w określonej ścieżce pliku. Typ dokumentu prezentacji to pptx, domyślnie.
...

{
...

    {
        ...
        //Utwórz klasę SlideExCollection

        ISlideCollection slds = pres.Slides;

        //Dodaj pusty slajd do kolekcji SlidesEx
