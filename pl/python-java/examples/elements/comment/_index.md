...
type: docs
weight: 230
url: /pl/python-java/examples/elements/comment/
keywords:
- komentarz
...
- Java
- Aspose.Slides
description: "Zarządzaj nowoczesnymi komentarzami slajdów w Aspose.Slides for Python via Java: dodawaj, odczytuj, usuwaj i odpowiadaj na komentarze w prezentacjach PowerPoint i OpenDocument."
---
Ten artykuł demonstruje, jak dodać, odczytać, usunąć i odpowiedzieć na nowoczesne komentarze przy użyciu **Aspose.Slides for Python via Java**.

Zainstaluj pakiet zgodnie z opisem w [Installation](/slides/pl/python-java/installation/). Każdy przykład importuje `asposeslides` przed uruchomieniem JVM, a następnie importuje API i wymagane typy Java po uruchomieniu JVM. Przykłady odczytu i usuwania używają pliku `modern_comment.pptx`, utworzonego przez pierwszy przykład.
