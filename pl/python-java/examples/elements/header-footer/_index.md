...
- Java
- Aspose.Slides
description: "Steruj nagłówkami i stopkami slajdów przy użyciu Aspose.Slides for Python via Java: dodawaj daty, numery slajdów i własny tekst w prezentacjach PPT, PPTX i ODP."
---
Ten artykuł pokazuje, jak dodać stopki i zaktualizować znaczniki daty i godziny przy użyciu **Aspose.Slides for Python via Java**.
