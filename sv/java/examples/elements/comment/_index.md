...
type: docs
weight: 230
url: /sv/java/examples/elements/comment/
keywords:
- kodexempel
- kommentar
- PowerPoint
...
- Java
- Aspose.Slides
description: "Arbeta med bildkommentarer i Aspose.Slides för Java: lägg till, svara, redigera, lösa och exportera kommentarer i PPT-, PPTX- och ODP-presentationer med Java‑kodexempel."
---
Denna artikel demonstrerar hur du lägger till, läser, tar bort och svarar på moderna kommentarer med hjälp av **Aspose.Slides for Java**.
