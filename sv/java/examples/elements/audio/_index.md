...
type: docs
weight: 70
url: /sv/java/examples/elements/audio/
keywords:
- kodexempel
- ljud
- PowerPoint
...
- Java
- Aspose.Slides
description: "Upptäck Aspose.Slides for Java ljudexempel: infoga, spela upp, trimma och extrahera ljud i PPT-, PPTX- och ODP-presentationer med tydlig Java-kod."
---
Den här artikeln visar hur man bäddar in ljudramar och styr uppspelning med **Aspose.Slides for Java**. Följande exempel visar grundläggande ljudoperationer.
...
Denna kod hämtar den första ljudramen på en bild.
