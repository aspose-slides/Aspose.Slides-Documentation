...
Aspose.Slides kan konvertera en PowerPoint‑matematikekvation direkt till LaTeX; en mellanliggande MathML‑fil och en extern konverterare krävs inte. En matematikekvation lagras i en textram som ett [IMathPortion](https://reference.aspose.com/slides/sv/java/com.aspose.slides/imathportion/). Använd [IMathPortion.getMathParagraph](https://reference.aspose.com/slides/sv/java/com.aspose.slides/imathportion/#getMathParagraph--) för att hämta ett [IMathParagraph](https://reference.aspose.com/slides/sv/java/com.aspose.slides/imathparagraph/), och anropa sedan [IMathParagraph.toLatex](https://reference.aspose.com/slides/sv/java/com.aspose.slides/imathparagraph/#toLatex--). Metoden returnerar en sträng som du kan spara, visa, skicka till ett annat program eller bearbeta vidare.

Följande exempel granskar varje textram på varje bild, hittar alla matematikdelar och skriver varje ekvation till en separat `.tex`‑fil:
...
[SlideUtil.getAllTextBoxes](https://reference.aspose.com/slides/sv/java/com.aspose.slides/slideutil/#getAllTextBoxes-com.aspose.slides.IBaseSlide-) returnerar alla textram som hittas på en bild. Typkontrollen för [IMathPortion](https://reference.aspose.com/slides/sv/java/com.aspose.slides/imathportion/) separerar äkta redigerbara ekvationer från vanlig text och bilder.

LaTeX‑motorer och dokumentmallar stödjer inte alla samma kommandon, paket eller Unicode‑tecken. Testa den returnerade strängen med den LaTeX‑motor som används av din applikation. Om en symbol eller Office Math‑element inte har någon lämplig representation i den miljön, ersätt den i den returnerade strängen med ett projektspecifikt kommando eller hoppa över ekvationen och registrera problemet för granskning.

## **Spara matematiska ekvationer som MathML**

Medan människor lätt kan skriva koden för vissa ekvationsformat som LaTeX, har de svårigheter att skriva koden för MathML eftersom det senare är avsett att genereras automatiskt av program. Program läser och analyserar MathML enkelt eftersom dess kod är i XML, så MathML används ofta som ett utskrifts‑ och utskriftsformat i många områden. 
...
Ja, om dessa objekt innehåller textdelar med ett [MathParagraph](https://reference.aspose.com/slides/sv/java/com.aspose.slides/mathparagraph/) (dvs. äkta PowerPoint‑formler) exporteras de. Om en formel är inbäddad som en bild sker ingen export.
