...
- Java
- Aspose.Slides
description: "Upptäck Aspose.Slides för Java: hantera enkelt diagramarbetsböcker i PowerPoint- och OpenDocument-format för att effektivisera dina presentationsdata."
---
## **Översikt**

Den här artikeln förklarar hur du arbetar med diagramarbetsböcker i Aspose.Slides. Den visar hur du läser och skriver diagramdata via arbetsbokströmmar, använder arbetsboksceller som diagramdatapetiketter, får åtkomst till kalkylbladssamlingar och specificerar datakälltyp för diagramvärden.

Den tar också upp hur du arbetar med externa arbetsböcker som datakällor för diagram. Exemplen demonstrerar hur du skapar och tilldelar en extern arbetsbok, hämtar sökvägen till en extern arbetsbok som är länkad till ett diagram och redigerar diagramdata när arbetsboken är tillgänglig.

För arbetsboksceller som representerar saknad data, se [Kontrollera visning av tomma celler](/slides/sv/java/chart-series/) för skillnaden mellan en tom cell och noll, samt en linjediagramjämförelse av de tillgängliga visningslägena.

## **Läsa och skriva diagramdata från en arbetsbok**
Aspose.Slides tillhandahåller metoderna [ReadWorkbookStream](https://reference.aspose.com/slides/sv/java/com.aspose.slides/IChartData#readWorkbookStream--) och [WriteWorkbookStream](https://reference.aspose.com/slides/sv/java/com.aspose.slides/IChartData#writeWorkbookStream-byte:A-) som gör att du kan läsa och skriva arbetsböcker med diagramdata (innehållande diagramdata redigerad med Aspose.Cells). **Obs** att diagramdata måste organiseras på samma sätt eller ha en struktur som liknar källan.

Denna Java‑kod demonstrerar ett exempel på en operation:
...
När du ersätter en inbäddad arbetsbok med en modifierad, behåller diagrammet sina ursprungliga serier och kategorisamlingar. Denna inkonsekvens kan leda till att [IChart.validateChartLayout](https://reference.aspose.com/slides/sv/java/com.aspose.slides/ichart/#validateChartLayout--) kastar ett `ArgumentOutOfRangeException` (parameter: index). För att undvika undantaget, rensa befintliga serier och kategorier **innan** du skriver tillbaka den uppdaterade arbetsboken till diagrammet.
...
Att rensa samlingarna säkerställer att diagramdatastrukturen överensstämmer med den nya arbetsboken, så att `validateChartLayout` kan slutföras utan fel.

## **Ställ in en arbetsbokscell som diagramdatapetikett**
...
5. Ställ in arbetsbokscellen som en datapetikett.
6. Spara presentationen.

Denna Java‑kod visar hur du ställer in en arbetsbokscell som diagramdatapetikett:
...
Denna Java‑kod demonstrerar en operation där metoden [IChartDataWorkbook.Worksheets](https://reference.aspose.com/slides/sv/java/com.aspose.slides/IChartDataWorkbook#getWorksheets--) används för att få åtkomst till en kalkylbladsamling:
...
Den andra (`boolean`) parametern för `setExternalWorkbook`‑metoden används för att ange om en Excel‑arbetsbok ska laddas eller inte. 

* När dess värde sätts till `false` uppdateras endast arbetsbokens sökväg – diagramdata laddas inte och uppdateras inte från målarbetsboken. Du kan vilja använda denna inställning när målarbetsboken saknas eller är otillgänglig. 
* När dess värde sätts till `true` uppdateras diagramdata från målarbetsboken.
...
Nej. Presentationen lagrar en [länk till den externa filen](https://reference.aspose.com/slides/sv/java/com.aspose.slides/chartdata/#getExternalWorkbookPath--) och använder den för att läsa data. Den externa filen i sig ändras inte när presentationen sparas.

**Vad ska jag göra om den externa filen är lösenordsskyddad?**

Aspose.Slides accepterar inte ett lösenord vid länking. En vanlig lösning är att ta bort skyddet i förväg eller förbereda en avkrypterad kopia (t.ex. med [Aspose.Cells](/cells/java/)) och länka till den kopian.
