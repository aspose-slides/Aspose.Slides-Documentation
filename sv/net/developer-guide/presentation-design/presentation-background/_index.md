---
title: Hantera presentationsbakgrunder i .NET
...
Solida färger, gradienter och bilder används ofta som bakgrund för bilder. Du kan ange bakgrunden för en **normal bild** (en enskild bild) eller en **masterbild** (gäller flera bilder samtidigt).
...
Aspose.Slides gör det möjligt att ange en solid färg som bakgrund för masterbilden i en presentation. Masterbilden fungerar som en mall som styr formatering för alla bilder, så när du väljer en solid färg för masterbildens bakgrund appliceras den på varje bild.
...
3. Ställ in masterbildens bakgrunds [FillType](https://reference.aspose.com/slides/sv/net/aspose.slides/filltype/) till `Solid`.
...
4. Använd egenskapen [GradientFormat](https://reference.aspose.com/slides/sv/net/aspose.slides/fillformat/gradientformat/) på [FillFormat](https://reference.aspose.com/slides/sv/net/aspose.slides/fillformat/) för att konfigurera dina önskade gradientinställningar.
5. Spara den ändrade presentationen.
...
Förutom solida och gradientfyllningar gör Aspose.Slides det möjligt att använda bilder som bakgrund för bilder.
...
Följande kodexempel visar hur du ställer in bakgrundsfyllningstypen till en tilad bild och ändrar tilningsinställningarna:
...
### **Ändra transparenten för bakgrundsbilden**

Du kanske vill justera transparensen för en bilds bakgrundsbild för att få bildens innehåll att framträda tydligare. Följande C#‑kod visar hur du ändrar transparensen för en bildbakgrundsbild:
...
Genom att använda [BaseSlide](https://reference.aspose.com/slides/sv/net/aspose.slides/baseslide/)-klassens `background`‑egenskap kan du erhålla den effektiva bakgrunden för en bild.
...
### Kan jag återställa en anpassad bakgrund och återgå till temats/layoutens bakgrund?

Ja. Ta bort bildens anpassade fyllning så ärver bakgrunden återigen från motsvarande [layout](/slides/sv/net/slide-layout/)/[master](/slides/sv/net/slide-master/)-bild (dvs. [tema‑bakgrunden](/slides/sv/net/presentation-theme/)).

### Vad händer med bakgrunden om jag ändrar presentationens tema senare?

Om en bild har sin egen fyllning förblir den oförändrad. Om bakgrunden ärvs från [layout](/slides/sv/net/slide-layout/)/[master](/slides/sv/net/slide-master/)-bilden uppdateras den så att den matchar det [nya temat](/slides/sv/net/presentation-theme/).