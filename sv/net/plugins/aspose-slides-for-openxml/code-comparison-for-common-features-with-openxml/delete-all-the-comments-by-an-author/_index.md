---
title: Ta bort alla kommentarer av en författare
type: docs
weight: 70
url: /sv/net/delete-all-the-comments-by-an-author/
---
## **OpenXML SDK**
``` csharp
...
// Ta bort alla kommentarer i bilderna från en viss författare.
...

{
    ...
    // Hämta den angivna kommentarsförfattaren.
    ...
    // Iterera genom alla matchande författare.
...

    {
        ...
        // Iterera genom alla bilder och hämta bilddelarna.
...

        {
...

            {
...

                {
                    ...
                    // Ta bort alla kommentarer från den angivna författaren.

                    slideCommentsPart.CommentList.RemoveChild<Comment>(comm);

                }

                // Om commentPart inte har några befintliga kommentarer.
        ...
        // Ta bort kommentarsförfattaren från delen med kommentarsförfattare.
