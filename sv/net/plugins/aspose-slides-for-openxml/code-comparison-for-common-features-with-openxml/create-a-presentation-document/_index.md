---
title: Skapa ett presentationsdokument
type: docs
weight: 60
url: /sv/net/create-a-presentation-document/
---
## **OpenXML SDK**
```csharp
...

{
    ...
    // Skapa en presentation på en angiven filsökväg. Presentationsdokumenttypen är pptx som standard.
...

{
    ...
    {
        //Instansiera SlideExCollection-klass
        ISlideCollection slds = pres.Slides;
        //Lägg till en tom bild i SlidesEx-samlingen
