---
title: Sök och ersätt text utan att förlora format i presentation
type: docs
weight: 100
url: /sv/net/find-and-replace-text-without-losing-format-in-presentation/
---
...
//Loopa igenom bildspel

foreach (PowerPoint.Slide sld in pres.Slides)

	//Loopa igenom alla former i bilden

	foreach (PowerPoint.Shape shp in sld.Shapes)

	{

		//Hämta texten i formen

		string str = shp.TextFrame.TextRange.Text;

		//Hitta text att ersätta
