...
Dataetiketter på ett diagram visar detaljer om diagrammets dataserier eller enskilda datapunkter. De gör det möjligt för läsare att snabbt identifiera dataserier, och de gör också diagrammen enklare att förstå.

## **Ställ in dataprecision i diagrammets dataetiketter**

Den här Python-koden visar hur du ställer in dataprecisionen i en diagramdataetikett:
...
Aspose.Slides för Python via Java låter dig ange procentsatsetiketter på visade diagram. Den här Python-koden demonstrerar hur du gör:
...
Den här Python-koden visar hur du ställer in procentsymbolen för en diagramdataetikett:
...
Den här Python-koden visar hur du ställer in etikettavståndet från en kategorisk axel när du hanterar ett diagram ritat från axlar:
...
## **Justera etiketts placering**

När du skapar ett diagram som inte är beroende av någon axel, som ett pajdiagram, kan diagrammets dataetiketter hamna för nära dess kant. I ett sådant fall måste du justera etikettens placering så att förbindelselina visas tydligt.

Den här Python-koden visar hur du justerar etikettens placering på ett pajdiagram:
...
Kombinera automatisk etikettplacering, förbindelselina och minskad teckenstorlek; vid behov, dölj vissa fält (till exempel kategorin) eller visa etiketter endast för extrema/nyckelpunkter.
...
Ange uttryckligen teckensnitt (familj, storlek) och verifiera att teckensnittet är tillgängligt på renderingssidan för att undvika reservteckensnitt.