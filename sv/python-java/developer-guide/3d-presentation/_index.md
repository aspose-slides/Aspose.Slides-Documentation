...
Aspose.Slides för Python via Java kan skapa, redigera, bevara och rendera PowerPoint‑liknande 3D‑formatering för former och text. Denna artikel täcker 3D‑effekter såsom rotation, extrusion, kantlinjer, belysning, material, gradient‑ eller bildfyllningar samt 3D‑text.
...
Installera paketet enligt beskrivningen i [Installation](/slides/sv/python-java/installation/). Varje exempel importerar `asposeslides`, startar JVM:en om det behövs och importerar sedan API:t. Bildfyllnads‑exemplet kräver en `image.jpg`‑fil i arbetskatalogen.
...
| [getExtrusionColor](https://reference.aspose.com/slides/sv/python-java/aspose.slides/threedformat/#getExtrusionColor) | Färg på de extruderade sidorna. | Gör djupet synligt eller matcha sidofärgen med den främre fyllningen. |
| [getDepth](https://reference.aspose.com/slides/sv/python-java/aspose.slides/threedformat/#getDepth) och [setDepth](https://reference.aspose.com/slides/sv/python-java/aspose.slides/threedformat/#setDepth) | Ytterligare 3D‑djup som används av PowerPoint‑3D‑formatering. | Finjustera djupet för former eller text, särskilt tillsammans med kantlinje‑ och materialinställningar. |
...
![Renderad blå 3D-rektangel med vit 3D-text på frontytan](img_01_01.png)
...
I Aspose.Slides ställer du in kameratyp och rotation via 3D‑formatet som returneras av [Shape.getThreeDFormat](https://reference.aspose.com/slides/sv/python-java/aspose.slides/shape/#getThreeDFormat):
...
Använd kameran när du behöver ändra hur betraktaren ser objektet. Den ändrar inte 2D‑formen på sliden. Den ändrar 3D‑vypunkten som PowerPoint och Aspose.Slides använder vid rendering.

## **Lägg till extrusion och djup**

Extrusion får en form att se tjock ut genom att sträcka den bakom frontytan. I PowerPoint styr djupkontrollen denna synliga tjocklek och färgkontrollen bestämmer färgen på sidoytorna.

![PowerPoint‑djupkontroller mappade till extruderingsfärg och extruderingshöjds‑egenskaper](img_02_02.png)

Ställ in extruderingshöjden för tjockleken och extruderingsfärgen för sidofärgen:
...
Använd djupinställningen när du behöver arbeta direkt med PowerPoints djupvärde eller kombinera djup med kantlinje, material och texteffekter. I många form‑scenarier är extruderingshöjd den tydligare inställningen eftersom den direkt uttrycker den synliga extrusionen.

## **Använd gradient‑ eller bildfyllningar med 3D‑effekter**

3D‑formatering är oberoende av formens fyllning. Du kan tillämpa en solid färg, gradient, mönster eller bildfyllning på frontytan och fortfarande använda samma kamera-, ljus-, material‑ och extruderingsinställningar.
...
För att istället använda en bildfyllning, lägg till bilden i presentationen och tilldela den till formens fyllning:
...
![Renderad 3D‑rektangel med en fotofyllning på frontytan och orange extrusion](img_02_04.png)
...
Följande exempel skapar text med en mönsterfyllning, tillämpar en WordArt‑transform och konfigurerar 3D‑inställningar på [TextFrameFormat](https://reference.aspose.com/slides/sv/python-java/aspose.slides/textframeformat/):
...
![Renderad 3D‑text med en bågad WordArt‑transform, orange mönsterfyllning och mörk extrusion](img_02_05.png)

## **Export‑ och renderingsbeteende**

Aspose.Slides bevarar 3D‑formatering vid sparande till PowerPoint‑format som PPTX. Vid rendering eller export till layout‑fasta format rasteriseras 3D‑scenen eller ritas in i utskriften som ett 2D‑resultat. Detta gäller när du renderar slides till PNG, exporterar till PDF, exporterar till HTML eller genererar ramar för videokonvertering.
...
- Om du behöver granska ärvda eller temabaserade formateringsvärden, använd API:t för effektiv formatering.
...
Aspose.Slides skapar och renderar PowerPoint‑3D‑effekter för former och text. Det gör inte exporterade bilder, PDF‑filer eller HTML‑sidor till interaktiva 3D‑scener som en betraktare kan rotera. I PPTX förblir 3D‑formateringen redigerbar i PowerPoint när formatet stöder det.

**Vad är skillnaden mellan en 3D‑modell och en 3D‑effekt?**

En 3D‑modell är ett separat 3D‑objekt som infogas i en presentation. En 3D‑effekt är formatering som appliceras på en vanlig PowerPoint‑form eller text, såsom rotation, extrusion, kantlinje, belysning och material. Denna artikel behandlar 3D‑effekter.

**Vilka inställningar krävs för en synlig 3D‑form?**

Som minimum ska du ställa in en kamerarotation och antingen extrusion eller djup. I praktiken bör du också ställa in en ljusrigg och material så att de renderade ytorna har tydliga högdagrar och skuggor.

**Kan jag applicera 3D‑effekter på både former och text?**

Ja. Använd [Shape.getThreeDFormat] för formens kropp och [TextFrameFormat.getThreeDFormat] för text.

**Kommer 3D‑effekter att visas vid export till bilder, PDF, HTML eller videoramar?**

Ja. Aspose.Slides renderar 3D‑effekter när slide‑bilder, PDF‑utdata, HTML‑utdata eller ramar för videokonvertering produceras. Den exporterade utdata innehåller den renderade bilden, inte ett redigerbart 3D‑objekt.

**Kan jag läsa de slutgiltiga 3D‑värdena efter att arv och temainställningar har tillämpats?**

Ja. Använd [ThreeDFormat.getEffective] för att läsa de slutgiltiga kameravärdena, ljusriggen, kantlinjen och relaterade 3D‑värden.