...
## **Stödda filformat**
Den här tabellen innehåller de filformat som Aspose.Slides för Python via Java kan läsa in och spara:
...
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|XML-pappersspecifikation||{{< emoticons/tick >}}||
