...
type: docs
weight: 230
url: /sv/nodejs-java/examples/elements/comment/
keywords:
- kodexempel
- kommentar
- PowerPoint
...
- JavaScript
- Aspose.Slides
description: "Arbeta med bildkommentarer i Aspose.Slides för Node.js: lägg till, svara, redigera, lösa och exportera kommentarer i PPT-, PPTX- och ODP-presentationer med kodexempel."
---
Den här artikeln visar hur man lägger till, läser, tar bort och svarar på moderna kommentarer med **Aspose.Slides for Node.js via Java**.

## **Lägg till en modern kommentar**

Skapa en kommentar som skrivits av en användare och spara presentationen.
