---
title: Konvertera PowerPoint-presentationer i Handout-läge med JavaScript
...
{{% alert color="warning" %}} 
Kom ihåg att `setSlidesLayoutOptions`‑metoden endast är tillgänglig för vissa utdataformat, såsom PDF, HTML, TIFF, och när rendering som bilder. 
{{% /alert %}} 
...
Aspose.Slides stöder [förinställningar](https://reference.aspose.com/slides/sv/nodejs-java/aspose.slides/handouttype/) upp till 9 miniatyrer per sida med horisontell eller vertikal ordning: 1, 2, 3, 4 (horisontell/vertikal), 6 (horisontell/vertikal) och 9 (horisontell/vertikal).

**Kan jag definiera ett anpassat rutnät, till exempel 5 eller 8 bilder per sida?**

Nej. Antalet och ordningen av miniatyrer styrs strikt av uppräkningen [HandoutType](https://reference.aspose.com/slides/sv/nodejs-java/aspose.slides/handouttype/); godtyckliga layouter stöds inte.

**Kan jag inkludera dolda bilder i Handout‑utdata?**

Ja. Använd `setShowHiddenSlides`‑metoden i exportinställningarna för målformatet, till exempel [PdfOptions](https://reference.aspose.com/slides/sv/nodejs-java/aspose.slides/pdfoptions/), [HtmlOptions](https://reference.aspose.com/slides/sv/nodejs-java/aspose.slides/htmloptions/) eller [TiffOptions](https://reference.aspose.com/slides/sv/nodejs-java/aspose.slides/tiffoptions/).