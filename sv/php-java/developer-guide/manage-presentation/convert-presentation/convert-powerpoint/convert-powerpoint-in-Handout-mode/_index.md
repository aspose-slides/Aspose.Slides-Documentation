...
{{% alert color="warning" %}} 
Tänk på att `setShowHiddenSlides`‑metoden endast är tillgänglig för vissa utdataformat, såsom PDF, HTML, TIFF, och vid rendering som bilder.
{{% /alert %}} 
...
Aspose.Slides stöder [presets](https://reference.aspose.com/slides/sv/php-java/aspose.slides/handouttype/) upp till 9 miniatyrer per sida med horisontell eller vertikal ordning: 1, 2, 3, 4 (horisontell/vertikal), 6 (horisontell/vertikal) och 9 (horisontell/vertikal).

**Kan jag definiera ett anpassat rutnät, exempelvis 5 eller 8 bilder per sida?**
