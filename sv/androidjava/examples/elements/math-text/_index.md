...
type: docs
weight: 160
url: /sv/androidjava/examples/elements/math-text/
keywords:
- kodexempel
- matematisk text
- PowerPoint
...
- Java
- Aspose.Slides
description: "Utforska Aspose.Slides for Android MathematicalText-exempel: skapa och formatera ekvationer, bråk, matriser och symboler med Java i PPT-, PPTX- och ODP-presentationer."
---
Den här artikeln demonstrerar hur man arbetar med matematiska textrutor och formaterar ekvationer med **Aspose.Slides for Android via Java**.
...
static void addMathText() {
    ...
    try {
        ...
        // Lägg till en Math-form på bilden.
        IAutoShape mathShape = slide.getShapes().addMathShape(0, 0, 720, 150);

        // Få åtkomst till det matematiska stycket.
...
static void accessMathText() {
    ...
    try {
        ...
        if (mathShape != null) {
            ...
            // Exempel: skapa ett bråk (inte tillagt här).
            IMathElement fraction = new MathematicalText("x").divide("y");

            // Använd mathParagraph eller fraction efter behov...
        }
    } finally {
        presentation.dispose();
    }
