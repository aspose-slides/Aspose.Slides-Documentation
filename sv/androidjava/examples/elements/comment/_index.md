...
type: docs
weight: 230
url: /sv/androidjava/examples/elements/comment/
keywords:
- kodexempel
- kommentar
- PowerPoint
...
- Java
- Aspose.Slides
description: "Arbeta med bildkommentarer i Aspose.Slides för Android: lägg till, svara, redigera, lösa och exportera kommentarer i PPT-, PPTX- och ODP-presentationer med Java‑kodexempel."
---
Denna artikel demonstrerar hur man lägger till, läser, tar bort och svarar på moderna kommentarer med **Aspose.Slides for Android via Java**.
