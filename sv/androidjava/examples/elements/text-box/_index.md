...
type: docs
weight: 40
url: /sv/androidjava/examples/elements/text-box/
keywords:
- kodexempel
- textruta
- PowerPoint
...
- Java
- Aspose.Slides
description: "Arbeta med textrutor i Aspose.Slides för Android: lägg till, formatera, justera, radbryt, automatiskt anpassa och stilisera text med Java för PPT-, PPTX- och ODP-presentationer."
---
...
Det här exemplet hittar och raderar alla textrutor på den första bilden som innehåller ett specifikt nyckelord:
...
> 💡 **Tips:** Skapa alltid en kopia av formsamlingen innan du modifierar den under iteration för att undvika fel vid samlingsmodifiering.