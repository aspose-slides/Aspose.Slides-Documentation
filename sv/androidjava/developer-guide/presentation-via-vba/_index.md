...
Aspose.Slides tillhandahåller klassen [VbaProject](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/vbaproject/) för att låta dig skapa VBA‑projekt (och projektreferenser) och redigera befintliga moduler. Du kan använda gränssnittet [IVbaProject](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/ivbaproject/) för att hantera VBA som är inbäddad i en presentation.
...
Den här Java‑koden visar hur du lägger till ett VBA‑makro från grunden i en presentation:
...
Du kanske vill titta på **Aspose** [Macro Remover](https://products.aspose.app/slides/sv/remove-macros), en gratis webbapp för att ta bort makron från PowerPoint-, Excel‑ och Word‑dokument. 

{{% /alert %}} 

## **Ta bort VBA‑makron**

Genom att använda egenskapen [VbaProject](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/presentation/#getVbaProject--) under klassen [Presentation](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/presentation) kan du ta bort ett VBA‑makro.

1. Skapa en instans av klassen [Presentation](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/presentation) och ladda presentationen som innehåller makrot.
1. Åtkom makromodulen och ta bort den.
1. Spara den modifierade presentationen.

Den här Java‑koden visar hur du tar bort ett VBA‑makro:
...
Den här Java‑koden visar hur du extraherar VBA‑makron från en presentation som innehåller makron:
...
1. Skapa en instans av klassen [Presentation](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/presentation/) och ladda en presentation som innehåller ett makro.
2. Kontrollera om presentationen innehåller ett [VBA‑projekt](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/vbaproject/).
...
### Stöds arbete med ActiveX‑kontroller som är kopplade till VBA‑kod?
