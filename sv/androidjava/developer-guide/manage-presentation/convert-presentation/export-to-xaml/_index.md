...
XAML, som är ett XML‑baserat språk, är Microsofts variant för att beskriva ett GUI. Du kommer troligen att använda en designer för att arbeta med XAML‑filer för det mesta, men du kan fortfarande skriva och redigera ditt GUI.
...
Du kan välja alternativ från gränssnittet [IXamlOptions](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/IXamlOptions) som styr exportprocessen och bestämmer hur Aspose.Slides exporterar din presentation till XAML.

Till exempel, om du vill att Aspose.Slides ska lägga till dolda bilder från din presentation vid export till XAML, kan du sätta egenskapen [ExportHiddenSlides](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/IXamlOptions#setExportHiddenSlides-boolean-) till true. Se detta exempel i Java‑kod:
