...
Aspose.Slides låter dig konfigurera en samling av reservteckensnittsnormer för en presentation. Varje reservregel representeras av klassen `FontFallBackRule` och kan läggas till i en `FontFallBackRulesCollection`, som implementerar gränssnittet `IFontFallBackRulesCollection`.

Efter att du har skapat samlingen kan du tilldela den till egenskapen `FontFallBackRulesCollection` i presentationens `FontsManager`. `FontsManager` styr teckensnitt över hela presentationen, och varje `Presentation`‑instans har sin egen `FontsManager`.

När `FontsManager` har initierats med reservteckensnittssamlingen tillämpas de angivna reservteckensnitten under presentationens rendering.

## **Tillämna reservregler**

Instanser av [FontFallBackRule](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/FontFallBackRule) klassen kan organiseras i [FontFallBackRulesCollection](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/FontFallBackRulesCollection), som implementerar [IFontFallBackRulesCollection](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/IFontFallBackRulesCollection) gränssnittet. Det går att lägga till eller ta bort regler i samlingen.

Sedan kan denna samling tilldelas [FontFallBackRulesCollection](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/FontFallBackRulesCollection)‑metoden i klassen [FontsManager](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/FontsManager). FontsManager styr teckensnitt över hela presentationen.
...
Här är ett exempel på hur du skapar en samling av reservteckensnittsnormer och tilldelar den till [FontsManager](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/Presentation#getFontsManager--) för en viss presentation:  
...
När FontsManager har initialiserats med reservteckensnittssamlingen tillämpas reservteckensnitten under presentationens rendering.
...
Ja. De är oberoende steg i samma teckensnittslösningspipeline: först löser motorn teckensnittstillgänglighet ([replacement](/slides/sv/androidjava/font-replacement/)/[substitution](/slides/sv/androidjava/font-substitution/)), sedan fyller reservteckensnittet i luckor för saknade glyfer i tillgängliga teckensnitt.