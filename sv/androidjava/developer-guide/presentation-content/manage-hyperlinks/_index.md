---
title: Hantera hyperlänkar i presentationer på Android
...
- Java
- Aspose.Slides
description: "Hantera hyperlänkar i PowerPoint- och OpenDocument-presentationer med Aspose.Slides för Android via Java — förbättra interaktivitet och arbetsflöde på några minuter."
---
## **Introduktion**
...
Aspose.Slides för Android via Java låter dig utföra många uppgifter som involverar hyperlänkar i presentationer.
...
Du kanske vill se *[Hantera OLE](/slides/sv/androidjava/manage-ole/)*.
{{% /alert %}}
...
Klassen [Hyperlink](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/Hyperlink) är muterbar. Med den här klassen kan du ändra värdena för följande egenskaper:
...
Du kan komma åt [IHyperlinkQueries](https://reference.aspose.com/slides/sv/androidjava/com.aspose.slides/IHyperlinkQueries) från en presentation, bild eller text som hyperlänken är definierad för.
...
Ja. Master‑bild- och layout‑element stöder hyperlänkar. Sådana länkar visas på underordnade bilder och är klickbara under bildspelet.

### Kommer hyperlänkar att bevaras vid export till PDF, HTML, bilder eller video?

I [PDF](/slides/sv/androidjava/convert-powerpoint-to-pdf/) och [HTML](/slides/sv/androidjava/convert-powerpoint-to-html/) ja – länkar bevaras i allmänhet. Vid export till [bilder](/slides/sv/androidjava/convert-powerpoint-to-png/) och [video](/slides/sv/androidjava/convert-powerpoint-to-video/) kommer klickbarhet inte att överföras på grund av formatens natur (raster‑ramar/video stöder inte hyperlänkar).