---
title: Konvertera PPT och PPTX till PDF i Python | Avancerade alternativ
...
Att konvertera PowerPoint-presentationer (PPT, PPTX, ODP) till PDF-format i Python erbjuder flera fördelar, inklusive att säkerställa kompatibilitet över olika enheter och bevara layout och formatering av din presentation. Denna guide visar hur man konverterar presentationer till PDF-dokument, använder olika alternativ för att kontrollera bildkvalitet, inkluderar dolda bilder, lösenordsskyddar PDF-dokument, upptäcker teckensnittsersättningar, väljer specifika bilder för konvertering och tillämpar efterlevnadsstandarder på utdatafiler.
...
Paketet innehåller den körtid det behöver, så Microsoft PowerPoint behöver inte vara installerat på den maskin som utför konverteringen.
...
Aspose.Slides för Python skriver direkt API‑information och versionsnummer i utdatadokumenten. Till exempel, när den konverterar en presentation till PDF, fyller Aspose.Slides för Python i fältet Application med värdet '*Aspose.Slides*' och PDF Producer‑fältet med ett värde i formatet '*Aspose.Slides v XX.XX*'. **Obs** att du inte kan instruera Aspose.Slides för Python att ändra eller ta bort denna information från utdatadokument.
{{% /alert %}}
...
Aspose.Slides exporterar presentationer till PDF och säkerställer att innehållet i de resulterande PDF‑filerna noggrant matchar originalpresentationerna. Element och attribut återges exakt i konverteringen, inklusive:
...
Den standardmässiga PowerPoint‑PDF‑konverteringsoperationen utförs med standardalternativ. I detta fall försöker Aspose.Slides konvertera den angivna presentationen till PDF med optimala inställningar på högsta kvalitet. Denna Python‑kod visar hur du konverterar en PowerPoint till PDF:

_Steg: PowerPoint till PDF‑konverteringar i Python_

Följande exempelprogram förklarar dessa konverteringar med Python via .NET
- <a name="python-net-powerpoint-to-pdf"><strong>Steg: Konvertera PowerPoint till PDF med Python via .NET</a></strong>
- <a name="python-net-ppt-to-pdf"><strong>Steg: Konvertera PPT till PDF med Python via .NET</a></strong>
- <a name="python-net-pptx-to-pdf"><strong>Steg: Konvertera PPTX till PDF med Python via .NET</a></strong>
- <a name="python-net-odp-to-pdf"><strong>Steg: Konvertera ODP till PDF med Python via .NET</a></strong>
- <a name="python-net-odp-to-pdf"><strong>Steg: Konvertera PPS till PDF med Python via .NET</a></strong>
...
{{%  alert  color="primary"  %}} 
Aspose tillhandahåller en gratis online **PowerPoint till PDF‑konverterare**(https://products.aspose.app/slides/sv/conversion/ppt-to-pdf) som demonstrerar processen för presentation‑till‑PDF‑konvertering. För en live‑implementering av proceduren som beskrivs här kan du göra ett test med konverteraren.
{{% /alert %}}
...
Med anpassade konverteringsalternativ kan du ställa in din föredragna kvalitet för rasterbilder, ange hur metafiler ska hanteras, sätta en komprimeringsnivå för text, ange DPI för bilder osv. Kodexemplet nedan demonstrerar en operation där en PowerPoint‑presentation konverteras till PDF med flera anpassade alternativ:
...
# Ställer in kvaliteten för JPG-bilder
pdf_options.jpeg_quality = 90

# Ställer in DPI för bilder
pdf_options.sufficient_resolution = 300

# Ställer in beteendet för metafiler
pdf_options.save_metafiles_as_png = True

# Ställer in komprimeringsnivån för textinnehåll
pdf_options.text_compression = slides.export.PdfTextCompression.FLATE

# Definierar PDF-kompatibilitetsläget
...
Denna Python‑kod visar hur du konverterar en PowerPoint till en lösenordsskyddad PDF (med skyddsparametrar från klassen [PdfOptions](https://docs.aspose.com/slides/sv/python-net/api-reference/aspose.slides.export/pdfoptions/)):
...
Denna Python‑kod visar hur du konverterar specifika bilder i en PowerPoint‑presentation till PDF:
...
# Ställer in en array med bildpositioner
slides_array = [ 1, 3 ]
...
Denna Python‑kod visar hur du konverterar en PowerPoint när dess bildstorlek är specifik till en PDF:
...
with slides.Presentation("SelectedSlides.pptx") as presentation:
    ...
    with slides.Presentation() as resized_presentation:
        ...
        # Klona den första bilden från originalpresentationen och ta bort den tomma standardsliden.
        slide = presentation.slides[0]
        resized_presentation.slides.insert_clone(0, slide)
        resized_presentation.slides.remove_at(1)

        # Spara den omgjorda presentationen som en PDF.
        resized_presentation.save("PDF_with_custom_slide_size.pdf", slides.export.SaveFormat.PDF)
```

## **Konvertera PowerPoint till PDF i anteckningsvy för bilder**

Denna Python‑kod visar hur du konverterar en PowerPoint till PDF‑anteckningar:
...
# Konfigurerar PDF-alternativen med notlayout
pdfOptions = slides.export.PdfOptions()
...
# Sparar presentationen som en PDF med anteckningar
...
Aspose.Slides låter dig använda en konverteringsprocedur som följer [Web Content Accessibility Guidelines (**WCAG**)](https://www.w3.org/TR/WCAG-TECHS/pdf.html). Du kan exportera ett PowerPoint‑dokument till PDF med någon av dessa efterlevnadsstandarder: **PDF/A1a**, **PDF/A1b** och **PDF/UA**. Detta Python‑kodexempel demonstrerar en PowerPoint‑till‑PDF‑konverteringsoperation där flera PDF‑filer baserade på olika efterlevnadsstandarder erhålls:
...
{{% alert title="Note" color="warning" %}} 
Aspose.Slides stöd för PDF‑konverteringsoperationer utökas till att låta dig konvertera PDF till de mest populära filformaten. Du kan göra [PDF till HTML](https://products.aspose.com/slides/sv/python-net/conversion/pdf-to-html/), [PDF till bild](https://products.aspose.com/slides/sv/python-net/conversion/pdf-to-image/), [PDF till JPG](https://products.aspose.com/slides/sv/python-net/conversion/pdf-to-jpg/), och [PDF till PNG](https://products.aspose.com/slides/sv/python-net/conversion/pdf-to-png/) konverteringar. Andra PDF‑konverteringsoperationer till specialiserade format—[PDF till SVG](https://products.aspose.com/slides/sv/python-net/conversion/pdf-to-svg/), [PDF till TIFF](https://products.aspose.com/slides/sv/python-net/conversion/pdf-to-tiff/), och [PDF till XML](https://products.aspose.com/slides/sv/python-net/conversion/pdf-to-xml/)—stöds också.
{{% /alert %}}

> **Obs:** Vid export till PDF/UA behandlar Aspose.Slides komplex grafik som SmartArt, diagram och formler som en enda figur. Enskilda banor bevaras inte som separat innehåll och kan märkas som artefakter; alternativ text tillhandahålls endast för hela figuren.

## **FAQ**

### Kan Aspose.Slides för Python ta bort programinformation från PDF‑filen?
...
Du kan specificera vilka bildindex du vill konvertera genom att skicka en array med bildpositioner till `save`‑metoden.

### Är det möjligt att lösenordsskydda PDF‑filen under konverteringen?

Ja, du kan ange ett lösenord och definiera åtkomstbehörigheter med `PdfOptions`‑klassen innan du sparar presentationen som PDF.
...
### Hur kan jag säkerställa att min PDF uppfyller tillgänglighetsstandarder?
...
Ja, genom att sätta egenskapen `show_hidden_slides` i `PdfOptions` till `True` inkluderas dolda bilder i PDF‑filen.
...
### Hanterar Aspose.Slides teckensnittsersättningar automatiskt?

Aspose.Slides upptäcker teckensnittsersättningar under konverteringen, och du kan hantera dem via egenskapen `warning_callback` i `SaveOptions` (för närvarande begränsad).
