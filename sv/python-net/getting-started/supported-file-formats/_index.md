...
- Python
- Aspose.Slides
description: "Upptäck alla filformat som Aspose.Slides för Python via .NET kan öppna, spara och konvertera — inklusive PPT, PPTX och ODP — med tydliga import/export‑stödanteckningar."
---
## **Översikt**

Aspose.Slides stöder presentationsfiler från Microsoft PowerPoint 97 till Office 365, inklusive Microsoft PowerPoint för Mac. Denna artikel listar de PowerPoint-versioner som stöds av biblioteket och ger en tabell över filformat som kan läsas in, sparas eller båda.
...
## **Stödda filformat**
Denna tabell innehåller de filformat som Aspose.Slides för Python via .NET kan läsa in och spara:

|**Format**|**Beskrivning**|**Läs in**|**Spara**|**Anmärkningar**|
| :- | :- | :- | :- | :- |
...
|[PPS](https://docs.fileformat.com/presentation/pps/)|PowerPoint 97-2003-visning|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[PPSX](https://docs.fileformat.com/presentation/ppsx/)|PowerPoint-visning|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|PowerPoint-makroaktiverad presentation|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|PowerPoint-makroaktiverad visning|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
Ja. Aspose.Slides för Python via .NET stöder export till PDF med efterlevnadsnivåer såsom PDF/A-2a, PDF/A-2b, PDF/A-2u, PDF/A-3a, PDF/A-3b samt PDF/UA via inställningen [compliance](https://reference.aspose.com/slides/sv/python-net/aspose.slides.export/pdfoptions/compliance/) i [PDF export options](https://reference.aspose.com/slides/sv/python-net/aspose.slides.export/pdfoptions/).

**Stöder biblioteket inbäddning av teckensnitt vid export till PDF, med detaljerad kontroll över vad som inbäddas?**

Ja. Du kan styra om teckensnitt inbäddas helt eller delvis (endast använda glyfer), ange hur vanliga systemteckensnitt behandlas och konfigurera beteende för ASCII‑text via [PDF export options](https://reference.aspose.com/slides/sv/python-net/aspose.slides.export/pdfoptions/).

**Kan jag upptäcka om en fil är lösenordsskyddad innan jag faktiskt laddar den?**

Ja. Med hjälp av [factory-based inspection API](https://reference.aspose.com/slides/sv/python-net/aspose.slides/presentationfactory/) kan du fråga en presentationsfil för att avgöra om den är lösenordsskyddad utan att öppna den helt.

**Finns det mekanismer för teckensnittsfallback och stöd för anpassade teckensnitt?**

Ja. Biblioteket stöder [laddning](/slides/sv/python-net/custom-font/) och [inbäddning](/slides/sv/python-net/embedded-font/) av anpassade teckensnitt och tillhandahåller font [fallbackregler](/slides/sv/python-net/fallback-font/) för att förhindra saknade glyfer vid rendering och konvertering.

**Kan jag exportera bilder till XPS, och finns det alternativ för att finjustera XPS-utdata?**

Ja. [Export till XPS](/slides/sv/python-net/convert-powerpoint-to-xps/) stöds, och du kan justera relevanta [sparalternativ](https://reference.aspose.com/slides/sv/python-net/aspose.slides.export/xpsoptions/) för att kontrollera utskriftskvaliteten och innehållet i XPS-dokumentet.