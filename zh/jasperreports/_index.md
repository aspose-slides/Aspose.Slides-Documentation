...
description: Aspose.Slides for JasperReports 是一个专为需要在 Java 应用程序中轻松将 JasperReports 报表导出为 Microsoft PowerPoint 演示文稿 (PPT) 和 Microsoft PowerPoint 幻灯片放映 (PPS) 格式的开发人员设计和开发的库。
type: docs
weight: 70
