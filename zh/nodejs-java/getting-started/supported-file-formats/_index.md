...
## **支持的文件格式**
此表格包含 Aspose.Slides for Node.js 通过 Java 可加载和保存的文件格式：
...
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|启用宏的 PowerPoint 幻灯片放映|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
