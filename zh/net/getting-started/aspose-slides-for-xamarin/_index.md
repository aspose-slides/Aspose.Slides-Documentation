...
Xamarin 是一种用于 .NET C# 移动开发的框架。Xamarin 拥有扩展 .NET 平台功能的工具和库。它允许开发人员为 **Android** 操作系统构建应用程序。 

{{% alert color="info" %}} 

在 Xamarin 开发中，程序员可以使用常用的开发环境（C#、Visual Studio 以及第三方库）。
...
我们在本页底部附近的另一个章节提供了完整功能的对比。

在 Aspose.Slides for Xamarin API 中，类、命名空间、逻辑和行为尽可能与 .NET 版本保持一致。您可以以最小的成本将 Aspose.Slides .NET 应用迁移到 Xamarin。


## **快速示例**
您可以使用 Aspose.Slides for Xamarin 通过 Slides for Android 构建并利用您的 C# 应用程序。

我们提供了一个通过 Xamarin 的 Android 示例应用，该应用使用 Aspose.Slides 在触摸时显示演示文稿幻灯片并在幻灯片上添加新形状。您可以在[GitHub](https://github.com/aspose-slides/Aspose.Slides-for-.NET/tree/master/Xamarin) 上找到示例的完整源码。

让我们从创建一个 Xamarin Android 应用开始：

![todo:image_alt_text](https://lh3.googleusercontent.com/sNkKZnuuGo8phWI-4g4jRA_ZESKpO9RXehPj46RVymXGPcCJuYooePXcBEcb7N6uUUxgocl4o9OjwnajzWKmL2i4MUz3gKKwXw6C0ow_VScN8vlyGBK3SpLKoE_m9BDJ3iNE4xPj)

首先，我们创建一个内容布局，其中包含图像视图、Prev 和 Next 按钮：
...
在此，我们引用包含示例演示文稿（"HelloWorld.pptx"）的 "Aspose.Slides.Droid.dll" 库到 Xamarin 应用的 Assets，并将其初始化添加到 MainActivity：
...
|创建/编辑/删除幻灯片分节|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|**备注幻灯片功能**| | |
