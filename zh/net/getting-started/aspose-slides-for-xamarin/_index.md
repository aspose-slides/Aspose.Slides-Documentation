---
title: 适用于 Xamarin 的 Aspose.Slides
type: docs
weight: 150
...
- C#
- Aspose.Slides
description: "使用 Aspose.Slides 在 C# 中构建 Xamarin 移动应用，以在 Android 上查看、编辑和转换演示文稿，支持 PPT、PPTX 和 ODP 的丰富功能。"
---
## **简介**

Xamarin 是一个用于 .NET C# 移动开发的框架。Xamarin 提供的工具和库扩展了 .NET 平台的功能。它允许开发者为 **Android** 操作系统构建应用程序。

{{% alert color="info" %}} 

在 Xamarin 开发中，程序员可以使用常用的开发环境（C#、Visual Studio 和第三方库）。

{{% /alert %}}

Aspose.Slides API 在 Xamarin 平台上运行。为实现此目的，Aspose.Slides .NET 包为 Xamarin 添加了单独的 DLL。Aspose.Slides for Xamarin 支持 .NET 版本中大多数可用功能：
...
我们在本页底部的另一个章节中提供了完整功能的对比。

在 Aspose.Slides for Xamarin API 中，类、命名空间、逻辑和行为尽可能保持与 .NET 版本相同。您可以以极低的成本将 Aspose.Slides .NET 应用迁移到 Xamarin。

## **快速示例**
您可以使用 Aspose.Slides for Xamarin 通过 Slides for Android 构建并运行您的 C# 应用程序。

我们提供了一个基于 Xamarin 的 Android 示例应用，该应用使用 Aspose.Slides 显示演示文稿幻灯片，并在触摸时向幻灯片添加新形状。您可以在[GitHub](https://github.com/aspose-slides/Aspose.Slides-for-.NET/tree/master/Xamarin)上找到示例的完整源代码。

让我们从创建一个 Xamarin Android 应用开始：

![todo:image_alt_text](https://lh3.googleusercontent.com/sNkKZnuuGo8phWI-4g4jRA_ZESKpO9RXehPj46RVymXGPcCJuYooePXcBEcb7N6uUUxgocl4o9OjwnajzWKmL2i4MUz3gKKwXw6C0ow_VScN8vlyGBK3SpLKoE_m9BDJ3iNE4xPj)

首先，创建一个包含 ImageView、Prev 和 Next 按钮的内容布局：
...
这里，我们在 Xamarin 应用的 Assets 中引用包含示例演示文稿（"HelloWorld.pptx"）的 "Aspose.Slides.Droid.dll" 库，并在 MainActivity 中进行初始化：
...
下面添加函数，以在点击按钮时显示 Prev 和 Next 幻灯片：
...
|PowerPoint 97 - 2003 格式 打开/保存|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|PowerPoint 2007 格式 打开/保存|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|评论呈现|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|创建/编辑/删除幻灯片章节|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|**备注幻灯片功能**| | |
...
|旧版图表|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|文字段落格式化|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|**动画功能：**| | |
