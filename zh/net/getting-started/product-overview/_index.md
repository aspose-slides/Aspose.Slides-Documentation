...
- 主要支持途径是 [Aspose 论坛](https://forum.aspose.com/)。在 [Aspose.Slides 论坛](https://forum.aspose.com/c/slides/11) 中发布您的问题——我们会在几个小时内给予回复。Aspose.Slides 支持团队会直接回答在论坛上发布的问题。
...
- 在报告问题之前，首先检查并确认您正在使用最新的 Aspose.Slides for .NET 版本。也许，您所遇到的问题在更新中已得到解决。
  ...
  请参见 [Aspose.Slides 下载](https://www.nuget.org/packages/Aspose.Slides.NET/) 获取有关最新产品版本的信息。
