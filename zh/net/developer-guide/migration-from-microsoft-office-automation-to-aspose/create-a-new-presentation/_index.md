...
{{% /alert %}} 
## **创建演示文稿**
下面是两个代码示例，演示如何使用 VSTO 和 Aspose.Slides for .NET 来实现相同的目标。第一个示例是[VSTO](/slides/zh/net/create-a-new-presentation/)，[第二个示例](/slides/zh/net/create-a-new-presentation/) 使用 Aspose.Slides。
### **VSTO 示例**
**VSTO 输出** 
