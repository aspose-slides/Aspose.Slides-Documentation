...
---
{{% alert color="info" %}} 
此页面列出了在 Aspose.Slides for .NET 15.2.0 API 中[added](/slides/zh/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-2-0/)或[removed](/slides/zh/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-2-0/)的类、方法、属性等以及其他更改。
{{% /alert %}} 
## **Public API Changes**
...
Aspose.Slides.SmartArt.SmartArtShape 类已从 Aspose.Slides.GeometryShape 类继承。此更改改进了 Aspose.Slides 对象模型，并为 SmartArtShape 类添加了新功能。
...
在修复序列化问题的范围内，已向 Aspose.Slides.Animation.PropertyType 枚举添加了 PptXPptY 值。
