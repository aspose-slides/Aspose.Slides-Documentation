---
title: Aspose.Slides for .NET 15.10.0 中的公共 API 与向后不兼容的更改
...
---
{{% alert color="info" %}} 
此页面列出了所有[已添加](/slides/zh/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/)或[已移除](/slides/zh/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/)的类、方法、属性等，以及 Aspose.Slides for .NET 15.10.0 API 引入的其他更改。 
{{% /alert %}} 
## **公共 API 更改**
#### **添加了 VideoPlayerHtmlController 以支持将媒体文件导出为 HTML**
...
``` 
#### **已添加图表系列动画 API**
已向 Aspose.Slides.Animation.ISequence 接口添加了两个新方法。
