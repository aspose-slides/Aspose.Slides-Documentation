...
此页面列出了所有已添加[added](/slides/zh/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/)或已移除[removed](/slides/zh/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-15-10-0/)的类、方法、属性等，以及 Aspose.Slides for .NET 15.10.0 API 引入的其他更改。
...
引入了两个新枚举 EffectChartMajorGroupingType 和 EffectChartMinorGroupingType，专用于图表元素动画。
