---
title: Aspose.Slides for .NET 14.6.0 的公共 API 及向后不兼容更改
...
在自定义数值类型情况下，要指定数值，请使用系列 DataPoints 集合中特定数据点的 ErrorBarCustomValues 属性。
...
``` 
#### **已添加 Aspose.Slides.Charts.IErrorBarsCustomValues 接口**
当 IErrorBarsFormat.ValueType 属性等于 Custom 时，要指定数值，请使用 DataPoints 集合中特定数据点的 ErrorBarCustomValues 属性。
...
``` 
#### **已添加 Aspose.Slides.Charts.IDataSourceTypeForErrorBarsCustomValues 接口**
...
``` 
#### **已添加 Aspose.Slides.IShapeCollection.AddClone(...), 以及 .InsertClone(...) 方法**
...
IPresentation.ViewProperties 允许开发者在 PowerPoint 中打开演示文稿时更改视图类型和批注可见性。
