...
在自定义值类型的情况下，要指定值，请使用系列 DataPoints 集合中特定数据点的 ErrorBarCustomValues 属性。
...
IPresentation.ViewProperty 允许开发者在 PowerPoint 中打开演示文稿时更改演示文稿的视图类型和备注的可见性。
