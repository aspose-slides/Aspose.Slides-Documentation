...
此页面列出了在 Aspose.Slides for .NET 16.1.0 API 中新增的或移除的所有[class](/slides/net/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-net-16-1-0/)类、方法、属性等，以及其他更改。
