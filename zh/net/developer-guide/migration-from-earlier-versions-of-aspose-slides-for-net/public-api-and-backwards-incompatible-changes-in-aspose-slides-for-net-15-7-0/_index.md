---
title: Aspose.Slides for .NET 15.7.0 的公共 API 和向后不兼容更改
...
{{% alert color="primary" %}} 
此页面列出所有已添加或已移除的类、方法、属性等，以及 Aspose.Slides for .NET 15.7.0 API 中引入的其他更改。
{{% /alert %}} 
## **Public API Changes**
...
#### **已在 ITiffOptions 和 TiffOptions 中添加属性 PixelFormat**
