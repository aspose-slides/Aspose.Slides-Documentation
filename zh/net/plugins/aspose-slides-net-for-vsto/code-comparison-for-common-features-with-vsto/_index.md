...
- [在表格单元格中添加图像](/slides/zh/net/add-image-in-table-cell/)
- [在 VSTO 和 Aspose.Slides 中添加带动画的图片框](/slides/zh/net/adding-picture-frame-with-animation-in-vsto-and-aspose-slides/)
- [向演示文稿添加形状](/slides/zh/net/adding-shapes-to-presentation/)
- [动态添加文本](/slides/zh/net/adding-text-dynamically/)
- [向演示文稿添加图片框](/slides/zh/net/add-picture-frame-to-presentation/)
- [创建图表](/slides/zh/net/create-a-chart/)
- [将 Excel 图表创建并嵌入为 OLE 对象](/slides/zh/net/create-and-embed-an-excel-chart-as-an-ole-object/)
...
- [在演示文稿中查找和替换文本而不丢失格式](/slides/zh/net/find-and-replace-text-without-losing-format-in-presentation/)
...
- [在 VSTO 和 Aspose.Slides 中移除表格中的行或列](/slides/zh/net/removing-row-or-column-in-table-in-vsto-and-aspose-slides/)
