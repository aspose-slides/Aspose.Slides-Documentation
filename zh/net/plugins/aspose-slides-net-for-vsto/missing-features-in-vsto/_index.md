...
- [将布局幻灯片添加到演示文稿](/slides/zh/net/add-layout-slide-to-presentation/)
...
- [将媒体文件导出为 HTML 文件](/slides/zh/net/export-media-files-into-file/)
- [生成 JPEG 格式的幻灯片缩略图](/slides/zh/net/generate-slide-thumbnail-as-jpeg/)
- [从具有用户定义维度的幻灯片生成缩略图](/slides/zh/net/generating-a-thumbnail-from-a-slide-with-user-defined-dimensions/)
