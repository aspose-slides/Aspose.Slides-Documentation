...
## **使用强调框**
新属性 **ShowLabelAsDataCallout** 已添加到 **DataLabelFormat** 类和 **IDataLabelFormat** 接口，用于确定指定图表的数据标签将显示为数据强调框还是数据标签。在下面给出的示例中，我们设置了强调框。

{{< gist "aspose-slides" "a690df625dc0b1fff869ab198affe7a4" "Examples-SlidesCPP-DisplayChartLabels-DisplayChartLabels.cpp" >}}

## **为圆环图设置强调框**
Aspose.Slides for C++ 支持为圆环图设置系列数据标签强调框形状。以下示例给出。
