...
* 除了 Word 的编辑功能之外，您还可以受益于增强的协作、打印和共享功能。 

{{% alert color="info" %}} 

您可以尝试我们的 [**演示文稿转 Word 在线转换器**](https://products.aspose.app/slides/zh/conversion/ppt-to-word) ，了解从幻灯片文本内容中可以获得的收益。 

{{% /alert %}} 

## **Aspose.Slides 与 Aspose.Words**

要将 PowerPoint 文件（PPTX 或 PPT）转换为 Word（DOCX 或 DOCX），您需要同时使用 [Aspose.Slides for C++](https://products.aspose.com/slides/zh/cpp/) 和 [Aspose.Words for C++](https://products.aspose.com/words/cpp/)。  

作为独立的 API，适用于 C++ 的 [Aspose.Slides](https://products.aspose.app/slides) 提供了可从演示文稿中提取文本的功能。  
...
您只需在项目中添加适用于 C++ 的 [Aspose.Slides](https://releases.aspose.com/slides/zh/cpp/) 和 [Aspose.Words](https://releases.aspose.com/words/cpp/) 相应的包。两个库均为独立的 API，且不需要安装 Microsoft Office。  

### 是否支持所有 PowerPoint 和 OpenDocument 演示文稿格式？

Aspose.Slides [支持所有演示文稿格式](/slides/zh/cpp/supported-file-formats/)，包括 PPT、PPTX、ODP 以及其他常见文件类型。这确保您能够处理在不同版本的 Microsoft PowerPoint 中创建的演示文稿。