...
## **支持的文件格式**
此表包含 Aspose.Slides for С++ 可以加载和保存的文件格式：
...
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|支持宏的 PowerPoint 演示文稿|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|支持宏的 PowerPoint 演示|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[POTM](https://docs.fileformat.com/presentation/potm/)|支持宏的 PowerPoint 模板|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[XPS](https://docs.fileformat.com/page-description-language/xps/)|XML 文档规范| |{{< emoticons/tick >}}| |
...
|[BMP](https://docs.fileformat.com/image/bmp/)|设备独立位图| |{{< emoticons/tick >}}| |
