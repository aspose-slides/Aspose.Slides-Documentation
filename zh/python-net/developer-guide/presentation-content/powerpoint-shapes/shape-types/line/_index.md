---
title: 使用 Python 在演示文稿中创建直线形状
linktitle: 直线
type: docs
weight: 50
url: /zh/python-net/developer-guide/presentation-content/powerpoint-shapes/shape-types/line/
keywords:
- 直线
- 创建直线
- 添加直线
...
- Python
- Aspose.Slides
description: "了解如何使用 Aspose.Slides for Python via .NET 在 PowerPoint 和 OpenDocument 演示文稿中操作直线格式。探索属性、方法和示例。"
---

## **概述**

Aspose.Slides for Python via .NET 支持向幻灯片添加不同类型的形状。在本主题中，我们将通过向幻灯片添加直线来开始使用形状。使用 Aspose.Slides，开发人员不仅可以创建简单的直线，还可以在幻灯片上绘制一些花哨的直线。

## **创建普通直线**

使用 Aspose.Slides 向幻灯片添加普通直线，可作为简易分隔符或连接线。要向演示文稿中选定的幻灯片添加普通直线，请按以下步骤操作：
...
Aspose.Slides 允许您配置直线属性，使其更具视觉吸引力。下面，我们配置几项直线属性，使其看起来像箭头。请按以下步骤操作：
...
**我可以将普通直线转换为连接线，使其“吸附”到形状上吗？**

不行。普通直线（类型为 [LINE](https://reference.aspose.com/slides/python-net/aspose.slides/shapetype/) 的 [AutoShape](https://reference.aspose.com/slides/python-net/aspose.slides/autoshape/)）不会自动成为连接线。要实现吸附到形状，请使用专用的 [Connector](https://reference.aspose.com/slides/python-net/aspose.slides/connector/) 类型以及用于连接的 [相应 API](/slides/zh/python-net/connector/)。

**如果直线的属性是从主题继承而来，难以确定最终值，我该怎么办？**
