---
title: 使用 Python 将 PowerPoint 演示文稿转换为 SWF Flash
...
可以。请在 [SwfOptions](https://reference.aspose.com/slides/python-net/aspose.slides.export/swfoptions/) 中启用 [show_hidden_slides](https://reference.aspose.com/slides/python-net/aspose.slides.export/swfoptions/show_hidden_slides/) 选项。默认情况下，隐藏的幻灯片不会被导出。
...
[viewer_included](https://reference.aspose.com/slides/python-net/aspose.slides.export/swfoptions/viewer_included/) 会添加内嵌播放器 UI（导航控件、面板、搜索）。如果您打算使用自己的播放器或需要没有 UI 的纯 SWF 框架，请禁用此选项。

**如果导出机器上缺少源字体会怎样？**

Aspose.Slides 将使用您通过 [default_regular_font](https://reference.aspose.com/slides/python-net/aspose.slides.export/swfoptions/default_regular_font/) 在 [SwfOptions](https://reference.aspose.com/slides/python-net/aspose.slides.export/swfoptions/) 中指定的字体进行替代，以避免意外的回退。