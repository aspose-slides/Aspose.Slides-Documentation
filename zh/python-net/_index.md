...
它是首个也是唯一一个为 Python 开发者提供完整功能的 PowerPoint® 文档管理的组件。

Aspose.Slides for Python via .NET 包含广泛的功能，例如处理文本、形状、表格和动画；添加音频和视频；幻灯片预览；以及将幻灯片导出为 SVG、PDF 等格式。
...
它是跨平台的，可在 Windows、Linux 和 macOS 环境中使用。

### 如何开始使用 Aspose.Slides for Python？

您可以通过 PyPi 安装，并浏览 [开发者指南](/slides/zh/python-net/developer-guide/) 以获取示例、API 参考和教程，快速入门。