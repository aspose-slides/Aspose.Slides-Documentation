...
**欢迎使用 Aspose.Slides for Node.js via .NET**

![Aspose.Slides for Node.js via .NET 产品logo](aspose_slides-for-nodejs-via-net.png)

Aspose.Slides for Node.js via .NET 是一个类库，能够使您的应用程序无需使用 Microsoft PowerPoint® 即可读取和写入 PowerPoint® 文档。

Aspose.Slides for Node.js via .NET 是第一个也是唯一提供管理 PowerPoint® 文档功能的组件。

Aspose.Slides for Node.js via .NET 提供了许多关键功能，如管理文本、形状、表格和动画，向幻灯片添加音频和视频，预览幻灯片，将幻灯片导出为 SVG、PDF 格式等。

{{% /alert %}}

## Aspose.Slides for Node.js via .NET 资源

{{% alert color="primary" %}}

Aspose.Slides for Node.js via .NET 是从 Aspose.Slides for .NET 移植而来的，因此您可以使用后者的文档和 API 参考。
