...
type: docs
weight: 30
url: /zh/nodejs-net/supported-file-formats/
---
...
## **支持的文件格式**
此表包含了 Aspose.Slides for Node.js 通过 .NET 可以加载和保存的文件格式：
...
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|支持宏的 PowerPoint 放映|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
