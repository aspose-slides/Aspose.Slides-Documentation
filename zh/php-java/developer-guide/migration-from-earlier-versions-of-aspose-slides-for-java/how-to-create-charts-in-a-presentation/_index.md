...
一款新的 [Aspose.Slides for PHP via Java API](https://docs.aspose.com/slides/php-java/) 已经发布，现在这个单一产品支持从头生成 PowerPoint 文档和编辑现有文档的能力。

{{% /alert %}} 
## **对旧代码的支持**
为了使用在 Aspose.Slides for PHP via Java 14.x.x 之前版本中开发的旧代码，您需要对代码进行一些小的更改，代码将像以前一样工作。所有在旧版 Aspose.Slides for PHP via Java 中属于 com.aspose.slides 和 com.aspose.slides.pptx 命名空间的类现在已合并到单一的 com.aspose.slides 命名空间中。请查看以下简单代码片段，了解如何使用旧版 Aspose.Slides API 从零开始在演示文稿中创建普通图表，并按照步骤描述如何迁移到新的合并 API。
...
## **新版 Aspose.Slides for PHP via Java 14.x.x 方法**
...
请查看以下简单代码片段，了解如何使用旧版 Aspose.Slides API 从零开始在演示文稿中创建散点图以及如何使用新合并 API 实现它。
## **旧版 Aspose.Slides for PHP via Java 方法**
