...
本页列出了所有在 Aspose.Slides for PHP via Java 14.7.0 API 中新增的 [类](/slides/php-java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-14-7-0/)、方法、属性等，以及任何新限制和其他变更。
