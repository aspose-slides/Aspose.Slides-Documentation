...
- PHP
- Aspose.Slides
description: "使用 Aspose.Slides for PHP via Java 将 ODP 转换为 PPTX。干净的代码示例、批处理技巧和高质量结果——无需 PowerPoint。"
---

## **将 ODP 转换为 PPTX/PPT 演示文稿**
Aspose.Slides for PHP via Java 提供了表示演示文稿文件的 [Presentation](https://reference.aspose.com/slides/php-java/aspose.slides/Presentation) 类。[Presentation](https://reference.aspose.com/slides/php-java/aspose.slides/Presentation) 类现在还可以在对象实例化时通过 [Presentation](https://reference.aspose.com/slides/php-java/aspose.slides/Presentation#Presentation-java.lang.String-) 构造函数访问 ODP。下面的示例展示了如何将 ODP 演示文稿转换为 PPTX 演示文稿。
```php
// 打开 ODP 文件
...
会。库使用完整的演示文稿对象模型，保留结构，包括母版幻灯片和布局，因此转换后设计保持正确。

**我可以转换受密码保护的 ODP 文件吗？**

可以。Aspose.Slides 支持检测保护，提供密码后可打开并处理[受保护的演示文稿](/slides/zh/php-java/password-protected-presentation/)（包括 ODP），并支持配置加密和访问文档属性。
