...
- PHP
- Aspose.Slides
description: "了解 Aspose.Slides for PHP via Java：一个强大的 API，可高效创建、编辑、自动化和转换 PowerPoint 与 OpenDocument 演示文稿。"
---
...
|**功能**|**说明**|
| :- | :- |
|文本格式化|<p>在 Aspose.Slides for PHP via Java 中，您可以通过与形状关联的文本框管理文本。因此，您可以使用文本框关联的段落和部分对文本进行格式化。这些文本元素可以通过 Aspose.Slides for PHP via Java 进行格式化。</p><p>- 字体类型</p><p>- 字体大小</p><p>- 字体颜色</p><p>- 字体色阶</p><p>- 段落对齐</p><p>- 段落项目符号</p><p>- 段落方向</p>|
|形状格式化|<p>在 Aspose.Slides for PHP via Java 中，幻灯片的基本元素是形状。您可以使用 Aspose.Slides for PHP via Java 对这些形状元素进行格式化：</p><p>- 位置</p><p>- 大小</p><p>- 线条</p><p>- 填充（包括图案、渐变、纯色）</p><p>- 文本</p><p>- 图像</p>|
...
可以在不同线程中安全地处理不同的文档；同一个[presentation](https://reference.aspose.com/slides/php-java/aspose.slides/presentation/)对象不应同时被[multiple threads](/slides/zh/php-java/multithreading/)使用。
...
是的。建议安装常用字体包，或在应用程序中显式[specify font directories](/slides/zh/php-java/custom-font/)以避免意外的替代。

**评估版有何限制？**

在[/slides/php-java/licensing/]评估模式下，输出会添加水印并存在某些限制；可使用[30-day temporary license](https://purchase.aspose.com/temporary-license/)进行完整功能测试。
