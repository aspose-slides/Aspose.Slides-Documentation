...
type: docs
weight: 40
url: /zh/java/examples/elements/text-box/
keywords:
- 代码示例
- 文本框
- PowerPoint
...
- Java
- Aspose.Slides
description: "在 Aspose.Slides for Java 中使用文本框：使用 Java 为 PPT、PPTX 和 ODP 演示文稿添加、格式化、对齐、换行、自动适应并设置文本样式。"
---
...
文本框就是一个没有填充和边框且包含一些格式化文本的 `AutoShape`。以下是创建方法：
...
要查找包含特定关键字（例如 “Slide”）的所有文本框，可遍历形状并检查其文本：
...
> 💡 **提示：**在迭代期间修改形状集合前，请始终先创建其副本，以避免集合修改错误。