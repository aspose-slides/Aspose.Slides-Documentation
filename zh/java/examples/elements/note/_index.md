...
type: docs
weight: 240
url: /zh/java/examples/elements/note/
keywords:
- 代码示例
- 笔记
- PowerPoint
...
- Java
- Aspose.Slides
description: "在 Aspose.Slides for Java 中处理幻灯片备注：使用清晰的 Java 示例添加、读取、编辑和导出 PPT、PPTX 和 ODP 的演讲者备注。"
---
本文演示如何使用 **Aspose.Slides for Java** 添加、读取、删除和更新备注幻灯片。
