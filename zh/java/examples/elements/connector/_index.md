...
type: docs
weight: 190
url: /zh/java/examples/elements/connector/
keywords:
- 代码示例
- 连接器
- PowerPoint
...
- Java
- Aspose.Slides
description: "了解如何使用 Aspose.Slides for Java 在形状之间添加、路由和设置连接器的样式，提供 PPT、PPTX 和 ODP 演示文稿的 Java 示例。"
---
本文演示如何使用 **Aspose.Slides for Java** 将形状通过连接线连接并更改其目标。
