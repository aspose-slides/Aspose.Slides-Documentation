...
type: docs
weight: 200
url: /zh/java/examples/elements/activex/
keywords:
- 代码示例
- ActiveX
- PowerPoint
...
- Java
- Aspose.Slides
description: "查看 Aspose.Slides for Java 的 ActiveX 示例：在 PPT 和 PPTX 演示文稿中插入、配置和控制 ActiveX 对象，示例代码清晰明确。"
---
本文演示了如何在演示文稿中使用 **Aspose.Slides for Java** 添加、访问、删除和配置 ActiveX 控件。
