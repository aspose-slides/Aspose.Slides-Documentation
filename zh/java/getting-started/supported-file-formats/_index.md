...
## **支持的文件格式**
该表包含Aspose.Slides for Java可以加载和保存的文件格式：
...
|[PPS](https://docs.fileformat.com/presentation/pps/)|PowerPoint 97-2003 幻灯片|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
...
|[PPSX ](https://docs.fileformat.com/presentation/ppsx/)|PowerPoint 幻灯片|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPTM](https://docs.fileformat.com/presentation/pptm/)|PowerPoint 启用宏的演示文稿|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
|[PPSM](https://docs.fileformat.com/presentation/ppsm/)|PowerPoint 启用宏的幻灯片|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |
