...
所有 Aspose.Slides for Java 示例均托管在 [Github](https://github.com/aspose-slides/Aspose.Slides-for-Java)。您既可以使用喜欢的 Github 客户端克隆仓库，也可以从 [here](https://codeload.github.com/aspose-slides/Aspose.Slides-for-Java/zip/master) 下载 ZIP 文件。
...
当您将 **Aspose.Slides Examples** 项目导入 IDE 时，Maven 会自动从 [Aspose Maven Repository](https://releases.aspose.com/java/repo/com/aspose/) 下载 aspose.slides JAR 文件。如果您无法访问互联网，可以手动将 JAR 添加到本地仓库。
