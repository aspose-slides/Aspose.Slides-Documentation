...
## **为甜甜圈图设置提示**
Aspose.Slides for Java 支持为甜甜圈图设置系列数据标签提示形状。以下示例提供了示例代码。
