...
此页面列出了在 Aspose.Slides for Java 15.7.0 API 中添加的所有[class added](/slides/zh/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-7-0/)或[class removed](/slides/zh/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-7-0/) 的类、方法、属性等，以及其他更改。
