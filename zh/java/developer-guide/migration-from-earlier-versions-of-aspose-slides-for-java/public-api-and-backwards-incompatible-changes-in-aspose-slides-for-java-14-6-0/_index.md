...
此页面列出了 Aspose.Slides for Java 14.6.0 API 中所有 [添加的](/slides/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-14-6-0/) 类、方法、属性等，任何新限制和引入的其他更改。
