...
本页面列出了在 Aspose.Slides for Java 15.8.0 API 中添加的或删除的所有[class](/slides/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-9-0/)、方法、属性等，以及其他更改。
