...
此页面列出了所有 [添加的](/slides/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-16-1-0/) 或 [删除的](/slides/java/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-16-1-0/) 类、方法、属性等，及 Aspose.Slides for Java 16.1.0 API 引入的其他更改。
