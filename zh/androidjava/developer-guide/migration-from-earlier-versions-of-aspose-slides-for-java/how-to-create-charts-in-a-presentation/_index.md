...
type: docs
weight: 30
url: /zh/androidjava/how-to-create-charts-in-a-presentation/
---

{{% alert color="primary" %}} 

新的 [Aspose.Slides for Java API](https://docs.aspose.com/slides/androidjava/) 已经发布，现在该单一产品支持从头生成 PowerPoint 文档并编辑现有文档的功能。

{{% /alert %}} 
## **对旧代码的支持**
为了使用在 14.x.x 之前版本的 Aspose.Slides for Java 开发的旧代码，您需要对代码进行一些小的更改，代码将正常工作。所有在旧版 Aspose.Slides for Java 中属于 com.aspose.slides 和 com.aspose.slides.pptx 命名空间的类现在已合并到单一的 com.aspose.slides 命名空间中。请查看以下简单代码片段，了解如何使用旧版 Aspose.Slides API 从头在演示文稿中创建普通图表，并遵循描述如何迁移到新的合并 API 的步骤。
...
请查看以下简单代码片段，了解如何使用旧版 Aspose.Slides API 从头在演示文稿中创建散点图，以及如何使用新的合并 API 来实现。
## **旧版 Aspose.Slides for Java 方法**
