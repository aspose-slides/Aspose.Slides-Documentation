---
title: Aspose.Slides for Java 15.10.0 的公共 API 和向后不兼容更改
type: docs
weight: 180
url: /zh/androidjava/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/
---

{{% alert color="primary" %}} 

此页面列出了 Aspose.Slides for Java 15.10.0 API 中所有[添加的](/slides/zh/androidjava/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/)或[移除的](/slides/zh/androidjava/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-15-10-0/)类、方法、属性等，以及其他更改。

{{% /alert %}} 
## **公共 API 更改**
#### **图表系列动画 API 已添加到 ISequence**
新添加了 2 个方法到 com.aspose.slides.ISequence 接口。
...
```
#### **新增 com.aspose.slides.VideoPlayerHtmlController 支持导出媒体文件到 HTML**
