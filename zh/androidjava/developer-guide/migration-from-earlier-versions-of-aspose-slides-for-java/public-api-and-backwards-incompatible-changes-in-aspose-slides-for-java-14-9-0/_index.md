...
本页面列出了所有在 Aspose.Slides for Java 14.9.0 API 中添加的 [类](/slides/androidjava/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-14-9-0/)、方法、属性等，以及任何新的限制和其他 [更改](/slides/androidjava/public-api-and-backwards-incompatible-changes-in-aspose-slides-for-java-14-9-0/)。
