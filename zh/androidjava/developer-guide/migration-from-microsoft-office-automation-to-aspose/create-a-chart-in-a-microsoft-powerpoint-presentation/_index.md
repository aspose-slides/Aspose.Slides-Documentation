...
type: docs
weight: 70
url: /zh/androidjava/create-a-chart-in-a-microsoft-powerpoint-presentation/
---

{{% alert color="primary" %}} 

 图表是数据的可视化表示，广泛用于演示文稿。本文展示了如何通过使用 [VSTO](/slides/zh/androidjava/create-a-chart-in-a-microsoft-powerpoint-presentation/) 和 [Aspose.Slides for Android via Java](/slides/zh/androidjava/create-a-chart-in-a-microsoft-powerpoint-presentation/) 编程方式在 Microsoft PowerPoint 中创建图表的代码。
