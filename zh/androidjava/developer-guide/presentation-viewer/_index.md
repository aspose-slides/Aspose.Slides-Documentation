...
## **实时示例**
您可以尝试 [**Aspose.Slides 查看器**](https://products.aspose.app/slides/viewer/) 免费应用程序，以查看您可以用 Aspose.Slides API 实现的功能：
...
## **使用自定义形状 ID 生成 SVG**
Aspose.Slides for Android via Java 可用于从具有自定义形状 ID 的幻灯片生成 [SVG](https://docs.fileformat.com/page-description-language/svg/)。为此，使用来自 [ISvgShape](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ISvgShape) 的 ID 属性，该属性表示生成的 SVG 中的形状自定义 ID。可以使用 CustomSvgShapeFormattingController 来设置形状 ID。
