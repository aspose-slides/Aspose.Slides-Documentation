...
type: docs
weight: 100
url: /zh/androidjava/examples/elements/animation/
keywords:
- 代码示例
- 动画
- PowerPoint
...
- Java
- Aspose.Slides
description: "使用 Aspose.Slides for Android 的 Java 示例，探索 PPT、PPTX 和 ODP 演示文稿的动画示例：添加、序列化以及自定义效果和过渡。"
---
本文演示了如何使用 **Aspose.Slides for Android via Java** 创建简单动画并管理其顺序。

## **添加动画**

创建一个矩形形状，并在点击时触发淡入淡出效果。
