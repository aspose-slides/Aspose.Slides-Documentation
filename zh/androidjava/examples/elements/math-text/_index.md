...
type: docs
weight: 160
url: /zh/androidjava/examples/elements/math-text/
keywords:
- 代码示例
- 数学文本
- PowerPoint
...
- Java
- Aspose.Slides
description: "了解 Aspose.Slides for Android 的 MathematicalText 示例：使用 Java 在 PPT、PPTX 和 ODP 演示文稿中创建和格式化公式、分数、矩阵和符号。"
---
本文演示了使用 **Aspose.Slides for Android via Java** 处理数学文本形状和格式化公式的工作。
