...
type: docs
weight: 230
url: /zh/androidjava/examples/elements/comment/
keywords:
- 代码示例
- 注释
- PowerPoint
...
- Java
- Aspose.Slides
description: "使用 Aspose.Slides for Android 处理幻灯片注释：添加、回复、编辑、解决以及在 PPT、PPTX 和 ODP 演示文稿中导出注释，提供 Java 代码示例。"
---
本文演示了如何使用 **Aspose.Slides for Android via Java** 添加、读取、删除以及回复现代评论。
