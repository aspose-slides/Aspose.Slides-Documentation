...
type: docs
weight: 60
url: /zh/androidjava/examples/elements/chart/
keywords:
- 代码示例
- 图表
- PowerPoint
...
- Java
- Aspose.Slides
description: "使用 Aspose.Slides for Android 精通图表：创建、格式化、绑定数据，并通过 Java 示例将图表导出为 PPT、PPTX 和 ODP。"
---
以下示例展示了如何使用 **Aspose.Slides for Android via Java** 添加、访问、删除和更新不同类型的图表。下面的代码片段演示了基本的图表操作。

## **添加图表**

此方法将在第一张幻灯片上添加一个简单的面积图表。
