...
Use [Shape](https://reference.aspose.com/slides/nodejs-java/aspose.slides/shape/).`getThreeDFormat()` to apply 3D formatting to a shape. The returned [ThreeDFormat](https://reference.aspose.com/slides/nodejs-java/aspose.slides/threedformat/) object controls the 3D scene for that shape.

For text, use [TextFrameFormat](https://reference.aspose.com/slides/nodejs-java/aspose.slides/textframeformat/).`getThreeDFormat()`. This applies 3D formatting to the text frame instead of the shape body.
...
Yes. Use [Shape](https://reference.aspose.com/slides/nodejs-java/aspose.slides/shape/).`getThreeDFormat()` for the shape body and [TextFrameFormat](https://reference.aspose.com/slides/nodejs-java/aspose.slides/textframeformat/).`getThreeDFormat()` for text.
