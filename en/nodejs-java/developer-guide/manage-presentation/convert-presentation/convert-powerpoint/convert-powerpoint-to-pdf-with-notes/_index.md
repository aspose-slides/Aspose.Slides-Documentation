---
title: Convert PowerPoint Presentations to PDF with Notes in JavaScript
...
- JavaScript
- Aspose.Slides
description: "Convert formats PPT and PPTX to PDF with notes in JavaScript using Aspose.Slides for Node.js. Preserve layouts and speaker notes for professional presentations."
---
...
To set the notes page dimensions and orientation before export, see [Notes Page Size](/slides/nodejs-java/notes-size/).
