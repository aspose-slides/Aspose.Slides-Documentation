...
For file and stream detection examples, the behavior of newly created presentations, and the distinction between source and output formats, see [Determine the Original Presentation Format](/slides/nodejs-java/detect-presentation-source-format/).
