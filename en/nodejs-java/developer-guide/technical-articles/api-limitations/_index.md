...
- JavaScript
- Aspose.Slides
description: "Learn the key API limitations in Aspose.Slides for Node.js — supported features, caveats, and workarounds for exporting PPT, PPTX and ODP presentations."
---
