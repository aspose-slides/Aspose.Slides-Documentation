...
- JavaScript
- Aspose.Slides
description: "Manage PowerPoint ink objects—create, edit & style digital ink with Aspose.Slides for Node.js. Get JavaScript code samples for traces, brush color & size."
---
...
Aspose.Slides provides all the Ink types (e.g. [Ink](https://reference.aspose.com/slides/nodejs-java/aspose.slides/nk/) class) you need to create and manage ink objects.
