...
- JavaScript
- Aspose.Slides
description: "Insert and edit math equations in PowerPoint PPT and PPTX with Aspose.Slides for Node.js via Java, supporting OMML, formatting controls, and clear JavaScript code samples."
---
...
- A math shape, created with [addMathShape](https://reference.aspose.com/slides/nodejs-java/aspose.slides/shapecollection/#addMathShape), is the shape that contains the equation.
- [MathPortion](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathportion/) stores math content inside the shape text frame.
- [MathParagraph](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathparagraph/) contains one or more [MathBlock](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathblock/) objects.

Most examples below use [MathematicalText](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathematicaltext/) and the fluent methods from [MathElementBase](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) to keep the code short and readable.

For MathML export scenarios, see [Export Math Equations from Presentations in Node.js via Java](/slides/nodejs-java/exporting-math-equations/).
...
Use [`divide`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) to create a fraction. You can choose a fraction style with [MathFractionTypes](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathfractiontypes/).
...
Use [`radical`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) to create a square root, cube root, or other root. The current element becomes the base, and the argument becomes the degree.
...
Use [`asArgumentOfFunction`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) or [`function`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) for functions such as `sin(x)`, `log(x)`, or custom function names. For limits, put `lim` in a [MathLimit](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathlimit/) or use [`setLowerLimit`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/).
...
Use [`nary`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) for summations, unions, intersections, and other large operators. Use [`integral`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) for integrals. Both methods let you set lower and upper limits.
...
Use [MathMatrix](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathmatrix/) for rows and columns. Matrices do not include brackets by default, so enclose the matrix when you need parentheses, brackets, or braces.
...
Use [`toMathArray`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) when you need aligned equations or a vertical stack of expressions.
...
Use [`asArgumentOfFunction`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) when the argument is the current element and the function name is known.
...
Use the subscript and superscript helpers for indexes and powers. When the indexes must appear on the left side of the base, use [`setSubSuperscriptOnTheLeft`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/).
...
Use [`enclose`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) to put an expression inside delimiters. You can also set a separator character for delimiter expressions that contain several elements.
...
Use [`toBorderBox`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) when the equation itself should be framed.
...
Use [`group`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) to place a grouping character above or below an expression. Add a limit to label the grouped terms.
...
Use formatting helpers only where they clarify the formula. For example, [`overbar`](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) places a bar above a math element.
...
| Task | Main API |
| --- | --- |
| Create math text | [MathematicalText](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathematicaltext/) |
| Combine elements | [join](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Create fractions | [divide](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Add superscript or subscript | [setSuperscript](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/), [setSubscript](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Add functions | [function](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/), [asArgumentOfFunction](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Add radicals | [radical](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Add limits | [setLowerLimit](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/), [setUpperLimit](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Add left-side scripts | [setSubSuperscriptOnTheLeft](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Add summations and integrals | [nary](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/), [integral](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Add matrices | [MathMatrix](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathmatrix/) |
| Add equation arrays | [toMathArray](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Add delimiters | [enclose](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Add bars and borders | [overbar](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/), [toBorderBox](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
| Group terms | [group](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathelementbase/) |
...
Yes. Get the equation's [MathParagraph](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathparagraph/) from its [MathPortion](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathportion/), and call [MathParagraph.toLatex](https://reference.aspose.com/slides/nodejs-java/aspose.slides/mathparagraph/#toLatex--) to export it directly. For a complete example, see [Export Math Equations from Presentations in Node.js via Java](/slides/nodejs-java/exporting-math-equations/#export-math-equations-to-latex).
