...
Use [IShape](https://reference.aspose.com/slides/java/com.aspose.slides/ishape/).`getThreeDFormat()` to apply 3D formatting to a shape. The returned format object controls the 3D scene for that shape.

For text, use [ITextFrameFormat](https://reference.aspose.com/slides/java/com.aspose.slides/itextframeformat/).`getThreeDFormat()`. This applies 3D formatting to the text frame instead of the shape body.
...
Yes. Use [IShape](https://reference.aspose.com/slides/java/com.aspose.slides/ishape/).`getThreeDFormat()` for the shape body and [ITextFrameFormat](https://reference.aspose.com/slides/java/com.aspose.slides/itextframeformat/).`getThreeDFormat()` for text.
