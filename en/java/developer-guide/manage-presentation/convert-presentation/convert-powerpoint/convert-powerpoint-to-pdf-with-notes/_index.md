---
title: Convert PowerPoint Presentations to PDF with Notes in Java
...
- Java
- Aspose.Slides
description: "Convert formats PPT and PPTX to PDF with notes using Aspose.Slides for Java. Preserve layouts and speaker notes for professional presentations."
---
...
To set the notes page dimensions and orientation before export, see [Notes Page Size](/slides/java/notes-size/).
