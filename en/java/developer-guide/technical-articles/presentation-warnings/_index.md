---
title: Handle Presentation Warnings in Java
type: docs
weight: 90
url: /java/presentation-warnings/
aliases:
...
- Java
- Aspose.Slides
description: "Learn how to collect, classify, and act on warnings while loading, rendering, converting, and saving presentations with Aspose.Slides for Java."
---
...
Implement the [IWarningCallback](https://reference.aspose.com/slides/java/com.aspose.slides/iwarningcallback/) interface and examine the [getWarningType](https://reference.aspose.com/slides/java/com.aspose.slides/iwarninginfo/#getWarningType--) and [getDescription](https://reference.aspose.com/slides/java/com.aspose.slides/iwarninginfo/#getDescription--) values supplied through [IWarningInfo](https://reference.aspose.com/slides/java/com.aspose.slides/iwarninginfo/). Return [ReturnAction.Continue](https://reference.aspose.com/slides/java/com.aspose.slides/returnaction/#Continue) to accept the warning or [ReturnAction.Abort](https://reference.aspose.com/slides/java/com.aspose.slides/returnaction/#Abort) to stop the operation.

Use [LoadOptions.setWarningCallback](https://reference.aspose.com/slides/java/com.aspose.slides/loadoptions/#setWarningCallback-com.aspose.slides.IWarningCallback-) for warnings raised while opening a presentation. Rendering and export option classes inherit [SaveOptions.setWarningCallback](https://reference.aspose.com/slides/java/com.aspose.slides/saveoptions/#setWarningCallback-com.aspose.slides.IWarningCallback-), which receives warnings from slide rendering, conversion, and saving. Because the warning itself does not identify the application operation, associate each callback instance with an operation stage when you build a combined report.
...
Returning `ReturnAction.Abort` asks the warning dispatcher to terminate the current operation by raising an exception. The public exception depends on the operation and presentation format. For example, loading can surface a [PptxReadException](https://reference.aspose.com/slides/java/com.aspose.slides/pptxreadexception/) or [PptReadException](https://reference.aspose.com/slides/java/com.aspose.slides/pptreadexception/), while saving or exporting can surface a [PptxException](https://reference.aspose.com/slides/java/com.aspose.slides/pptxexception/). Handle the exception at the boundary of the operation and use the warning report to determine whether the application policy caused the termination instead of relying on one exception subtype or message. The callback records the warning before returning `ReturnAction.Abort`, ensuring that the reason remains available to the application.

## **Warning Categories**

The [WarningType](https://reference.aspose.com/slides/java/com.aspose.slides/warningtype/) class provides integer constants for the following categories:

| Warning type | Meaning | Typical policy |
| --- | --- | --- |
| [SourceFileCorruption](https://reference.aspose.com/slides/java/com.aspose.slides/warningtype/#SourceFileCorruption) | The source presentation contains corruption that can make a document saved in its original format unusable. | Abort. |
| [DataLoss](https://reference.aspose.com/slides/java/com.aspose.slides/warningtype/#DataLoss) | Text, charts, images, or other data may be absent after loading or saving. | Abort. |
| [MajorFormattingLoss](https://reference.aspose.com/slides/java/com.aspose.slides/warningtype/#MajorFormattingLoss) | The presentation may lose important formatting. | Abort in strict validation mode; otherwise record and continue. |
| [MinorFormattingLoss](https://reference.aspose.com/slides/java/com.aspose.slides/warningtype/#MinorFormattingLoss) | A limited formatting difference may occur. | Record for diagnostics and continue. |
| [CompatibilityIssue](https://reference.aspose.com/slides/java/com.aspose.slides/warningtype/#CompatibilityIssue) | The result may not open or behave correctly in some applications or older versions. | Log and continue unless compatibility is mandatory. |
| [UnexpectedContent](https://reference.aspose.com/slides/java/com.aspose.slides/warningtype/#UnexpectedContent) | The source contains unsupported or unrecognized content whose effect may not yet be known. | Record and continue, or treat as an error in a strict policy. |
...
An empty warning report is not a guarantee that every source feature has been preserved. Apply any additional content and visual checks required by the application. See also [Open Presentations](/slides/java/open-presentation/) and [Save Presentations](/slides/java/save-presentation/).
