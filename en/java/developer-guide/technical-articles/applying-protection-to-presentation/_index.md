...
Yes. Locks limit editing of objects inside the file, while [password protection](/slides/java/password-protected-presentation/) controls access to opening and/or saving changes. These mechanisms complement each other and work together.
