---
title: Add Slides to Presentations in Java
linktitle: Add Slide
type: docs
weight: 10
...
- Java
- Aspose.Slides
description: "Easily add slides to your PowerPoint and OpenDocument presentations using Aspose.Slides for Java—seamless, efficient slide insertion in seconds."
---
...
Yes. The library supports slide collections and [insert](https://reference.aspose.com/slides/java/com.aspose.slides/slidecollection/#insertEmptySlide-int-com.aspose.slides.ILayoutSlide-)/[clone](https://reference.aspose.com/slides/java/com.aspose.slides/slidecollection/#insertClone-int-com.aspose.slides.ISlide-com.aspose.slides.ILayoutSlide-) operations, so you can add a slide at the required index rather than only at the end.
...
Generally choose the [LayoutSlide](https://reference.aspose.com/slides/java/com.aspose.slides/layoutslide/) that matches the required structure ([Title and Content, Two Content, etc.](https://reference.aspose.com/slides/java/com.aspose.slides/slidelayouttype/)). If such a layout is missing, you can [add it to the master](/slides/java/slide-layout/) and then use it.
