...
- Java
- Aspose.Slides
description: "Export math equations from PowerPoint presentations to LaTeX or MathML directly with Aspose.Slides for Java."
---
...
Aspose.Slides can convert a PowerPoint math equation directly to LaTeX; an intermediate MathML file and an external converter are not required. A math equation is stored in a text frame as an [IMathPortion](https://reference.aspose.com/slides/java/com.aspose.slides/imathportion/). Use [IMathPortion.getMathParagraph](https://reference.aspose.com/slides/java/com.aspose.slides/imathportion/#getMathParagraph--) to get an [IMathParagraph](https://reference.aspose.com/slides/java/com.aspose.slides/imathparagraph/), and then call [IMathParagraph.toLatex](https://reference.aspose.com/slides/java/com.aspose.slides/imathparagraph/#toLatex--). The method returns a string that you can save, display, send to another application, or process further.
...
You can export either an entire math paragraph ([MathParagraph](https://reference.aspose.com/slides/java/com.aspose.slides/mathparagraph/)) or an individual block ([MathBlock](https://reference.aspose.com/slides/java/com.aspose.slides/mathblock/)) to MathML. Both types provide a method to write to MathML.

**How can I tell that an object on a slide is a math formula rather than regular text or an image?**

A formula lives in a [MathPortion](https://reference.aspose.com/slides/java/com.aspose.slides/mathportion/) and has a [MathParagraph](https://reference.aspose.com/slides/java/com.aspose.slides/mathparagraph/). Images and regular text portions without a [MathParagraph](https://reference.aspose.com/slides/java/com.aspose.slides/mathparagraph/) are not exportable formulas.
...
Yes, if those objects contain text portions with a [MathParagraph](https://reference.aspose.com/slides/java/com.aspose.slides/mathparagraph/) (i.e., genuine PowerPoint formulas), they are exported. If a formula is embedded as an image, it is not.
