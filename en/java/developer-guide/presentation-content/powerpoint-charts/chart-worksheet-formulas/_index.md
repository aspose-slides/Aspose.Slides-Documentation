---
title: Apply Chart Worksheet Formulas in Presentations in Java
...
- Java
- Aspose.Slides
description: "Apply Excel-style formulas in Aspose.Slides for Java chart worksheets, recalculate values, and use the results in PowerPoint charts."
---

## **Overview**

PowerPoint charts usually store their source data in an embedded worksheet. In Aspose.Slides for Java, you can access that worksheet through the chart data workbook, write input values, assign formulas to cells, calculate supported formulas, and use the calculated cells as chart data.
...
In Aspose.Slides, the worksheet is exposed through the [IChartDataWorkbook](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdataworkbook/) interface. Use [IChartDataCell.setFormula](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdatacell/#setFormula-java.lang.String-) for A1-style formulas and [IChartDataCell.setR1C1Formula](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdatacell/#setR1C1Formula-java.lang.String-) for R1C1-style formulas. After changing input cells or formulas, call [IChartDataWorkbook.calculateFormulas](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdataworkbook/#calculateFormulas--) to recalculate supported formulas and update the corresponding cell values.

A calculated cell still exposes its result through [IChartDataCell.getValue](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdatacell/#getValue--). This is important when you need to inspect a formula result in code or use the cell as a chart data point.
...
A1 notation identifies columns with letters and rows with numbers. Assign A1-style expressions through [IChartDataCell.setFormula](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdatacell/#setFormula-java.lang.String-).
...
R1C1 notation identifies both rows and columns numerically. Relative references use offsets in square brackets. Assign this syntax through [IChartDataCell.setR1C1Formula](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdatacell/#setR1C1Formula-java.lang.String-).
...
Some chart workbook functions interpret text according to culture-specific rules. This is especially important for functions intended for languages that use double-byte character sets (DBCS). To calculate such formulas correctly, create [LoadOptions](https://reference.aspose.com/slides/java/com.aspose.slides/loadoptions/), set the preferred culture with [SpreadsheetOptions.setPreferredCulture](https://reference.aspose.com/slides/java/com.aspose.slides/spreadsheetoptions/#setPreferredCulture-java.util.Locale-), assign the spreadsheet options through [LoadOptions.setSpreadsheetOptions](https://reference.aspose.com/slides/java/com.aspose.slides/loadoptions/#setSpreadsheetOptions-com.aspose.slides.ISpreadsheetOptions-), and then load the presentation.

The following example selects the Japanese culture, opens a presentation with the configured load options, and calls [IChartDataWorkbook.calculateFormulas](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdataworkbook/#calculateFormulas--) for every chart workbook:
...
After changing input cells or formulas, do not rely on an old cached result. Call [IChartDataWorkbook.calculateFormulas](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdataworkbook/#calculateFormulas--) before reading calculated values or saving chart data that depends on them.
...
A formula can be valid but produce a spreadsheet error result such as `#DIV/0!`, `#N/A`, `#NAME?`, `#NULL!`, `#NUM!`, `#REF!`, or `#VALUE!`. In this case, the error token is a cell result and can be returned through [IChartDataCell.getValue](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdatacell/#getValue--).

A formula can also fail at the parsing, reference, dependency, or supported-data level. Aspose.Slides provides spreadsheet-specific exceptions for these cases: [CellInvalidFormulaException](https://reference.aspose.com/slides/java/com.aspose.slides/cellinvalidformulaexception/), [CellInvalidReferenceException](https://reference.aspose.com/slides/java/com.aspose.slides/cellinvalidreferenceexception/), [CellCircularReferenceException](https://reference.aspose.com/slides/java/com.aspose.slides/cellcircularreferenceexception/), and [CellUnsupportedDataException](https://reference.aspose.com/slides/java/com.aspose.slides/cellunsupporteddataexception/).
...
**What is the difference between [IChartDataCell.setFormula](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdatacell/#setFormula-java.lang.String-) and [IChartDataCell.setR1C1Formula](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdatacell/#setR1C1Formula-java.lang.String-)?**
...
[IChartDataWorkbook.getCell](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdataworkbook/#getCell-int-java.lang.String-) returns an [IChartDataCell](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdatacell/). To obtain the calculated result, call that cell's [IChartDataCell.getValue](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdatacell/#getValue--) method after recalculation.

**When should I call [IChartDataWorkbook.calculateFormulas](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdataworkbook/#calculateFormulas--)?**

Call [IChartDataWorkbook.calculateFormulas](https://reference.aspose.com/slides/java/com.aspose.slides/ichartdataworkbook/#calculateFormulas--) after changing input values or formulas and before you depend on the calculated results. This updates the values of formulas that the built-in evaluator supports.
