...
Yes. [Transitions](/slides/java/slide-transition/) apply to the slide, while animation effects apply to objects on the slide. You can use both together in the same presentation and control them independently.

**Are chart animations preserved when saving to PPTX?**

Yes. When you [save to PPTX](/slides/java/save-presentation/), all animation effects and their ordering are preserved because they are part of the presentation's native animation model.
...
Yes. You can [export a presentation to video](/slides/java/convert-powerpoint-to-video/) while preserving animations, configuring timings and other export settings so the resulting clip reflects the animated playback.
