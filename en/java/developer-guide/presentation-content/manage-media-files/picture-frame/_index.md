...
try {
    ...
    if (shape instanceof IPictureFrame) {
        ...
        // getSvgImage returns null when the picture is a raster image.
        if (svgImage != null) {
...
Aspose.Slides allows you to get the brightness and contrast effect applied to an image. The [ILuminance](https://reference.aspose.com/slides/java/com.aspose.slides/iluminance/) interface represents this image transform effect.
