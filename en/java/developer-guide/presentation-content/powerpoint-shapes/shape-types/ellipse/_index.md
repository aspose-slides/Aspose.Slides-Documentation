---
title: Add Ellipses to Presentations in Java
linktitle: Ellipse
type: docs
weight: 30
url: /java/ellipse/
...
- Java
- Aspose.Slides
description: "Learn how to create, format, and manipulate ellipse shapes in Aspose.Slides for Java across PPT and PPTX presentations—Java code examples included."
---
...
[Apply](/slides/java/shape-animation/) entrance, emphasis, or exit effects to the shape, and configure triggers and timing to orchestrate when and how the animation plays.
