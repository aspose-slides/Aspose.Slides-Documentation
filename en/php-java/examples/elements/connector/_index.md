...
type: docs
weight: 190
url: /php-java/examples/elements/connector/
keywords:
- connector
- add connector
- access connector
...
- PHP
- Aspose.Slides
description: "Draw and control connectors in PHP with Aspose.Slides: add, route, reroute, set connection points, arrows and styles to link shapes in PPT, PPTX and ODP."
---
