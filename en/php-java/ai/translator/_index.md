...
- PHP
- Aspose.Slides
description: "Translate PowerPoint slides with AI using Aspose.Slides for PHP. Localize PPT, PPTX and ODP while preserving layout—fast and developer-friendly. Try it."
---
...
You can use the built-in [OpenAIWebClient](https://reference.aspose.com/slides/php-java/aspose.slides/openaiwebclient/) to connect to OpenAI’s API.
...
In this example, we translate a PowerPoint presentation into Japanese using the built-in [OpenAIWebClient](https://reference.aspose.com/slides/php-java/aspose.slides/openaiwebclient/) with a specified OpenAI [model](https://platform.openai.com/docs/models).
