...
The examples are based on the [PresentationInfo](https://reference.aspose.com/slides/php-java/aspose.slides/presentationinfo/) and [DocumentProperties](https://reference.aspose.com/slides/php-java/aspose.slides/documentproperties/) APIs and demonstrate typical operations for working with presentation metadata.
