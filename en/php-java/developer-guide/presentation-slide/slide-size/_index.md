...
Notes and handout pages have separate dimensions from regular slides. See [Notes Page Size](/slides/php-java/notes-size/) to change their size and orientation.
