---
title: Create and Modify Custom Animation Behaviors in PHP
linktitle: Custom Animation
type: docs
weight: 151
url: /php-java/custom-animation/
keywords:
- custom animation
- animation behavior
- motion path
...
- PHP
- Aspose.Slides
description: "Create, inspect, and modify custom animation behaviors and editable motion paths in PowerPoint presentations with Aspose.Slides for PHP via Java."
---
...
For predefined effects and click triggers, see [Shape Animation](/slides/php-java/shape-animation/).

## **Understand the Animation Model**

An animation is organized as **Timeline → Sequence → Effect → Behaviors**:

- Each slide has a timeline containing its main sequence and interactive sequences.
- A [Sequence](https://reference.aspose.com/slides/php-java/aspose.slides/sequence/) contains effects, potentially targeting different shapes.
- An [Effect](https://reference.aspose.com/slides/php-java/aspose.slides/effect/) identifies a target shape, preset, subtype, and effect timing.
- The collection returned by [Effect::getBehaviors](https://reference.aspose.com/slides/php-java/aspose.slides/effect/getbehaviors/) contains the operations that implement the effect: changing color, moving, rotating, setting a property, and so on.

## **Create Individual Behaviors**

Call [Sequence::addEffect](https://reference.aspose.com/slides/php-java/aspose.slides/sequence/addeffect/) to create an effect and access the [getBehaviors](https://reference.aspose.com/slides/php-java/aspose.slides/effect/getbehaviors/) collection. A preset can populate this collection automatically. Keep its operations when extending the preset, or use [clear](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorcollection/clear/) when deliberately replacing them.

[BehaviorFactory](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorfactory/) creates the eight behavior types illustrated below. Motion is covered in [Build a Motion Path](#build-a-motion-path). Each snippet includes its imports and assumes that the PHP/Java Bridge and the Aspose.Slides PHP library have been loaded. Later editing examples state which output file they use.

### **Rotation**

Use [createRotationEffect](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorfactory/createrotationeffect/) to create a rotation. [getBy](https://reference.aspose.com/slides/php-java/aspose.slides/rotationeffect/getby/) specifies a relative angle in degrees; [getFrom](https://reference.aspose.com/slides/php-java/aspose.slides/rotationeffect/getfrom/) and [getTo](https://reference.aspose.com/slides/php-java/aspose.slides/rotationeffect/getto/) specify endpoints.
...
Use [createScaleEffect](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorfactory/createscaleeffect/) with X/Y percentages: [getFrom](https://reference.aspose.com/slides/php-java/aspose.slides/scaleeffect/getfrom/) and [getTo](https://reference.aspose.com/slides/php-java/aspose.slides/scaleeffect/getto/) describe the starting and ending size, while [getBy](https://reference.aspose.com/slides/php-java/aspose.slides/scaleeffect/getby/) describes a relative change. Here, 100 means the original size.
...
Use [createColorEffect](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorfactory/createcoloreffect/) to change the fill from blue to orange. [getFrom](https://reference.aspose.com/slides/php-java/aspose.slides/coloreffect/getfrom/) and [getTo](https://reference.aspose.com/slides/php-java/aspose.slides/coloreffect/getto/) are colors; [getBy](https://reference.aspose.com/slides/php-java/aspose.slides/coloreffect/getby/) is a color offset. The behavior's [BehaviorPropertyCollection](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorpropertycollection/) identifies the attribute being animated.
...
Use [createFilterEffect](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorfactory/createfiltereffect/) to select a wipe. [getType](https://reference.aspose.com/slides/php-java/aspose.slides/filtereffect/gettype/), [getSubtype](https://reference.aspose.com/slides/php-java/aspose.slides/filtereffect/getsubtype/), and [getReveal](https://reference.aspose.com/slides/php-java/aspose.slides/filtereffect/getreveal/) specify the filter, direction, and whether to reveal or hide the shape.
...
Use [createPropertyEffect](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorfactory/createpropertyeffect/) to animate opacity. [getFrom](https://reference.aspose.com/slides/php-java/aspose.slides/propertyeffect/getfrom/), [getTo](https://reference.aspose.com/slides/php-java/aspose.slides/propertyeffect/getto/), and [getBy](https://reference.aspose.com/slides/php-java/aspose.slides/propertyeffect/getby/) are strings interpreted using [getValueType](https://reference.aspose.com/slides/php-java/aspose.slides/propertyeffect/getvaluetype/) and [getCalcMode](https://reference.aspose.com/slides/php-java/aspose.slides/propertyeffect/getcalcmode/). Choose endpoints or a relative offset rather than setting all three indiscriminately.
...
Use [createSetEffect](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorfactory/createseteffect/) to assign visibility through [getTo](https://reference.aspose.com/slides/php-java/aspose.slides/seteffect/getto/). A set behavior does not interpolate between endpoints.
...
[BehaviorCollection](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorcollection/) supports [add](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorcollection/add/), [insert](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorcollection/insert/), [remove](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorcollection/remove/), and [removeAt](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorcollection/removeat/). This example opens `rotation.pptx`, adds scaling, moves it before rotation, and removes the rotation. Removing and reinserting the same object changes its stored position without making a copy.
...
A behavior has its own [Timing](https://reference.aspose.com/slides/php-java/aspose.slides/timing/), independent of the timing returned by [Effect::getTiming](https://reference.aspose.com/slides/php-java/aspose.slides/effect/gettiming/). Effect timing schedules the enclosing effect; behavior timing describes an operation inside it.

### **Set Duration, Delay, Repetition, and Acceleration**

Open `rotation.pptx` and set the duration ([getDuration](https://reference.aspose.com/slides/php-java/aspose.slides/timing/getduration/)) and trigger delay ([getTriggerDelayTime](https://reference.aspose.com/slides/php-java/aspose.slides/timing/gettriggerdelaytime/)) in seconds, then configure the repeat count through [setRepeatCount](https://reference.aspose.com/slides/php-java/aspose.slides/timing/setrepeatcount/). [getAccelerate](https://reference.aspose.com/slides/php-java/aspose.slides/timing/getaccelerate/) and [getDecelerate](https://reference.aspose.com/slides/php-java/aspose.slides/timing/getdecelerate/) are fractions of the duration; keep their sum at most 1.
...
Other repeat policies include [getRepeatDuration](https://reference.aspose.com/slides/php-java/aspose.slides/timing/getrepeatduration/), [getRepeatUntilEndSlide](https://reference.aspose.com/slides/php-java/aspose.slides/timing/getrepeatuntilendslide/), and [getRepeatUntilNextClick](https://reference.aspose.com/slides/php-java/aspose.slides/timing/getrepeatuntilnextclick/); choose a policy rather than enabling them all together. [getAutoReverse](https://reference.aspose.com/slides/php-java/aspose.slides/timing/getautoreverse/) plays the animation backwards after the forward pass. Acceleration and deceleration apply to continuous changes, not discrete assignments or commands.

## **Build a Motion Path**

Use [createMotionEffect](https://reference.aspose.com/slides/php-java/aspose.slides/behaviorfactory/createmotioneffect/) to create motion. Its [getFrom](https://reference.aspose.com/slides/php-java/aspose.slides/motioneffect/getfrom/), [getTo](https://reference.aspose.com/slides/php-java/aspose.slides/motioneffect/getto/), and [getBy](https://reference.aspose.com/slides/php-java/aspose.slides/motioneffect/getby/) describe percentage-based coordinates or offsets. For an editable route, create a [MotionPath](https://reference.aspose.com/slides/php-java/aspose.slides/motionpath/) and assign it with [MotionEffect::setPath](https://reference.aspose.com/slides/php-java/aspose.slides/motioneffect/setpath/). [MotionPath](https://reference.aspose.com/slides/php-java/aspose.slides/motionpath/) stores the path commands.

[MotionCommandPathType](https://reference.aspose.com/slides/php-java/aspose.slides/motioncommandpathtype/) selects the operation:
...
[MotionPathPointsType](https://reference.aspose.com/slides/php-java/aspose.slides/motionpathpointstype/) describes point-editing characteristics, such as corner or smooth points. It does not replace the command type. Use a curve point type for the curve example below, and a corner point type for the straight segments.

Path coordinates are normalized to slide dimensions: an X displacement of 0.25 represents one quarter of the slide width, not 0.25 points. Positive Y runs downward. Absolute commands specify positions in the path coordinate system; relative commands specify offsets from the current position. This is separate from [getOrigin](https://reference.aspose.com/slides/php-java/aspose.slides/motioneffect/getorigin/), which selects the path's reference frame, and [getPathEditMode](https://reference.aspose.com/slides/php-java/aspose.slides/motioneffect/getpatheditmode/), which controls how the path moves when the shape is moved.

### **Create a Straight Path**

Create a motion behavior with a starting point, one straight segment, and an end command. [MotionPath::add](https://reference.aspose.com/slides/php-java/aspose.slides/motionpath/add/) takes the command type, its points, the point type, and a relative-coordinate flag.
...
Each [MotionCmdPath](https://reference.aspose.com/slides/php-java/aspose.slides/motioncmdpath/) exposes [getPoints](https://reference.aspose.com/slides/php-java/aspose.slides/motioncmdpath/getpoints/), [getCommandType](https://reference.aspose.com/slides/php-java/aspose.slides/motioncmdpath/getcommandtype/), [getPointsType](https://reference.aspose.com/slides/php-java/aspose.slides/motioncmdpath/getpointstype/), and [isRelative](https://reference.aspose.com/slides/php-java/aspose.slides/motioncmdpath/isrelative/). The following examples use the known three-command path in `motion.pptx`. For arbitrary input, locate the intended effect and check command types and point counts before editing by index.
...
Use [insert](https://reference.aspose.com/slides/php-java/aspose.slides/motionpath/insert/) and [removeAt](https://reference.aspose.com/slides/php-java/aspose.slides/motionpath/removeat/) to replace the line in `motion.pptx`. Inserting shifts the old line to index 2.
...
When the behavior's index is unknown, select it by type. This example opens `rotation.pptx`, finds its [RotationEffect](https://reference.aspose.com/slides/php-java/aspose.slides/rotationeffect/), changes the angle, and checks the saved value after reopening.
...
| [HTML5](/slides/php-java/export-to-html5/) | Can play supported animations when shape animation is enabled in the export options. Test custom combinations in the browser. |
| [Animated GIF](/slides/php-java/convert-powerpoint-to-animated-gif/) | Stores rendered frames, not editable behaviors or click-triggered interaction. Check the actual rendered motion. |
| [Video](/slides/php-java/convert-powerpoint-to-video/) | Render animation frames and encode them as video. Support is limited to the renderer's [supported animations and effects](/slides/php-java/convert-powerpoint-to-video/#supported-animations-and-effects); commands and interactive events do not become an editable timeline. |
