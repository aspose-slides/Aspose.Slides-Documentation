...
### 4. **Access Aspose.Slides in Docker** 
   After starting the container, the script will generate a PDF file. You can find the generated output file `output.pdf` in the `/tmp` folder inside the container:
   ```bash
