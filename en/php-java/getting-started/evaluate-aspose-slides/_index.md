...
Yes. You can process different documents in parallel; you should not share the same presentation object [across threads](/slides/php-java/multithreading/). Evaluation mode does not affect this.
...
Yes. The [converters](/slides/php-java/convert-presentation/) work; the output will include a watermark.
