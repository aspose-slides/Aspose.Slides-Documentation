...
- Python
- Aspose.Slides
description: "Learn how to quickly resize slides in PPT, PPTX and ODP files with Python and Aspose.Slides, optimize presentations for any screen without losing quality."
---
...
Notes and handout pages have separate dimensions from regular slides. See [Notes Page Size](/slides/python-net/notes-size/) to change their size and orientation.
