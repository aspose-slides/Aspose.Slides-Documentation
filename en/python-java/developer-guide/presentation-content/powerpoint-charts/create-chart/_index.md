...
- Java
- Aspose.Slides
description: "Create and customize charts in PowerPoint presentations using Aspose.Slides for Python via Java. Add, format, and edit charts with practical code examples in Python."
---
...
To create charts, use the [ChartType](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/) class. The fields in this class correspond to different chart types.
...
3. Add a chart with default data and specify the [ChartType.Pie](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/#Pie) type.
4. Access the chart data workbook [ChartDataWorkbook](https://reference.aspose.com/slides/python-java/aspose.slides/chartdataworkbook/).
...
1. Create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class.
1. Get a reference to a slide using its index.
1. Add a chart with default data and specify the [ChartType.Line](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/#Line) type.
1. Save the modified presentation as a PPTX file.
...
1. Create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class.
2. Get a reference to a slide using its index.
3. Add a chart with default data and specify the [ChartType.Treemap](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/#Treemap) type.
4. Access the chart data workbook [ChartDataWorkbook](https://reference.aspose.com/slides/python-java/aspose.slides/chartdataworkbook/).
5. Clear the default series and categories.
6. Add new series and categories.
7. Add new chart data for the chart series.
...
1. Create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class.
2. Get a reference to a slide using its index.
3. Add a chart with default data and specify the [ChartType.OpenHighLowClose](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/#OpenHighLowClose) type.
4. Access the chart data workbook [ChartDataWorkbook](https://reference.aspose.com/slides/python-java/aspose.slides/chartdataworkbook/).
5. Clear the default series and categories.
6. Add new series and categories.
7. Add new chart data for the chart series.
...
1. Create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class.
2. Get a reference to a slide using its index.
3. Add a chart with default data and specify the [ChartType.BoxAndWhisker](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/#BoxAndWhisker) type.
4. Access the chart data workbook [ChartDataWorkbook](https://reference.aspose.com/slides/python-java/aspose.slides/chartdataworkbook/).
5. Clear the default series and categories.
6. Add new series and categories.
7. Add new chart data for the chart series.
...
1. Create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class.
2. Get a reference to a slide using its index.
3. Add a chart with default data and specify the [ChartType.Funnel](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/#Funnel) type.
...
1. Create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class.
2. Get a reference to a slide using its index.
3. Add a chart with default data and specify the [ChartType.Sunburst](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/#Sunburst) type.
4. Save the modified presentation as a PPTX file.
...
1. Create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class.
2. Get a reference to a slide using its index.
3. Add a chart with default data and specify the [ChartType.Histogram](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/#Histogram) type.
4. Access the chart data workbook [ChartDataWorkbook](https://reference.aspose.com/slides/python-java/aspose.slides/chartdataworkbook/).
5. Clear the default series and categories.
6. Add new series and categories.
...
1. Create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class.
2. Get a reference to a slide using its index.
3. Add a chart with some data and specify your preferred chart type ([ChartType.Radar](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/#Radar) in this case).
4. Save the modified presentation as a PPTX file.
...
1. Create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class.
2. Get a reference to a slide using its index.
3. Add a chart with default data and specify the [ChartType.ClusteredColumn](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/#ClusteredColumn) type.
4. Access the chart data workbook [ChartDataWorkbook](https://reference.aspose.com/slides/python-java/aspose.slides/chartdataworkbook/).
5. Clear the default series and categories.
6. Add new series and categories.
7. Add new chart data for the chart series.
...
This Python code shows how to create a multicategory chart:
...
1. Create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class that represents the presentation containing the chart you want to update.
2. Get a reference to a slide using its index.
...
try:
    ...
    workbook.getCell(default_worksheet_index, 0, 1, "New_Series1")# Modifying series name
    ...
    # Now updating series data
    workbook.getCell(default_worksheet_index, 0, 2, "New_Series2")# Modifying series name
...
Aspose.Slides supports a wide range of [chart types](https://reference.aspose.com/slides/python-java/aspose.slides/charttype/), including bar, line, pie, area, scatter, histogram, radar, and many more. This flexibility allows you to choose the most appropriate chart type for your data visualization needs.

**How do I add a new chart to a slide?**

To add a chart, you first create an instance of the [Presentation](https://reference.aspose.com/slides/python-java/aspose.slides/presentation/) class, retrieve the desired slide using its index, and then call the method to add a chart, specifying the chart type and initial data. This process integrates the chart directly into your presentation.

**How can I update the data displayed in a chart?**

You can update a chart’s data by accessing its data workbook ([ChartDataWorkbook](https://reference.aspose.com/slides/python-java/aspose.slides/chartdataworkbook/)), clearing any default series and categories, and then adding your custom data. This allows you to refresh the chart to reflect the latest data.

**Is it possible to customize the appearance of the chart?**

Yes, Aspose.Slides provides extensive customization options. You can modify colors, fonts, labels, legends, and other [formatting elements](/slides/python-java/chart-entities/) to tailor the chart’s appearance to your specific design requirements.
