...
| --- | --- |
| [getAlternativeTextTitle](https://reference.aspose.com/slides/python-java/aspose.slides/shape/#getAlternativeTextTitle) | A short title for the alternative description. |
| [getAlternativeText](https://reference.aspose.com/slides/python-java/aspose.slides/shape/#getAlternativeText) | A meaningful description of the shape's content or purpose in the context of the slide. |
| [getName](https://reference.aspose.com/slides/python-java/aspose.slides/shape/#getName) | The shape's name, which code can use to find a specific shape in the presentation. |
...
try:
    ...
    print(f"Alternative text title: {shape.getAlternativeTextTitle()}")
    print(f"Alternative text description: {shape.getAlternativeText()}")
...
Prefer finding the shape by the name returned by [getName](https://reference.aspose.com/slides/python-java/aspose.slides/shape/#getName) and checking that it is the expected shape. Alternative text may be edited or translated, which can break code that searches for an exact description; see [Identify and Find Shapes](/slides/python-java/shape-manipulations/).
