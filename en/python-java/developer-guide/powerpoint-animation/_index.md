...
## **Interactive Animation**
[EffectTriggerType](https://reference.aspose.com/slides/python-java/aspose.slides/effecttriggertype/) allows to define user actions (e.g. button click), that will make a certain animation start. Triggers have been added into the latest PowerPoint version only.
