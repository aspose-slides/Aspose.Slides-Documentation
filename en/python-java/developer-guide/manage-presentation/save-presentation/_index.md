...
For file and stream detection examples, the behavior of newly created presentations, and the distinction between source and output formats, see [Determine the Original Presentation Format](/slides/python-java/detect-presentation-source-format/).
