---
title: Change the Presentation Slide Size in Python via Java
linktitle: Slide Size
type: docs
weight: 70
url: /python-java/slide-size/
keywords:
- slide size
- aspect ratio
- standard
...
- Java
- Aspose.Slides
description: "Learn how to quickly resize slides in PPT, PPTX and ODP files with Python via Java and Aspose.Slides, and optimize presentations for any screen without losing quality."
---
...
This sample code shows you how to use Aspose.Slides for Python via Java to specify a custom slide size for a presentation:
...
- [DoNotScale](https://reference.aspose.com/slides/python-java/aspose.slides/slidesizescaletype/#DoNotScale)

  If you do NOT want the objects on the slides to be resized, use this setting.

- [EnsureFit](https://reference.aspose.com/slides/python-java/aspose.slides/slidesizescaletype/#EnsureFit)
...
- [Maximize](https://reference.aspose.com/slides/python-java/aspose.slides/slidesizescaletype/#Maximize)
...
This sample code shows you how to use the [Maximize](https://reference.aspose.com/slides/python-java/aspose.slides/slidesizescaletype/#Maximize) setting when changing the size of a presentation’s slide:
...
You can’t [merge presentations](/slides/python-java/merge-presentation/) while they have different slide sizes — first, resize one presentation to match the other. When changing the slide size, you can choose how existing content is handled via the [SlideSizeScaleType](https://reference.aspose.com/slides/python-java/aspose.slides/slidesizescaletype/) option. After aligning sizes, you can merge slides while preserving formatting.

**Can I generate thumbnails for individual shapes or specific regions of a slide, and will they respect the new slide size?**

Yes. Aspose.Slides can render thumbnails for [entire slides](https://reference.aspose.com/slides/python-java/aspose.slides/slide/#getImage) as well as for [selected shapes](https://reference.aspose.com/slides/python-java/aspose.slides/shape/#getImage). The resulting images reflect the current slide size and aspect ratio, ensuring consistent framing and geometry.
