...
type: docs
weight: 120
url: /python-java/examples/elements/table/
keywords:
- code example
- table
- add table
...
- Java
- Aspose.Slides
description: "Work with tables in Aspose.Slides for Python via Java: add, access, remove, and merge cells in PowerPoint and OpenDocument presentations."
---
