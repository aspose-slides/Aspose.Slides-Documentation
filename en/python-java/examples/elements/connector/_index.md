...
type: docs
weight: 190
url: /python-java/examples/elements/connector/
keywords:
- code example
- connector
- add connector
...
- Java
- Aspose.Slides
description: "Learn how to add, access, remove, and reconnect shapes with connectors using Aspose.Slides for Python via Java in PPT, PPTX, and ODP presentations."
---

This article demonstrates how to connect shapes with connectors and change their targets using **Aspose.Slides for Python via Java**.
