...
For complete C# examples that create, inspect, and modify behaviors and editable motion paths, see [Custom Animation](/slides/net/custom-animation/).
...
[Behavior](https://reference.aspose.com/slides/net/aspose.slides.animation/behavior) is a building block of a PowerPoint animation effect. Combine behaviors to customize an effect, or add a behavior to extend a predefined effect. Repetition is configured through timing settings rather than a separate repeat behavior.
...
[Sequence](https://reference.aspose.com/slides/net/aspose.slides.animation/sequence) is a collection of animation effects that can target different shapes.
...
PPT, PPTX, and ODP are supported for [reading](/slides/net/open-presentation/) and [writing](/slides/net/save-presentation/), but this does not guarantee animation preservation. Custom animation data can be lost when converting to ODP. See [Custom Animation](/slides/net/custom-animation/) for a tested example and format limitations.
