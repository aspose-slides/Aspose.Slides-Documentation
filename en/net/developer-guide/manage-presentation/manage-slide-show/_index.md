---
title: Manage Slide Show in .NET
...
Yes. Save the file as PPSX or PPSM; these formats launch directly in slide show when opened in PowerPoint. In Aspose.Slides, choose the corresponding save format [during export](/slides/net/save-presentation/).

**Can I exclude individual slides from the show without deleting them from the file?**

Yes. Mark a slide as [Hidden](https://reference.aspose.com/slides/net/aspose.slides/slide/hidden/). Hidden slides remain in the presentation but are not displayed during the slide show.
