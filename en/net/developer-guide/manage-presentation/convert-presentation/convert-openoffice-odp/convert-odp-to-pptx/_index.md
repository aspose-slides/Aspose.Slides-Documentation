---
title: Convert ODP to PPTX in .NET
...
- C#
- Aspose.Slides
description: "Convert ODP to PPTX with Aspose.Slides for .NET. Clean C# code examples, batch tips, and high-quality results—no PowerPoint needed."
---
...
Yes. Aspose.Slides supports detecting protection, opening and working with [protected presentations](/slides/net/password-protected-presentation/) (including ODP) when you provide the password, as well as configuring encryption and access to document properties.
