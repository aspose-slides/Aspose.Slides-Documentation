...
You can configure the translator to use your Azure OpenAI deployment with the [OpenAICompatibleWebClient](https://reference.aspose.com/slides/androidjava/com.aspose.slides/openaicompatiblewebclient/).
