---
title: Format PowerPoint Text on Android
...
Text formatting is one of the key elements while creating any kind of documents or presentations. We know that Aspose.Slides for Android via Java supports adding text to slides but in this topic, we will see that how can we control the alignment of the text paragraphs in a slide. Please follow the steps below to align text paragraphs using Aspose.Slides for Android via Java:
...
This article demonstrates how to set transparency property to any text shape using Aspose.Slides for Android via Java. In order to set the transparency to text. Please follow the steps below:
