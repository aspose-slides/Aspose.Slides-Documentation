...
| --- | --- |
| [getAlternativeTextTitle](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ishape/#getAlternativeTextTitle--) | A short title for the alternative description. |
| [getAlternativeText](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ishape/#getAlternativeText--) | A meaningful description of the shape's content or purpose in the context of the slide. |
| [getName](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ishape/#getName--) | The shape's name, which code can use to find a specific shape in the presentation. |
...
Prefer finding the shape by the name returned by [getName](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ishape/#getName--) and checking that it is the expected shape. Alternative text may be edited or translated, which can break code that searches for an exact description; see [Identify and Find Shapes](/slides/androidjava/shape-manipulations/).
