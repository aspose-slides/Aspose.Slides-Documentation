---
title: Add Trend Lines to Presentation Charts on Android
...
- Java
- Aspose.Slides
description: "Quickly add and customize trend lines in PowerPoint charts with Aspose.Slides for Android via Java — a practical guide to engage your audience."
---
...
Yes. Aspose.Slides converts presentations to [PDF](/slides/androidjava/convert-powerpoint-to-pdf/)/[SVG](/slides/androidjava/render-a-slide-as-an-svg-image/) and renders charts to images; trendlines, as part of the chart, are preserved during these operations. A method is also available to [export an image of the chart](/slides/androidjava/create-shape-thumbnails/) itself.
