...
Yes. They are independent stages of the same font-resolution pipeline: first the engine resolves font availability ([replacement](/slides/androidjava/font-replacement/)/[substitution](/slides/androidjava/font-substitution/)), then fallback fills gaps for missing glyphs in available fonts.
