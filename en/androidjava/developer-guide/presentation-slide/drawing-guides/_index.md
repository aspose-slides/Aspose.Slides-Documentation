---
title: Manage Drawing Guides in Presentations on Android
linktitle: Drawing Guides
type: docs
weight: 85
url: /androidjava/drawing-guides/
keywords:
- drawing guide
- horizontal guide
- vertical guide
...
- Java
- Aspose.Slides
description: "Add, access, and clear horizontal and vertical drawing guides in PowerPoint presentations using Aspose.Slides for Android via Java."
---
...
Drawing guides are editing aids, not slide content. They do not appear in a slide show or rendered output. Aspose.Slides for Android via Java exposes them through the [IDrawingGuidesCollection](https://reference.aspose.com/slides/androidjava/com.aspose.slides/idrawingguidescollection/) interface. A guide is represented by [IDrawingGuide](https://reference.aspose.com/slides/androidjava/com.aspose.slides/idrawingguide/) and has an orientation, a position, and a color.
...
Use [ICommonSlideViewProperties.getDrawingGuides](https://reference.aspose.com/slides/androidjava/com.aspose.slides/icommonslideviewproperties/#getDrawingGuides--) to manage guides displayed while editing normal slides. Call [IDrawingGuidesCollection.add](https://reference.aspose.com/slides/androidjava/com.aspose.slides/idrawingguidescollection/#add-byte-float-) with an [Orientation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/orientation/) value and a position in points.
...
The [IDrawingGuidesCollection.getCount](https://reference.aspose.com/slides/androidjava/com.aspose.slides/idrawingguidescollection/#getCount--) and [IDrawingGuidesCollection.get_Item](https://reference.aspose.com/slides/androidjava/com.aspose.slides/idrawingguidescollection/#get_Item-int-) methods provide access to existing guides. The [IDrawingGuide.getOrientation](https://reference.aspose.com/slides/androidjava/com.aspose.slides/idrawingguide/#getOrientation--), [IDrawingGuide.getPosition](https://reference.aspose.com/slides/androidjava/com.aspose.slides/idrawingguide/#getPosition--), and [IDrawingGuide.getColor](https://reference.aspose.com/slides/androidjava/com.aspose.slides/idrawingguide/#getColor--) methods return values that can also be changed through the corresponding setter methods.
...
A slide master and each of its layout slides can have their own drawing-guide collections. Use [IMasterSlide.getDrawingGuides](https://reference.aspose.com/slides/androidjava/com.aspose.slides/imasterslide/#getDrawingGuides--) for a master slide and [ILayoutSlide.getDrawingGuides](https://reference.aspose.com/slides/androidjava/com.aspose.slides/ilayoutslide/#getDrawingGuides--) for a layout slide.
...
Notes masters and handout masters also support drawing guides. Use [IMasterNotesSlide.getDrawingGuides](https://reference.aspose.com/slides/androidjava/com.aspose.slides/imasternotesslide/#getDrawingGuides--) and [IMasterHandoutSlide.getDrawingGuides](https://reference.aspose.com/slides/androidjava/com.aspose.slides/imasterhandoutslide/#getDrawingGuides--) to access their collections. If a presentation does not contain one of these masters, [IMasterNotesSlideManager.setDefaultMasterNotesSlide](https://reference.aspose.com/slides/androidjava/com.aspose.slides/imasternotesslidemanager/#setDefaultMasterNotesSlide--) or [IMasterHandoutSlideManager.setDefaultMasterHandoutSlide](https://reference.aspose.com/slides/androidjava/com.aspose.slides/imasterhandoutslidemanager/#setDefaultMasterHandoutSlide--) creates the default master and returns it.
...
Call [IDrawingGuidesCollection.clear](https://reference.aspose.com/slides/androidjava/com.aspose.slides/idrawingguidescollection/#clear--) to remove every guide from a particular collection. Clearing one collection does not affect guides stored in another scope.
...
No. The [IDrawingGuidesCollection.clear](https://reference.aspose.com/slides/androidjava/com.aspose.slides/idrawingguidescollection/#clear--) method removes only the guides in the selected collection. Shapes and other slide content remain unchanged.
