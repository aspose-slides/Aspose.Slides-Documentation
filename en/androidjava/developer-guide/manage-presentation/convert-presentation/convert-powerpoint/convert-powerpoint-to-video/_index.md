---
title: Convert PowerPoint Presentations to Video on Android
...
// The presentation with the animated smile shape created above.
Presentation presentation = new Presentation();
try {
...
Yes, Aspose.Slides allows working with [password-protected presentations](/slides/androidjava/password-protected-presentation/). When processing such files, you need to provide the correct password so that the library can access the content of the presentation.
