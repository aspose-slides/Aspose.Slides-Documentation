...
PPT, PPTX, and ODP are supported for [reading](/slides/cpp/open-presentation/) and [writing](/slides/cpp/save-presentation/), but format differences mean certain effects may look or behave slightly differently. Validate critical cases with real samples.
