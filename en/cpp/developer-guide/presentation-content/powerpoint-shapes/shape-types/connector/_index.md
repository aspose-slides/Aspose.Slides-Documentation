...
- C++
- Aspose.Slides
description: "Learn how to add, attach, reroute, adjust, and inspect straight, bent, and curved PowerPoint connectors with Aspose.Slides for C++."
---
...
Aspose.Slides represents connectors through the [IConnector](https://reference.aspose.com/slides/cpp/aspose.slides/iconnector/) interface. You can create them, attach their ends to shapes, choose connection sites, reroute them, and modify the geometry of connectors that have adjustment points.

## **Connector Types**

The [ShapeType](https://reference.aspose.com/slides/cpp/aspose.slides/shapetype/) enumeration includes straight, bent, and curved connector presets. The following table shows the available connector geometries and the number of adjustment points defined by each preset.
...
Use [IShapeCollection::AddConnector](https://reference.aspose.com/slides/cpp/aspose.slides/ishapecollection/addconnector/) to add a connector, and call [IConnector::set_StartShapeConnectedTo](https://reference.aspose.com/slides/cpp/aspose.slides/iconnector/set_startshapeconnectedto/) and [IConnector::set_EndShapeConnectedTo](https://reference.aspose.com/slides/cpp/aspose.slides/iconnector/set_endshapeconnectedto/) to attach its ends. After both ends are attached, [IConnector::Reroute](https://reference.aspose.com/slides/cpp/aspose.slides/iconnector/reroute/) selects a short route between the shapes.
...
Calling `IConnector::Reroute` can change the [IConnector::set_StartShapeConnectionSiteIndex](https://reference.aspose.com/slides/cpp/aspose.slides/iconnector/set_startshapeconnectionsiteindex/) and [IConnector::set_EndShapeConnectionSiteIndex](https://reference.aspose.com/slides/cpp/aspose.slides/iconnector/set_endshapeconnectionsiteindex/) values. Assign specific connection sites after rerouting if those sites must remain fixed.

{{% /alert %}}

## **Choose a Connection Site**

Each connectable shape reports its number of sites through [IShape::get_ConnectionSiteCount](https://reference.aspose.com/slides/cpp/aspose.slides/ishape/get_connectionsitecount/). Validate a preferred zero-based site index before assigning it to a connector end; site counts vary by shape geometry.
...
Connectors with adjustment points expose them through [IGeometryShape::get_Adjustments](https://reference.aspose.com/slides/cpp/aspose.slides/igeometryshape/get_adjustments/). Inspect every [IAdjustValue](https://reference.aspose.com/slides/cpp/aspose.slides/iadjustvalue/) and check its [IAdjustValue::get_Type](https://reference.aspose.com/slides/cpp/aspose.slides/iadjustvalue/get_type/) before changing its [IAdjustValue::set_RawValue](https://reference.aspose.com/slides/cpp/aspose.slides/iadjustvalue/set_rawvalue/). The general rules for identifying preset shape adjustments are described in [Shape Manipulation](/slides/cpp/shape-manipulations/).

The number, order, meaning, and valid value range of connector adjustments depend on the connector preset. The type returned by `IAdjustValue::get_Type` is read-only, while the raw adjustment value is writable. The read-only [IAdjustValue::get_Name](https://reference.aspose.com/slides/cpp/aspose.slides/iadjustvalue/get_name/) method provides additional identification when a connector contains more than one adjustment of the same semantic type.
...
- `ShapeType::BentConnector4` normally exposes one `ShapeAdjustmentType::ConnectorBendPositionX` and one `ShapeAdjustmentType::ConnectorBendPositionY` adjustment.
- For these bend positions, `RawValue / 100000.0f` produces the fraction of the connector frame width or height used by the examples below.
...
When the same connector geometry is oriented vertically, its [IShape::get_Frame](https://reference.aspose.com/slides/cpp/aspose.slides/ishape/get_frame/), [IShapeFrame::get_FlipH](https://reference.aspose.com/slides/cpp/aspose.slides/ishapeframe/get_fliph/), and [IShapeFrame::get_FlipV](https://reference.aspose.com/slides/cpp/aspose.slides/ishapeframe/get_flipv/) values affect the conversion from connector-frame coordinates to slide coordinates.
