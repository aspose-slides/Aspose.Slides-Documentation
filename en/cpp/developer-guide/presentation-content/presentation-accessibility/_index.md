...
| --- | --- |
| [AlternativeTextTitle](https://reference.aspose.com/slides/cpp/aspose.slides/ishape/get_alternativetexttitle/) | A short title for the alternative description. |
| [AlternativeText](https://reference.aspose.com/slides/cpp/aspose.slides/ishape/get_alternativetext/) | A meaningful description of the shape's content or purpose in the context of the slide. |
| [Name](https://reference.aspose.com/slides/cpp/aspose.slides/ishape/get_name/) | The shape's name, which code can use to find a specific shape in the presentation. |
...
Prefer finding the shape by its [Name](https://reference.aspose.com/slides/cpp/aspose.slides/ishape/get_name/) and checking that it is the expected shape. Alternative text may be edited or translated, which can break code that searches for an exact description; see [Identify and Find Shapes](/slides/cpp/shape-manipulations/).
