...
This article shows how to work with bubble charts in Aspose.Slides. It covers two specific customization options: scaling bubble sizes through the `set_BubbleSizeScale` method and controlling how bubble size values are represented through the `set_BubbleSizeRepresentation` method.
