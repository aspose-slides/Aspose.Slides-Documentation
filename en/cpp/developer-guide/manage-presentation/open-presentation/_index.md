...
After loading a file or stream, you can [determine its original presentation format](/slides/cpp/detect-presentation-source-format/) to choose how your application processes it.
